...
struct physx_PxContactModifyPair {
    physx_PxRigidActor_Pod const* actor2;
    physx_PxShape_Pod const* shape2;
    physx_PxTransform_Pod transform2;
...
struct physx_PxContactPairVelocity {
    uint8_t type;
    physx_PxVec3_Pod linearVelocity2;
    physx_PxVec3_Pod angularVelocity2;
};
...
struct physx_PxContactPairPose {
    uint8_t type;
    physx_PxTransform_Pod globalPose2;
};
...
void      physx_PxAllocatorCallback_delete(physx_PxAllocatorCallback_Pod* self_);
...
void*      physx_PxAllocatorCallback_allocate_mut(physx_PxAllocatorCallback_Pod* self_, size_t size, char const* typeName, char const* filename, int32_t line);
    ...
    /// This function should be thread safe as it can be called in the context of the user thread
    /// and physics processing thread(s).
void      physx_PxAllocatorCallback_deallocate_mut(physx_PxAllocatorCallback_Pod* self_, void* ptr);

void      physx_PxAssertHandler_delete(physx_PxAssertHandler_Pod* self_);

physx_PxAssertHandler_Pod*      physx_phys_PxGetAssertHandler();

void      physx_phys_PxSetAssertHandler(physx_PxAssertHandler_Pod* handler);
...
void      physx_PxFoundation_release_mut(physx_PxFoundation_Pod* self_);

    /// retrieves error callback
physx_PxErrorCallback_Pod*      physx_PxFoundation_getErrorCallback_mut(physx_PxFoundation_Pod* self_);

    /// Sets mask of errors to report.
void      physx_PxFoundation_setErrorLevel_mut(physx_PxFoundation_Pod* self_, uint32_t mask);

    /// Retrieves mask of errors to be reported.
uint32_t      physx_PxFoundation_getErrorLevel(physx_PxFoundation_Pod const* self_);

    /// Retrieves the allocator this object was created with.
physx_PxAllocatorCallback_Pod*      physx_PxFoundation_getAllocatorCallback_mut(physx_PxFoundation_Pod* self_);

    /// Retrieves if allocation names are being passed to allocator callback.
bool      physx_PxFoundation_getReportAllocationNames(physx_PxFoundation_Pod const* self_);
...
void      physx_PxFoundation_setReportAllocationNames_mut(physx_PxFoundation_Pod* self_, bool value);

void      physx_PxFoundation_registerAllocationListener_mut(physx_PxFoundation_Pod* self_, physx_PxAllocationListener_Pod* listener);

void      physx_PxFoundation_deregisterAllocationListener_mut(physx_PxFoundation_Pod* self_, physx_PxAllocationListener_Pod* listener);

void      physx_PxFoundation_registerErrorCallback_mut(physx_PxFoundation_Pod* self_, physx_PxErrorCallback_Pod* callback);

void      physx_PxFoundation_deregisterErrorCallback_mut(physx_PxFoundation_Pod* self_, physx_PxErrorCallback_Pod* callback);
...
physx_PxFoundation_Pod*      physx_phys_PxCreateFoundation(uint32_t version, physx_PxAllocatorCallback_Pod* allocator, physx_PxErrorCallback_Pod* errorCallback);

void      physx_phys_PxSetFoundationInstance(physx_PxFoundation_Pod* foundation);
...
void      physx_phys_PxSetProfilerCallback(physx_PxProfilerCallback_Pod* profiler);
...
void*      physx_PxAllocator_allocate_mut(physx_PxAllocator_Pod* self_, size_t size, char const* file, int32_t line);

void      physx_PxAllocator_deallocate_mut(physx_PxAllocator_Pod* self_, void* ptr);

physx_PxRawAllocator_Pod      physx_PxRawAllocator_new(char const* anon_param0);

void*      physx_PxRawAllocator_allocate_mut(physx_PxRawAllocator_Pod* self_, size_t size, char const* anon_param1, int32_t anon_param2);

void      physx_PxRawAllocator_deallocate_mut(physx_PxRawAllocator_Pod* self_, void* ptr);

void      physx_PxVirtualAllocatorCallback_delete(physx_PxVirtualAllocatorCallback_Pod* self_);

void*      physx_PxVirtualAllocatorCallback_allocate_mut(physx_PxVirtualAllocatorCallback_Pod* self_, size_t size, int32_t group, char const* file, int32_t line);

void      physx_PxVirtualAllocatorCallback_deallocate_mut(physx_PxVirtualAllocatorCallback_Pod* self_, void* ptr);

physx_PxVirtualAllocator_Pod      physx_PxVirtualAllocator_new(physx_PxVirtualAllocatorCallback_Pod* callback, int32_t group);

void*      physx_PxVirtualAllocator_allocate_mut(physx_PxVirtualAllocator_Pod* self_, size_t size, char const* file, int32_t line);

void      physx_PxVirtualAllocator_deallocate_mut(physx_PxVirtualAllocator_Pod* self_, void* ptr);
...
void*      physx_PxTempAllocator_allocate_mut(physx_PxTempAllocator_Pod* self_, size_t size, char const* file, int32_t line);

void      physx_PxTempAllocator_deallocate_mut(physx_PxTempAllocator_Pod* self_, void* ptr);
...
physx_PxVec3_Pod      physx_PxVec3_new();
    ...
    /// zero constructor.
physx_PxVec3_Pod      physx_PxVec3_new_1(int32_t anon_param0);
...
bool      physx_PxVec3_isZero(physx_PxVec3_Pod const* self_);

    /// returns true if all 3 elems of the vector are finite (not NAN or INF, etc.)
bool      physx_PxVec3_isFinite(physx_PxVec3_Pod const* self_);

    /// is normalized - used by API parameter validation
bool      physx_PxVec3_isNormalized(physx_PxVec3_Pod const* self_);

    /// returns the squared magnitude
    ///
    /// Avoids calling PxSqrt()!
float      physx_PxVec3_magnitudeSquared(physx_PxVec3_Pod const* self_);

    /// returns the magnitude
float      physx_PxVec3_magnitude(physx_PxVec3_Pod const* self_);

    /// returns the scalar product of this and other.
float      physx_PxVec3_dot(physx_PxVec3_Pod const* self_, physx_PxVec3_Pod const* v);

    /// cross product
physx_PxVec3_Pod      physx_PxVec3_cross(physx_PxVec3_Pod const* self_, physx_PxVec3_Pod const* v);

    /// returns a unit vector
physx_PxVec3_Pod      physx_PxVec3_getNormalized(physx_PxVec3_Pod const* self_);

    /// normalizes the vector in place
float      physx_PxVec3_normalize_mut(physx_PxVec3_Pod* self_);
...
float      physx_PxVec3_normalizeSafe_mut(physx_PxVec3_Pod* self_);

    /// normalizes the vector in place. Asserts if vector magnitude is under PX_NORMALIZATION_EPSILON.
    /// returns vector magnitude.
float      physx_PxVec3_normalizeFast_mut(physx_PxVec3_Pod* self_);

    /// a[i] * b[i], for all i.
physx_PxVec3_Pod      physx_PxVec3_multiply(physx_PxVec3_Pod const* self_, physx_PxVec3_Pod const* a);

    /// element-wise minimum
physx_PxVec3_Pod      physx_PxVec3_minimum(physx_PxVec3_Pod const* self_, physx_PxVec3_Pod const* v);

    /// returns MIN(x, y, z);
float      physx_PxVec3_minElement(physx_PxVec3_Pod const* self_);

    /// element-wise maximum
physx_PxVec3_Pod      physx_PxVec3_maximum(physx_PxVec3_Pod const* self_, physx_PxVec3_Pod const* v);

    /// returns MAX(x, y, z);
float      physx_PxVec3_maxElement(physx_PxVec3_Pod const* self_);

    /// returns absolute values of components;
physx_PxVec3_Pod      physx_PxVec3_abs(physx_PxVec3_Pod const* self_);

physx_PxVec3Padded_Pod*      physx_PxVec3Padded_new_alloc();

void      physx_PxVec3Padded_delete(physx_PxVec3Padded_Pod* self_);

physx_PxVec3Padded_Pod*      physx_PxVec3Padded_new_alloc_1(physx_PxVec3_Pod const* p);
...
physx_PxQuat_Pod      physx_PxQuat_new_1(int32_t anon_param0);
...
physx_PxQuat_Pod      physx_PxQuat_new_3(float nx, float ny, float nz, float nw);
    ...
    /// Unit:
    /// Radians
physx_PxQuat_Pod      physx_PxQuat_new_4(float angleRadians, physx_PxVec3_Pod const* unitAxis);

    /// Creates from orientation matrix.
physx_PxQuat_Pod      physx_PxQuat_new_5(physx_PxMat33_Pod const* m);

    /// returns true if quat is identity
bool      physx_PxQuat_isIdentity(physx_PxQuat_Pod const* self_);

    /// returns true if all elements are finite (not NAN or INF, etc.)
bool      physx_PxQuat_isFinite(physx_PxQuat_Pod const* self_);

    /// returns true if finite and magnitude is close to unit
bool      physx_PxQuat_isUnit(physx_PxQuat_Pod const* self_);

    /// returns true if finite and magnitude is reasonably close to unit to allow for some accumulation of error vs
    /// isValid
bool      physx_PxQuat_isSane(physx_PxQuat_Pod const* self_);

    /// converts this quaternion to angle-axis representation
void      physx_PxQuat_toRadiansAndUnitAxis(physx_PxQuat_Pod const* self_, float* angle, physx_PxVec3_Pod* axis);

    /// Gets the angle between this quat and the identity quaternion.
    ///
    /// Unit:
    /// Radians
float      physx_PxQuat_getAngle(physx_PxQuat_Pod const* self_);

    /// Gets the angle between this quat and the argument
    ///
    /// Unit:
    /// Radians
float      physx_PxQuat_getAngle_1(physx_PxQuat_Pod const* self_, physx_PxQuat_Pod const* q);

    /// This is the squared 4D vector length, should be 1 for unit quaternions.
float      physx_PxQuat_magnitudeSquared(physx_PxQuat_Pod const* self_);

    /// returns the scalar product of this and other.
float      physx_PxQuat_dot(physx_PxQuat_Pod const* self_, physx_PxQuat_Pod const* v);

physx_PxQuat_Pod      physx_PxQuat_getNormalized(physx_PxQuat_Pod const* self_);

float      physx_PxQuat_magnitude(physx_PxQuat_Pod const* self_);

    /// maps to the closest unit quaternion.
float      physx_PxQuat_normalize_mut(physx_PxQuat_Pod* self_);

physx_PxQuat_Pod      physx_PxQuat_getConjugate(physx_PxQuat_Pod const* self_);

physx_PxVec3_Pod      physx_PxQuat_getImaginaryPart(physx_PxQuat_Pod const* self_);

    /// brief computes rotation of x-axis
physx_PxVec3_Pod      physx_PxQuat_getBasisVector0(physx_PxQuat_Pod const* self_);

    /// brief computes rotation of y-axis
physx_PxVec3_Pod      physx_PxQuat_getBasisVector1(physx_PxQuat_Pod const* self_);

    /// brief computes rotation of z-axis
physx_PxVec3_Pod      physx_PxQuat_getBasisVector2(physx_PxQuat_Pod const* self_);

    /// rotates passed vec by this (assumed unitary)
physx_PxVec3_Pod      physx_PxQuat_rotate(physx_PxQuat_Pod const* self_, physx_PxVec3_Pod const* v);

    /// inverse rotates passed vec by this (assumed unitary)
physx_PxVec3_Pod      physx_PxQuat_rotateInv(physx_PxQuat_Pod const* self_, physx_PxVec3_Pod const* v);

physx_PxTransform_Pod      physx_PxTransform_new();

physx_PxTransform_Pod      physx_PxTransform_new_1(physx_PxVec3_Pod const* position);

physx_PxTransform_Pod      physx_PxTransform_new_2(int32_t anon_param0);

physx_PxTransform_Pod      physx_PxTransform_new_3(physx_PxQuat_Pod const* orientation);

physx_PxTransform_Pod      physx_PxTransform_new_4(float x, float y, float z, physx_PxQuat_Pod aQ);

physx_PxTransform_Pod      physx_PxTransform_new_5(physx_PxVec3_Pod const* p0, physx_PxQuat_Pod const* q0);

physx_PxTransform_Pod      physx_PxTransform_new_6(physx_PxMat44_Pod const* m);

physx_PxTransform_Pod      physx_PxTransform_getInverse(physx_PxTransform_Pod const* self_);

physx_PxVec3_Pod      physx_PxTransform_transform(physx_PxTransform_Pod const* self_, physx_PxVec3_Pod const* input);

physx_PxVec3_Pod      physx_PxTransform_transformInv(physx_PxTransform_Pod const* self_, physx_PxVec3_Pod const* input);

physx_PxVec3_Pod      physx_PxTransform_rotate(physx_PxTransform_Pod const* self_, physx_PxVec3_Pod const* input);

physx_PxVec3_Pod      physx_PxTransform_rotateInv(physx_PxTransform_Pod const* self_, physx_PxVec3_Pod const* input);

    /// Transform transform to parent (returns compound transform: first src, then *this)
physx_PxTransform_Pod      physx_PxTransform_transform_1(physx_PxTransform_Pod const* self_, physx_PxTransform_Pod const* src);

    /// returns true if finite and q is a unit quaternion
bool      physx_PxTransform_isValid(physx_PxTransform_Pod const* self_);

    /// returns true if finite and quat magnitude is reasonably close to unit to allow for some accumulation of error
    /// vs isValid
bool      physx_PxTransform_isSane(physx_PxTransform_Pod const* self_);

    /// returns true if all elems are finite (not NAN or INF, etc.)
bool      physx_PxTransform_isFinite(physx_PxTransform_Pod const* self_);

    /// Transform transform from parent (returns compound transform: first src, then this->inverse)
physx_PxTransform_Pod      physx_PxTransform_transformInv_1(physx_PxTransform_Pod const* self_, physx_PxTransform_Pod const* src);

    /// return a normalized transform (i.e. one in which the quaternion has unit magnitude)
physx_PxTransform_Pod      physx_PxTransform_getNormalized(physx_PxTransform_Pod const* self_);

    /// Default constructor
physx_PxMat33_Pod      physx_PxMat33_new();

    /// identity constructor
physx_PxMat33_Pod      physx_PxMat33_new_1(int32_t anon_param0);

    /// zero constructor
physx_PxMat33_Pod      physx_PxMat33_new_2(int32_t anon_param0);

    /// Construct from three base vectors
physx_PxMat33_Pod      physx_PxMat33_new_3(physx_PxVec3_Pod const* col0, physx_PxVec3_Pod const* col1, physx_PxVec3_Pod const* col2);
...
physx_PxMat33_Pod      physx_PxMat33_new_6(physx_PxQuat_Pod const* q);

    /// Construct from diagonal, off-diagonals are zero.
physx_PxMat33_Pod      physx_PxMat33_createDiagonal(physx_PxVec3_Pod const* d);

    /// Computes the outer product of two vectors
physx_PxMat33_Pod      physx_PxMat33_outer(physx_PxVec3_Pod const* a, physx_PxVec3_Pod const* b);

    /// Get transposed matrix
physx_PxMat33_Pod      physx_PxMat33_getTranspose(physx_PxMat33_Pod const* self_);

    /// Get the real inverse
physx_PxMat33_Pod      physx_PxMat33_getInverse(physx_PxMat33_Pod const* self_);

    /// Get determinant
float      physx_PxMat33_getDeterminant(physx_PxMat33_Pod const* self_);

    /// Transform vector by matrix, equal to v' = M*v
physx_PxVec3_Pod      physx_PxMat33_transform(physx_PxMat33_Pod const* self_, physx_PxVec3_Pod const* other);

    /// Transform vector by matrix transpose, v' = M^t*v
physx_PxVec3_Pod      physx_PxMat33_transformTranspose(physx_PxMat33_Pod const* self_, physx_PxVec3_Pod const* other);

float const*      physx_PxMat33_front(physx_PxMat33_Pod const* self_);
...
physx_PxBounds3_Pod      physx_PxBounds3_new_1(physx_PxVec3_Pod const* minimum, physx_PxVec3_Pod const* maximum);

    /// Return empty bounds.
physx_PxBounds3_Pod      physx_PxBounds3_empty();

    /// returns the AABB containing v0 and v1.
physx_PxBounds3_Pod      physx_PxBounds3_boundsOfPoints(physx_PxVec3_Pod const* v0, physx_PxVec3_Pod const* v1);

    /// returns the AABB from center and extents vectors.
physx_PxBounds3_Pod      physx_PxBounds3_centerExtents(physx_PxVec3_Pod const* center, physx_PxVec3_Pod const* extent);

    /// Construct from center, extent, and (not necessarily orthogonal) basis
physx_PxBounds3_Pod      physx_PxBounds3_basisExtent(physx_PxVec3_Pod const* center, physx_PxMat33_Pod const* basis, physx_PxVec3_Pod const* extent);

    /// Construct from pose and extent
physx_PxBounds3_Pod      physx_PxBounds3_poseExtent(physx_PxTransform_Pod const* pose, physx_PxVec3_Pod const* extent);

    /// gets the transformed bounds of the passed AABB (resulting in a bigger AABB).
    ///
    /// This version is safe to call for empty bounds.
physx_PxBounds3_Pod      physx_PxBounds3_transformSafe(physx_PxMat33_Pod const* matrix, physx_PxBounds3_Pod const* bounds);

    /// gets the transformed bounds of the passed AABB (resulting in a bigger AABB).
    ///
    /// Calling this method for empty bounds leads to undefined behavior. Use [`transformSafe`]() instead.
physx_PxBounds3_Pod      physx_PxBounds3_transformFast(physx_PxMat33_Pod const* matrix, physx_PxBounds3_Pod const* bounds);

    /// gets the transformed bounds of the passed AABB (resulting in a bigger AABB).
    ///
    /// This version is safe to call for empty bounds.
physx_PxBounds3_Pod      physx_PxBounds3_transformSafe_1(physx_PxTransform_Pod const* transform, physx_PxBounds3_Pod const* bounds);

    /// gets the transformed bounds of the passed AABB (resulting in a bigger AABB).
    ///
    /// Calling this method for empty bounds leads to undefined behavior. Use [`transformSafe`]() instead.
physx_PxBounds3_Pod      physx_PxBounds3_transformFast_1(physx_PxTransform_Pod const* transform, physx_PxBounds3_Pod const* bounds);

    /// Sets empty to true
void      physx_PxBounds3_setEmpty_mut(physx_PxBounds3_Pod* self_);

    /// Sets the bounds to maximum size [-PX_MAX_BOUNDS_EXTENTS, PX_MAX_BOUNDS_EXTENTS].
void      physx_PxBounds3_setMaximal_mut(physx_PxBounds3_Pod* self_);

    /// expands the volume to include v
void      physx_PxBounds3_include_mut(physx_PxBounds3_Pod* self_, physx_PxVec3_Pod const* v);

    /// expands the volume to include b.
void      physx_PxBounds3_include_mut_1(physx_PxBounds3_Pod* self_, physx_PxBounds3_Pod const* b);

bool      physx_PxBounds3_isEmpty(physx_PxBounds3_Pod const* self_);

    /// indicates whether the intersection of this and b is empty or not.
bool      physx_PxBounds3_intersects(physx_PxBounds3_Pod const* self_, physx_PxBounds3_Pod const* b);

    /// computes the 1D-intersection between two AABBs, on a given axis.
bool      physx_PxBounds3_intersects1D(physx_PxBounds3_Pod const* self_, physx_PxBounds3_Pod const* a, uint32_t axis);

    /// indicates if these bounds contain v.
bool      physx_PxBounds3_contains(physx_PxBounds3_Pod const* self_, physx_PxVec3_Pod const* v);

    /// checks a box is inside another box.
bool      physx_PxBounds3_isInside(physx_PxBounds3_Pod const* self_, physx_PxBounds3_Pod const* box_);

    /// returns the center of this axis aligned box.
physx_PxVec3_Pod      physx_PxBounds3_getCenter(physx_PxBounds3_Pod const* self_);

    /// get component of the box's center along a given axis
float      physx_PxBounds3_getCenter_1(physx_PxBounds3_Pod const* self_, uint32_t axis);

    /// get component of the box's extents along a given axis
float      physx_PxBounds3_getExtents(physx_PxBounds3_Pod const* self_, uint32_t axis);

    /// returns the dimensions (width/height/depth) of this axis aligned box.
physx_PxVec3_Pod      physx_PxBounds3_getDimensions(physx_PxBounds3_Pod const* self_);

    /// returns the extents, which are half of the width/height/depth.
physx_PxVec3_Pod      physx_PxBounds3_getExtents_1(physx_PxBounds3_Pod const* self_);

    /// scales the AABB.
    ///
    /// This version is safe to call for empty bounds.
void      physx_PxBounds3_scaleSafe_mut(physx_PxBounds3_Pod* self_, float scale);

    /// scales the AABB.
    ///
    /// Calling this method for empty bounds leads to undefined behavior. Use [`scaleSafe`]() instead.
void      physx_PxBounds3_scaleFast_mut(physx_PxBounds3_Pod* self_, float scale);

    /// fattens the AABB in all 3 dimensions by the given distance.
    ///
    /// This version is safe to call for empty bounds.
void      physx_PxBounds3_fattenSafe_mut(physx_PxBounds3_Pod* self_, float distance);

    /// fattens the AABB in all 3 dimensions by the given distance.
    ///
    /// Calling this method for empty bounds leads to undefined behavior. Use [`fattenSafe`]() instead.
void      physx_PxBounds3_fattenFast_mut(physx_PxBounds3_Pod* self_, float distance);

    /// checks that the AABB values are not NaN
bool      physx_PxBounds3_isFinite(physx_PxBounds3_Pod const* self_);

    /// checks that the AABB values describe a valid configuration.
bool      physx_PxBounds3_isValid(physx_PxBounds3_Pod const* self_);
...
physx_PxVec3_Pod      physx_PxBounds3_closestPoint(physx_PxBounds3_Pod const* self_, physx_PxVec3_Pod const* p);

void      physx_PxErrorCallback_delete(physx_PxErrorCallback_Pod* self_);

    /// Reports an error code.
void      physx_PxErrorCallback_reportError_mut(physx_PxErrorCallback_Pod* self_, int32_t code, char const* message, char const* file, int32_t line);

    /// callback when memory is allocated.
void      physx_PxAllocationListener_onAllocation_mut(physx_PxAllocationListener_Pod* self_, size_t size, char const* typeName, char const* filename, int32_t line, void* allocatedMemory);

    /// callback when memory is deallocated.
void      physx_PxAllocationListener_onDeallocation_mut(physx_PxAllocationListener_Pod* self_, void* allocatedMemory);

    /// The default constructor.
physx_PxBroadcastingAllocator_Pod*      physx_PxBroadcastingAllocator_new_alloc(physx_PxAllocatorCallback_Pod* allocator, physx_PxErrorCallback_Pod* error);

    /// The default constructor.
void      physx_PxBroadcastingAllocator_delete(physx_PxBroadcastingAllocator_Pod* self_);
    ...
    ///
    /// The allocated block of memory.
void*      physx_PxBroadcastingAllocator_allocate_mut(physx_PxBroadcastingAllocator_Pod* self_, size_t size, char const* typeName, char const* filename, int32_t line);
    ...
    /// This function should be thread safe as it can be called in the context of the user thread
    /// and physics processing thread(s).
void      physx_PxBroadcastingAllocator_deallocate_mut(physx_PxBroadcastingAllocator_Pod* self_, void* ptr);

    /// The default constructor.
physx_PxBroadcastingErrorCallback_Pod*      physx_PxBroadcastingErrorCallback_new_alloc(physx_PxErrorCallback_Pod* errorCallback);

    /// The default destructor.
void      physx_PxBroadcastingErrorCallback_delete(physx_PxBroadcastingErrorCallback_Pod* self_);

    /// Reports an error code.
void      physx_PxBroadcastingErrorCallback_reportError_mut(physx_PxBroadcastingErrorCallback_Pod* self_, int32_t code, char const* message, char const* file, int32_t line);
...
uint32_t      physx_PxInputStream_read_mut(physx_PxInputStream_Pod* self_, void* dest, uint32_t count);

void      physx_PxInputStream_delete(physx_PxInputStream_Pod* self_);

    /// return the length of the input data
    ///
    /// size in bytes of the input data
uint32_t      physx_PxInputData_getLength(physx_PxInputData_Pod const* self_);

    /// seek to the given offset from the start of the data.
void      physx_PxInputData_seek_mut(physx_PxInputData_Pod* self_, uint32_t offset);

    /// return the current offset from the start of the data
    ///
    /// the offset to seek to.
uint32_t      physx_PxInputData_tell(physx_PxInputData_Pod const* self_);

void      physx_PxInputData_delete(physx_PxInputData_Pod* self_);
...
uint32_t      physx_PxOutputStream_write_mut(physx_PxOutputStream_Pod* self_, void const* src, uint32_t count);

void      physx_PxOutputStream_delete(physx_PxOutputStream_Pod* self_);

    /// default constructor leaves data uninitialized.
physx_PxVec4_Pod      physx_PxVec4_new();

    /// zero constructor.
physx_PxVec4_Pod      physx_PxVec4_new_1(int32_t anon_param0);
...
physx_PxVec4_Pod      physx_PxVec4_new_3(float nx, float ny, float nz, float nw);
    ...
    /// Initializes from 3 scalar parameters.
physx_PxVec4_Pod      physx_PxVec4_new_4(physx_PxVec3_Pod const* v, float nw);

    /// Initializes from an array of scalar parameters.
physx_PxVec4_Pod      physx_PxVec4_new_5(float const* v);

    /// tests for exact zero vector
bool      physx_PxVec4_isZero(physx_PxVec4_Pod const* self_);

    /// returns true if all 3 elems of the vector are finite (not NAN or INF, etc.)
bool      physx_PxVec4_isFinite(physx_PxVec4_Pod const* self_);

    /// is normalized - used by API parameter validation
bool      physx_PxVec4_isNormalized(physx_PxVec4_Pod const* self_);

    /// returns the squared magnitude
    ///
    /// Avoids calling PxSqrt()!
float      physx_PxVec4_magnitudeSquared(physx_PxVec4_Pod const* self_);

    /// returns the magnitude
float      physx_PxVec4_magnitude(physx_PxVec4_Pod const* self_);

    /// returns the scalar product of this and other.
float      physx_PxVec4_dot(physx_PxVec4_Pod const* self_, physx_PxVec4_Pod const* v);

    /// returns a unit vector
physx_PxVec4_Pod      physx_PxVec4_getNormalized(physx_PxVec4_Pod const* self_);

    /// normalizes the vector in place
float      physx_PxVec4_normalize_mut(physx_PxVec4_Pod* self_);

    /// a[i] * b[i], for all i.
physx_PxVec4_Pod      physx_PxVec4_multiply(physx_PxVec4_Pod const* self_, physx_PxVec4_Pod const* a);

    /// element-wise minimum
physx_PxVec4_Pod      physx_PxVec4_minimum(physx_PxVec4_Pod const* self_, physx_PxVec4_Pod const* v);

    /// element-wise maximum
physx_PxVec4_Pod      physx_PxVec4_maximum(physx_PxVec4_Pod const* self_, physx_PxVec4_Pod const* v);

physx_PxVec3_Pod      physx_PxVec4_getXYZ(physx_PxVec4_Pod const* self_);

    /// Default constructor
physx_PxMat44_Pod      physx_PxMat44_new();

    /// identity constructor
physx_PxMat44_Pod      physx_PxMat44_new_1(int32_t anon_param0);

    /// zero constructor
physx_PxMat44_Pod      physx_PxMat44_new_2(int32_t anon_param0);

    /// Construct from four 4-vectors
physx_PxMat44_Pod      physx_PxMat44_new_3(physx_PxVec4_Pod const* col0, physx_PxVec4_Pod const* col1, physx_PxVec4_Pod const* col2, physx_PxVec4_Pod const* col3);
...
physx_PxMat44_Pod      physx_PxMat44_new_5(physx_PxVec3_Pod const* col0, physx_PxVec3_Pod const* col1, physx_PxVec3_Pod const* col2, physx_PxVec3_Pod const* col3);

    /// Construct from float[16]
physx_PxMat44_Pod      physx_PxMat44_new_6(float* values);

    /// Construct from a quaternion
physx_PxMat44_Pod      physx_PxMat44_new_7(physx_PxQuat_Pod const* q);

    /// Construct from a diagonal vector
physx_PxMat44_Pod      physx_PxMat44_new_8(physx_PxVec4_Pod const* diagonal);

    /// Construct from Mat33 and a translation
physx_PxMat44_Pod      physx_PxMat44_new_9(physx_PxMat33_Pod const* axes, physx_PxVec3_Pod const* position);

physx_PxMat44_Pod      physx_PxMat44_new_10(physx_PxTransform_Pod const* t);

    /// Get transposed matrix
physx_PxMat44_Pod      physx_PxMat44_getTranspose(physx_PxMat44_Pod const* self_);

    /// Transform vector by matrix, equal to v' = M*v
physx_PxVec4_Pod      physx_PxMat44_transform(physx_PxMat44_Pod const* self_, physx_PxVec4_Pod const* other);

    /// Transform vector by matrix, equal to v' = M*v
physx_PxVec3_Pod      physx_PxMat44_transform_1(physx_PxMat44_Pod const* self_, physx_PxVec3_Pod const* other);

    /// Rotate vector by matrix, equal to v' = M*v
physx_PxVec4_Pod      physx_PxMat44_rotate(physx_PxMat44_Pod const* self_, physx_PxVec4_Pod const* other);

    /// Rotate vector by matrix, equal to v' = M*v
physx_PxVec3_Pod      physx_PxMat44_rotate_1(physx_PxMat44_Pod const* self_, physx_PxVec3_Pod const* other);

physx_PxVec3_Pod      physx_PxMat44_getBasis(physx_PxMat44_Pod const* self_, uint32_t num);

physx_PxVec3_Pod      physx_PxMat44_getPosition(physx_PxMat44_Pod const* self_);

void      physx_PxMat44_setPosition_mut(physx_PxMat44_Pod* self_, physx_PxVec3_Pod const* position);

float const*      physx_PxMat44_front(physx_PxMat44_Pod const* self_);

void      physx_PxMat44_scale_mut(physx_PxMat44_Pod* self_, physx_PxVec4_Pod const* p);

physx_PxMat44_Pod      physx_PxMat44_inverseRT(physx_PxMat44_Pod const* self_);

bool      physx_PxMat44_isFinite(physx_PxMat44_Pod const* self_);
...
physx_PxPlane_Pod      physx_PxPlane_new_1(float nx, float ny, float nz, float distance);
    ...
    /// Constructor from a normal and a distance
physx_PxPlane_Pod      physx_PxPlane_new_2(physx_PxVec3_Pod const* normal, float distance);

    /// Constructor from a point on the plane and a normal
physx_PxPlane_Pod      physx_PxPlane_new_3(physx_PxVec3_Pod const* point, physx_PxVec3_Pod const* normal);

    /// Constructor from three points
physx_PxPlane_Pod      physx_PxPlane_new_4(physx_PxVec3_Pod const* p0, physx_PxVec3_Pod const* p1, physx_PxVec3_Pod const* p2);

float      physx_PxPlane_distance(physx_PxPlane_Pod const* self_, physx_PxVec3_Pod const* p);

bool      physx_PxPlane_contains(physx_PxPlane_Pod const* self_, physx_PxVec3_Pod const* p);

    /// projects p into the plane
physx_PxVec3_Pod      physx_PxPlane_project(physx_PxPlane_Pod const* self_, physx_PxVec3_Pod const* p);

    /// find an arbitrary point in the plane
physx_PxVec3_Pod      physx_PxPlane_pointInPlane(physx_PxPlane_Pod const* self_);

    /// equivalent plane with unit normal
void      physx_PxPlane_normalize_mut(physx_PxPlane_Pod* self_);

    /// transform plane
physx_PxPlane_Pod      physx_PxPlane_transform(physx_PxPlane_Pod const* self_, physx_PxTransform_Pod const* pose);

    /// inverse-transform plane
physx_PxPlane_Pod      physx_PxPlane_inverseTransform(physx_PxPlane_Pod const* self_, physx_PxTransform_Pod const* pose);
...
physx_PxQuat_Pod      physx_phys_PxShortestRotation(physx_PxVec3_Pod const* from, physx_PxVec3_Pod const* target);

physx_PxVec3_Pod      physx_phys_PxDiagonalize(physx_PxMat33_Pod const* m, physx_PxQuat_Pod* axes);
...
physx_PxTransform_Pod      physx_phys_PxTransformFromSegment(physx_PxVec3_Pod const* p0, physx_PxVec3_Pod const* p1, float* halfHeight);
...
physx_PxTransform_Pod      physx_phys_PxTransformFromPlaneEquation(physx_PxPlane_Pod const* plane);

    /// creates a plane equation from a transform, such as the actor transform for a PxPlaneGeometry
    ///
    /// the plane
physx_PxPlane_Pod      physx_phys_PxPlaneEquationFromTransform(physx_PxTransform_Pod const* pose);
...
physx_PxQuat_Pod      physx_phys_PxSlerp(float t, physx_PxQuat_Pod const* left, physx_PxQuat_Pod const* right);

    /// integrate transform.
void      physx_phys_PxIntegrateTransform(physx_PxTransform_Pod const* curTrans, physx_PxVec3_Pod const* linvel, physx_PxVec3_Pod const* angvel, float timeStep, physx_PxTransform_Pod* result);

    /// Compute the exponent of a PxVec3
physx_PxQuat_Pod      physx_phys_PxExp(physx_PxVec3_Pod const* v);

    /// computes a oriented bounding box around the scaled basis.
    ///
    /// Bounding box extent.
physx_PxVec3_Pod      physx_phys_PxOptimizeBoundingBox(physx_PxMat33_Pod* basis);

    /// return Returns the log of a PxQuat
physx_PxVec3_Pod      physx_phys_PxLog(physx_PxQuat_Pod const* q);

    /// return Returns 0 if v.x is largest element of v, 1 if v.y is largest element, 2 if v.z is largest element.
uint32_t      physx_phys_PxLargestAxis(physx_PxVec3_Pod const* v);
...
physx_PxVec3_Pod      physx_phys_PxEllipseClamp(physx_PxVec3_Pod const* point, physx_PxVec3_Pod const* radii);
...
void      physx_phys_PxSeparateSwingTwist(physx_PxQuat_Pod const* q, physx_PxQuat_Pod* swing, physx_PxQuat_Pod* twist);

    /// Compute the angle between two non-unit vectors
    ///
    /// Returns the angle (in radians) between the two vector v0 and v1.
float      physx_phys_PxComputeAngle(physx_PxVec3_Pod const* v0, physx_PxVec3_Pod const* v1);

    /// Compute two normalized vectors (right and up) that are perpendicular to an input normalized vector (dir).
void      physx_phys_PxComputeBasisVectors(physx_PxVec3_Pod const* dir, physx_PxVec3_Pod* right, physx_PxVec3_Pod* up);
...
void      physx_phys_PxComputeBasisVectors_1(physx_PxVec3_Pod const* p0, physx_PxVec3_Pod const* p1, physx_PxVec3_Pod* dir, physx_PxVec3_Pod* right, physx_PxVec3_Pod* up);

    /// Compute (i+1)%3
uint32_t      physx_phys_PxGetNextIndex3(uint32_t i);

void      physx_phys_computeBarycentric(physx_PxVec3_Pod const* a, physx_PxVec3_Pod const* b, physx_PxVec3_Pod const* c, physx_PxVec3_Pod const* d, physx_PxVec3_Pod const* p, physx_PxVec4_Pod* bary);

void      physx_phys_computeBarycentric_1(physx_PxVec3_Pod const* a, physx_PxVec3_Pod const* b, physx_PxVec3_Pod const* c, physx_PxVec3_Pod const* p, physx_PxVec4_Pod* bary);
...
float      physx_Interpolation_PxSDFSampleImpl(float const* sdf, physx_PxVec3_Pod const* localPos, physx_PxVec3_Pod const* sdfBoxLower, physx_PxVec3_Pod const* sdfBoxHigher, float sdfDx, float invSdfDx, uint32_t dimX, uint32_t dimY, uint32_t dimZ, float tolerance);

float      physx_phys_PxSdfSample(float const* sdf, physx_PxVec3_Pod const* localPos, physx_PxVec3_Pod const* sdfBoxLower, physx_PxVec3_Pod const* sdfBoxHigher, float sdfDx, float invSdfDx, uint32_t dimX, uint32_t dimY, uint32_t dimZ, physx_PxVec3_Pod* gradient, float tolerance);
...
void      physx_PxMutexImpl_delete(physx_PxMutexImpl_Pod* self_);

    /// Acquire (lock) the mutex. If the mutex is already locked
    /// by another thread, this method blocks until the mutex is
    /// unlocked.
void      physx_PxMutexImpl_lock_mut(physx_PxMutexImpl_Pod* self_);

    /// Acquire (lock) the mutex. If the mutex is already locked
    /// by another thread, this method returns false without blocking.
bool      physx_PxMutexImpl_trylock_mut(physx_PxMutexImpl_Pod* self_);

    /// Release (unlock) the mutex.
void      physx_PxMutexImpl_unlock_mut(physx_PxMutexImpl_Pod* self_);
...
void      physx_PxReadWriteLock_delete(physx_PxReadWriteLock_Pod* self_);

void      physx_PxReadWriteLock_lockReader_mut(physx_PxReadWriteLock_Pod* self_, bool takeLock);

void      physx_PxReadWriteLock_lockWriter_mut(physx_PxReadWriteLock_Pod* self_);

void      physx_PxReadWriteLock_unlockReader_mut(physx_PxReadWriteLock_Pod* self_);

void      physx_PxReadWriteLock_unlockWriter_mut(physx_PxReadWriteLock_Pod* self_);

    /// Mark the beginning of a nested profile block
    ///
    /// Returns implementation-specific profiler data for this event
void*      physx_PxProfilerCallback_zoneStart_mut(physx_PxProfilerCallback_Pod* self_, char const* eventName, bool detached, uint64_t contextId);

    /// Mark the end of a nested profile block
    ///
    /// eventName plus contextId can be used to uniquely match up start and end of a zone.
void      physx_PxProfilerCallback_zoneEnd_mut(physx_PxProfilerCallback_Pod* self_, void* profilerData, char const* eventName, bool detached, uint64_t contextId);

physx_PxProfileScoped_Pod*      physx_PxProfileScoped_new_alloc(physx_PxProfilerCallback_Pod* callback, char const* eventName, bool detached, uint64_t contextId);

void      physx_PxProfileScoped_delete(physx_PxProfileScoped_Pod* self_);

physx_PxSListEntry_Pod      physx_PxSListEntry_new();

physx_PxSListEntry_Pod*      physx_PxSListEntry_next_mut(physx_PxSListEntry_Pod* self_);

physx_PxSListImpl_Pod*      physx_PxSListImpl_new_alloc();

void      physx_PxSListImpl_delete(physx_PxSListImpl_Pod* self_);

void      physx_PxSListImpl_push_mut(physx_PxSListImpl_Pod* self_, physx_PxSListEntry_Pod* entry);

physx_PxSListEntry_Pod*      physx_PxSListImpl_pop_mut(physx_PxSListImpl_Pod* self_);

physx_PxSListEntry_Pod*      physx_PxSListImpl_flush_mut(physx_PxSListImpl_Pod* self_);

uint32_t      physx_PxSListImpl_getSize();

physx_PxSyncImpl_Pod*      physx_PxSyncImpl_new_alloc();

void      physx_PxSyncImpl_delete(physx_PxSyncImpl_Pod* self_);
...
bool      physx_PxSyncImpl_wait_mut(physx_PxSyncImpl_Pod* self_, uint32_t milliseconds);

    /// Signal the synchronization object, waking all threads waiting on it
void      physx_PxSyncImpl_set_mut(physx_PxSyncImpl_Pod* self_);

    /// Reset the synchronization object
void      physx_PxSyncImpl_reset_mut(physx_PxSyncImpl_Pod* self_);
...
void      physx_PxRunnable_delete(physx_PxRunnable_Pod* self_);

void      physx_PxRunnable_execute_mut(physx_PxRunnable_Pod* self_);
...
uint64_t      physx_PxCounterFrequencyToTensOfNanos_toTensOfNanos(physx_PxCounterFrequencyToTensOfNanos_Pod const* self_, uint64_t inCounter);
...
double      physx_PxTime_getElapsedSeconds_mut(physx_PxTime_Pod* self_);

double      physx_PxTime_peekElapsedSeconds_mut(physx_PxTime_Pod* self_);

double      physx_PxTime_getLastTime(physx_PxTime_Pod const* self_);

    /// default constructor leaves data uninitialized.
physx_PxVec2_Pod      physx_PxVec2_new();

    /// zero constructor.
physx_PxVec2_Pod      physx_PxVec2_new_1(int32_t anon_param0);
...
physx_PxVec2_Pod      physx_PxVec2_new_3(float nx, float ny);
    ...
    /// tests for exact zero vector
bool      physx_PxVec2_isZero(physx_PxVec2_Pod const* self_);

    /// returns true if all 2 elems of the vector are finite (not NAN or INF, etc.)
bool      physx_PxVec2_isFinite(physx_PxVec2_Pod const* self_);

    /// is normalized - used by API parameter validation
bool      physx_PxVec2_isNormalized(physx_PxVec2_Pod const* self_);

    /// returns the squared magnitude
    ///
    /// Avoids calling PxSqrt()!
float      physx_PxVec2_magnitudeSquared(physx_PxVec2_Pod const* self_);

    /// returns the magnitude
float      physx_PxVec2_magnitude(physx_PxVec2_Pod const* self_);

    /// returns the scalar product of this and other.
float      physx_PxVec2_dot(physx_PxVec2_Pod const* self_, physx_PxVec2_Pod const* v);

    /// returns a unit vector
physx_PxVec2_Pod      physx_PxVec2_getNormalized(physx_PxVec2_Pod const* self_);

    /// normalizes the vector in place
float      physx_PxVec2_normalize_mut(physx_PxVec2_Pod* self_);

    /// a[i] * b[i], for all i.
physx_PxVec2_Pod      physx_PxVec2_multiply(physx_PxVec2_Pod const* self_, physx_PxVec2_Pod const* a);

    /// element-wise minimum
physx_PxVec2_Pod      physx_PxVec2_minimum(physx_PxVec2_Pod const* self_, physx_PxVec2_Pod const* v);

    /// returns MIN(x, y);
float      physx_PxVec2_minElement(physx_PxVec2_Pod const* self_);

    /// element-wise maximum
physx_PxVec2_Pod      physx_PxVec2_maximum(physx_PxVec2_Pod const* self_, physx_PxVec2_Pod const* v);

    /// returns MAX(x, y);
float      physx_PxVec2_maxElement(physx_PxVec2_Pod const* self_);

physx_PxStridedData_Pod      physx_PxStridedData_new();

physx_PxBoundedData_Pod      physx_PxBoundedData_new();

physx_PxDebugPoint_Pod      physx_PxDebugPoint_new(physx_PxVec3_Pod const* p, uint32_t const* c);

physx_PxDebugLine_Pod      physx_PxDebugLine_new(physx_PxVec3_Pod const* p0, physx_PxVec3_Pod const* p1, uint32_t const* c);

physx_PxDebugTriangle_Pod      physx_PxDebugTriangle_new(physx_PxVec3_Pod const* p0, physx_PxVec3_Pod const* p1, physx_PxVec3_Pod const* p2, uint32_t const* c);

physx_PxDebugText_Pod      physx_PxDebugText_new();

physx_PxDebugText_Pod      physx_PxDebugText_new_1(physx_PxVec3_Pod const* pos, float const* sz, uint32_t const* clr, char const* str);

void      physx_PxRenderBuffer_delete(physx_PxRenderBuffer_Pod* self_);

uint32_t      physx_PxRenderBuffer_getNbPoints(physx_PxRenderBuffer_Pod const* self_);

physx_PxDebugPoint_Pod const*      physx_PxRenderBuffer_getPoints(physx_PxRenderBuffer_Pod const* self_);

void      physx_PxRenderBuffer_addPoint_mut(physx_PxRenderBuffer_Pod* self_, physx_PxDebugPoint_Pod const* point);

uint32_t      physx_PxRenderBuffer_getNbLines(physx_PxRenderBuffer_Pod const* self_);

physx_PxDebugLine_Pod const*      physx_PxRenderBuffer_getLines(physx_PxRenderBuffer_Pod const* self_);

void      physx_PxRenderBuffer_addLine_mut(physx_PxRenderBuffer_Pod* self_, physx_PxDebugLine_Pod const* line);

physx_PxDebugLine_Pod*      physx_PxRenderBuffer_reserveLines_mut(physx_PxRenderBuffer_Pod* self_, uint32_t nbLines);

physx_PxDebugPoint_Pod*      physx_PxRenderBuffer_reservePoints_mut(physx_PxRenderBuffer_Pod* self_, uint32_t nbLines);

uint32_t      physx_PxRenderBuffer_getNbTriangles(physx_PxRenderBuffer_Pod const* self_);

physx_PxDebugTriangle_Pod const*      physx_PxRenderBuffer_getTriangles(physx_PxRenderBuffer_Pod const* self_);

void      physx_PxRenderBuffer_addTriangle_mut(physx_PxRenderBuffer_Pod* self_, physx_PxDebugTriangle_Pod const* triangle);

void      physx_PxRenderBuffer_append_mut(physx_PxRenderBuffer_Pod* self_, physx_PxRenderBuffer_Pod const* other);

void      physx_PxRenderBuffer_clear_mut(physx_PxRenderBuffer_Pod* self_);

void      physx_PxRenderBuffer_shift_mut(physx_PxRenderBuffer_Pod* self_, physx_PxVec3_Pod const* delta);

bool      physx_PxRenderBuffer_empty(physx_PxRenderBuffer_Pod const* self_);

void      physx_PxProcessPxBaseCallback_delete(physx_PxProcessPxBaseCallback_Pod* self_);

void      physx_PxProcessPxBaseCallback_process_mut(physx_PxProcessPxBaseCallback_Pod* self_, physx_PxBase_Pod* anon_param0);
...
void      physx_PxSerializationContext_registerReference_mut(physx_PxSerializationContext_Pod* self_, physx_PxBase_Pod* base, uint32_t kind, size_t reference);

    /// Returns the collection that is being serialized.
physx_PxCollection_Pod const*      physx_PxSerializationContext_getCollection(physx_PxSerializationContext_Pod const* self_);
...
void      physx_PxSerializationContext_writeData_mut(physx_PxSerializationContext_Pod* self_, void const* data, uint32_t size);

    /// Aligns the serialized data.
    ///
    /// This function is assumed to be called within the implementation of PxSerializer::exportData and PxSerializer::exportExtraData.
void      physx_PxSerializationContext_alignData_mut(physx_PxSerializationContext_Pod* self_, uint32_t alignment);
...
void      physx_PxSerializationContext_writeName_mut(physx_PxSerializationContext_Pod* self_, char const* name);
...
physx_PxBase_Pod*      physx_PxDeserializationContext_resolveReference(physx_PxDeserializationContext_Pod const* self_, uint32_t kind, size_t reference);
...
void      physx_PxDeserializationContext_readName_mut(physx_PxDeserializationContext_Pod* self_, char const** name);

    /// Function to align the extra data stream to a power of 2 alignment
    ///
    /// This function is assumed to be called within the implementation of PxSerializer::createObject.
void      physx_PxDeserializationContext_alignExtraData_mut(physx_PxDeserializationContext_Pod* self_, uint32_t alignment);

    /// Register a serializer for a concrete type
void      physx_PxSerializationRegistry_registerSerializer_mut(physx_PxSerializationRegistry_Pod* self_, uint16_t type_, physx_PxSerializer_Pod* serializer);
...
physx_PxSerializer_Pod*      physx_PxSerializationRegistry_unregisterSerializer_mut(physx_PxSerializationRegistry_Pod* self_, uint16_t type_);

    /// Returns PxSerializer corresponding to type
    ///
    /// Registered PxSerializer object corresponding to type
physx_PxSerializer_Pod const*      physx_PxSerializationRegistry_getSerializer(physx_PxSerializationRegistry_Pod const* self_, uint16_t type_);

    /// Register a RepX serializer for a concrete type
void      physx_PxSerializationRegistry_registerRepXSerializer_mut(physx_PxSerializationRegistry_Pod* self_, uint16_t type_, physx_PxRepXSerializer_Pod* serializer);
...
physx_PxRepXSerializer_Pod*      physx_PxSerializationRegistry_unregisterRepXSerializer_mut(physx_PxSerializationRegistry_Pod* self_, uint16_t type_);

    /// Returns RepX serializer given the corresponding type name
    ///
    /// Registered PxRepXSerializer object corresponding to type name
physx_PxRepXSerializer_Pod*      physx_PxSerializationRegistry_getRepXSerializer(physx_PxSerializationRegistry_Pod const* self_, char const* typeName);
...
void      physx_PxSerializationRegistry_release_mut(physx_PxSerializationRegistry_Pod* self_);
    ...
    /// operation fails.
void      physx_PxCollection_add_mut(physx_PxCollection_Pod* self_, physx_PxBase_Pod* object, uint64_t id);

    /// Removes a PxBase member object from the collection.
    ///
    /// Object needs to be contained by the collection.
void      physx_PxCollection_remove_mut(physx_PxCollection_Pod* self_, physx_PxBase_Pod* object);

    /// Returns whether the collection contains a certain PxBase object.
    ///
    /// Whether object is contained.
bool      physx_PxCollection_contains(physx_PxCollection_Pod const* self_, physx_PxBase_Pod* object);
...
void      physx_PxCollection_addId_mut(physx_PxCollection_Pod* self_, physx_PxBase_Pod* object, uint64_t id);

    /// Removes id from a contained PxBase object.
    ///
    /// May only be called for ids that are associated with an object in the collection.
void      physx_PxCollection_removeId_mut(physx_PxCollection_Pod* self_, uint64_t id);
...
void      physx_PxCollection_add_mut_1(physx_PxCollection_Pod* self_, physx_PxCollection_Pod* collection);
...
void      physx_PxCollection_remove_mut_1(physx_PxCollection_Pod* self_, physx_PxCollection_Pod* collection);

    /// Gets number of PxBase objects in this collection.
    ///
    /// Number of objects in this collection
uint32_t      physx_PxCollection_getNbObjects(physx_PxCollection_Pod const* self_);

    /// Gets the PxBase object of this collection given its index.
    ///
    /// PxBase object at index index
physx_PxBase_Pod*      physx_PxCollection_getObject(physx_PxCollection_Pod const* self_, uint32_t index);
...
uint32_t      physx_PxCollection_getObjects(physx_PxCollection_Pod const* self_, physx_PxBase_Pod** userBuffer, uint32_t bufferSize, uint32_t startIndex);
...
physx_PxBase_Pod*      physx_PxCollection_find(physx_PxCollection_Pod const* self_, uint64_t id);

    /// Gets number of PxSerialObjectId names in this collection.
    ///
    /// Number of PxSerialObjectId names in this collection
uint32_t      physx_PxCollection_getNbIds(physx_PxCollection_Pod const* self_);
...
uint32_t      physx_PxCollection_getIds(physx_PxCollection_Pod const* self_, uint64_t* userBuffer, uint32_t bufferSize, uint32_t startIndex);
...
uint64_t      physx_PxCollection_getId(physx_PxCollection_Pod const* self_, physx_PxBase_Pod const* object);
...
void      physx_PxCollection_release_mut(physx_PxCollection_Pod* self_);
...
void      physx_PxBase_release_mut(physx_PxBase_Pod* self_);

    /// Returns string name of dynamic type.
    ///
    /// Class name of most derived type of this object.
char const*      physx_PxBase_getConcreteTypeName(physx_PxBase_Pod const* self_);

    /// Returns concrete type of object.
    ///
    /// PxConcreteType::Enum of serialized object
uint16_t      physx_PxBase_getConcreteType(physx_PxBase_Pod const* self_);

    /// Set PxBaseFlag
void      physx_PxBase_setBaseFlag_mut(physx_PxBase_Pod* self_, int32_t flag, bool value);

    /// Set PxBaseFlags
void      physx_PxBase_setBaseFlags_mut(physx_PxBase_Pod* self_, uint16_t inFlags);

    /// Returns PxBaseFlags
    ///
    /// PxBaseFlags
uint16_t      physx_PxBase_getBaseFlags(physx_PxBase_Pod const* self_);
...
bool      physx_PxBase_isReleasable(physx_PxBase_Pod const* self_);

    /// Decrements the reference count of the object and releases it if the new reference count is zero.
void      physx_PxRefCounted_release_mut(physx_PxRefCounted_Pod* self_);
...
uint32_t      physx_PxRefCounted_getReferenceCount(physx_PxRefCounted_Pod const* self_);
...
void      physx_PxRefCounted_acquireReference_mut(physx_PxRefCounted_Pod* self_);
...
bool      physx_PxTolerancesScale_isValid(physx_PxTolerancesScale_Pod const* self_);

    /// Allocate a new string.
    ///
    /// *Always* a valid null terminated string.  "" is returned if "" or null is passed in.
char const*      physx_PxStringTable_allocateStr_mut(physx_PxStringTable_Pod* self_, char const* inSrc);

    /// Release the string table and all the strings associated with it.
void      physx_PxStringTable_release_mut(physx_PxStringTable_Pod* self_);

    /// Returns string name of dynamic type.
    ///
    /// Class name of most derived type of this object.
char const*      physx_PxSerializer_getConcreteTypeName(physx_PxSerializer_Pod const* self_);
...
void      physx_PxSerializer_requiresObjects(physx_PxSerializer_Pod const* self_, physx_PxBase_Pod* anon_param0, physx_PxProcessPxBaseCallback_Pod* anon_param1);
    ...
    ///
    /// Whether the class is subordinate
bool      physx_PxSerializer_isSubordinate(physx_PxSerializer_Pod const* self_);

    /// Exports object's extra data to stream.
void      physx_PxSerializer_exportExtraData(physx_PxSerializer_Pod const* self_, physx_PxBase_Pod* anon_param0, physx_PxSerializationContext_Pod* anon_param1);

    /// Exports object's data to stream.
void      physx_PxSerializer_exportData(physx_PxSerializer_Pod const* self_, physx_PxBase_Pod* anon_param0, physx_PxSerializationContext_Pod* anon_param1);

    /// Register references that the object maintains to other objects.
void      physx_PxSerializer_registerReferences(physx_PxSerializer_Pod const* self_, physx_PxBase_Pod* obj, physx_PxSerializationContext_Pod* s);

    /// Returns size needed to create the class instance.
    ///
    /// sizeof class instance.
size_t      physx_PxSerializer_getClassSize(physx_PxSerializer_Pod const* self_);
...
physx_PxBase_Pod*      physx_PxSerializer_createObject(physx_PxSerializer_Pod const* self_, uint8_t** address, physx_PxDeserializationContext_Pod* context);

    /// *******************************************************************************************************************
void      physx_PxSerializer_delete(physx_PxSerializer_Pod* self_);

    /// Builds object (TriangleMesh, Heightfield, ConvexMesh or BVH) from given data in PxPhysics.
    ///
    /// PxBase Created object in PxPhysics.
physx_PxBase_Pod*      physx_PxInsertionCallback_buildObjectFromData_mut(physx_PxInsertionCallback_Pod* self_, int32_t type_, void* data);

    /// Set the user-provided dispatcher object for CPU tasks
void      physx_PxTaskManager_setCpuDispatcher_mut(physx_PxTaskManager_Pod* self_, physx_PxCpuDispatcher_Pod* ref_);

    /// Get the user-provided dispatcher object for CPU tasks
    ///
    /// The CPU dispatcher object.
physx_PxCpuDispatcher_Pod*      physx_PxTaskManager_getCpuDispatcher(physx_PxTaskManager_Pod const* self_);

    /// Reset any dependencies between Tasks
    ///
    /// Will be called at the start of every frame before tasks are submitted.
void      physx_PxTaskManager_resetDependencies_mut(physx_PxTaskManager_Pod* self_);

    /// Called by the owning scene to start the task graph.
    ///
    /// All tasks with ref count of 1 will be dispatched.
void      physx_PxTaskManager_startSimulation_mut(physx_PxTaskManager_Pod* self_);

    /// Called by the owning scene at the end of a simulation step.
void      physx_PxTaskManager_stopSimulation_mut(physx_PxTaskManager_Pod* self_);

    /// Called by the worker threads to inform the PxTaskManager that a task has completed processing.
void      physx_PxTaskManager_taskCompleted_mut(physx_PxTaskManager_Pod* self_, physx_PxTask_Pod* task);

    /// Retrieve a task by name
    ///
    /// The ID of the task with that name, or eNOT_PRESENT if not found
uint32_t      physx_PxTaskManager_getNamedTask_mut(physx_PxTaskManager_Pod* self_, char const* name);

    /// Submit a task with a unique name.
    ///
    /// The ID of the task with that name, or eNOT_PRESENT if not found
uint32_t      physx_PxTaskManager_submitNamedTask_mut(physx_PxTaskManager_Pod* self_, physx_PxTask_Pod* task, char const* name, int32_t type_);

    /// Submit an unnamed task.
    ///
    /// The ID of the task with that name, or eNOT_PRESENT if not found
uint32_t      physx_PxTaskManager_submitUnnamedTask_mut(physx_PxTaskManager_Pod* self_, physx_PxTask_Pod* task, int32_t type_);

    /// Retrieve a task given a task ID
    ///
    /// The task associated with the ID
physx_PxTask_Pod*      physx_PxTaskManager_getTaskFromID_mut(physx_PxTaskManager_Pod* self_, uint32_t id);

    /// Release the PxTaskManager object, referenced dispatchers will not be released
void      physx_PxTaskManager_release_mut(physx_PxTaskManager_Pod* self_);

    /// Construct a new PxTaskManager instance with the given [optional] dispatchers
physx_PxTaskManager_Pod*      physx_PxTaskManager_createTaskManager(physx_PxErrorCallback_Pod* errorCallback, physx_PxCpuDispatcher_Pod* anon_param1);
    ...
    /// discard its pointer.
void      physx_PxCpuDispatcher_submitTask_mut(physx_PxCpuDispatcher_Pod* self_, physx_PxBaseTask_Pod* task);
...
uint32_t      physx_PxCpuDispatcher_getWorkerCount(physx_PxCpuDispatcher_Pod const* self_);

void      physx_PxCpuDispatcher_delete(physx_PxCpuDispatcher_Pod* self_);
    ...
    /// must never block.
void      physx_PxBaseTask_run_mut(physx_PxBaseTask_Pod* self_);
...
char const*      physx_PxBaseTask_getName(physx_PxBaseTask_Pod const* self_);

    /// Implemented by derived implementation classes
void      physx_PxBaseTask_addReference_mut(physx_PxBaseTask_Pod* self_);

    /// Implemented by derived implementation classes
void      physx_PxBaseTask_removeReference_mut(physx_PxBaseTask_Pod* self_);

    /// Implemented by derived implementation classes
int32_t      physx_PxBaseTask_getReference(physx_PxBaseTask_Pod const* self_);
...
void      physx_PxBaseTask_release_mut(physx_PxBaseTask_Pod* self_);

    /// Return PxTaskManager to which this task was submitted
    ///
    /// Note, can return NULL if task was not submitted, or has been
    /// completed.
physx_PxTaskManager_Pod*      physx_PxBaseTask_getTaskManager(physx_PxBaseTask_Pod const* self_);

void      physx_PxBaseTask_setContextId_mut(physx_PxBaseTask_Pod* self_, uint64_t id);

uint64_t      physx_PxBaseTask_getContextId(physx_PxBaseTask_Pod const* self_);

    /// Release method implementation
void      physx_PxTask_release_mut(physx_PxTask_Pod* self_);

    /// Inform the PxTaskManager this task must finish before the given
void      physx_PxTask_finishBefore_mut(physx_PxTask_Pod* self_, uint32_t taskID);

    /// Inform the PxTaskManager this task cannot start until the given
void      physx_PxTask_startAfter_mut(physx_PxTask_Pod* self_, uint32_t taskID);

    /// Manually increment this task's reference count. The task will
    /// not be allowed to run until removeReference() is called.
void      physx_PxTask_addReference_mut(physx_PxTask_Pod* self_);

    /// Manually decrement this task's reference count. If the reference
    /// count reaches zero, the task will be dispatched.
void      physx_PxTask_removeReference_mut(physx_PxTask_Pod* self_);

    /// Return the ref-count for this task
int32_t      physx_PxTask_getReference(physx_PxTask_Pod const* self_);

    /// Return the unique ID for this task
uint32_t      physx_PxTask_getTaskID(physx_PxTask_Pod const* self_);

    /// Called by PxTaskManager at submission time for initialization
    ///
    /// Perform simulation step initialization here.
void      physx_PxTask_submitted_mut(physx_PxTask_Pod* self_);
...
void      physx_PxLightCpuTask_setContinuation_mut(physx_PxLightCpuTask_Pod* self_, physx_PxTaskManager_Pod* tm, physx_PxBaseTask_Pod* c);

    /// Initialize this task and specify the task that will have its ref count decremented on completion.
    ///
    /// This overload of setContinuation() queries the PxTaskManager from the continuation
    /// task, which cannot be NULL.
void      physx_PxLightCpuTask_setContinuation_mut_1(physx_PxLightCpuTask_Pod* self_, physx_PxBaseTask_Pod* c);

    /// Retrieves continuation task
physx_PxBaseTask_Pod*      physx_PxLightCpuTask_getContinuation(physx_PxLightCpuTask_Pod const* self_);

    /// Manually decrement this task's reference count. If the reference
    /// count reaches zero, the task will be dispatched.
void      physx_PxLightCpuTask_removeReference_mut(physx_PxLightCpuTask_Pod* self_);

    /// Return the ref-count for this task
int32_t      physx_PxLightCpuTask_getReference(physx_PxLightCpuTask_Pod const* self_);

    /// Manually increment this task's reference count. The task will
    /// not be allowed to run until removeReference() is called.
void      physx_PxLightCpuTask_addReference_mut(physx_PxLightCpuTask_Pod* self_);

    /// called by CpuDispatcher after run method has completed
    ///
    /// Decrements the continuation task's reference count, if specified.
void      physx_PxLightCpuTask_release_mut(physx_PxLightCpuTask_Pod* self_);

    /// Returns the type of the geometry.
    ///
    /// The type of the object.
int32_t      physx_PxGeometry_getType(physx_PxGeometry_Pod const* self_);
...
physx_PxBoxGeometry_Pod      physx_PxBoxGeometry_new_1(physx_PxVec3_Pod halfExtents_);
...
bool      physx_PxBoxGeometry_isValid(physx_PxBoxGeometry_Pod const* self_);

void      physx_PxBVHRaycastCallback_delete(physx_PxBVHRaycastCallback_Pod* self_);

bool      physx_PxBVHRaycastCallback_reportHit_mut(physx_PxBVHRaycastCallback_Pod* self_, uint32_t boundsIndex, float* distance);

void      physx_PxBVHOverlapCallback_delete(physx_PxBVHOverlapCallback_Pod* self_);

bool      physx_PxBVHOverlapCallback_reportHit_mut(physx_PxBVHOverlapCallback_Pod* self_, uint32_t boundsIndex);

void      physx_PxBVHTraversalCallback_delete(physx_PxBVHTraversalCallback_Pod* self_);

bool      physx_PxBVHTraversalCallback_visitNode_mut(physx_PxBVHTraversalCallback_Pod* self_, physx_PxBounds3_Pod const* bounds);

bool      physx_PxBVHTraversalCallback_reportLeaf_mut(physx_PxBVHTraversalCallback_Pod* self_, uint32_t nbPrims, uint32_t const* prims);

    /// Raycast test against a BVH.
    ///
    /// false if query has been aborted
bool      physx_PxBVH_raycast(physx_PxBVH_Pod const* self_, physx_PxVec3_Pod const* origin, physx_PxVec3_Pod const* unitDir, float maxDist, physx_PxBVHRaycastCallback_Pod* cb, uint32_t queryFlags);

    /// Sweep test against a BVH.
    ///
    /// false if query has been aborted
bool      physx_PxBVH_sweep(physx_PxBVH_Pod const* self_, physx_PxGeometry_Pod const* geom, physx_PxTransform_Pod const* pose, physx_PxVec3_Pod const* unitDir, float maxDist, physx_PxBVHRaycastCallback_Pod* cb, uint32_t queryFlags);

    /// Overlap test against a BVH.
    ///
    /// false if query has been aborted
bool      physx_PxBVH_overlap(physx_PxBVH_Pod const* self_, physx_PxGeometry_Pod const* geom, physx_PxTransform_Pod const* pose, physx_PxBVHOverlapCallback_Pod* cb, uint32_t queryFlags);
    ...
    ///
    /// false if query has been aborted
bool      physx_PxBVH_cull(physx_PxBVH_Pod const* self_, uint32_t nbPlanes, physx_PxPlane_Pod const* planes, physx_PxBVHOverlapCallback_Pod* cb, uint32_t queryFlags);
...
uint32_t      physx_PxBVH_getNbBounds(physx_PxBVH_Pod const* self_);

    /// Retrieve the read-only bounds in the BVH.
    ///
    /// These are the user-defined bounds passed to the BVH builder, not the internal bounds around each BVH node.
physx_PxBounds3_Pod const*      physx_PxBVH_getBounds(physx_PxBVH_Pod const* self_);
    ...
    ///
    /// These are the user-defined bounds passed to the BVH builder, not the internal bounds around each BVH node.
physx_PxBounds3_Pod*      physx_PxBVH_getBoundsForModification_mut(physx_PxBVH_Pod* self_);
...
void      physx_PxBVH_refit_mut(physx_PxBVH_Pod* self_);
    ...
    ///
    /// true if success
bool      physx_PxBVH_updateBounds_mut(physx_PxBVH_Pod* self_, uint32_t boundsIndex, physx_PxBounds3_Pod const* newBounds);
...
void      physx_PxBVH_partialRefit_mut(physx_PxBVH_Pod* self_);
    ...
    ///
    /// false if query has been aborted
bool      physx_PxBVH_traverse(physx_PxBVH_Pod const* self_, physx_PxBVHTraversalCallback_Pod* cb);

char const*      physx_PxBVH_getConcreteTypeName(physx_PxBVH_Pod const* self_);
...
bool      physx_PxCapsuleGeometry_isValid(physx_PxCapsuleGeometry_Pod const* self_);

    /// Returns the number of vertices.
    ///
    /// Number of vertices.
uint32_t      physx_PxConvexMesh_getNbVertices(physx_PxConvexMesh_Pod const* self_);

    /// Returns the vertices.
    ///
    /// Array of vertices.
physx_PxVec3_Pod const*      physx_PxConvexMesh_getVertices(physx_PxConvexMesh_Pod const* self_);

    /// Returns the index buffer.
    ///
    /// Index buffer.
uint8_t const*      physx_PxConvexMesh_getIndexBuffer(physx_PxConvexMesh_Pod const* self_);

    /// Returns the number of polygons.
    ///
    /// Number of polygons.
uint32_t      physx_PxConvexMesh_getNbPolygons(physx_PxConvexMesh_Pod const* self_);

    /// Returns the polygon data.
    ///
    /// True if success.
bool      physx_PxConvexMesh_getPolygonData(physx_PxConvexMesh_Pod const* self_, uint32_t index, physx_PxHullPolygon_Pod* data);

    /// Decrements the reference count of a convex mesh and releases it if the new reference count is zero.
void      physx_PxConvexMesh_release_mut(physx_PxConvexMesh_Pod* self_);
...
void      physx_PxConvexMesh_getMassInformation(physx_PxConvexMesh_Pod const* self_, float* mass, physx_PxMat33_Pod* localInertia, physx_PxVec3_Pod* localCenterOfMass);

    /// Returns the local-space (vertex space) AABB from the convex mesh.
    ///
    /// local-space bounds
physx_PxBounds3_Pod      physx_PxConvexMesh_getLocalBounds(physx_PxConvexMesh_Pod const* self_);

    /// Returns the local-space Signed Distance Field for this mesh if it has one.
    ///
    /// local-space SDF.
float const*      physx_PxConvexMesh_getSDF(physx_PxConvexMesh_Pod const* self_);

char const*      physx_PxConvexMesh_getConcreteTypeName(physx_PxConvexMesh_Pod const* self_);
...
bool      physx_PxConvexMesh_isGpuCompatible(physx_PxConvexMesh_Pod const* self_);
...
physx_PxMeshScale_Pod      physx_PxMeshScale_new_2(physx_PxVec3_Pod const* s);

    /// Constructor to initialize to arbitrary scaling.
physx_PxMeshScale_Pod      physx_PxMeshScale_new_3(physx_PxVec3_Pod const* s, physx_PxQuat_Pod const* r);

    /// Returns true if the scaling is an identity transformation.
bool      physx_PxMeshScale_isIdentity(physx_PxMeshScale_Pod const* self_);

    /// Returns the inverse of this scaling transformation.
physx_PxMeshScale_Pod      physx_PxMeshScale_getInverse(physx_PxMeshScale_Pod const* self_);

    /// Converts this transformation to a 3x3 matrix representation.
physx_PxMat33_Pod      physx_PxMeshScale_toMat33(physx_PxMeshScale_Pod const* self_);
...
bool      physx_PxMeshScale_hasNegativeDeterminant(physx_PxMeshScale_Pod const* self_);

physx_PxVec3_Pod      physx_PxMeshScale_transform(physx_PxMeshScale_Pod const* self_, physx_PxVec3_Pod const* v);

bool      physx_PxMeshScale_isValidForTriangleMesh(physx_PxMeshScale_Pod const* self_);

bool      physx_PxMeshScale_isValidForConvexMesh(physx_PxMeshScale_Pod const* self_);

    /// Constructor. By default creates an empty object with a NULL mesh and identity scale.
physx_PxConvexMeshGeometry_Pod      physx_PxConvexMeshGeometry_new(physx_PxConvexMesh_Pod* mesh, physx_PxMeshScale_Pod const* scaling, uint8_t flags);
...
bool      physx_PxConvexMeshGeometry_isValid(physx_PxConvexMeshGeometry_Pod const* self_);
...
bool      physx_PxSphereGeometry_isValid(physx_PxSphereGeometry_Pod const* self_);
...
physx_PxPlaneGeometry_Pod      physx_PxPlaneGeometry_new();
    ...
    ///
    /// True if the current settings are valid
bool      physx_PxPlaneGeometry_isValid(physx_PxPlaneGeometry_Pod const* self_);

    /// Constructor. By default creates an empty object with a NULL mesh and identity scale.
physx_PxTriangleMeshGeometry_Pod      physx_PxTriangleMeshGeometry_new(physx_PxTriangleMesh_Pod* mesh, physx_PxMeshScale_Pod const* scaling, uint8_t flags);
...
bool      physx_PxTriangleMeshGeometry_isValid(physx_PxTriangleMeshGeometry_Pod const* self_);

    /// Constructor.
physx_PxHeightFieldGeometry_Pod      physx_PxHeightFieldGeometry_new(physx_PxHeightField_Pod* hf, uint8_t flags, float heightScale_, float rowScale_, float columnScale_);
...
bool      physx_PxHeightFieldGeometry_isValid(physx_PxHeightFieldGeometry_Pod const* self_);
...
physx_PxParticleSystemGeometry_Pod      physx_PxParticleSystemGeometry_new();
    ...
    ///
    /// True if the current settings are valid for shape creation.
bool      physx_PxParticleSystemGeometry_isValid(physx_PxParticleSystemGeometry_Pod const* self_);
...
physx_PxHairSystemGeometry_Pod      physx_PxHairSystemGeometry_new();
    ...
    ///
    /// True if the current settings are valid for shape creation.
bool      physx_PxHairSystemGeometry_isValid(physx_PxHairSystemGeometry_Pod const* self_);

    /// Constructor. By default creates an empty object with a NULL mesh and identity scale.
physx_PxTetrahedronMeshGeometry_Pod      physx_PxTetrahedronMeshGeometry_new(physx_PxTetrahedronMesh_Pod* mesh);
...
bool      physx_PxTetrahedronMeshGeometry_isValid(physx_PxTetrahedronMeshGeometry_Pod const* self_);
...
bool      physx_PxLocationHit_hadInitialOverlap(physx_PxLocationHit_Pod const* self_);
...
physx_PxCustomGeometryType_Pod      physx_PxCustomGeometryCallbacks_getCustomType(physx_PxCustomGeometryCallbacks_Pod const* self_);

    /// Return local bounds.
    ///
    /// Bounding box in the geometry local space.
physx_PxBounds3_Pod      physx_PxCustomGeometryCallbacks_getLocalBounds(physx_PxCustomGeometryCallbacks_Pod const* self_, physx_PxGeometry_Pod const* geometry);
...
bool      physx_PxCustomGeometryCallbacks_overlap(physx_PxCustomGeometryCallbacks_Pod const* self_, physx_PxGeometry_Pod const* geom0, physx_PxTransform_Pod const* pose0, physx_PxGeometry_Pod const* geom1, physx_PxTransform_Pod const* pose1, physx_PxQueryThreadContext_Pod* threadContext);
...
void      physx_PxCustomGeometryCallbacks_computeMassProperties(physx_PxCustomGeometryCallbacks_Pod const* self_, physx_PxGeometry_Pod const* geometry, physx_PxMassProperties_Pod* massProperties);

    /// Compatible with PhysX's PCM feature. Allows to optimize contact generation.
bool      physx_PxCustomGeometryCallbacks_usePersistentContactManifold(physx_PxCustomGeometryCallbacks_Pod const* self_, physx_PxGeometry_Pod const* geometry, float* breakingThreshold);

void      physx_PxCustomGeometryCallbacks_delete(physx_PxCustomGeometryCallbacks_Pod* self_);
...
physx_PxCustomGeometry_Pod      physx_PxCustomGeometry_new();
    ...
    /// Constructor.
physx_PxCustomGeometry_Pod      physx_PxCustomGeometry_new_1(physx_PxCustomGeometryCallbacks_Pod* _callbacks);

    /// Returns true if the geometry is valid.
    ///
    /// True if the current settings are valid for shape creation.
bool      physx_PxCustomGeometry_isValid(physx_PxCustomGeometry_Pod const* self_);

    /// Returns the custom type of the custom geometry.
physx_PxCustomGeometryType_Pod      physx_PxCustomGeometry_getCustomType(physx_PxCustomGeometry_Pod const* self_);

int32_t      physx_PxGeometryHolder_getType(physx_PxGeometryHolder_Pod const* self_);

physx_PxGeometry_Pod*      physx_PxGeometryHolder_any_mut(physx_PxGeometryHolder_Pod* self_);

physx_PxGeometry_Pod const*      physx_PxGeometryHolder_any(physx_PxGeometryHolder_Pod const* self_);

physx_PxSphereGeometry_Pod*      physx_PxGeometryHolder_sphere_mut(physx_PxGeometryHolder_Pod* self_);

physx_PxSphereGeometry_Pod const*      physx_PxGeometryHolder_sphere(physx_PxGeometryHolder_Pod const* self_);

physx_PxPlaneGeometry_Pod*      physx_PxGeometryHolder_plane_mut(physx_PxGeometryHolder_Pod* self_);

physx_PxPlaneGeometry_Pod const*      physx_PxGeometryHolder_plane(physx_PxGeometryHolder_Pod const* self_);

physx_PxCapsuleGeometry_Pod*      physx_PxGeometryHolder_capsule_mut(physx_PxGeometryHolder_Pod* self_);

physx_PxCapsuleGeometry_Pod const*      physx_PxGeometryHolder_capsule(physx_PxGeometryHolder_Pod const* self_);

physx_PxBoxGeometry_Pod*      physx_PxGeometryHolder_box_mut(physx_PxGeometryHolder_Pod* self_);

physx_PxBoxGeometry_Pod const*      physx_PxGeometryHolder_box(physx_PxGeometryHolder_Pod const* self_);

physx_PxConvexMeshGeometry_Pod*      physx_PxGeometryHolder_convexMesh_mut(physx_PxGeometryHolder_Pod* self_);

physx_PxConvexMeshGeometry_Pod const*      physx_PxGeometryHolder_convexMesh(physx_PxGeometryHolder_Pod const* self_);

physx_PxTetrahedronMeshGeometry_Pod*      physx_PxGeometryHolder_tetMesh_mut(physx_PxGeometryHolder_Pod* self_);

physx_PxTetrahedronMeshGeometry_Pod const*      physx_PxGeometryHolder_tetMesh(physx_PxGeometryHolder_Pod const* self_);

physx_PxTriangleMeshGeometry_Pod*      physx_PxGeometryHolder_triangleMesh_mut(physx_PxGeometryHolder_Pod* self_);

physx_PxTriangleMeshGeometry_Pod const*      physx_PxGeometryHolder_triangleMesh(physx_PxGeometryHolder_Pod const* self_);

physx_PxHeightFieldGeometry_Pod*      physx_PxGeometryHolder_heightField_mut(physx_PxGeometryHolder_Pod* self_);

physx_PxHeightFieldGeometry_Pod const*      physx_PxGeometryHolder_heightField(physx_PxGeometryHolder_Pod const* self_);

physx_PxParticleSystemGeometry_Pod*      physx_PxGeometryHolder_particleSystem_mut(physx_PxGeometryHolder_Pod* self_);

physx_PxParticleSystemGeometry_Pod const*      physx_PxGeometryHolder_particleSystem(physx_PxGeometryHolder_Pod const* self_);

physx_PxHairSystemGeometry_Pod*      physx_PxGeometryHolder_hairSystem_mut(physx_PxGeometryHolder_Pod* self_);

physx_PxHairSystemGeometry_Pod const*      physx_PxGeometryHolder_hairSystem(physx_PxGeometryHolder_Pod const* self_);

physx_PxCustomGeometry_Pod*      physx_PxGeometryHolder_custom_mut(physx_PxGeometryHolder_Pod* self_);

physx_PxCustomGeometry_Pod const*      physx_PxGeometryHolder_custom(physx_PxGeometryHolder_Pod const* self_);

void      physx_PxGeometryHolder_storeAny_mut(physx_PxGeometryHolder_Pod* self_, physx_PxGeometry_Pod const* geometry);

physx_PxGeometryHolder_Pod      physx_PxGeometryHolder_new();

physx_PxGeometryHolder_Pod      physx_PxGeometryHolder_new_1(physx_PxGeometry_Pod const* geometry);
...
bool      physx_PxGeometryQuery_overlap(physx_PxGeometry_Pod const* geom0, physx_PxTransform_Pod const* pose0, physx_PxGeometry_Pod const* geom1, physx_PxTransform_Pod const* pose1, uint32_t queryFlags, physx_PxQueryThreadContext_Pod* threadContext);
...
bool      physx_PxGeometryQuery_computePenetration(physx_PxVec3_Pod* direction, float* depth, physx_PxGeometry_Pod const* geom0, physx_PxTransform_Pod const* pose0, physx_PxGeometry_Pod const* geom1, physx_PxTransform_Pod const* pose1, uint32_t queryFlags);
...
float      physx_PxGeometryQuery_pointDistance(physx_PxVec3_Pod const* point, physx_PxGeometry_Pod const* geom, physx_PxTransform_Pod const* pose, physx_PxVec3_Pod* closestPoint, uint32_t* closestIndex, uint32_t queryFlags);

    /// computes the bounds for a geometry object
void      physx_PxGeometryQuery_computeGeomBounds(physx_PxBounds3_Pod* bounds, physx_PxGeometry_Pod const* geom, physx_PxTransform_Pod const* pose, float offset, float inflation, uint32_t queryFlags);

    /// Checks if provided geometry is valid.
    ///
    /// True if geometry is valid.
bool      physx_PxGeometryQuery_isValid(physx_PxGeometry_Pod const* geom);

uint8_t      physx_PxHeightFieldSample_tessFlag(physx_PxHeightFieldSample_Pod const* self_);

void      physx_PxHeightFieldSample_setTessFlag_mut(physx_PxHeightFieldSample_Pod* self_);

void      physx_PxHeightFieldSample_clearTessFlag_mut(physx_PxHeightFieldSample_Pod* self_);

    /// Decrements the reference count of a height field and releases it if the new reference count is zero.
void      physx_PxHeightField_release_mut(physx_PxHeightField_Pod* self_);
...
uint32_t      physx_PxHeightField_saveCells(physx_PxHeightField_Pod const* self_, void* destBuffer, uint32_t destBufferSize);
...
bool      physx_PxHeightField_modifySamples_mut(physx_PxHeightField_Pod* self_, int32_t startCol, int32_t startRow, physx_PxHeightFieldDesc_Pod const* subfieldDesc, bool shrinkBounds);

    /// Retrieves the number of sample rows in the samples array.
    ///
    /// The number of sample rows in the samples array.
uint32_t      physx_PxHeightField_getNbRows(physx_PxHeightField_Pod const* self_);

    /// Retrieves the number of sample columns in the samples array.
    ///
    /// The number of sample columns in the samples array.
uint32_t      physx_PxHeightField_getNbColumns(physx_PxHeightField_Pod const* self_);

    /// Retrieves the format of the sample data.
    ///
    /// The format of the sample data.
int32_t      physx_PxHeightField_getFormat(physx_PxHeightField_Pod const* self_);
...
uint32_t      physx_PxHeightField_getSampleStride(physx_PxHeightField_Pod const* self_);

    /// Retrieves the convex edge threshold.
    ///
    /// The convex edge threshold.
float      physx_PxHeightField_getConvexEdgeThreshold(physx_PxHeightField_Pod const* self_);
...
uint16_t      physx_PxHeightField_getFlags(physx_PxHeightField_Pod const* self_);
...
float      physx_PxHeightField_getHeight(physx_PxHeightField_Pod const* self_, float x, float z);
...
uint16_t      physx_PxHeightField_getTriangleMaterialIndex(physx_PxHeightField_Pod const* self_, uint32_t triangleIndex);
...
physx_PxVec3_Pod      physx_PxHeightField_getTriangleNormal(physx_PxHeightField_Pod const* self_, uint32_t triangleIndex);

    /// Returns heightfield sample of given row and column
    ///
    /// Heightfield sample
physx_PxHeightFieldSample_Pod const*      physx_PxHeightField_getSample(physx_PxHeightField_Pod const* self_, uint32_t row, uint32_t column);
...
uint32_t      physx_PxHeightField_getTimestamp(physx_PxHeightField_Pod const* self_);

char const*      physx_PxHeightField_getConcreteTypeName(physx_PxHeightField_Pod const* self_);

    /// Constructor sets to default.
physx_PxHeightFieldDesc_Pod      physx_PxHeightFieldDesc_new();

    /// (re)sets the structure to the default.
void      physx_PxHeightFieldDesc_setToDefault_mut(physx_PxHeightFieldDesc_Pod* self_);

    /// Returns true if the descriptor is valid.
    ///
    /// True if the current settings are valid.
bool      physx_PxHeightFieldDesc_isValid(physx_PxHeightFieldDesc_Pod const* self_);
...
void      physx_PxMeshQuery_getTriangle(physx_PxTriangleMeshGeometry_Pod const* triGeom, physx_PxTransform_Pod const* transform, uint32_t triangleIndex, physx_PxTriangle_Pod* triangle, uint32_t* vertexIndices, uint32_t* adjacencyIndices);
    ...
    /// }
    /// }
void      physx_PxMeshQuery_getTriangle_1(physx_PxHeightFieldGeometry_Pod const* hfGeom, physx_PxTransform_Pod const* transform, uint32_t triangleIndex, physx_PxTriangle_Pod* triangle, uint32_t* vertexIndices, uint32_t* adjacencyIndices);
...
uint32_t      physx_PxMeshQuery_findOverlapTriangleMesh(physx_PxGeometry_Pod const* geom, physx_PxTransform_Pod const* geomPose, physx_PxTriangleMeshGeometry_Pod const* meshGeom, physx_PxTransform_Pod const* meshPose, uint32_t* results, uint32_t maxResults, uint32_t startIndex, bool* overflow, uint32_t queryFlags);
    ...
    ///
    /// Number of overlaps found, i.e. number of elements written to the results buffer
uint32_t      physx_PxMeshQuery_findOverlapHeightField(physx_PxGeometry_Pod const* geom, physx_PxTransform_Pod const* geomPose, physx_PxHeightFieldGeometry_Pod const* hfGeom, physx_PxTransform_Pod const* hfPose, uint32_t* results, uint32_t maxResults, uint32_t startIndex, bool* overflow, uint32_t queryFlags);
...
bool      physx_PxMeshQuery_sweep(physx_PxVec3_Pod const* unitDir, float distance, physx_PxGeometry_Pod const* geom, physx_PxTransform_Pod const* pose, uint32_t triangleCount, physx_PxTriangle_Pod const* triangles, physx_PxGeomSweepHit_Pod* sweepHit, uint16_t hitFlags, uint32_t const* cachedIndex, float inflation, bool doubleSided, uint32_t queryFlags);

    /// constructor sets to default.
physx_PxSimpleTriangleMesh_Pod      physx_PxSimpleTriangleMesh_new();

    /// (re)sets the structure to the default.
void      physx_PxSimpleTriangleMesh_setToDefault_mut(physx_PxSimpleTriangleMesh_Pod* self_);

    /// returns true if the current settings are valid
bool      physx_PxSimpleTriangleMesh_isValid(physx_PxSimpleTriangleMesh_Pod const* self_);

    /// Constructor
physx_PxTriangle_Pod*      physx_PxTriangle_new_alloc();

    /// Constructor
physx_PxTriangle_Pod*      physx_PxTriangle_new_alloc_1(physx_PxVec3_Pod const* p0, physx_PxVec3_Pod const* p1, physx_PxVec3_Pod const* p2);

    /// Destructor
void      physx_PxTriangle_delete(physx_PxTriangle_Pod* self_);

    /// Compute the normal of the Triangle.
void      physx_PxTriangle_normal(physx_PxTriangle_Pod const* self_, physx_PxVec3_Pod* _normal);

    /// Compute the unnormalized normal of the triangle.
void      physx_PxTriangle_denormalizedNormal(physx_PxTriangle_Pod const* self_, physx_PxVec3_Pod* _normal);

    /// Compute the area of the triangle.
    ///
    /// Area of the triangle.
float      physx_PxTriangle_area(physx_PxTriangle_Pod const* self_);

    /// Computes a point on the triangle from u and v barycentric coordinates.
physx_PxVec3_Pod      physx_PxTriangle_pointFromUV(physx_PxTriangle_Pod const* self_, float u, float v);

physx_PxTrianglePadded_Pod*      physx_PxTrianglePadded_new_alloc();

void      physx_PxTrianglePadded_delete(physx_PxTrianglePadded_Pod* self_);

    /// Returns the number of vertices.
    ///
    /// number of vertices
uint32_t      physx_PxTriangleMesh_getNbVertices(physx_PxTriangleMesh_Pod const* self_);

    /// Returns the vertices.
    ///
    /// array of vertices
physx_PxVec3_Pod const*      physx_PxTriangleMesh_getVertices(physx_PxTriangleMesh_Pod const* self_);
...
physx_PxVec3_Pod*      physx_PxTriangleMesh_getVerticesForModification_mut(physx_PxTriangleMesh_Pod* self_);
...
physx_PxBounds3_Pod      physx_PxTriangleMesh_refitBVH_mut(physx_PxTriangleMesh_Pod* self_);

    /// Returns the number of triangles.
    ///
    /// number of triangles
uint32_t      physx_PxTriangleMesh_getNbTriangles(physx_PxTriangleMesh_Pod const* self_);
    ...
    ///
    /// array of triangles
void const*      physx_PxTriangleMesh_getTriangles(physx_PxTriangleMesh_Pod const* self_);
...
uint8_t      physx_PxTriangleMesh_getTriangleMeshFlags(physx_PxTriangleMesh_Pod const* self_);
...
uint32_t const*      physx_PxTriangleMesh_getTrianglesRemap(physx_PxTriangleMesh_Pod const* self_);

    /// Decrements the reference count of a triangle mesh and releases it if the new reference count is zero.
void      physx_PxTriangleMesh_release_mut(physx_PxTriangleMesh_Pod* self_);
    ...
    ///
    /// Material table index, or 0xffff if no per-triangle materials are used
uint16_t      physx_PxTriangleMesh_getTriangleMaterialIndex(physx_PxTriangleMesh_Pod const* self_, uint32_t triangleIndex);

    /// Returns the local-space (vertex space) AABB from the triangle mesh.
    ///
    /// local-space bounds
physx_PxBounds3_Pod      physx_PxTriangleMesh_getLocalBounds(physx_PxTriangleMesh_Pod const* self_);

    /// Returns the local-space Signed Distance Field for this mesh if it has one.
    ///
    /// local-space SDF.
float const*      physx_PxTriangleMesh_getSDF(physx_PxTriangleMesh_Pod const* self_);

    /// Returns the resolution of the local-space dense SDF.
void      physx_PxTriangleMesh_getSDFDimensions(physx_PxTriangleMesh_Pod const* self_, uint32_t* numX, uint32_t* numY, uint32_t* numZ);
...
void      physx_PxTriangleMesh_setPreferSDFProjection_mut(physx_PxTriangleMesh_Pod* self_, bool preferProjection);

    /// Returns whether this mesh prefers SDF projection.
    ///
    /// whether this mesh prefers SDF projection.
bool      physx_PxTriangleMesh_getPreferSDFProjection(physx_PxTriangleMesh_Pod const* self_);
    ...
    /// Similarly, to obtain the localInertia of an identically shaped object with a uniform density of d, simply multiply the
    /// localInertia of the unit density mesh by d.
void      physx_PxTriangleMesh_getMassInformation(physx_PxTriangleMesh_Pod const* self_, float* mass, physx_PxMat33_Pod* localInertia, physx_PxVec3_Pod* localCenterOfMass);

    /// Constructor
physx_PxTetrahedron_Pod*      physx_PxTetrahedron_new_alloc();

    /// Constructor
physx_PxTetrahedron_Pod*      physx_PxTetrahedron_new_alloc_1(physx_PxVec3_Pod const* p0, physx_PxVec3_Pod const* p1, physx_PxVec3_Pod const* p2, physx_PxVec3_Pod const* p3);

    /// Destructor
void      physx_PxTetrahedron_delete(physx_PxTetrahedron_Pod* self_);

    /// Decrements the reference count of a tetrahedron mesh and releases it if the new reference count is zero.
void      physx_PxSoftBodyAuxData_release_mut(physx_PxSoftBodyAuxData_Pod* self_);

    /// Returns the number of vertices.
    ///
    /// number of vertices
uint32_t      physx_PxTetrahedronMesh_getNbVertices(physx_PxTetrahedronMesh_Pod const* self_);

    /// Returns the vertices
    ///
    /// array of vertices
physx_PxVec3_Pod const*      physx_PxTetrahedronMesh_getVertices(physx_PxTetrahedronMesh_Pod const* self_);

    /// Returns the number of tetrahedrons.
    ///
    /// number of tetrahedrons
uint32_t      physx_PxTetrahedronMesh_getNbTetrahedrons(physx_PxTetrahedronMesh_Pod const* self_);
...
void const*      physx_PxTetrahedronMesh_getTetrahedrons(physx_PxTetrahedronMesh_Pod const* self_);
...
uint8_t      physx_PxTetrahedronMesh_getTetrahedronMeshFlags(physx_PxTetrahedronMesh_Pod const* self_);
    ...
    ///
    /// the remapping table (or NULL if 'PxCookingParams::suppressTriangleMeshRemapTable' has been used)
uint32_t const*      physx_PxTetrahedronMesh_getTetrahedraRemap(physx_PxTetrahedronMesh_Pod const* self_);

    /// Returns the local-space (vertex space) AABB from the tetrahedron mesh.
    ///
    /// local-space bounds
physx_PxBounds3_Pod      physx_PxTetrahedronMesh_getLocalBounds(physx_PxTetrahedronMesh_Pod const* self_);

    /// Decrements the reference count of a tetrahedron mesh and releases it if the new reference count is zero.
void      physx_PxTetrahedronMesh_release_mut(physx_PxTetrahedronMesh_Pod* self_);

    /// Const accecssor to the softbody's collision mesh.
physx_PxTetrahedronMesh_Pod const*      physx_PxSoftBodyMesh_getCollisionMesh(physx_PxSoftBodyMesh_Pod const* self_);

    /// Accecssor to the softbody's collision mesh.
physx_PxTetrahedronMesh_Pod*      physx_PxSoftBodyMesh_getCollisionMesh_mut(physx_PxSoftBodyMesh_Pod* self_);

    /// Const accessor to the softbody's simulation mesh.
physx_PxTetrahedronMesh_Pod const*      physx_PxSoftBodyMesh_getSimulationMesh(physx_PxSoftBodyMesh_Pod const* self_);

    /// Accecssor to the softbody's simulation mesh.
physx_PxTetrahedronMesh_Pod*      physx_PxSoftBodyMesh_getSimulationMesh_mut(physx_PxSoftBodyMesh_Pod* self_);

    /// Const accessor to the softbodies simulation state.
physx_PxSoftBodyAuxData_Pod const*      physx_PxSoftBodyMesh_getSoftBodyAuxData(physx_PxSoftBodyMesh_Pod const* self_);

    /// Accessor to the softbody's auxilary data like mass and rest pose information
physx_PxSoftBodyAuxData_Pod*      physx_PxSoftBodyMesh_getSoftBodyAuxData_mut(physx_PxSoftBodyMesh_Pod* self_);

    /// Decrements the reference count of a tetrahedron mesh and releases it if the new reference count is zero.
void      physx_PxSoftBodyMesh_release_mut(physx_PxSoftBodyMesh_Pod* self_);

void      physx_PxCollisionMeshMappingData_release_mut(physx_PxCollisionMeshMappingData_Pod* self_);

physx_PxTetrahedronMeshData_Pod const*      physx_PxCollisionTetrahedronMeshData_getMesh(physx_PxCollisionTetrahedronMeshData_Pod const* self_);

physx_PxTetrahedronMeshData_Pod*      physx_PxCollisionTetrahedronMeshData_getMesh_mut(physx_PxCollisionTetrahedronMeshData_Pod* self_);

physx_PxSoftBodyCollisionData_Pod const*      physx_PxCollisionTetrahedronMeshData_getData(physx_PxCollisionTetrahedronMeshData_Pod const* self_);

physx_PxSoftBodyCollisionData_Pod*      physx_PxCollisionTetrahedronMeshData_getData_mut(physx_PxCollisionTetrahedronMeshData_Pod* self_);

void      physx_PxCollisionTetrahedronMeshData_release_mut(physx_PxCollisionTetrahedronMeshData_Pod* self_);

physx_PxTetrahedronMeshData_Pod*      physx_PxSimulationTetrahedronMeshData_getMesh_mut(physx_PxSimulationTetrahedronMeshData_Pod* self_);

physx_PxSoftBodySimulationData_Pod*      physx_PxSimulationTetrahedronMeshData_getData_mut(physx_PxSimulationTetrahedronMeshData_Pod* self_);

void      physx_PxSimulationTetrahedronMeshData_release_mut(physx_PxSimulationTetrahedronMeshData_Pod* self_);
...
void      physx_PxActor_release_mut(physx_PxActor_Pod* self_);

    /// Retrieves the type of actor.
    ///
    /// The actor type of the actor.
int32_t      physx_PxActor_getType(physx_PxActor_Pod const* self_);

    /// Retrieves the scene which this actor belongs to.
    ///
    /// Owner Scene. NULL if not part of a scene.
physx_PxScene_Pod*      physx_PxActor_getScene(physx_PxActor_Pod const* self_);
    ...
    /// Default:
    /// NULL
void      physx_PxActor_setName_mut(physx_PxActor_Pod* self_, char const* name);

    /// Retrieves the name string set with setName().
    ///
    /// Name string associated with object.
char const*      physx_PxActor_getName(physx_PxActor_Pod const* self_);
...
physx_PxBounds3_Pod      physx_PxActor_getWorldBounds(physx_PxActor_Pod const* self_, float inflation);
...
void      physx_PxActor_setActorFlag_mut(physx_PxActor_Pod* self_, int32_t flag, bool value);

    /// Sets the actor flags.
    ///
    /// See the list of flags [`PxActorFlag`]
void      physx_PxActor_setActorFlags_mut(physx_PxActor_Pod* self_, uint8_t inFlags);
...
uint8_t      physx_PxActor_getActorFlags(physx_PxActor_Pod const* self_);
    ...
    /// NOT
    /// wake the actor up automatically.
void      physx_PxActor_setDominanceGroup_mut(physx_PxActor_Pod* self_, uint8_t dominanceGroup);

    /// Retrieves the value set with setDominanceGroup().
    ///
    /// The dominance group of this actor.
uint8_t      physx_PxActor_getDominanceGroup(physx_PxActor_Pod const* self_);
    ...
    /// Default:
    /// PX_DEFAULT_CLIENT
void      physx_PxActor_setOwnerClient_mut(physx_PxActor_Pod* self_, uint8_t inClient);

    /// Returns the owner client that was specified at creation time.
    ///
    /// This value cannot be changed once the object is placed into the scene.
uint8_t      physx_PxActor_getOwnerClient(physx_PxActor_Pod const* self_);
...
physx_PxAggregate_Pod*      physx_PxActor_getAggregate(physx_PxActor_Pod const* self_);
...
void      physx_PxAggregate_release_mut(physx_PxAggregate_Pod* self_);
...
bool      physx_PxAggregate_addActor_mut(physx_PxAggregate_Pod* self_, physx_PxActor_Pod* actor, physx_PxBVH_Pod const* bvh);
...
bool      physx_PxAggregate_removeActor_mut(physx_PxAggregate_Pod* self_, physx_PxActor_Pod* actor);
...
bool      physx_PxAggregate_addArticulation_mut(physx_PxAggregate_Pod* self_, physx_PxArticulationReducedCoordinate_Pod* articulation);
...
bool      physx_PxAggregate_removeArticulation_mut(physx_PxAggregate_Pod* self_, physx_PxArticulationReducedCoordinate_Pod* articulation);
...
uint32_t      physx_PxAggregate_getNbActors(physx_PxAggregate_Pod const* self_);

    /// Retrieves max amount of shapes that can be contained in the aggregate.
    ///
    /// Max shape size.
uint32_t      physx_PxAggregate_getMaxNbShapes(physx_PxAggregate_Pod const* self_);
...
uint32_t      physx_PxAggregate_getActors(physx_PxAggregate_Pod const* self_, physx_PxActor_Pod** userBuffer, uint32_t bufferSize, uint32_t startIndex);

    /// Retrieves the scene which this aggregate belongs to.
    ///
    /// Owner Scene. NULL if not part of a scene.
physx_PxScene_Pod*      physx_PxAggregate_getScene_mut(physx_PxAggregate_Pod* self_);

    /// Retrieves aggregate's self-collision flag.
    ///
    /// self-collision flag
bool      physx_PxAggregate_getSelfCollision(physx_PxAggregate_Pod const* self_);

char const*      physx_PxAggregate_getConcreteTypeName(physx_PxAggregate_Pod const* self_);
...
void      physx_PxConstraintVisualizer_visualizeJointFrames_mut(physx_PxConstraintVisualizer_Pod* self_, physx_PxTransform_Pod const* parent, physx_PxTransform_Pod const* child);

    /// Visualize joint linear limit
void      physx_PxConstraintVisualizer_visualizeLinearLimit_mut(physx_PxConstraintVisualizer_Pod* self_, physx_PxTransform_Pod const* t0, physx_PxTransform_Pod const* t1, float value, bool active);

    /// Visualize joint angular limit
void      physx_PxConstraintVisualizer_visualizeAngularLimit_mut(physx_PxConstraintVisualizer_Pod* self_, physx_PxTransform_Pod const* t0, float lower, float upper, bool active);

    /// Visualize limit cone
void      physx_PxConstraintVisualizer_visualizeLimitCone_mut(physx_PxConstraintVisualizer_Pod* self_, physx_PxTransform_Pod const* t, float tanQSwingY, float tanQSwingZ, bool active);

    /// Visualize joint double cone
void      physx_PxConstraintVisualizer_visualizeDoubleCone_mut(physx_PxConstraintVisualizer_Pod* self_, physx_PxTransform_Pod const* t, float angle, bool active);

    /// Visualize line
void      physx_PxConstraintVisualizer_visualizeLine_mut(physx_PxConstraintVisualizer_Pod* self_, physx_PxVec3_Pod const* p0, physx_PxVec3_Pod const* p1, uint32_t color);
...
void*      physx_PxConstraintConnector_prepareData_mut(physx_PxConstraintConnector_Pod* self_);
...
void      physx_PxConstraintConnector_onConstraintRelease_mut(physx_PxConstraintConnector_Pod* self_);
...
void      physx_PxConstraintConnector_onComShift_mut(physx_PxConstraintConnector_Pod* self_, uint32_t actor);
...
void      physx_PxConstraintConnector_onOriginShift_mut(physx_PxConstraintConnector_Pod* self_, physx_PxVec3_Pod const* shift);
...
physx_PxBase_Pod*      physx_PxConstraintConnector_getSerializable_mut(physx_PxConstraintConnector_Pod* self_);

    /// Obtain the pointer to the constraint's constant data
void const*      physx_PxConstraintConnector_getConstantBlock(physx_PxConstraintConnector_Pod const* self_);

    /// Let the connector know it has been connected to a constraint.
void      physx_PxConstraintConnector_connectToConstraint_mut(physx_PxConstraintConnector_Pod* self_, physx_PxConstraint_Pod* anon_param0);

    /// virtual destructor
void      physx_PxConstraintConnector_delete(physx_PxConstraintConnector_Pod* self_);

physx_PxSolverBody_Pod      physx_PxSolverBody_new();

float      physx_PxSolverBodyData_projectVelocity(physx_PxSolverBodyData_Pod const* self_, physx_PxVec3_Pod const* lin, physx_PxVec3_Pod const* ang);

void      physx_PxSolverConstraintPrepDesc_delete(physx_PxSolverConstraintPrepDesc_Pod* self_);
...
uint8_t*      physx_PxConstraintAllocator_reserveConstraintData_mut(physx_PxConstraintAllocator_Pod* self_, uint32_t byteSize);
...
uint8_t*      physx_PxConstraintAllocator_reserveFrictionData_mut(physx_PxConstraintAllocator_Pod* self_, uint32_t byteSize);

void      physx_PxConstraintAllocator_delete(physx_PxConstraintAllocator_Pod* self_);
...
physx_PxArticulationDrive_Pod      physx_PxArticulationDrive_new_1(float stiffness_, float damping_, float maxForce_, int32_t driveType_);

float      physx_PxTGSSolverBodyVel_projectVelocity(physx_PxTGSSolverBodyVel_Pod const* self_, physx_PxVec3_Pod const* lin, physx_PxVec3_Pod const* ang);

float      physx_PxTGSSolverBodyData_projectVelocity(physx_PxTGSSolverBodyData_Pod const* self_, physx_PxVec3_Pod const* linear, physx_PxVec3_Pod const* angular);

void      physx_PxTGSSolverConstraintPrepDesc_delete(physx_PxTGSSolverConstraintPrepDesc_Pod* self_);
...
void      physx_PxArticulationAttachment_setRestLength_mut(physx_PxArticulationAttachment_Pod* self_, float restLength);

    /// Gets the spring rest length for the sub-tendon from the root to this leaf attachment.
    ///
    /// The rest length.
float      physx_PxArticulationAttachment_getRestLength(physx_PxArticulationAttachment_Pod const* self_);

    /// Sets the low and high limit on the length of the sub-tendon from the root to this leaf attachment.
    ///
    /// Setting this on non-leaf attachments has no effect.
void      physx_PxArticulationAttachment_setLimitParameters_mut(physx_PxArticulationAttachment_Pod* self_, physx_PxArticulationTendonLimit_Pod const* parameters);
...
physx_PxArticulationTendonLimit_Pod      physx_PxArticulationAttachment_getLimitParameters(physx_PxArticulationAttachment_Pod const* self_);

    /// Sets the attachment's relative offset in the link actor frame.
void      physx_PxArticulationAttachment_setRelativeOffset_mut(physx_PxArticulationAttachment_Pod* self_, physx_PxVec3_Pod const* offset);

    /// Gets the attachment's relative offset in the link actor frame.
    ///
    /// The relative offset in the link actor frame.
physx_PxVec3_Pod      physx_PxArticulationAttachment_getRelativeOffset(physx_PxArticulationAttachment_Pod const* self_);

    /// Sets the attachment coefficient.
void      physx_PxArticulationAttachment_setCoefficient_mut(physx_PxArticulationAttachment_Pod* self_, float coefficient);
...
float      physx_PxArticulationAttachment_getCoefficient(physx_PxArticulationAttachment_Pod const* self_);

    /// Gets the articulation link.
    ///
    /// The articulation link that this attachment is attached to.
physx_PxArticulationLink_Pod*      physx_PxArticulationAttachment_getLink(physx_PxArticulationAttachment_Pod const* self_);

    /// Gets the parent attachment.
    ///
    /// The parent attachment.
physx_PxArticulationAttachment_Pod*      physx_PxArticulationAttachment_getParent(physx_PxArticulationAttachment_Pod const* self_);
...
bool      physx_PxArticulationAttachment_isLeaf(physx_PxArticulationAttachment_Pod const* self_);

    /// Gets the spatial tendon that the attachment is a part of.
    ///
    /// The tendon.
physx_PxArticulationSpatialTendon_Pod*      physx_PxArticulationAttachment_getTendon(physx_PxArticulationAttachment_Pod const* self_);
...
void      physx_PxArticulationAttachment_release_mut(physx_PxArticulationAttachment_Pod* self_);

    /// Returns the string name of the dynamic type.
    ///
    /// The string name.
char const*      physx_PxArticulationAttachment_getConcreteTypeName(physx_PxArticulationAttachment_Pod const* self_);
...
void      physx_PxArticulationTendonJoint_setCoefficient_mut(physx_PxArticulationTendonJoint_Pod* self_, int32_t axis, float coefficient, float recipCoefficient);

    /// Gets the tendon joint coefficient.
void      physx_PxArticulationTendonJoint_getCoefficient(physx_PxArticulationTendonJoint_Pod const* self_, int32_t* axis, float* coefficient, float* recipCoefficient);

    /// Gets the articulation link.
    ///
    /// The articulation link (and its incoming joint in particular) that this tendon joint is associated with.
physx_PxArticulationLink_Pod*      physx_PxArticulationTendonJoint_getLink(physx_PxArticulationTendonJoint_Pod const* self_);

    /// Gets the parent tendon joint.
    ///
    /// The parent tendon joint.
physx_PxArticulationTendonJoint_Pod*      physx_PxArticulationTendonJoint_getParent(physx_PxArticulationTendonJoint_Pod const* self_);

    /// Gets the tendon that the joint is a part of.
    ///
    /// The tendon.
physx_PxArticulationFixedTendon_Pod*      physx_PxArticulationTendonJoint_getTendon(physx_PxArticulationTendonJoint_Pod const* self_);
...
void      physx_PxArticulationTendonJoint_release_mut(physx_PxArticulationTendonJoint_Pod* self_);

    /// Returns the string name of the dynamic type.
    ///
    /// The string name.
char const*      physx_PxArticulationTendonJoint_getConcreteTypeName(physx_PxArticulationTendonJoint_Pod const* self_);

    /// Sets the spring stiffness term acting on the tendon length.
void      physx_PxArticulationTendon_setStiffness_mut(physx_PxArticulationTendon_Pod* self_, float stiffness);

    /// Gets the spring stiffness of the tendon.
    ///
    /// The spring stiffness.
float      physx_PxArticulationTendon_getStiffness(physx_PxArticulationTendon_Pod const* self_);

    /// Sets the damping term acting both on the tendon length and tendon-length limits.
void      physx_PxArticulationTendon_setDamping_mut(physx_PxArticulationTendon_Pod* self_, float damping);

    /// Gets the damping term acting both on the tendon length and tendon-length limits.
    ///
    /// The damping term.
float      physx_PxArticulationTendon_getDamping(physx_PxArticulationTendon_Pod const* self_);
...
void      physx_PxArticulationTendon_setLimitStiffness_mut(physx_PxArticulationTendon_Pod* self_, float stiffness);
...
float      physx_PxArticulationTendon_getLimitStiffness(physx_PxArticulationTendon_Pod const* self_);
...
void      physx_PxArticulationTendon_setOffset_mut(physx_PxArticulationTendon_Pod* self_, float offset, bool autowake);

    /// Gets the length offset term for the tendon.
    ///
    /// The offset term.
float      physx_PxArticulationTendon_getOffset(physx_PxArticulationTendon_Pod const* self_);

    /// Gets the articulation that the tendon is a part of.
    ///
    /// The articulation.
physx_PxArticulationReducedCoordinate_Pod*      physx_PxArticulationTendon_getArticulation(physx_PxArticulationTendon_Pod const* self_);
...
void      physx_PxArticulationTendon_release_mut(physx_PxArticulationTendon_Pod* self_);
...
physx_PxArticulationAttachment_Pod*      physx_PxArticulationSpatialTendon_createAttachment_mut(physx_PxArticulationSpatialTendon_Pod* self_, physx_PxArticulationAttachment_Pod* parent, float coefficient, physx_PxVec3_Pod relativeOffset, physx_PxArticulationLink_Pod* link);
...
uint32_t      physx_PxArticulationSpatialTendon_getAttachments(physx_PxArticulationSpatialTendon_Pod const* self_, physx_PxArticulationAttachment_Pod** userBuffer, uint32_t bufferSize, uint32_t startIndex);

    /// Returns the number of attachments in the tendon.
    ///
    /// The number of attachments.
uint32_t      physx_PxArticulationSpatialTendon_getNbAttachments(physx_PxArticulationSpatialTendon_Pod const* self_);

    /// Returns the string name of the dynamic type.
    ///
    /// The string name.
char const*      physx_PxArticulationSpatialTendon_getConcreteTypeName(physx_PxArticulationSpatialTendon_Pod const* self_);
...
physx_PxArticulationTendonJoint_Pod*      physx_PxArticulationFixedTendon_createTendonJoint_mut(physx_PxArticulationFixedTendon_Pod* self_, physx_PxArticulationTendonJoint_Pod* parent, int32_t axis, float coefficient, float recipCoefficient, physx_PxArticulationLink_Pod* link);
...
uint32_t      physx_PxArticulationFixedTendon_getTendonJoints(physx_PxArticulationFixedTendon_Pod const* self_, physx_PxArticulationTendonJoint_Pod** userBuffer, uint32_t bufferSize, uint32_t startIndex);

    /// Returns the number of tendon joints in the tendon.
    ///
    /// The number of tendon joints.
uint32_t      physx_PxArticulationFixedTendon_getNbTendonJoints(physx_PxArticulationFixedTendon_Pod const* self_);
...
void      physx_PxArticulationFixedTendon_setRestLength_mut(physx_PxArticulationFixedTendon_Pod* self_, float restLength);

    /// Gets the spring rest length of the tendon.
    ///
    /// The spring rest length of the tendon.
float      physx_PxArticulationFixedTendon_getRestLength(physx_PxArticulationFixedTendon_Pod const* self_);
...
void      physx_PxArticulationFixedTendon_setLimitParameters_mut(physx_PxArticulationFixedTendon_Pod* self_, physx_PxArticulationTendonLimit_Pod const* parameter);

    /// Gets the low and high limit on the length of the tendon.
    ///
    /// Struct with the low and high limit.
physx_PxArticulationTendonLimit_Pod      physx_PxArticulationFixedTendon_getLimitParameters(physx_PxArticulationFixedTendon_Pod const* self_);

    /// Returns the string name of the dynamic type.
    ///
    /// The string name.
char const*      physx_PxArticulationFixedTendon_getConcreteTypeName(physx_PxArticulationFixedTendon_Pod const* self_);

physx_PxArticulationCache_Pod      physx_PxArticulationCache_new();

    /// Releases an articulation cache.
void      physx_PxArticulationCache_release_mut(physx_PxArticulationCache_Pod* self_);
...
void      physx_PxArticulationSensor_release_mut(physx_PxArticulationSensor_Pod* self_);
...
physx_PxSpatialForce_Pod      physx_PxArticulationSensor_getForces(physx_PxArticulationSensor_Pod const* self_);
...
physx_PxTransform_Pod      physx_PxArticulationSensor_getRelativePose(physx_PxArticulationSensor_Pod const* self_);
...
void      physx_PxArticulationSensor_setRelativePose_mut(physx_PxArticulationSensor_Pod* self_, physx_PxTransform_Pod const* pose);

    /// Returns the link that this sensor is attached to.
    ///
    /// A pointer to the link.
physx_PxArticulationLink_Pod*      physx_PxArticulationSensor_getLink(physx_PxArticulationSensor_Pod const* self_);
...
uint32_t      physx_PxArticulationSensor_getIndex(physx_PxArticulationSensor_Pod const* self_);

    /// Returns the articulation that this sensor is part of.
    ///
    /// A pointer to the articulation.
physx_PxArticulationReducedCoordinate_Pod*      physx_PxArticulationSensor_getArticulation(physx_PxArticulationSensor_Pod const* self_);

    /// Returns the sensor's flags.
    ///
    /// The current set of flags of the sensor.
uint8_t      physx_PxArticulationSensor_getFlags(physx_PxArticulationSensor_Pod const* self_);
...
void      physx_PxArticulationSensor_setFlag_mut(physx_PxArticulationSensor_Pod* self_, int32_t flag, bool enabled);

    /// Returns the string name of the dynamic type.
    ///
    /// The string name.
char const*      physx_PxArticulationSensor_getConcreteTypeName(physx_PxArticulationSensor_Pod const* self_);

    /// Returns the scene which this articulation belongs to.
    ///
    /// Owner Scene. NULL if not part of a scene.
physx_PxScene_Pod*      physx_PxArticulationReducedCoordinate_getScene(physx_PxArticulationReducedCoordinate_Pod const* self_);
...
void      physx_PxArticulationReducedCoordinate_setSolverIterationCounts_mut(physx_PxArticulationReducedCoordinate_Pod* self_, uint32_t minPositionIters, uint32_t minVelocityIters);

    /// Returns the solver iteration counts.
void      physx_PxArticulationReducedCoordinate_getSolverIterationCounts(physx_PxArticulationReducedCoordinate_Pod const* self_, uint32_t* minPositionIters, uint32_t* minVelocityIters);
...
bool      physx_PxArticulationReducedCoordinate_isSleeping(physx_PxArticulationReducedCoordinate_Pod const* self_);
    ...
    ///
    /// This call may not be made during simulation.
void      physx_PxArticulationReducedCoordinate_setSleepThreshold_mut(physx_PxArticulationReducedCoordinate_Pod* self_, float threshold);

    /// Returns the mass-normalized energy below which the articulation may go to sleep.
    ///
    /// The energy threshold for sleeping.
float      physx_PxArticulationReducedCoordinate_getSleepThreshold(physx_PxArticulationReducedCoordinate_Pod const* self_);
    ...
    ///
    /// This call may not be made during simulation.
void      physx_PxArticulationReducedCoordinate_setStabilizationThreshold_mut(physx_PxArticulationReducedCoordinate_Pod* self_, float threshold);
...
float      physx_PxArticulationReducedCoordinate_getStabilizationThreshold(physx_PxArticulationReducedCoordinate_Pod const* self_);
...
void      physx_PxArticulationReducedCoordinate_setWakeCounter_mut(physx_PxArticulationReducedCoordinate_Pod* self_, float wakeCounterValue);
    ...
    ///
    /// This call may not be made during simulation, except in a split simulation in-between [`PxScene::fetchCollision`] and #PxScene::advance.
float      physx_PxArticulationReducedCoordinate_getWakeCounter(physx_PxArticulationReducedCoordinate_Pod const* self_);
    ...
    /// This call may only be made on articulations that are in a scene, and may not be made during simulation,
    /// except in a split simulation in-between [`PxScene::fetchCollision`] and #PxScene::advance.
void      physx_PxArticulationReducedCoordinate_wakeUp_mut(physx_PxArticulationReducedCoordinate_Pod* self_);
...
void      physx_PxArticulationReducedCoordinate_putToSleep_mut(physx_PxArticulationReducedCoordinate_Pod* self_);
    ...
    ///
    /// This call may not be made during simulation.
void      physx_PxArticulationReducedCoordinate_setMaxCOMLinearVelocity_mut(physx_PxArticulationReducedCoordinate_Pod* self_, float maxLinearVelocity);
...
float      physx_PxArticulationReducedCoordinate_getMaxCOMLinearVelocity(physx_PxArticulationReducedCoordinate_Pod const* self_);
    ...
    ///
    /// This call may not be made during simulation.
void      physx_PxArticulationReducedCoordinate_setMaxCOMAngularVelocity_mut(physx_PxArticulationReducedCoordinate_Pod* self_, float maxAngularVelocity);
...
float      physx_PxArticulationReducedCoordinate_getMaxCOMAngularVelocity(physx_PxArticulationReducedCoordinate_Pod const* self_);
...
physx_PxArticulationLink_Pod*      physx_PxArticulationReducedCoordinate_createLink_mut(physx_PxArticulationReducedCoordinate_Pod* self_, physx_PxArticulationLink_Pod* parent, physx_PxTransform_Pod const* pose);
    ...
    ///
    /// This call may not be made during simulation.
void      physx_PxArticulationReducedCoordinate_release_mut(physx_PxArticulationReducedCoordinate_Pod* self_);

    /// Returns the number of links in the articulation.
    ///
    /// The number of links.
uint32_t      physx_PxArticulationReducedCoordinate_getNbLinks(physx_PxArticulationReducedCoordinate_Pod const* self_);
...
uint32_t      physx_PxArticulationReducedCoordinate_getLinks(physx_PxArticulationReducedCoordinate_Pod const* self_, physx_PxArticulationLink_Pod** userBuffer, uint32_t bufferSize, uint32_t startIndex);

    /// Returns the number of shapes in the articulation.
    ///
    /// The number of shapes.
uint32_t      physx_PxArticulationReducedCoordinate_getNbShapes(physx_PxArticulationReducedCoordinate_Pod const* self_);

    /// Sets a name string for the articulation that can be retrieved with getName().
    ///
    /// This is for debugging and is not used by the SDK. The string is not copied by the SDK,
    /// only the pointer is stored.
void      physx_PxArticulationReducedCoordinate_setName_mut(physx_PxArticulationReducedCoordinate_Pod* self_, char const* name);

    /// Returns the name string set with setName().
    ///
    /// Name string associated with the articulation.
char const*      physx_PxArticulationReducedCoordinate_getName(physx_PxArticulationReducedCoordinate_Pod const* self_);
...
physx_PxBounds3_Pod      physx_PxArticulationReducedCoordinate_getWorldBounds(physx_PxArticulationReducedCoordinate_Pod const* self_, float inflation);
...
physx_PxAggregate_Pod*      physx_PxArticulationReducedCoordinate_getAggregate(physx_PxArticulationReducedCoordinate_Pod const* self_);

    /// Sets flags on the articulation.
    ///
    /// This call may not be made during simulation.
void      physx_PxArticulationReducedCoordinate_setArticulationFlags_mut(physx_PxArticulationReducedCoordinate_Pod* self_, uint8_t flags);

    /// Raises or clears a flag on the articulation.
    ///
    /// This call may not be made during simulation.
void      physx_PxArticulationReducedCoordinate_setArticulationFlag_mut(physx_PxArticulationReducedCoordinate_Pod* self_, int32_t flag, bool value);

    /// Returns the articulation's flags.
    ///
    /// The flags.
uint8_t      physx_PxArticulationReducedCoordinate_getArticulationFlags(physx_PxArticulationReducedCoordinate_Pod const* self_);
...
uint32_t      physx_PxArticulationReducedCoordinate_getDofs(physx_PxArticulationReducedCoordinate_Pod const* self_);
...
physx_PxArticulationCache_Pod*      physx_PxArticulationReducedCoordinate_createCache(physx_PxArticulationReducedCoordinate_Pod const* self_);
...
uint32_t      physx_PxArticulationReducedCoordinate_getCacheDataSize(physx_PxArticulationReducedCoordinate_Pod const* self_);
...
void      physx_PxArticulationReducedCoordinate_zeroCache(physx_PxArticulationReducedCoordinate_Pod const* self_, physx_PxArticulationCache_Pod* cache);
    ...
    ///
    /// This call may only be made on articulations that are in a scene, and may not be made during simulation.
void      physx_PxArticulationReducedCoordinate_applyCache_mut(physx_PxArticulationReducedCoordinate_Pod* self_, physx_PxArticulationCache_Pod* cache, uint32_t flags, bool autowake);

    /// Copies internal data of the articulation to the cache.
    ///
    /// This call may only be made on articulations that are in a scene, and may not be made during simulation.
void      physx_PxArticulationReducedCoordinate_copyInternalStateToCache(physx_PxArticulationReducedCoordinate_Pod const* self_, physx_PxArticulationCache_Pod* cache, uint32_t flags);
...
void      physx_PxArticulationReducedCoordinate_packJointData(physx_PxArticulationReducedCoordinate_Pod const* self_, float const* maximum, float* reduced);
    ...
    ///
    /// The articulation must be in a scene.
void      physx_PxArticulationReducedCoordinate_unpackJointData(physx_PxArticulationReducedCoordinate_Pod const* self_, float const* reduced, float* maximum);
    ...
    ///
    /// This call may only be made on articulations that are in a scene, and may not be made during simulation.
void      physx_PxArticulationReducedCoordinate_commonInit(physx_PxArticulationReducedCoordinate_Pod const* self_);
    ...
    ///
    /// This call may only be made on articulations that are in a scene, and may not be made during simulation.
void      physx_PxArticulationReducedCoordinate_computeGeneralizedGravityForce(physx_PxArticulationReducedCoordinate_Pod const* self_, physx_PxArticulationCache_Pod* cache);
    ...
    ///
    /// This call may only be made on articulations that are in a scene, and may not be made during simulation.
void      physx_PxArticulationReducedCoordinate_computeCoriolisAndCentrifugalForce(physx_PxArticulationReducedCoordinate_Pod const* self_, physx_PxArticulationCache_Pod* cache);
    ...
    ///
    /// This call may only be made on articulations that are in a scene, and may not be made during simulation.
void      physx_PxArticulationReducedCoordinate_computeGeneralizedExternalForce(physx_PxArticulationReducedCoordinate_Pod const* self_, physx_PxArticulationCache_Pod* cache);
    ...
    ///
    /// This call may only be made on articulations that are in a scene, and may not be made during simulation.
void      physx_PxArticulationReducedCoordinate_computeJointAcceleration(physx_PxArticulationReducedCoordinate_Pod const* self_, physx_PxArticulationCache_Pod* cache);
    ...
    ///
    /// This call may only be made on articulations that are in a scene, and may not be made during simulation.
void      physx_PxArticulationReducedCoordinate_computeJointForce(physx_PxArticulationReducedCoordinate_Pod const* self_, physx_PxArticulationCache_Pod* cache);
    ...
    ///
    /// This call may only be made on articulations that are in a scene, and may not be made during simulation.
void      physx_PxArticulationReducedCoordinate_computeDenseJacobian(physx_PxArticulationReducedCoordinate_Pod const* self_, physx_PxArticulationCache_Pod* cache, uint32_t* nRows, uint32_t* nCols);
    ...
    ///
    /// This call may only be made on articulations that are in a scene, and may not be made during simulation.
void      physx_PxArticulationReducedCoordinate_computeCoefficientMatrix(physx_PxArticulationReducedCoordinate_Pod const* self_, physx_PxArticulationCache_Pod* cache);
    ...
    ///
    /// This call may only be made on articulations that are in a scene, and may not be made during simulation.
bool      physx_PxArticulationReducedCoordinate_computeLambda(physx_PxArticulationReducedCoordinate_Pod const* self_, physx_PxArticulationCache_Pod* cache, physx_PxArticulationCache_Pod* initialState, float const*const jointTorque, uint32_t maxIter);
    ...
    ///
    /// This call may only be made on articulations that are in a scene, and may not be made during simulation.
void      physx_PxArticulationReducedCoordinate_computeGeneralizedMassMatrix(physx_PxArticulationReducedCoordinate_Pod const* self_, physx_PxArticulationCache_Pod* cache);

    /// Adds a loop joint to the articulation system for inverse dynamics.
    ///
    /// This call may not be made during simulation.
void      physx_PxArticulationReducedCoordinate_addLoopJoint_mut(physx_PxArticulationReducedCoordinate_Pod* self_, physx_PxConstraint_Pod* joint);

    /// Removes a loop joint from the articulation for inverse dynamics.
    ///
    /// This call may not be made during simulation.
void      physx_PxArticulationReducedCoordinate_removeLoopJoint_mut(physx_PxArticulationReducedCoordinate_Pod* self_, physx_PxConstraint_Pod* joint);

    /// Returns the number of loop joints in the articulation for inverse dynamics.
    ///
    /// The number of loop joints.
uint32_t      physx_PxArticulationReducedCoordinate_getNbLoopJoints(physx_PxArticulationReducedCoordinate_Pod const* self_);

    /// Returns the set of loop constraints (i.e. joints) in the articulation.
    ///
    /// The number of constraints written into the buffer.
uint32_t      physx_PxArticulationReducedCoordinate_getLoopJoints(physx_PxArticulationReducedCoordinate_Pod const* self_, physx_PxConstraint_Pod** userBuffer, uint32_t bufferSize, uint32_t startIndex);
    ...
    ///
    /// This call may only be made on articulations that are in a scene.
uint32_t      physx_PxArticulationReducedCoordinate_getCoefficientMatrixSize(physx_PxArticulationReducedCoordinate_Pod const* self_);
    ...
    ///
    /// This call may not be made during simulation.
void      physx_PxArticulationReducedCoordinate_setRootGlobalPose_mut(physx_PxArticulationReducedCoordinate_Pod* self_, physx_PxTransform_Pod const* pose, bool autowake);
    ...
    /// This call is not allowed while the simulation is running except in a split simulation during [`PxScene::collide`]() and up to #PxScene::advance(),
    /// and in PxContactModifyCallback or in contact report callbacks.
physx_PxTransform_Pod      physx_PxArticulationReducedCoordinate_getRootGlobalPose(physx_PxArticulationReducedCoordinate_Pod const* self_);
    ...
    ///
    /// This call may not be made during simulation, except in a split simulation in-between [`PxScene::fetchCollision`] and #PxScene::advance.
void      physx_PxArticulationReducedCoordinate_setRootLinearVelocity_mut(physx_PxArticulationReducedCoordinate_Pod* self_, physx_PxVec3_Pod const* linearVelocity, bool autowake);
    ...
    /// This call is not allowed while the simulation is running except in a split simulation during [`PxScene::collide`]() and up to #PxScene::advance(),
    /// and in PxContactModifyCallback or in contact report callbacks.
physx_PxVec3_Pod      physx_PxArticulationReducedCoordinate_getRootLinearVelocity(physx_PxArticulationReducedCoordinate_Pod const* self_);
    ...
    ///
    /// This call may not be made during simulation, except in a split simulation in-between [`PxScene::fetchCollision`] and #PxScene::advance.
void      physx_PxArticulationReducedCoordinate_setRootAngularVelocity_mut(physx_PxArticulationReducedCoordinate_Pod* self_, physx_PxVec3_Pod const* angularVelocity, bool autowake);
    ...
    /// This call is not allowed while the simulation is running except in a split simulation during [`PxScene::collide`]() and up to #PxScene::advance(),
    /// and in PxContactModifyCallback or in contact report callbacks.
physx_PxVec3_Pod      physx_PxArticulationReducedCoordinate_getRootAngularVelocity(physx_PxArticulationReducedCoordinate_Pod const* self_);
...
physx_PxSpatialVelocity_Pod      physx_PxArticulationReducedCoordinate_getLinkAcceleration_mut(physx_PxArticulationReducedCoordinate_Pod* self_, uint32_t linkId);
...
uint32_t      physx_PxArticulationReducedCoordinate_getGpuArticulationIndex_mut(physx_PxArticulationReducedCoordinate_Pod* self_);
...
physx_PxArticulationSpatialTendon_Pod*      physx_PxArticulationReducedCoordinate_createSpatialTendon_mut(physx_PxArticulationReducedCoordinate_Pod* self_);
    ...
    /// add the tendon, remove and then re-add the articulation to the scene.
physx_PxArticulationFixedTendon_Pod*      physx_PxArticulationReducedCoordinate_createFixedTendon_mut(physx_PxArticulationReducedCoordinate_Pod* self_);
...
physx_PxArticulationSensor_Pod*      physx_PxArticulationReducedCoordinate_createSensor_mut(physx_PxArticulationReducedCoordinate_Pod* self_, physx_PxArticulationLink_Pod* link, physx_PxTransform_Pod const* relativePose);
...
uint32_t      physx_PxArticulationReducedCoordinate_getSpatialTendons(physx_PxArticulationReducedCoordinate_Pod const* self_, physx_PxArticulationSpatialTendon_Pod** userBuffer, uint32_t bufferSize, uint32_t startIndex);

    /// Returns the number of spatial tendons in the articulation.
    ///
    /// The number of tendons.
uint32_t      physx_PxArticulationReducedCoordinate_getNbSpatialTendons_mut(physx_PxArticulationReducedCoordinate_Pod* self_);
    ...
    ///
    /// The number of tendons written into the buffer.
uint32_t      physx_PxArticulationReducedCoordinate_getFixedTendons(physx_PxArticulationReducedCoordinate_Pod const* self_, physx_PxArticulationFixedTendon_Pod** userBuffer, uint32_t bufferSize, uint32_t startIndex);

    /// Returns the number of fixed tendons in the articulation.
    ///
    /// The number of tendons.
uint32_t      physx_PxArticulationReducedCoordinate_getNbFixedTendons_mut(physx_PxArticulationReducedCoordinate_Pod* self_);
...
uint32_t      physx_PxArticulationReducedCoordinate_getSensors(physx_PxArticulationReducedCoordinate_Pod const* self_, physx_PxArticulationSensor_Pod** userBuffer, uint32_t bufferSize, uint32_t startIndex);

    /// Returns the number of sensors in the articulation.
    ///
    /// The number of sensors.
uint32_t      physx_PxArticulationReducedCoordinate_getNbSensors_mut(physx_PxArticulationReducedCoordinate_Pod* self_);
    ...
    ///
    /// This call may only be made on articulations that are in a scene, and may not be made during simulation.
void      physx_PxArticulationReducedCoordinate_updateKinematic_mut(physx_PxArticulationReducedCoordinate_Pod* self_, uint8_t flags);

    /// Gets the parent articulation link of this joint.
    ///
    /// The parent link.
physx_PxArticulationLink_Pod*      physx_PxArticulationJointReducedCoordinate_getParentArticulationLink(physx_PxArticulationJointReducedCoordinate_Pod const* self_);

    /// Sets the joint pose in the parent link actor frame.
    ///
    /// This call is not allowed while the simulation is running.
void      physx_PxArticulationJointReducedCoordinate_setParentPose_mut(physx_PxArticulationJointReducedCoordinate_Pod* self_, physx_PxTransform_Pod const* pose);

    /// Gets the joint pose in the parent link actor frame.
    ///
    /// The joint pose.
physx_PxTransform_Pod      physx_PxArticulationJointReducedCoordinate_getParentPose(physx_PxArticulationJointReducedCoordinate_Pod const* self_);

    /// Gets the child articulation link of this joint.
    ///
    /// The child link.
physx_PxArticulationLink_Pod*      physx_PxArticulationJointReducedCoordinate_getChildArticulationLink(physx_PxArticulationJointReducedCoordinate_Pod const* self_);

    /// Sets the joint pose in the child link actor frame.
    ///
    /// This call is not allowed while the simulation is running.
void      physx_PxArticulationJointReducedCoordinate_setChildPose_mut(physx_PxArticulationJointReducedCoordinate_Pod* self_, physx_PxTransform_Pod const* pose);

    /// Gets the joint pose in the child link actor frame.
    ///
    /// The joint pose.
physx_PxTransform_Pod      physx_PxArticulationJointReducedCoordinate_getChildPose(physx_PxArticulationJointReducedCoordinate_Pod const* self_);
...
void      physx_PxArticulationJointReducedCoordinate_setJointType_mut(physx_PxArticulationJointReducedCoordinate_Pod* self_, int32_t jointType);

    /// Gets the joint type.
    ///
    /// The joint type.
int32_t      physx_PxArticulationJointReducedCoordinate_getJointType(physx_PxArticulationJointReducedCoordinate_Pod const* self_);
...
void      physx_PxArticulationJointReducedCoordinate_setMotion_mut(physx_PxArticulationJointReducedCoordinate_Pod* self_, int32_t axis, int32_t motion);

    /// Returns the joint motion for the given axis.
    ///
    /// The joint motion of the given axis.
int32_t      physx_PxArticulationJointReducedCoordinate_getMotion(physx_PxArticulationJointReducedCoordinate_Pod const* self_, int32_t axis);
...
void      physx_PxArticulationJointReducedCoordinate_setLimitParams_mut(physx_PxArticulationJointReducedCoordinate_Pod* self_, int32_t axis, physx_PxArticulationLimit_Pod const* limit);

    /// Returns the joint limits for a given axis.
    ///
    /// The joint limits.
physx_PxArticulationLimit_Pod      physx_PxArticulationJointReducedCoordinate_getLimitParams(physx_PxArticulationJointReducedCoordinate_Pod const* self_, int32_t axis);
    ...
    ///
    /// This call is not allowed while the simulation is running.
void      physx_PxArticulationJointReducedCoordinate_setDriveParams_mut(physx_PxArticulationJointReducedCoordinate_Pod* self_, int32_t axis, physx_PxArticulationDrive_Pod const* drive);

    /// Gets the joint drive configuration for the given axis.
    ///
    /// The drive parameters.
physx_PxArticulationDrive_Pod      physx_PxArticulationJointReducedCoordinate_getDriveParams(physx_PxArticulationJointReducedCoordinate_Pod const* self_, int32_t axis);
...
void      physx_PxArticulationJointReducedCoordinate_setDriveTarget_mut(physx_PxArticulationJointReducedCoordinate_Pod* self_, int32_t axis, float target, bool autowake);

    /// Returns the joint drive position target for the given axis.
    ///
    /// The target position.
float      physx_PxArticulationJointReducedCoordinate_getDriveTarget(physx_PxArticulationJointReducedCoordinate_Pod const* self_, int32_t axis);
    ...
    ///
    /// This call is not allowed while the simulation is running.
void      physx_PxArticulationJointReducedCoordinate_setDriveVelocity_mut(physx_PxArticulationJointReducedCoordinate_Pod* self_, int32_t axis, float targetVel, bool autowake);

    /// Returns the joint drive velocity target for the given axis.
    ///
    /// The target velocity.
float      physx_PxArticulationJointReducedCoordinate_getDriveVelocity(physx_PxArticulationJointReducedCoordinate_Pod const* self_, int32_t axis);
    ...
    ///
    /// This call is not allowed while the simulation is running.
void      physx_PxArticulationJointReducedCoordinate_setArmature_mut(physx_PxArticulationJointReducedCoordinate_Pod* self_, int32_t axis, float armature);

    /// Gets the joint armature for the given axis.
    ///
    /// The armature set on the given axis.
float      physx_PxArticulationJointReducedCoordinate_getArmature(physx_PxArticulationJointReducedCoordinate_Pod const* self_, int32_t axis);
    ...
    ///
    /// This call is not allowed while the simulation is running.
void      physx_PxArticulationJointReducedCoordinate_setFrictionCoefficient_mut(physx_PxArticulationJointReducedCoordinate_Pod* self_, float coefficient);

    /// Gets the joint friction coefficient.
    ///
    /// The joint friction coefficient.
float      physx_PxArticulationJointReducedCoordinate_getFrictionCoefficient(physx_PxArticulationJointReducedCoordinate_Pod const* self_);
    ...
    ///
    /// This call is not allowed while the simulation is running.
void      physx_PxArticulationJointReducedCoordinate_setMaxJointVelocity_mut(physx_PxArticulationJointReducedCoordinate_Pod* self_, float maxJointV);

    /// Gets the maximal joint velocity enforced for all axes.
    ///
    /// The maximal per-axis joint velocity.
float      physx_PxArticulationJointReducedCoordinate_getMaxJointVelocity(physx_PxArticulationJointReducedCoordinate_Pod const* self_);
...
void      physx_PxArticulationJointReducedCoordinate_setJointPosition_mut(physx_PxArticulationJointReducedCoordinate_Pod* self_, int32_t axis, float jointPos);
    ...
    /// This call is not allowed while the simulation is running except in a split simulation during [`PxScene::collide`]() and up to #PxScene::advance(),
    /// and in PxContactModifyCallback or in contact report callbacks.
float      physx_PxArticulationJointReducedCoordinate_getJointPosition(physx_PxArticulationJointReducedCoordinate_Pod const* self_, int32_t axis);
    ...
    ///
    /// This call is not allowed while the simulation is running.
void      physx_PxArticulationJointReducedCoordinate_setJointVelocity_mut(physx_PxArticulationJointReducedCoordinate_Pod* self_, int32_t axis, float jointVel);
    ...
    /// This call is not allowed while the simulation is running except in a split simulation during [`PxScene::collide`]() and up to #PxScene::advance(),
    /// and in PxContactModifyCallback or in contact report callbacks.
float      physx_PxArticulationJointReducedCoordinate_getJointVelocity(physx_PxArticulationJointReducedCoordinate_Pod const* self_, int32_t axis);

    /// Returns the string name of the dynamic type.
    ///
    /// The string name.
char const*      physx_PxArticulationJointReducedCoordinate_getConcreteTypeName(physx_PxArticulationJointReducedCoordinate_Pod const* self_);
...
void      physx_PxShape_release_mut(physx_PxShape_Pod* self_);
...
void      physx_PxShape_setGeometry_mut(physx_PxShape_Pod* self_, physx_PxGeometry_Pod const* geometry);
...
physx_PxGeometry_Pod const*      physx_PxShape_getGeometry(physx_PxShape_Pod const* self_);

    /// Retrieves the actor which this shape is associated with.
    ///
    /// The actor this shape is associated with, if it is an exclusive shape, else NULL
physx_PxRigidActor_Pod*      physx_PxShape_getActor(physx_PxShape_Pod const* self_);
...
void      physx_PxShape_setLocalPose_mut(physx_PxShape_Pod* self_, physx_PxTransform_Pod const* pose);
...
physx_PxTransform_Pod      physx_PxShape_getLocalPose(physx_PxShape_Pod const* self_);
    ...
    /// Default:
    /// (0,0,0,0)
void      physx_PxShape_setSimulationFilterData_mut(physx_PxShape_Pod* self_, physx_PxFilterData_Pod const* data);

    /// Retrieves the shape's collision filter data.
physx_PxFilterData_Pod      physx_PxShape_getSimulationFilterData(physx_PxShape_Pod const* self_);

    /// Sets the user definable query filter data.
    ///
    /// Default:
    /// (0,0,0,0)
void      physx_PxShape_setQueryFilterData_mut(physx_PxShape_Pod* self_, physx_PxFilterData_Pod const* data);

    /// Retrieves the shape's Query filter data.
physx_PxFilterData_Pod      physx_PxShape_getQueryFilterData(physx_PxShape_Pod const* self_);
    ...
    /// NOT
    /// wake the associated actor up automatically.
void      physx_PxShape_setMaterials_mut(physx_PxShape_Pod* self_, physx_PxMaterial_Pod* const* materials, uint16_t materialCount);
...
uint16_t      physx_PxShape_getNbMaterials(physx_PxShape_Pod const* self_);
...
uint32_t      physx_PxShape_getMaterials(physx_PxShape_Pod const* self_, physx_PxMaterial_Pod** userBuffer, uint32_t bufferSize, uint32_t startIndex);
...
physx_PxBaseMaterial_Pod*      physx_PxShape_getMaterialFromInternalFaceIndex(physx_PxShape_Pod const* self_, uint32_t faceIndex);
    ...
    /// NOT
    /// wake the associated actor up automatically.
void      physx_PxShape_setContactOffset_mut(physx_PxShape_Pod* self_, float contactOffset);

    /// Retrieves the contact offset.
    ///
    /// The contact offset of the shape.
float      physx_PxShape_getContactOffset(physx_PxShape_Pod const* self_);
    ...
    /// NOT
    /// wake the associated actor up automatically.
void      physx_PxShape_setRestOffset_mut(physx_PxShape_Pod* self_, float restOffset);

    /// Retrieves the rest offset.
    ///
    /// The rest offset of the shape.
float      physx_PxShape_getRestOffset(physx_PxShape_Pod const* self_);
    ...
    /// Default:
    /// 800.0f
void      physx_PxShape_setDensityForFluid_mut(physx_PxShape_Pod* self_, float densityForFluid);

    /// Retrieves the density used to interact with fluids.
    ///
    /// The density of the body when interacting with fluid.
float      physx_PxShape_getDensityForFluid(physx_PxShape_Pod const* self_);
    ...
    /// Default:
    /// 0.0
void      physx_PxShape_setTorsionalPatchRadius_mut(physx_PxShape_Pod* self_, float radius);
...
float      physx_PxShape_getTorsionalPatchRadius(physx_PxShape_Pod const* self_);
    ...
    /// Default:
    /// 0.0
void      physx_PxShape_setMinTorsionalPatchRadius_mut(physx_PxShape_Pod* self_, float radius);
...
float      physx_PxShape_getMinTorsionalPatchRadius(physx_PxShape_Pod const* self_);
...
void      physx_PxShape_setFlag_mut(physx_PxShape_Pod* self_, int32_t flag, bool value);

    /// Sets shape flags
void      physx_PxShape_setFlags_mut(physx_PxShape_Pod* self_, uint8_t inFlags);

    /// Retrieves shape flags.
    ///
    /// The values of the shape flags.
uint8_t      physx_PxShape_getFlags(physx_PxShape_Pod const* self_);

    /// Returns true if the shape is exclusive to an actor.
bool      physx_PxShape_isExclusive(physx_PxShape_Pod const* self_);
    ...
    /// Default:
    /// NULL
void      physx_PxShape_setName_mut(physx_PxShape_Pod* self_, char const* name);

    /// retrieves the name string set with setName().
    ///
    /// The name associated with the shape.
char const*      physx_PxShape_getName(physx_PxShape_Pod const* self_);

char const*      physx_PxShape_getConcreteTypeName(physx_PxShape_Pod const* self_);
...
void      physx_PxRigidActor_release_mut(physx_PxRigidActor_Pod* self_);
...
uint32_t      physx_PxRigidActor_getInternalActorIndex(physx_PxRigidActor_Pod const* self_);
...
physx_PxTransform_Pod      physx_PxRigidActor_getGlobalPose(physx_PxRigidActor_Pod const* self_);
...
void      physx_PxRigidActor_setGlobalPose_mut(physx_PxRigidActor_Pod* self_, physx_PxTransform_Pod const* pose, bool autowake);
    ...
    ///
    /// True if success.
bool      physx_PxRigidActor_attachShape_mut(physx_PxRigidActor_Pod* self_, physx_PxShape_Pod* shape);
    ...
    /// NOT
    /// wake the actor up automatically.
void      physx_PxRigidActor_detachShape_mut(physx_PxRigidActor_Pod* self_, physx_PxShape_Pod* shape, bool wakeOnLostTouch);
...
uint32_t      physx_PxRigidActor_getNbShapes(physx_PxRigidActor_Pod const* self_);
...
uint32_t      physx_PxRigidActor_getShapes(physx_PxRigidActor_Pod const* self_, physx_PxShape_Pod** userBuffer, uint32_t bufferSize, uint32_t startIndex);
...
uint32_t      physx_PxRigidActor_getNbConstraints(physx_PxRigidActor_Pod const* self_);
...
uint32_t      physx_PxRigidActor_getConstraints(physx_PxRigidActor_Pod const* self_, physx_PxConstraint_Pod** userBuffer, uint32_t bufferSize, uint32_t startIndex);
...
uint32_t      physx_PxNodeIndex_index(physx_PxNodeIndex_Pod const* self_);

uint32_t      physx_PxNodeIndex_articulationLinkId(physx_PxNodeIndex_Pod const* self_);

uint32_t      physx_PxNodeIndex_isArticulation(physx_PxNodeIndex_Pod const* self_);

bool      physx_PxNodeIndex_isStaticBody(physx_PxNodeIndex_Pod const* self_);

bool      physx_PxNodeIndex_isValid(physx_PxNodeIndex_Pod const* self_);

void      physx_PxNodeIndex_setIndices_mut(physx_PxNodeIndex_Pod* self_, uint32_t index, uint32_t articLinkId);

void      physx_PxNodeIndex_setIndices_mut_1(physx_PxNodeIndex_Pod* self_, uint32_t index);

uint64_t      physx_PxNodeIndex_getInd(physx_PxNodeIndex_Pod const* self_);
    ...
    /// Default:
    /// the identity transform
void      physx_PxRigidBody_setCMassLocalPose_mut(physx_PxRigidBody_Pod* self_, physx_PxTransform_Pod const* pose);

    /// Retrieves the center of mass pose relative to the actor frame.
    ///
    /// The center of mass pose relative to the actor frame.
physx_PxTransform_Pod      physx_PxRigidBody_getCMassLocalPose(physx_PxRigidBody_Pod const* self_);
    ...
    /// NOT
    /// wake the actor up automatically.
void      physx_PxRigidBody_setMass_mut(physx_PxRigidBody_Pod* self_, float mass);
...
float      physx_PxRigidBody_getMass(physx_PxRigidBody_Pod const* self_);

    /// Retrieves the inverse mass of the actor.
    ///
    /// The inverse mass of this actor.
float      physx_PxRigidBody_getInvMass(physx_PxRigidBody_Pod const* self_);
    ...
    /// NOT
    /// wake the actor up automatically.
void      physx_PxRigidBody_setMassSpaceInertiaTensor_mut(physx_PxRigidBody_Pod* self_, physx_PxVec3_Pod const* m);
    ...
    ///
    /// A value of 0 in an element is interpreted as infinite inertia along that axis.
physx_PxVec3_Pod      physx_PxRigidBody_getMassSpaceInertiaTensor(physx_PxRigidBody_Pod const* self_);
...
physx_PxVec3_Pod      physx_PxRigidBody_getMassSpaceInvInertiaTensor(physx_PxRigidBody_Pod const* self_);
    ...
    /// Default:
    /// 0.0
void      physx_PxRigidBody_setLinearDamping_mut(physx_PxRigidBody_Pod* self_, float linDamp);

    /// Retrieves the linear damping coefficient.
    ///
    /// The linear damping coefficient associated with this actor.
float      physx_PxRigidBody_getLinearDamping(physx_PxRigidBody_Pod const* self_);
    ...
    /// Default:
    /// 0.05
void      physx_PxRigidBody_setAngularDamping_mut(physx_PxRigidBody_Pod* self_, float angDamp);

    /// Retrieves the angular damping coefficient.
    ///
    /// The angular damping coefficient associated with this actor.
float      physx_PxRigidBody_getAngularDamping(physx_PxRigidBody_Pod const* self_);
...
physx_PxVec3_Pod      physx_PxRigidBody_getLinearVelocity(physx_PxRigidBody_Pod const* self_);
...
physx_PxVec3_Pod      physx_PxRigidBody_getAngularVelocity(physx_PxRigidBody_Pod const* self_);
    ...
    /// Default:
    /// PX_MAX_F32
void      physx_PxRigidBody_setMaxLinearVelocity_mut(physx_PxRigidBody_Pod* self_, float maxLinVel);

    /// Retrieves the maximum angular velocity permitted for this actor.
    ///
    /// The maximum allowed angular velocity for this actor.
float      physx_PxRigidBody_getMaxLinearVelocity(physx_PxRigidBody_Pod const* self_);
    ...
    /// Default:
    /// 100.0
void      physx_PxRigidBody_setMaxAngularVelocity_mut(physx_PxRigidBody_Pod* self_, float maxAngVel);

    /// Retrieves the maximum angular velocity permitted for this actor.
    ///
    /// The maximum allowed angular velocity for this actor.
float      physx_PxRigidBody_getMaxAngularVelocity(physx_PxRigidBody_Pod const* self_);
...
void      physx_PxRigidBody_addForce_mut(physx_PxRigidBody_Pod* self_, physx_PxVec3_Pod const* force, int32_t mode, bool autowake);
...
void      physx_PxRigidBody_addTorque_mut(physx_PxRigidBody_Pod* self_, physx_PxVec3_Pod const* torque, int32_t mode, bool autowake);
    ...
    ///
    /// It is invalid to use this method if the actor has not been added to a scene already or if PxActorFlag::eDISABLE_SIMULATION is set.
void      physx_PxRigidBody_clearForce_mut(physx_PxRigidBody_Pod* self_, int32_t mode);
    ...
    ///
    /// It is invalid to use this method if the actor has not been added to a scene already or if PxActorFlag::eDISABLE_SIMULATION is set.
void      physx_PxRigidBody_clearTorque_mut(physx_PxRigidBody_Pod* self_, int32_t mode);
    ...
    ///
    /// It is invalid to use this method if the actor has not been added to a scene already or if PxActorFlag::eDISABLE_SIMULATION is set.
void      physx_PxRigidBody_setForceAndTorque_mut(physx_PxRigidBody_Pod* self_, physx_PxVec3_Pod const* force, physx_PxVec3_Pod const* torque, int32_t mode);
    ...
    /// NOT
    /// wake the actor up automatically.
void      physx_PxRigidBody_setRigidBodyFlag_mut(physx_PxRigidBody_Pod* self_, int32_t flag, bool value);

void      physx_PxRigidBody_setRigidBodyFlags_mut(physx_PxRigidBody_Pod* self_, uint16_t inFlags);
...
uint16_t      physx_PxRigidBody_getRigidBodyFlags(physx_PxRigidBody_Pod const* self_);
...
void      physx_PxRigidBody_setMinCCDAdvanceCoefficient_mut(physx_PxRigidBody_Pod* self_, float advanceCoefficient);

    /// Gets the CCD minimum advance coefficient.
    ///
    /// The value of the CCD min advance coefficient.
float      physx_PxRigidBody_getMinCCDAdvanceCoefficient(physx_PxRigidBody_Pod const* self_);
...
void      physx_PxRigidBody_setMaxDepenetrationVelocity_mut(physx_PxRigidBody_Pod* self_, float biasClamp);
...
float      physx_PxRigidBody_getMaxDepenetrationVelocity(physx_PxRigidBody_Pod const* self_);
...
void      physx_PxRigidBody_setMaxContactImpulse_mut(physx_PxRigidBody_Pod* self_, float maxImpulse);

    /// Returns the maximum impulse that may be applied at a contact.
    ///
    /// The maximum impulse that may be applied at a contact
float      physx_PxRigidBody_getMaxContactImpulse(physx_PxRigidBody_Pod const* self_);
...
void      physx_PxRigidBody_setContactSlopCoefficient_mut(physx_PxRigidBody_Pod* self_, float slopCoefficient);

    /// Returns the contact slop coefficient.
    ///
    /// The contact slop coefficient.
float      physx_PxRigidBody_getContactSlopCoefficient(physx_PxRigidBody_Pod const* self_);

    /// Returns the island node index
    ///
    /// The island node index.
physx_PxNodeIndex_Pod      physx_PxRigidBody_getInternalIslandNodeIndex(physx_PxRigidBody_Pod const* self_);
...
void      physx_PxArticulationLink_release_mut(physx_PxArticulationLink_Pod* self_);

    /// Gets the articulation that the link is a part of.
    ///
    /// The articulation.
physx_PxArticulationReducedCoordinate_Pod*      physx_PxArticulationLink_getArticulation(physx_PxArticulationLink_Pod const* self_);

    /// Gets the joint which connects this link to its parent.
    ///
    /// The joint connecting the link to the parent. NULL for the root link.
physx_PxArticulationJointReducedCoordinate_Pod*      physx_PxArticulationLink_getInboundJoint(physx_PxArticulationLink_Pod const* self_);
...
uint32_t      physx_PxArticulationLink_getInboundJointDof(physx_PxArticulationLink_Pod const* self_);

    /// Gets the number of child links.
    ///
    /// The number of child links.
uint32_t      physx_PxArticulationLink_getNbChildren(physx_PxArticulationLink_Pod const* self_);
    ...
    ///
    /// The low-level index, or 0xFFFFFFFF if the articulation is not in a scene.
uint32_t      physx_PxArticulationLink_getLinkIndex(physx_PxArticulationLink_Pod const* self_);

    /// Retrieves the child links.
    ///
    /// The number of articulation links written to the buffer.
uint32_t      physx_PxArticulationLink_getChildren(physx_PxArticulationLink_Pod const* self_, physx_PxArticulationLink_Pod** userBuffer, uint32_t bufferSize, uint32_t startIndex);
    ...
    ///
    /// This call is not allowed while the simulation is running.
void      physx_PxArticulationLink_setCfmScale_mut(physx_PxArticulationLink_Pod* self_, float cfm);

    /// Get the constraint-force-mixing scale term.
    ///
    /// The constraint-force-mixing scale term.
float      physx_PxArticulationLink_getCfmScale(physx_PxArticulationLink_Pod const* self_);
    ...
    /// This call is not allowed while the simulation is running except in a split simulation during [`PxScene::collide`]() and up to #PxScene::advance(),
    /// and in PxContactModifyCallback or in contact report callbacks.
physx_PxVec3_Pod      physx_PxArticulationLink_getLinearVelocity(physx_PxArticulationLink_Pod const* self_);
    ...
    /// This call is not allowed while the simulation is running except in a split simulation during [`PxScene::collide`]() and up to #PxScene::advance(),
    /// and in PxContactModifyCallback or in contact report callbacks.
physx_PxVec3_Pod      physx_PxArticulationLink_getAngularVelocity(physx_PxArticulationLink_Pod const* self_);

    /// Returns the string name of the dynamic type.
    ///
    /// The string name.
char const*      physx_PxArticulationLink_getConcreteTypeName(physx_PxArticulationLink_Pod const* self_);
...
void      physx_PxConstraint_release_mut(physx_PxConstraint_Pod* self_);

    /// Retrieves the scene which this constraint belongs to.
    ///
    /// Owner Scene. NULL if not part of a scene.
physx_PxScene_Pod*      physx_PxConstraint_getScene(physx_PxConstraint_Pod const* self_);

    /// Retrieves the actors for this constraint.
void      physx_PxConstraint_getActors(physx_PxConstraint_Pod const* self_, physx_PxRigidActor_Pod** actor0, physx_PxRigidActor_Pod** actor1);

    /// Sets the actors for this constraint.
void      physx_PxConstraint_setActors_mut(physx_PxConstraint_Pod* self_, physx_PxRigidActor_Pod* actor0, physx_PxRigidActor_Pod* actor1);

    /// Notify the scene that the constraint shader data has been updated by the application
void      physx_PxConstraint_markDirty_mut(physx_PxConstraint_Pod* self_);

    /// Retrieve the flags for this constraint
    ///
    /// the constraint flags
uint16_t      physx_PxConstraint_getFlags(physx_PxConstraint_Pod const* self_);

    /// Set the flags for this constraint
    ///
    /// default: PxConstraintFlag::eDRIVE_LIMITS_ARE_FORCES
void      physx_PxConstraint_setFlags_mut(physx_PxConstraint_Pod* self_, uint16_t flags);

    /// Set a flag for this constraint
void      physx_PxConstraint_setFlag_mut(physx_PxConstraint_Pod* self_, int32_t flag, bool value);

    /// Retrieve the constraint force most recently applied to maintain this constraint.
    ///
    /// It is not allowed to use this method while the simulation is running (except during PxScene::collide(),
    /// in PxContactModifyCallback or in contact report callbacks).
void      physx_PxConstraint_getForce(physx_PxConstraint_Pod const* self_, physx_PxVec3_Pod* linear, physx_PxVec3_Pod* angular);
...
bool      physx_PxConstraint_isValid(physx_PxConstraint_Pod const* self_);
...
void      physx_PxConstraint_setBreakForce_mut(physx_PxConstraint_Pod* self_, float linear, float angular);

    /// Retrieve the constraint break force and torque thresholds
void      physx_PxConstraint_getBreakForce(physx_PxConstraint_Pod const* self_, float* linear, float* angular);
...
void      physx_PxConstraint_setMinResponseThreshold_mut(physx_PxConstraint_Pod* self_, float threshold);

    /// Retrieve the constraint break force and torque thresholds
    ///
    /// the minimum response threshold for a constraint row
float      physx_PxConstraint_getMinResponseThreshold(physx_PxConstraint_Pod const* self_);
...
void*      physx_PxConstraint_getExternalReference_mut(physx_PxConstraint_Pod* self_, uint32_t* typeID);

    /// Set the constraint functions for this constraint
void      physx_PxConstraint_setConstraintFunctions_mut(physx_PxConstraint_Pod* self_, physx_PxConstraintConnector_Pod* connector, physx_PxConstraintShaderTable_Pod const* shaders);

char const*      physx_PxConstraint_getConcreteTypeName(physx_PxConstraint_Pod const* self_);
...
bool      physx_PxContactStreamIterator_hasNextPatch(physx_PxContactStreamIterator_Pod const* self_);

    /// Returns the total contact count.
    ///
    /// Total contact count.
uint32_t      physx_PxContactStreamIterator_getTotalContactCount(physx_PxContactStreamIterator_Pod const* self_);

    /// Returns the total patch count.
    ///
    /// Total patch count.
uint32_t      physx_PxContactStreamIterator_getTotalPatchCount(physx_PxContactStreamIterator_Pod const* self_);

    /// Advances iterator to next contact patch.
void      physx_PxContactStreamIterator_nextPatch_mut(physx_PxContactStreamIterator_Pod* self_);

    /// Returns if the current patch has more contacts.
    ///
    /// If there are more contacts in the current patch.
bool      physx_PxContactStreamIterator_hasNextContact(physx_PxContactStreamIterator_Pod const* self_);

    /// Advances to the next contact in the patch.
void      physx_PxContactStreamIterator_nextContact_mut(physx_PxContactStreamIterator_Pod* self_);

    /// Gets the current contact's normal
    ///
    /// The current contact's normal.
physx_PxVec3_Pod const*      physx_PxContactStreamIterator_getContactNormal(physx_PxContactStreamIterator_Pod const* self_);

    /// Gets the inverse mass scale for body 0.
    ///
    /// The inverse mass scale for body 0.
float      physx_PxContactStreamIterator_getInvMassScale0(physx_PxContactStreamIterator_Pod const* self_);

    /// Gets the inverse mass scale for body 1.
    ///
    /// The inverse mass scale for body 1.
float      physx_PxContactStreamIterator_getInvMassScale1(physx_PxContactStreamIterator_Pod const* self_);

    /// Gets the inverse inertia scale for body 0.
    ///
    /// The inverse inertia scale for body 0.
float      physx_PxContactStreamIterator_getInvInertiaScale0(physx_PxContactStreamIterator_Pod const* self_);

    /// Gets the inverse inertia scale for body 1.
    ///
    /// The inverse inertia scale for body 1.
float      physx_PxContactStreamIterator_getInvInertiaScale1(physx_PxContactStreamIterator_Pod const* self_);

    /// Gets the contact's max impulse.
    ///
    /// The contact's max impulse.
float      physx_PxContactStreamIterator_getMaxImpulse(physx_PxContactStreamIterator_Pod const* self_);

    /// Gets the contact's target velocity.
    ///
    /// The contact's target velocity.
physx_PxVec3_Pod const*      physx_PxContactStreamIterator_getTargetVel(physx_PxContactStreamIterator_Pod const* self_);

    /// Gets the contact's contact point.
    ///
    /// The contact's contact point.
physx_PxVec3_Pod const*      physx_PxContactStreamIterator_getContactPoint(physx_PxContactStreamIterator_Pod const* self_);

    /// Gets the contact's separation.
    ///
    /// The contact's separation.
float      physx_PxContactStreamIterator_getSeparation(physx_PxContactStreamIterator_Pod const* self_);

    /// Gets the contact's face index for shape 0.
    ///
    /// The contact's face index for shape 0.
uint32_t      physx_PxContactStreamIterator_getFaceIndex0(physx_PxContactStreamIterator_Pod const* self_);

    /// Gets the contact's face index for shape 1.
    ///
    /// The contact's face index for shape 1.
uint32_t      physx_PxContactStreamIterator_getFaceIndex1(physx_PxContactStreamIterator_Pod const* self_);

    /// Gets the contact's static friction coefficient.
    ///
    /// The contact's static friction coefficient.
float      physx_PxContactStreamIterator_getStaticFriction(physx_PxContactStreamIterator_Pod const* self_);

    /// Gets the contact's dynamic friction coefficient.
    ///
    /// The contact's dynamic friction coefficient.
float      physx_PxContactStreamIterator_getDynamicFriction(physx_PxContactStreamIterator_Pod const* self_);

    /// Gets the contact's restitution coefficient.
    ///
    /// The contact's restitution coefficient.
float      physx_PxContactStreamIterator_getRestitution(physx_PxContactStreamIterator_Pod const* self_);

    /// Gets the contact's damping value.
    ///
    /// The contact's damping value.
float      physx_PxContactStreamIterator_getDamping(physx_PxContactStreamIterator_Pod const* self_);

    /// Gets the contact's material flags.
    ///
    /// The contact's material flags.
uint32_t      physx_PxContactStreamIterator_getMaterialFlags(physx_PxContactStreamIterator_Pod const* self_);

    /// Gets the contact's material index for shape 0.
    ///
    /// The contact's material index for shape 0.
uint16_t      physx_PxContactStreamIterator_getMaterialIndex0(physx_PxContactStreamIterator_Pod const* self_);

    /// Gets the contact's material index for shape 1.
    ///
    /// The contact's material index for shape 1.
uint16_t      physx_PxContactStreamIterator_getMaterialIndex1(physx_PxContactStreamIterator_Pod const* self_);

    /// Advances the contact stream iterator to a specific contact index.
    ///
    /// True if advancing was possible
bool      physx_PxContactStreamIterator_advanceToIndex_mut(physx_PxContactStreamIterator_Pod* self_, uint32_t initialIndex);

    /// Get the position of a specific contact point in the set.
    ///
    /// Position to the requested point in world space
physx_PxVec3_Pod const*      physx_PxContactSet_getPoint(physx_PxContactSet_Pod const* self_, uint32_t i);

    /// Alter the position of a specific contact point in the set.
void      physx_PxContactSet_setPoint_mut(physx_PxContactSet_Pod* self_, uint32_t i, physx_PxVec3_Pod const* p);

    /// Get the contact normal of a specific contact point in the set.
    ///
    /// The requested normal in world space
physx_PxVec3_Pod const*      physx_PxContactSet_getNormal(physx_PxContactSet_Pod const* self_, uint32_t i);
...
void      physx_PxContactSet_setNormal_mut(physx_PxContactSet_Pod* self_, uint32_t i, physx_PxVec3_Pod const* n);

    /// Get the separation distance of a specific contact point in the set.
    ///
    /// The separation. Negative implies penetration.
float      physx_PxContactSet_getSeparation(physx_PxContactSet_Pod const* self_, uint32_t i);

    /// Alter the separation of a specific contact point in the set.
void      physx_PxContactSet_setSeparation_mut(physx_PxContactSet_Pod* self_, uint32_t i, float s);

    /// Get the target velocity of a specific contact point in the set.
    ///
    /// The target velocity in world frame
physx_PxVec3_Pod const*      physx_PxContactSet_getTargetVelocity(physx_PxContactSet_Pod const* self_, uint32_t i);

    /// Alter the target velocity of a specific contact point in the set.
void      physx_PxContactSet_setTargetVelocity_mut(physx_PxContactSet_Pod* self_, uint32_t i, physx_PxVec3_Pod const* v);
...
uint32_t      physx_PxContactSet_getInternalFaceIndex0(physx_PxContactSet_Pod const* self_, uint32_t i);
...
uint32_t      physx_PxContactSet_getInternalFaceIndex1(physx_PxContactSet_Pod const* self_, uint32_t i);

    /// Get the maximum impulse for a specific contact point in the set.
    ///
    /// The maximum impulse
float      physx_PxContactSet_getMaxImpulse(physx_PxContactSet_Pod const* self_, uint32_t i);
...
void      physx_PxContactSet_setMaxImpulse_mut(physx_PxContactSet_Pod* self_, uint32_t i, float s);

    /// Get the restitution coefficient for a specific contact point in the set.
    ///
    /// The restitution coefficient
float      physx_PxContactSet_getRestitution(physx_PxContactSet_Pod const* self_, uint32_t i);

    /// Alter the restitution coefficient for a specific contact point in the set.
    ///
    /// Valid ranges [0,1]
void      physx_PxContactSet_setRestitution_mut(physx_PxContactSet_Pod* self_, uint32_t i, float r);

    /// Get the static friction coefficient for a specific contact point in the set.
    ///
    /// The friction coefficient (dimensionless)
float      physx_PxContactSet_getStaticFriction(physx_PxContactSet_Pod const* self_, uint32_t i);

    /// Alter the static friction coefficient for a specific contact point in the set.
void      physx_PxContactSet_setStaticFriction_mut(physx_PxContactSet_Pod* self_, uint32_t i, float f);

    /// Get the static friction coefficient for a specific contact point in the set.
    ///
    /// The friction coefficient
float      physx_PxContactSet_getDynamicFriction(physx_PxContactSet_Pod const* self_, uint32_t i);

    /// Alter the static dynamic coefficient for a specific contact point in the set.
void      physx_PxContactSet_setDynamicFriction_mut(physx_PxContactSet_Pod* self_, uint32_t i, float f);
...
void      physx_PxContactSet_ignore_mut(physx_PxContactSet_Pod* self_, uint32_t i);

    /// The number of contact points in the set.
uint32_t      physx_PxContactSet_size(physx_PxContactSet_Pod const* self_);
...
float      physx_PxContactSet_getInvMassScale0(physx_PxContactSet_Pod const* self_);
    ...
    /// 1.0 makes this contact treat the body as if it had larger mass. A value of 0.f makes this contact
    /// treat the body as if it had infinite mass. Any value > 1.f makes this contact treat the body as if it had smaller mass.
float      physx_PxContactSet_getInvMassScale1(physx_PxContactSet_Pod const* self_);
...
float      physx_PxContactSet_getInvInertiaScale0(physx_PxContactSet_Pod const* self_);
    ...
    /// 1.0 makes this contact treat the body as if it had larger inertia. A value of 0.f makes this contact
    /// treat the body as if it had infinite inertia. Any value > 1.f makes this contact treat the body as if it had smaller inertia.
float      physx_PxContactSet_getInvInertiaScale1(physx_PxContactSet_Pod const* self_);
    ...
    /// 1.0 makes this contact treat the body as if it had larger mass. A value of 0.f makes this contact
    /// treat the body as if it had infinite mass. Any value > 1.f makes this contact treat the body as if it had smaller mass.
void      physx_PxContactSet_setInvMassScale0_mut(physx_PxContactSet_Pod* self_, float scale);
    ...
    /// 1.0 makes this contact treat the body as if it had larger mass. A value of 0.f makes this contact
    /// treat the body as if it had infinite mass. Any value > 1.f makes this contact treat the body as if it had smaller mass.
void      physx_PxContactSet_setInvMassScale1_mut(physx_PxContactSet_Pod* self_, float scale);
    ...
    /// 1.0 makes this contact treat the body as if it had larger inertia. A value of 0.f makes this contact
    /// treat the body as if it had infinite inertia. Any value > 1.f makes this contact treat the body as if it had smaller inertia.
void      physx_PxContactSet_setInvInertiaScale0_mut(physx_PxContactSet_Pod* self_, float scale);
    ...
    /// 1.0 makes this contact treat the body as if it had larger inertia. A value of 0.f makes this contact
    /// treat the body as if it had infinite inertia. Any value > 1.f makes this contact treat the body as if it had smaller inertia.
void      physx_PxContactSet_setInvInertiaScale1_mut(physx_PxContactSet_Pod* self_, float scale);
...
void      physx_PxContactModifyCallback_onContactModify_mut(physx_PxContactModifyCallback_Pod* self_, physx_PxContactModifyPair_Pod*const pairs, uint32_t count);
    ...
    /// The number of contacts can not be changed, so you cannot add your own contacts.  You may however
    /// disable contacts using PxContactSet::ignore().
void      physx_PxCCDContactModifyCallback_onCCDContactModify_mut(physx_PxCCDContactModifyCallback_Pod* self_, physx_PxContactModifyPair_Pod*const pairs, uint32_t count);
...
void      physx_PxDeletionListener_onRelease_mut(physx_PxDeletionListener_Pod* self_, physx_PxBase_Pod const* observed, void* userData, int32_t deletionEvent);

bool      physx_PxBaseMaterial_isKindOf(physx_PxBaseMaterial_Pod const* self_, char const* name);

    /// Sets young's modulus which defines the body's stiffness
void      physx_PxFEMMaterial_setYoungsModulus_mut(physx_PxFEMMaterial_Pod* self_, float young);

    /// Retrieves the young's modulus value.
    ///
    /// The young's modulus value.
float      physx_PxFEMMaterial_getYoungsModulus(physx_PxFEMMaterial_Pod const* self_);
...
void      physx_PxFEMMaterial_setPoissons_mut(physx_PxFEMMaterial_Pod* self_, float poisson);

    /// Retrieves the Poisson's ratio.
    ///
    /// The Poisson's ratio.
float      physx_PxFEMMaterial_getPoissons(physx_PxFEMMaterial_Pod const* self_);
...
void      physx_PxFEMMaterial_setDynamicFriction_mut(physx_PxFEMMaterial_Pod* self_, float dynamicFriction);

    /// Retrieves the dynamic friction value
    ///
    /// The dynamic friction value
float      physx_PxFEMMaterial_getDynamicFriction(physx_PxFEMMaterial_Pod const* self_);

physx_PxFilterData_Pod      physx_PxFilterData_new(int32_t anon_param0);
...
physx_PxFilterData_Pod      physx_PxFilterData_new_2(uint32_t w0, uint32_t w1, uint32_t w2, uint32_t w3);
    ...
    /// (re)sets the structure to the default.
void      physx_PxFilterData_setToDefault_mut(physx_PxFilterData_Pod* self_);
...
void      physx_PxSimulationFilterCallback_pairLost_mut(physx_PxSimulationFilterCallback_Pod* self_, uint32_t pairID, uint32_t attributes0, physx_PxFilterData_Pod filterData0, uint32_t attributes1, physx_PxFilterData_Pod filterData1, bool objectRemoved);
...
bool      physx_PxSimulationFilterCallback_statusChange_mut(physx_PxSimulationFilterCallback_Pod* self_, uint32_t* pairID, uint16_t* pairFlags, uint16_t* filterFlags);

    /// Any combination of PxDataAccessFlag::eREADABLE and PxDataAccessFlag::eWRITABLE
uint8_t      physx_PxLockedData_getDataAccessFlags_mut(physx_PxLockedData_Pod* self_);

    /// Unlocks the bulk data.
void      physx_PxLockedData_unlock_mut(physx_PxLockedData_Pod* self_);

    /// virtual destructor
void      physx_PxLockedData_delete(physx_PxLockedData_Pod* self_);
...
void      physx_PxMaterial_setDynamicFriction_mut(physx_PxMaterial_Pod* self_, float coef);

    /// Retrieves the DynamicFriction value.
    ///
    /// The coefficient of dynamic friction.
float      physx_PxMaterial_getDynamicFriction(physx_PxMaterial_Pod const* self_);
    ...
    /// NOT
    /// wake any actors which may be affected.
void      physx_PxMaterial_setStaticFriction_mut(physx_PxMaterial_Pod* self_, float coef);

    /// Retrieves the coefficient of static friction.
    ///
    /// The coefficient of static friction.
float      physx_PxMaterial_getStaticFriction(physx_PxMaterial_Pod const* self_);
    ...
    /// NOT
    /// wake any actors which may be affected.
void      physx_PxMaterial_setRestitution_mut(physx_PxMaterial_Pod* self_, float rest);
...
float      physx_PxMaterial_getRestitution(physx_PxMaterial_Pod const* self_);
    ...
    /// NOT
    /// wake any actors which may be affected.
void      physx_PxMaterial_setDamping_mut(physx_PxMaterial_Pod* self_, float damping);
...
float      physx_PxMaterial_getDamping(physx_PxMaterial_Pod const* self_);
    ...
    /// NOT
    /// wake any actors which may be affected.
void      physx_PxMaterial_setFlag_mut(physx_PxMaterial_Pod* self_, int32_t flag, bool b);
    ...
    /// NOT
    /// wake any actors which may be affected.
void      physx_PxMaterial_setFlags_mut(physx_PxMaterial_Pod* self_, uint16_t flags);

    /// Retrieves the flags. See [`PxMaterialFlag`].
    ///
    /// The material flags.
uint16_t      physx_PxMaterial_getFlags(physx_PxMaterial_Pod const* self_);
    ...
    /// NOT
    /// wake any actors which may be affected.
void      physx_PxMaterial_setFrictionCombineMode_mut(physx_PxMaterial_Pod* self_, int32_t combMode);
...
int32_t      physx_PxMaterial_getFrictionCombineMode(physx_PxMaterial_Pod const* self_);
    ...
    /// NOT
    /// wake any actors which may be affected.
void      physx_PxMaterial_setRestitutionCombineMode_mut(physx_PxMaterial_Pod* self_, int32_t combMode);
...
int32_t      physx_PxMaterial_getRestitutionCombineMode(physx_PxMaterial_Pod const* self_);

char const*      physx_PxMaterial_getConcreteTypeName(physx_PxMaterial_Pod const* self_);

    /// Construct parameters with default values.
physx_PxDiffuseParticleParams_Pod      physx_PxDiffuseParticleParams_new();

    /// (re)sets the structure to the default.
void      physx_PxDiffuseParticleParams_setToDefault_mut(physx_PxDiffuseParticleParams_Pod* self_);

    /// Sets friction
void      physx_PxParticleMaterial_setFriction_mut(physx_PxParticleMaterial_Pod* self_, float friction);

    /// Retrieves the friction value.
    ///
    /// The friction value.
float      physx_PxParticleMaterial_getFriction(physx_PxParticleMaterial_Pod const* self_);

    /// Sets velocity damping term
void      physx_PxParticleMaterial_setDamping_mut(physx_PxParticleMaterial_Pod* self_, float damping);

    /// Retrieves the velocity damping term
    ///
    /// The velocity damping term.
float      physx_PxParticleMaterial_getDamping(physx_PxParticleMaterial_Pod const* self_);

    /// Sets adhesion term
void      physx_PxParticleMaterial_setAdhesion_mut(physx_PxParticleMaterial_Pod* self_, float adhesion);

    /// Retrieves the adhesion term
    ///
    /// The adhesion term.
float      physx_PxParticleMaterial_getAdhesion(physx_PxParticleMaterial_Pod const* self_);

    /// Sets gravity scale term
void      physx_PxParticleMaterial_setGravityScale_mut(physx_PxParticleMaterial_Pod* self_, float scale);

    /// Retrieves the gravity scale term
    ///
    /// The gravity scale term.
float      physx_PxParticleMaterial_getGravityScale(physx_PxParticleMaterial_Pod const* self_);
...
void      physx_PxParticleMaterial_setAdhesionRadiusScale_mut(physx_PxParticleMaterial_Pod* self_, float scale);

    /// Retrieves the adhesion radius scale.
    ///
    /// The adhesion radius scale.
float      physx_PxParticleMaterial_getAdhesionRadiusScale(physx_PxParticleMaterial_Pod const* self_);
...
void      physx_PxPhysics_release_mut(physx_PxPhysics_Pod* self_);

    /// Retrieves the Foundation instance.
    ///
    /// A reference to the Foundation object.
physx_PxFoundation_Pod*      physx_PxPhysics_getFoundation_mut(physx_PxPhysics_Pod* self_);
    ...
    ///
    /// The new aggregate.
physx_PxAggregate_Pod*      physx_PxPhysics_createAggregate_mut(physx_PxPhysics_Pod* self_, uint32_t maxActor, uint32_t maxShape, uint32_t filterHint);

    /// Returns the simulation tolerance parameters.
    ///
    /// The current simulation tolerance parameters.
physx_PxTolerancesScale_Pod const*      physx_PxPhysics_getTolerancesScale(physx_PxPhysics_Pod const* self_);
...
physx_PxTriangleMesh_Pod*      physx_PxPhysics_createTriangleMesh_mut(physx_PxPhysics_Pod* self_, physx_PxInputStream_Pod* stream);

    /// Return the number of triangle meshes that currently exist.
    ///
    /// Number of triangle meshes.
uint32_t      physx_PxPhysics_getNbTriangleMeshes(physx_PxPhysics_Pod const* self_);
...
uint32_t      physx_PxPhysics_getTriangleMeshes(physx_PxPhysics_Pod const* self_, physx_PxTriangleMesh_Pod** userBuffer, uint32_t bufferSize, uint32_t startIndex);
...
physx_PxTetrahedronMesh_Pod*      physx_PxPhysics_createTetrahedronMesh_mut(physx_PxPhysics_Pod* self_, physx_PxInputStream_Pod* stream);

    /// Creates a softbody mesh object.
    ///
    /// The new softbody mesh.
physx_PxSoftBodyMesh_Pod*      physx_PxPhysics_createSoftBodyMesh_mut(physx_PxPhysics_Pod* self_, physx_PxInputStream_Pod* stream);

    /// Return the number of tetrahedron meshes that currently exist.
    ///
    /// Number of tetrahedron meshes.
uint32_t      physx_PxPhysics_getNbTetrahedronMeshes(physx_PxPhysics_Pod const* self_);
...
uint32_t      physx_PxPhysics_getTetrahedronMeshes(physx_PxPhysics_Pod const* self_, physx_PxTetrahedronMesh_Pod** userBuffer, uint32_t bufferSize, uint32_t startIndex);
    ...
    ///
    /// The new heightfield.
physx_PxHeightField_Pod*      physx_PxPhysics_createHeightField_mut(physx_PxPhysics_Pod* self_, physx_PxInputStream_Pod* stream);

    /// Return the number of heightfields that currently exist.
    ///
    /// Number of heightfields.
uint32_t      physx_PxPhysics_getNbHeightFields(physx_PxPhysics_Pod const* self_);
...
uint32_t      physx_PxPhysics_getHeightFields(physx_PxPhysics_Pod const* self_, physx_PxHeightField_Pod** userBuffer, uint32_t bufferSize, uint32_t startIndex);
    ...
    ///
    /// The new convex mesh.
physx_PxConvexMesh_Pod*      physx_PxPhysics_createConvexMesh_mut(physx_PxPhysics_Pod* self_, physx_PxInputStream_Pod* stream);

    /// Return the number of convex meshes that currently exist.
    ///
    /// Number of convex meshes.
uint32_t      physx_PxPhysics_getNbConvexMeshes(physx_PxPhysics_Pod const* self_);
...
uint32_t      physx_PxPhysics_getConvexMeshes(physx_PxPhysics_Pod const* self_, physx_PxConvexMesh_Pod** userBuffer, uint32_t bufferSize, uint32_t startIndex);

    /// Creates a bounding volume hierarchy.
    ///
    /// The new BVH.
physx_PxBVH_Pod*      physx_PxPhysics_createBVH_mut(physx_PxPhysics_Pod* self_, physx_PxInputStream_Pod* stream);

    /// Return the number of bounding volume hierarchies that currently exist.
    ///
    /// Number of bounding volume hierarchies.
uint32_t      physx_PxPhysics_getNbBVHs(physx_PxPhysics_Pod const* self_);
...
uint32_t      physx_PxPhysics_getBVHs(physx_PxPhysics_Pod const* self_, physx_PxBVH_Pod** userBuffer, uint32_t bufferSize, uint32_t startIndex);
...
physx_PxScene_Pod*      physx_PxPhysics_createScene_mut(physx_PxPhysics_Pod* self_, physx_PxSceneDesc_Pod const* sceneDesc);

    /// Gets number of created scenes.
    ///
    /// The number of scenes created.
uint32_t      physx_PxPhysics_getNbScenes(physx_PxPhysics_Pod const* self_);
...
uint32_t      physx_PxPhysics_getScenes(physx_PxPhysics_Pod const* self_, physx_PxScene_Pod** userBuffer, uint32_t bufferSize, uint32_t startIndex);

    /// Creates a static rigid actor with the specified pose and all other fields initialized
    /// to their default values.
physx_PxRigidStatic_Pod*      physx_PxPhysics_createRigidStatic_mut(physx_PxPhysics_Pod* self_, physx_PxTransform_Pod const* pose);

    /// Creates a dynamic rigid actor with the specified pose and all other fields initialized
    /// to their default values.
physx_PxRigidDynamic_Pod*      physx_PxPhysics_createRigidDynamic_mut(physx_PxPhysics_Pod* self_, physx_PxTransform_Pod const* pose);
...
physx_PxPruningStructure_Pod*      physx_PxPhysics_createPruningStructure_mut(physx_PxPhysics_Pod* self_, physx_PxRigidActor_Pod* const* actors, uint32_t nbActors);
...
physx_PxShape_Pod*      physx_PxPhysics_createShape_mut(physx_PxPhysics_Pod* self_, physx_PxGeometry_Pod const* geometry, physx_PxMaterial_Pod const* material, bool isExclusive, uint8_t shapeFlags);
...
physx_PxShape_Pod*      physx_PxPhysics_createShape_mut_1(physx_PxPhysics_Pod* self_, physx_PxGeometry_Pod const* geometry, physx_PxMaterial_Pod* const* materials, uint16_t materialCount, bool isExclusive, uint8_t shapeFlags);

    /// Return the number of shapes that currently exist.
    ///
    /// Number of shapes.
uint32_t      physx_PxPhysics_getNbShapes(physx_PxPhysics_Pod const* self_);
...
uint32_t      physx_PxPhysics_getShapes(physx_PxPhysics_Pod const* self_, physx_PxShape_Pod** userBuffer, uint32_t bufferSize, uint32_t startIndex);
...
physx_PxConstraint_Pod*      physx_PxPhysics_createConstraint_mut(physx_PxPhysics_Pod* self_, physx_PxRigidActor_Pod* actor0, physx_PxRigidActor_Pod* actor1, physx_PxConstraintConnector_Pod* connector, physx_PxConstraintShaderTable_Pod const* shaders, uint32_t dataSize);

    /// Creates a reduced-coordinate articulation with all fields initialized to their default values.
    ///
    /// the new articulation
physx_PxArticulationReducedCoordinate_Pod*      physx_PxPhysics_createArticulationReducedCoordinate_mut(physx_PxPhysics_Pod* self_);

    /// Creates a new rigid body material with certain default properties.
    ///
    /// The new rigid body material.
physx_PxMaterial_Pod*      physx_PxPhysics_createMaterial_mut(physx_PxPhysics_Pod* self_, float staticFriction, float dynamicFriction, float restitution);

    /// Return the number of rigid body materials that currently exist.
    ///
    /// Number of rigid body materials.
uint32_t      physx_PxPhysics_getNbMaterials(physx_PxPhysics_Pod const* self_);
...
uint32_t      physx_PxPhysics_getMaterials(physx_PxPhysics_Pod const* self_, physx_PxMaterial_Pod** userBuffer, uint32_t bufferSize, uint32_t startIndex);
...
void      physx_PxPhysics_registerDeletionListener_mut(physx_PxPhysics_Pod* self_, physx_PxDeletionListener_Pod* observer, uint8_t const* deletionEvents, bool restrictedObjectSet);

    /// Unregister a deletion listener.
    ///
    /// It is illegal to register or unregister a deletion listener while deletions are being processed.
void      physx_PxPhysics_unregisterDeletionListener_mut(physx_PxPhysics_Pod* self_, physx_PxDeletionListener_Pod* observer);
...
void      physx_PxPhysics_registerDeletionListenerObjects_mut(physx_PxPhysics_Pod* self_, physx_PxDeletionListener_Pod* observer, physx_PxBase_Pod const* const* observables, uint32_t observableCount);
    ...
    ///
    /// The deletion listener has to be registered through [`registerDeletionListener`]() and configured to support restricted object sets prior to this method being used.
void      physx_PxPhysics_unregisterDeletionListenerObjects_mut(physx_PxPhysics_Pod* self_, physx_PxDeletionListener_Pod* observer, physx_PxBase_Pod const* const* observables, uint32_t observableCount);
...
physx_PxInsertionCallback_Pod*      physx_PxPhysics_getPhysicsInsertionCallback_mut(physx_PxPhysics_Pod* self_);
...
physx_PxPhysics_Pod*      physx_phys_PxCreatePhysics(uint32_t version, physx_PxFoundation_Pod* foundation, physx_PxTolerancesScale_Pod const* scale, bool trackOutstandingAllocations, physx_PxPvd_Pod* pvd, physx_PxOmniPvd_Pod* omniPvd);

physx_PxPhysics_Pod*      physx_phys_PxGetPhysics();

physx_PxActorShape_Pod      physx_PxActorShape_new();

physx_PxActorShape_Pod      physx_PxActorShape_new_1(physx_PxRigidActor_Pod* a, physx_PxShape_Pod* s);

    /// constructor sets to default
physx_PxQueryCache_Pod      physx_PxQueryCache_new();

    /// constructor to set properties
physx_PxQueryCache_Pod      physx_PxQueryCache_new_1(physx_PxShape_Pod* s, uint32_t findex);

    /// default constructor
physx_PxQueryFilterData_Pod      physx_PxQueryFilterData_new();

    /// constructor to set both filter data and filter flags
physx_PxQueryFilterData_Pod      physx_PxQueryFilterData_new_1(physx_PxFilterData_Pod const* fd, uint16_t f);

    /// constructor to set filter flags only
physx_PxQueryFilterData_Pod      physx_PxQueryFilterData_new_2(uint16_t f);
...
int32_t      physx_PxQueryFilterCallback_preFilter_mut(physx_PxQueryFilterCallback_Pod* self_, physx_PxFilterData_Pod const* filterData, physx_PxShape_Pod const* shape, physx_PxRigidActor_Pod const* actor, uint16_t* queryFlags);
...
int32_t      physx_PxQueryFilterCallback_postFilter_mut(physx_PxQueryFilterCallback_Pod* self_, physx_PxFilterData_Pod const* filterData, physx_PxQueryHit_Pod const* hit, physx_PxShape_Pod const* shape, physx_PxRigidActor_Pod const* actor);

    /// virtual destructor
void      physx_PxQueryFilterCallback_delete(physx_PxQueryFilterCallback_Pod* self_);
...
void      physx_PxRigidDynamic_setKinematicTarget_mut(physx_PxRigidDynamic_Pod* self_, physx_PxTransform_Pod const* destination);
...
bool      physx_PxRigidDynamic_getKinematicTarget(physx_PxRigidDynamic_Pod const* self_, physx_PxTransform_Pod* target);
...
bool      physx_PxRigidDynamic_isSleeping(physx_PxRigidDynamic_Pod const* self_);
...
void      physx_PxRigidDynamic_setSleepThreshold_mut(physx_PxRigidDynamic_Pod* self_, float threshold);

    /// Returns the mass-normalized kinetic energy below which an actor may go to sleep.
    ///
    /// The energy threshold for sleeping.
float      physx_PxRigidDynamic_getSleepThreshold(physx_PxRigidDynamic_Pod const* self_);
...
void      physx_PxRigidDynamic_setStabilizationThreshold_mut(physx_PxRigidDynamic_Pod* self_, float threshold);
    ...
    ///
    /// The energy threshold for participating in stabilization.
float      physx_PxRigidDynamic_getStabilizationThreshold(physx_PxRigidDynamic_Pod const* self_);
...
uint8_t      physx_PxRigidDynamic_getRigidDynamicLockFlags(physx_PxRigidDynamic_Pod const* self_);
    ...
    /// Default:
    /// no flags are set
void      physx_PxRigidDynamic_setRigidDynamicLockFlag_mut(physx_PxRigidDynamic_Pod* self_, int32_t flag, bool value);

void      physx_PxRigidDynamic_setRigidDynamicLockFlags_mut(physx_PxRigidDynamic_Pod* self_, uint8_t flags);
    ...
    ///
    /// The linear velocity of the actor.
physx_PxVec3_Pod      physx_PxRigidDynamic_getLinearVelocity(physx_PxRigidDynamic_Pod const* self_);
...
void      physx_PxRigidDynamic_setLinearVelocity_mut(physx_PxRigidDynamic_Pod* self_, physx_PxVec3_Pod const* linVel, bool autowake);
    ...
    ///
    /// The angular velocity of the actor.
physx_PxVec3_Pod      physx_PxRigidDynamic_getAngularVelocity(physx_PxRigidDynamic_Pod const* self_);
    ...
    ///
    /// It is invalid to use this method if PxActorFlag::eDISABLE_SIMULATION is set.
void      physx_PxRigidDynamic_setAngularVelocity_mut(physx_PxRigidDynamic_Pod* self_, physx_PxVec3_Pod const* angVel, bool autowake);
...
void      physx_PxRigidDynamic_setWakeCounter_mut(physx_PxRigidDynamic_Pod* self_, float wakeCounterValue);
...
float      physx_PxRigidDynamic_getWakeCounter(physx_PxRigidDynamic_Pod const* self_);
    ...
    /// based on whether a target pose has been set (see the comment in [`isSleeping`]()).
void      physx_PxRigidDynamic_wakeUp_mut(physx_PxRigidDynamic_Pod* self_);
    ...
    /// It is invalid to use this method for kinematic actors since the sleep state for kinematics is defined
    /// based on whether a target pose has been set (see the comment in [`isSleeping`]()).
void      physx_PxRigidDynamic_putToSleep_mut(physx_PxRigidDynamic_Pod* self_);
...
void      physx_PxRigidDynamic_setSolverIterationCounts_mut(physx_PxRigidDynamic_Pod* self_, uint32_t minPositionIters, uint32_t minVelocityIters);

    /// Retrieves the solver iteration counts.
void      physx_PxRigidDynamic_getSolverIterationCounts(physx_PxRigidDynamic_Pod const* self_, uint32_t* minPositionIters, uint32_t* minVelocityIters);
...
float      physx_PxRigidDynamic_getContactReportThreshold(physx_PxRigidDynamic_Pod const* self_);

    /// Sets the force threshold for contact reports.
    ///
    /// See [`getContactReportThreshold`]().
void      physx_PxRigidDynamic_setContactReportThreshold_mut(physx_PxRigidDynamic_Pod* self_, float threshold);

char const*      physx_PxRigidDynamic_getConcreteTypeName(physx_PxRigidDynamic_Pod const* self_);

char const*      physx_PxRigidStatic_getConcreteTypeName(physx_PxRigidStatic_Pod const* self_);

    /// constructor sets to default.
physx_PxSceneQueryDesc_Pod      physx_PxSceneQueryDesc_new();

    /// (re)sets the structure to the default.
void      physx_PxSceneQueryDesc_setToDefault_mut(physx_PxSceneQueryDesc_Pod* self_);

    /// Returns true if the descriptor is valid.
    ///
    /// true if the current settings are valid.
bool      physx_PxSceneQueryDesc_isValid(physx_PxSceneQueryDesc_Pod const* self_);

    /// Sets the rebuild rate of the dynamic tree pruning structures.
void      physx_PxSceneQuerySystemBase_setDynamicTreeRebuildRateHint_mut(physx_PxSceneQuerySystemBase_Pod* self_, uint32_t dynamicTreeRebuildRateHint);

    /// Retrieves the rebuild rate of the dynamic tree pruning structures.
    ///
    /// The rebuild rate of the dynamic tree pruning structures.
uint32_t      physx_PxSceneQuerySystemBase_getDynamicTreeRebuildRateHint(physx_PxSceneQuerySystemBase_Pod const* self_);
...
void      physx_PxSceneQuerySystemBase_forceRebuildDynamicTree_mut(physx_PxSceneQuerySystemBase_Pod* self_, uint32_t prunerIndex);

    /// Sets scene query update mode
void      physx_PxSceneQuerySystemBase_setUpdateMode_mut(physx_PxSceneQuerySystemBase_Pod* self_, int32_t updateMode);

    /// Gets scene query update mode
    ///
    /// Current scene query update mode.
int32_t      physx_PxSceneQuerySystemBase_getUpdateMode(physx_PxSceneQuerySystemBase_Pod const* self_);
...
uint32_t      physx_PxSceneQuerySystemBase_getStaticTimestamp(physx_PxSceneQuerySystemBase_Pod const* self_);
...
void      physx_PxSceneQuerySystemBase_flushUpdates_mut(physx_PxSceneQuerySystemBase_Pod* self_);
...
bool      physx_PxSceneQuerySystemBase_overlap(physx_PxSceneQuerySystemBase_Pod const* self_, physx_PxGeometry_Pod const* geometry, physx_PxTransform_Pod const* pose, physx_PxOverlapCallback_Pod* hitCall, physx_PxQueryFilterData_Pod const* filterData, physx_PxQueryFilterCallback_Pod* filterCall, physx_PxQueryCache_Pod const* cache, uint32_t queryFlags);

    /// Sets scene query update mode
void      physx_PxSceneSQSystem_setSceneQueryUpdateMode_mut(physx_PxSceneSQSystem_Pod* self_, int32_t updateMode);

    /// Gets scene query update mode
    ///
    /// Current scene query update mode.
int32_t      physx_PxSceneSQSystem_getSceneQueryUpdateMode(physx_PxSceneSQSystem_Pod const* self_);

    /// Retrieves the scene's internal scene query timestamp, increased each time a change to the
    /// static scene query structure is performed.
    ///
    /// scene query static timestamp
uint32_t      physx_PxSceneSQSystem_getSceneQueryStaticTimestamp(physx_PxSceneSQSystem_Pod const* self_);

    /// Flushes any changes to the scene query representation.
void      physx_PxSceneSQSystem_flushQueryUpdates_mut(physx_PxSceneSQSystem_Pod* self_);

    /// Forces dynamic trees to be immediately rebuilt.
void      physx_PxSceneSQSystem_forceDynamicTreeRebuild_mut(physx_PxSceneSQSystem_Pod* self_, bool rebuildStaticStructure, bool rebuildDynamicStructure);

    /// Return the value of PxSceneQueryDesc::staticStructure that was set when creating the scene with PxPhysics::createScene
int32_t      physx_PxSceneSQSystem_getStaticStructure(physx_PxSceneSQSystem_Pod const* self_);

    /// Return the value of PxSceneQueryDesc::dynamicStructure that was set when creating the scene with PxPhysics::createScene
int32_t      physx_PxSceneSQSystem_getDynamicStructure(physx_PxSceneSQSystem_Pod const* self_);
    ...
    /// using this function.
void      physx_PxSceneSQSystem_sceneQueriesUpdate_mut(physx_PxSceneSQSystem_Pod* self_, physx_PxBaseTask_Pod* completionTask, bool controlSimulation);
...
bool      physx_PxSceneSQSystem_checkQueries_mut(physx_PxSceneSQSystem_Pod* self_, bool block);
...
bool      physx_PxSceneSQSystem_fetchQueries_mut(physx_PxSceneSQSystem_Pod* self_, bool block);

    /// Decrements the reference count of the object and releases it if the new reference count is zero.
void      physx_PxSceneQuerySystem_release_mut(physx_PxSceneQuerySystem_Pod* self_);

    /// Acquires a counted reference to this object.
    ///
    /// This method increases the reference count of the object by 1. Decrement the reference count by calling release()
void      physx_PxSceneQuerySystem_acquireReference_mut(physx_PxSceneQuerySystem_Pod* self_);
...
void      physx_PxSceneQuerySystem_preallocate_mut(physx_PxSceneQuerySystem_Pod* self_, uint32_t prunerIndex, uint32_t nbShapes);
...
void      physx_PxSceneQuerySystem_flushMemory_mut(physx_PxSceneQuerySystem_Pod* self_);

    /// Adds a shape to the SQ system.
    ///
    /// The same function is used to add either a regular shape, or a SQ compound shape.
void      physx_PxSceneQuerySystem_addSQShape_mut(physx_PxSceneQuerySystem_Pod* self_, physx_PxRigidActor_Pod const* actor, physx_PxShape_Pod const* shape, physx_PxBounds3_Pod const* bounds, physx_PxTransform_Pod const* transform, uint32_t const* compoundHandle, bool hasPruningStructure);

    /// Removes a shape from the SQ system.
    ///
    /// The same function is used to remove either a regular shape, or a SQ compound shape.
void      physx_PxSceneQuerySystem_removeSQShape_mut(physx_PxSceneQuerySystem_Pod* self_, physx_PxRigidActor_Pod const* actor, physx_PxShape_Pod const* shape);
...
void      physx_PxSceneQuerySystem_updateSQShape_mut(physx_PxSceneQuerySystem_Pod* self_, physx_PxRigidActor_Pod const* actor, physx_PxShape_Pod const* shape, physx_PxTransform_Pod const* transform);

    /// Adds a compound to the SQ system.
    ///
    /// SQ compound handle
uint32_t      physx_PxSceneQuerySystem_addSQCompound_mut(physx_PxSceneQuerySystem_Pod* self_, physx_PxRigidActor_Pod const* actor, physx_PxShape_Pod const** shapes, physx_PxBVH_Pod const* bvh, physx_PxTransform_Pod const* transforms);

    /// Removes a compound from the SQ system.
void      physx_PxSceneQuerySystem_removeSQCompound_mut(physx_PxSceneQuerySystem_Pod* self_, uint32_t compoundHandle);

    /// Updates a compound in the SQ system.
    ///
    /// The compound structures are immediately updated when the call occurs.
void      physx_PxSceneQuerySystem_updateSQCompound_mut(physx_PxSceneQuerySystem_Pod* self_, uint32_t compoundHandle, physx_PxTransform_Pod const* compoundTransform);

    /// Shift the data structures' origin by the specified vector.
    ///
    /// Please refer to the notes of the similar function in PxScene.
void      physx_PxSceneQuerySystem_shiftOrigin_mut(physx_PxSceneQuerySystem_Pod* self_, physx_PxVec3_Pod const* shift);

    /// Merges a pruning structure with the SQ system's internal pruners.
void      physx_PxSceneQuerySystem_merge_mut(physx_PxSceneQuerySystem_Pod* self_, physx_PxPruningStructure_Pod const* pruningStructure);
...
uint32_t      physx_PxSceneQuerySystem_getHandle(physx_PxSceneQuerySystem_Pod const* self_, physx_PxRigidActor_Pod const* actor, physx_PxShape_Pod const* shape, uint32_t* prunerIndex);
...
void      physx_PxSceneQuerySystem_sync_mut(physx_PxSceneQuerySystem_Pod* self_, uint32_t prunerIndex, uint32_t const* handles, uint32_t const* indices, physx_PxBounds3_Pod const* bounds, physx_PxTransformPadded_Pod const* transforms, uint32_t count, physx_PxBitMap_Pod const* ignoredIndices);
...
void      physx_PxSceneQuerySystem_finalizeUpdates_mut(physx_PxSceneQuerySystem_Pod* self_);
...
void*      physx_PxSceneQuerySystem_prepareSceneQueryBuildStep_mut(physx_PxSceneQuerySystem_Pod* self_, uint32_t prunerIndex);
...
void      physx_PxSceneQuerySystem_sceneQueryBuildStep_mut(physx_PxSceneQuerySystem_Pod* self_, void* handle);

physx_PxBroadPhaseDesc_Pod      physx_PxBroadPhaseDesc_new(int32_t type_);

bool      physx_PxBroadPhaseDesc_isValid(physx_PxBroadPhaseDesc_Pod const* self_);
...
physx_PxBroadPhaseUpdateData_Pod      physx_PxBroadPhaseUpdateData_new(uint32_t const* created, uint32_t nbCreated, uint32_t const* updated, uint32_t nbUpdated, uint32_t const* removed, uint32_t nbRemoved, physx_PxBounds3_Pod const* bounds, uint32_t const* groups, float const* distances, uint32_t capacity);
...
physx_PxBroadPhaseResults_Pod      physx_PxBroadPhaseResults_new();
    ...
    ///
    /// Number of regions
uint32_t      physx_PxBroadPhaseRegions_getNbRegions(physx_PxBroadPhaseRegions_Pod const* self_);

    /// Gets broad-phase regions.
    ///
    /// Number of written out regions.
uint32_t      physx_PxBroadPhaseRegions_getRegions(physx_PxBroadPhaseRegions_Pod const* self_, physx_PxBroadPhaseRegionInfo_Pod* userBuffer, uint32_t bufferSize, uint32_t startIndex);
...
uint32_t      physx_PxBroadPhaseRegions_addRegion_mut(physx_PxBroadPhaseRegions_Pod* self_, physx_PxBroadPhaseRegion_Pod const* region, bool populateRegion, physx_PxBounds3_Pod const* bounds, float const* distances);
    ...
    ///
    /// True if success
bool      physx_PxBroadPhaseRegions_removeRegion_mut(physx_PxBroadPhaseRegions_Pod* self_, uint32_t handle);

uint32_t      physx_PxBroadPhaseRegions_getNbOutOfBoundsObjects(physx_PxBroadPhaseRegions_Pod const* self_);

uint32_t const*      physx_PxBroadPhaseRegions_getOutOfBoundsObjects(physx_PxBroadPhaseRegions_Pod const* self_);

void      physx_PxBroadPhase_release_mut(physx_PxBroadPhase_Pod* self_);

    /// Gets the broadphase type.
    ///
    /// Broadphase type.
int32_t      physx_PxBroadPhase_getType(physx_PxBroadPhase_Pod const* self_);

    /// Gets broad-phase caps.
void      physx_PxBroadPhase_getCaps(physx_PxBroadPhase_Pod const* self_, physx_PxBroadPhaseCaps_Pod* caps);
    ...
    ///
    /// Region API, or NULL.
physx_PxBroadPhaseRegions_Pod*      physx_PxBroadPhase_getRegions_mut(physx_PxBroadPhase_Pod* self_);
...
physx_PxAllocatorCallback_Pod*      physx_PxBroadPhase_getAllocator_mut(physx_PxBroadPhase_Pod* self_);

    /// Retrieves the profiler's context ID.
    ///
    /// The context ID.
uint64_t      physx_PxBroadPhase_getContextID(physx_PxBroadPhase_Pod const* self_);
...
void      physx_PxBroadPhase_setScratchBlock_mut(physx_PxBroadPhase_Pod* self_, void* scratchBlock, uint32_t size);
...
void      physx_PxBroadPhase_update_mut(physx_PxBroadPhase_Pod* self_, physx_PxBroadPhaseUpdateData_Pod const* updateData, physx_PxBaseTask_Pod* continuation);
...
void      physx_PxBroadPhase_fetchResults_mut(physx_PxBroadPhase_Pod* self_, physx_PxBroadPhaseResults_Pod* results);
...
void      physx_PxBroadPhase_update_mut_1(physx_PxBroadPhase_Pod* self_, physx_PxBroadPhaseResults_Pod* results, physx_PxBroadPhaseUpdateData_Pod const* updateData);
...
physx_PxBroadPhase_Pod*      physx_phys_PxCreateBroadPhase(physx_PxBroadPhaseDesc_Pod const* desc);

void      physx_PxAABBManager_release_mut(physx_PxAABBManager_Pod* self_);

    /// Retrieves the underlying broadphase.
    ///
    /// The managed broadphase.
physx_PxBroadPhase_Pod*      physx_PxAABBManager_getBroadPhase_mut(physx_PxAABBManager_Pod* self_);
...
physx_PxBounds3_Pod const*      physx_PxAABBManager_getBounds(physx_PxAABBManager_Pod const* self_);
...
float const*      physx_PxAABBManager_getDistances(physx_PxAABBManager_Pod const* self_);

    /// Retrieves the managed filter groups.
    ///
    /// The managed object groups.
uint32_t const*      physx_PxAABBManager_getGroups(physx_PxAABBManager_Pod const* self_);
...
uint32_t      physx_PxAABBManager_getCapacity(physx_PxAABBManager_Pod const* self_);
...
void      physx_PxAABBManager_addObject_mut(physx_PxAABBManager_Pod* self_, uint32_t index, physx_PxBounds3_Pod const* bounds, uint32_t group, float distance);

    /// Removes an object from the manager.
void      physx_PxAABBManager_removeObject_mut(physx_PxAABBManager_Pod* self_, uint32_t index);
...
void      physx_PxAABBManager_updateObject_mut(physx_PxAABBManager_Pod* self_, uint32_t index, physx_PxBounds3_Pod const* bounds, float const* distance);
    ...
    /// task to the function. It is legal to pass NULL there, but the underlying (CPU) implementations will
    /// then run single-threaded.
void      physx_PxAABBManager_update_mut(physx_PxAABBManager_Pod* self_, physx_PxBaseTask_Pod* continuation);

    /// Retrieves the broadphase results after an update.
    ///
    /// This should be called once after each update call to retrieve the results of the broadphase. The
    /// results are incremental, i.e. the system only returns new and lost pairs, not all current pairs.
void      physx_PxAABBManager_fetchResults_mut(physx_PxAABBManager_Pod* self_, physx_PxBroadPhaseResults_Pod* results);

    /// Helper for single-threaded updates.
    ///
    /// This short helper function performs a single-theaded update and reports the results in a single call.
void      physx_PxAABBManager_update_mut_1(physx_PxAABBManager_Pod* self_, physx_PxBroadPhaseResults_Pod* results);
...
physx_PxAABBManager_Pod*      physx_phys_PxCreateAABBManager(physx_PxBroadPhase_Pod* broadphase);

    /// constructor sets to default
physx_PxSceneLimits_Pod      physx_PxSceneLimits_new();

    /// (re)sets the structure to the default
void      physx_PxSceneLimits_setToDefault_mut(physx_PxSceneLimits_Pod* self_);

    /// Returns true if the descriptor is valid.
    ///
    /// true if the current settings are valid.
bool      physx_PxSceneLimits_isValid(physx_PxSceneLimits_Pod const* self_);

physx_PxgDynamicsMemoryConfig_Pod      physx_PxgDynamicsMemoryConfig_new();

bool      physx_PxgDynamicsMemoryConfig_isValid(physx_PxgDynamicsMemoryConfig_Pod const* self_);

    /// constructor sets to default.
physx_PxSceneDesc_Pod      physx_PxSceneDesc_new(physx_PxTolerancesScale_Pod const* scale);

    /// (re)sets the structure to the default.
void      physx_PxSceneDesc_setToDefault_mut(physx_PxSceneDesc_Pod* self_, physx_PxTolerancesScale_Pod const* scale);

    /// Returns true if the descriptor is valid.
    ///
    /// true if the current settings are valid.
bool      physx_PxSceneDesc_isValid(physx_PxSceneDesc_Pod const* self_);

physx_PxTolerancesScale_Pod const*      physx_PxSceneDesc_getTolerancesScale(physx_PxSceneDesc_Pod const* self_);

    /// Get number of broadphase volumes added for the current simulation step.
    ///
    /// Number of broadphase volumes added.
uint32_t      physx_PxSimulationStatistics_getNbBroadPhaseAdds(physx_PxSimulationStatistics_Pod const* self_);

    /// Get number of broadphase volumes removed for the current simulation step.
    ///
    /// Number of broadphase volumes removed.
uint32_t      physx_PxSimulationStatistics_getNbBroadPhaseRemoves(physx_PxSimulationStatistics_Pod const* self_);
...
uint32_t      physx_PxSimulationStatistics_getRbPairStats(physx_PxSimulationStatistics_Pod const* self_, int32_t pairType, int32_t g0, int32_t g1);

physx_PxSimulationStatistics_Pod      physx_PxSimulationStatistics_new();

    /// Sets the PVD flag. See PxPvdSceneFlag.
void      physx_PxPvdSceneClient_setScenePvdFlag_mut(physx_PxPvdSceneClient_Pod* self_, int32_t flag, bool value);

    /// Sets the PVD flags. See PxPvdSceneFlags.
void      physx_PxPvdSceneClient_setScenePvdFlags_mut(physx_PxPvdSceneClient_Pod* self_, uint8_t flags);

    /// Retrieves the PVD flags. See PxPvdSceneFlags.
uint8_t      physx_PxPvdSceneClient_getScenePvdFlags(physx_PxPvdSceneClient_Pod const* self_);

    /// update camera on PVD application's render window
void      physx_PxPvdSceneClient_updateCamera_mut(physx_PxPvdSceneClient_Pod* self_, char const* name, physx_PxVec3_Pod const* origin, physx_PxVec3_Pod const* up, physx_PxVec3_Pod const* target);

    /// draw points on PVD application's render window
void      physx_PxPvdSceneClient_drawPoints_mut(physx_PxPvdSceneClient_Pod* self_, physx_PxDebugPoint_Pod const* points, uint32_t count);

    /// draw lines on PVD application's render window
void      physx_PxPvdSceneClient_drawLines_mut(physx_PxPvdSceneClient_Pod* self_, physx_PxDebugLine_Pod const* lines, uint32_t count);

    /// draw triangles on PVD application's render window
void      physx_PxPvdSceneClient_drawTriangles_mut(physx_PxPvdSceneClient_Pod* self_, physx_PxDebugTriangle_Pod const* triangles, uint32_t count);

    /// draw text on PVD application's render window
void      physx_PxPvdSceneClient_drawText_mut(physx_PxPvdSceneClient_Pod* self_, physx_PxDebugText_Pod const* text);

physx_PxDominanceGroupPair_Pod      physx_PxDominanceGroupPair_new(uint8_t a, uint8_t b);

void      physx_PxBroadPhaseCallback_delete(physx_PxBroadPhaseCallback_Pod* self_);

    /// Out-of-bounds notification.
    ///
    /// This function is called when an object leaves the broad-phase.
void      physx_PxBroadPhaseCallback_onObjectOutOfBounds_mut(physx_PxBroadPhaseCallback_Pod* self_, physx_PxShape_Pod* shape, physx_PxActor_Pod* actor);

    /// Out-of-bounds notification.
    ///
    /// This function is called when an aggregate leaves the broad-phase.
void      physx_PxBroadPhaseCallback_onObjectOutOfBounds_mut_1(physx_PxBroadPhaseCallback_Pod* self_, physx_PxAggregate_Pod* aggregate);
...
void      physx_PxScene_release_mut(physx_PxScene_Pod* self_);
...
void      physx_PxScene_setFlag_mut(physx_PxScene_Pod* self_, int32_t flag, bool value);

    /// Get the scene flags.
    ///
    /// The scene flags. See [`PxSceneFlag`]
uint32_t      physx_PxScene_getFlags(physx_PxScene_Pod const* self_);
...
void      physx_PxScene_setLimits_mut(physx_PxScene_Pod* self_, physx_PxSceneLimits_Pod const* limits);

    /// Get current scene limits.
    ///
    /// Current scene limits.
physx_PxSceneLimits_Pod      physx_PxScene_getLimits(physx_PxScene_Pod const* self_);

    /// Call this method to retrieve the Physics SDK.
    ///
    /// The physics SDK this scene is associated with.
physx_PxPhysics_Pod*      physx_PxScene_getPhysics_mut(physx_PxScene_Pod* self_);

    /// Retrieves the scene's internal timestamp, increased each time a simulation step is completed.
    ///
    /// scene timestamp
uint32_t      physx_PxScene_getTimestamp(physx_PxScene_Pod const* self_);
    ...
    ///
    /// True if success
bool      physx_PxScene_addArticulation_mut(physx_PxScene_Pod* self_, physx_PxArticulationReducedCoordinate_Pod* articulation);
...
void      physx_PxScene_removeArticulation_mut(physx_PxScene_Pod* self_, physx_PxArticulationReducedCoordinate_Pod* articulation, bool wakeOnLostTouch);
    ...
    ///
    /// True if success
bool      physx_PxScene_addActor_mut(physx_PxScene_Pod* self_, physx_PxActor_Pod* actor, physx_PxBVH_Pod const* bvh);
    ...
    ///
    /// True if success
bool      physx_PxScene_addActors_mut(physx_PxScene_Pod* self_, physx_PxActor_Pod* const* actors, uint32_t nbActors);
    ...
    ///
    /// True if success
bool      physx_PxScene_addActors_mut_1(physx_PxScene_Pod* self_, physx_PxPruningStructure_Pod const* pruningStructure);
...
void      physx_PxScene_removeActor_mut(physx_PxScene_Pod* self_, physx_PxActor_Pod* actor, bool wakeOnLostTouch);
    ...
    ///
    /// If the actor is a PxRigidActor then all assigned PxConstraint objects will get removed from the scene automatically.
void      physx_PxScene_removeActors_mut(physx_PxScene_Pod* self_, physx_PxActor_Pod* const* actors, uint32_t nbActors, bool wakeOnLostTouch);
    ...
    ///
    /// True if success
bool      physx_PxScene_addAggregate_mut(physx_PxScene_Pod* self_, physx_PxAggregate_Pod* aggregate);
...
void      physx_PxScene_removeAggregate_mut(physx_PxScene_Pod* self_, physx_PxAggregate_Pod* aggregate, bool wakeOnLostTouch);
    ...
    ///
    /// True if success
bool      physx_PxScene_addCollection_mut(physx_PxScene_Pod* self_, physx_PxCollection_Pod const* collection);

    /// Retrieve the number of actors of certain types in the scene. For supported types, see PxActorTypeFlags.
    ///
    /// the number of actors.
uint32_t      physx_PxScene_getNbActors(physx_PxScene_Pod const* self_, uint16_t types);
...
uint32_t      physx_PxScene_getActors(physx_PxScene_Pod const* self_, uint16_t types, physx_PxActor_Pod** userBuffer, uint32_t bufferSize, uint32_t startIndex);
...
physx_PxActor_Pod**      physx_PxScene_getActiveActors_mut(physx_PxScene_Pod* self_, uint32_t* nbActorsOut);

    /// Returns the number of articulations in the scene.
    ///
    /// the number of articulations in this scene.
uint32_t      physx_PxScene_getNbArticulations(physx_PxScene_Pod const* self_);

    /// Retrieve all the articulations in the scene.
    ///
    /// Number of articulations written to the buffer.
uint32_t      physx_PxScene_getArticulations(physx_PxScene_Pod const* self_, physx_PxArticulationReducedCoordinate_Pod** userBuffer, uint32_t bufferSize, uint32_t startIndex);

    /// Returns the number of constraint shaders in the scene.
    ///
    /// the number of constraint shaders in this scene.
uint32_t      physx_PxScene_getNbConstraints(physx_PxScene_Pod const* self_);

    /// Retrieve all the constraint shaders in the scene.
    ///
    /// Number of constraint shaders written to the buffer.
uint32_t      physx_PxScene_getConstraints(physx_PxScene_Pod const* self_, physx_PxConstraint_Pod** userBuffer, uint32_t bufferSize, uint32_t startIndex);

    /// Returns the number of aggregates in the scene.
    ///
    /// the number of aggregates in this scene.
uint32_t      physx_PxScene_getNbAggregates(physx_PxScene_Pod const* self_);

    /// Retrieve all the aggregates in the scene.
    ///
    /// Number of aggregates written to the buffer.
uint32_t      physx_PxScene_getAggregates(physx_PxScene_Pod const* self_, physx_PxAggregate_Pod** userBuffer, uint32_t bufferSize, uint32_t startIndex);
...
void      physx_PxScene_setDominanceGroupPair_mut(physx_PxScene_Pod* self_, uint8_t group1, uint8_t group2, physx_PxDominanceGroupPair_Pod const* dominance);

    /// Samples the dominance matrix.
physx_PxDominanceGroupPair_Pod      physx_PxScene_getDominanceGroupPair(physx_PxScene_Pod const* self_, uint8_t group1, uint8_t group2);

    /// Return the cpu dispatcher that was set in PxSceneDesc::cpuDispatcher when creating the scene with PxPhysics::createScene
physx_PxCpuDispatcher_Pod*      physx_PxScene_getCpuDispatcher(physx_PxScene_Pod const* self_);
...
uint8_t      physx_PxScene_createClient_mut(physx_PxScene_Pod* self_);
...
void      physx_PxScene_setSimulationEventCallback_mut(physx_PxScene_Pod* self_, physx_PxSimulationEventCallback_Pod* callback);
...
physx_PxSimulationEventCallback_Pod*      physx_PxScene_getSimulationEventCallback(physx_PxScene_Pod const* self_);

    /// Sets a user callback object, which receives callbacks on all contacts generated for specified actors.
    ///
    /// Do not set the callback while the simulation is running. Calls to this method while the simulation is running will be ignored.
void      physx_PxScene_setContactModifyCallback_mut(physx_PxScene_Pod* self_, physx_PxContactModifyCallback_Pod* callback);

    /// Sets a user callback object, which receives callbacks on all CCD contacts generated for specified actors.
    ///
    /// Do not set the callback while the simulation is running. Calls to this method while the simulation is running will be ignored.
void      physx_PxScene_setCCDContactModifyCallback_mut(physx_PxScene_Pod* self_, physx_PxCCDContactModifyCallback_Pod* callback);
...
physx_PxContactModifyCallback_Pod*      physx_PxScene_getContactModifyCallback(physx_PxScene_Pod const* self_);

    /// Retrieves the PxCCDContactModifyCallback pointer set with setContactModifyCallback().
    ///
    /// The current user contact modify callback pointer. See [`PxContactModifyCallback`].
physx_PxCCDContactModifyCallback_Pod*      physx_PxScene_getCCDContactModifyCallback(physx_PxScene_Pod const* self_);

    /// Sets a broad-phase user callback object.
    ///
    /// Do not set the callback while the simulation is running. Calls to this method while the simulation is running will be ignored.
void      physx_PxScene_setBroadPhaseCallback_mut(physx_PxScene_Pod* self_, physx_PxBroadPhaseCallback_Pod* callback);
...
physx_PxBroadPhaseCallback_Pod*      physx_PxScene_getBroadPhaseCallback(physx_PxScene_Pod const* self_);
...
void      physx_PxScene_setFilterShaderData_mut(physx_PxScene_Pod* self_, void const* data, uint32_t dataSize);
...
void const*      physx_PxScene_getFilterShaderData(physx_PxScene_Pod const* self_);

    /// Gets the size of the shared global filter data ([`PxSceneDesc`].filterShaderData)
    ///
    /// Size of shared filter data [bytes].
uint32_t      physx_PxScene_getFilterShaderDataSize(physx_PxScene_Pod const* self_);
    ...
    ///
    /// True if success
bool      physx_PxScene_resetFiltering_mut(physx_PxScene_Pod* self_, physx_PxActor_Pod* actor);
    ...
    /// Sleeping:
    /// Does wake up the actor.
bool      physx_PxScene_resetFiltering_mut_1(physx_PxScene_Pod* self_, physx_PxRigidActor_Pod* actor, physx_PxShape_Pod* const* shapes, uint32_t shapeCount);

    /// Gets the pair filtering mode for kinematic-kinematic pairs.
    ///
    /// Filtering mode for kinematic-kinematic pairs.
int32_t      physx_PxScene_getKinematicKinematicFilteringMode(physx_PxScene_Pod const* self_);

    /// Gets the pair filtering mode for static-kinematic pairs.
    ///
    /// Filtering mode for static-kinematic pairs.
int32_t      physx_PxScene_getStaticKinematicFilteringMode(physx_PxScene_Pod const* self_);
    ...
    ///
    /// True if success
bool      physx_PxScene_simulate_mut(physx_PxScene_Pod* self_, float elapsedTime, physx_PxBaseTask_Pod* completionTask, void* scratchMemBlock, uint32_t scratchMemBlockSize, bool controlSimulation);
    ...
    ///
    /// True if success
bool      physx_PxScene_advance_mut(physx_PxScene_Pod* self_, physx_PxBaseTask_Pod* completionTask);
    ...
    ///
    /// True if success
bool      physx_PxScene_collide_mut(physx_PxScene_Pod* self_, float elapsedTime, physx_PxBaseTask_Pod* completionTask, void* scratchMemBlock, uint32_t scratchMemBlockSize, bool controlSimulation);
    ...
    ///
    /// True if the results are available.
bool      physx_PxScene_checkResults_mut(physx_PxScene_Pod* self_, bool block);
    ...
    /// message.
bool      physx_PxScene_fetchCollision_mut(physx_PxScene_Pod* self_, bool block);

    /// This is the big brother to checkResults() it basically does the following:
    ///
    /// True if the results have been fetched.
bool      physx_PxScene_fetchResults_mut(physx_PxScene_Pod* self_, bool block, uint32_t* errorState);
    ...
    ///
    /// True if the results have been fetched.
bool      physx_PxScene_fetchResultsStart_mut(physx_PxScene_Pod* self_, physx_PxContactPairHeader_Pod const** contactPairs, uint32_t* nbContactPairs, bool block);
...
void      physx_PxScene_processCallbacks_mut(physx_PxScene_Pod* self_, physx_PxBaseTask_Pod* continuation);
...
void      physx_PxScene_fetchResultsFinish_mut(physx_PxScene_Pod* self_, uint32_t* errorState);

    /// This call performs the synchronization of particle system data copies.
void      physx_PxScene_fetchResultsParticleSystem_mut(physx_PxScene_Pod* self_);
...
void      physx_PxScene_flushSimulation_mut(physx_PxScene_Pod* self_, bool sendPendingReports);
    ...
    /// NOT
    /// wake the actor up automatically.
void      physx_PxScene_setGravity_mut(physx_PxScene_Pod* self_, physx_PxVec3_Pod const* vec);

    /// Retrieves the current gravity setting.
    ///
    /// The current gravity for the scene.
physx_PxVec3_Pod      physx_PxScene_getGravity(physx_PxScene_Pod const* self_);

    /// Set the bounce threshold velocity.  Collision speeds below this threshold will not cause a bounce.
    ///
    /// Do not use this method while the simulation is running.
void      physx_PxScene_setBounceThresholdVelocity_mut(physx_PxScene_Pod* self_, float t);

    /// Return the bounce threshold velocity.
float      physx_PxScene_getBounceThresholdVelocity(physx_PxScene_Pod const* self_);

    /// Sets the maximum number of CCD passes
    ///
    /// Do not use this method while the simulation is running.
void      physx_PxScene_setCCDMaxPasses_mut(physx_PxScene_Pod* self_, uint32_t ccdMaxPasses);

    /// Gets the maximum number of CCD passes.
    ///
    /// The maximum number of CCD passes.
uint32_t      physx_PxScene_getCCDMaxPasses(physx_PxScene_Pod const* self_);

    /// Set the maximum CCD separation.
    ///
    /// Do not use this method while the simulation is running.
void      physx_PxScene_setCCDMaxSeparation_mut(physx_PxScene_Pod* self_, float t);

    /// Gets the maximum CCD separation.
    ///
    /// The maximum CCD separation.
float      physx_PxScene_getCCDMaxSeparation(physx_PxScene_Pod const* self_);

    /// Set the CCD threshold.
    ///
    /// Do not use this method while the simulation is running.
void      physx_PxScene_setCCDThreshold_mut(physx_PxScene_Pod* self_, float t);

    /// Gets the CCD threshold.
    ///
    /// The CCD threshold.
float      physx_PxScene_getCCDThreshold(physx_PxScene_Pod const* self_);

    /// Set the max bias coefficient.
    ///
    /// Do not use this method while the simulation is running.
void      physx_PxScene_setMaxBiasCoefficient_mut(physx_PxScene_Pod* self_, float t);

    /// Gets the max bias coefficient.
    ///
    /// The max bias coefficient.
float      physx_PxScene_getMaxBiasCoefficient(physx_PxScene_Pod const* self_);

    /// Set the friction offset threshold.
    ///
    /// Do not use this method while the simulation is running.
void      physx_PxScene_setFrictionOffsetThreshold_mut(physx_PxScene_Pod* self_, float t);

    /// Gets the friction offset threshold.
float      physx_PxScene_getFrictionOffsetThreshold(physx_PxScene_Pod const* self_);

    /// Set the friction correlation distance.
    ///
    /// Do not use this method while the simulation is running.
void      physx_PxScene_setFrictionCorrelationDistance_mut(physx_PxScene_Pod* self_, float t);

    /// Gets the friction correlation distance.
float      physx_PxScene_getFrictionCorrelationDistance(physx_PxScene_Pod const* self_);

    /// Return the friction model.
int32_t      physx_PxScene_getFrictionType(physx_PxScene_Pod const* self_);

    /// Return the solver model.
int32_t      physx_PxScene_getSolverType(physx_PxScene_Pod const* self_);
...
bool      physx_PxScene_setVisualizationParameter_mut(physx_PxScene_Pod* self_, int32_t param, float value);

    /// Function that lets you query debug visualization parameters.
    ///
    /// The value of the parameter.
float      physx_PxScene_getVisualizationParameter(physx_PxScene_Pod const* self_, int32_t paramEnum);
    ...
    ///
    /// Do not use this method while the simulation is running.
void      physx_PxScene_setVisualizationCullingBox_mut(physx_PxScene_Pod* self_, physx_PxBounds3_Pod const* box_);

    /// Retrieves the visualization culling box.
    ///
    /// the box to which the geometry will be culled.
physx_PxBounds3_Pod      physx_PxScene_getVisualizationCullingBox(physx_PxScene_Pod const* self_);
    ...
    ///
    /// The render buffer.
physx_PxRenderBuffer_Pod const*      physx_PxScene_getRenderBuffer_mut(physx_PxScene_Pod* self_);

    /// Call this method to retrieve statistics for the current simulation step.
    ///
    /// Do not use this method while the simulation is running. Calls to this method while the simulation is running will be ignored.
void      physx_PxScene_getSimulationStatistics(physx_PxScene_Pod const* self_, physx_PxSimulationStatistics_Pod* stats);

    /// Returns broad-phase type.
    ///
    /// Broad-phase type
int32_t      physx_PxScene_getBroadPhaseType(physx_PxScene_Pod const* self_);

    /// Gets broad-phase caps.
    ///
    /// True if success
bool      physx_PxScene_getBroadPhaseCaps(physx_PxScene_Pod const* self_, physx_PxBroadPhaseCaps_Pod* caps);

    /// Returns number of regions currently registered in the broad-phase.
    ///
    /// Number of regions
uint32_t      physx_PxScene_getNbBroadPhaseRegions(physx_PxScene_Pod const* self_);

    /// Gets broad-phase regions.
    ///
    /// Number of written out regions
uint32_t      physx_PxScene_getBroadPhaseRegions(physx_PxScene_Pod const* self_, physx_PxBroadPhaseRegionInfo_Pod* userBuffer, uint32_t bufferSize, uint32_t startIndex);
    ...
    ///
    /// Handle for newly created region, or 0xffffffff in case of failure.
uint32_t      physx_PxScene_addBroadPhaseRegion_mut(physx_PxScene_Pod* self_, physx_PxBroadPhaseRegion_Pod const* region, bool populateRegion);
    ...
    ///
    /// True if success
bool      physx_PxScene_removeBroadPhaseRegion_mut(physx_PxScene_Pod* self_, uint32_t handle);

    /// Get the task manager associated with this scene
    ///
    /// the task manager associated with the scene
physx_PxTaskManager_Pod*      physx_PxScene_getTaskManager(physx_PxScene_Pod const* self_);
...
void      physx_PxScene_lockRead_mut(physx_PxScene_Pod* self_, char const* file, uint32_t line);

    /// Unlock the scene from reading.
    ///
    /// Each unlockRead() must be paired with a lockRead() from the same thread.
void      physx_PxScene_unlockRead_mut(physx_PxScene_Pod* self_);
    ...
    /// lockRead().
void      physx_PxScene_lockWrite_mut(physx_PxScene_Pod* self_, char const* file, uint32_t line);

    /// Unlock the scene from writing.
    ///
    /// Each unlockWrite() must be paired with a lockWrite() from the same thread.
void      physx_PxScene_unlockWrite_mut(physx_PxScene_Pod* self_);
    ...
    ///
    /// Do not use this method while the simulation is running.
void      physx_PxScene_setNbContactDataBlocks_mut(physx_PxScene_Pod* self_, uint32_t numBlocks);
...
uint32_t      physx_PxScene_getNbContactDataBlocksUsed(physx_PxScene_Pod const* self_);
...
uint32_t      physx_PxScene_getMaxNbContactDataBlocksUsed(physx_PxScene_Pod const* self_);
...
uint32_t      physx_PxScene_getContactReportStreamBufferSize(physx_PxScene_Pod const* self_);

    /// Sets the number of actors required to spawn a separate rigid body solver thread.
    ///
    /// Do not use this method while the simulation is running.
void      physx_PxScene_setSolverBatchSize_mut(physx_PxScene_Pod* self_, uint32_t solverBatchSize);
...
uint32_t      physx_PxScene_getSolverBatchSize(physx_PxScene_Pod const* self_);

    /// Sets the number of articulations required to spawn a separate rigid body solver thread.
    ///
    /// Do not use this method while the simulation is running.
void      physx_PxScene_setSolverArticulationBatchSize_mut(physx_PxScene_Pod* self_, uint32_t solverBatchSize);
...
uint32_t      physx_PxScene_getSolverArticulationBatchSize(physx_PxScene_Pod const* self_);

    /// Returns the wake counter reset value.
    ///
    /// Wake counter reset value
float      physx_PxScene_getWakeCounterResetValue(physx_PxScene_Pod const* self_);
...
void      physx_PxScene_shiftOrigin_mut(physx_PxScene_Pod* self_, physx_PxVec3_Pod const* shift);

    /// Returns the Pvd client associated with the scene.
    ///
    /// the client, NULL if no PVD supported.
physx_PxPvdSceneClient_Pod*      physx_PxScene_getScenePvdClient_mut(physx_PxScene_Pod* self_);

    /// Copy GPU articulation data from the internal GPU buffer to a user-provided device buffer.
void      physx_PxScene_copyArticulationData_mut(physx_PxScene_Pod* self_, void* data, void* index, int32_t dataType, uint32_t nbCopyArticulations, void* copyEvent);

    /// Apply GPU articulation data from a user-provided device buffer to the internal GPU buffer.
void      physx_PxScene_applyArticulationData_mut(physx_PxScene_Pod* self_, void* data, void* index, int32_t dataType, uint32_t nbUpdatedArticulations, void* waitEvent, void* signalEvent);

    /// Copy GPU softbody data from the internal GPU buffer to a user-provided device buffer.
void      physx_PxScene_copySoftBodyData_mut(physx_PxScene_Pod* self_, void** data, void* dataSizes, void* softBodyIndices, int32_t flag, uint32_t nbCopySoftBodies, uint32_t maxSize, void* copyEvent);

    /// Apply user-provided data to the internal softbody system.
void      physx_PxScene_applySoftBodyData_mut(physx_PxScene_Pod* self_, void** data, void* dataSizes, void* softBodyIndices, int32_t flag, uint32_t nbUpdatedSoftBodies, uint32_t maxSize, void* applyEvent);
...
void      physx_PxScene_copyContactData_mut(physx_PxScene_Pod* self_, void* data, uint32_t maxContactPairs, void* numContactPairs, void* copyEvent);

    /// Copy GPU rigid body data from the internal GPU buffer to a user-provided device buffer.
void      physx_PxScene_copyBodyData_mut(physx_PxScene_Pod* self_, physx_PxGpuBodyData_Pod* data, physx_PxGpuActorPair_Pod* index, uint32_t nbCopyActors, void* copyEvent);

    /// Apply user-provided data to rigid body.
void      physx_PxScene_applyActorData_mut(physx_PxScene_Pod* self_, void* data, physx_PxGpuActorPair_Pod* index, int32_t flag, uint32_t nbUpdatedActors, void* waitEvent, void* signalEvent);
...
void      physx_PxScene_computeDenseJacobians_mut(physx_PxScene_Pod* self_, physx_PxIndexDataPair_Pod const* indices, uint32_t nbIndices, void* computeEvent);
...
void      physx_PxScene_computeGeneralizedMassMatrices_mut(physx_PxScene_Pod* self_, physx_PxIndexDataPair_Pod const* indices, uint32_t nbIndices, void* computeEvent);
...
void      physx_PxScene_computeGeneralizedGravityForces_mut(physx_PxScene_Pod* self_, physx_PxIndexDataPair_Pod const* indices, uint32_t nbIndices, void* computeEvent);
    ...
    ///
    /// The user must ensure that adequate space is provided for each articulation.
void      physx_PxScene_computeCoriolisAndCentrifugalForces_mut(physx_PxScene_Pod* self_, physx_PxIndexDataPair_Pod const* indices, uint32_t nbIndices, void* computeEvent);

physx_PxgDynamicsMemoryConfig_Pod      physx_PxScene_getGpuDynamicsConfig(physx_PxScene_Pod const* self_);
...
void      physx_PxScene_applyParticleBufferData_mut(physx_PxScene_Pod* self_, uint32_t const* indices, physx_PxGpuParticleBufferIndexPair_Pod const* bufferIndexPair, uint32_t const* flags, uint32_t nbUpdatedBuffers, void* waitEvent, void* signalEvent);

    /// Constructor
physx_PxSceneReadLock_Pod*      physx_PxSceneReadLock_new_alloc(physx_PxScene_Pod* scene, char const* file, uint32_t line);

void      physx_PxSceneReadLock_delete(physx_PxSceneReadLock_Pod* self_);

    /// Constructor
physx_PxSceneWriteLock_Pod*      physx_PxSceneWriteLock_new_alloc(physx_PxScene_Pod* scene, char const* file, uint32_t line);

void      physx_PxSceneWriteLock_delete(physx_PxSceneWriteLock_Pod* self_);
...
bool      physx_PxContactPairExtraDataIterator_nextItemSet_mut(physx_PxContactPairExtraDataIterator_Pod* self_);
...
uint32_t      physx_PxContactPair_extractContacts(physx_PxContactPair_Pod const* self_, physx_PxContactPairPoint_Pod* userBuffer, uint32_t bufferSize);
...
void      physx_PxContactPair_bufferContacts(physx_PxContactPair_Pod const* self_, physx_PxContactPair_Pod* newPair, uint8_t* bufferMemory);

uint32_t const*      physx_PxContactPair_getInternalFaceIndices(physx_PxContactPair_Pod const* self_);

physx_PxTriggerPair_Pod      physx_PxTriggerPair_new();

physx_PxConstraintInfo_Pod      physx_PxConstraintInfo_new();

physx_PxConstraintInfo_Pod      physx_PxConstraintInfo_new_1(physx_PxConstraint_Pod* c, void* extRef, uint32_t t);
...
void      physx_PxSimulationEventCallback_onConstraintBreak_mut(physx_PxSimulationEventCallback_Pod* self_, physx_PxConstraintInfo_Pod* constraints, uint32_t count);
...
void      physx_PxSimulationEventCallback_onWake_mut(physx_PxSimulationEventCallback_Pod* self_, physx_PxActor_Pod** actors, uint32_t count);
...
void      physx_PxSimulationEventCallback_onSleep_mut(physx_PxSimulationEventCallback_Pod* self_, physx_PxActor_Pod** actors, uint32_t count);
...
void      physx_PxSimulationEventCallback_onContact_mut(physx_PxSimulationEventCallback_Pod* self_, physx_PxContactPairHeader_Pod const* pairHeader, physx_PxContactPair_Pod const* pairs, uint32_t nbPairs);
...
void      physx_PxSimulationEventCallback_onTrigger_mut(physx_PxSimulationEventCallback_Pod* self_, physx_PxTriggerPair_Pod* pairs, uint32_t count);
...
void      physx_PxSimulationEventCallback_onAdvance_mut(physx_PxSimulationEventCallback_Pod* self_, physx_PxRigidBody_Pod const* const* bodyBuffer, physx_PxTransform_Pod const* poseBuffer, uint32_t count);

void      physx_PxSimulationEventCallback_delete(physx_PxSimulationEventCallback_Pod* self_);

physx_PxFEMParameters_Pod      physx_PxFEMParameters_new();

    /// Release this object.
void      physx_PxPruningStructure_release_mut(physx_PxPruningStructure_Pod* self_);
...
uint32_t      physx_PxPruningStructure_getRigidActors(physx_PxPruningStructure_Pod const* self_, physx_PxRigidActor_Pod** userBuffer, uint32_t bufferSize, uint32_t startIndex);
...
uint32_t      physx_PxPruningStructure_getNbRigidActors(physx_PxPruningStructure_Pod const* self_);
...
void const*      physx_PxPruningStructure_getStaticMergeData(physx_PxPruningStructure_Pod const* self_);
...
void const*      physx_PxPruningStructure_getDynamicMergeData(physx_PxPruningStructure_Pod const* self_);

char const*      physx_PxPruningStructure_getConcreteTypeName(physx_PxPruningStructure_Pod const* self_);
...
bool      physx_PxExtendedVec3_isZero(physx_PxExtendedVec3_Pod const* self_);

double      physx_PxExtendedVec3_dot(physx_PxExtendedVec3_Pod const* self_, physx_PxVec3_Pod const* v);

double      physx_PxExtendedVec3_distanceSquared(physx_PxExtendedVec3_Pod const* self_, physx_PxExtendedVec3_Pod const* v);

double      physx_PxExtendedVec3_magnitudeSquared(physx_PxExtendedVec3_Pod const* self_);

double      physx_PxExtendedVec3_magnitude(physx_PxExtendedVec3_Pod const* self_);

double      physx_PxExtendedVec3_normalize_mut(physx_PxExtendedVec3_Pod* self_);

bool      physx_PxExtendedVec3_isFinite(physx_PxExtendedVec3_Pod const* self_);

void      physx_PxExtendedVec3_maximum_mut(physx_PxExtendedVec3_Pod* self_, physx_PxExtendedVec3_Pod const* v);

void      physx_PxExtendedVec3_minimum_mut(physx_PxExtendedVec3_Pod* self_, physx_PxExtendedVec3_Pod const* v);

void      physx_PxExtendedVec3_set_mut(physx_PxExtendedVec3_Pod* self_, double x_, double y_, double z_);

void      physx_PxExtendedVec3_setPlusInfinity_mut(physx_PxExtendedVec3_Pod* self_);

void      physx_PxExtendedVec3_setMinusInfinity_mut(physx_PxExtendedVec3_Pod* self_);

void      physx_PxExtendedVec3_cross_mut(physx_PxExtendedVec3_Pod* self_, physx_PxExtendedVec3_Pod const* left, physx_PxVec3_Pod const* right);

void      physx_PxExtendedVec3_cross_mut_1(physx_PxExtendedVec3_Pod* self_, physx_PxExtendedVec3_Pod const* left, physx_PxExtendedVec3_Pod const* right);

physx_PxExtendedVec3_Pod      physx_PxExtendedVec3_cross(physx_PxExtendedVec3_Pod const* self_, physx_PxExtendedVec3_Pod const* v);

void      physx_PxExtendedVec3_cross_mut_2(physx_PxExtendedVec3_Pod* self_, physx_PxVec3_Pod const* left, physx_PxExtendedVec3_Pod const* right);

physx_PxVec3_Pod      physx_phys_toVec3(physx_PxExtendedVec3_Pod const* v);

int32_t      physx_PxObstacle_getType(physx_PxObstacle_Pod const* self_);
...
void      physx_PxObstacleContext_release_mut(physx_PxObstacleContext_Pod* self_);

    /// Retrieves the controller manager associated with this context.
    ///
    /// The associated controller manager
physx_PxControllerManager_Pod*      physx_PxObstacleContext_getControllerManager(physx_PxObstacleContext_Pod const* self_);

    /// Adds an obstacle to the context.
    ///
    /// Handle for newly-added obstacle
uint32_t      physx_PxObstacleContext_addObstacle_mut(physx_PxObstacleContext_Pod* self_, physx_PxObstacle_Pod const* obstacle);

    /// Removes an obstacle from the context.
    ///
    /// True if success
bool      physx_PxObstacleContext_removeObstacle_mut(physx_PxObstacleContext_Pod* self_, uint32_t handle);

    /// Updates data for an existing obstacle.
    ///
    /// True if success
bool      physx_PxObstacleContext_updateObstacle_mut(physx_PxObstacleContext_Pod* self_, uint32_t handle, physx_PxObstacle_Pod const* obstacle);

    /// Retrieves number of obstacles in the context.
    ///
    /// Number of obstacles in the context
uint32_t      physx_PxObstacleContext_getNbObstacles(physx_PxObstacleContext_Pod const* self_);

    /// Retrieves desired obstacle.
    ///
    /// Desired obstacle
physx_PxObstacle_Pod const*      physx_PxObstacleContext_getObstacle(physx_PxObstacleContext_Pod const* self_, uint32_t i);

    /// Retrieves desired obstacle by given handle.
    ///
    /// Desired obstacle
physx_PxObstacle_Pod const*      physx_PxObstacleContext_getObstacleByHandle(physx_PxObstacleContext_Pod const* self_, uint32_t handle);
...
void      physx_PxUserControllerHitReport_onShapeHit_mut(physx_PxUserControllerHitReport_Pod* self_, physx_PxControllerShapeHit_Pod const* hit);

    /// Called when current controller hits another controller.
void      physx_PxUserControllerHitReport_onControllerHit_mut(physx_PxUserControllerHitReport_Pod* self_, physx_PxControllersHit_Pod const* hit);

    /// Called when current controller hits a user-defined obstacle.
void      physx_PxUserControllerHitReport_onObstacleHit_mut(physx_PxUserControllerHitReport_Pod* self_, physx_PxControllerObstacleHit_Pod const* hit);

void      physx_PxControllerFilterCallback_delete(physx_PxControllerFilterCallback_Pod* self_);

    /// Filtering method for CCT-vs-CCT.
    ///
    /// true to keep the pair, false to filter it out
bool      physx_PxControllerFilterCallback_filter_mut(physx_PxControllerFilterCallback_Pod* self_, physx_PxController_Pod const* a, physx_PxController_Pod const* b);

physx_PxControllerFilters_Pod      physx_PxControllerFilters_new(physx_PxFilterData_Pod const* filterData, physx_PxQueryFilterCallback_Pod* cb, physx_PxControllerFilterCallback_Pod* cctFilterCb);

    /// returns true if the current settings are valid
    ///
    /// True if the descriptor is valid.
bool      physx_PxControllerDesc_isValid(physx_PxControllerDesc_Pod const* self_);

    /// Returns the character controller type
    ///
    /// The controllers type.
int32_t      physx_PxControllerDesc_getType(physx_PxControllerDesc_Pod const* self_);

    /// Return the type of controller
int32_t      physx_PxController_getType(physx_PxController_Pod const* self_);

    /// Releases the controller.
void      physx_PxController_release_mut(physx_PxController_Pod* self_);

    /// Moves the character using a "collide-and-slide" algorithm.
    ///
    /// Collision flags, collection of ::PxControllerCollisionFlags
uint8_t      physx_PxController_move_mut(physx_PxController_Pod* self_, physx_PxVec3_Pod const* disp, float minDist, float elapsedTime, physx_PxControllerFilters_Pod const* filters, physx_PxObstacleContext_Pod const* obstacles);
...
bool      physx_PxController_setPosition_mut(physx_PxController_Pod* self_, physx_PxExtendedVec3_Pod const* position);
...
physx_PxExtendedVec3_Pod const*      physx_PxController_getPosition(physx_PxController_Pod const* self_);
    ...
    ///
    /// Currently always returns true.
bool      physx_PxController_setFootPosition_mut(physx_PxController_Pod* self_, physx_PxExtendedVec3_Pod const* position);
...
physx_PxExtendedVec3_Pod      physx_PxController_getFootPosition(physx_PxController_Pod const* self_);
...
physx_PxRigidDynamic_Pod*      physx_PxController_getActor(physx_PxController_Pod const* self_);

    /// The step height.
void      physx_PxController_setStepOffset_mut(physx_PxController_Pod* self_, float offset);

    /// Retrieve the step height.
    ///
    /// The step offset for the controller.
float      physx_PxController_getStepOffset(physx_PxController_Pod const* self_);

    /// Sets the non-walkable mode for the CCT.
void      physx_PxController_setNonWalkableMode_mut(physx_PxController_Pod* self_, int32_t flag);

    /// Retrieves the non-walkable mode for the CCT.
    ///
    /// The current non-walkable mode.
int32_t      physx_PxController_getNonWalkableMode(physx_PxController_Pod const* self_);

    /// Retrieve the contact offset.
    ///
    /// The contact offset for the controller.
float      physx_PxController_getContactOffset(physx_PxController_Pod const* self_);

    /// Sets the contact offset.
void      physx_PxController_setContactOffset_mut(physx_PxController_Pod* self_, float offset);

    /// Retrieve the 'up' direction.
    ///
    /// The up direction for the controller.
physx_PxVec3_Pod      physx_PxController_getUpDirection(physx_PxController_Pod const* self_);

    /// Sets the 'up' direction.
void      physx_PxController_setUpDirection_mut(physx_PxController_Pod* self_, physx_PxVec3_Pod const* up);

    /// Retrieve the slope limit.
    ///
    /// The slope limit for the controller.
float      physx_PxController_getSlopeLimit(physx_PxController_Pod const* self_);
    ...
    /// will be ignored.
void      physx_PxController_setSlopeLimit_mut(physx_PxController_Pod* self_, float slopeLimit);
    ...
    /// function.
void      physx_PxController_invalidateCache_mut(physx_PxController_Pod* self_);

    /// Retrieve the scene associated with the controller.
    ///
    /// The physics scene
physx_PxScene_Pod*      physx_PxController_getScene_mut(physx_PxController_Pod* self_);

    /// Returns the user data associated with this controller.
    ///
    /// The user pointer associated with the controller.
void*      physx_PxController_getUserData(physx_PxController_Pod const* self_);

    /// Sets the user data associated with this controller.
void      physx_PxController_setUserData_mut(physx_PxController_Pod* self_, void* userData);

    /// Returns information about the controller's internal state.
void      physx_PxController_getState(physx_PxController_Pod const* self_, physx_PxControllerState_Pod* state);

    /// Returns the controller's internal statistics.
void      physx_PxController_getStats(physx_PxController_Pod const* self_, physx_PxControllerStats_Pod* stats);
...
void      physx_PxController_resize_mut(physx_PxController_Pod* self_, float height);

    /// constructor sets to default.
physx_PxBoxControllerDesc_Pod*      physx_PxBoxControllerDesc_new_alloc();

void      physx_PxBoxControllerDesc_delete(physx_PxBoxControllerDesc_Pod* self_);

    /// (re)sets the structure to the default.
void      physx_PxBoxControllerDesc_setToDefault_mut(physx_PxBoxControllerDesc_Pod* self_);

    /// returns true if the current settings are valid
    ///
    /// True if the descriptor is valid.
bool      physx_PxBoxControllerDesc_isValid(physx_PxBoxControllerDesc_Pod const* self_);

    /// Gets controller's half height.
    ///
    /// The half height of the controller.
float      physx_PxBoxController_getHalfHeight(physx_PxBoxController_Pod const* self_);

    /// Gets controller's half side extent.
    ///
    /// The half side extent of the controller.
float      physx_PxBoxController_getHalfSideExtent(physx_PxBoxController_Pod const* self_);

    /// Gets controller's half forward extent.
    ///
    /// The half forward extent of the controller.
float      physx_PxBoxController_getHalfForwardExtent(physx_PxBoxController_Pod const* self_);
...
bool      physx_PxBoxController_setHalfHeight_mut(physx_PxBoxController_Pod* self_, float halfHeight);
    ...
    ///
    /// Currently always true.
bool      physx_PxBoxController_setHalfSideExtent_mut(physx_PxBoxController_Pod* self_, float halfSideExtent);
    ...
    ///
    /// Currently always true.
bool      physx_PxBoxController_setHalfForwardExtent_mut(physx_PxBoxController_Pod* self_, float halfForwardExtent);

    /// constructor sets to default.
physx_PxCapsuleControllerDesc_Pod*      physx_PxCapsuleControllerDesc_new_alloc();

void      physx_PxCapsuleControllerDesc_delete(physx_PxCapsuleControllerDesc_Pod* self_);

    /// (re)sets the structure to the default.
void      physx_PxCapsuleControllerDesc_setToDefault_mut(physx_PxCapsuleControllerDesc_Pod* self_);

    /// returns true if the current settings are valid
    ///
    /// True if the descriptor is valid.
bool      physx_PxCapsuleControllerDesc_isValid(physx_PxCapsuleControllerDesc_Pod const* self_);

    /// Gets controller's radius.
    ///
    /// The radius of the controller.
float      physx_PxCapsuleController_getRadius(physx_PxCapsuleController_Pod const* self_);
    ...
    ///
    /// Currently always true.
bool      physx_PxCapsuleController_setRadius_mut(physx_PxCapsuleController_Pod* self_, float radius);

    /// Gets controller's height.
    ///
    /// The height of the capsule controller.
float      physx_PxCapsuleController_getHeight(physx_PxCapsuleController_Pod const* self_);
    ...
    ///
    /// Currently always true.
bool      physx_PxCapsuleController_setHeight_mut(physx_PxCapsuleController_Pod* self_, float height);

    /// Gets controller's climbing mode.
    ///
    /// The capsule controller's climbing mode.
int32_t      physx_PxCapsuleController_getClimbingMode(physx_PxCapsuleController_Pod const* self_);

    /// Sets controller's climbing mode.
bool      physx_PxCapsuleController_setClimbingMode_mut(physx_PxCapsuleController_Pod* self_, int32_t mode);
...
uint8_t      physx_PxControllerBehaviorCallback_getBehaviorFlags_mut(physx_PxControllerBehaviorCallback_Pod* self_, physx_PxShape_Pod const* shape, physx_PxActor_Pod const* actor);
...
uint8_t      physx_PxControllerBehaviorCallback_getBehaviorFlags_mut_1(physx_PxControllerBehaviorCallback_Pod* self_, physx_PxController_Pod const* controller);
...
uint8_t      physx_PxControllerBehaviorCallback_getBehaviorFlags_mut_2(physx_PxControllerBehaviorCallback_Pod* self_, physx_PxObstacle_Pod const* obstacle);
...
void      physx_PxControllerManager_release_mut(physx_PxControllerManager_Pod* self_);

    /// Returns the scene the manager is adding the controllers to.
    ///
    /// The associated physics scene.
physx_PxScene_Pod*      physx_PxControllerManager_getScene(physx_PxControllerManager_Pod const* self_);

    /// Returns the number of controllers that are being managed.
    ///
    /// The number of controllers.
uint32_t      physx_PxControllerManager_getNbControllers(physx_PxControllerManager_Pod const* self_);

    /// Retrieve one of the controllers in the manager.
    ///
    /// The controller with the specified index.
physx_PxController_Pod*      physx_PxControllerManager_getController_mut(physx_PxControllerManager_Pod* self_, uint32_t index);

    /// Creates a new character controller.
    ///
    /// The new controller
physx_PxController_Pod*      physx_PxControllerManager_createController_mut(physx_PxControllerManager_Pod* self_, physx_PxControllerDesc_Pod const* desc);

    /// Releases all the controllers that are being managed.
void      physx_PxControllerManager_purgeControllers_mut(physx_PxControllerManager_Pod* self_);

    /// Retrieves debug data.
    ///
    /// The render buffer filled with debug-render data
physx_PxRenderBuffer_Pod*      physx_PxControllerManager_getRenderBuffer_mut(physx_PxControllerManager_Pod* self_);

    /// Sets debug rendering flags
void      physx_PxControllerManager_setDebugRenderingFlags_mut(physx_PxControllerManager_Pod* self_, uint32_t flags);

    /// Returns the number of obstacle contexts that are being managed.
    ///
    /// The number of obstacle contexts.
uint32_t      physx_PxControllerManager_getNbObstacleContexts(physx_PxControllerManager_Pod const* self_);

    /// Retrieve one of the obstacle contexts in the manager.
    ///
    /// The obstacle context with the specified index.
physx_PxObstacleContext_Pod*      physx_PxControllerManager_getObstacleContext_mut(physx_PxControllerManager_Pod* self_, uint32_t index);

    /// Creates an obstacle context.
    ///
    /// New obstacle context
physx_PxObstacleContext_Pod*      physx_PxControllerManager_createObstacleContext_mut(physx_PxControllerManager_Pod* self_);
...
void      physx_PxControllerManager_computeInteractions_mut(physx_PxControllerManager_Pod* self_, float elapsedTime, physx_PxControllerFilterCallback_Pod* cctFilterCb);
...
void      physx_PxControllerManager_setTessellation_mut(physx_PxControllerManager_Pod* self_, bool flag, float maxEdgeLength);
...
void      physx_PxControllerManager_setOverlapRecoveryModule_mut(physx_PxControllerManager_Pod* self_, bool flag);
...
void      physx_PxControllerManager_setPreciseSweeps_mut(physx_PxControllerManager_Pod* self_, bool flag);
...
void      physx_PxControllerManager_setPreventVerticalSlidingAgainstCeiling_mut(physx_PxControllerManager_Pod* self_, bool flag);
...
void      physx_PxControllerManager_shiftOrigin_mut(physx_PxControllerManager_Pod* self_, physx_PxVec3_Pod const* shift);
...
physx_PxControllerManager_Pod*      physx_phys_PxCreateControllerManager(physx_PxScene_Pod* scene, bool lockingEnabled);
...
physx_PxSDFDesc_Pod      physx_PxSDFDesc_new();
    ...
    ///
    /// true if the current settings are valid
bool      physx_PxSDFDesc_isValid(physx_PxSDFDesc_Pod const* self_);

    /// constructor sets to default.
physx_PxConvexMeshDesc_Pod      physx_PxConvexMeshDesc_new();

    /// (re)sets the structure to the default.
void      physx_PxConvexMeshDesc_setToDefault_mut(physx_PxConvexMeshDesc_Pod* self_);

    /// Returns true if the descriptor is valid.
    ///
    /// True if the current settings are valid
bool      physx_PxConvexMeshDesc_isValid(physx_PxConvexMeshDesc_Pod const* self_);

    /// Constructor sets to default.
physx_PxTriangleMeshDesc_Pod      physx_PxTriangleMeshDesc_new();

    /// (re)sets the structure to the default.
void      physx_PxTriangleMeshDesc_setToDefault_mut(physx_PxTriangleMeshDesc_Pod* self_);

    /// Returns true if the descriptor is valid.
    ///
    /// true if the current settings are valid
bool      physx_PxTriangleMeshDesc_isValid(physx_PxTriangleMeshDesc_Pod const* self_);

    /// Constructor to build an empty tetmesh description
physx_PxTetrahedronMeshDesc_Pod      physx_PxTetrahedronMeshDesc_new();

bool      physx_PxTetrahedronMeshDesc_isValid(physx_PxTetrahedronMeshDesc_Pod const* self_);
...
bool      physx_PxSoftBodySimulationDataDesc_isValid(physx_PxSoftBodySimulationDataDesc_Pod const* self_);

    /// Desc initialization to default value.
void      physx_PxBVH34MidphaseDesc_setToDefault_mut(physx_PxBVH34MidphaseDesc_Pod* self_);

    /// Returns true if the descriptor is valid.
    ///
    /// true if the current settings are valid.
bool      physx_PxBVH34MidphaseDesc_isValid(physx_PxBVH34MidphaseDesc_Pod const* self_);
...
physx_PxMidphaseDesc_Pod      physx_PxMidphaseDesc_new();
    ...
    ///
    /// PxMeshMidPhase::Enum
int32_t      physx_PxMidphaseDesc_getType(physx_PxMidphaseDesc_Pod const* self_);

    /// Initialize the midphase mesh structure descriptor
void      physx_PxMidphaseDesc_setToDefault_mut(physx_PxMidphaseDesc_Pod* self_, int32_t type_);

    /// Returns true if the descriptor is valid.
    ///
    /// true if the current settings are valid.
bool      physx_PxMidphaseDesc_isValid(physx_PxMidphaseDesc_Pod const* self_);

physx_PxBVHDesc_Pod      physx_PxBVHDesc_new();

    /// Initialize the BVH descriptor
void      physx_PxBVHDesc_setToDefault_mut(physx_PxBVHDesc_Pod* self_);

    /// Returns true if the descriptor is valid.
    ///
    /// true if the current settings are valid.
bool      physx_PxBVHDesc_isValid(physx_PxBVHDesc_Pod const* self_);

physx_PxCookingParams_Pod      physx_PxCookingParams_new(physx_PxTolerancesScale_Pod const* sc);
...
physx_PxInsertionCallback_Pod*      physx_phys_PxGetStandaloneInsertionCallback();
    ...
    ///
    /// true on success.
bool      physx_phys_PxCookBVH(physx_PxBVHDesc_Pod const* desc, physx_PxOutputStream_Pod* stream);
...
physx_PxBVH_Pod*      physx_phys_PxCreateBVH(physx_PxBVHDesc_Pod const* desc, physx_PxInsertionCallback_Pod* insertionCallback);
    ...
    ///
    /// true on success
bool      physx_phys_PxCookHeightField(physx_PxHeightFieldDesc_Pod const* desc, physx_PxOutputStream_Pod* stream);

    /// Cooks and creates a heightfield mesh and inserts it into PxPhysics.
    ///
    /// PxHeightField pointer on success
physx_PxHeightField_Pod*      physx_phys_PxCreateHeightField(physx_PxHeightFieldDesc_Pod const* desc, physx_PxInsertionCallback_Pod* insertionCallback);
    ...
    ///
    /// true on success.
bool      physx_phys_PxCookConvexMesh(physx_PxCookingParams_Pod const* params, physx_PxConvexMeshDesc_Pod const* desc, physx_PxOutputStream_Pod* stream, int32_t* condition);
...
physx_PxConvexMesh_Pod*      physx_phys_PxCreateConvexMesh(physx_PxCookingParams_Pod const* params, physx_PxConvexMeshDesc_Pod const* desc, physx_PxInsertionCallback_Pod* insertionCallback, int32_t* condition);
...
bool      physx_phys_PxValidateConvexMesh(physx_PxCookingParams_Pod const* params, physx_PxConvexMeshDesc_Pod const* desc);
    ...
    ///
    /// true on success
bool      physx_phys_PxComputeHullPolygons(physx_PxCookingParams_Pod const* params, physx_PxSimpleTriangleMesh_Pod const* mesh, physx_PxAllocatorCallback_Pod* inCallback, uint32_t* nbVerts, physx_PxVec3_Pod** vertices, uint32_t* nbIndices, uint32_t** indices, uint32_t* nbPolygons, physx_PxHullPolygon_Pod** hullPolygons);
    ...
    ///
    /// true if all the validity conditions hold, false otherwise.
bool      physx_phys_PxValidateTriangleMesh(physx_PxCookingParams_Pod const* params, physx_PxTriangleMeshDesc_Pod const* desc);
...
physx_PxTriangleMesh_Pod*      physx_phys_PxCreateTriangleMesh(physx_PxCookingParams_Pod const* params, physx_PxTriangleMeshDesc_Pod const* desc, physx_PxInsertionCallback_Pod* insertionCallback, int32_t* condition);
    ...
    ///
    /// true on success
bool      physx_phys_PxCookTriangleMesh(physx_PxCookingParams_Pod const* params, physx_PxTriangleMeshDesc_Pod const* desc, physx_PxOutputStream_Pod* stream, int32_t* condition);

physx_PxDefaultMemoryOutputStream_Pod*      physx_PxDefaultMemoryOutputStream_new_alloc(physx_PxAllocatorCallback_Pod* allocator);

void      physx_PxDefaultMemoryOutputStream_delete(physx_PxDefaultMemoryOutputStream_Pod* self_);

uint32_t      physx_PxDefaultMemoryOutputStream_write_mut(physx_PxDefaultMemoryOutputStream_Pod* self_, void const* src, uint32_t count);

uint32_t      physx_PxDefaultMemoryOutputStream_getSize(physx_PxDefaultMemoryOutputStream_Pod const* self_);

uint8_t*      physx_PxDefaultMemoryOutputStream_getData(physx_PxDefaultMemoryOutputStream_Pod const* self_);

physx_PxDefaultMemoryInputData_Pod*      physx_PxDefaultMemoryInputData_new_alloc(uint8_t* data, uint32_t length);

uint32_t      physx_PxDefaultMemoryInputData_read_mut(physx_PxDefaultMemoryInputData_Pod* self_, void* dest, uint32_t count);

uint32_t      physx_PxDefaultMemoryInputData_getLength(physx_PxDefaultMemoryInputData_Pod const* self_);

void      physx_PxDefaultMemoryInputData_seek_mut(physx_PxDefaultMemoryInputData_Pod* self_, uint32_t pos);

uint32_t      physx_PxDefaultMemoryInputData_tell(physx_PxDefaultMemoryInputData_Pod const* self_);

physx_PxDefaultFileOutputStream_Pod*      physx_PxDefaultFileOutputStream_new_alloc(char const* name);

void      physx_PxDefaultFileOutputStream_delete(physx_PxDefaultFileOutputStream_Pod* self_);

uint32_t      physx_PxDefaultFileOutputStream_write_mut(physx_PxDefaultFileOutputStream_Pod* self_, void const* src, uint32_t count);

bool      physx_PxDefaultFileOutputStream_isValid_mut(physx_PxDefaultFileOutputStream_Pod* self_);

physx_PxDefaultFileInputData_Pod*      physx_PxDefaultFileInputData_new_alloc(char const* name);

void      physx_PxDefaultFileInputData_delete(physx_PxDefaultFileInputData_Pod* self_);

uint32_t      physx_PxDefaultFileInputData_read_mut(physx_PxDefaultFileInputData_Pod* self_, void* dest, uint32_t count);

void      physx_PxDefaultFileInputData_seek_mut(physx_PxDefaultFileInputData_Pod* self_, uint32_t pos);

uint32_t      physx_PxDefaultFileInputData_tell(physx_PxDefaultFileInputData_Pod const* self_);

uint32_t      physx_PxDefaultFileInputData_getLength(physx_PxDefaultFileInputData_Pod const* self_);

bool      physx_PxDefaultFileInputData_isValid(physx_PxDefaultFileInputData_Pod const* self_);

void*      physx_phys_platformAlignedAlloc(size_t size);

void      physx_phys_platformAlignedFree(void* ptr);

void*      physx_PxDefaultAllocator_allocate_mut(physx_PxDefaultAllocator_Pod* self_, size_t size, char const* anon_param1, char const* anon_param2, int32_t anon_param3);

void      physx_PxDefaultAllocator_deallocate_mut(physx_PxDefaultAllocator_Pod* self_, void* ptr);

void      physx_PxDefaultAllocator_delete(physx_PxDefaultAllocator_Pod* self_);

    /// Set the actors for this joint.
    ///
    /// An actor may be NULL to indicate the world frame. At most one of the actors may be NULL.
void      physx_PxJoint_setActors_mut(physx_PxJoint_Pod* self_, physx_PxRigidActor_Pod* actor0, physx_PxRigidActor_Pod* actor1);

    /// Get the actors for this joint.
void      physx_PxJoint_getActors(physx_PxJoint_Pod const* self_, physx_PxRigidActor_Pod** actor0, physx_PxRigidActor_Pod** actor1);

    /// Set the joint local pose for an actor.
    ///
    /// This is the relative pose which locates the joint frame relative to the actor.
void      physx_PxJoint_setLocalPose_mut(physx_PxJoint_Pod* self_, int32_t actor, physx_PxTransform_Pod const* localPose);

    /// get the joint local pose for an actor.
    ///
    /// return the local pose for this joint
physx_PxTransform_Pod      physx_PxJoint_getLocalPose(physx_PxJoint_Pod const* self_, int32_t actor);

    /// get the relative pose for this joint
    ///
    /// This function returns the pose of the joint frame of actor1 relative to actor0
physx_PxTransform_Pod      physx_PxJoint_getRelativeTransform(physx_PxJoint_Pod const* self_);
...
physx_PxVec3_Pod      physx_PxJoint_getRelativeLinearVelocity(physx_PxJoint_Pod const* self_);
...
physx_PxVec3_Pod      physx_PxJoint_getRelativeAngularVelocity(physx_PxJoint_Pod const* self_);
...
void      physx_PxJoint_setBreakForce_mut(physx_PxJoint_Pod* self_, float force, float torque);

    /// get the break force for this joint.
void      physx_PxJoint_getBreakForce(physx_PxJoint_Pod const* self_, float* force, float* torque);

    /// set the constraint flags for this joint.
void      physx_PxJoint_setConstraintFlags_mut(physx_PxJoint_Pod* self_, uint16_t flags);

    /// set a constraint flags for this joint to a specified value.
void      physx_PxJoint_setConstraintFlag_mut(physx_PxJoint_Pod* self_, int32_t flag, bool value);

    /// get the constraint flags for this joint.
    ///
    /// the constraint flags
uint16_t      physx_PxJoint_getConstraintFlags(physx_PxJoint_Pod const* self_);

    /// set the inverse mass scale for actor0.
void      physx_PxJoint_setInvMassScale0_mut(physx_PxJoint_Pod* self_, float invMassScale);

    /// get the inverse mass scale for actor0.
    ///
    /// inverse mass scale for actor0
float      physx_PxJoint_getInvMassScale0(physx_PxJoint_Pod const* self_);

    /// set the inverse inertia scale for actor0.
void      physx_PxJoint_setInvInertiaScale0_mut(physx_PxJoint_Pod* self_, float invInertiaScale);

    /// get the inverse inertia scale for actor0.
    ///
    /// inverse inertia scale for actor0
float      physx_PxJoint_getInvInertiaScale0(physx_PxJoint_Pod const* self_);

    /// set the inverse mass scale for actor1.
void      physx_PxJoint_setInvMassScale1_mut(physx_PxJoint_Pod* self_, float invMassScale);

    /// get the inverse mass scale for actor1.
    ///
    /// inverse mass scale for actor1
float      physx_PxJoint_getInvMassScale1(physx_PxJoint_Pod const* self_);

    /// set the inverse inertia scale for actor1.
void      physx_PxJoint_setInvInertiaScale1_mut(physx_PxJoint_Pod* self_, float invInertiaScale);

    /// get the inverse inertia scale for actor1.
    ///
    /// inverse inertia scale for actor1
float      physx_PxJoint_getInvInertiaScale1(physx_PxJoint_Pod const* self_);
    ...
    ///
    /// the constraint
physx_PxConstraint_Pod*      physx_PxJoint_getConstraint(physx_PxJoint_Pod const* self_);

    /// Sets a name string for the object that can be retrieved with getName().
    ///
    /// This is for debugging and is not used by the SDK. The string is not copied by the SDK,
    /// only the pointer is stored.
void      physx_PxJoint_setName_mut(physx_PxJoint_Pod* self_, char const* name);

    /// Retrieves the name string set with setName().
    ///
    /// Name string associated with object.
char const*      physx_PxJoint_getName(physx_PxJoint_Pod const* self_);

    /// Deletes the joint.
    ///
    /// This call does not wake up the connected rigid bodies.
void      physx_PxJoint_release_mut(physx_PxJoint_Pod* self_);

    /// Retrieves the scene which this joint belongs to.
    ///
    /// Owner Scene. NULL if not part of a scene.
physx_PxScene_Pod*      physx_PxJoint_getScene(physx_PxJoint_Pod const* self_);

    /// Put class meta data in stream, used for serialization
void      physx_PxJoint_getBinaryMetaData(physx_PxOutputStream_Pod* stream);
...
void      physx_phys_PxSetJointGlobalFrame(physx_PxJoint_Pod* joint, physx_PxVec3_Pod const* wsAnchor, physx_PxVec3_Pod const* wsAxis);

    /// Create a distance Joint.
physx_PxDistanceJoint_Pod*      physx_phys_PxDistanceJointCreate(physx_PxPhysics_Pod* physics, physx_PxRigidActor_Pod* actor0, physx_PxTransform_Pod const* localFrame0, physx_PxRigidActor_Pod* actor1, physx_PxTransform_Pod const* localFrame1);

    /// Return the current distance of the joint
float      physx_PxDistanceJoint_getDistance(physx_PxDistanceJoint_Pod const* self_);
    ...
    /// Range
    /// [0, PX_MAX_F32)
void      physx_PxDistanceJoint_setMinDistance_mut(physx_PxDistanceJoint_Pod* self_, float distance);

    /// Get the allowed minimum distance for the joint.
    ///
    /// the allowed minimum distance
float      physx_PxDistanceJoint_getMinDistance(physx_PxDistanceJoint_Pod const* self_);
    ...
    /// Range
    /// [0, PX_MAX_F32)
void      physx_PxDistanceJoint_setMaxDistance_mut(physx_PxDistanceJoint_Pod* self_, float distance);

    /// Get the allowed maximum distance for the joint.
    ///
    /// the allowed maximum distance
float      physx_PxDistanceJoint_getMaxDistance(physx_PxDistanceJoint_Pod const* self_);

    /// Set the error tolerance of the joint.
void      physx_PxDistanceJoint_setTolerance_mut(physx_PxDistanceJoint_Pod* self_, float tolerance);
...
float      physx_PxDistanceJoint_getTolerance(physx_PxDistanceJoint_Pod const* self_);
    ...
    /// Range
    /// [0, PX_MAX_F32)
void      physx_PxDistanceJoint_setStiffness_mut(physx_PxDistanceJoint_Pod* self_, float stiffness);

    /// Get the strength of the joint spring.
    ///
    /// stiffness the spring strength of the joint
float      physx_PxDistanceJoint_getStiffness(physx_PxDistanceJoint_Pod const* self_);
    ...
    /// Range
    /// [0, PX_MAX_F32)
void      physx_PxDistanceJoint_setDamping_mut(physx_PxDistanceJoint_Pod* self_, float damping);

    /// Get the damping of the joint spring.
    ///
    /// the degree of damping of the joint spring of the joint
float      physx_PxDistanceJoint_getDamping(physx_PxDistanceJoint_Pod const* self_);
    ...
    /// Range
    /// [0, PX_MAX_F32)
void      physx_PxDistanceJoint_setContactDistance_mut(physx_PxDistanceJoint_Pod* self_, float contactDistance);

    /// Get the contact distance.
    ///
    /// the contact distance
float      physx_PxDistanceJoint_getContactDistance(physx_PxDistanceJoint_Pod const* self_);

    /// Set the flags specific to the Distance Joint.
    ///
    /// Default
    /// PxDistanceJointFlag::eMAX_DISTANCE_ENABLED
void      physx_PxDistanceJoint_setDistanceJointFlags_mut(physx_PxDistanceJoint_Pod* self_, uint16_t flags);

    /// Set a single flag specific to a Distance Joint to true or false.
void      physx_PxDistanceJoint_setDistanceJointFlag_mut(physx_PxDistanceJoint_Pod* self_, int32_t flag, bool value);

    /// Get the flags specific to the Distance Joint.
    ///
    /// the joint flags
uint16_t      physx_PxDistanceJoint_getDistanceJointFlags(physx_PxDistanceJoint_Pod const* self_);

    /// Returns string name of PxDistanceJoint, used for serialization
char const*      physx_PxDistanceJoint_getConcreteTypeName(physx_PxDistanceJoint_Pod const* self_);

    /// Create a distance Joint.
physx_PxContactJoint_Pod*      physx_phys_PxContactJointCreate(physx_PxPhysics_Pod* physics, physx_PxRigidActor_Pod* actor0, physx_PxTransform_Pod const* localFrame0, physx_PxRigidActor_Pod* actor1, physx_PxTransform_Pod const* localFrame1);

physx_PxJacobianRow_Pod      physx_PxJacobianRow_new();

physx_PxJacobianRow_Pod      physx_PxJacobianRow_new_1(physx_PxVec3_Pod const* lin0, physx_PxVec3_Pod const* lin1, physx_PxVec3_Pod const* ang0, physx_PxVec3_Pod const* ang1);

    /// Set the current contact of the joint
void      physx_PxContactJoint_setContact_mut(physx_PxContactJoint_Pod* self_, physx_PxVec3_Pod const* contact);

    /// Set the current contact normal of the joint
void      physx_PxContactJoint_setContactNormal_mut(physx_PxContactJoint_Pod* self_, physx_PxVec3_Pod const* contactNormal);

    /// Set the current penetration of the joint
void      physx_PxContactJoint_setPenetration_mut(physx_PxContactJoint_Pod* self_, float penetration);

    /// Return the current contact of the joint
physx_PxVec3_Pod      physx_PxContactJoint_getContact(physx_PxContactJoint_Pod const* self_);

    /// Return the current contact normal of the joint
physx_PxVec3_Pod      physx_PxContactJoint_getContactNormal(physx_PxContactJoint_Pod const* self_);

    /// Return the current penetration value of the joint
float      physx_PxContactJoint_getPenetration(physx_PxContactJoint_Pod const* self_);

float      physx_PxContactJoint_getRestitution(physx_PxContactJoint_Pod const* self_);

void      physx_PxContactJoint_setRestitution_mut(physx_PxContactJoint_Pod* self_, float restitution);

float      physx_PxContactJoint_getBounceThreshold(physx_PxContactJoint_Pod const* self_);

void      physx_PxContactJoint_setBounceThreshold_mut(physx_PxContactJoint_Pod* self_, float bounceThreshold);

    /// Returns string name of PxContactJoint, used for serialization
char const*      physx_PxContactJoint_getConcreteTypeName(physx_PxContactJoint_Pod const* self_);

void      physx_PxContactJoint_computeJacobians(physx_PxContactJoint_Pod const* self_, physx_PxJacobianRow_Pod* jacobian);

uint32_t      physx_PxContactJoint_getNbJacobianRows(physx_PxContactJoint_Pod const* self_);

    /// Create a fixed joint.
physx_PxFixedJoint_Pod*      physx_phys_PxFixedJointCreate(physx_PxPhysics_Pod* physics, physx_PxRigidActor_Pod* actor0, physx_PxTransform_Pod const* localFrame0, physx_PxRigidActor_Pod* actor1, physx_PxTransform_Pod const* localFrame1);

    /// Returns string name of PxFixedJoint, used for serialization
char const*      physx_PxFixedJoint_getConcreteTypeName(physx_PxFixedJoint_Pod const* self_);
...
physx_PxJointLimitParameters_Pod*      physx_PxJointLimitParameters_new_alloc();
    ...
    ///
    /// true if the current settings are valid
bool      physx_PxJointLimitParameters_isValid(physx_PxJointLimitParameters_Pod const* self_);

bool      physx_PxJointLimitParameters_isSoft(physx_PxJointLimitParameters_Pod const* self_);

    /// construct a linear hard limit
physx_PxJointLinearLimit_Pod      physx_PxJointLinearLimit_new(physx_PxTolerancesScale_Pod const* scale, float extent, float contactDist_deprecated);

    /// construct a linear soft limit
physx_PxJointLinearLimit_Pod      physx_PxJointLinearLimit_new_1(float extent, physx_PxSpring_Pod const* spring);

    /// Returns true if the limit is valid
    ///
    /// true if the current settings are valid
bool      physx_PxJointLinearLimit_isValid(physx_PxJointLinearLimit_Pod const* self_);

void      physx_PxJointLinearLimit_delete(physx_PxJointLinearLimit_Pod* self_);

    /// Construct a linear hard limit pair. The lower distance value must be less than the upper distance value.
physx_PxJointLinearLimitPair_Pod      physx_PxJointLinearLimitPair_new(physx_PxTolerancesScale_Pod const* scale, float lowerLimit, float upperLimit, float contactDist_deprecated);

    /// construct a linear soft limit pair
physx_PxJointLinearLimitPair_Pod      physx_PxJointLinearLimitPair_new_1(float lowerLimit, float upperLimit, physx_PxSpring_Pod const* spring);

    /// Returns true if the limit is valid.
    ///
    /// true if the current settings are valid
bool      physx_PxJointLinearLimitPair_isValid(physx_PxJointLinearLimitPair_Pod const* self_);

void      physx_PxJointLinearLimitPair_delete(physx_PxJointLinearLimitPair_Pod* self_);
...
physx_PxJointAngularLimitPair_Pod      physx_PxJointAngularLimitPair_new(float lowerLimit, float upperLimit, float contactDist_deprecated);
    ...
    ///
    /// The lower value must be less than the upper value.
physx_PxJointAngularLimitPair_Pod      physx_PxJointAngularLimitPair_new_1(float lowerLimit, float upperLimit, physx_PxSpring_Pod const* spring);

    /// Returns true if the limit is valid.
    ///
    /// true if the current settings are valid
bool      physx_PxJointAngularLimitPair_isValid(physx_PxJointAngularLimitPair_Pod const* self_);

void      physx_PxJointAngularLimitPair_delete(physx_PxJointAngularLimitPair_Pod* self_);
...
physx_PxJointLimitCone_Pod      physx_PxJointLimitCone_new_1(float yLimitAngle, float zLimitAngle, physx_PxSpring_Pod const* spring);

    /// Returns true if the limit is valid.
    ///
    /// true if the current settings are valid
bool      physx_PxJointLimitCone_isValid(physx_PxJointLimitCone_Pod const* self_);

void      physx_PxJointLimitCone_delete(physx_PxJointLimitCone_Pod* self_);
...
physx_PxJointLimitPyramid_Pod      physx_PxJointLimitPyramid_new_1(float yLimitAngleMin, float yLimitAngleMax, float zLimitAngleMin, float zLimitAngleMax, physx_PxSpring_Pod const* spring);

    /// Returns true if the limit is valid.
    ///
    /// true if the current settings are valid
bool      physx_PxJointLimitPyramid_isValid(physx_PxJointLimitPyramid_Pod const* self_);

void      physx_PxJointLimitPyramid_delete(physx_PxJointLimitPyramid_Pod* self_);

    /// Create a prismatic joint.
physx_PxPrismaticJoint_Pod*      physx_phys_PxPrismaticJointCreate(physx_PxPhysics_Pod* physics, physx_PxRigidActor_Pod* actor0, physx_PxTransform_Pod const* localFrame0, physx_PxRigidActor_Pod* actor1, physx_PxTransform_Pod const* localFrame1);

    /// returns the displacement of the joint along its axis.
float      physx_PxPrismaticJoint_getPosition(physx_PxPrismaticJoint_Pod const* self_);

    /// returns the velocity of the joint along its axis
float      physx_PxPrismaticJoint_getVelocity(physx_PxPrismaticJoint_Pod const* self_);
    ...
    /// a valid float.
void      physx_PxPrismaticJoint_setLimit_mut(physx_PxPrismaticJoint_Pod* self_, physx_PxJointLinearLimitPair_Pod const* anon_param0);

    /// gets the joint limit  parameters.
physx_PxJointLinearLimitPair_Pod      physx_PxPrismaticJoint_getLimit(physx_PxPrismaticJoint_Pod const* self_);

    /// Set the flags specific to the Prismatic Joint.
    ///
    /// Default
    /// PxPrismaticJointFlags(0)
void      physx_PxPrismaticJoint_setPrismaticJointFlags_mut(physx_PxPrismaticJoint_Pod* self_, uint16_t flags);

    /// Set a single flag specific to a Prismatic Joint to true or false.
void      physx_PxPrismaticJoint_setPrismaticJointFlag_mut(physx_PxPrismaticJoint_Pod* self_, int32_t flag, bool value);

    /// Get the flags specific to the Prismatic Joint.
    ///
    /// the joint flags
uint16_t      physx_PxPrismaticJoint_getPrismaticJointFlags(physx_PxPrismaticJoint_Pod const* self_);

    /// Returns string name of PxPrismaticJoint, used for serialization
char const*      physx_PxPrismaticJoint_getConcreteTypeName(physx_PxPrismaticJoint_Pod const* self_);

    /// Create a revolute joint.
physx_PxRevoluteJoint_Pod*      physx_phys_PxRevoluteJointCreate(physx_PxPhysics_Pod* physics, physx_PxRigidActor_Pod* actor0, physx_PxTransform_Pod const* localFrame0, physx_PxRigidActor_Pod* actor1, physx_PxTransform_Pod const* localFrame1);

    /// return the angle of the joint, in the range (-2*Pi, 2*Pi]
float      physx_PxRevoluteJoint_getAngle(physx_PxRevoluteJoint_Pod const* self_);

    /// return the velocity of the joint
float      physx_PxRevoluteJoint_getVelocity(physx_PxRevoluteJoint_Pod const* self_);
...
void      physx_PxRevoluteJoint_setLimit_mut(physx_PxRevoluteJoint_Pod* self_, physx_PxJointAngularLimitPair_Pod const* limits);

    /// get the joint limit parameters.
    ///
    /// the joint limit parameters
physx_PxJointAngularLimitPair_Pod      physx_PxRevoluteJoint_getLimit(physx_PxRevoluteJoint_Pod const* self_);
    ...
    /// Default:
    /// 0.0
void      physx_PxRevoluteJoint_setDriveVelocity_mut(physx_PxRevoluteJoint_Pod* self_, float velocity, bool autowake);

    /// gets the target velocity for the drive model.
    ///
    /// the drive target velocity
float      physx_PxRevoluteJoint_getDriveVelocity(physx_PxRevoluteJoint_Pod const* self_);
    ...
    /// Default:
    /// PX_MAX_F32
void      physx_PxRevoluteJoint_setDriveForceLimit_mut(physx_PxRevoluteJoint_Pod* self_, float limit);

    /// gets the maximum torque the drive can exert.
    ///
    /// the torque limit
float      physx_PxRevoluteJoint_getDriveForceLimit(physx_PxRevoluteJoint_Pod const* self_);
    ...
    /// Default:
    /// 1.0
void      physx_PxRevoluteJoint_setDriveGearRatio_mut(physx_PxRevoluteJoint_Pod* self_, float ratio);

    /// gets the gear ratio.
    ///
    /// the drive gear ratio
float      physx_PxRevoluteJoint_getDriveGearRatio(physx_PxRevoluteJoint_Pod const* self_);

    /// sets the flags specific to the Revolute Joint.
    ///
    /// Default
    /// PxRevoluteJointFlags(0)
void      physx_PxRevoluteJoint_setRevoluteJointFlags_mut(physx_PxRevoluteJoint_Pod* self_, uint16_t flags);

    /// sets a single flag specific to a Revolute Joint.
void      physx_PxRevoluteJoint_setRevoluteJointFlag_mut(physx_PxRevoluteJoint_Pod* self_, int32_t flag, bool value);

    /// gets the flags specific to the Revolute Joint.
    ///
    /// the joint flags
uint16_t      physx_PxRevoluteJoint_getRevoluteJointFlags(physx_PxRevoluteJoint_Pod const* self_);

    /// Returns string name of PxRevoluteJoint, used for serialization
char const*      physx_PxRevoluteJoint_getConcreteTypeName(physx_PxRevoluteJoint_Pod const* self_);

    /// Create a spherical joint.
physx_PxSphericalJoint_Pod*      physx_phys_PxSphericalJointCreate(physx_PxPhysics_Pod* physics, physx_PxRigidActor_Pod* actor0, physx_PxTransform_Pod const* localFrame0, physx_PxRigidActor_Pod* actor1, physx_PxTransform_Pod const* localFrame1);
    ...
    ///
    /// the limit cone
physx_PxJointLimitCone_Pod      physx_PxSphericalJoint_getLimitCone(physx_PxSphericalJoint_Pod const* self_);

    /// Get the limit cone.
void      physx_PxSphericalJoint_setLimitCone_mut(physx_PxSphericalJoint_Pod* self_, physx_PxJointLimitCone_Pod const* limit);

    /// get the swing angle of the joint from the Y axis
float      physx_PxSphericalJoint_getSwingYAngle(physx_PxSphericalJoint_Pod const* self_);

    /// get the swing angle of the joint from the Z axis
float      physx_PxSphericalJoint_getSwingZAngle(physx_PxSphericalJoint_Pod const* self_);

    /// Set the flags specific to the Spherical Joint.
    ///
    /// Default
    /// PxSphericalJointFlags(0)
void      physx_PxSphericalJoint_setSphericalJointFlags_mut(physx_PxSphericalJoint_Pod* self_, uint16_t flags);

    /// Set a single flag specific to a Spherical Joint to true or false.
void      physx_PxSphericalJoint_setSphericalJointFlag_mut(physx_PxSphericalJoint_Pod* self_, int32_t flag, bool value);

    /// Get the flags specific to the Spherical Joint.
    ///
    /// the joint flags
uint16_t      physx_PxSphericalJoint_getSphericalJointFlags(physx_PxSphericalJoint_Pod const* self_);

    /// Returns string name of PxSphericalJoint, used for serialization
char const*      physx_PxSphericalJoint_getConcreteTypeName(physx_PxSphericalJoint_Pod const* self_);

    /// Create a D6 joint.
physx_PxD6Joint_Pod*      physx_phys_PxD6JointCreate(physx_PxPhysics_Pod* physics, physx_PxRigidActor_Pod* actor0, physx_PxTransform_Pod const* localFrame0, physx_PxRigidActor_Pod* actor1, physx_PxTransform_Pod const* localFrame1);
...
bool      physx_PxD6JointDrive_isValid(physx_PxD6JointDrive_Pod const* self_);
...
void      physx_PxD6Joint_setMotion_mut(physx_PxD6Joint_Pod* self_, int32_t axis, int32_t type_);

    /// Get the motion type around the specified axis.
    ///
    /// the motion type around the specified axis
int32_t      physx_PxD6Joint_getMotion(physx_PxD6Joint_Pod const* self_, int32_t axis);

    /// get the twist angle of the joint, in the range (-2*Pi, 2*Pi]
float      physx_PxD6Joint_getTwistAngle(physx_PxD6Joint_Pod const* self_);

    /// get the swing angle of the joint from the Y axis
float      physx_PxD6Joint_getSwingYAngle(physx_PxD6Joint_Pod const* self_);

    /// get the swing angle of the joint from the Z axis
float      physx_PxD6Joint_getSwingZAngle(physx_PxD6Joint_Pod const* self_);
    ...
    /// to a distance limit.
void      physx_PxD6Joint_setDistanceLimit_mut(physx_PxD6Joint_Pod* self_, physx_PxJointLinearLimit_Pod const* limit);

    /// Get the distance limit for the joint.
    ///
    /// the distance limit structure
physx_PxJointLinearLimit_Pod      physx_PxD6Joint_getDistanceLimit(physx_PxD6Joint_Pod const* self_);
...
void      physx_PxD6Joint_setLinearLimit_mut(physx_PxD6Joint_Pod* self_, int32_t axis, physx_PxJointLinearLimitPair_Pod const* limit);

    /// Get the linear limit for a given linear axis.
    ///
    /// the linear limit pair structure from desired axis
physx_PxJointLinearLimitPair_Pod      physx_PxD6Joint_getLinearLimit(physx_PxD6Joint_Pod const* self_, int32_t axis);
    ...
    ///
    /// The limit angle range is (-2*Pi, 2*Pi).
void      physx_PxD6Joint_setTwistLimit_mut(physx_PxD6Joint_Pod* self_, physx_PxJointAngularLimitPair_Pod const* limit);

    /// Get the twist limit for the joint.
    ///
    /// the twist limit structure
physx_PxJointAngularLimitPair_Pod      physx_PxD6Joint_getTwistLimit(physx_PxD6Joint_Pod const* self_);
...
void      physx_PxD6Joint_setSwingLimit_mut(physx_PxD6Joint_Pod* self_, physx_PxJointLimitCone_Pod const* limit);

    /// Get the cone limit for the joint.
    ///
    /// the swing limit structure
physx_PxJointLimitCone_Pod      physx_PxD6Joint_getSwingLimit(physx_PxD6Joint_Pod const* self_);
...
void      physx_PxD6Joint_setPyramidSwingLimit_mut(physx_PxD6Joint_Pod* self_, physx_PxJointLimitPyramid_Pod const* limit);

    /// Get the pyramidal swing limit for the joint.
    ///
    /// the swing limit structure
physx_PxJointLimitPyramid_Pod      physx_PxD6Joint_getPyramidSwingLimit(physx_PxD6Joint_Pod const* self_);
...
void      physx_PxD6Joint_setDrive_mut(physx_PxD6Joint_Pod* self_, int32_t index, physx_PxD6JointDrive_Pod const* drive);

    /// Get the drive parameters for the specified drive type.
physx_PxD6JointDrive_Pod      physx_PxD6Joint_getDrive(physx_PxD6Joint_Pod const* self_, int32_t index);
    ...
    /// Default
    /// the identity transform
void      physx_PxD6Joint_setDrivePosition_mut(physx_PxD6Joint_Pod* self_, physx_PxTransform_Pod const* pose, bool autowake);

    /// Get the drive goal pose.
physx_PxTransform_Pod      physx_PxD6Joint_getDrivePosition(physx_PxD6Joint_Pod const* self_);

    /// Set the target goal velocity for drive.
    ///
    /// The velocity is measured in the constraint frame of actor[0]
void      physx_PxD6Joint_setDriveVelocity_mut(physx_PxD6Joint_Pod* self_, physx_PxVec3_Pod const* linear, physx_PxVec3_Pod const* angular, bool autowake);

    /// Get the target goal velocity for joint drive.
void      physx_PxD6Joint_getDriveVelocity(physx_PxD6Joint_Pod const* self_, physx_PxVec3_Pod* linear, physx_PxVec3_Pod* angular);
    ...
    /// Default:
    /// 1e10f
void      physx_PxD6Joint_setProjectionLinearTolerance_mut(physx_PxD6Joint_Pod* self_, float tolerance);

    /// Get the linear tolerance threshold for projection.
    ///
    /// the linear tolerance threshold
float      physx_PxD6Joint_getProjectionLinearTolerance(physx_PxD6Joint_Pod const* self_);
...
void      physx_PxD6Joint_setProjectionAngularTolerance_mut(physx_PxD6Joint_Pod* self_, float tolerance);

    /// Get the angular tolerance threshold for projection.
    ///
    /// tolerance the angular tolerance threshold in radians
float      physx_PxD6Joint_getProjectionAngularTolerance(physx_PxD6Joint_Pod const* self_);

    /// Returns string name of PxD6Joint, used for serialization
char const*      physx_PxD6Joint_getConcreteTypeName(physx_PxD6Joint_Pod const* self_);

    /// Create a gear Joint.
physx_PxGearJoint_Pod*      physx_phys_PxGearJointCreate(physx_PxPhysics_Pod* physics, physx_PxRigidActor_Pod* actor0, physx_PxTransform_Pod const* localFrame0, physx_PxRigidActor_Pod* actor1, physx_PxTransform_Pod const* localFrame1);
    ...
    ///
    /// true if success
bool      physx_PxGearJoint_setHinges_mut(physx_PxGearJoint_Pod* self_, physx_PxBase_Pod const* hinge0, physx_PxBase_Pod const* hinge1);
    ...
    ///
    /// Calling this function resets the internal positional error correction term.
void      physx_PxGearJoint_setGearRatio_mut(physx_PxGearJoint_Pod* self_, float ratio);

    /// Get the gear ratio.
    ///
    /// Current ratio
float      physx_PxGearJoint_getGearRatio(physx_PxGearJoint_Pod const* self_);

char const*      physx_PxGearJoint_getConcreteTypeName(physx_PxGearJoint_Pod const* self_);

    /// Create a rack
    /// &
    /// pinion Joint.
physx_PxRackAndPinionJoint_Pod*      physx_phys_PxRackAndPinionJointCreate(physx_PxPhysics_Pod* physics, physx_PxRigidActor_Pod* actor0, physx_PxTransform_Pod const* localFrame0, physx_PxRigidActor_Pod* actor1, physx_PxTransform_Pod const* localFrame1);
    ...
    ///
    /// true if success
bool      physx_PxRackAndPinionJoint_setJoints_mut(physx_PxRackAndPinionJoint_Pod* self_, physx_PxBase_Pod const* hinge, physx_PxBase_Pod const* prismatic);
    ...
    ///
    /// Calling this function resets the internal positional error correction term.
void      physx_PxRackAndPinionJoint_setRatio_mut(physx_PxRackAndPinionJoint_Pod* self_, float ratio);

    /// Get the ratio.
    ///
    /// Current ratio
float      physx_PxRackAndPinionJoint_getRatio(physx_PxRackAndPinionJoint_Pod const* self_);
    ...
    ///
    /// true if success
bool      physx_PxRackAndPinionJoint_setData_mut(physx_PxRackAndPinionJoint_Pod* self_, uint32_t nbRackTeeth, uint32_t nbPinionTeeth, float rackLength);

char const*      physx_PxRackAndPinionJoint_getConcreteTypeName(physx_PxRackAndPinionJoint_Pod const* self_);

physx_PxGroupsMask_Pod*      physx_PxGroupsMask_new_alloc();

void      physx_PxGroupsMask_delete(physx_PxGroupsMask_Pod* self_);
...
uint16_t      physx_phys_PxDefaultSimulationFilterShader(uint32_t attributes0, physx_PxFilterData_Pod filterData0, uint32_t attributes1, physx_PxFilterData_Pod filterData1, uint16_t* pairFlags, void const* constantBlock, uint32_t constantBlockSize);
...
uint16_t      physx_phys_PxGetGroup(physx_PxActor_Pod const* actor);

    /// Sets which collision group this actor is part of
    ///
    /// Collision group is an integer between 0 and 31.
void      physx_phys_PxSetGroup(physx_PxActor_Pod* actor, uint16_t collisionGroup);
...
void      physx_phys_PxGetFilterConstants(physx_PxGroupsMask_Pod* c0, physx_PxGroupsMask_Pod* c1);

    /// Setups filtering's K0 and K1 value. See comments for PxGroupsMask
void      physx_phys_PxSetFilterConstants(physx_PxGroupsMask_Pod const* c0, physx_PxGroupsMask_Pod const* c1);

    /// Gets 64-bit mask used for collision filtering. See comments for PxGroupsMask
    ///
    /// The group mask for the actor.
physx_PxGroupsMask_Pod      physx_phys_PxGetGroupsMask(physx_PxActor_Pod const* actor);

    /// Sets 64-bit mask used for collision filtering. See comments for PxGroupsMask
void      physx_phys_PxSetGroupsMask(physx_PxActor_Pod* actor, physx_PxGroupsMask_Pod const* mask);

physx_PxDefaultErrorCallback_Pod*      physx_PxDefaultErrorCallback_new_alloc();

void      physx_PxDefaultErrorCallback_delete(physx_PxDefaultErrorCallback_Pod* self_);

void      physx_PxDefaultErrorCallback_reportError_mut(physx_PxDefaultErrorCallback_Pod* self_, int32_t code, char const* message, char const* file, int32_t line);
...
physx_PxShape_Pod*      physx_PxRigidActorExt_createExclusiveShape(physx_PxRigidActor_Pod* actor, physx_PxGeometry_Pod const* geometry, physx_PxMaterial_Pod* const* materials, uint16_t materialCount, uint8_t shapeFlags);
    ...
    ///
    /// The newly created shape.
physx_PxShape_Pod*      physx_PxRigidActorExt_createExclusiveShape_1(physx_PxRigidActor_Pod* actor, physx_PxGeometry_Pod const* geometry, physx_PxMaterial_Pod const* material, uint8_t shapeFlags);
...
physx_PxBounds3_Pod*      physx_PxRigidActorExt_getRigidActorShapeLocalBoundsList(physx_PxRigidActor_Pod const* actor, uint32_t* numBounds);
...
physx_PxBVH_Pod*      physx_PxRigidActorExt_createBVHFromActor(physx_PxPhysics_Pod* physics, physx_PxRigidActor_Pod const* actor);

    /// Default constructor.
physx_PxMassProperties_Pod      physx_PxMassProperties_new();

    /// Construct from individual elements.
physx_PxMassProperties_Pod      physx_PxMassProperties_new_1(float m, physx_PxMat33_Pod const* inertiaT, physx_PxVec3_Pod const* com);
...
physx_PxMassProperties_Pod      physx_PxMassProperties_new_2(physx_PxGeometry_Pod const* geometry);

    /// Translate the center of mass by a given vector and adjust the inertia tensor accordingly.
void      physx_PxMassProperties_translate_mut(physx_PxMassProperties_Pod* self_, physx_PxVec3_Pod const* t);
...
physx_PxVec3_Pod      physx_PxMassProperties_getMassSpaceInertia(physx_PxMat33_Pod const* inertia, physx_PxQuat_Pod* massFrame);

    /// Translate an inertia tensor using the parallel axis theorem
    ///
    /// The translated inertia tensor.
physx_PxMat33_Pod      physx_PxMassProperties_translateInertia(physx_PxMat33_Pod const* inertia, float mass, physx_PxVec3_Pod const* t);

    /// Rotate an inertia tensor around the center of mass
    ///
    /// The rotated inertia tensor.
physx_PxMat33_Pod      physx_PxMassProperties_rotateInertia(physx_PxMat33_Pod const* inertia, physx_PxQuat_Pod const* q);

    /// Non-uniform scaling of the inertia tensor
    ///
    /// The scaled inertia tensor.
physx_PxMat33_Pod      physx_PxMassProperties_scaleInertia(physx_PxMat33_Pod const* inertia, physx_PxQuat_Pod const* scaleRotation, physx_PxVec3_Pod const* scale);

    /// Sum up individual mass properties.
    ///
    /// The summed up mass properties.
physx_PxMassProperties_Pod      physx_PxMassProperties_sum(physx_PxMassProperties_Pod const* props, physx_PxTransform_Pod const* transforms, uint32_t count);
...
bool      physx_PxRigidBodyExt_updateMassAndInertia(physx_PxRigidBody_Pod* body, float const* shapeDensities, uint32_t shapeDensityCount, physx_PxVec3_Pod const* massLocalPose, bool includeNonSimShapes);
    ...
    ///
    /// Boolean. True on success else false.
bool      physx_PxRigidBodyExt_updateMassAndInertia_1(physx_PxRigidBody_Pod* body, float density, physx_PxVec3_Pod const* massLocalPose, bool includeNonSimShapes);
    ...
    ///
    /// Boolean. True on success else false.
bool      physx_PxRigidBodyExt_setMassAndUpdateInertia(physx_PxRigidBody_Pod* body, float const* shapeMasses, uint32_t shapeMassCount, physx_PxVec3_Pod const* massLocalPose, bool includeNonSimShapes);
    ...
    ///
    /// Boolean. True on success else false.
bool      physx_PxRigidBodyExt_setMassAndUpdateInertia_1(physx_PxRigidBody_Pod* body, float mass, physx_PxVec3_Pod const* massLocalPose, bool includeNonSimShapes);

    /// Compute the mass, inertia tensor and center of mass from a list of shapes.
    ///
    /// The mass properties from the combined shapes.
physx_PxMassProperties_Pod      physx_PxRigidBodyExt_computeMassPropertiesFromShapes(physx_PxShape_Pod const* const* shapes, uint32_t shapeCount);
...
void      physx_PxRigidBodyExt_addForceAtPos(physx_PxRigidBody_Pod* body, physx_PxVec3_Pod const* force, physx_PxVec3_Pod const* pos, int32_t mode, bool wakeup);
    ...
    /// Sleeping:
    /// This call wakes the actor if it is sleeping and the wakeup parameter is true (default).
void      physx_PxRigidBodyExt_addForceAtLocalPos(physx_PxRigidBody_Pod* body, physx_PxVec3_Pod const* force, physx_PxVec3_Pod const* pos, int32_t mode, bool wakeup);
    ...
    /// Sleeping:
    /// This call wakes the actor if it is sleeping and the wakeup parameter is true (default).
void      physx_PxRigidBodyExt_addLocalForceAtPos(physx_PxRigidBody_Pod* body, physx_PxVec3_Pod const* force, physx_PxVec3_Pod const* pos, int32_t mode, bool wakeup);
    ...
    /// Sleeping:
    /// This call wakes the actor if it is sleeping and the wakeup parameter is true (default).
void      physx_PxRigidBodyExt_addLocalForceAtLocalPos(physx_PxRigidBody_Pod* body, physx_PxVec3_Pod const* force, physx_PxVec3_Pod const* pos, int32_t mode, bool wakeup);
...
physx_PxVec3_Pod      physx_PxRigidBodyExt_getVelocityAtPos(physx_PxRigidBody_Pod const* body, physx_PxVec3_Pod const* pos);
...
physx_PxVec3_Pod      physx_PxRigidBodyExt_getLocalVelocityAtLocalPos(physx_PxRigidBody_Pod const* body, physx_PxVec3_Pod const* pos);
...
physx_PxVec3_Pod      physx_PxRigidBodyExt_getVelocityAtOffset(physx_PxRigidBody_Pod const* body, physx_PxVec3_Pod const* pos);
...
void      physx_PxRigidBodyExt_computeVelocityDeltaFromImpulse(physx_PxRigidBody_Pod const* body, physx_PxVec3_Pod const* impulsiveForce, physx_PxVec3_Pod const* impulsiveTorque, physx_PxVec3_Pod* deltaLinearVelocity, physx_PxVec3_Pod* deltaAngularVelocity);
...
void      physx_PxRigidBodyExt_computeLinearAngularImpulse(physx_PxRigidBody_Pod const* body, physx_PxTransform_Pod const* globalPose, physx_PxVec3_Pod const* point, physx_PxVec3_Pod const* impulse, float invMassScale, float invInertiaScale, physx_PxVec3_Pod* linearImpulse, physx_PxVec3_Pod* angularImpulse);
...
bool      physx_PxRigidBodyExt_linearSweepSingle(physx_PxRigidBody_Pod* body, physx_PxScene_Pod* scene, physx_PxVec3_Pod const* unitDir, float distance, uint16_t outputFlags, physx_PxSweepHit_Pod* closestHit, uint32_t* shapeIndex, physx_PxQueryFilterData_Pod const* filterData, physx_PxQueryFilterCallback_Pod* filterCall, physx_PxQueryCache_Pod const* cache, float inflation);
...
physx_PxTransform_Pod      physx_PxShapeExt_getGlobalPose(physx_PxShape_Pod const* shape, physx_PxRigidActor_Pod const* actor);

    /// Raycast test against the shape.
    ///
    /// Number of hits between the ray and the shape
uint32_t      physx_PxShapeExt_raycast(physx_PxShape_Pod const* shape, physx_PxRigidActor_Pod const* actor, physx_PxVec3_Pod const* rayOrigin, physx_PxVec3_Pod const* rayDir, float maxDist, uint16_t hitFlags, uint32_t maxHits, physx_PxRaycastHit_Pod* rayHits);

    /// Test overlap between the shape and a geometry object
    ///
    /// True if the shape overlaps the geometry object
bool      physx_PxShapeExt_overlap(physx_PxShape_Pod const* shape, physx_PxRigidActor_Pod const* actor, physx_PxGeometry_Pod const* otherGeom, physx_PxTransform_Pod const* otherGeomPose);
...
bool      physx_PxShapeExt_sweep(physx_PxShape_Pod const* shape, physx_PxRigidActor_Pod const* actor, physx_PxVec3_Pod const* unitDir, float distance, physx_PxGeometry_Pod const* otherGeom, physx_PxTransform_Pod const* otherGeomPose, physx_PxSweepHit_Pod* sweepHit, uint16_t hitFlags);

    /// Retrieves the axis aligned bounding box enclosing the shape.
    ///
    /// The shape's bounding box.
physx_PxBounds3_Pod      physx_PxShapeExt_getWorldBounds(physx_PxShape_Pod const* shape, physx_PxRigidActor_Pod const* actor, float inflation);

physx_PxMeshOverlapUtil_Pod*      physx_PxMeshOverlapUtil_new_alloc();

void      physx_PxMeshOverlapUtil_delete(physx_PxMeshOverlapUtil_Pod* self_);

    /// Find the mesh triangles which touch the specified geometry object.
    ///
    /// Number of overlaps found. Triangle indices can then be accessed through the [`getResults`]() function.
uint32_t      physx_PxMeshOverlapUtil_findOverlap_mut(physx_PxMeshOverlapUtil_Pod* self_, physx_PxGeometry_Pod const* geom, physx_PxTransform_Pod const* geomPose, physx_PxTriangleMeshGeometry_Pod const* meshGeom, physx_PxTransform_Pod const* meshPose);

    /// Find the height field triangles which touch the specified geometry object.
    ///
    /// Number of overlaps found. Triangle indices can then be accessed through the [`getResults`]() function.
uint32_t      physx_PxMeshOverlapUtil_findOverlap_mut_1(physx_PxMeshOverlapUtil_Pod* self_, physx_PxGeometry_Pod const* geom, physx_PxTransform_Pod const* geomPose, physx_PxHeightFieldGeometry_Pod const* hfGeom, physx_PxTransform_Pod const* hfPose);

    /// Retrieves array of triangle indices after a findOverlap call.
    ///
    /// Indices of touched triangles
uint32_t const*      physx_PxMeshOverlapUtil_getResults(physx_PxMeshOverlapUtil_Pod const* self_);

    /// Retrieves number of triangle indices after a findOverlap call.
    ///
    /// Number of touched triangles
uint32_t      physx_PxMeshOverlapUtil_getNbResults(physx_PxMeshOverlapUtil_Pod const* self_);
    ...
    ///
    /// True if the MTD has successfully been computed, i.e. if objects do overlap.
bool      physx_phys_PxComputeTriangleMeshPenetration(physx_PxVec3_Pod* direction, float* depth, physx_PxGeometry_Pod const* geom, physx_PxTransform_Pod const* geomPose, physx_PxTriangleMeshGeometry_Pod const* meshGeom, physx_PxTransform_Pod const* meshPose, uint32_t maxIter, uint32_t* usedIter);
    ...
    ///
    /// True if the MTD has successfully been computed, i.e. if objects do overlap.
bool      physx_phys_PxComputeHeightFieldPenetration(physx_PxVec3_Pod* direction, float* depth, physx_PxGeometry_Pod const* geom, physx_PxTransform_Pod const* geomPose, physx_PxHeightFieldGeometry_Pod const* heightFieldGeom, physx_PxTransform_Pod const* heightFieldPose, uint32_t maxIter, uint32_t* usedIter);

physx_PxXmlMiscParameter_Pod      physx_PxXmlMiscParameter_new();

physx_PxXmlMiscParameter_Pod      physx_PxXmlMiscParameter_new_1(physx_PxVec3_Pod* inUpVector, physx_PxTolerancesScale_Pod inScale);
...
bool      physx_PxSerialization_isSerializable(physx_PxCollection_Pod* collection, physx_PxSerializationRegistry_Pod* sr, physx_PxCollection_Pod const* externalReferences);
...
void      physx_PxSerialization_complete(physx_PxCollection_Pod* collection, physx_PxSerializationRegistry_Pod* sr, physx_PxCollection_Pod const* exceptFor, bool followJoints);
...
void      physx_PxSerialization_createSerialObjectIds(physx_PxCollection_Pod* collection, uint64_t base);

    /// Creates a PxCollection from XML data.
    ///
    /// a pointer to a PxCollection if successful or NULL if it failed.
physx_PxCollection_Pod*      physx_PxSerialization_createCollectionFromXml(physx_PxInputData_Pod* inputData, physx_PxCooking_Pod* cooking, physx_PxSerializationRegistry_Pod* sr, physx_PxCollection_Pod const* externalRefs, physx_PxStringTable_Pod* stringTable, physx_PxXmlMiscParameter_Pod* outArgs);
...
physx_PxCollection_Pod*      physx_PxSerialization_createCollectionFromBinary(void* memBlock, physx_PxSerializationRegistry_Pod* sr, physx_PxCollection_Pod const* externalRefs);
...
bool      physx_PxSerialization_serializeCollectionToXml(physx_PxOutputStream_Pod* outputStream, physx_PxCollection_Pod* collection, physx_PxSerializationRegistry_Pod* sr, physx_PxCooking_Pod* cooking, physx_PxCollection_Pod const* externalRefs, physx_PxXmlMiscParameter_Pod* inArgs);
...
bool      physx_PxSerialization_serializeCollectionToBinary(physx_PxOutputStream_Pod* outputStream, physx_PxCollection_Pod* collection, physx_PxSerializationRegistry_Pod* sr, physx_PxCollection_Pod const* externalRefs, bool exportNames);

    /// Creates an application managed registry for serialization.
    ///
    /// PxSerializationRegistry instance.
physx_PxSerializationRegistry_Pod*      physx_PxSerialization_createSerializationRegistry(physx_PxPhysics_Pod* physics);

    /// Deletes the dispatcher.
    ///
    /// Do not keep a reference to the deleted instance.
void      physx_PxDefaultCpuDispatcher_release_mut(physx_PxDefaultCpuDispatcher_Pod* self_);

    /// Enables profiling at task level.
    ///
    /// By default enabled only in profiling builds.
void      physx_PxDefaultCpuDispatcher_setRunProfiled_mut(physx_PxDefaultCpuDispatcher_Pod* self_, bool runProfiled);

    /// Checks if profiling is enabled at task level.
    ///
    /// True if tasks should be profiled.
bool      physx_PxDefaultCpuDispatcher_getRunProfiled(physx_PxDefaultCpuDispatcher_Pod const* self_);
...
physx_PxDefaultCpuDispatcher_Pod*      physx_phys_PxDefaultCpuDispatcherCreate(uint32_t numThreads, uint32_t* affinityMasks, int32_t mode, uint32_t yieldProcessorCount);
    ...
    ///
    /// True on success.
bool      physx_phys_PxBuildSmoothNormals(uint32_t nbTris, uint32_t nbVerts, physx_PxVec3_Pod const* verts, uint32_t const* dFaces, uint16_t const* wFaces, physx_PxVec3_Pod* normals, bool flip);
    ...
    /// not be constructed
physx_PxRigidDynamic_Pod*      physx_phys_PxCreateDynamic(physx_PxPhysics_Pod* sdk, physx_PxTransform_Pod const* transform, physx_PxGeometry_Pod const* geometry, physx_PxMaterial_Pod* material, float density, physx_PxTransform_Pod const* shapeOffset);

    /// simple method to create a PxRigidDynamic actor with a single PxShape.
    ///
    /// a new dynamic actor with the PxRigidBodyFlag, or NULL if it could
    /// not be constructed
physx_PxRigidDynamic_Pod*      physx_phys_PxCreateDynamic_1(physx_PxPhysics_Pod* sdk, physx_PxTransform_Pod const* transform, physx_PxShape_Pod* shape, float density);
    ...
    /// not be constructed
physx_PxRigidDynamic_Pod*      physx_phys_PxCreateKinematic(physx_PxPhysics_Pod* sdk, physx_PxTransform_Pod const* transform, physx_PxGeometry_Pod const* geometry, physx_PxMaterial_Pod* material, float density, physx_PxTransform_Pod const* shapeOffset);
    ...
    /// a new dynamic actor with the PxRigidBodyFlag::eKINEMATIC set, or NULL if it could
    /// not be constructed
physx_PxRigidDynamic_Pod*      physx_phys_PxCreateKinematic_1(physx_PxPhysics_Pod* sdk, physx_PxTransform_Pod const* transform, physx_PxShape_Pod* shape, float density);
...
physx_PxRigidStatic_Pod*      physx_phys_PxCreateStatic(physx_PxPhysics_Pod* sdk, physx_PxTransform_Pod const* transform, physx_PxGeometry_Pod const* geometry, physx_PxMaterial_Pod* material, physx_PxTransform_Pod const* shapeOffset);

    /// simple method to create a PxRigidStatic actor with a single PxShape.
    ///
    /// a new static actor, or NULL if it could not be constructed
physx_PxRigidStatic_Pod*      physx_phys_PxCreateStatic_1(physx_PxPhysics_Pod* sdk, physx_PxTransform_Pod const* transform, physx_PxShape_Pod* shape);
...
physx_PxShape_Pod*      physx_phys_PxCloneShape(physx_PxPhysics_Pod* physicsSDK, physx_PxShape_Pod const* shape, bool isExclusive);
    ...
    ///
    /// the newly-created rigid static
physx_PxRigidStatic_Pod*      physx_phys_PxCloneStatic(physx_PxPhysics_Pod* physicsSDK, physx_PxTransform_Pod const* transform, physx_PxRigidActor_Pod const* actor);
    ...
    ///
    /// the newly-created rigid static
physx_PxRigidDynamic_Pod*      physx_phys_PxCloneDynamic(physx_PxPhysics_Pod* physicsSDK, physx_PxTransform_Pod const* transform, physx_PxRigidDynamic_Pod const* body);

    /// create a plane actor. The plane equation is n.x + d = 0
    ///
    /// a new static actor, or NULL if it could not be constructed
physx_PxRigidStatic_Pod*      physx_phys_PxCreatePlane(physx_PxPhysics_Pod* sdk, physx_PxPlane_Pod const* plane, physx_PxMaterial_Pod* material);
...
void      physx_phys_PxScaleRigidActor(physx_PxRigidActor_Pod* actor, float scale, bool scaleMassProps);

physx_PxStringTable_Pod*      physx_PxStringTableExt_createStringTable(physx_PxAllocatorCallback_Pod* inAllocator);
...
uint32_t      physx_PxBroadPhaseExt_createRegionsFromWorldBounds(physx_PxBounds3_Pod* regions, physx_PxBounds3_Pod const* globalBounds, uint32_t nbSubdiv, uint32_t upAxis);
    ...
    ///
    /// True if a blocking hit was found.
bool      physx_PxSceneQueryExt_raycastAny(physx_PxScene_Pod const* scene, physx_PxVec3_Pod const* origin, physx_PxVec3_Pod const* unitDir, float distance, physx_PxQueryHit_Pod* hit, physx_PxQueryFilterData_Pod const* filterData, physx_PxQueryFilterCallback_Pod* filterCall, physx_PxQueryCache_Pod const* cache);
    ...
    ///
    /// True if a blocking hit was found.
bool      physx_PxSceneQueryExt_raycastSingle(physx_PxScene_Pod const* scene, physx_PxVec3_Pod const* origin, physx_PxVec3_Pod const* unitDir, float distance, uint16_t outputFlags, physx_PxRaycastHit_Pod* hit, physx_PxQueryFilterData_Pod const* filterData, physx_PxQueryFilterCallback_Pod* filterCall, physx_PxQueryCache_Pod const* cache);
...
int32_t      physx_PxSceneQueryExt_raycastMultiple(physx_PxScene_Pod const* scene, physx_PxVec3_Pod const* origin, physx_PxVec3_Pod const* unitDir, float distance, uint16_t outputFlags, physx_PxRaycastHit_Pod* hitBuffer, uint32_t hitBufferSize, bool* blockingHit, physx_PxQueryFilterData_Pod const* filterData, physx_PxQueryFilterCallback_Pod* filterCall, physx_PxQueryCache_Pod const* cache);
...
int32_t      physx_PxSceneQueryExt_sweepMultiple(physx_PxScene_Pod const* scene, physx_PxGeometry_Pod const* geometry, physx_PxTransform_Pod const* pose, physx_PxVec3_Pod const* unitDir, float distance, uint16_t outputFlags, physx_PxSweepHit_Pod* hitBuffer, uint32_t hitBufferSize, bool* blockingHit, physx_PxQueryFilterData_Pod const* filterData, physx_PxQueryFilterCallback_Pod* filterCall, physx_PxQueryCache_Pod const* cache, float inflation);
    ...
    ///
    /// Number of hits in the buffer, or -1 if the buffer overflowed.
int32_t      physx_PxSceneQueryExt_overlapMultiple(physx_PxScene_Pod const* scene, physx_PxGeometry_Pod const* geometry, physx_PxTransform_Pod const* pose, physx_PxOverlapHit_Pod* hitBuffer, uint32_t hitBufferSize, physx_PxQueryFilterData_Pod const* filterData, physx_PxQueryFilterCallback_Pod* filterCall);
...
bool      physx_PxSceneQueryExt_overlapAny(physx_PxScene_Pod const* scene, physx_PxGeometry_Pod const* geometry, physx_PxTransform_Pod const* pose, physx_PxOverlapHit_Pod* hit, physx_PxQueryFilterData_Pod const* filterData, physx_PxQueryFilterCallback_Pod* filterCall);

void      physx_PxBatchQueryExt_release_mut(physx_PxBatchQueryExt_Pod* self_);
...
physx_PxRaycastBuffer_Pod*      physx_PxBatchQueryExt_raycast_mut(physx_PxBatchQueryExt_Pod* self_, physx_PxVec3_Pod const* origin, physx_PxVec3_Pod const* unitDir, float distance, uint16_t maxNbTouches, uint16_t hitFlags, physx_PxQueryFilterData_Pod const* filterData, physx_PxQueryCache_Pod const* cache);
    ...
    /// This will point either to an element of the buffer allocated on construction or to a user buffer passed to the constructor.
physx_PxSweepBuffer_Pod*      physx_PxBatchQueryExt_sweep_mut(physx_PxBatchQueryExt_Pod* self_, physx_PxGeometry_Pod const* geometry, physx_PxTransform_Pod const* pose, physx_PxVec3_Pod const* unitDir, float distance, uint16_t maxNbTouches, uint16_t hitFlags, physx_PxQueryFilterData_Pod const* filterData, physx_PxQueryCache_Pod const* cache, float inflation);
    ...
    /// This will point either to an element of the buffer allocated on construction or to a user buffer passed to the constructor.
physx_PxOverlapBuffer_Pod*      physx_PxBatchQueryExt_overlap_mut(physx_PxBatchQueryExt_Pod* self_, physx_PxGeometry_Pod const* geometry, physx_PxTransform_Pod const* pose, uint16_t maxNbTouches, physx_PxQueryFilterData_Pod const* filterData, physx_PxQueryCache_Pod const* cache);

void      physx_PxBatchQueryExt_execute_mut(physx_PxBatchQueryExt_Pod* self_);
...
physx_PxBatchQueryExt_Pod*      physx_phys_PxCreateBatchQueryExt(physx_PxScene_Pod const* scene, physx_PxQueryFilterCallback_Pod* queryFilterCallback, uint32_t maxNbRaycasts, uint32_t maxNbRaycastTouches, uint32_t maxNbSweeps, uint32_t maxNbSweepTouches, uint32_t maxNbOverlaps, uint32_t maxNbOverlapTouches);

    /// Create a PxBatchQueryExt with user-supplied result and touch buffers.
    ///
    /// Returns a PxBatchQueryExt instance. A NULL pointer will be returned if the subsequent allocations fail or if any of the arguments are illegal.
    /// In the event that a NULL pointer is returned a corresponding error will be issued to the error stream.
physx_PxBatchQueryExt_Pod*      physx_phys_PxCreateBatchQueryExt_1(physx_PxScene_Pod const* scene, physx_PxQueryFilterCallback_Pod* queryFilterCallback, physx_PxRaycastBuffer_Pod* raycastBuffers, uint32_t maxNbRaycasts, physx_PxRaycastHit_Pod* raycastTouches, uint32_t maxNbRaycastTouches, physx_PxSweepBuffer_Pod* sweepBuffers, uint32_t maxNbSweeps, physx_PxSweepHit_Pod* sweepTouches, uint32_t maxNbSweepTouches, physx_PxOverlapBuffer_Pod* overlapBuffers, uint32_t maxNbOverlaps, physx_PxOverlapHit_Pod* overlapTouches, uint32_t maxNbOverlapTouches);
...
physx_PxSceneQuerySystem_Pod*      physx_phys_PxCreateExternalSceneQuerySystem(physx_PxSceneQueryDesc_Pod const* desc, uint64_t contextID);
    ...
    ///
    /// A pruner index
uint32_t      physx_PxCustomSceneQuerySystem_addPruner_mut(physx_PxCustomSceneQuerySystem_Pod* self_, int32_t primaryType, int32_t secondaryType, uint32_t preallocated);
...
uint32_t      physx_PxCustomSceneQuerySystem_startCustomBuildstep_mut(physx_PxCustomSceneQuerySystem_Pod* self_);

    /// Perform a custom build-step for a given pruner.
void      physx_PxCustomSceneQuerySystem_customBuildstep_mut(physx_PxCustomSceneQuerySystem_Pod* self_, uint32_t index);

    /// Finish custom build-steps
    ///
    /// Call this function once after all the customBuildstep() calls are done.
void      physx_PxCustomSceneQuerySystem_finishCustomBuildstep_mut(physx_PxCustomSceneQuerySystem_Pod* self_);

void      physx_PxCustomSceneQuerySystemAdapter_delete(physx_PxCustomSceneQuerySystemAdapter_Pod* self_);
...
uint32_t      physx_PxCustomSceneQuerySystemAdapter_getPrunerIndex(physx_PxCustomSceneQuerySystemAdapter_Pod const* self_, physx_PxRigidActor_Pod const* actor, physx_PxShape_Pod const* shape);
...
bool      physx_PxCustomSceneQuerySystemAdapter_processPruner(physx_PxCustomSceneQuerySystemAdapter_Pod const* self_, uint32_t prunerIndex, physx_PxQueryThreadContext_Pod const* context, physx_PxQueryFilterData_Pod const* filterData, physx_PxQueryFilterCallback_Pod* filterCall);
...
physx_PxCustomSceneQuerySystem_Pod*      physx_phys_PxCreateCustomSceneQuerySystem(int32_t sceneQueryUpdateMode, uint64_t contextID, physx_PxCustomSceneQuerySystemAdapter_Pod const* adapter, bool usesTreeOfPruners);
...
uint32_t      physx_phys_PxFindFaceIndex(physx_PxConvexMeshGeometry_Pod const* convexGeom, physx_PxTransform_Pod const* geomPose, physx_PxVec3_Pod const* impactPos, physx_PxVec3_Pod const* unitDir);
...
bool      physx_PxPoissonSampler_setSamplingRadius_mut(physx_PxPoissonSampler_Pod* self_, float samplingRadius);

    /// Adds new Poisson Samples inside the sphere specified
void      physx_PxPoissonSampler_addSamplesInSphere_mut(physx_PxPoissonSampler_Pod* self_, physx_PxVec3_Pod const* sphereCenter, float sphereRadius, bool createVolumeSamples);

    /// Adds new Poisson Samples inside the box specified
void      physx_PxPoissonSampler_addSamplesInBox_mut(physx_PxPoissonSampler_Pod* self_, physx_PxBounds3_Pod const* axisAlignedBox, physx_PxQuat_Pod const* boxOrientation, bool createVolumeSamples);

void      physx_PxPoissonSampler_delete(physx_PxPoissonSampler_Pod* self_);

    /// Creates a shape sampler
    ///
    /// Returns the sampler
physx_PxPoissonSampler_Pod*      physx_phys_PxCreateShapeSampler(physx_PxGeometry_Pod const* geometry, physx_PxTransform_Pod const* transform, physx_PxBounds3_Pod const* worldBounds, float initialSamplingRadius, int32_t numSampleAttemptsAroundPoint);

    /// Checks whether a point is inside the triangle mesh
    ///
    /// Returns true if the point is inside the triangle mesh
bool      physx_PxTriangleMeshPoissonSampler_isPointInTriangleMesh_mut(physx_PxTriangleMeshPoissonSampler_Pod* self_, physx_PxVec3_Pod const* p);

void      physx_PxTriangleMeshPoissonSampler_delete(physx_PxTriangleMeshPoissonSampler_Pod* self_);

    /// Creates a triangle mesh sampler
    ///
    /// Returns the sampler
physx_PxTriangleMeshPoissonSampler_Pod*      physx_phys_PxCreateTriangleMeshSampler(uint32_t const* triangles, uint32_t numTriangles, physx_PxVec3_Pod const* vertices, uint32_t numVertices, float initialSamplingRadius, int32_t numSampleAttemptsAroundPoint);
...
int32_t      physx_PxTetrahedronMeshExt_findTetrahedronContainingPoint(physx_PxTetrahedronMesh_Pod const* mesh, physx_PxVec3_Pod const* point, physx_PxVec4_Pod* bary, float tolerance);

    /// Returns the index of the tetrahedron closest to a point
    ///
    /// The index of the tetrahedon closest to the point
int32_t      physx_PxTetrahedronMeshExt_findTetrahedronClosestToPoint(physx_PxTetrahedronMesh_Pod const* mesh, physx_PxVec3_Pod const* point, physx_PxVec4_Pod* bary);
...
bool      physx_phys_PxInitExtensions(physx_PxPhysics_Pod* physics, physx_PxPvd_Pod* pvd);
...
bool      physx_PxRepXObject_isValid(physx_PxRepXObject_Pod const* self_);

physx_PxRepXInstantiationArgs_Pod      physx_PxRepXInstantiationArgs_new(physx_PxPhysics_Pod* inPhysics, physx_PxCooking_Pod* inCooking, physx_PxStringTable_Pod* inStringTable);

    /// The type this Serializer is meant to operate on.
char const*      physx_PxRepXSerializer_getTypeName_mut(physx_PxRepXSerializer_Pod* self_);

    /// Convert from a RepX object to a key-value pair hierarchy
void      physx_PxRepXSerializer_objectToFile_mut(physx_PxRepXSerializer_Pod* self_, physx_PxRepXObject_Pod const* inLiveObject, physx_PxCollection_Pod* inCollection, physx_XmlWriter_Pod* inWriter, physx_MemoryBuffer_Pod* inTempBuffer, physx_PxRepXInstantiationArgs_Pod* inArgs);
...
physx_PxRepXObject_Pod      physx_PxRepXSerializer_fileToObject_mut(physx_PxRepXSerializer_Pod* self_, physx_XmlReader_Pod* inReader, physx_XmlMemoryAllocator_Pod* inAllocator, physx_PxRepXInstantiationArgs_Pod* inArgs, physx_PxCollection_Pod* inCollection);

    /// Connects the SDK to the PhysX Visual Debugger application.
bool      physx_PxPvd_connect_mut(physx_PxPvd_Pod* self_, physx_PxPvdTransport_Pod* transport, uint8_t flags);
...
void      physx_PxPvd_disconnect_mut(physx_PxPvd_Pod* self_);

    /// Return if connection to PVD is created.
bool      physx_PxPvd_isConnected_mut(physx_PxPvd_Pod* self_, bool useCachedStatus);

    /// returns the PVD data transport
    /// returns NULL if no transport is present.
physx_PxPvdTransport_Pod*      physx_PxPvd_getTransport_mut(physx_PxPvd_Pod* self_);

    /// Retrieves the PVD flags. See PxPvdInstrumentationFlags.
uint8_t      physx_PxPvd_getInstrumentationFlags_mut(physx_PxPvd_Pod* self_);

    /// Releases the pvd instance.
void      physx_PxPvd_release_mut(physx_PxPvd_Pod* self_);

    /// Create a pvd instance.
physx_PxPvd_Pod*      physx_phys_PxCreatePvd(physx_PxFoundation_Pod* foundation);

    /// Connects to the Visual Debugger application.
    /// return True if success
bool      physx_PxPvdTransport_connect_mut(physx_PxPvdTransport_Pod* self_);

    /// Disconnects from the Visual Debugger application.
    /// If we are still connected, this will kill the entire debugger connection.
void      physx_PxPvdTransport_disconnect_mut(physx_PxPvdTransport_Pod* self_);

    /// Return if connection to PVD is created.
bool      physx_PxPvdTransport_isConnected_mut(physx_PxPvdTransport_Pod* self_);
...
bool      physx_PxPvdTransport_write_mut(physx_PxPvdTransport_Pod* self_, uint8_t const* inBytes, uint32_t inLength);

physx_PxPvdTransport_Pod*      physx_PxPvdTransport_lock_mut(physx_PxPvdTransport_Pod* self_);

void      physx_PxPvdTransport_unlock_mut(physx_PxPvdTransport_Pod* self_);

    /// send any data and block until we know it is at least on the wire.
void      physx_PxPvdTransport_flush_mut(physx_PxPvdTransport_Pod* self_);

    /// Return size of written data.
uint64_t      physx_PxPvdTransport_getWrittenDataSize_mut(physx_PxPvdTransport_Pod* self_);

void      physx_PxPvdTransport_release_mut(physx_PxPvdTransport_Pod* self_);
