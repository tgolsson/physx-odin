...
extern "C" {
    void physx_PxAllocatorCallback_delete(physx_PxAllocatorCallback_Pod* self__pod) {
        physx::PxAllocatorCallback* self_ = reinterpret_cast<physx::PxAllocatorCallback*>(self__pod);
        delete self_;
    }

    void* physx_PxAllocatorCallback_allocate_mut(physx_PxAllocatorCallback_Pod* self__pod, size_t size_pod, char const* typeName, char const* filename, int32_t line) {
        physx::PxAllocatorCallback* self_ = reinterpret_cast<physx::PxAllocatorCallback*>(self__pod);
        size_t size;
    ...
    void physx_PxAllocatorCallback_deallocate_mut(physx_PxAllocatorCallback_Pod* self__pod, void* ptr) {
        physx::PxAllocatorCallback* self_ = reinterpret_cast<physx::PxAllocatorCallback*>(self__pod);
        self_->deallocate(ptr);
    }

    void physx_PxAssertHandler_delete(physx_PxAssertHandler_Pod* self__pod) {
        physx::PxAssertHandler* self_ = reinterpret_cast<physx::PxAssertHandler*>(self__pod);
        delete self_;
    }

    physx_PxAssertHandler_Pod* physx_phys_PxGetAssertHandler() {
    ...
    void physx_phys_PxSetAssertHandler(physx_PxAssertHandler_Pod* handler_pod) {
        physx::PxAssertHandler& handler = reinterpret_cast<physx::PxAssertHandler&>(*handler_pod);
        PxSetAssertHandler(handler);
    }

    void physx_PxFoundation_release_mut(physx_PxFoundation_Pod* self__pod) {
        physx::PxFoundation* self_ = reinterpret_cast<physx::PxFoundation*>(self__pod);
        self_->release();
    }

    physx_PxErrorCallback_Pod* physx_PxFoundation_getErrorCallback_mut(physx_PxFoundation_Pod* self__pod) {
        physx::PxFoundation* self_ = reinterpret_cast<physx::PxFoundation*>(self__pod);
    ...
    void physx_PxFoundation_setErrorLevel_mut(physx_PxFoundation_Pod* self__pod, uint32_t mask) {
        physx::PxFoundation* self_ = reinterpret_cast<physx::PxFoundation*>(self__pod);
        self_->setErrorLevel(mask);
    }

    uint32_t physx_PxFoundation_getErrorLevel(physx_PxFoundation_Pod const* self__pod) {
    ...
    physx_PxAllocatorCallback_Pod* physx_PxFoundation_getAllocatorCallback_mut(physx_PxFoundation_Pod* self__pod) {
        physx::PxFoundation* self_ = reinterpret_cast<physx::PxFoundation*>(self__pod);
    ...
    bool physx_PxFoundation_getReportAllocationNames(physx_PxFoundation_Pod const* self__pod) {
        physx::PxFoundation const* self_ = reinterpret_cast<physx::PxFoundation const*>(self__pod);
        bool return_val = self_->getReportAllocationNames();
        return return_val;
    }

    void physx_PxFoundation_setReportAllocationNames_mut(physx_PxFoundation_Pod* self__pod, bool value) {
        physx::PxFoundation* self_ = reinterpret_cast<physx::PxFoundation*>(self__pod);
        self_->setReportAllocationNames(value);
    }

    void physx_PxFoundation_registerAllocationListener_mut(physx_PxFoundation_Pod* self__pod, physx_PxAllocationListener_Pod* listener_pod) {
        physx::PxFoundation* self_ = reinterpret_cast<physx::PxFoundation*>(self__pod);
    ...
    void physx_PxFoundation_deregisterAllocationListener_mut(physx_PxFoundation_Pod* self__pod, physx_PxAllocationListener_Pod* listener_pod) {
        physx::PxFoundation* self_ = reinterpret_cast<physx::PxFoundation*>(self__pod);
        physx::PxAllocationListener& listener = reinterpret_cast<physx::PxAllocationListener&>(*listener_pod);
        self_->deregisterAllocationListener(listener);
    }

    void physx_PxFoundation_registerErrorCallback_mut(physx_PxFoundation_Pod* self__pod, physx_PxErrorCallback_Pod* callback_pod) {
        physx::PxFoundation* self_ = reinterpret_cast<physx::PxFoundation*>(self__pod);
        physx::PxErrorCallback& callback = reinterpret_cast<physx::PxErrorCallback&>(*callback_pod);
        self_->registerErrorCallback(callback);
    }

    void physx_PxFoundation_deregisterErrorCallback_mut(physx_PxFoundation_Pod* self__pod, physx_PxErrorCallback_Pod* callback_pod) {
        physx::PxFoundation* self_ = reinterpret_cast<physx::PxFoundation*>(self__pod);
        physx::PxErrorCallback& callback = reinterpret_cast<physx::PxErrorCallback&>(*callback_pod);
        self_->deregisterErrorCallback(callback);
    }

    physx_PxFoundation_Pod* physx_phys_PxCreateFoundation(uint32_t version, physx_PxAllocatorCallback_Pod* allocator_pod, physx_PxErrorCallback_Pod* errorCallback_pod) {
    ...
    void physx_phys_PxSetFoundationInstance(physx_PxFoundation_Pod* foundation_pod) {
        physx::PxFoundation& foundation = reinterpret_cast<physx::PxFoundation&>(*foundation_pod);
        PxSetFoundationInstance(foundation);
    }

    physx_PxFoundation_Pod* physx_phys_PxGetFoundation() {
        physx::PxFoundation& return_val = PxGetFoundation();
        auto return_val_pod = reinterpret_cast<physx_PxFoundation_Pod*>(&return_val);
        return return_val_pod;
    }

    physx_PxProfilerCallback_Pod* physx_phys_PxGetProfilerCallback() {
    ...
    void physx_phys_PxSetProfilerCallback(physx_PxProfilerCallback_Pod* profiler_pod) {
        physx::PxProfilerCallback* profiler = reinterpret_cast<physx::PxProfilerCallback*>(profiler_pod);
        PxSetProfilerCallback(profiler);
    }

    physx_PxAllocatorCallback_Pod* physx_phys_PxGetAllocatorCallback() {
        physx::PxAllocatorCallback* return_val = PxGetAllocatorCallback();
        auto return_val_pod = reinterpret_cast<physx_PxAllocatorCallback_Pod*>(return_val);
        return return_val_pod;
    }

    physx_PxAllocatorCallback_Pod* physx_phys_PxGetBroadcastAllocator() {
        physx::PxAllocatorCallback* return_val = PxGetBroadcastAllocator();
        auto return_val_pod = reinterpret_cast<physx_PxAllocatorCallback_Pod*>(return_val);
        return return_val_pod;
    }

    physx_PxErrorCallback_Pod* physx_phys_PxGetErrorCallback() {
        physx::PxErrorCallback* return_val = PxGetErrorCallback();
        auto return_val_pod = reinterpret_cast<physx_PxErrorCallback_Pod*>(return_val);
        return return_val_pod;
    }

    physx_PxErrorCallback_Pod* physx_phys_PxGetBroadcastError() {
    ...
    physx_PxAllocator_Pod physx_PxAllocator_new(char const* anon_param0) {
    ...
    void* physx_PxAllocator_allocate_mut(physx_PxAllocator_Pod* self__pod, size_t size_pod, char const* file, int32_t line) {
    ...
    void physx_PxAllocator_deallocate_mut(physx_PxAllocator_Pod* self__pod, void* ptr) {
        physx::PxAllocator* self_ = reinterpret_cast<physx::PxAllocator*>(self__pod);
        self_->deallocate(ptr);
    }

    physx_PxRawAllocator_Pod physx_PxRawAllocator_new(char const* anon_param0) {
    ...
    void* physx_PxRawAllocator_allocate_mut(physx_PxRawAllocator_Pod* self__pod, size_t size_pod, char const* anon_param1, int32_t anon_param2) {
    ...
    void physx_PxRawAllocator_deallocate_mut(physx_PxRawAllocator_Pod* self__pod, void* ptr) {
        physx::PxRawAllocator* self_ = reinterpret_cast<physx::PxRawAllocator*>(self__pod);
        self_->deallocate(ptr);
    }

    void physx_PxVirtualAllocatorCallback_delete(physx_PxVirtualAllocatorCallback_Pod* self__pod) {
        physx::PxVirtualAllocatorCallback* self_ = reinterpret_cast<physx::PxVirtualAllocatorCallback*>(self__pod);
        delete self_;
    }

    void* physx_PxVirtualAllocatorCallback_allocate_mut(physx_PxVirtualAllocatorCallback_Pod* self__pod, size_t size_pod, int32_t group, char const* file, int32_t line) {
        physx::PxVirtualAllocatorCallback* self_ = reinterpret_cast<physx::PxVirtualAllocatorCallback*>(self__pod);
        size_t size;
        memcpy(&size, &size_pod, sizeof(size));
    ...
    void physx_PxVirtualAllocatorCallback_deallocate_mut(physx_PxVirtualAllocatorCallback_Pod* self__pod, void* ptr) {
        physx::PxVirtualAllocatorCallback* self_ = reinterpret_cast<physx::PxVirtualAllocatorCallback*>(self__pod);
        self_->deallocate(ptr);
    }

    physx_PxVirtualAllocator_Pod physx_PxVirtualAllocator_new(physx_PxVirtualAllocatorCallback_Pod* callback_pod, int32_t group) {
    ...
    void* physx_PxVirtualAllocator_allocate_mut(physx_PxVirtualAllocator_Pod* self__pod, size_t size_pod, char const* file, int32_t line) {
    ...
    void physx_PxVirtualAllocator_deallocate_mut(physx_PxVirtualAllocator_Pod* self__pod, void* ptr) {
        physx::PxVirtualAllocator* self_ = reinterpret_cast<physx::PxVirtualAllocator*>(self__pod);
        self_->deallocate(ptr);
    }

    physx_PxTempAllocatorChunk_Pod physx_PxTempAllocatorChunk_new() {
    ...
    physx_PxTempAllocator_Pod physx_PxTempAllocator_new(char const* anon_param0) {
    ...
    void* physx_PxTempAllocator_allocate_mut(physx_PxTempAllocator_Pod* self__pod, size_t size_pod, char const* file, int32_t line) {
    ...
    void physx_PxTempAllocator_deallocate_mut(physx_PxTempAllocator_Pod* self__pod, void* ptr) {
        physx::PxTempAllocator* self_ = reinterpret_cast<physx::PxTempAllocator*>(self__pod);
        self_->deallocate(ptr);
    }
    ...
    physx_PxVec3_Pod physx_PxVec3_new() {
        PxVec3 return_val;
    ...
    physx_PxVec3_Pod physx_PxVec3_new_1(int32_t anon_param0_pod) {
    ...
    physx_PxVec3_Pod physx_PxVec3_new_2(float a) {
        PxVec3 return_val(a);
        physx_PxVec3_Pod return_val_pod;
        memcpy(&return_val_pod, &return_val, sizeof(return_val_pod));
        return return_val_pod;
    ...
    physx_PxVec3_Pod physx_PxVec3_new_3(float nx, float ny, float nz) {
    ...
    bool physx_PxVec3_isZero(physx_PxVec3_Pod const* self__pod) {
        physx::PxVec3 const* self_ = reinterpret_cast<physx::PxVec3 const*>(self__pod);
        bool return_val = self_->isZero();
        return return_val;
    }

    bool physx_PxVec3_isFinite(physx_PxVec3_Pod const* self__pod) {
        physx::PxVec3 const* self_ = reinterpret_cast<physx::PxVec3 const*>(self__pod);
        bool return_val = self_->isFinite();
        return return_val;
    }

    bool physx_PxVec3_isNormalized(physx_PxVec3_Pod const* self__pod) {
        physx::PxVec3 const* self_ = reinterpret_cast<physx::PxVec3 const*>(self__pod);
        bool return_val = self_->isNormalized();
        return return_val;
    }

    float physx_PxVec3_magnitudeSquared(physx_PxVec3_Pod const* self__pod) {
        physx::PxVec3 const* self_ = reinterpret_cast<physx::PxVec3 const*>(self__pod);
        float return_val = self_->magnitudeSquared();
        return return_val;
    }

    float physx_PxVec3_magnitude(physx_PxVec3_Pod const* self__pod) {
        physx::PxVec3 const* self_ = reinterpret_cast<physx::PxVec3 const*>(self__pod);
        float return_val = self_->magnitude();
        return return_val;
    }

    float physx_PxVec3_dot(physx_PxVec3_Pod const* self__pod, physx_PxVec3_Pod const* v_pod) {
        physx::PxVec3 const* self_ = reinterpret_cast<physx::PxVec3 const*>(self__pod);
    ...
    physx_PxVec3_Pod physx_PxVec3_cross(physx_PxVec3_Pod const* self__pod, physx_PxVec3_Pod const* v_pod) {
        physx::PxVec3 const* self_ = reinterpret_cast<physx::PxVec3 const*>(self__pod);
        physx::PxVec3 const& v = reinterpret_cast<physx::PxVec3 const&>(*v_pod);
    ...
    physx_PxVec3_Pod physx_PxVec3_getNormalized(physx_PxVec3_Pod const* self__pod) {
        physx::PxVec3 const* self_ = reinterpret_cast<physx::PxVec3 const*>(self__pod);
    ...
    float physx_PxVec3_normalize_mut(physx_PxVec3_Pod* self__pod) {
        physx::PxVec3* self_ = reinterpret_cast<physx::PxVec3*>(self__pod);
        float return_val = self_->normalize();
        return return_val;
    }

    float physx_PxVec3_normalizeSafe_mut(physx_PxVec3_Pod* self__pod) {
        physx::PxVec3* self_ = reinterpret_cast<physx::PxVec3*>(self__pod);
        float return_val = self_->normalizeSafe();
        return return_val;
    }

    float physx_PxVec3_normalizeFast_mut(physx_PxVec3_Pod* self__pod) {
        physx::PxVec3* self_ = reinterpret_cast<physx::PxVec3*>(self__pod);
        float return_val = self_->normalizeFast();
        return return_val;
    }

    physx_PxVec3_Pod physx_PxVec3_multiply(physx_PxVec3_Pod const* self__pod, physx_PxVec3_Pod const* a_pod) {
        physx::PxVec3 const* self_ = reinterpret_cast<physx::PxVec3 const*>(self__pod);
    ...
    physx_PxVec3_Pod physx_PxVec3_minimum(physx_PxVec3_Pod const* self__pod, physx_PxVec3_Pod const* v_pod) {
        physx::PxVec3 const* self_ = reinterpret_cast<physx::PxVec3 const*>(self__pod);
        physx::PxVec3 const& v = reinterpret_cast<physx::PxVec3 const&>(*v_pod);
    ...
    float physx_PxVec3_minElement(physx_PxVec3_Pod const* self__pod) {
        physx::PxVec3 const* self_ = reinterpret_cast<physx::PxVec3 const*>(self__pod);
        float return_val = self_->minElement();
        return return_val;
    }

    physx_PxVec3_Pod physx_PxVec3_maximum(physx_PxVec3_Pod const* self__pod, physx_PxVec3_Pod const* v_pod) {
        physx::PxVec3 const* self_ = reinterpret_cast<physx::PxVec3 const*>(self__pod);
        physx::PxVec3 const& v = reinterpret_cast<physx::PxVec3 const&>(*v_pod);
    ...
    float physx_PxVec3_maxElement(physx_PxVec3_Pod const* self__pod) {
        physx::PxVec3 const* self_ = reinterpret_cast<physx::PxVec3 const*>(self__pod);
        float return_val = self_->maxElement();
        return return_val;
    }

    physx_PxVec3_Pod physx_PxVec3_abs(physx_PxVec3_Pod const* self__pod) {
        physx::PxVec3 const* self_ = reinterpret_cast<physx::PxVec3 const*>(self__pod);
    ...
    physx_PxVec3Padded_Pod* physx_PxVec3Padded_new_alloc() {
        auto return_val = new physx::PxVec3Padded();
        auto return_val_pod = reinterpret_cast<physx_PxVec3Padded_Pod*>(return_val);
        return return_val_pod;
    }

    void physx_PxVec3Padded_delete(physx_PxVec3Padded_Pod* self__pod) {
        physx::PxVec3Padded* self_ = reinterpret_cast<physx::PxVec3Padded*>(self__pod);
        delete self_;
    }

    physx_PxVec3Padded_Pod* physx_PxVec3Padded_new_alloc_1(physx_PxVec3_Pod const* p_pod) {
    ...
    physx_PxVec3Padded_Pod* physx_PxVec3Padded_new_alloc_2(float f) {
        auto return_val = new physx::PxVec3Padded(f);
        auto return_val_pod = reinterpret_cast<physx_PxVec3Padded_Pod*>(return_val);
        return return_val_pod;
    }

    physx_PxQuat_Pod physx_PxQuat_new() {
        PxQuat return_val;
    ...
    physx_PxQuat_Pod physx_PxQuat_new_1(int32_t anon_param0_pod) {
    ...
    physx_PxQuat_Pod physx_PxQuat_new_2(float r) {
        PxQuat return_val(r);
        physx_PxQuat_Pod return_val_pod;
        memcpy(&return_val_pod, &return_val, sizeof(return_val_pod));
        return return_val_pod;
    ...
    physx_PxQuat_Pod physx_PxQuat_new_3(float nx, float ny, float nz, float nw) {
    ...
    physx_PxQuat_Pod physx_PxQuat_new_4(float angleRadians, physx_PxVec3_Pod const* unitAxis_pod) {
    ...
    physx_PxQuat_Pod physx_PxQuat_new_5(physx_PxMat33_Pod const* m_pod) {
    ...
    bool physx_PxQuat_isIdentity(physx_PxQuat_Pod const* self__pod) {
        physx::PxQuat const* self_ = reinterpret_cast<physx::PxQuat const*>(self__pod);
        bool return_val = self_->isIdentity();
        return return_val;
    }

    bool physx_PxQuat_isFinite(physx_PxQuat_Pod const* self__pod) {
        physx::PxQuat const* self_ = reinterpret_cast<physx::PxQuat const*>(self__pod);
        bool return_val = self_->isFinite();
        return return_val;
    }

    bool physx_PxQuat_isUnit(physx_PxQuat_Pod const* self__pod) {
        physx::PxQuat const* self_ = reinterpret_cast<physx::PxQuat const*>(self__pod);
        bool return_val = self_->isUnit();
        return return_val;
    }

    bool physx_PxQuat_isSane(physx_PxQuat_Pod const* self__pod) {
        physx::PxQuat const* self_ = reinterpret_cast<physx::PxQuat const*>(self__pod);
        bool return_val = self_->isSane();
        return return_val;
    }

    void physx_PxQuat_toRadiansAndUnitAxis(physx_PxQuat_Pod const* self__pod, float* angle_pod, physx_PxVec3_Pod* axis_pod) {
        physx::PxQuat const* self_ = reinterpret_cast<physx::PxQuat const*>(self__pod);
    ...
    float physx_PxQuat_getAngle(physx_PxQuat_Pod const* self__pod) {
        physx::PxQuat const* self_ = reinterpret_cast<physx::PxQuat const*>(self__pod);
        float return_val = self_->getAngle();
        return return_val;
    }

    float physx_PxQuat_getAngle_1(physx_PxQuat_Pod const* self__pod, physx_PxQuat_Pod const* q_pod) {
        physx::PxQuat const* self_ = reinterpret_cast<physx::PxQuat const*>(self__pod);
    ...
    float physx_PxQuat_magnitudeSquared(physx_PxQuat_Pod const* self__pod) {
        physx::PxQuat const* self_ = reinterpret_cast<physx::PxQuat const*>(self__pod);
        float return_val = self_->magnitudeSquared();
        return return_val;
    }

    float physx_PxQuat_dot(physx_PxQuat_Pod const* self__pod, physx_PxQuat_Pod const* v_pod) {
        physx::PxQuat const* self_ = reinterpret_cast<physx::PxQuat const*>(self__pod);
    ...
    physx_PxQuat_Pod physx_PxQuat_getNormalized(physx_PxQuat_Pod const* self__pod) {
        physx::PxQuat const* self_ = reinterpret_cast<physx::PxQuat const*>(self__pod);
    ...
    float physx_PxQuat_magnitude(physx_PxQuat_Pod const* self__pod) {
        physx::PxQuat const* self_ = reinterpret_cast<physx::PxQuat const*>(self__pod);
        float return_val = self_->magnitude();
        return return_val;
    }

    float physx_PxQuat_normalize_mut(physx_PxQuat_Pod* self__pod) {
        physx::PxQuat* self_ = reinterpret_cast<physx::PxQuat*>(self__pod);
        float return_val = self_->normalize();
        return return_val;
    }

    physx_PxQuat_Pod physx_PxQuat_getConjugate(physx_PxQuat_Pod const* self__pod) {
        physx::PxQuat const* self_ = reinterpret_cast<physx::PxQuat const*>(self__pod);
    ...
    physx_PxVec3_Pod physx_PxQuat_getImaginaryPart(physx_PxQuat_Pod const* self__pod) {
        physx::PxQuat const* self_ = reinterpret_cast<physx::PxQuat const*>(self__pod);
    ...
    physx_PxVec3_Pod physx_PxQuat_getBasisVector0(physx_PxQuat_Pod const* self__pod) {
        physx::PxQuat const* self_ = reinterpret_cast<physx::PxQuat const*>(self__pod);
    ...
    physx_PxVec3_Pod physx_PxQuat_getBasisVector1(physx_PxQuat_Pod const* self__pod) {
        physx::PxQuat const* self_ = reinterpret_cast<physx::PxQuat const*>(self__pod);
    ...
    physx_PxVec3_Pod physx_PxQuat_getBasisVector2(physx_PxQuat_Pod const* self__pod) {
        physx::PxQuat const* self_ = reinterpret_cast<physx::PxQuat const*>(self__pod);
    ...
    physx_PxVec3_Pod physx_PxQuat_rotate(physx_PxQuat_Pod const* self__pod, physx_PxVec3_Pod const* v_pod) {
        physx::PxQuat const* self_ = reinterpret_cast<physx::PxQuat const*>(self__pod);
        physx::PxVec3 const& v = reinterpret_cast<physx::PxVec3 const&>(*v_pod);
    ...
    physx_PxVec3_Pod physx_PxQuat_rotateInv(physx_PxQuat_Pod const* self__pod, physx_PxVec3_Pod const* v_pod) {
        physx::PxQuat const* self_ = reinterpret_cast<physx::PxQuat const*>(self__pod);
        physx::PxVec3 const& v = reinterpret_cast<physx::PxVec3 const&>(*v_pod);
    ...
    physx_PxTransform_Pod physx_PxTransform_new() {
    ...
    physx_PxTransform_Pod physx_PxTransform_new_1(physx_PxVec3_Pod const* position_pod) {
    ...
    physx_PxTransform_Pod physx_PxTransform_new_2(int32_t anon_param0_pod) {
        auto anon_param0 = static_cast<physx::PxIDENTITY>(anon_param0_pod);
    ...
    physx_PxTransform_Pod physx_PxTransform_new_3(physx_PxQuat_Pod const* orientation_pod) {
    ...
    physx_PxTransform_Pod physx_PxTransform_new_4(float x, float y, float z, physx_PxQuat_Pod aQ_pod) {
        physx::PxQuat aQ;
    ...
    physx_PxTransform_Pod physx_PxTransform_new_5(physx_PxVec3_Pod const* p0_pod, physx_PxQuat_Pod const* q0_pod) {
    ...
    physx_PxTransform_Pod physx_PxTransform_new_6(physx_PxMat44_Pod const* m_pod) {
    ...
    physx_PxTransform_Pod physx_PxTransform_getInverse(physx_PxTransform_Pod const* self__pod) {
    ...
    physx_PxVec3_Pod physx_PxTransform_transform(physx_PxTransform_Pod const* self__pod, physx_PxVec3_Pod const* input_pod) {
        physx::PxTransform const* self_ = reinterpret_cast<physx::PxTransform const*>(self__pod);
    ...
    physx_PxVec3_Pod physx_PxTransform_transformInv(physx_PxTransform_Pod const* self__pod, physx_PxVec3_Pod const* input_pod) {
        physx::PxTransform const* self_ = reinterpret_cast<physx::PxTransform const*>(self__pod);
        physx::PxVec3 const& input = reinterpret_cast<physx::PxVec3 const&>(*input_pod);
    ...
    physx_PxVec3_Pod physx_PxTransform_rotate(physx_PxTransform_Pod const* self__pod, physx_PxVec3_Pod const* input_pod) {
        physx::PxTransform const* self_ = reinterpret_cast<physx::PxTransform const*>(self__pod);
        physx::PxVec3 const& input = reinterpret_cast<physx::PxVec3 const&>(*input_pod);
    ...
    physx_PxVec3_Pod physx_PxTransform_rotateInv(physx_PxTransform_Pod const* self__pod, physx_PxVec3_Pod const* input_pod) {
        physx::PxTransform const* self_ = reinterpret_cast<physx::PxTransform const*>(self__pod);
        physx::PxVec3 const& input = reinterpret_cast<physx::PxVec3 const&>(*input_pod);
    ...
    physx_PxTransform_Pod physx_PxTransform_transform_1(physx_PxTransform_Pod const* self__pod, physx_PxTransform_Pod const* src_pod) {
        physx::PxTransform const* self_ = reinterpret_cast<physx::PxTransform const*>(self__pod);
    ...
    bool physx_PxTransform_isValid(physx_PxTransform_Pod const* self__pod) {
        physx::PxTransform const* self_ = reinterpret_cast<physx::PxTransform const*>(self__pod);
        bool return_val = self_->isValid();
        return return_val;
    }

    bool physx_PxTransform_isSane(physx_PxTransform_Pod const* self__pod) {
        physx::PxTransform const* self_ = reinterpret_cast<physx::PxTransform const*>(self__pod);
        bool return_val = self_->isSane();
        return return_val;
    }

    bool physx_PxTransform_isFinite(physx_PxTransform_Pod const* self__pod) {
        physx::PxTransform const* self_ = reinterpret_cast<physx::PxTransform const*>(self__pod);
        bool return_val = self_->isFinite();
        return return_val;
    }

    physx_PxTransform_Pod physx_PxTransform_transformInv_1(physx_PxTransform_Pod const* self__pod, physx_PxTransform_Pod const* src_pod) {
        physx::PxTransform const* self_ = reinterpret_cast<physx::PxTransform const*>(self__pod);
        physx::PxTransform const& src = reinterpret_cast<physx::PxTransform const&>(*src_pod);
    ...
    physx_PxTransform_Pod physx_PxTransform_getNormalized(physx_PxTransform_Pod const* self__pod) {
        physx::PxTransform const* self_ = reinterpret_cast<physx::PxTransform const*>(self__pod);
    ...
    physx_PxMat33_Pod physx_PxMat33_new() {
        PxMat33 return_val;
    ...
    physx_PxMat33_Pod physx_PxMat33_new_1(int32_t anon_param0_pod) {
        auto anon_param0 = static_cast<physx::PxIDENTITY>(anon_param0_pod);
    ...
    physx_PxMat33_Pod physx_PxMat33_new_2(int32_t anon_param0_pod) {
        auto anon_param0 = static_cast<physx::PxZERO>(anon_param0_pod);
        PxMat33 return_val(anon_param0);
        physx_PxMat33_Pod return_val_pod;
        memcpy(&return_val_pod, &return_val, sizeof(return_val_pod));
    ...
    physx_PxMat33_Pod physx_PxMat33_new_3(physx_PxVec3_Pod const* col0_pod, physx_PxVec3_Pod const* col1_pod, physx_PxVec3_Pod const* col2_pod) {
    ...
    physx_PxMat33_Pod physx_PxMat33_new_4(float r) {
    ...
    physx_PxMat33_Pod physx_PxMat33_new_5(float* values) {
    ...
    physx_PxMat33_Pod physx_PxMat33_new_6(physx_PxQuat_Pod const* q_pod) {
        physx::PxQuat const& q = reinterpret_cast<physx::PxQuat const&>(*q_pod);
    ...
    physx_PxMat33_Pod physx_PxMat33_createDiagonal(physx_PxVec3_Pod const* d_pod) {
    ...
    physx_PxMat33_Pod physx_PxMat33_outer(physx_PxVec3_Pod const* a_pod, physx_PxVec3_Pod const* b_pod) {
        physx::PxVec3 const& a = reinterpret_cast<physx::PxVec3 const&>(*a_pod);
    ...
    physx_PxMat33_Pod physx_PxMat33_getTranspose(physx_PxMat33_Pod const* self__pod) {
    ...
    physx_PxMat33_Pod physx_PxMat33_getInverse(physx_PxMat33_Pod const* self__pod) {
        physx::PxMat33 const* self_ = reinterpret_cast<physx::PxMat33 const*>(self__pod);
    ...
    float physx_PxMat33_getDeterminant(physx_PxMat33_Pod const* self__pod) {
        physx::PxMat33 const* self_ = reinterpret_cast<physx::PxMat33 const*>(self__pod);
        float return_val = self_->getDeterminant();
        return return_val;
    }

    physx_PxVec3_Pod physx_PxMat33_transform(physx_PxMat33_Pod const* self__pod, physx_PxVec3_Pod const* other_pod) {
        physx::PxMat33 const* self_ = reinterpret_cast<physx::PxMat33 const*>(self__pod);
    ...
    physx_PxVec3_Pod physx_PxMat33_transformTranspose(physx_PxMat33_Pod const* self__pod, physx_PxVec3_Pod const* other_pod) {
        physx::PxMat33 const* self_ = reinterpret_cast<physx::PxMat33 const*>(self__pod);
        physx::PxVec3 const& other = reinterpret_cast<physx::PxVec3 const&>(*other_pod);
    ...
    float const* physx_PxMat33_front(physx_PxMat33_Pod const* self__pod) {
        physx::PxMat33 const* self_ = reinterpret_cast<physx::PxMat33 const*>(self__pod);
        float const* return_val = self_->front();
        return return_val;
    }

    physx_PxBounds3_Pod physx_PxBounds3_new() {
    ...
    physx_PxBounds3_Pod physx_PxBounds3_new_1(physx_PxVec3_Pod const* minimum_pod, physx_PxVec3_Pod const* maximum_pod) {
    ...
    physx_PxBounds3_Pod physx_PxBounds3_empty() {
    ...
    physx_PxBounds3_Pod physx_PxBounds3_boundsOfPoints(physx_PxVec3_Pod const* v0_pod, physx_PxVec3_Pod const* v1_pod) {
    ...
    physx_PxBounds3_Pod physx_PxBounds3_centerExtents(physx_PxVec3_Pod const* center_pod, physx_PxVec3_Pod const* extent_pod) {
    ...
    physx_PxBounds3_Pod physx_PxBounds3_basisExtent(physx_PxVec3_Pod const* center_pod, physx_PxMat33_Pod const* basis_pod, physx_PxVec3_Pod const* extent_pod) {
        physx::PxVec3 const& center = reinterpret_cast<physx::PxVec3 const&>(*center_pod);
    ...
    physx_PxBounds3_Pod physx_PxBounds3_poseExtent(physx_PxTransform_Pod const* pose_pod, physx_PxVec3_Pod const* extent_pod) {
    ...
    physx_PxBounds3_Pod physx_PxBounds3_transformSafe(physx_PxMat33_Pod const* matrix_pod, physx_PxBounds3_Pod const* bounds_pod) {
    ...
    physx_PxBounds3_Pod physx_PxBounds3_transformFast(physx_PxMat33_Pod const* matrix_pod, physx_PxBounds3_Pod const* bounds_pod) {
        physx::PxMat33 const& matrix = reinterpret_cast<physx::PxMat33 const&>(*matrix_pod);
        physx::PxBounds3 const& bounds = reinterpret_cast<physx::PxBounds3 const&>(*bounds_pod);
    ...
    physx_PxBounds3_Pod physx_PxBounds3_transformSafe_1(physx_PxTransform_Pod const* transform_pod, physx_PxBounds3_Pod const* bounds_pod) {
    ...
    physx_PxBounds3_Pod physx_PxBounds3_transformFast_1(physx_PxTransform_Pod const* transform_pod, physx_PxBounds3_Pod const* bounds_pod) {
        physx::PxTransform const& transform = reinterpret_cast<physx::PxTransform const&>(*transform_pod);
        physx::PxBounds3 const& bounds = reinterpret_cast<physx::PxBounds3 const&>(*bounds_pod);
    ...
    void physx_PxBounds3_setEmpty_mut(physx_PxBounds3_Pod* self__pod) {
        physx::PxBounds3* self_ = reinterpret_cast<physx::PxBounds3*>(self__pod);
        self_->setEmpty();
    }

    void physx_PxBounds3_setMaximal_mut(physx_PxBounds3_Pod* self__pod) {
        physx::PxBounds3* self_ = reinterpret_cast<physx::PxBounds3*>(self__pod);
        self_->setMaximal();
    }

    void physx_PxBounds3_include_mut(physx_PxBounds3_Pod* self__pod, physx_PxVec3_Pod const* v_pod) {
        physx::PxBounds3* self_ = reinterpret_cast<physx::PxBounds3*>(self__pod);
        physx::PxVec3 const& v = reinterpret_cast<physx::PxVec3 const&>(*v_pod);
        self_->include(v);
    }

    void physx_PxBounds3_include_mut_1(physx_PxBounds3_Pod* self__pod, physx_PxBounds3_Pod const* b_pod) {
        physx::PxBounds3* self_ = reinterpret_cast<physx::PxBounds3*>(self__pod);
        physx::PxBounds3 const& b = reinterpret_cast<physx::PxBounds3 const&>(*b_pod);
        self_->include(b);
    }

    bool physx_PxBounds3_isEmpty(physx_PxBounds3_Pod const* self__pod) {
        physx::PxBounds3 const* self_ = reinterpret_cast<physx::PxBounds3 const*>(self__pod);
        bool return_val = self_->isEmpty();
        return return_val;
    }

    bool physx_PxBounds3_intersects(physx_PxBounds3_Pod const* self__pod, physx_PxBounds3_Pod const* b_pod) {
        physx::PxBounds3 const* self_ = reinterpret_cast<physx::PxBounds3 const*>(self__pod);
        physx::PxBounds3 const& b = reinterpret_cast<physx::PxBounds3 const&>(*b_pod);
    ...
    bool physx_PxBounds3_intersects1D(physx_PxBounds3_Pod const* self__pod, physx_PxBounds3_Pod const* a_pod, uint32_t axis) {
        physx::PxBounds3 const* self_ = reinterpret_cast<physx::PxBounds3 const*>(self__pod);
    ...
    bool physx_PxBounds3_contains(physx_PxBounds3_Pod const* self__pod, physx_PxVec3_Pod const* v_pod) {
        physx::PxBounds3 const* self_ = reinterpret_cast<physx::PxBounds3 const*>(self__pod);
        physx::PxVec3 const& v = reinterpret_cast<physx::PxVec3 const&>(*v_pod);
    ...
    bool physx_PxBounds3_isInside(physx_PxBounds3_Pod const* self__pod, physx_PxBounds3_Pod const* box_pod) {
        physx::PxBounds3 const* self_ = reinterpret_cast<physx::PxBounds3 const*>(self__pod);
    ...
    physx_PxVec3_Pod physx_PxBounds3_getCenter(physx_PxBounds3_Pod const* self__pod) {
        physx::PxBounds3 const* self_ = reinterpret_cast<physx::PxBounds3 const*>(self__pod);
    ...
    float physx_PxBounds3_getCenter_1(physx_PxBounds3_Pod const* self__pod, uint32_t axis) {
        physx::PxBounds3 const* self_ = reinterpret_cast<physx::PxBounds3 const*>(self__pod);
        float return_val = self_->getCenter(axis);
        return return_val;
    }

    float physx_PxBounds3_getExtents(physx_PxBounds3_Pod const* self__pod, uint32_t axis) {
        physx::PxBounds3 const* self_ = reinterpret_cast<physx::PxBounds3 const*>(self__pod);
        float return_val = self_->getExtents(axis);
        return return_val;
    }

    physx_PxVec3_Pod physx_PxBounds3_getDimensions(physx_PxBounds3_Pod const* self__pod) {
        physx::PxBounds3 const* self_ = reinterpret_cast<physx::PxBounds3 const*>(self__pod);
    ...
    physx_PxVec3_Pod physx_PxBounds3_getExtents_1(physx_PxBounds3_Pod const* self__pod) {
        physx::PxBounds3 const* self_ = reinterpret_cast<physx::PxBounds3 const*>(self__pod);
    ...
    void physx_PxBounds3_scaleSafe_mut(physx_PxBounds3_Pod* self__pod, float scale) {
        physx::PxBounds3* self_ = reinterpret_cast<physx::PxBounds3*>(self__pod);
        self_->scaleSafe(scale);
    }

    void physx_PxBounds3_scaleFast_mut(physx_PxBounds3_Pod* self__pod, float scale) {
        physx::PxBounds3* self_ = reinterpret_cast<physx::PxBounds3*>(self__pod);
        self_->scaleFast(scale);
    }

    void physx_PxBounds3_fattenSafe_mut(physx_PxBounds3_Pod* self__pod, float distance) {
        physx::PxBounds3* self_ = reinterpret_cast<physx::PxBounds3*>(self__pod);
        self_->fattenSafe(distance);
    }

    void physx_PxBounds3_fattenFast_mut(physx_PxBounds3_Pod* self__pod, float distance) {
        physx::PxBounds3* self_ = reinterpret_cast<physx::PxBounds3*>(self__pod);
        self_->fattenFast(distance);
    }

    bool physx_PxBounds3_isFinite(physx_PxBounds3_Pod const* self__pod) {
        physx::PxBounds3 const* self_ = reinterpret_cast<physx::PxBounds3 const*>(self__pod);
        bool return_val = self_->isFinite();
        return return_val;
    }

    bool physx_PxBounds3_isValid(physx_PxBounds3_Pod const* self__pod) {
        physx::PxBounds3 const* self_ = reinterpret_cast<physx::PxBounds3 const*>(self__pod);
        bool return_val = self_->isValid();
        return return_val;
    }

    physx_PxVec3_Pod physx_PxBounds3_closestPoint(physx_PxBounds3_Pod const* self__pod, physx_PxVec3_Pod const* p_pod) {
        physx::PxBounds3 const* self_ = reinterpret_cast<physx::PxBounds3 const*>(self__pod);
        physx::PxVec3 const& p = reinterpret_cast<physx::PxVec3 const&>(*p_pod);
    ...
    void physx_PxErrorCallback_delete(physx_PxErrorCallback_Pod* self__pod) {
        physx::PxErrorCallback* self_ = reinterpret_cast<physx::PxErrorCallback*>(self__pod);
        delete self_;
    }

    void physx_PxErrorCallback_reportError_mut(physx_PxErrorCallback_Pod* self__pod, int32_t code_pod, char const* message, char const* file, int32_t line) {
        physx::PxErrorCallback* self_ = reinterpret_cast<physx::PxErrorCallback*>(self__pod);
        auto code = static_cast<physx::PxErrorCode::Enum>(code_pod);
        self_->reportError(code, message, file, line);
    }

    void physx_PxAllocationListener_onAllocation_mut(physx_PxAllocationListener_Pod* self__pod, size_t size_pod, char const* typeName, char const* filename, int32_t line, void* allocatedMemory) {
    ...
    void physx_PxAllocationListener_onDeallocation_mut(physx_PxAllocationListener_Pod* self__pod, void* allocatedMemory) {
        physx::PxAllocationListener* self_ = reinterpret_cast<physx::PxAllocationListener*>(self__pod);
        self_->onDeallocation(allocatedMemory);
    }

    physx_PxBroadcastingAllocator_Pod* physx_PxBroadcastingAllocator_new_alloc(physx_PxAllocatorCallback_Pod* allocator_pod, physx_PxErrorCallback_Pod* error_pod) {
        physx::PxAllocatorCallback& allocator = reinterpret_cast<physx::PxAllocatorCallback&>(*allocator_pod);
    ...
    void physx_PxBroadcastingAllocator_delete(physx_PxBroadcastingAllocator_Pod* self__pod) {
        physx::PxBroadcastingAllocator* self_ = reinterpret_cast<physx::PxBroadcastingAllocator*>(self__pod);
        delete self_;
    }

    void* physx_PxBroadcastingAllocator_allocate_mut(physx_PxBroadcastingAllocator_Pod* self__pod, size_t size_pod, char const* typeName, char const* filename, int32_t line) {
        physx::PxBroadcastingAllocator* self_ = reinterpret_cast<physx::PxBroadcastingAllocator*>(self__pod);
        size_t size;
        memcpy(&size, &size_pod, sizeof(size));
        void* return_val = self_->allocate(size, typeName, filename, line);
    ...
    void physx_PxBroadcastingAllocator_deallocate_mut(physx_PxBroadcastingAllocator_Pod* self__pod, void* ptr) {
        physx::PxBroadcastingAllocator* self_ = reinterpret_cast<physx::PxBroadcastingAllocator*>(self__pod);
        self_->deallocate(ptr);
    }

    physx_PxBroadcastingErrorCallback_Pod* physx_PxBroadcastingErrorCallback_new_alloc(physx_PxErrorCallback_Pod* errorCallback_pod) {
        physx::PxErrorCallback& errorCallback = reinterpret_cast<physx::PxErrorCallback&>(*errorCallback_pod);
    ...
    void physx_PxBroadcastingErrorCallback_delete(physx_PxBroadcastingErrorCallback_Pod* self__pod) {
        physx::PxBroadcastingErrorCallback* self_ = reinterpret_cast<physx::PxBroadcastingErrorCallback*>(self__pod);
        delete self_;
    }

    void physx_PxBroadcastingErrorCallback_reportError_mut(physx_PxBroadcastingErrorCallback_Pod* self__pod, int32_t code_pod, char const* message, char const* file, int32_t line) {
        physx::PxBroadcastingErrorCallback* self_ = reinterpret_cast<physx::PxBroadcastingErrorCallback*>(self__pod);
        auto code = static_cast<physx::PxErrorCode::Enum>(code_pod);
        self_->reportError(code, message, file, line);
    }
    ...
    uint32_t physx_PxInputStream_read_mut(physx_PxInputStream_Pod* self__pod, void* dest, uint32_t count) {
        physx::PxInputStream* self_ = reinterpret_cast<physx::PxInputStream*>(self__pod);
        uint32_t return_val = self_->read(dest, count);
        return return_val;
    }

    void physx_PxInputStream_delete(physx_PxInputStream_Pod* self__pod) {
        physx::PxInputStream* self_ = reinterpret_cast<physx::PxInputStream*>(self__pod);
        delete self_;
    }

    uint32_t physx_PxInputData_getLength(physx_PxInputData_Pod const* self__pod) {
        physx::PxInputData const* self_ = reinterpret_cast<physx::PxInputData const*>(self__pod);
        uint32_t return_val = self_->getLength();
        return return_val;
    }

    void physx_PxInputData_seek_mut(physx_PxInputData_Pod* self__pod, uint32_t offset) {
        physx::PxInputData* self_ = reinterpret_cast<physx::PxInputData*>(self__pod);
        self_->seek(offset);
    }

    uint32_t physx_PxInputData_tell(physx_PxInputData_Pod const* self__pod) {
        physx::PxInputData const* self_ = reinterpret_cast<physx::PxInputData const*>(self__pod);
        uint32_t return_val = self_->tell();
        return return_val;
    }

    void physx_PxInputData_delete(physx_PxInputData_Pod* self__pod) {
        physx::PxInputData* self_ = reinterpret_cast<physx::PxInputData*>(self__pod);
        delete self_;
    }

    uint32_t physx_PxOutputStream_write_mut(physx_PxOutputStream_Pod* self__pod, void const* src, uint32_t count) {
        physx::PxOutputStream* self_ = reinterpret_cast<physx::PxOutputStream*>(self__pod);
        uint32_t return_val = self_->write(src, count);
        return return_val;
    }

    void physx_PxOutputStream_delete(physx_PxOutputStream_Pod* self__pod) {
        physx::PxOutputStream* self_ = reinterpret_cast<physx::PxOutputStream*>(self__pod);
        delete self_;
    }

    physx_PxVec4_Pod physx_PxVec4_new() {
        PxVec4 return_val;
    ...
    physx_PxVec4_Pod physx_PxVec4_new_1(int32_t anon_param0_pod) {
        auto anon_param0 = static_cast<physx::PxZERO>(anon_param0_pod);
    ...
    physx_PxVec4_Pod physx_PxVec4_new_2(float a) {
        PxVec4 return_val(a);
        physx_PxVec4_Pod return_val_pod;
        memcpy(&return_val_pod, &return_val, sizeof(return_val_pod));
        return return_val_pod;
    ...
    physx_PxVec4_Pod physx_PxVec4_new_3(float nx, float ny, float nz, float nw) {
    ...
    physx_PxVec4_Pod physx_PxVec4_new_4(physx_PxVec3_Pod const* v_pod, float nw) {
        physx::PxVec3 const& v = reinterpret_cast<physx::PxVec3 const&>(*v_pod);
    ...
    physx_PxVec4_Pod physx_PxVec4_new_5(float const* v) {
        PxVec4 return_val(v);
        physx_PxVec4_Pod return_val_pod;
        memcpy(&return_val_pod, &return_val, sizeof(return_val_pod));
        return return_val_pod;
    ...
    bool physx_PxVec4_isZero(physx_PxVec4_Pod const* self__pod) {
        physx::PxVec4 const* self_ = reinterpret_cast<physx::PxVec4 const*>(self__pod);
        bool return_val = self_->isZero();
        return return_val;
    }

    bool physx_PxVec4_isFinite(physx_PxVec4_Pod const* self__pod) {
        physx::PxVec4 const* self_ = reinterpret_cast<physx::PxVec4 const*>(self__pod);
        bool return_val = self_->isFinite();
        return return_val;
    }

    bool physx_PxVec4_isNormalized(physx_PxVec4_Pod const* self__pod) {
        physx::PxVec4 const* self_ = reinterpret_cast<physx::PxVec4 const*>(self__pod);
        bool return_val = self_->isNormalized();
        return return_val;
    }

    float physx_PxVec4_magnitudeSquared(physx_PxVec4_Pod const* self__pod) {
        physx::PxVec4 const* self_ = reinterpret_cast<physx::PxVec4 const*>(self__pod);
        float return_val = self_->magnitudeSquared();
        return return_val;
    }

    float physx_PxVec4_magnitude(physx_PxVec4_Pod const* self__pod) {
        physx::PxVec4 const* self_ = reinterpret_cast<physx::PxVec4 const*>(self__pod);
        float return_val = self_->magnitude();
        return return_val;
    }

    float physx_PxVec4_dot(physx_PxVec4_Pod const* self__pod, physx_PxVec4_Pod const* v_pod) {
        physx::PxVec4 const* self_ = reinterpret_cast<physx::PxVec4 const*>(self__pod);
    ...
    physx_PxVec4_Pod physx_PxVec4_getNormalized(physx_PxVec4_Pod const* self__pod) {
        physx::PxVec4 const* self_ = reinterpret_cast<physx::PxVec4 const*>(self__pod);
    ...
    float physx_PxVec4_normalize_mut(physx_PxVec4_Pod* self__pod) {
        physx::PxVec4* self_ = reinterpret_cast<physx::PxVec4*>(self__pod);
        float return_val = self_->normalize();
        return return_val;
    }

    physx_PxVec4_Pod physx_PxVec4_multiply(physx_PxVec4_Pod const* self__pod, physx_PxVec4_Pod const* a_pod) {
        physx::PxVec4 const* self_ = reinterpret_cast<physx::PxVec4 const*>(self__pod);
    ...
    physx_PxVec4_Pod physx_PxVec4_minimum(physx_PxVec4_Pod const* self__pod, physx_PxVec4_Pod const* v_pod) {
        physx::PxVec4 const* self_ = reinterpret_cast<physx::PxVec4 const*>(self__pod);
        physx::PxVec4 const& v = reinterpret_cast<physx::PxVec4 const&>(*v_pod);
    ...
    physx_PxVec4_Pod physx_PxVec4_maximum(physx_PxVec4_Pod const* self__pod, physx_PxVec4_Pod const* v_pod) {
        physx::PxVec4 const* self_ = reinterpret_cast<physx::PxVec4 const*>(self__pod);
        physx::PxVec4 const& v = reinterpret_cast<physx::PxVec4 const&>(*v_pod);
    ...
    physx_PxVec3_Pod physx_PxVec4_getXYZ(physx_PxVec4_Pod const* self__pod) {
        physx::PxVec4 const* self_ = reinterpret_cast<physx::PxVec4 const*>(self__pod);
    ...
    physx_PxMat44_Pod physx_PxMat44_new() {
        PxMat44 return_val;
    ...
    physx_PxMat44_Pod physx_PxMat44_new_1(int32_t anon_param0_pod) {
        auto anon_param0 = static_cast<physx::PxIDENTITY>(anon_param0_pod);
    ...
    physx_PxMat44_Pod physx_PxMat44_new_2(int32_t anon_param0_pod) {
        auto anon_param0 = static_cast<physx::PxZERO>(anon_param0_pod);
        PxMat44 return_val(anon_param0);
        physx_PxMat44_Pod return_val_pod;
        memcpy(&return_val_pod, &return_val, sizeof(return_val_pod));
    ...
    physx_PxMat44_Pod physx_PxMat44_new_3(physx_PxVec4_Pod const* col0_pod, physx_PxVec4_Pod const* col1_pod, physx_PxVec4_Pod const* col2_pod, physx_PxVec4_Pod const* col3_pod) {
    ...
    physx_PxMat44_Pod physx_PxMat44_new_4(float r) {
    ...
    physx_PxMat44_Pod physx_PxMat44_new_5(physx_PxVec3_Pod const* col0_pod, physx_PxVec3_Pod const* col1_pod, physx_PxVec3_Pod const* col2_pod, physx_PxVec3_Pod const* col3_pod) {
        physx::PxVec3 const& col0 = reinterpret_cast<physx::PxVec3 const&>(*col0_pod);
        physx::PxVec3 const& col1 = reinterpret_cast<physx::PxVec3 const&>(*col1_pod);
        physx::PxVec3 const& col2 = reinterpret_cast<physx::PxVec3 const&>(*col2_pod);
    ...
    physx_PxMat44_Pod physx_PxMat44_new_6(float* values) {
    ...
    physx_PxMat44_Pod physx_PxMat44_new_7(physx_PxQuat_Pod const* q_pod) {
        physx::PxQuat const& q = reinterpret_cast<physx::PxQuat const&>(*q_pod);
    ...
    physx_PxMat44_Pod physx_PxMat44_new_8(physx_PxVec4_Pod const* diagonal_pod) {
    ...
    physx_PxMat44_Pod physx_PxMat44_new_9(physx_PxMat33_Pod const* axes_pod, physx_PxVec3_Pod const* position_pod) {
    ...
    physx_PxMat44_Pod physx_PxMat44_new_10(physx_PxTransform_Pod const* t_pod) {
    ...
    physx_PxMat44_Pod physx_PxMat44_getTranspose(physx_PxMat44_Pod const* self__pod) {
    ...
    physx_PxVec4_Pod physx_PxMat44_transform(physx_PxMat44_Pod const* self__pod, physx_PxVec4_Pod const* other_pod) {
        physx::PxMat44 const* self_ = reinterpret_cast<physx::PxMat44 const*>(self__pod);
    ...
    physx_PxVec3_Pod physx_PxMat44_transform_1(physx_PxMat44_Pod const* self__pod, physx_PxVec3_Pod const* other_pod) {
        physx::PxMat44 const* self_ = reinterpret_cast<physx::PxMat44 const*>(self__pod);
        physx::PxVec3 const& other = reinterpret_cast<physx::PxVec3 const&>(*other_pod);
        physx::PxVec3 return_val = self_->transform(other);
        physx_PxVec3_Pod return_val_pod;
    ...
    physx_PxVec4_Pod physx_PxMat44_rotate(physx_PxMat44_Pod const* self__pod, physx_PxVec4_Pod const* other_pod) {
        physx::PxMat44 const* self_ = reinterpret_cast<physx::PxMat44 const*>(self__pod);
        physx::PxVec4 const& other = reinterpret_cast<physx::PxVec4 const&>(*other_pod);
    ...
    physx_PxVec3_Pod physx_PxMat44_rotate_1(physx_PxMat44_Pod const* self__pod, physx_PxVec3_Pod const* other_pod) {
        physx::PxMat44 const* self_ = reinterpret_cast<physx::PxMat44 const*>(self__pod);
        physx::PxVec3 const& other = reinterpret_cast<physx::PxVec3 const&>(*other_pod);
    ...
    physx_PxVec3_Pod physx_PxMat44_getBasis(physx_PxMat44_Pod const* self__pod, uint32_t num) {
        physx::PxMat44 const* self_ = reinterpret_cast<physx::PxMat44 const*>(self__pod);
    ...
    physx_PxVec3_Pod physx_PxMat44_getPosition(physx_PxMat44_Pod const* self__pod) {
        physx::PxMat44 const* self_ = reinterpret_cast<physx::PxMat44 const*>(self__pod);
    ...
    void physx_PxMat44_setPosition_mut(physx_PxMat44_Pod* self__pod, physx_PxVec3_Pod const* position_pod) {
        physx::PxMat44* self_ = reinterpret_cast<physx::PxMat44*>(self__pod);
        physx::PxVec3 const& position = reinterpret_cast<physx::PxVec3 const&>(*position_pod);
        self_->setPosition(position);
    }

    float const* physx_PxMat44_front(physx_PxMat44_Pod const* self__pod) {
        physx::PxMat44 const* self_ = reinterpret_cast<physx::PxMat44 const*>(self__pod);
        float const* return_val = self_->front();
        return return_val;
    }

    void physx_PxMat44_scale_mut(physx_PxMat44_Pod* self__pod, physx_PxVec4_Pod const* p_pod) {
        physx::PxMat44* self_ = reinterpret_cast<physx::PxMat44*>(self__pod);
        physx::PxVec4 const& p = reinterpret_cast<physx::PxVec4 const&>(*p_pod);
        self_->scale(p);
    }

    physx_PxMat44_Pod physx_PxMat44_inverseRT(physx_PxMat44_Pod const* self__pod) {
        physx::PxMat44 const* self_ = reinterpret_cast<physx::PxMat44 const*>(self__pod);
    ...
    bool physx_PxMat44_isFinite(physx_PxMat44_Pod const* self__pod) {
        physx::PxMat44 const* self_ = reinterpret_cast<physx::PxMat44 const*>(self__pod);
        bool return_val = self_->isFinite();
        return return_val;
    }

    physx_PxPlane_Pod physx_PxPlane_new() {
        PxPlane return_val;
    ...
    physx_PxPlane_Pod physx_PxPlane_new_1(float nx, float ny, float nz, float distance) {
    ...
    physx_PxPlane_Pod physx_PxPlane_new_2(physx_PxVec3_Pod const* normal_pod, float distance) {
    ...
    physx_PxPlane_Pod physx_PxPlane_new_3(physx_PxVec3_Pod const* point_pod, physx_PxVec3_Pod const* normal_pod) {
    ...
    physx_PxPlane_Pod physx_PxPlane_new_4(physx_PxVec3_Pod const* p0_pod, physx_PxVec3_Pod const* p1_pod, physx_PxVec3_Pod const* p2_pod) {
        physx::PxVec3 const& p0 = reinterpret_cast<physx::PxVec3 const&>(*p0_pod);
    ...
    float physx_PxPlane_distance(physx_PxPlane_Pod const* self__pod, physx_PxVec3_Pod const* p_pod) {
    ...
    bool physx_PxPlane_contains(physx_PxPlane_Pod const* self__pod, physx_PxVec3_Pod const* p_pod) {
        physx::PxPlane const* self_ = reinterpret_cast<physx::PxPlane const*>(self__pod);
        physx::PxVec3 const& p = reinterpret_cast<physx::PxVec3 const&>(*p_pod);
    ...
    physx_PxVec3_Pod physx_PxPlane_project(physx_PxPlane_Pod const* self__pod, physx_PxVec3_Pod const* p_pod) {
        physx::PxPlane const* self_ = reinterpret_cast<physx::PxPlane const*>(self__pod);
        physx::PxVec3 const& p = reinterpret_cast<physx::PxVec3 const&>(*p_pod);
    ...
    physx_PxVec3_Pod physx_PxPlane_pointInPlane(physx_PxPlane_Pod const* self__pod) {
        physx::PxPlane const* self_ = reinterpret_cast<physx::PxPlane const*>(self__pod);
    ...
    void physx_PxPlane_normalize_mut(physx_PxPlane_Pod* self__pod) {
        physx::PxPlane* self_ = reinterpret_cast<physx::PxPlane*>(self__pod);
        self_->normalize();
    }

    physx_PxPlane_Pod physx_PxPlane_transform(physx_PxPlane_Pod const* self__pod, physx_PxTransform_Pod const* pose_pod) {
        physx::PxPlane const* self_ = reinterpret_cast<physx::PxPlane const*>(self__pod);
        physx::PxTransform const& pose = reinterpret_cast<physx::PxTransform const&>(*pose_pod);
    ...
    physx_PxPlane_Pod physx_PxPlane_inverseTransform(physx_PxPlane_Pod const* self__pod, physx_PxTransform_Pod const* pose_pod) {
        physx::PxPlane const* self_ = reinterpret_cast<physx::PxPlane const*>(self__pod);
        physx::PxTransform const& pose = reinterpret_cast<physx::PxTransform const&>(*pose_pod);
    ...
    physx_PxQuat_Pod physx_phys_PxShortestRotation(physx_PxVec3_Pod const* from_pod, physx_PxVec3_Pod const* target_pod) {
    ...
    physx_PxVec3_Pod physx_phys_PxDiagonalize(physx_PxMat33_Pod const* m_pod, physx_PxQuat_Pod* axes_pod) {
        physx::PxMat33 const& m = reinterpret_cast<physx::PxMat33 const&>(*m_pod);
    ...
    physx_PxTransform_Pod physx_phys_PxTransformFromSegment(physx_PxVec3_Pod const* p0_pod, physx_PxVec3_Pod const* p1_pod, float* halfHeight) {
        physx::PxVec3 const& p0 = reinterpret_cast<physx::PxVec3 const&>(*p0_pod);
        physx::PxVec3 const& p1 = reinterpret_cast<physx::PxVec3 const&>(*p1_pod);
    ...
    physx_PxTransform_Pod physx_phys_PxTransformFromPlaneEquation(physx_PxPlane_Pod const* plane_pod) {
    ...
    physx_PxPlane_Pod physx_phys_PxPlaneEquationFromTransform(physx_PxTransform_Pod const* pose_pod) {
        physx::PxTransform const& pose = reinterpret_cast<physx::PxTransform const&>(*pose_pod);
    ...
    physx_PxQuat_Pod physx_phys_PxSlerp(float t, physx_PxQuat_Pod const* left_pod, physx_PxQuat_Pod const* right_pod) {
    ...
    void physx_phys_PxIntegrateTransform(physx_PxTransform_Pod const* curTrans_pod, physx_PxVec3_Pod const* linvel_pod, physx_PxVec3_Pod const* angvel_pod, float timeStep, physx_PxTransform_Pod* result_pod) {
    ...
    physx_PxQuat_Pod physx_phys_PxExp(physx_PxVec3_Pod const* v_pod) {
        physx::PxVec3 const& v = reinterpret_cast<physx::PxVec3 const&>(*v_pod);
    ...
    physx_PxVec3_Pod physx_phys_PxOptimizeBoundingBox(physx_PxMat33_Pod* basis_pod) {
    ...
    physx_PxVec3_Pod physx_phys_PxLog(physx_PxQuat_Pod const* q_pod) {
        physx::PxQuat const& q = reinterpret_cast<physx::PxQuat const&>(*q_pod);
    ...
    uint32_t physx_phys_PxLargestAxis(physx_PxVec3_Pod const* v_pod) {
        physx::PxVec3 const& v = reinterpret_cast<physx::PxVec3 const&>(*v_pod);
    ...
    physx_PxVec3_Pod physx_phys_PxEllipseClamp(physx_PxVec3_Pod const* point_pod, physx_PxVec3_Pod const* radii_pod) {
        physx::PxVec3 const& point = reinterpret_cast<physx::PxVec3 const&>(*point_pod);
    ...
    void physx_phys_PxSeparateSwingTwist(physx_PxQuat_Pod const* q_pod, physx_PxQuat_Pod* swing_pod, physx_PxQuat_Pod* twist_pod) {
        physx::PxQuat const& q = reinterpret_cast<physx::PxQuat const&>(*q_pod);
    ...
    float physx_phys_PxComputeAngle(physx_PxVec3_Pod const* v0_pod, physx_PxVec3_Pod const* v1_pod) {
        physx::PxVec3 const& v0 = reinterpret_cast<physx::PxVec3 const&>(*v0_pod);
        physx::PxVec3 const& v1 = reinterpret_cast<physx::PxVec3 const&>(*v1_pod);
    ...
    void physx_phys_PxComputeBasisVectors(physx_PxVec3_Pod const* dir_pod, physx_PxVec3_Pod* right_pod, physx_PxVec3_Pod* up_pod) {
    ...
    void physx_phys_PxComputeBasisVectors_1(physx_PxVec3_Pod const* p0_pod, physx_PxVec3_Pod const* p1_pod, physx_PxVec3_Pod* dir_pod, physx_PxVec3_Pod* right_pod, physx_PxVec3_Pod* up_pod) {
        physx::PxVec3 const& p0 = reinterpret_cast<physx::PxVec3 const&>(*p0_pod);
        physx::PxVec3 const& p1 = reinterpret_cast<physx::PxVec3 const&>(*p1_pod);
    ...
    void physx_phys_computeBarycentric(physx_PxVec3_Pod const* a_pod, physx_PxVec3_Pod const* b_pod, physx_PxVec3_Pod const* c_pod, physx_PxVec3_Pod const* d_pod, physx_PxVec3_Pod const* p_pod, physx_PxVec4_Pod* bary_pod) {
        physx::PxVec3 const& a = reinterpret_cast<physx::PxVec3 const&>(*a_pod);
        physx::PxVec3 const& b = reinterpret_cast<physx::PxVec3 const&>(*b_pod);
    ...
    void physx_phys_computeBarycentric_1(physx_PxVec3_Pod const* a_pod, physx_PxVec3_Pod const* b_pod, physx_PxVec3_Pod const* c_pod, physx_PxVec3_Pod const* p_pod, physx_PxVec4_Pod* bary_pod) {
        physx::PxVec3 const& a = reinterpret_cast<physx::PxVec3 const&>(*a_pod);
        physx::PxVec3 const& b = reinterpret_cast<physx::PxVec3 const&>(*b_pod);
        physx::PxVec3 const& c = reinterpret_cast<physx::PxVec3 const&>(*c_pod);
        physx::PxVec3 const& p = reinterpret_cast<physx::PxVec3 const&>(*p_pod);
    ...
    float physx_Interpolation_PxSDFSampleImpl(float const* sdf, physx_PxVec3_Pod const* localPos_pod, physx_PxVec3_Pod const* sdfBoxLower_pod, physx_PxVec3_Pod const* sdfBoxHigher_pod, float sdfDx, float invSdfDx, uint32_t dimX, uint32_t dimY, uint32_t dimZ, float tolerance) {
    ...
    float physx_phys_PxSdfSample(float const* sdf, physx_PxVec3_Pod const* localPos_pod, physx_PxVec3_Pod const* sdfBoxLower_pod, physx_PxVec3_Pod const* sdfBoxHigher_pod, float sdfDx, float invSdfDx, uint32_t dimX, uint32_t dimY, uint32_t dimZ, physx_PxVec3_Pod* gradient_pod, float tolerance) {
        physx::PxVec3 const& localPos = reinterpret_cast<physx::PxVec3 const&>(*localPos_pod);
        physx::PxVec3 const& sdfBoxLower = reinterpret_cast<physx::PxVec3 const&>(*sdfBoxLower_pod);
        physx::PxVec3 const& sdfBoxHigher = reinterpret_cast<physx::PxVec3 const&>(*sdfBoxHigher_pod);
    ...
    physx_PxMutexImpl_Pod* physx_PxMutexImpl_new_alloc() {
        auto return_val = new physx::PxMutexImpl();
        auto return_val_pod = reinterpret_cast<physx_PxMutexImpl_Pod*>(return_val);
        return return_val_pod;
    }

    void physx_PxMutexImpl_delete(physx_PxMutexImpl_Pod* self__pod) {
        physx::PxMutexImpl* self_ = reinterpret_cast<physx::PxMutexImpl*>(self__pod);
        delete self_;
    }

    void physx_PxMutexImpl_lock_mut(physx_PxMutexImpl_Pod* self__pod) {
        physx::PxMutexImpl* self_ = reinterpret_cast<physx::PxMutexImpl*>(self__pod);
        self_->lock();
    }

    bool physx_PxMutexImpl_trylock_mut(physx_PxMutexImpl_Pod* self__pod) {
        physx::PxMutexImpl* self_ = reinterpret_cast<physx::PxMutexImpl*>(self__pod);
        bool return_val = self_->trylock();
        return return_val;
    }

    void physx_PxMutexImpl_unlock_mut(physx_PxMutexImpl_Pod* self__pod) {
        physx::PxMutexImpl* self_ = reinterpret_cast<physx::PxMutexImpl*>(self__pod);
        self_->unlock();
    }
    ...
    physx_PxReadWriteLock_Pod* physx_PxReadWriteLock_new_alloc() {
        auto return_val = new physx::PxReadWriteLock();
        auto return_val_pod = reinterpret_cast<physx_PxReadWriteLock_Pod*>(return_val);
        return return_val_pod;
    }

    void physx_PxReadWriteLock_delete(physx_PxReadWriteLock_Pod* self__pod) {
        physx::PxReadWriteLock* self_ = reinterpret_cast<physx::PxReadWriteLock*>(self__pod);
        delete self_;
    }

    void physx_PxReadWriteLock_lockReader_mut(physx_PxReadWriteLock_Pod* self__pod, bool takeLock) {
        physx::PxReadWriteLock* self_ = reinterpret_cast<physx::PxReadWriteLock*>(self__pod);
        self_->lockReader(takeLock);
    }

    void physx_PxReadWriteLock_lockWriter_mut(physx_PxReadWriteLock_Pod* self__pod) {
        physx::PxReadWriteLock* self_ = reinterpret_cast<physx::PxReadWriteLock*>(self__pod);
        self_->lockWriter();
    }

    void physx_PxReadWriteLock_unlockReader_mut(physx_PxReadWriteLock_Pod* self__pod) {
        physx::PxReadWriteLock* self_ = reinterpret_cast<physx::PxReadWriteLock*>(self__pod);
        self_->unlockReader();
    }

    void physx_PxReadWriteLock_unlockWriter_mut(physx_PxReadWriteLock_Pod* self__pod) {
        physx::PxReadWriteLock* self_ = reinterpret_cast<physx::PxReadWriteLock*>(self__pod);
        self_->unlockWriter();
    }

    void* physx_PxProfilerCallback_zoneStart_mut(physx_PxProfilerCallback_Pod* self__pod, char const* eventName, bool detached, uint64_t contextId) {
    ...
    void physx_PxProfilerCallback_zoneEnd_mut(physx_PxProfilerCallback_Pod* self__pod, void* profilerData, char const* eventName, bool detached, uint64_t contextId) {
        physx::PxProfilerCallback* self_ = reinterpret_cast<physx::PxProfilerCallback*>(self__pod);
        self_->zoneEnd(profilerData, eventName, detached, contextId);
    }

    physx_PxProfileScoped_Pod* physx_PxProfileScoped_new_alloc(physx_PxProfilerCallback_Pod* callback_pod, char const* eventName, bool detached, uint64_t contextId) {
    ...
    void physx_PxProfileScoped_delete(physx_PxProfileScoped_Pod* self__pod) {
        physx::PxProfileScoped* self_ = reinterpret_cast<physx::PxProfileScoped*>(self__pod);
        delete self_;
    }

    physx_PxSListEntry_Pod physx_PxSListEntry_new() {
    ...
    physx_PxSListEntry_Pod* physx_PxSListEntry_next_mut(physx_PxSListEntry_Pod* self__pod) {
    ...
    physx_PxSListImpl_Pod* physx_PxSListImpl_new_alloc() {
        auto return_val = new physx::PxSListImpl();
        auto return_val_pod = reinterpret_cast<physx_PxSListImpl_Pod*>(return_val);
        return return_val_pod;
    }

    void physx_PxSListImpl_delete(physx_PxSListImpl_Pod* self__pod) {
        physx::PxSListImpl* self_ = reinterpret_cast<physx::PxSListImpl*>(self__pod);
        delete self_;
    }

    void physx_PxSListImpl_push_mut(physx_PxSListImpl_Pod* self__pod, physx_PxSListEntry_Pod* entry_pod) {
        physx::PxSListImpl* self_ = reinterpret_cast<physx::PxSListImpl*>(self__pod);
        physx::PxSListEntry* entry = reinterpret_cast<physx::PxSListEntry*>(entry_pod);
        self_->push(entry);
    }

    physx_PxSListEntry_Pod* physx_PxSListImpl_pop_mut(physx_PxSListImpl_Pod* self__pod) {
        physx::PxSListImpl* self_ = reinterpret_cast<physx::PxSListImpl*>(self__pod);
    ...
    physx_PxSListEntry_Pod* physx_PxSListImpl_flush_mut(physx_PxSListImpl_Pod* self__pod) {
        physx::PxSListImpl* self_ = reinterpret_cast<physx::PxSListImpl*>(self__pod);
    ...
    physx_PxSyncImpl_Pod* physx_PxSyncImpl_new_alloc() {
        auto return_val = new physx::PxSyncImpl();
        auto return_val_pod = reinterpret_cast<physx_PxSyncImpl_Pod*>(return_val);
        return return_val_pod;
    }

    void physx_PxSyncImpl_delete(physx_PxSyncImpl_Pod* self__pod) {
        physx::PxSyncImpl* self_ = reinterpret_cast<physx::PxSyncImpl*>(self__pod);
        delete self_;
    }

    bool physx_PxSyncImpl_wait_mut(physx_PxSyncImpl_Pod* self__pod, uint32_t milliseconds) {
        physx::PxSyncImpl* self_ = reinterpret_cast<physx::PxSyncImpl*>(self__pod);
        bool return_val = self_->wait(milliseconds);
        return return_val;
    }

    void physx_PxSyncImpl_set_mut(physx_PxSyncImpl_Pod* self__pod) {
        physx::PxSyncImpl* self_ = reinterpret_cast<physx::PxSyncImpl*>(self__pod);
        self_->set();
    }

    void physx_PxSyncImpl_reset_mut(physx_PxSyncImpl_Pod* self__pod) {
        physx::PxSyncImpl* self_ = reinterpret_cast<physx::PxSyncImpl*>(self__pod);
        self_->reset();
    }
    ...
    physx_PxRunnable_Pod* physx_PxRunnable_new_alloc() {
        auto return_val = new physx::PxRunnable();
        auto return_val_pod = reinterpret_cast<physx_PxRunnable_Pod*>(return_val);
        return return_val_pod;
    }

    void physx_PxRunnable_delete(physx_PxRunnable_Pod* self__pod) {
        physx::PxRunnable* self_ = reinterpret_cast<physx::PxRunnable*>(self__pod);
        delete self_;
    }

    void physx_PxRunnable_execute_mut(physx_PxRunnable_Pod* self__pod) {
        physx::PxRunnable* self_ = reinterpret_cast<physx::PxRunnable*>(self__pod);
        self_->execute();
    }
    ...
    uint32_t physx_phys_PxTlsSetValue(uint32_t index, size_t value_pod) {
        size_t value;
    ...
    physx_PxCounterFrequencyToTensOfNanos_Pod physx_PxCounterFrequencyToTensOfNanos_new(uint64_t inNum, uint64_t inDenom) {
    ...
    uint64_t physx_PxCounterFrequencyToTensOfNanos_toTensOfNanos(physx_PxCounterFrequencyToTensOfNanos_Pod const* self__pod, uint64_t inCounter) {
    ...
    physx_PxCounterFrequencyToTensOfNanos_Pod const* physx_PxTime_getBootCounterFrequency() {
    ...
    physx_PxCounterFrequencyToTensOfNanos_Pod physx_PxTime_getCounterFrequency() {
    ...
    physx_PxTime_Pod physx_PxTime_new() {
        PxTime return_val;
    ...
    physx_PxVec2_Pod physx_PxVec2_new_1(int32_t anon_param0_pod) {
        auto anon_param0 = static_cast<physx::PxZERO>(anon_param0_pod);
    ...
    physx_PxVec2_Pod physx_PxVec2_new_2(float a) {
        PxVec2 return_val(a);
        physx_PxVec2_Pod return_val_pod;
        memcpy(&return_val_pod, &return_val, sizeof(return_val_pod));
        return return_val_pod;
    ...
    physx_PxVec2_Pod physx_PxVec2_new_3(float nx, float ny) {
    ...
    bool physx_PxVec2_isZero(physx_PxVec2_Pod const* self__pod) {
        physx::PxVec2 const* self_ = reinterpret_cast<physx::PxVec2 const*>(self__pod);
        bool return_val = self_->isZero();
        return return_val;
    }

    bool physx_PxVec2_isFinite(physx_PxVec2_Pod const* self__pod) {
        physx::PxVec2 const* self_ = reinterpret_cast<physx::PxVec2 const*>(self__pod);
        bool return_val = self_->isFinite();
        return return_val;
    }

    bool physx_PxVec2_isNormalized(physx_PxVec2_Pod const* self__pod) {
        physx::PxVec2 const* self_ = reinterpret_cast<physx::PxVec2 const*>(self__pod);
        bool return_val = self_->isNormalized();
        return return_val;
    }

    float physx_PxVec2_magnitudeSquared(physx_PxVec2_Pod const* self__pod) {
        physx::PxVec2 const* self_ = reinterpret_cast<physx::PxVec2 const*>(self__pod);
        float return_val = self_->magnitudeSquared();
        return return_val;
    }

    float physx_PxVec2_magnitude(physx_PxVec2_Pod const* self__pod) {
        physx::PxVec2 const* self_ = reinterpret_cast<physx::PxVec2 const*>(self__pod);
        float return_val = self_->magnitude();
        return return_val;
    }

    float physx_PxVec2_dot(physx_PxVec2_Pod const* self__pod, physx_PxVec2_Pod const* v_pod) {
        physx::PxVec2 const* self_ = reinterpret_cast<physx::PxVec2 const*>(self__pod);
    ...
    physx_PxVec2_Pod physx_PxVec2_getNormalized(physx_PxVec2_Pod const* self__pod) {
        physx::PxVec2 const* self_ = reinterpret_cast<physx::PxVec2 const*>(self__pod);
    ...
    float physx_PxVec2_normalize_mut(physx_PxVec2_Pod* self__pod) {
        physx::PxVec2* self_ = reinterpret_cast<physx::PxVec2*>(self__pod);
        float return_val = self_->normalize();
        return return_val;
    }

    physx_PxVec2_Pod physx_PxVec2_multiply(physx_PxVec2_Pod const* self__pod, physx_PxVec2_Pod const* a_pod) {
        physx::PxVec2 const* self_ = reinterpret_cast<physx::PxVec2 const*>(self__pod);
    ...
    physx_PxVec2_Pod physx_PxVec2_minimum(physx_PxVec2_Pod const* self__pod, physx_PxVec2_Pod const* v_pod) {
        physx::PxVec2 const* self_ = reinterpret_cast<physx::PxVec2 const*>(self__pod);
        physx::PxVec2 const& v = reinterpret_cast<physx::PxVec2 const&>(*v_pod);
    ...
    float physx_PxVec2_minElement(physx_PxVec2_Pod const* self__pod) {
        physx::PxVec2 const* self_ = reinterpret_cast<physx::PxVec2 const*>(self__pod);
        float return_val = self_->minElement();
        return return_val;
    }

    physx_PxVec2_Pod physx_PxVec2_maximum(physx_PxVec2_Pod const* self__pod, physx_PxVec2_Pod const* v_pod) {
        physx::PxVec2 const* self_ = reinterpret_cast<physx::PxVec2 const*>(self__pod);
        physx::PxVec2 const& v = reinterpret_cast<physx::PxVec2 const&>(*v_pod);
    ...
    float physx_PxVec2_maxElement(physx_PxVec2_Pod const* self__pod) {
        physx::PxVec2 const* self_ = reinterpret_cast<physx::PxVec2 const*>(self__pod);
        float return_val = self_->maxElement();
        return return_val;
    }

    physx_PxStridedData_Pod physx_PxStridedData_new() {
    ...
    physx_PxBoundedData_Pod physx_PxBoundedData_new() {
    ...
    physx_PxDebugPoint_Pod physx_PxDebugPoint_new(physx_PxVec3_Pod const* p_pod, uint32_t const* c_pod) {
        physx::PxVec3 const& p = reinterpret_cast<physx::PxVec3 const&>(*p_pod);
    ...
    physx_PxDebugLine_Pod physx_PxDebugLine_new(physx_PxVec3_Pod const* p0_pod, physx_PxVec3_Pod const* p1_pod, uint32_t const* c_pod) {
        physx::PxVec3 const& p0 = reinterpret_cast<physx::PxVec3 const&>(*p0_pod);
        physx::PxVec3 const& p1 = reinterpret_cast<physx::PxVec3 const&>(*p1_pod);
        uint32_t const& c = *c_pod;
    ...
    physx_PxDebugTriangle_Pod physx_PxDebugTriangle_new(physx_PxVec3_Pod const* p0_pod, physx_PxVec3_Pod const* p1_pod, physx_PxVec3_Pod const* p2_pod, uint32_t const* c_pod) {
        physx::PxVec3 const& p0 = reinterpret_cast<physx::PxVec3 const&>(*p0_pod);
        physx::PxVec3 const& p1 = reinterpret_cast<physx::PxVec3 const&>(*p1_pod);
        physx::PxVec3 const& p2 = reinterpret_cast<physx::PxVec3 const&>(*p2_pod);
        uint32_t const& c = *c_pod;
    ...
    physx_PxDebugText_Pod physx_PxDebugText_new() {
    ...
    physx_PxDebugText_Pod physx_PxDebugText_new_1(physx_PxVec3_Pod const* pos_pod, float const* sz_pod, uint32_t const* clr_pod, char const* str) {
    ...
    void physx_PxRenderBuffer_delete(physx_PxRenderBuffer_Pod* self__pod) {
        physx::PxRenderBuffer* self_ = reinterpret_cast<physx::PxRenderBuffer*>(self__pod);
        delete self_;
    }

    uint32_t physx_PxRenderBuffer_getNbPoints(physx_PxRenderBuffer_Pod const* self__pod) {
    ...
    physx_PxDebugPoint_Pod const* physx_PxRenderBuffer_getPoints(physx_PxRenderBuffer_Pod const* self__pod) {
        physx::PxRenderBuffer const* self_ = reinterpret_cast<physx::PxRenderBuffer const*>(self__pod);
    ...
    void physx_PxRenderBuffer_addPoint_mut(physx_PxRenderBuffer_Pod* self__pod, physx_PxDebugPoint_Pod const* point_pod) {
        physx::PxRenderBuffer* self_ = reinterpret_cast<physx::PxRenderBuffer*>(self__pod);
        physx::PxDebugPoint const& point = reinterpret_cast<physx::PxDebugPoint const&>(*point_pod);
        self_->addPoint(point);
    }

    uint32_t physx_PxRenderBuffer_getNbLines(physx_PxRenderBuffer_Pod const* self__pod) {
        physx::PxRenderBuffer const* self_ = reinterpret_cast<physx::PxRenderBuffer const*>(self__pod);
        uint32_t return_val = self_->getNbLines();
        return return_val;
    }

    physx_PxDebugLine_Pod const* physx_PxRenderBuffer_getLines(physx_PxRenderBuffer_Pod const* self__pod) {
        physx::PxRenderBuffer const* self_ = reinterpret_cast<physx::PxRenderBuffer const*>(self__pod);
    ...
    void physx_PxRenderBuffer_addLine_mut(physx_PxRenderBuffer_Pod* self__pod, physx_PxDebugLine_Pod const* line_pod) {
        physx::PxRenderBuffer* self_ = reinterpret_cast<physx::PxRenderBuffer*>(self__pod);
        physx::PxDebugLine const& line = reinterpret_cast<physx::PxDebugLine const&>(*line_pod);
        self_->addLine(line);
    }

    physx_PxDebugLine_Pod* physx_PxRenderBuffer_reserveLines_mut(physx_PxRenderBuffer_Pod* self__pod, uint32_t nbLines) {
        physx::PxRenderBuffer* self_ = reinterpret_cast<physx::PxRenderBuffer*>(self__pod);
    ...
    physx_PxDebugPoint_Pod* physx_PxRenderBuffer_reservePoints_mut(physx_PxRenderBuffer_Pod* self__pod, uint32_t nbLines) {
        physx::PxRenderBuffer* self_ = reinterpret_cast<physx::PxRenderBuffer*>(self__pod);
    ...
    uint32_t physx_PxRenderBuffer_getNbTriangles(physx_PxRenderBuffer_Pod const* self__pod) {
        physx::PxRenderBuffer const* self_ = reinterpret_cast<physx::PxRenderBuffer const*>(self__pod);
        uint32_t return_val = self_->getNbTriangles();
        return return_val;
    }

    physx_PxDebugTriangle_Pod const* physx_PxRenderBuffer_getTriangles(physx_PxRenderBuffer_Pod const* self__pod) {
        physx::PxRenderBuffer const* self_ = reinterpret_cast<physx::PxRenderBuffer const*>(self__pod);
    ...
    void physx_PxRenderBuffer_addTriangle_mut(physx_PxRenderBuffer_Pod* self__pod, physx_PxDebugTriangle_Pod const* triangle_pod) {
        physx::PxRenderBuffer* self_ = reinterpret_cast<physx::PxRenderBuffer*>(self__pod);
        physx::PxDebugTriangle const& triangle = reinterpret_cast<physx::PxDebugTriangle const&>(*triangle_pod);
        self_->addTriangle(triangle);
    }

    void physx_PxRenderBuffer_append_mut(physx_PxRenderBuffer_Pod* self__pod, physx_PxRenderBuffer_Pod const* other_pod) {
        physx::PxRenderBuffer* self_ = reinterpret_cast<physx::PxRenderBuffer*>(self__pod);
        physx::PxRenderBuffer const& other = reinterpret_cast<physx::PxRenderBuffer const&>(*other_pod);
        self_->append(other);
    }

    void physx_PxRenderBuffer_clear_mut(physx_PxRenderBuffer_Pod* self__pod) {
        physx::PxRenderBuffer* self_ = reinterpret_cast<physx::PxRenderBuffer*>(self__pod);
        self_->clear();
    }

    void physx_PxRenderBuffer_shift_mut(physx_PxRenderBuffer_Pod* self__pod, physx_PxVec3_Pod const* delta_pod) {
        physx::PxRenderBuffer* self_ = reinterpret_cast<physx::PxRenderBuffer*>(self__pod);
        physx::PxVec3 const& delta = reinterpret_cast<physx::PxVec3 const&>(*delta_pod);
        self_->shift(delta);
    }

    bool physx_PxRenderBuffer_empty(physx_PxRenderBuffer_Pod const* self__pod) {
        physx::PxRenderBuffer const* self_ = reinterpret_cast<physx::PxRenderBuffer const*>(self__pod);
        bool return_val = self_->empty();
        return return_val;
    }

    void physx_PxProcessPxBaseCallback_delete(physx_PxProcessPxBaseCallback_Pod* self__pod) {
        physx::PxProcessPxBaseCallback* self_ = reinterpret_cast<physx::PxProcessPxBaseCallback*>(self__pod);
        delete self_;
    }

    void physx_PxProcessPxBaseCallback_process_mut(physx_PxProcessPxBaseCallback_Pod* self__pod, physx_PxBase_Pod* anon_param0_pod) {
        physx::PxProcessPxBaseCallback* self_ = reinterpret_cast<physx::PxProcessPxBaseCallback*>(self__pod);
        physx::PxBase& anon_param0 = reinterpret_cast<physx::PxBase&>(*anon_param0_pod);
        self_->process(anon_param0);
    }

    void physx_PxSerializationContext_registerReference_mut(physx_PxSerializationContext_Pod* self__pod, physx_PxBase_Pod* base_pod, uint32_t kind, size_t reference_pod) {
    ...
    physx_PxCollection_Pod const* physx_PxSerializationContext_getCollection(physx_PxSerializationContext_Pod const* self__pod) {
    ...
    void physx_PxSerializationContext_writeData_mut(physx_PxSerializationContext_Pod* self__pod, void const* data, uint32_t size) {
        physx::PxSerializationContext* self_ = reinterpret_cast<physx::PxSerializationContext*>(self__pod);
        self_->writeData(data, size);
    }

    void physx_PxSerializationContext_alignData_mut(physx_PxSerializationContext_Pod* self__pod, uint32_t alignment) {
        physx::PxSerializationContext* self_ = reinterpret_cast<physx::PxSerializationContext*>(self__pod);
        self_->alignData(alignment);
    }

    void physx_PxSerializationContext_writeName_mut(physx_PxSerializationContext_Pod* self__pod, char const* name) {
        physx::PxSerializationContext* self_ = reinterpret_cast<physx::PxSerializationContext*>(self__pod);
        self_->writeName(name);
    }

    physx_PxBase_Pod* physx_PxDeserializationContext_resolveReference(physx_PxDeserializationContext_Pod const* self__pod, uint32_t kind, size_t reference_pod) {
    ...
    void physx_PxDeserializationContext_readName_mut(physx_PxDeserializationContext_Pod* self__pod, char const** name_pod) {
    ...
    void physx_PxDeserializationContext_alignExtraData_mut(physx_PxDeserializationContext_Pod* self__pod, uint32_t alignment) {
        physx::PxDeserializationContext* self_ = reinterpret_cast<physx::PxDeserializationContext*>(self__pod);
        self_->alignExtraData(alignment);
    }

    void physx_PxSerializationRegistry_registerSerializer_mut(physx_PxSerializationRegistry_Pod* self__pod, uint16_t type, physx_PxSerializer_Pod* serializer_pod) {
    ...
    physx_PxSerializer_Pod* physx_PxSerializationRegistry_unregisterSerializer_mut(physx_PxSerializationRegistry_Pod* self__pod, uint16_t type) {
        physx::PxSerializationRegistry* self_ = reinterpret_cast<physx::PxSerializationRegistry*>(self__pod);
    ...
    physx_PxSerializer_Pod const* physx_PxSerializationRegistry_getSerializer(physx_PxSerializationRegistry_Pod const* self__pod, uint16_t type) {
    ...
    void physx_PxSerializationRegistry_registerRepXSerializer_mut(physx_PxSerializationRegistry_Pod* self__pod, uint16_t type, physx_PxRepXSerializer_Pod* serializer_pod) {
        physx::PxSerializationRegistry* self_ = reinterpret_cast<physx::PxSerializationRegistry*>(self__pod);
    ...
    physx_PxRepXSerializer_Pod* physx_PxSerializationRegistry_unregisterRepXSerializer_mut(physx_PxSerializationRegistry_Pod* self__pod, uint16_t type) {
        physx::PxSerializationRegistry* self_ = reinterpret_cast<physx::PxSerializationRegistry*>(self__pod);
    ...
    physx_PxRepXSerializer_Pod* physx_PxSerializationRegistry_getRepXSerializer(physx_PxSerializationRegistry_Pod const* self__pod, char const* typeName) {
        physx::PxSerializationRegistry const* self_ = reinterpret_cast<physx::PxSerializationRegistry const*>(self__pod);
    ...
    void physx_PxSerializationRegistry_release_mut(physx_PxSerializationRegistry_Pod* self__pod) {
        physx::PxSerializationRegistry* self_ = reinterpret_cast<physx::PxSerializationRegistry*>(self__pod);
        self_->release();
    }

    void physx_PxCollection_add_mut(physx_PxCollection_Pod* self__pod, physx_PxBase_Pod* object_pod, uint64_t id) {
    ...
    void physx_PxCollection_remove_mut(physx_PxCollection_Pod* self__pod, physx_PxBase_Pod* object_pod) {
        physx::PxCollection* self_ = reinterpret_cast<physx::PxCollection*>(self__pod);
        physx::PxBase& object = reinterpret_cast<physx::PxBase&>(*object_pod);
        self_->remove(object);
    }

    bool physx_PxCollection_contains(physx_PxCollection_Pod const* self__pod, physx_PxBase_Pod* object_pod) {
    ...
    void physx_PxCollection_addId_mut(physx_PxCollection_Pod* self__pod, physx_PxBase_Pod* object_pod, uint64_t id) {
        physx::PxCollection* self_ = reinterpret_cast<physx::PxCollection*>(self__pod);
        physx::PxBase& object = reinterpret_cast<physx::PxBase&>(*object_pod);
        self_->addId(object, id);
    }

    void physx_PxCollection_removeId_mut(physx_PxCollection_Pod* self__pod, uint64_t id) {
        physx::PxCollection* self_ = reinterpret_cast<physx::PxCollection*>(self__pod);
        self_->removeId(id);
    }

    void physx_PxCollection_add_mut_1(physx_PxCollection_Pod* self__pod, physx_PxCollection_Pod* collection_pod) {
        physx::PxCollection* self_ = reinterpret_cast<physx::PxCollection*>(self__pod);
        physx::PxCollection& collection = reinterpret_cast<physx::PxCollection&>(*collection_pod);
        self_->add(collection);
    }

    void physx_PxCollection_remove_mut_1(physx_PxCollection_Pod* self__pod, physx_PxCollection_Pod* collection_pod) {
        physx::PxCollection* self_ = reinterpret_cast<physx::PxCollection*>(self__pod);
        physx::PxCollection& collection = reinterpret_cast<physx::PxCollection&>(*collection_pod);
        self_->remove(collection);
    }

    uint32_t physx_PxCollection_getNbObjects(physx_PxCollection_Pod const* self__pod) {
        physx::PxCollection const* self_ = reinterpret_cast<physx::PxCollection const*>(self__pod);
        uint32_t return_val = self_->getNbObjects();
        return return_val;
    }

    physx_PxBase_Pod* physx_PxCollection_getObject(physx_PxCollection_Pod const* self__pod, uint32_t index) {
        physx::PxCollection const* self_ = reinterpret_cast<physx::PxCollection const*>(self__pod);
    ...
    uint32_t physx_PxCollection_getObjects(physx_PxCollection_Pod const* self__pod, physx_PxBase_Pod** userBuffer_pod, uint32_t bufferSize, uint32_t startIndex) {
        physx::PxCollection const* self_ = reinterpret_cast<physx::PxCollection const*>(self__pod);
    ...
    physx_PxBase_Pod* physx_PxCollection_find(physx_PxCollection_Pod const* self__pod, uint64_t id) {
        physx::PxCollection const* self_ = reinterpret_cast<physx::PxCollection const*>(self__pod);
    ...
    uint32_t physx_PxCollection_getNbIds(physx_PxCollection_Pod const* self__pod) {
        physx::PxCollection const* self_ = reinterpret_cast<physx::PxCollection const*>(self__pod);
        uint32_t return_val = self_->getNbIds();
        return return_val;
    }

    uint32_t physx_PxCollection_getIds(physx_PxCollection_Pod const* self__pod, uint64_t* userBuffer, uint32_t bufferSize, uint32_t startIndex) {
        physx::PxCollection const* self_ = reinterpret_cast<physx::PxCollection const*>(self__pod);
        uint32_t return_val = self_->getIds(userBuffer, bufferSize, startIndex);
        return return_val;
    }

    uint64_t physx_PxCollection_getId(physx_PxCollection_Pod const* self__pod, physx_PxBase_Pod const* object_pod) {
        physx::PxCollection const* self_ = reinterpret_cast<physx::PxCollection const*>(self__pod);
    ...
    void physx_PxCollection_release_mut(physx_PxCollection_Pod* self__pod) {
        physx::PxCollection* self_ = reinterpret_cast<physx::PxCollection*>(self__pod);
        self_->release();
    }

    physx_PxCollection_Pod* physx_phys_PxCreateCollection() {
        physx::PxCollection* return_val = PxCreateCollection();
        auto return_val_pod = reinterpret_cast<physx_PxCollection_Pod*>(return_val);
        return return_val_pod;
    }

    void physx_PxBase_release_mut(physx_PxBase_Pod* self__pod) {
        physx::PxBase* self_ = reinterpret_cast<physx::PxBase*>(self__pod);
        self_->release();
    }

    char const* physx_PxBase_getConcreteTypeName(physx_PxBase_Pod const* self__pod) {
        physx::PxBase const* self_ = reinterpret_cast<physx::PxBase const*>(self__pod);
        char const* return_val = self_->getConcreteTypeName();
        return return_val;
    }

    uint16_t physx_PxBase_getConcreteType(physx_PxBase_Pod const* self__pod) {
        physx::PxBase const* self_ = reinterpret_cast<physx::PxBase const*>(self__pod);
        uint16_t return_val = self_->getConcreteType();
        return return_val;
    }

    void physx_PxBase_setBaseFlag_mut(physx_PxBase_Pod* self__pod, int32_t flag_pod, bool value) {
        physx::PxBase* self_ = reinterpret_cast<physx::PxBase*>(self__pod);
        auto flag = static_cast<physx::PxBaseFlag::Enum>(flag_pod);
        self_->setBaseFlag(flag, value);
    }

    void physx_PxBase_setBaseFlags_mut(physx_PxBase_Pod* self__pod, uint16_t inFlags_pod) {
        physx::PxBase* self_ = reinterpret_cast<physx::PxBase*>(self__pod);
        auto inFlags = physx::PxBaseFlags(inFlags_pod);
        self_->setBaseFlags(inFlags);
    }

    uint16_t physx_PxBase_getBaseFlags(physx_PxBase_Pod const* self__pod) {
        physx::PxBase const* self_ = reinterpret_cast<physx::PxBase const*>(self__pod);
    ...
    bool physx_PxBase_isReleasable(physx_PxBase_Pod const* self__pod) {
        physx::PxBase const* self_ = reinterpret_cast<physx::PxBase const*>(self__pod);
        bool return_val = self_->isReleasable();
        return return_val;
    }

    void physx_PxRefCounted_release_mut(physx_PxRefCounted_Pod* self__pod) {
        physx::PxRefCounted* self_ = reinterpret_cast<physx::PxRefCounted*>(self__pod);
        self_->release();
    }

    uint32_t physx_PxRefCounted_getReferenceCount(physx_PxRefCounted_Pod const* self__pod) {
    ...
    void physx_PxRefCounted_acquireReference_mut(physx_PxRefCounted_Pod* self__pod) {
        physx::PxRefCounted* self_ = reinterpret_cast<physx::PxRefCounted*>(self__pod);
        self_->acquireReference();
    }

    physx_PxTolerancesScale_Pod physx_PxTolerancesScale_new(float defaultLength, float defaultSpeed) {
    ...
    bool physx_PxTolerancesScale_isValid(physx_PxTolerancesScale_Pod const* self__pod) {
        physx::PxTolerancesScale const* self_ = reinterpret_cast<physx::PxTolerancesScale const*>(self__pod);
        bool return_val = self_->isValid();
        return return_val;
    }

    char const* physx_PxStringTable_allocateStr_mut(physx_PxStringTable_Pod* self__pod, char const* inSrc) {
        physx::PxStringTable* self_ = reinterpret_cast<physx::PxStringTable*>(self__pod);
        char const* return_val = self_->allocateStr(inSrc);
        return return_val;
    }

    void physx_PxStringTable_release_mut(physx_PxStringTable_Pod* self__pod) {
        physx::PxStringTable* self_ = reinterpret_cast<physx::PxStringTable*>(self__pod);
        self_->release();
    }

    char const* physx_PxSerializer_getConcreteTypeName(physx_PxSerializer_Pod const* self__pod) {
        physx::PxSerializer const* self_ = reinterpret_cast<physx::PxSerializer const*>(self__pod);
        char const* return_val = self_->getConcreteTypeName();
        return return_val;
    }

    void physx_PxSerializer_requiresObjects(physx_PxSerializer_Pod const* self__pod, physx_PxBase_Pod* anon_param0_pod, physx_PxProcessPxBaseCallback_Pod* anon_param1_pod) {
        physx::PxSerializer const* self_ = reinterpret_cast<physx::PxSerializer const*>(self__pod);
        physx::PxBase& anon_param0 = reinterpret_cast<physx::PxBase&>(*anon_param0_pod);
    ...
    bool physx_PxSerializer_isSubordinate(physx_PxSerializer_Pod const* self__pod) {
        physx::PxSerializer const* self_ = reinterpret_cast<physx::PxSerializer const*>(self__pod);
        bool return_val = self_->isSubordinate();
        return return_val;
    }

    void physx_PxSerializer_exportExtraData(physx_PxSerializer_Pod const* self__pod, physx_PxBase_Pod* anon_param0_pod, physx_PxSerializationContext_Pod* anon_param1_pod) {
        physx::PxSerializer const* self_ = reinterpret_cast<physx::PxSerializer const*>(self__pod);
        physx::PxBase& anon_param0 = reinterpret_cast<physx::PxBase&>(*anon_param0_pod);
    ...
    void physx_PxSerializer_exportData(physx_PxSerializer_Pod const* self__pod, physx_PxBase_Pod* anon_param0_pod, physx_PxSerializationContext_Pod* anon_param1_pod) {
        physx::PxSerializer const* self_ = reinterpret_cast<physx::PxSerializer const*>(self__pod);
        physx::PxBase& anon_param0 = reinterpret_cast<physx::PxBase&>(*anon_param0_pod);
        physx::PxSerializationContext& anon_param1 = reinterpret_cast<physx::PxSerializationContext&>(*anon_param1_pod);
    ...
    void physx_PxSerializer_registerReferences(physx_PxSerializer_Pod const* self__pod, physx_PxBase_Pod* obj_pod, physx_PxSerializationContext_Pod* s_pod) {
        physx::PxSerializer const* self_ = reinterpret_cast<physx::PxSerializer const*>(self__pod);
    ...
    size_t physx_PxSerializer_getClassSize(physx_PxSerializer_Pod const* self__pod) {
        physx::PxSerializer const* self_ = reinterpret_cast<physx::PxSerializer const*>(self__pod);
    ...
    physx_PxBase_Pod* physx_PxSerializer_createObject(physx_PxSerializer_Pod const* self__pod, uint8_t** address_pod, physx_PxDeserializationContext_Pod* context_pod) {
        physx::PxSerializer const* self_ = reinterpret_cast<physx::PxSerializer const*>(self__pod);
    ...
    void physx_PxSerializer_delete(physx_PxSerializer_Pod* self__pod) {
        physx::PxSerializer* self_ = reinterpret_cast<physx::PxSerializer*>(self__pod);
        delete self_;
    }

    physx_PxBase_Pod* physx_PxInsertionCallback_buildObjectFromData_mut(physx_PxInsertionCallback_Pod* self__pod, int32_t type_pod, void* data) {
    ...
    void physx_PxTaskManager_setCpuDispatcher_mut(physx_PxTaskManager_Pod* self__pod, physx_PxCpuDispatcher_Pod* ref_pod) {
    ...
    physx_PxCpuDispatcher_Pod* physx_PxTaskManager_getCpuDispatcher(physx_PxTaskManager_Pod const* self__pod) {
    ...
    void physx_PxTaskManager_resetDependencies_mut(physx_PxTaskManager_Pod* self__pod) {
        physx::PxTaskManager* self_ = reinterpret_cast<physx::PxTaskManager*>(self__pod);
        self_->resetDependencies();
    }

    void physx_PxTaskManager_startSimulation_mut(physx_PxTaskManager_Pod* self__pod) {
        physx::PxTaskManager* self_ = reinterpret_cast<physx::PxTaskManager*>(self__pod);
        self_->startSimulation();
    }

    void physx_PxTaskManager_stopSimulation_mut(physx_PxTaskManager_Pod* self__pod) {
        physx::PxTaskManager* self_ = reinterpret_cast<physx::PxTaskManager*>(self__pod);
        self_->stopSimulation();
    }

    void physx_PxTaskManager_taskCompleted_mut(physx_PxTaskManager_Pod* self__pod, physx_PxTask_Pod* task_pod) {
        physx::PxTaskManager* self_ = reinterpret_cast<physx::PxTaskManager*>(self__pod);
        physx::PxTask& task = reinterpret_cast<physx::PxTask&>(*task_pod);
        self_->taskCompleted(task);
    }

    uint32_t physx_PxTaskManager_getNamedTask_mut(physx_PxTaskManager_Pod* self__pod, char const* name) {
        physx::PxTaskManager* self_ = reinterpret_cast<physx::PxTaskManager*>(self__pod);
        uint32_t return_val = self_->getNamedTask(name);
        return return_val;
    }

    uint32_t physx_PxTaskManager_submitNamedTask_mut(physx_PxTaskManager_Pod* self__pod, physx_PxTask_Pod* task_pod, char const* name, int32_t type_pod) {
        physx::PxTaskManager* self_ = reinterpret_cast<physx::PxTaskManager*>(self__pod);
        physx::PxTask* task = reinterpret_cast<physx::PxTask*>(task_pod);
    ...
    uint32_t physx_PxTaskManager_submitUnnamedTask_mut(physx_PxTaskManager_Pod* self__pod, physx_PxTask_Pod* task_pod, int32_t type_pod) {
        physx::PxTaskManager* self_ = reinterpret_cast<physx::PxTaskManager*>(self__pod);
        physx::PxTask& task = reinterpret_cast<physx::PxTask&>(*task_pod);
        auto type = static_cast<physx::PxTaskType::Enum>(type_pod);
    ...
    physx_PxTask_Pod* physx_PxTaskManager_getTaskFromID_mut(physx_PxTaskManager_Pod* self__pod, uint32_t id) {
        physx::PxTaskManager* self_ = reinterpret_cast<physx::PxTaskManager*>(self__pod);
    ...
    void physx_PxTaskManager_release_mut(physx_PxTaskManager_Pod* self__pod) {
        physx::PxTaskManager* self_ = reinterpret_cast<physx::PxTaskManager*>(self__pod);
        self_->release();
    }

    physx_PxTaskManager_Pod* physx_PxTaskManager_createTaskManager(physx_PxErrorCallback_Pod* errorCallback_pod, physx_PxCpuDispatcher_Pod* anon_param1_pod) {
        physx::PxErrorCallback& errorCallback = reinterpret_cast<physx::PxErrorCallback&>(*errorCallback_pod);
    ...
    void physx_PxCpuDispatcher_submitTask_mut(physx_PxCpuDispatcher_Pod* self__pod, physx_PxBaseTask_Pod* task_pod) {
    ...
    uint32_t physx_PxCpuDispatcher_getWorkerCount(physx_PxCpuDispatcher_Pod const* self__pod) {
    ...
    void physx_PxCpuDispatcher_delete(physx_PxCpuDispatcher_Pod* self__pod) {
        physx::PxCpuDispatcher* self_ = reinterpret_cast<physx::PxCpuDispatcher*>(self__pod);
        delete self_;
    }

    void physx_PxBaseTask_run_mut(physx_PxBaseTask_Pod* self__pod) {
        physx::PxBaseTask* self_ = reinterpret_cast<physx::PxBaseTask*>(self__pod);
        self_->run();
    }

    char const* physx_PxBaseTask_getName(physx_PxBaseTask_Pod const* self__pod) {
        physx::PxBaseTask const* self_ = reinterpret_cast<physx::PxBaseTask const*>(self__pod);
        char const* return_val = self_->getName();
        return return_val;
    }

    void physx_PxBaseTask_addReference_mut(physx_PxBaseTask_Pod* self__pod) {
        physx::PxBaseTask* self_ = reinterpret_cast<physx::PxBaseTask*>(self__pod);
        self_->addReference();
    }

    void physx_PxBaseTask_removeReference_mut(physx_PxBaseTask_Pod* self__pod) {
        physx::PxBaseTask* self_ = reinterpret_cast<physx::PxBaseTask*>(self__pod);
        self_->removeReference();
    }

    int32_t physx_PxBaseTask_getReference(physx_PxBaseTask_Pod const* self__pod) {
        physx::PxBaseTask const* self_ = reinterpret_cast<physx::PxBaseTask const*>(self__pod);
        int32_t return_val = self_->getReference();
        return return_val;
    }

    void physx_PxBaseTask_release_mut(physx_PxBaseTask_Pod* self__pod) {
        physx::PxBaseTask* self_ = reinterpret_cast<physx::PxBaseTask*>(self__pod);
        self_->release();
    }

    physx_PxTaskManager_Pod* physx_PxBaseTask_getTaskManager(physx_PxBaseTask_Pod const* self__pod) {
        physx::PxBaseTask const* self_ = reinterpret_cast<physx::PxBaseTask const*>(self__pod);
    ...
    void physx_PxBaseTask_setContextId_mut(physx_PxBaseTask_Pod* self__pod, uint64_t id) {
        physx::PxBaseTask* self_ = reinterpret_cast<physx::PxBaseTask*>(self__pod);
        self_->setContextId(id);
    }

    uint64_t physx_PxBaseTask_getContextId(physx_PxBaseTask_Pod const* self__pod) {
        physx::PxBaseTask const* self_ = reinterpret_cast<physx::PxBaseTask const*>(self__pod);
        uint64_t return_val = self_->getContextId();
        return return_val;
    }

    void physx_PxTask_release_mut(physx_PxTask_Pod* self__pod) {
        physx::PxTask* self_ = reinterpret_cast<physx::PxTask*>(self__pod);
        self_->release();
    }

    void physx_PxTask_finishBefore_mut(physx_PxTask_Pod* self__pod, uint32_t taskID) {
        physx::PxTask* self_ = reinterpret_cast<physx::PxTask*>(self__pod);
        self_->finishBefore(taskID);
    }

    void physx_PxTask_startAfter_mut(physx_PxTask_Pod* self__pod, uint32_t taskID) {
        physx::PxTask* self_ = reinterpret_cast<physx::PxTask*>(self__pod);
        self_->startAfter(taskID);
    }

    void physx_PxTask_addReference_mut(physx_PxTask_Pod* self__pod) {
        physx::PxTask* self_ = reinterpret_cast<physx::PxTask*>(self__pod);
        self_->addReference();
    }

    void physx_PxTask_removeReference_mut(physx_PxTask_Pod* self__pod) {
        physx::PxTask* self_ = reinterpret_cast<physx::PxTask*>(self__pod);
        self_->removeReference();
    }

    int32_t physx_PxTask_getReference(physx_PxTask_Pod const* self__pod) {
        physx::PxTask const* self_ = reinterpret_cast<physx::PxTask const*>(self__pod);
        int32_t return_val = self_->getReference();
        return return_val;
    }

    uint32_t physx_PxTask_getTaskID(physx_PxTask_Pod const* self__pod) {
        physx::PxTask const* self_ = reinterpret_cast<physx::PxTask const*>(self__pod);
        uint32_t return_val = self_->getTaskID();
        return return_val;
    }

    void physx_PxTask_submitted_mut(physx_PxTask_Pod* self__pod) {
        physx::PxTask* self_ = reinterpret_cast<physx::PxTask*>(self__pod);
        self_->submitted();
    }

    void physx_PxLightCpuTask_setContinuation_mut(physx_PxLightCpuTask_Pod* self__pod, physx_PxTaskManager_Pod* tm_pod, physx_PxBaseTask_Pod* c_pod) {
    ...
    void physx_PxLightCpuTask_setContinuation_mut_1(physx_PxLightCpuTask_Pod* self__pod, physx_PxBaseTask_Pod* c_pod) {
        physx::PxLightCpuTask* self_ = reinterpret_cast<physx::PxLightCpuTask*>(self__pod);
        physx::PxBaseTask* c = reinterpret_cast<physx::PxBaseTask*>(c_pod);
        self_->setContinuation(c);
    }

    physx_PxBaseTask_Pod* physx_PxLightCpuTask_getContinuation(physx_PxLightCpuTask_Pod const* self__pod) {
    ...
    void physx_PxLightCpuTask_removeReference_mut(physx_PxLightCpuTask_Pod* self__pod) {
        physx::PxLightCpuTask* self_ = reinterpret_cast<physx::PxLightCpuTask*>(self__pod);
        self_->removeReference();
    }

    int32_t physx_PxLightCpuTask_getReference(physx_PxLightCpuTask_Pod const* self__pod) {
        physx::PxLightCpuTask const* self_ = reinterpret_cast<physx::PxLightCpuTask const*>(self__pod);
        int32_t return_val = self_->getReference();
        return return_val;
    }

    void physx_PxLightCpuTask_addReference_mut(physx_PxLightCpuTask_Pod* self__pod) {
        physx::PxLightCpuTask* self_ = reinterpret_cast<physx::PxLightCpuTask*>(self__pod);
        self_->addReference();
    }

    void physx_PxLightCpuTask_release_mut(physx_PxLightCpuTask_Pod* self__pod) {
        physx::PxLightCpuTask* self_ = reinterpret_cast<physx::PxLightCpuTask*>(self__pod);
        self_->release();
    }

    int32_t physx_PxGeometry_getType(physx_PxGeometry_Pod const* self__pod) {
    ...
    physx_PxBoxGeometry_Pod physx_PxBoxGeometry_new(float hx, float hy, float hz) {
    ...
    physx_PxBoxGeometry_Pod physx_PxBoxGeometry_new_1(physx_PxVec3_Pod halfExtents__pod) {
    ...
    bool physx_PxBoxGeometry_isValid(physx_PxBoxGeometry_Pod const* self__pod) {
        physx::PxBoxGeometry const* self_ = reinterpret_cast<physx::PxBoxGeometry const*>(self__pod);
        bool return_val = self_->isValid();
        return return_val;
    }

    void physx_PxBVHRaycastCallback_delete(physx_PxBVHRaycastCallback_Pod* self__pod) {
        physx::PxBVHRaycastCallback* self_ = reinterpret_cast<physx::PxBVHRaycastCallback*>(self__pod);
        delete self_;
    }

    bool physx_PxBVHRaycastCallback_reportHit_mut(physx_PxBVHRaycastCallback_Pod* self__pod, uint32_t boundsIndex, float* distance_pod) {
        physx::PxBVHRaycastCallback* self_ = reinterpret_cast<physx::PxBVHRaycastCallback*>(self__pod);
    ...
    void physx_PxBVHOverlapCallback_delete(physx_PxBVHOverlapCallback_Pod* self__pod) {
        physx::PxBVHOverlapCallback* self_ = reinterpret_cast<physx::PxBVHOverlapCallback*>(self__pod);
        delete self_;
    }

    bool physx_PxBVHOverlapCallback_reportHit_mut(physx_PxBVHOverlapCallback_Pod* self__pod, uint32_t boundsIndex) {
        physx::PxBVHOverlapCallback* self_ = reinterpret_cast<physx::PxBVHOverlapCallback*>(self__pod);
        bool return_val = self_->reportHit(boundsIndex);
        return return_val;
    }

    void physx_PxBVHTraversalCallback_delete(physx_PxBVHTraversalCallback_Pod* self__pod) {
        physx::PxBVHTraversalCallback* self_ = reinterpret_cast<physx::PxBVHTraversalCallback*>(self__pod);
        delete self_;
    }

    bool physx_PxBVHTraversalCallback_visitNode_mut(physx_PxBVHTraversalCallback_Pod* self__pod, physx_PxBounds3_Pod const* bounds_pod) {
        physx::PxBVHTraversalCallback* self_ = reinterpret_cast<physx::PxBVHTraversalCallback*>(self__pod);
        physx::PxBounds3 const& bounds = reinterpret_cast<physx::PxBounds3 const&>(*bounds_pod);
    ...
    bool physx_PxBVHTraversalCallback_reportLeaf_mut(physx_PxBVHTraversalCallback_Pod* self__pod, uint32_t nbPrims, uint32_t const* prims) {
        physx::PxBVHTraversalCallback* self_ = reinterpret_cast<physx::PxBVHTraversalCallback*>(self__pod);
        bool return_val = self_->reportLeaf(nbPrims, prims);
        return return_val;
    }

    bool physx_PxBVH_raycast(physx_PxBVH_Pod const* self__pod, physx_PxVec3_Pod const* origin_pod, physx_PxVec3_Pod const* unitDir_pod, float maxDist, physx_PxBVHRaycastCallback_Pod* cb_pod, uint32_t queryFlags_pod) {
    ...
    bool physx_PxBVH_sweep(physx_PxBVH_Pod const* self__pod, physx_PxGeometry_Pod const* geom_pod, physx_PxTransform_Pod const* pose_pod, physx_PxVec3_Pod const* unitDir_pod, float maxDist, physx_PxBVHRaycastCallback_Pod* cb_pod, uint32_t queryFlags_pod) {
        physx::PxBVH const* self_ = reinterpret_cast<physx::PxBVH const*>(self__pod);
    ...
    bool physx_PxBVH_overlap(physx_PxBVH_Pod const* self__pod, physx_PxGeometry_Pod const* geom_pod, physx_PxTransform_Pod const* pose_pod, physx_PxBVHOverlapCallback_Pod* cb_pod, uint32_t queryFlags_pod) {
        physx::PxBVH const* self_ = reinterpret_cast<physx::PxBVH const*>(self__pod);
        physx::PxGeometry const& geom = reinterpret_cast<physx::PxGeometry const&>(*geom_pod);
        physx::PxTransform const& pose = reinterpret_cast<physx::PxTransform const&>(*pose_pod);
    ...
    bool physx_PxBVH_cull(physx_PxBVH_Pod const* self__pod, uint32_t nbPlanes, physx_PxPlane_Pod const* planes_pod, physx_PxBVHOverlapCallback_Pod* cb_pod, uint32_t queryFlags_pod) {
        physx::PxBVH const* self_ = reinterpret_cast<physx::PxBVH const*>(self__pod);
    ...
    uint32_t physx_PxBVH_getNbBounds(physx_PxBVH_Pod const* self__pod) {
        physx::PxBVH const* self_ = reinterpret_cast<physx::PxBVH const*>(self__pod);
        uint32_t return_val = self_->getNbBounds();
        return return_val;
    }

    physx_PxBounds3_Pod const* physx_PxBVH_getBounds(physx_PxBVH_Pod const* self__pod) {
        physx::PxBVH const* self_ = reinterpret_cast<physx::PxBVH const*>(self__pod);
    ...
    physx_PxBounds3_Pod* physx_PxBVH_getBoundsForModification_mut(physx_PxBVH_Pod* self__pod) {
    ...
    void physx_PxBVH_refit_mut(physx_PxBVH_Pod* self__pod) {
        physx::PxBVH* self_ = reinterpret_cast<physx::PxBVH*>(self__pod);
        self_->refit();
    }

    bool physx_PxBVH_updateBounds_mut(physx_PxBVH_Pod* self__pod, uint32_t boundsIndex, physx_PxBounds3_Pod const* newBounds_pod) {
        physx::PxBVH* self_ = reinterpret_cast<physx::PxBVH*>(self__pod);
    ...
    void physx_PxBVH_partialRefit_mut(physx_PxBVH_Pod* self__pod) {
        physx::PxBVH* self_ = reinterpret_cast<physx::PxBVH*>(self__pod);
        self_->partialRefit();
    }

    bool physx_PxBVH_traverse(physx_PxBVH_Pod const* self__pod, physx_PxBVHTraversalCallback_Pod* cb_pod) {
        physx::PxBVH const* self_ = reinterpret_cast<physx::PxBVH const*>(self__pod);
    ...
    char const* physx_PxBVH_getConcreteTypeName(physx_PxBVH_Pod const* self__pod) {
        physx::PxBVH const* self_ = reinterpret_cast<physx::PxBVH const*>(self__pod);
        char const* return_val = self_->getConcreteTypeName();
        return return_val;
    }

    physx_PxCapsuleGeometry_Pod physx_PxCapsuleGeometry_new(float radius_, float halfHeight_) {
    ...
    bool physx_PxCapsuleGeometry_isValid(physx_PxCapsuleGeometry_Pod const* self__pod) {
        physx::PxCapsuleGeometry const* self_ = reinterpret_cast<physx::PxCapsuleGeometry const*>(self__pod);
        bool return_val = self_->isValid();
        return return_val;
    }

    uint32_t physx_PxConvexMesh_getNbVertices(physx_PxConvexMesh_Pod const* self__pod) {
    ...
    physx_PxVec3_Pod const* physx_PxConvexMesh_getVertices(physx_PxConvexMesh_Pod const* self__pod) {
        physx::PxConvexMesh const* self_ = reinterpret_cast<physx::PxConvexMesh const*>(self__pod);
    ...
    uint8_t const* physx_PxConvexMesh_getIndexBuffer(physx_PxConvexMesh_Pod const* self__pod) {
        physx::PxConvexMesh const* self_ = reinterpret_cast<physx::PxConvexMesh const*>(self__pod);
        uint8_t const* return_val = self_->getIndexBuffer();
        return return_val;
    }

    uint32_t physx_PxConvexMesh_getNbPolygons(physx_PxConvexMesh_Pod const* self__pod) {
        physx::PxConvexMesh const* self_ = reinterpret_cast<physx::PxConvexMesh const*>(self__pod);
        uint32_t return_val = self_->getNbPolygons();
        return return_val;
    }

    bool physx_PxConvexMesh_getPolygonData(physx_PxConvexMesh_Pod const* self__pod, uint32_t index, physx_PxHullPolygon_Pod* data_pod) {
        physx::PxConvexMesh const* self_ = reinterpret_cast<physx::PxConvexMesh const*>(self__pod);
    ...
    void physx_PxConvexMesh_release_mut(physx_PxConvexMesh_Pod* self__pod) {
        physx::PxConvexMesh* self_ = reinterpret_cast<physx::PxConvexMesh*>(self__pod);
        self_->release();
    }

    void physx_PxConvexMesh_getMassInformation(physx_PxConvexMesh_Pod const* self__pod, float* mass_pod, physx_PxMat33_Pod* localInertia_pod, physx_PxVec3_Pod* localCenterOfMass_pod) {
        physx::PxConvexMesh const* self_ = reinterpret_cast<physx::PxConvexMesh const*>(self__pod);
        float& mass = *mass_pod;
    ...
    physx_PxBounds3_Pod physx_PxConvexMesh_getLocalBounds(physx_PxConvexMesh_Pod const* self__pod) {
        physx::PxConvexMesh const* self_ = reinterpret_cast<physx::PxConvexMesh const*>(self__pod);
    ...
    float const* physx_PxConvexMesh_getSDF(physx_PxConvexMesh_Pod const* self__pod) {
        physx::PxConvexMesh const* self_ = reinterpret_cast<physx::PxConvexMesh const*>(self__pod);
        float const* return_val = self_->getSDF();
        return return_val;
    }

    char const* physx_PxConvexMesh_getConcreteTypeName(physx_PxConvexMesh_Pod const* self__pod) {
        physx::PxConvexMesh const* self_ = reinterpret_cast<physx::PxConvexMesh const*>(self__pod);
        char const* return_val = self_->getConcreteTypeName();
        return return_val;
    }

    bool physx_PxConvexMesh_isGpuCompatible(physx_PxConvexMesh_Pod const* self__pod) {
        physx::PxConvexMesh const* self_ = reinterpret_cast<physx::PxConvexMesh const*>(self__pod);
        bool return_val = self_->isGpuCompatible();
        return return_val;
    }

    physx_PxMeshScale_Pod physx_PxMeshScale_new() {
    ...
    physx_PxMeshScale_Pod physx_PxMeshScale_new_1(float r) {
    ...
    physx_PxMeshScale_Pod physx_PxMeshScale_new_2(physx_PxVec3_Pod const* s_pod) {
    ...
    physx_PxMeshScale_Pod physx_PxMeshScale_new_3(physx_PxVec3_Pod const* s_pod, physx_PxQuat_Pod const* r_pod) {
        physx::PxVec3 const& s = reinterpret_cast<physx::PxVec3 const&>(*s_pod);
    ...
    bool physx_PxMeshScale_isIdentity(physx_PxMeshScale_Pod const* self__pod) {
        physx::PxMeshScale const* self_ = reinterpret_cast<physx::PxMeshScale const*>(self__pod);
        bool return_val = self_->isIdentity();
        return return_val;
    }

    physx_PxMeshScale_Pod physx_PxMeshScale_getInverse(physx_PxMeshScale_Pod const* self__pod) {
        physx::PxMeshScale const* self_ = reinterpret_cast<physx::PxMeshScale const*>(self__pod);
    ...
    physx_PxMat33_Pod physx_PxMeshScale_toMat33(physx_PxMeshScale_Pod const* self__pod) {
        physx::PxMeshScale const* self_ = reinterpret_cast<physx::PxMeshScale const*>(self__pod);
    ...
    bool physx_PxMeshScale_hasNegativeDeterminant(physx_PxMeshScale_Pod const* self__pod) {
        physx::PxMeshScale const* self_ = reinterpret_cast<physx::PxMeshScale const*>(self__pod);
        bool return_val = self_->hasNegativeDeterminant();
        return return_val;
    }

    physx_PxVec3_Pod physx_PxMeshScale_transform(physx_PxMeshScale_Pod const* self__pod, physx_PxVec3_Pod const* v_pod) {
        physx::PxMeshScale const* self_ = reinterpret_cast<physx::PxMeshScale const*>(self__pod);
        physx::PxVec3 const& v = reinterpret_cast<physx::PxVec3 const&>(*v_pod);
    ...
    bool physx_PxMeshScale_isValidForTriangleMesh(physx_PxMeshScale_Pod const* self__pod) {
        physx::PxMeshScale const* self_ = reinterpret_cast<physx::PxMeshScale const*>(self__pod);
        bool return_val = self_->isValidForTriangleMesh();
        return return_val;
    }

    bool physx_PxMeshScale_isValidForConvexMesh(physx_PxMeshScale_Pod const* self__pod) {
        physx::PxMeshScale const* self_ = reinterpret_cast<physx::PxMeshScale const*>(self__pod);
        bool return_val = self_->isValidForConvexMesh();
        return return_val;
    }

    physx_PxConvexMeshGeometry_Pod physx_PxConvexMeshGeometry_new(physx_PxConvexMesh_Pod* mesh_pod, physx_PxMeshScale_Pod const* scaling_pod, uint8_t flags_pod) {
    ...
    bool physx_PxConvexMeshGeometry_isValid(physx_PxConvexMeshGeometry_Pod const* self__pod) {
        physx::PxConvexMeshGeometry const* self_ = reinterpret_cast<physx::PxConvexMeshGeometry const*>(self__pod);
        bool return_val = self_->isValid();
        return return_val;
    }

    physx_PxSphereGeometry_Pod physx_PxSphereGeometry_new(float ir) {
    ...
    bool physx_PxSphereGeometry_isValid(physx_PxSphereGeometry_Pod const* self__pod) {
        physx::PxSphereGeometry const* self_ = reinterpret_cast<physx::PxSphereGeometry const*>(self__pod);
        bool return_val = self_->isValid();
        return return_val;
    }

    physx_PxPlaneGeometry_Pod physx_PxPlaneGeometry_new() {
    ...
    bool physx_PxPlaneGeometry_isValid(physx_PxPlaneGeometry_Pod const* self__pod) {
        physx::PxPlaneGeometry const* self_ = reinterpret_cast<physx::PxPlaneGeometry const*>(self__pod);
        bool return_val = self_->isValid();
        return return_val;
    }

    physx_PxTriangleMeshGeometry_Pod physx_PxTriangleMeshGeometry_new(physx_PxTriangleMesh_Pod* mesh_pod, physx_PxMeshScale_Pod const* scaling_pod, uint8_t flags_pod) {
    ...
    bool physx_PxTriangleMeshGeometry_isValid(physx_PxTriangleMeshGeometry_Pod const* self__pod) {
        physx::PxTriangleMeshGeometry const* self_ = reinterpret_cast<physx::PxTriangleMeshGeometry const*>(self__pod);
        bool return_val = self_->isValid();
        return return_val;
    }

    physx_PxHeightFieldGeometry_Pod physx_PxHeightFieldGeometry_new(physx_PxHeightField_Pod* hf_pod, uint8_t flags_pod, float heightScale_, float rowScale_, float columnScale_) {
    ...
    bool physx_PxHeightFieldGeometry_isValid(physx_PxHeightFieldGeometry_Pod const* self__pod) {
        physx::PxHeightFieldGeometry const* self_ = reinterpret_cast<physx::PxHeightFieldGeometry const*>(self__pod);
        bool return_val = self_->isValid();
        return return_val;
    }

    physx_PxParticleSystemGeometry_Pod physx_PxParticleSystemGeometry_new() {
    ...
    bool physx_PxParticleSystemGeometry_isValid(physx_PxParticleSystemGeometry_Pod const* self__pod) {
        physx::PxParticleSystemGeometry const* self_ = reinterpret_cast<physx::PxParticleSystemGeometry const*>(self__pod);
        bool return_val = self_->isValid();
        return return_val;
    }

    physx_PxHairSystemGeometry_Pod physx_PxHairSystemGeometry_new() {
    ...
    bool physx_PxHairSystemGeometry_isValid(physx_PxHairSystemGeometry_Pod const* self__pod) {
        physx::PxHairSystemGeometry const* self_ = reinterpret_cast<physx::PxHairSystemGeometry const*>(self__pod);
        bool return_val = self_->isValid();
        return return_val;
    }

    physx_PxTetrahedronMeshGeometry_Pod physx_PxTetrahedronMeshGeometry_new(physx_PxTetrahedronMesh_Pod* mesh_pod) {
    ...
    bool physx_PxTetrahedronMeshGeometry_isValid(physx_PxTetrahedronMeshGeometry_Pod const* self__pod) {
        physx::PxTetrahedronMeshGeometry const* self_ = reinterpret_cast<physx::PxTetrahedronMeshGeometry const*>(self__pod);
        bool return_val = self_->isValid();
        return return_val;
    }

    physx_PxQueryHit_Pod physx_PxQueryHit_new() {
    ...
    physx_PxLocationHit_Pod physx_PxLocationHit_new() {
    ...
    bool physx_PxLocationHit_hadInitialOverlap(physx_PxLocationHit_Pod const* self__pod) {
    ...
    physx_PxGeomRaycastHit_Pod physx_PxGeomRaycastHit_new() {
    ...
    physx_PxGeomOverlapHit_Pod physx_PxGeomOverlapHit_new() {
    ...
    physx_PxGeomSweepHit_Pod physx_PxGeomSweepHit_new() {
    ...
    physx_PxGeomIndexPair_Pod physx_PxGeomIndexPair_new() {
    ...
    physx_PxGeomIndexPair_Pod physx_PxGeomIndexPair_new_1(uint32_t _id0, uint32_t _id1) {
    ...
    physx_PxCustomGeometryType_Pod physx_PxCustomGeometryType_new() {
    ...
    physx_PxCustomGeometryType_Pod physx_PxCustomGeometryType_INVALID() {
    ...
    physx_PxCustomGeometryType_Pod physx_PxCustomGeometryCallbacks_getCustomType(physx_PxCustomGeometryCallbacks_Pod const* self__pod) {
    ...
    physx_PxBounds3_Pod physx_PxCustomGeometryCallbacks_getLocalBounds(physx_PxCustomGeometryCallbacks_Pod const* self__pod, physx_PxGeometry_Pod const* geometry_pod) {
        physx::PxCustomGeometryCallbacks const* self_ = reinterpret_cast<physx::PxCustomGeometryCallbacks const*>(self__pod);
    ...
    bool physx_PxCustomGeometryCallbacks_overlap(physx_PxCustomGeometryCallbacks_Pod const* self__pod, physx_PxGeometry_Pod const* geom0_pod, physx_PxTransform_Pod const* pose0_pod, physx_PxGeometry_Pod const* geom1_pod, physx_PxTransform_Pod const* pose1_pod, physx_PxQueryThreadContext_Pod* threadContext_pod) {
        physx::PxCustomGeometryCallbacks const* self_ = reinterpret_cast<physx::PxCustomGeometryCallbacks const*>(self__pod);
    ...
    void physx_PxCustomGeometryCallbacks_computeMassProperties(physx_PxCustomGeometryCallbacks_Pod const* self__pod, physx_PxGeometry_Pod const* geometry_pod, physx_PxMassProperties_Pod* massProperties_pod) {
        physx::PxCustomGeometryCallbacks const* self_ = reinterpret_cast<physx::PxCustomGeometryCallbacks const*>(self__pod);
        physx::PxGeometry const& geometry = reinterpret_cast<physx::PxGeometry const&>(*geometry_pod);
    ...
    bool physx_PxCustomGeometryCallbacks_usePersistentContactManifold(physx_PxCustomGeometryCallbacks_Pod const* self__pod, physx_PxGeometry_Pod const* geometry_pod, float* breakingThreshold_pod) {
        physx::PxCustomGeometryCallbacks const* self_ = reinterpret_cast<physx::PxCustomGeometryCallbacks const*>(self__pod);
        physx::PxGeometry const& geometry = reinterpret_cast<physx::PxGeometry const&>(*geometry_pod);
    ...
    void physx_PxCustomGeometryCallbacks_delete(physx_PxCustomGeometryCallbacks_Pod* self__pod) {
        physx::PxCustomGeometryCallbacks* self_ = reinterpret_cast<physx::PxCustomGeometryCallbacks*>(self__pod);
        delete self_;
    }

    physx_PxCustomGeometry_Pod physx_PxCustomGeometry_new() {
    ...
    physx_PxCustomGeometry_Pod physx_PxCustomGeometry_new_1(physx_PxCustomGeometryCallbacks_Pod* _callbacks_pod) {
    ...
    bool physx_PxCustomGeometry_isValid(physx_PxCustomGeometry_Pod const* self__pod) {
        physx::PxCustomGeometry const* self_ = reinterpret_cast<physx::PxCustomGeometry const*>(self__pod);
        bool return_val = self_->isValid();
        return return_val;
    }

    physx_PxCustomGeometryType_Pod physx_PxCustomGeometry_getCustomType(physx_PxCustomGeometry_Pod const* self__pod) {
        physx::PxCustomGeometry const* self_ = reinterpret_cast<physx::PxCustomGeometry const*>(self__pod);
        physx::PxCustomGeometryType return_val = self_->getCustomType();
        physx_PxCustomGeometryType_Pod return_val_pod;
        memcpy(&return_val_pod, &return_val, sizeof(return_val_pod));
    ...
    int32_t physx_PxGeometryHolder_getType(physx_PxGeometryHolder_Pod const* self__pod) {
    ...
    physx_PxGeometry_Pod* physx_PxGeometryHolder_any_mut(physx_PxGeometryHolder_Pod* self__pod) {
    ...
    physx_PxGeometry_Pod const* physx_PxGeometryHolder_any(physx_PxGeometryHolder_Pod const* self__pod) {
        physx::PxGeometryHolder const* self_ = reinterpret_cast<physx::PxGeometryHolder const*>(self__pod);
    ...
    physx_PxSphereGeometry_Pod* physx_PxGeometryHolder_sphere_mut(physx_PxGeometryHolder_Pod* self__pod) {
        physx::PxGeometryHolder* self_ = reinterpret_cast<physx::PxGeometryHolder*>(self__pod);
    ...
    physx_PxSphereGeometry_Pod const* physx_PxGeometryHolder_sphere(physx_PxGeometryHolder_Pod const* self__pod) {
        physx::PxGeometryHolder const* self_ = reinterpret_cast<physx::PxGeometryHolder const*>(self__pod);
    ...
    physx_PxPlaneGeometry_Pod* physx_PxGeometryHolder_plane_mut(physx_PxGeometryHolder_Pod* self__pod) {
        physx::PxGeometryHolder* self_ = reinterpret_cast<physx::PxGeometryHolder*>(self__pod);
    ...
    physx_PxPlaneGeometry_Pod const* physx_PxGeometryHolder_plane(physx_PxGeometryHolder_Pod const* self__pod) {
        physx::PxGeometryHolder const* self_ = reinterpret_cast<physx::PxGeometryHolder const*>(self__pod);
    ...
    physx_PxCapsuleGeometry_Pod* physx_PxGeometryHolder_capsule_mut(physx_PxGeometryHolder_Pod* self__pod) {
        physx::PxGeometryHolder* self_ = reinterpret_cast<physx::PxGeometryHolder*>(self__pod);
    ...
    physx_PxCapsuleGeometry_Pod const* physx_PxGeometryHolder_capsule(physx_PxGeometryHolder_Pod const* self__pod) {
        physx::PxGeometryHolder const* self_ = reinterpret_cast<physx::PxGeometryHolder const*>(self__pod);
    ...
    physx_PxBoxGeometry_Pod* physx_PxGeometryHolder_box_mut(physx_PxGeometryHolder_Pod* self__pod) {
        physx::PxGeometryHolder* self_ = reinterpret_cast<physx::PxGeometryHolder*>(self__pod);
    ...
    physx_PxBoxGeometry_Pod const* physx_PxGeometryHolder_box(physx_PxGeometryHolder_Pod const* self__pod) {
        physx::PxGeometryHolder const* self_ = reinterpret_cast<physx::PxGeometryHolder const*>(self__pod);
    ...
    physx_PxConvexMeshGeometry_Pod* physx_PxGeometryHolder_convexMesh_mut(physx_PxGeometryHolder_Pod* self__pod) {
        physx::PxGeometryHolder* self_ = reinterpret_cast<physx::PxGeometryHolder*>(self__pod);
    ...
    physx_PxConvexMeshGeometry_Pod const* physx_PxGeometryHolder_convexMesh(physx_PxGeometryHolder_Pod const* self__pod) {
        physx::PxGeometryHolder const* self_ = reinterpret_cast<physx::PxGeometryHolder const*>(self__pod);
    ...
    physx_PxTetrahedronMeshGeometry_Pod* physx_PxGeometryHolder_tetMesh_mut(physx_PxGeometryHolder_Pod* self__pod) {
        physx::PxGeometryHolder* self_ = reinterpret_cast<physx::PxGeometryHolder*>(self__pod);
    ...
    physx_PxTetrahedronMeshGeometry_Pod const* physx_PxGeometryHolder_tetMesh(physx_PxGeometryHolder_Pod const* self__pod) {
        physx::PxGeometryHolder const* self_ = reinterpret_cast<physx::PxGeometryHolder const*>(self__pod);
    ...
    physx_PxTriangleMeshGeometry_Pod* physx_PxGeometryHolder_triangleMesh_mut(physx_PxGeometryHolder_Pod* self__pod) {
        physx::PxGeometryHolder* self_ = reinterpret_cast<physx::PxGeometryHolder*>(self__pod);
    ...
    physx_PxTriangleMeshGeometry_Pod const* physx_PxGeometryHolder_triangleMesh(physx_PxGeometryHolder_Pod const* self__pod) {
        physx::PxGeometryHolder const* self_ = reinterpret_cast<physx::PxGeometryHolder const*>(self__pod);
    ...
    physx_PxHeightFieldGeometry_Pod* physx_PxGeometryHolder_heightField_mut(physx_PxGeometryHolder_Pod* self__pod) {
        physx::PxGeometryHolder* self_ = reinterpret_cast<physx::PxGeometryHolder*>(self__pod);
    ...
    physx_PxHeightFieldGeometry_Pod const* physx_PxGeometryHolder_heightField(physx_PxGeometryHolder_Pod const* self__pod) {
        physx::PxGeometryHolder const* self_ = reinterpret_cast<physx::PxGeometryHolder const*>(self__pod);
    ...
    physx_PxParticleSystemGeometry_Pod* physx_PxGeometryHolder_particleSystem_mut(physx_PxGeometryHolder_Pod* self__pod) {
        physx::PxGeometryHolder* self_ = reinterpret_cast<physx::PxGeometryHolder*>(self__pod);
    ...
    physx_PxParticleSystemGeometry_Pod const* physx_PxGeometryHolder_particleSystem(physx_PxGeometryHolder_Pod const* self__pod) {
        physx::PxGeometryHolder const* self_ = reinterpret_cast<physx::PxGeometryHolder const*>(self__pod);
    ...
    physx_PxHairSystemGeometry_Pod* physx_PxGeometryHolder_hairSystem_mut(physx_PxGeometryHolder_Pod* self__pod) {
        physx::PxGeometryHolder* self_ = reinterpret_cast<physx::PxGeometryHolder*>(self__pod);
    ...
    physx_PxHairSystemGeometry_Pod const* physx_PxGeometryHolder_hairSystem(physx_PxGeometryHolder_Pod const* self__pod) {
        physx::PxGeometryHolder const* self_ = reinterpret_cast<physx::PxGeometryHolder const*>(self__pod);
    ...
    physx_PxCustomGeometry_Pod* physx_PxGeometryHolder_custom_mut(physx_PxGeometryHolder_Pod* self__pod) {
        physx::PxGeometryHolder* self_ = reinterpret_cast<physx::PxGeometryHolder*>(self__pod);
    ...
    physx_PxCustomGeometry_Pod const* physx_PxGeometryHolder_custom(physx_PxGeometryHolder_Pod const* self__pod) {
        physx::PxGeometryHolder const* self_ = reinterpret_cast<physx::PxGeometryHolder const*>(self__pod);
    ...
    void physx_PxGeometryHolder_storeAny_mut(physx_PxGeometryHolder_Pod* self__pod, physx_PxGeometry_Pod const* geometry_pod) {
        physx::PxGeometryHolder* self_ = reinterpret_cast<physx::PxGeometryHolder*>(self__pod);
        physx::PxGeometry const& geometry = reinterpret_cast<physx::PxGeometry const&>(*geometry_pod);
        self_->storeAny(geometry);
    }

    physx_PxGeometryHolder_Pod physx_PxGeometryHolder_new() {
    ...
    physx_PxGeometryHolder_Pod physx_PxGeometryHolder_new_1(physx_PxGeometry_Pod const* geometry_pod) {
        physx::PxGeometry const& geometry = reinterpret_cast<physx::PxGeometry const&>(*geometry_pod);
    ...
    uint32_t physx_PxGeometryQuery_raycast(physx_PxVec3_Pod const* origin_pod, physx_PxVec3_Pod const* unitDir_pod, physx_PxGeometry_Pod const* geom_pod, physx_PxTransform_Pod const* pose_pod, float maxDist, uint16_t hitFlags_pod, uint32_t maxHits, physx_PxGeomRaycastHit_Pod* rayHits_pod, uint32_t stride, uint32_t queryFlags_pod, physx_PxQueryThreadContext_Pod* threadContext_pod) {
        physx::PxVec3 const& origin = reinterpret_cast<physx::PxVec3 const&>(*origin_pod);
        physx::PxVec3 const& unitDir = reinterpret_cast<physx::PxVec3 const&>(*unitDir_pod);
        physx::PxGeometry const& geom = reinterpret_cast<physx::PxGeometry const&>(*geom_pod);
        physx::PxTransform const& pose = reinterpret_cast<physx::PxTransform const&>(*pose_pod);
    ...
    bool physx_PxGeometryQuery_overlap(physx_PxGeometry_Pod const* geom0_pod, physx_PxTransform_Pod const* pose0_pod, physx_PxGeometry_Pod const* geom1_pod, physx_PxTransform_Pod const* pose1_pod, uint32_t queryFlags_pod, physx_PxQueryThreadContext_Pod* threadContext_pod) {
        physx::PxGeometry const& geom0 = reinterpret_cast<physx::PxGeometry const&>(*geom0_pod);
        physx::PxTransform const& pose0 = reinterpret_cast<physx::PxTransform const&>(*pose0_pod);
        physx::PxGeometry const& geom1 = reinterpret_cast<physx::PxGeometry const&>(*geom1_pod);
        physx::PxTransform const& pose1 = reinterpret_cast<physx::PxTransform const&>(*pose1_pod);
    ...
    bool physx_PxGeometryQuery_sweep(physx_PxVec3_Pod const* unitDir_pod, float maxDist, physx_PxGeometry_Pod const* geom0_pod, physx_PxTransform_Pod const* pose0_pod, physx_PxGeometry_Pod const* geom1_pod, physx_PxTransform_Pod const* pose1_pod, physx_PxGeomSweepHit_Pod* sweepHit_pod, uint16_t hitFlags_pod, float inflation, uint32_t queryFlags_pod, physx_PxQueryThreadContext_Pod* threadContext_pod) {
        physx::PxVec3 const& unitDir = reinterpret_cast<physx::PxVec3 const&>(*unitDir_pod);
        physx::PxGeometry const& geom0 = reinterpret_cast<physx::PxGeometry const&>(*geom0_pod);
        physx::PxTransform const& pose0 = reinterpret_cast<physx::PxTransform const&>(*pose0_pod);
        physx::PxGeometry const& geom1 = reinterpret_cast<physx::PxGeometry const&>(*geom1_pod);
    ...
    bool physx_PxGeometryQuery_computePenetration(physx_PxVec3_Pod* direction_pod, float* depth_pod, physx_PxGeometry_Pod const* geom0_pod, physx_PxTransform_Pod const* pose0_pod, physx_PxGeometry_Pod const* geom1_pod, physx_PxTransform_Pod const* pose1_pod, uint32_t queryFlags_pod) {
    ...
    float physx_PxGeometryQuery_pointDistance(physx_PxVec3_Pod const* point_pod, physx_PxGeometry_Pod const* geom_pod, physx_PxTransform_Pod const* pose_pod, physx_PxVec3_Pod* closestPoint_pod, uint32_t* closestIndex, uint32_t queryFlags_pod) {
        physx::PxVec3 const& point = reinterpret_cast<physx::PxVec3 const&>(*point_pod);
        physx::PxGeometry const& geom = reinterpret_cast<physx::PxGeometry const&>(*geom_pod);
        physx::PxTransform const& pose = reinterpret_cast<physx::PxTransform const&>(*pose_pod);
    ...
    void physx_PxGeometryQuery_computeGeomBounds(physx_PxBounds3_Pod* bounds_pod, physx_PxGeometry_Pod const* geom_pod, physx_PxTransform_Pod const* pose_pod, float offset, float inflation, uint32_t queryFlags_pod) {
    ...
    bool physx_PxGeometryQuery_isValid(physx_PxGeometry_Pod const* geom_pod) {
        physx::PxGeometry const& geom = reinterpret_cast<physx::PxGeometry const&>(*geom_pod);
        bool return_val = PxGeometryQuery::isValid(geom);
        return return_val;
    }

    uint8_t physx_PxHeightFieldSample_tessFlag(physx_PxHeightFieldSample_Pod const* self__pod) {
    ...
    void physx_PxHeightFieldSample_setTessFlag_mut(physx_PxHeightFieldSample_Pod* self__pod) {
        physx::PxHeightFieldSample* self_ = reinterpret_cast<physx::PxHeightFieldSample*>(self__pod);
        self_->setTessFlag();
    }

    void physx_PxHeightFieldSample_clearTessFlag_mut(physx_PxHeightFieldSample_Pod* self__pod) {
        physx::PxHeightFieldSample* self_ = reinterpret_cast<physx::PxHeightFieldSample*>(self__pod);
        self_->clearTessFlag();
    }

    void physx_PxHeightField_release_mut(physx_PxHeightField_Pod* self__pod) {
        physx::PxHeightField* self_ = reinterpret_cast<physx::PxHeightField*>(self__pod);
        self_->release();
    }

    uint32_t physx_PxHeightField_saveCells(physx_PxHeightField_Pod const* self__pod, void* destBuffer, uint32_t destBufferSize) {
    ...
    bool physx_PxHeightField_modifySamples_mut(physx_PxHeightField_Pod* self__pod, int32_t startCol, int32_t startRow, physx_PxHeightFieldDesc_Pod const* subfieldDesc_pod, bool shrinkBounds) {
        physx::PxHeightField* self_ = reinterpret_cast<physx::PxHeightField*>(self__pod);
    ...
    uint32_t physx_PxHeightField_getNbRows(physx_PxHeightField_Pod const* self__pod) {
        physx::PxHeightField const* self_ = reinterpret_cast<physx::PxHeightField const*>(self__pod);
        uint32_t return_val = self_->getNbRows();
        return return_val;
    }

    uint32_t physx_PxHeightField_getNbColumns(physx_PxHeightField_Pod const* self__pod) {
        physx::PxHeightField const* self_ = reinterpret_cast<physx::PxHeightField const*>(self__pod);
        uint32_t return_val = self_->getNbColumns();
        return return_val;
    }

    int32_t physx_PxHeightField_getFormat(physx_PxHeightField_Pod const* self__pod) {
        physx::PxHeightField const* self_ = reinterpret_cast<physx::PxHeightField const*>(self__pod);
    ...
    uint32_t physx_PxHeightField_getSampleStride(physx_PxHeightField_Pod const* self__pod) {
        physx::PxHeightField const* self_ = reinterpret_cast<physx::PxHeightField const*>(self__pod);
        uint32_t return_val = self_->getSampleStride();
        return return_val;
    }

    float physx_PxHeightField_getConvexEdgeThreshold(physx_PxHeightField_Pod const* self__pod) {
        physx::PxHeightField const* self_ = reinterpret_cast<physx::PxHeightField const*>(self__pod);
        float return_val = self_->getConvexEdgeThreshold();
        return return_val;
    }

    uint16_t physx_PxHeightField_getFlags(physx_PxHeightField_Pod const* self__pod) {
        physx::PxHeightField const* self_ = reinterpret_cast<physx::PxHeightField const*>(self__pod);
    ...
    float physx_PxHeightField_getHeight(physx_PxHeightField_Pod const* self__pod, float x, float z) {
        physx::PxHeightField const* self_ = reinterpret_cast<physx::PxHeightField const*>(self__pod);
        float return_val = self_->getHeight(x, z);
        return return_val;
    }

    uint16_t physx_PxHeightField_getTriangleMaterialIndex(physx_PxHeightField_Pod const* self__pod, uint32_t triangleIndex) {
        physx::PxHeightField const* self_ = reinterpret_cast<physx::PxHeightField const*>(self__pod);
        uint16_t return_val = self_->getTriangleMaterialIndex(triangleIndex);
        return return_val;
    }

    physx_PxVec3_Pod physx_PxHeightField_getTriangleNormal(physx_PxHeightField_Pod const* self__pod, uint32_t triangleIndex) {
        physx::PxHeightField const* self_ = reinterpret_cast<physx::PxHeightField const*>(self__pod);
    ...
    physx_PxHeightFieldSample_Pod const* physx_PxHeightField_getSample(physx_PxHeightField_Pod const* self__pod, uint32_t row, uint32_t column) {
        physx::PxHeightField const* self_ = reinterpret_cast<physx::PxHeightField const*>(self__pod);
    ...
    uint32_t physx_PxHeightField_getTimestamp(physx_PxHeightField_Pod const* self__pod) {
        physx::PxHeightField const* self_ = reinterpret_cast<physx::PxHeightField const*>(self__pod);
        uint32_t return_val = self_->getTimestamp();
        return return_val;
    }

    char const* physx_PxHeightField_getConcreteTypeName(physx_PxHeightField_Pod const* self__pod) {
        physx::PxHeightField const* self_ = reinterpret_cast<physx::PxHeightField const*>(self__pod);
        char const* return_val = self_->getConcreteTypeName();
        return return_val;
    }

    physx_PxHeightFieldDesc_Pod physx_PxHeightFieldDesc_new() {
    ...
    void physx_PxHeightFieldDesc_setToDefault_mut(physx_PxHeightFieldDesc_Pod* self__pod) {
        physx::PxHeightFieldDesc* self_ = reinterpret_cast<physx::PxHeightFieldDesc*>(self__pod);
        self_->setToDefault();
    }

    bool physx_PxHeightFieldDesc_isValid(physx_PxHeightFieldDesc_Pod const* self__pod) {
        physx::PxHeightFieldDesc const* self_ = reinterpret_cast<physx::PxHeightFieldDesc const*>(self__pod);
        bool return_val = self_->isValid();
        return return_val;
    }

    void physx_PxMeshQuery_getTriangle(physx_PxTriangleMeshGeometry_Pod const* triGeom_pod, physx_PxTransform_Pod const* transform_pod, uint32_t triangleIndex, physx_PxTriangle_Pod* triangle_pod, uint32_t* vertexIndices, uint32_t* adjacencyIndices) {
    ...
    void physx_PxMeshQuery_getTriangle_1(physx_PxHeightFieldGeometry_Pod const* hfGeom_pod, physx_PxTransform_Pod const* transform_pod, uint32_t triangleIndex, physx_PxTriangle_Pod* triangle_pod, uint32_t* vertexIndices, uint32_t* adjacencyIndices) {
    ...
    uint32_t physx_PxMeshQuery_findOverlapHeightField(physx_PxGeometry_Pod const* geom_pod, physx_PxTransform_Pod const* geomPose_pod, physx_PxHeightFieldGeometry_Pod const* hfGeom_pod, physx_PxTransform_Pod const* hfPose_pod, uint32_t* results, uint32_t maxResults, uint32_t startIndex, bool* overflow_pod, uint32_t queryFlags_pod) {
        physx::PxGeometry const& geom = reinterpret_cast<physx::PxGeometry const&>(*geom_pod);
        physx::PxTransform const& geomPose = reinterpret_cast<physx::PxTransform const&>(*geomPose_pod);
        physx::PxHeightFieldGeometry const& hfGeom = reinterpret_cast<physx::PxHeightFieldGeometry const&>(*hfGeom_pod);
    ...
    bool physx_PxMeshQuery_sweep(physx_PxVec3_Pod const* unitDir_pod, float distance, physx_PxGeometry_Pod const* geom_pod, physx_PxTransform_Pod const* pose_pod, uint32_t triangleCount, physx_PxTriangle_Pod const* triangles_pod, physx_PxGeomSweepHit_Pod* sweepHit_pod, uint16_t hitFlags_pod, uint32_t const* cachedIndex, float inflation, bool doubleSided, uint32_t queryFlags_pod) {
        physx::PxVec3 const& unitDir = reinterpret_cast<physx::PxVec3 const&>(*unitDir_pod);
        physx::PxGeometry const& geom = reinterpret_cast<physx::PxGeometry const&>(*geom_pod);
        physx::PxTransform const& pose = reinterpret_cast<physx::PxTransform const&>(*pose_pod);
    ...
    physx_PxSimpleTriangleMesh_Pod physx_PxSimpleTriangleMesh_new() {
    ...
    void physx_PxSimpleTriangleMesh_setToDefault_mut(physx_PxSimpleTriangleMesh_Pod* self__pod) {
        physx::PxSimpleTriangleMesh* self_ = reinterpret_cast<physx::PxSimpleTriangleMesh*>(self__pod);
        self_->setToDefault();
    }

    bool physx_PxSimpleTriangleMesh_isValid(physx_PxSimpleTriangleMesh_Pod const* self__pod) {
        physx::PxSimpleTriangleMesh const* self_ = reinterpret_cast<physx::PxSimpleTriangleMesh const*>(self__pod);
        bool return_val = self_->isValid();
        return return_val;
    }

    physx_PxTriangle_Pod* physx_PxTriangle_new_alloc() {
        auto return_val = new physx::PxTriangle();
        auto return_val_pod = reinterpret_cast<physx_PxTriangle_Pod*>(return_val);
        return return_val_pod;
    }

    physx_PxTriangle_Pod* physx_PxTriangle_new_alloc_1(physx_PxVec3_Pod const* p0_pod, physx_PxVec3_Pod const* p1_pod, physx_PxVec3_Pod const* p2_pod) {
        physx::PxVec3 const& p0 = reinterpret_cast<physx::PxVec3 const&>(*p0_pod);
        physx::PxVec3 const& p1 = reinterpret_cast<physx::PxVec3 const&>(*p1_pod);
        physx::PxVec3 const& p2 = reinterpret_cast<physx::PxVec3 const&>(*p2_pod);
    ...
    void physx_PxTriangle_delete(physx_PxTriangle_Pod* self__pod) {
        physx::PxTriangle* self_ = reinterpret_cast<physx::PxTriangle*>(self__pod);
        delete self_;
    }

    void physx_PxTriangle_normal(physx_PxTriangle_Pod const* self__pod, physx_PxVec3_Pod* _normal_pod) {
    ...
    void physx_PxTriangle_denormalizedNormal(physx_PxTriangle_Pod const* self__pod, physx_PxVec3_Pod* _normal_pod) {
        physx::PxTriangle const* self_ = reinterpret_cast<physx::PxTriangle const*>(self__pod);
        physx::PxVec3& _normal = reinterpret_cast<physx::PxVec3&>(*_normal_pod);
        self_->denormalizedNormal(_normal);
    }

    float physx_PxTriangle_area(physx_PxTriangle_Pod const* self__pod) {
        physx::PxTriangle const* self_ = reinterpret_cast<physx::PxTriangle const*>(self__pod);
        float return_val = self_->area();
        return return_val;
    }

    physx_PxVec3_Pod physx_PxTriangle_pointFromUV(physx_PxTriangle_Pod const* self__pod, float u, float v) {
        physx::PxTriangle const* self_ = reinterpret_cast<physx::PxTriangle const*>(self__pod);
    ...
    physx_PxTrianglePadded_Pod* physx_PxTrianglePadded_new_alloc() {
        auto return_val = new physx::PxTrianglePadded();
        auto return_val_pod = reinterpret_cast<physx_PxTrianglePadded_Pod*>(return_val);
        return return_val_pod;
    }

    void physx_PxTrianglePadded_delete(physx_PxTrianglePadded_Pod* self__pod) {
        physx::PxTrianglePadded* self_ = reinterpret_cast<physx::PxTrianglePadded*>(self__pod);
        delete self_;
    }

    uint32_t physx_PxTriangleMesh_getNbVertices(physx_PxTriangleMesh_Pod const* self__pod) {
        physx::PxTriangleMesh const* self_ = reinterpret_cast<physx::PxTriangleMesh const*>(self__pod);
        uint32_t return_val = self_->getNbVertices();
        return return_val;
    }

    physx_PxVec3_Pod const* physx_PxTriangleMesh_getVertices(physx_PxTriangleMesh_Pod const* self__pod) {
        physx::PxTriangleMesh const* self_ = reinterpret_cast<physx::PxTriangleMesh const*>(self__pod);
        physx::PxVec3 const* return_val = self_->getVertices();
        auto return_val_pod = reinterpret_cast<physx_PxVec3_Pod const*>(return_val);
        return return_val_pod;
    ...
    physx_PxVec3_Pod* physx_PxTriangleMesh_getVerticesForModification_mut(physx_PxTriangleMesh_Pod* self__pod) {
    ...
    physx_PxBounds3_Pod physx_PxTriangleMesh_refitBVH_mut(physx_PxTriangleMesh_Pod* self__pod) {
        physx::PxTriangleMesh* self_ = reinterpret_cast<physx::PxTriangleMesh*>(self__pod);
    ...
    uint32_t physx_PxTriangleMesh_getNbTriangles(physx_PxTriangleMesh_Pod const* self__pod) {
        physx::PxTriangleMesh const* self_ = reinterpret_cast<physx::PxTriangleMesh const*>(self__pod);
        uint32_t return_val = self_->getNbTriangles();
        return return_val;
    }

    void const* physx_PxTriangleMesh_getTriangles(physx_PxTriangleMesh_Pod const* self__pod) {
        physx::PxTriangleMesh const* self_ = reinterpret_cast<physx::PxTriangleMesh const*>(self__pod);
        void const* return_val = self_->getTriangles();
        return return_val;
    }

    uint8_t physx_PxTriangleMesh_getTriangleMeshFlags(physx_PxTriangleMesh_Pod const* self__pod) {
        physx::PxTriangleMesh const* self_ = reinterpret_cast<physx::PxTriangleMesh const*>(self__pod);
    ...
    uint32_t const* physx_PxTriangleMesh_getTrianglesRemap(physx_PxTriangleMesh_Pod const* self__pod) {
        physx::PxTriangleMesh const* self_ = reinterpret_cast<physx::PxTriangleMesh const*>(self__pod);
        uint32_t const* return_val = self_->getTrianglesRemap();
        return return_val;
    }

    void physx_PxTriangleMesh_release_mut(physx_PxTriangleMesh_Pod* self__pod) {
        physx::PxTriangleMesh* self_ = reinterpret_cast<physx::PxTriangleMesh*>(self__pod);
        self_->release();
    }

    uint16_t physx_PxTriangleMesh_getTriangleMaterialIndex(physx_PxTriangleMesh_Pod const* self__pod, uint32_t triangleIndex) {
        physx::PxTriangleMesh const* self_ = reinterpret_cast<physx::PxTriangleMesh const*>(self__pod);
        uint16_t return_val = self_->getTriangleMaterialIndex(triangleIndex);
        return return_val;
    }

    physx_PxBounds3_Pod physx_PxTriangleMesh_getLocalBounds(physx_PxTriangleMesh_Pod const* self__pod) {
        physx::PxTriangleMesh const* self_ = reinterpret_cast<physx::PxTriangleMesh const*>(self__pod);
        physx::PxBounds3 return_val = self_->getLocalBounds();
        physx_PxBounds3_Pod return_val_pod;
        memcpy(&return_val_pod, &return_val, sizeof(return_val_pod));
    ...
    float const* physx_PxTriangleMesh_getSDF(physx_PxTriangleMesh_Pod const* self__pod) {
        physx::PxTriangleMesh const* self_ = reinterpret_cast<physx::PxTriangleMesh const*>(self__pod);
        float const* return_val = self_->getSDF();
        return return_val;
    }

    void physx_PxTriangleMesh_getSDFDimensions(physx_PxTriangleMesh_Pod const* self__pod, uint32_t* numX_pod, uint32_t* numY_pod, uint32_t* numZ_pod) {
        physx::PxTriangleMesh const* self_ = reinterpret_cast<physx::PxTriangleMesh const*>(self__pod);
    ...
    void physx_PxTriangleMesh_setPreferSDFProjection_mut(physx_PxTriangleMesh_Pod* self__pod, bool preferProjection) {
        physx::PxTriangleMesh* self_ = reinterpret_cast<physx::PxTriangleMesh*>(self__pod);
        self_->setPreferSDFProjection(preferProjection);
    }

    bool physx_PxTriangleMesh_getPreferSDFProjection(physx_PxTriangleMesh_Pod const* self__pod) {
        physx::PxTriangleMesh const* self_ = reinterpret_cast<physx::PxTriangleMesh const*>(self__pod);
        bool return_val = self_->getPreferSDFProjection();
        return return_val;
    }

    void physx_PxTriangleMesh_getMassInformation(physx_PxTriangleMesh_Pod const* self__pod, float* mass_pod, physx_PxMat33_Pod* localInertia_pod, physx_PxVec3_Pod* localCenterOfMass_pod) {
        physx::PxTriangleMesh const* self_ = reinterpret_cast<physx::PxTriangleMesh const*>(self__pod);
        float& mass = *mass_pod;
        physx::PxMat33& localInertia = reinterpret_cast<physx::PxMat33&>(*localInertia_pod);
        physx::PxVec3& localCenterOfMass = reinterpret_cast<physx::PxVec3&>(*localCenterOfMass_pod);
    ...
    physx_PxTetrahedron_Pod* physx_PxTetrahedron_new_alloc() {
        auto return_val = new physx::PxTetrahedron();
        auto return_val_pod = reinterpret_cast<physx_PxTetrahedron_Pod*>(return_val);
        return return_val_pod;
    }

    physx_PxTetrahedron_Pod* physx_PxTetrahedron_new_alloc_1(physx_PxVec3_Pod const* p0_pod, physx_PxVec3_Pod const* p1_pod, physx_PxVec3_Pod const* p2_pod, physx_PxVec3_Pod const* p3_pod) {
        physx::PxVec3 const& p0 = reinterpret_cast<physx::PxVec3 const&>(*p0_pod);
        physx::PxVec3 const& p1 = reinterpret_cast<physx::PxVec3 const&>(*p1_pod);
        physx::PxVec3 const& p2 = reinterpret_cast<physx::PxVec3 const&>(*p2_pod);
    ...
    void physx_PxTetrahedron_delete(physx_PxTetrahedron_Pod* self__pod) {
        physx::PxTetrahedron* self_ = reinterpret_cast<physx::PxTetrahedron*>(self__pod);
        delete self_;
    }

    void physx_PxSoftBodyAuxData_release_mut(physx_PxSoftBodyAuxData_Pod* self__pod) {
        physx::PxSoftBodyAuxData* self_ = reinterpret_cast<physx::PxSoftBodyAuxData*>(self__pod);
        self_->release();
    }

    uint32_t physx_PxTetrahedronMesh_getNbVertices(physx_PxTetrahedronMesh_Pod const* self__pod) {
        physx::PxTetrahedronMesh const* self_ = reinterpret_cast<physx::PxTetrahedronMesh const*>(self__pod);
        uint32_t return_val = self_->getNbVertices();
        return return_val;
    }

    physx_PxVec3_Pod const* physx_PxTetrahedronMesh_getVertices(physx_PxTetrahedronMesh_Pod const* self__pod) {
        physx::PxTetrahedronMesh const* self_ = reinterpret_cast<physx::PxTetrahedronMesh const*>(self__pod);
        physx::PxVec3 const* return_val = self_->getVertices();
        auto return_val_pod = reinterpret_cast<physx_PxVec3_Pod const*>(return_val);
        return return_val_pod;
    ...
    uint32_t physx_PxTetrahedronMesh_getNbTetrahedrons(physx_PxTetrahedronMesh_Pod const* self__pod) {
        physx::PxTetrahedronMesh const* self_ = reinterpret_cast<physx::PxTetrahedronMesh const*>(self__pod);
        uint32_t return_val = self_->getNbTetrahedrons();
        return return_val;
    }

    void const* physx_PxTetrahedronMesh_getTetrahedrons(physx_PxTetrahedronMesh_Pod const* self__pod) {
        physx::PxTetrahedronMesh const* self_ = reinterpret_cast<physx::PxTetrahedronMesh const*>(self__pod);
        void const* return_val = self_->getTetrahedrons();
        return return_val;
    }

    uint8_t physx_PxTetrahedronMesh_getTetrahedronMeshFlags(physx_PxTetrahedronMesh_Pod const* self__pod) {
        physx::PxTetrahedronMesh const* self_ = reinterpret_cast<physx::PxTetrahedronMesh const*>(self__pod);
    ...
    uint32_t const* physx_PxTetrahedronMesh_getTetrahedraRemap(physx_PxTetrahedronMesh_Pod const* self__pod) {
        physx::PxTetrahedronMesh const* self_ = reinterpret_cast<physx::PxTetrahedronMesh const*>(self__pod);
        uint32_t const* return_val = self_->getTetrahedraRemap();
        return return_val;
    }

    physx_PxBounds3_Pod physx_PxTetrahedronMesh_getLocalBounds(physx_PxTetrahedronMesh_Pod const* self__pod) {
        physx::PxTetrahedronMesh const* self_ = reinterpret_cast<physx::PxTetrahedronMesh const*>(self__pod);
        physx::PxBounds3 return_val = self_->getLocalBounds();
        physx_PxBounds3_Pod return_val_pod;
        memcpy(&return_val_pod, &return_val, sizeof(return_val_pod));
    ...
    void physx_PxTetrahedronMesh_release_mut(physx_PxTetrahedronMesh_Pod* self__pod) {
        physx::PxTetrahedronMesh* self_ = reinterpret_cast<physx::PxTetrahedronMesh*>(self__pod);
        self_->release();
    }

    physx_PxTetrahedronMesh_Pod const* physx_PxSoftBodyMesh_getCollisionMesh(physx_PxSoftBodyMesh_Pod const* self__pod) {
    ...
    physx_PxTetrahedronMesh_Pod* physx_PxSoftBodyMesh_getCollisionMesh_mut(physx_PxSoftBodyMesh_Pod* self__pod) {
    ...
    physx_PxTetrahedronMesh_Pod const* physx_PxSoftBodyMesh_getSimulationMesh(physx_PxSoftBodyMesh_Pod const* self__pod) {
        physx::PxSoftBodyMesh const* self_ = reinterpret_cast<physx::PxSoftBodyMesh const*>(self__pod);
    ...
    physx_PxTetrahedronMesh_Pod* physx_PxSoftBodyMesh_getSimulationMesh_mut(physx_PxSoftBodyMesh_Pod* self__pod) {
        physx::PxSoftBodyMesh* self_ = reinterpret_cast<physx::PxSoftBodyMesh*>(self__pod);
    ...
    physx_PxSoftBodyAuxData_Pod const* physx_PxSoftBodyMesh_getSoftBodyAuxData(physx_PxSoftBodyMesh_Pod const* self__pod) {
        physx::PxSoftBodyMesh const* self_ = reinterpret_cast<physx::PxSoftBodyMesh const*>(self__pod);
    ...
    physx_PxSoftBodyAuxData_Pod* physx_PxSoftBodyMesh_getSoftBodyAuxData_mut(physx_PxSoftBodyMesh_Pod* self__pod) {
        physx::PxSoftBodyMesh* self_ = reinterpret_cast<physx::PxSoftBodyMesh*>(self__pod);
    ...
    void physx_PxSoftBodyMesh_release_mut(physx_PxSoftBodyMesh_Pod* self__pod) {
        physx::PxSoftBodyMesh* self_ = reinterpret_cast<physx::PxSoftBodyMesh*>(self__pod);
        self_->release();
    }

    void physx_PxCollisionMeshMappingData_release_mut(physx_PxCollisionMeshMappingData_Pod* self__pod) {
        physx::PxCollisionMeshMappingData* self_ = reinterpret_cast<physx::PxCollisionMeshMappingData*>(self__pod);
        self_->release();
    }

    physx_PxTetrahedronMeshData_Pod const* physx_PxCollisionTetrahedronMeshData_getMesh(physx_PxCollisionTetrahedronMeshData_Pod const* self__pod) {
    ...
    physx_PxTetrahedronMeshData_Pod* physx_PxCollisionTetrahedronMeshData_getMesh_mut(physx_PxCollisionTetrahedronMeshData_Pod* self__pod) {
    ...
    physx_PxSoftBodyCollisionData_Pod const* physx_PxCollisionTetrahedronMeshData_getData(physx_PxCollisionTetrahedronMeshData_Pod const* self__pod) {
        physx::PxCollisionTetrahedronMeshData const* self_ = reinterpret_cast<physx::PxCollisionTetrahedronMeshData const*>(self__pod);
    ...
    physx_PxSoftBodyCollisionData_Pod* physx_PxCollisionTetrahedronMeshData_getData_mut(physx_PxCollisionTetrahedronMeshData_Pod* self__pod) {
        physx::PxCollisionTetrahedronMeshData* self_ = reinterpret_cast<physx::PxCollisionTetrahedronMeshData*>(self__pod);
    ...
    void physx_PxCollisionTetrahedronMeshData_release_mut(physx_PxCollisionTetrahedronMeshData_Pod* self__pod) {
        physx::PxCollisionTetrahedronMeshData* self_ = reinterpret_cast<physx::PxCollisionTetrahedronMeshData*>(self__pod);
        self_->release();
    }

    physx_PxTetrahedronMeshData_Pod* physx_PxSimulationTetrahedronMeshData_getMesh_mut(physx_PxSimulationTetrahedronMeshData_Pod* self__pod) {
    ...
    physx_PxSoftBodySimulationData_Pod* physx_PxSimulationTetrahedronMeshData_getData_mut(physx_PxSimulationTetrahedronMeshData_Pod* self__pod) {
        physx::PxSimulationTetrahedronMeshData* self_ = reinterpret_cast<physx::PxSimulationTetrahedronMeshData*>(self__pod);
    ...
    void physx_PxSimulationTetrahedronMeshData_release_mut(physx_PxSimulationTetrahedronMeshData_Pod* self__pod) {
        physx::PxSimulationTetrahedronMeshData* self_ = reinterpret_cast<physx::PxSimulationTetrahedronMeshData*>(self__pod);
        self_->release();
    }

    void physx_PxActor_release_mut(physx_PxActor_Pod* self__pod) {
        physx::PxActor* self_ = reinterpret_cast<physx::PxActor*>(self__pod);
        self_->release();
    }

    int32_t physx_PxActor_getType(physx_PxActor_Pod const* self__pod) {
    ...
    physx_PxScene_Pod* physx_PxActor_getScene(physx_PxActor_Pod const* self__pod) {
        physx::PxActor const* self_ = reinterpret_cast<physx::PxActor const*>(self__pod);
    ...
    void physx_PxActor_setName_mut(physx_PxActor_Pod* self__pod, char const* name) {
        physx::PxActor* self_ = reinterpret_cast<physx::PxActor*>(self__pod);
        self_->setName(name);
    }

    char const* physx_PxActor_getName(physx_PxActor_Pod const* self__pod) {
        physx::PxActor const* self_ = reinterpret_cast<physx::PxActor const*>(self__pod);
        char const* return_val = self_->getName();
        return return_val;
    }

    physx_PxBounds3_Pod physx_PxActor_getWorldBounds(physx_PxActor_Pod const* self__pod, float inflation) {
        physx::PxActor const* self_ = reinterpret_cast<physx::PxActor const*>(self__pod);
    ...
    void physx_PxActor_setActorFlag_mut(physx_PxActor_Pod* self__pod, int32_t flag_pod, bool value) {
        physx::PxActor* self_ = reinterpret_cast<physx::PxActor*>(self__pod);
        auto flag = static_cast<physx::PxActorFlag::Enum>(flag_pod);
        self_->setActorFlag(flag, value);
    }

    void physx_PxActor_setActorFlags_mut(physx_PxActor_Pod* self__pod, uint8_t inFlags_pod) {
        physx::PxActor* self_ = reinterpret_cast<physx::PxActor*>(self__pod);
        auto inFlags = physx::PxActorFlags(inFlags_pod);
        self_->setActorFlags(inFlags);
    }

    uint8_t physx_PxActor_getActorFlags(physx_PxActor_Pod const* self__pod) {
        physx::PxActor const* self_ = reinterpret_cast<physx::PxActor const*>(self__pod);
    ...
    void physx_PxActor_setDominanceGroup_mut(physx_PxActor_Pod* self__pod, uint8_t dominanceGroup) {
        physx::PxActor* self_ = reinterpret_cast<physx::PxActor*>(self__pod);
        self_->setDominanceGroup(dominanceGroup);
    }

    uint8_t physx_PxActor_getDominanceGroup(physx_PxActor_Pod const* self__pod) {
        physx::PxActor const* self_ = reinterpret_cast<physx::PxActor const*>(self__pod);
        uint8_t return_val = self_->getDominanceGroup();
        return return_val;
    }

    void physx_PxActor_setOwnerClient_mut(physx_PxActor_Pod* self__pod, uint8_t inClient) {
        physx::PxActor* self_ = reinterpret_cast<physx::PxActor*>(self__pod);
        self_->setOwnerClient(inClient);
    }

    uint8_t physx_PxActor_getOwnerClient(physx_PxActor_Pod const* self__pod) {
        physx::PxActor const* self_ = reinterpret_cast<physx::PxActor const*>(self__pod);
        uint8_t return_val = self_->getOwnerClient();
        return return_val;
    }

    physx_PxAggregate_Pod* physx_PxActor_getAggregate(physx_PxActor_Pod const* self__pod) {
        physx::PxActor const* self_ = reinterpret_cast<physx::PxActor const*>(self__pod);
    ...
    uint32_t physx_phys_PxGetAggregateFilterHint(int32_t type_pod, bool enableSelfCollision) {
    ...
    void physx_PxAggregate_release_mut(physx_PxAggregate_Pod* self__pod) {
        physx::PxAggregate* self_ = reinterpret_cast<physx::PxAggregate*>(self__pod);
        self_->release();
    }

    bool physx_PxAggregate_addActor_mut(physx_PxAggregate_Pod* self__pod, physx_PxActor_Pod* actor_pod, physx_PxBVH_Pod const* bvh_pod) {
        physx::PxAggregate* self_ = reinterpret_cast<physx::PxAggregate*>(self__pod);
    ...
    bool physx_PxAggregate_removeActor_mut(physx_PxAggregate_Pod* self__pod, physx_PxActor_Pod* actor_pod) {
        physx::PxAggregate* self_ = reinterpret_cast<physx::PxAggregate*>(self__pod);
        physx::PxActor& actor = reinterpret_cast<physx::PxActor&>(*actor_pod);
    ...
    bool physx_PxAggregate_addArticulation_mut(physx_PxAggregate_Pod* self__pod, physx_PxArticulationReducedCoordinate_Pod* articulation_pod) {
        physx::PxAggregate* self_ = reinterpret_cast<physx::PxAggregate*>(self__pod);
    ...
    bool physx_PxAggregate_removeArticulation_mut(physx_PxAggregate_Pod* self__pod, physx_PxArticulationReducedCoordinate_Pod* articulation_pod) {
        physx::PxAggregate* self_ = reinterpret_cast<physx::PxAggregate*>(self__pod);
        physx::PxArticulationReducedCoordinate& articulation = reinterpret_cast<physx::PxArticulationReducedCoordinate&>(*articulation_pod);
    ...
    uint32_t physx_PxAggregate_getNbActors(physx_PxAggregate_Pod const* self__pod) {
        physx::PxAggregate const* self_ = reinterpret_cast<physx::PxAggregate const*>(self__pod);
        uint32_t return_val = self_->getNbActors();
        return return_val;
    }

    uint32_t physx_PxAggregate_getMaxNbShapes(physx_PxAggregate_Pod const* self__pod) {
        physx::PxAggregate const* self_ = reinterpret_cast<physx::PxAggregate const*>(self__pod);
        uint32_t return_val = self_->getMaxNbShapes();
        return return_val;
    }

    uint32_t physx_PxAggregate_getActors(physx_PxAggregate_Pod const* self__pod, physx_PxActor_Pod** userBuffer_pod, uint32_t bufferSize, uint32_t startIndex) {
        physx::PxAggregate const* self_ = reinterpret_cast<physx::PxAggregate const*>(self__pod);
    ...
    physx_PxScene_Pod* physx_PxAggregate_getScene_mut(physx_PxAggregate_Pod* self__pod) {
        physx::PxAggregate* self_ = reinterpret_cast<physx::PxAggregate*>(self__pod);
        physx::PxScene* return_val = self_->getScene();
        auto return_val_pod = reinterpret_cast<physx_PxScene_Pod*>(return_val);
        return return_val_pod;
    ...
    bool physx_PxAggregate_getSelfCollision(physx_PxAggregate_Pod const* self__pod) {
        physx::PxAggregate const* self_ = reinterpret_cast<physx::PxAggregate const*>(self__pod);
        bool return_val = self_->getSelfCollision();
        return return_val;
    }

    char const* physx_PxAggregate_getConcreteTypeName(physx_PxAggregate_Pod const* self__pod) {
        physx::PxAggregate const* self_ = reinterpret_cast<physx::PxAggregate const*>(self__pod);
        char const* return_val = self_->getConcreteTypeName();
        return return_val;
    }

    physx_PxConstraintInvMassScale_Pod physx_PxConstraintInvMassScale_new() {
    ...
    physx_PxConstraintInvMassScale_Pod physx_PxConstraintInvMassScale_new_1(float lin0, float ang0, float lin1, float ang1) {
    ...
    void physx_PxConstraintVisualizer_visualizeJointFrames_mut(physx_PxConstraintVisualizer_Pod* self__pod, physx_PxTransform_Pod const* parent_pod, physx_PxTransform_Pod const* child_pod) {
    ...
    void physx_PxConstraintVisualizer_visualizeLinearLimit_mut(physx_PxConstraintVisualizer_Pod* self__pod, physx_PxTransform_Pod const* t0_pod, physx_PxTransform_Pod const* t1_pod, float value, bool active) {
        physx::PxConstraintVisualizer* self_ = reinterpret_cast<physx::PxConstraintVisualizer*>(self__pod);
    ...
    void physx_PxConstraintVisualizer_visualizeAngularLimit_mut(physx_PxConstraintVisualizer_Pod* self__pod, physx_PxTransform_Pod const* t0_pod, float lower, float upper, bool active) {
        physx::PxConstraintVisualizer* self_ = reinterpret_cast<physx::PxConstraintVisualizer*>(self__pod);
        physx::PxTransform const& t0 = reinterpret_cast<physx::PxTransform const&>(*t0_pod);
        self_->visualizeAngularLimit(t0, lower, upper, active);
    }

    void physx_PxConstraintVisualizer_visualizeLimitCone_mut(physx_PxConstraintVisualizer_Pod* self__pod, physx_PxTransform_Pod const* t_pod, float tanQSwingY, float tanQSwingZ, bool active) {
        physx::PxConstraintVisualizer* self_ = reinterpret_cast<physx::PxConstraintVisualizer*>(self__pod);
        physx::PxTransform const& t = reinterpret_cast<physx::PxTransform const&>(*t_pod);
        self_->visualizeLimitCone(t, tanQSwingY, tanQSwingZ, active);
    }

    void physx_PxConstraintVisualizer_visualizeDoubleCone_mut(physx_PxConstraintVisualizer_Pod* self__pod, physx_PxTransform_Pod const* t_pod, float angle, bool active) {
        physx::PxConstraintVisualizer* self_ = reinterpret_cast<physx::PxConstraintVisualizer*>(self__pod);
        physx::PxTransform const& t = reinterpret_cast<physx::PxTransform const&>(*t_pod);
        self_->visualizeDoubleCone(t, angle, active);
    }

    void physx_PxConstraintVisualizer_visualizeLine_mut(physx_PxConstraintVisualizer_Pod* self__pod, physx_PxVec3_Pod const* p0_pod, physx_PxVec3_Pod const* p1_pod, uint32_t color) {
        physx::PxConstraintVisualizer* self_ = reinterpret_cast<physx::PxConstraintVisualizer*>(self__pod);
        physx::PxVec3 const& p0 = reinterpret_cast<physx::PxVec3 const&>(*p0_pod);
        physx::PxVec3 const& p1 = reinterpret_cast<physx::PxVec3 const&>(*p1_pod);
    ...
    void* physx_PxConstraintConnector_prepareData_mut(physx_PxConstraintConnector_Pod* self__pod) {
    ...
    void physx_PxConstraintConnector_onConstraintRelease_mut(physx_PxConstraintConnector_Pod* self__pod) {
        physx::PxConstraintConnector* self_ = reinterpret_cast<physx::PxConstraintConnector*>(self__pod);
        self_->onConstraintRelease();
    }

    void physx_PxConstraintConnector_onComShift_mut(physx_PxConstraintConnector_Pod* self__pod, uint32_t actor) {
        physx::PxConstraintConnector* self_ = reinterpret_cast<physx::PxConstraintConnector*>(self__pod);
        self_->onComShift(actor);
    }

    void physx_PxConstraintConnector_onOriginShift_mut(physx_PxConstraintConnector_Pod* self__pod, physx_PxVec3_Pod const* shift_pod) {
        physx::PxConstraintConnector* self_ = reinterpret_cast<physx::PxConstraintConnector*>(self__pod);
        physx::PxVec3 const& shift = reinterpret_cast<physx::PxVec3 const&>(*shift_pod);
        self_->onOriginShift(shift);
    }

    physx_PxBase_Pod* physx_PxConstraintConnector_getSerializable_mut(physx_PxConstraintConnector_Pod* self__pod) {
        physx::PxConstraintConnector* self_ = reinterpret_cast<physx::PxConstraintConnector*>(self__pod);
    ...
    void const* physx_PxConstraintConnector_getConstantBlock(physx_PxConstraintConnector_Pod const* self__pod) {
    ...
    void physx_PxConstraintConnector_connectToConstraint_mut(physx_PxConstraintConnector_Pod* self__pod, physx_PxConstraint_Pod* anon_param0_pod) {
        physx::PxConstraintConnector* self_ = reinterpret_cast<physx::PxConstraintConnector*>(self__pod);
        physx::PxConstraint* anon_param0 = reinterpret_cast<physx::PxConstraint*>(anon_param0_pod);
        self_->connectToConstraint(anon_param0);
    }

    void physx_PxConstraintConnector_delete(physx_PxConstraintConnector_Pod* self__pod) {
        physx::PxConstraintConnector* self_ = reinterpret_cast<physx::PxConstraintConnector*>(self__pod);
        delete self_;
    }

    physx_PxSolverBody_Pod physx_PxSolverBody_new() {
    ...
    float physx_PxSolverBodyData_projectVelocity(physx_PxSolverBodyData_Pod const* self__pod, physx_PxVec3_Pod const* lin_pod, physx_PxVec3_Pod const* ang_pod) {
    ...
    void physx_PxSolverConstraintPrepDesc_delete(physx_PxSolverConstraintPrepDesc_Pod* self__pod) {
        physx::PxSolverConstraintPrepDesc* self_ = reinterpret_cast<physx::PxSolverConstraintPrepDesc*>(self__pod);
        delete self_;
    }

    uint8_t* physx_PxConstraintAllocator_reserveConstraintData_mut(physx_PxConstraintAllocator_Pod* self__pod, uint32_t byteSize) {
    ...
    uint8_t* physx_PxConstraintAllocator_reserveFrictionData_mut(physx_PxConstraintAllocator_Pod* self__pod, uint32_t byteSize) {
        physx::PxConstraintAllocator* self_ = reinterpret_cast<physx::PxConstraintAllocator*>(self__pod);
        uint8_t* return_val = self_->reserveFrictionData(byteSize);
        return return_val;
    }

    void physx_PxConstraintAllocator_delete(physx_PxConstraintAllocator_Pod* self__pod) {
        physx::PxConstraintAllocator* self_ = reinterpret_cast<physx::PxConstraintAllocator*>(self__pod);
        delete self_;
    }

    physx_PxArticulationLimit_Pod physx_PxArticulationLimit_new() {
    ...
    physx_PxArticulationLimit_Pod physx_PxArticulationLimit_new_1(float low_, float high_) {
    ...
    physx_PxArticulationDrive_Pod physx_PxArticulationDrive_new() {
    ...
    physx_PxArticulationDrive_Pod physx_PxArticulationDrive_new_1(float stiffness_, float damping_, float maxForce_, int32_t driveType__pod) {
    ...
    float physx_PxTGSSolverBodyVel_projectVelocity(physx_PxTGSSolverBodyVel_Pod const* self__pod, physx_PxVec3_Pod const* lin_pod, physx_PxVec3_Pod const* ang_pod) {
    ...
    float physx_PxTGSSolverBodyData_projectVelocity(physx_PxTGSSolverBodyData_Pod const* self__pod, physx_PxVec3_Pod const* linear_pod, physx_PxVec3_Pod const* angular_pod) {
    ...
    void physx_PxTGSSolverConstraintPrepDesc_delete(physx_PxTGSSolverConstraintPrepDesc_Pod* self__pod) {
        physx::PxTGSSolverConstraintPrepDesc* self_ = reinterpret_cast<physx::PxTGSSolverConstraintPrepDesc*>(self__pod);
        delete self_;
    }

    void physx_PxArticulationAttachment_setRestLength_mut(physx_PxArticulationAttachment_Pod* self__pod, float restLength) {
    ...
    float physx_PxArticulationAttachment_getRestLength(physx_PxArticulationAttachment_Pod const* self__pod) {
    ...
    void physx_PxArticulationAttachment_setLimitParameters_mut(physx_PxArticulationAttachment_Pod* self__pod, physx_PxArticulationTendonLimit_Pod const* parameters_pod) {
        physx::PxArticulationAttachment* self_ = reinterpret_cast<physx::PxArticulationAttachment*>(self__pod);
    ...
    physx_PxArticulationTendonLimit_Pod physx_PxArticulationAttachment_getLimitParameters(physx_PxArticulationAttachment_Pod const* self__pod) {
        physx::PxArticulationAttachment const* self_ = reinterpret_cast<physx::PxArticulationAttachment const*>(self__pod);
    ...
    void physx_PxArticulationAttachment_setRelativeOffset_mut(physx_PxArticulationAttachment_Pod* self__pod, physx_PxVec3_Pod const* offset_pod) {
        physx::PxArticulationAttachment* self_ = reinterpret_cast<physx::PxArticulationAttachment*>(self__pod);
        physx::PxVec3 const& offset = reinterpret_cast<physx::PxVec3 const&>(*offset_pod);
        self_->setRelativeOffset(offset);
    }

    physx_PxVec3_Pod physx_PxArticulationAttachment_getRelativeOffset(physx_PxArticulationAttachment_Pod const* self__pod) {
        physx::PxArticulationAttachment const* self_ = reinterpret_cast<physx::PxArticulationAttachment const*>(self__pod);
    ...
    void physx_PxArticulationAttachment_setCoefficient_mut(physx_PxArticulationAttachment_Pod* self__pod, float coefficient) {
        physx::PxArticulationAttachment* self_ = reinterpret_cast<physx::PxArticulationAttachment*>(self__pod);
        self_->setCoefficient(coefficient);
    }

    float physx_PxArticulationAttachment_getCoefficient(physx_PxArticulationAttachment_Pod const* self__pod) {
        physx::PxArticulationAttachment const* self_ = reinterpret_cast<physx::PxArticulationAttachment const*>(self__pod);
        float return_val = self_->getCoefficient();
        return return_val;
    }

    physx_PxArticulationLink_Pod* physx_PxArticulationAttachment_getLink(physx_PxArticulationAttachment_Pod const* self__pod) {
        physx::PxArticulationAttachment const* self_ = reinterpret_cast<physx::PxArticulationAttachment const*>(self__pod);
    ...
    physx_PxArticulationAttachment_Pod* physx_PxArticulationAttachment_getParent(physx_PxArticulationAttachment_Pod const* self__pod) {
        physx::PxArticulationAttachment const* self_ = reinterpret_cast<physx::PxArticulationAttachment const*>(self__pod);
    ...
    bool physx_PxArticulationAttachment_isLeaf(physx_PxArticulationAttachment_Pod const* self__pod) {
        physx::PxArticulationAttachment const* self_ = reinterpret_cast<physx::PxArticulationAttachment const*>(self__pod);
        bool return_val = self_->isLeaf();
        return return_val;
    }

    physx_PxArticulationSpatialTendon_Pod* physx_PxArticulationAttachment_getTendon(physx_PxArticulationAttachment_Pod const* self__pod) {
        physx::PxArticulationAttachment const* self_ = reinterpret_cast<physx::PxArticulationAttachment const*>(self__pod);
    ...
    void physx_PxArticulationAttachment_release_mut(physx_PxArticulationAttachment_Pod* self__pod) {
        physx::PxArticulationAttachment* self_ = reinterpret_cast<physx::PxArticulationAttachment*>(self__pod);
        self_->release();
    }

    char const* physx_PxArticulationAttachment_getConcreteTypeName(physx_PxArticulationAttachment_Pod const* self__pod) {
        physx::PxArticulationAttachment const* self_ = reinterpret_cast<physx::PxArticulationAttachment const*>(self__pod);
        char const* return_val = self_->getConcreteTypeName();
        return return_val;
    }

    void physx_PxArticulationTendonJoint_setCoefficient_mut(physx_PxArticulationTendonJoint_Pod* self__pod, int32_t axis_pod, float coefficient, float recipCoefficient) {
    ...
    void physx_PxArticulationTendonJoint_getCoefficient(physx_PxArticulationTendonJoint_Pod const* self__pod, int32_t* axis_pod, float* coefficient_pod, float* recipCoefficient_pod) {
    ...
    physx_PxArticulationLink_Pod* physx_PxArticulationTendonJoint_getLink(physx_PxArticulationTendonJoint_Pod const* self__pod) {
        physx::PxArticulationTendonJoint const* self_ = reinterpret_cast<physx::PxArticulationTendonJoint const*>(self__pod);
        physx::PxArticulationLink* return_val = self_->getLink();
        auto return_val_pod = reinterpret_cast<physx_PxArticulationLink_Pod*>(return_val);
        return return_val_pod;
    ...
    physx_PxArticulationTendonJoint_Pod* physx_PxArticulationTendonJoint_getParent(physx_PxArticulationTendonJoint_Pod const* self__pod) {
        physx::PxArticulationTendonJoint const* self_ = reinterpret_cast<physx::PxArticulationTendonJoint const*>(self__pod);
    ...
    physx_PxArticulationFixedTendon_Pod* physx_PxArticulationTendonJoint_getTendon(physx_PxArticulationTendonJoint_Pod const* self__pod) {
        physx::PxArticulationTendonJoint const* self_ = reinterpret_cast<physx::PxArticulationTendonJoint const*>(self__pod);
    ...
    void physx_PxArticulationTendonJoint_release_mut(physx_PxArticulationTendonJoint_Pod* self__pod) {
        physx::PxArticulationTendonJoint* self_ = reinterpret_cast<physx::PxArticulationTendonJoint*>(self__pod);
        self_->release();
    }

    char const* physx_PxArticulationTendonJoint_getConcreteTypeName(physx_PxArticulationTendonJoint_Pod const* self__pod) {
        physx::PxArticulationTendonJoint const* self_ = reinterpret_cast<physx::PxArticulationTendonJoint const*>(self__pod);
        char const* return_val = self_->getConcreteTypeName();
        return return_val;
    }

    void physx_PxArticulationTendon_setStiffness_mut(physx_PxArticulationTendon_Pod* self__pod, float stiffness) {
        physx::PxArticulationTendon* self_ = reinterpret_cast<physx::PxArticulationTendon*>(self__pod);
        self_->setStiffness(stiffness);
    }

    float physx_PxArticulationTendon_getStiffness(physx_PxArticulationTendon_Pod const* self__pod) {
    ...
    void physx_PxArticulationTendon_setDamping_mut(physx_PxArticulationTendon_Pod* self__pod, float damping) {
        physx::PxArticulationTendon* self_ = reinterpret_cast<physx::PxArticulationTendon*>(self__pod);
        self_->setDamping(damping);
    }

    float physx_PxArticulationTendon_getDamping(physx_PxArticulationTendon_Pod const* self__pod) {
        physx::PxArticulationTendon const* self_ = reinterpret_cast<physx::PxArticulationTendon const*>(self__pod);
        float return_val = self_->getDamping();
        return return_val;
    }

    void physx_PxArticulationTendon_setLimitStiffness_mut(physx_PxArticulationTendon_Pod* self__pod, float stiffness) {
        physx::PxArticulationTendon* self_ = reinterpret_cast<physx::PxArticulationTendon*>(self__pod);
        self_->setLimitStiffness(stiffness);
    }

    float physx_PxArticulationTendon_getLimitStiffness(physx_PxArticulationTendon_Pod const* self__pod) {
        physx::PxArticulationTendon const* self_ = reinterpret_cast<physx::PxArticulationTendon const*>(self__pod);
        float return_val = self_->getLimitStiffness();
        return return_val;
    }

    void physx_PxArticulationTendon_setOffset_mut(physx_PxArticulationTendon_Pod* self__pod, float offset, bool autowake) {
        physx::PxArticulationTendon* self_ = reinterpret_cast<physx::PxArticulationTendon*>(self__pod);
        self_->setOffset(offset, autowake);
    }

    float physx_PxArticulationTendon_getOffset(physx_PxArticulationTendon_Pod const* self__pod) {
        physx::PxArticulationTendon const* self_ = reinterpret_cast<physx::PxArticulationTendon const*>(self__pod);
        float return_val = self_->getOffset();
        return return_val;
    }

    physx_PxArticulationReducedCoordinate_Pod* physx_PxArticulationTendon_getArticulation(physx_PxArticulationTendon_Pod const* self__pod) {
        physx::PxArticulationTendon const* self_ = reinterpret_cast<physx::PxArticulationTendon const*>(self__pod);
    ...
    void physx_PxArticulationTendon_release_mut(physx_PxArticulationTendon_Pod* self__pod) {
        physx::PxArticulationTendon* self_ = reinterpret_cast<physx::PxArticulationTendon*>(self__pod);
        self_->release();
    }

    physx_PxArticulationAttachment_Pod* physx_PxArticulationSpatialTendon_createAttachment_mut(physx_PxArticulationSpatialTendon_Pod* self__pod, physx_PxArticulationAttachment_Pod* parent_pod, float coefficient, physx_PxVec3_Pod relativeOffset_pod, physx_PxArticulationLink_Pod* link_pod) {
    ...
    uint32_t physx_PxArticulationSpatialTendon_getAttachments(physx_PxArticulationSpatialTendon_Pod const* self__pod, physx_PxArticulationAttachment_Pod** userBuffer_pod, uint32_t bufferSize, uint32_t startIndex) {
    ...
    uint32_t physx_PxArticulationSpatialTendon_getNbAttachments(physx_PxArticulationSpatialTendon_Pod const* self__pod) {
        physx::PxArticulationSpatialTendon const* self_ = reinterpret_cast<physx::PxArticulationSpatialTendon const*>(self__pod);
        uint32_t return_val = self_->getNbAttachments();
        return return_val;
    }

    char const* physx_PxArticulationSpatialTendon_getConcreteTypeName(physx_PxArticulationSpatialTendon_Pod const* self__pod) {
        physx::PxArticulationSpatialTendon const* self_ = reinterpret_cast<physx::PxArticulationSpatialTendon const*>(self__pod);
        char const* return_val = self_->getConcreteTypeName();
        return return_val;
    }

    physx_PxArticulationTendonJoint_Pod* physx_PxArticulationFixedTendon_createTendonJoint_mut(physx_PxArticulationFixedTendon_Pod* self__pod, physx_PxArticulationTendonJoint_Pod* parent_pod, int32_t axis_pod, float coefficient, float recipCoefficient, physx_PxArticulationLink_Pod* link_pod) {
    ...
    uint32_t physx_PxArticulationFixedTendon_getTendonJoints(physx_PxArticulationFixedTendon_Pod const* self__pod, physx_PxArticulationTendonJoint_Pod** userBuffer_pod, uint32_t bufferSize, uint32_t startIndex) {
    ...
    uint32_t physx_PxArticulationFixedTendon_getNbTendonJoints(physx_PxArticulationFixedTendon_Pod const* self__pod) {
        physx::PxArticulationFixedTendon const* self_ = reinterpret_cast<physx::PxArticulationFixedTendon const*>(self__pod);
        uint32_t return_val = self_->getNbTendonJoints();
        return return_val;
    }

    void physx_PxArticulationFixedTendon_setRestLength_mut(physx_PxArticulationFixedTendon_Pod* self__pod, float restLength) {
        physx::PxArticulationFixedTendon* self_ = reinterpret_cast<physx::PxArticulationFixedTendon*>(self__pod);
        self_->setRestLength(restLength);
    }

    float physx_PxArticulationFixedTendon_getRestLength(physx_PxArticulationFixedTendon_Pod const* self__pod) {
        physx::PxArticulationFixedTendon const* self_ = reinterpret_cast<physx::PxArticulationFixedTendon const*>(self__pod);
        float return_val = self_->getRestLength();
        return return_val;
    }

    void physx_PxArticulationFixedTendon_setLimitParameters_mut(physx_PxArticulationFixedTendon_Pod* self__pod, physx_PxArticulationTendonLimit_Pod const* parameter_pod) {
        physx::PxArticulationFixedTendon* self_ = reinterpret_cast<physx::PxArticulationFixedTendon*>(self__pod);
    ...
    physx_PxArticulationTendonLimit_Pod physx_PxArticulationFixedTendon_getLimitParameters(physx_PxArticulationFixedTendon_Pod const* self__pod) {
        physx::PxArticulationFixedTendon const* self_ = reinterpret_cast<physx::PxArticulationFixedTendon const*>(self__pod);
        physx::PxArticulationTendonLimit return_val = self_->getLimitParameters();
        physx_PxArticulationTendonLimit_Pod return_val_pod;
        memcpy(&return_val_pod, &return_val, sizeof(return_val_pod));
    ...
    char const* physx_PxArticulationFixedTendon_getConcreteTypeName(physx_PxArticulationFixedTendon_Pod const* self__pod) {
        physx::PxArticulationFixedTendon const* self_ = reinterpret_cast<physx::PxArticulationFixedTendon const*>(self__pod);
        char const* return_val = self_->getConcreteTypeName();
        return return_val;
    }

    physx_PxArticulationCache_Pod physx_PxArticulationCache_new() {
    ...
    void physx_PxArticulationCache_release_mut(physx_PxArticulationCache_Pod* self__pod) {
        physx::PxArticulationCache* self_ = reinterpret_cast<physx::PxArticulationCache*>(self__pod);
        self_->release();
    }

    void physx_PxArticulationSensor_release_mut(physx_PxArticulationSensor_Pod* self__pod) {
        physx::PxArticulationSensor* self_ = reinterpret_cast<physx::PxArticulationSensor*>(self__pod);
        self_->release();
    }

    physx_PxSpatialForce_Pod physx_PxArticulationSensor_getForces(physx_PxArticulationSensor_Pod const* self__pod) {
    ...
    physx_PxTransform_Pod physx_PxArticulationSensor_getRelativePose(physx_PxArticulationSensor_Pod const* self__pod) {
        physx::PxArticulationSensor const* self_ = reinterpret_cast<physx::PxArticulationSensor const*>(self__pod);
    ...
    void physx_PxArticulationSensor_setRelativePose_mut(physx_PxArticulationSensor_Pod* self__pod, physx_PxTransform_Pod const* pose_pod) {
        physx::PxArticulationSensor* self_ = reinterpret_cast<physx::PxArticulationSensor*>(self__pod);
        physx::PxTransform const& pose = reinterpret_cast<physx::PxTransform const&>(*pose_pod);
        self_->setRelativePose(pose);
    }

    physx_PxArticulationLink_Pod* physx_PxArticulationSensor_getLink(physx_PxArticulationSensor_Pod const* self__pod) {
        physx::PxArticulationSensor const* self_ = reinterpret_cast<physx::PxArticulationSensor const*>(self__pod);
        physx::PxArticulationLink* return_val = self_->getLink();
        auto return_val_pod = reinterpret_cast<physx_PxArticulationLink_Pod*>(return_val);
        return return_val_pod;
    ...
    uint32_t physx_PxArticulationSensor_getIndex(physx_PxArticulationSensor_Pod const* self__pod) {
        physx::PxArticulationSensor const* self_ = reinterpret_cast<physx::PxArticulationSensor const*>(self__pod);
        uint32_t return_val = self_->getIndex();
        return return_val;
    }

    physx_PxArticulationReducedCoordinate_Pod* physx_PxArticulationSensor_getArticulation(physx_PxArticulationSensor_Pod const* self__pod) {
        physx::PxArticulationSensor const* self_ = reinterpret_cast<physx::PxArticulationSensor const*>(self__pod);
        physx::PxArticulationReducedCoordinate* return_val = self_->getArticulation();
        auto return_val_pod = reinterpret_cast<physx_PxArticulationReducedCoordinate_Pod*>(return_val);
        return return_val_pod;
    ...
    uint8_t physx_PxArticulationSensor_getFlags(physx_PxArticulationSensor_Pod const* self__pod) {
        physx::PxArticulationSensor const* self_ = reinterpret_cast<physx::PxArticulationSensor const*>(self__pod);
    ...
    void physx_PxArticulationSensor_setFlag_mut(physx_PxArticulationSensor_Pod* self__pod, int32_t flag_pod, bool enabled) {
        physx::PxArticulationSensor* self_ = reinterpret_cast<physx::PxArticulationSensor*>(self__pod);
        auto flag = static_cast<physx::PxArticulationSensorFlag::Enum>(flag_pod);
        self_->setFlag(flag, enabled);
    }

    char const* physx_PxArticulationSensor_getConcreteTypeName(physx_PxArticulationSensor_Pod const* self__pod) {
        physx::PxArticulationSensor const* self_ = reinterpret_cast<physx::PxArticulationSensor const*>(self__pod);
        char const* return_val = self_->getConcreteTypeName();
        return return_val;
    }

    physx_PxScene_Pod* physx_PxArticulationReducedCoordinate_getScene(physx_PxArticulationReducedCoordinate_Pod const* self__pod) {
    ...
    void physx_PxArticulationReducedCoordinate_setSolverIterationCounts_mut(physx_PxArticulationReducedCoordinate_Pod* self__pod, uint32_t minPositionIters, uint32_t minVelocityIters) {
    ...
    void physx_PxArticulationReducedCoordinate_getSolverIterationCounts(physx_PxArticulationReducedCoordinate_Pod const* self__pod, uint32_t* minPositionIters_pod, uint32_t* minVelocityIters_pod) {
        physx::PxArticulationReducedCoordinate const* self_ = reinterpret_cast<physx::PxArticulationReducedCoordinate const*>(self__pod);
    ...
    bool physx_PxArticulationReducedCoordinate_isSleeping(physx_PxArticulationReducedCoordinate_Pod const* self__pod) {
        physx::PxArticulationReducedCoordinate const* self_ = reinterpret_cast<physx::PxArticulationReducedCoordinate const*>(self__pod);
        bool return_val = self_->isSleeping();
        return return_val;
    }

    void physx_PxArticulationReducedCoordinate_setSleepThreshold_mut(physx_PxArticulationReducedCoordinate_Pod* self__pod, float threshold) {
        physx::PxArticulationReducedCoordinate* self_ = reinterpret_cast<physx::PxArticulationReducedCoordinate*>(self__pod);
        self_->setSleepThreshold(threshold);
    }

    float physx_PxArticulationReducedCoordinate_getSleepThreshold(physx_PxArticulationReducedCoordinate_Pod const* self__pod) {
        physx::PxArticulationReducedCoordinate const* self_ = reinterpret_cast<physx::PxArticulationReducedCoordinate const*>(self__pod);
        float return_val = self_->getSleepThreshold();
        return return_val;
    }

    void physx_PxArticulationReducedCoordinate_setStabilizationThreshold_mut(physx_PxArticulationReducedCoordinate_Pod* self__pod, float threshold) {
        physx::PxArticulationReducedCoordinate* self_ = reinterpret_cast<physx::PxArticulationReducedCoordinate*>(self__pod);
        self_->setStabilizationThreshold(threshold);
    }

    float physx_PxArticulationReducedCoordinate_getStabilizationThreshold(physx_PxArticulationReducedCoordinate_Pod const* self__pod) {
        physx::PxArticulationReducedCoordinate const* self_ = reinterpret_cast<physx::PxArticulationReducedCoordinate const*>(self__pod);
        float return_val = self_->getStabilizationThreshold();
        return return_val;
    }

    void physx_PxArticulationReducedCoordinate_setWakeCounter_mut(physx_PxArticulationReducedCoordinate_Pod* self__pod, float wakeCounterValue) {
        physx::PxArticulationReducedCoordinate* self_ = reinterpret_cast<physx::PxArticulationReducedCoordinate*>(self__pod);
        self_->setWakeCounter(wakeCounterValue);
    }

    float physx_PxArticulationReducedCoordinate_getWakeCounter(physx_PxArticulationReducedCoordinate_Pod const* self__pod) {
        physx::PxArticulationReducedCoordinate const* self_ = reinterpret_cast<physx::PxArticulationReducedCoordinate const*>(self__pod);
        float return_val = self_->getWakeCounter();
        return return_val;
    }

    void physx_PxArticulationReducedCoordinate_wakeUp_mut(physx_PxArticulationReducedCoordinate_Pod* self__pod) {
        physx::PxArticulationReducedCoordinate* self_ = reinterpret_cast<physx::PxArticulationReducedCoordinate*>(self__pod);
        self_->wakeUp();
    }

    void physx_PxArticulationReducedCoordinate_putToSleep_mut(physx_PxArticulationReducedCoordinate_Pod* self__pod) {
        physx::PxArticulationReducedCoordinate* self_ = reinterpret_cast<physx::PxArticulationReducedCoordinate*>(self__pod);
        self_->putToSleep();
    }

    void physx_PxArticulationReducedCoordinate_setMaxCOMLinearVelocity_mut(physx_PxArticulationReducedCoordinate_Pod* self__pod, float maxLinearVelocity) {
        physx::PxArticulationReducedCoordinate* self_ = reinterpret_cast<physx::PxArticulationReducedCoordinate*>(self__pod);
        self_->setMaxCOMLinearVelocity(maxLinearVelocity);
    }

    float physx_PxArticulationReducedCoordinate_getMaxCOMLinearVelocity(physx_PxArticulationReducedCoordinate_Pod const* self__pod) {
        physx::PxArticulationReducedCoordinate const* self_ = reinterpret_cast<physx::PxArticulationReducedCoordinate const*>(self__pod);
        float return_val = self_->getMaxCOMLinearVelocity();
        return return_val;
    }

    void physx_PxArticulationReducedCoordinate_setMaxCOMAngularVelocity_mut(physx_PxArticulationReducedCoordinate_Pod* self__pod, float maxAngularVelocity) {
        physx::PxArticulationReducedCoordinate* self_ = reinterpret_cast<physx::PxArticulationReducedCoordinate*>(self__pod);
        self_->setMaxCOMAngularVelocity(maxAngularVelocity);
    }

    float physx_PxArticulationReducedCoordinate_getMaxCOMAngularVelocity(physx_PxArticulationReducedCoordinate_Pod const* self__pod) {
        physx::PxArticulationReducedCoordinate const* self_ = reinterpret_cast<physx::PxArticulationReducedCoordinate const*>(self__pod);
        float return_val = self_->getMaxCOMAngularVelocity();
        return return_val;
    }

    physx_PxArticulationLink_Pod* physx_PxArticulationReducedCoordinate_createLink_mut(physx_PxArticulationReducedCoordinate_Pod* self__pod, physx_PxArticulationLink_Pod* parent_pod, physx_PxTransform_Pod const* pose_pod) {
        physx::PxArticulationReducedCoordinate* self_ = reinterpret_cast<physx::PxArticulationReducedCoordinate*>(self__pod);
    ...
    void physx_PxArticulationReducedCoordinate_release_mut(physx_PxArticulationReducedCoordinate_Pod* self__pod) {
        physx::PxArticulationReducedCoordinate* self_ = reinterpret_cast<physx::PxArticulationReducedCoordinate*>(self__pod);
        self_->release();
    }

    uint32_t physx_PxArticulationReducedCoordinate_getNbLinks(physx_PxArticulationReducedCoordinate_Pod const* self__pod) {
        physx::PxArticulationReducedCoordinate const* self_ = reinterpret_cast<physx::PxArticulationReducedCoordinate const*>(self__pod);
        uint32_t return_val = self_->getNbLinks();
        return return_val;
    }

    uint32_t physx_PxArticulationReducedCoordinate_getLinks(physx_PxArticulationReducedCoordinate_Pod const* self__pod, physx_PxArticulationLink_Pod** userBuffer_pod, uint32_t bufferSize, uint32_t startIndex) {
        physx::PxArticulationReducedCoordinate const* self_ = reinterpret_cast<physx::PxArticulationReducedCoordinate const*>(self__pod);
    ...
    uint32_t physx_PxArticulationReducedCoordinate_getNbShapes(physx_PxArticulationReducedCoordinate_Pod const* self__pod) {
        physx::PxArticulationReducedCoordinate const* self_ = reinterpret_cast<physx::PxArticulationReducedCoordinate const*>(self__pod);
        uint32_t return_val = self_->getNbShapes();
        return return_val;
    }

    void physx_PxArticulationReducedCoordinate_setName_mut(physx_PxArticulationReducedCoordinate_Pod* self__pod, char const* name) {
        physx::PxArticulationReducedCoordinate* self_ = reinterpret_cast<physx::PxArticulationReducedCoordinate*>(self__pod);
        self_->setName(name);
    }

    char const* physx_PxArticulationReducedCoordinate_getName(physx_PxArticulationReducedCoordinate_Pod const* self__pod) {
        physx::PxArticulationReducedCoordinate const* self_ = reinterpret_cast<physx::PxArticulationReducedCoordinate const*>(self__pod);
        char const* return_val = self_->getName();
        return return_val;
    }

    physx_PxBounds3_Pod physx_PxArticulationReducedCoordinate_getWorldBounds(physx_PxArticulationReducedCoordinate_Pod const* self__pod, float inflation) {
        physx::PxArticulationReducedCoordinate const* self_ = reinterpret_cast<physx::PxArticulationReducedCoordinate const*>(self__pod);
        physx::PxBounds3 return_val = self_->getWorldBounds(inflation);
        physx_PxBounds3_Pod return_val_pod;
        memcpy(&return_val_pod, &return_val, sizeof(return_val_pod));
    ...
    physx_PxAggregate_Pod* physx_PxArticulationReducedCoordinate_getAggregate(physx_PxArticulationReducedCoordinate_Pod const* self__pod) {
        physx::PxArticulationReducedCoordinate const* self_ = reinterpret_cast<physx::PxArticulationReducedCoordinate const*>(self__pod);
        physx::PxAggregate* return_val = self_->getAggregate();
        auto return_val_pod = reinterpret_cast<physx_PxAggregate_Pod*>(return_val);
        return return_val_pod;
    ...
    void physx_PxArticulationReducedCoordinate_setArticulationFlags_mut(physx_PxArticulationReducedCoordinate_Pod* self__pod, uint8_t flags_pod) {
        physx::PxArticulationReducedCoordinate* self_ = reinterpret_cast<physx::PxArticulationReducedCoordinate*>(self__pod);
        auto flags = physx::PxArticulationFlags(flags_pod);
        self_->setArticulationFlags(flags);
    }

    void physx_PxArticulationReducedCoordinate_setArticulationFlag_mut(physx_PxArticulationReducedCoordinate_Pod* self__pod, int32_t flag_pod, bool value) {
        physx::PxArticulationReducedCoordinate* self_ = reinterpret_cast<physx::PxArticulationReducedCoordinate*>(self__pod);
        auto flag = static_cast<physx::PxArticulationFlag::Enum>(flag_pod);
        self_->setArticulationFlag(flag, value);
    }

    uint8_t physx_PxArticulationReducedCoordinate_getArticulationFlags(physx_PxArticulationReducedCoordinate_Pod const* self__pod) {
        physx::PxArticulationReducedCoordinate const* self_ = reinterpret_cast<physx::PxArticulationReducedCoordinate const*>(self__pod);
    ...
    uint32_t physx_PxArticulationReducedCoordinate_getDofs(physx_PxArticulationReducedCoordinate_Pod const* self__pod) {
        physx::PxArticulationReducedCoordinate const* self_ = reinterpret_cast<physx::PxArticulationReducedCoordinate const*>(self__pod);
        uint32_t return_val = self_->getDofs();
        return return_val;
    }

    physx_PxArticulationCache_Pod* physx_PxArticulationReducedCoordinate_createCache(physx_PxArticulationReducedCoordinate_Pod const* self__pod) {
        physx::PxArticulationReducedCoordinate const* self_ = reinterpret_cast<physx::PxArticulationReducedCoordinate const*>(self__pod);
    ...
    uint32_t physx_PxArticulationReducedCoordinate_getCacheDataSize(physx_PxArticulationReducedCoordinate_Pod const* self__pod) {
        physx::PxArticulationReducedCoordinate const* self_ = reinterpret_cast<physx::PxArticulationReducedCoordinate const*>(self__pod);
        uint32_t return_val = self_->getCacheDataSize();
        return return_val;
    }

    void physx_PxArticulationReducedCoordinate_zeroCache(physx_PxArticulationReducedCoordinate_Pod const* self__pod, physx_PxArticulationCache_Pod* cache_pod) {
        physx::PxArticulationReducedCoordinate const* self_ = reinterpret_cast<physx::PxArticulationReducedCoordinate const*>(self__pod);
        physx::PxArticulationCache& cache = reinterpret_cast<physx::PxArticulationCache&>(*cache_pod);
        self_->zeroCache(cache);
    }

    void physx_PxArticulationReducedCoordinate_applyCache_mut(physx_PxArticulationReducedCoordinate_Pod* self__pod, physx_PxArticulationCache_Pod* cache_pod, uint32_t flags_pod, bool autowake) {
        physx::PxArticulationReducedCoordinate* self_ = reinterpret_cast<physx::PxArticulationReducedCoordinate*>(self__pod);
        physx::PxArticulationCache& cache = reinterpret_cast<physx::PxArticulationCache&>(*cache_pod);
    ...
    void physx_PxArticulationReducedCoordinate_copyInternalStateToCache(physx_PxArticulationReducedCoordinate_Pod const* self__pod, physx_PxArticulationCache_Pod* cache_pod, uint32_t flags_pod) {
        physx::PxArticulationReducedCoordinate const* self_ = reinterpret_cast<physx::PxArticulationReducedCoordinate const*>(self__pod);
        physx::PxArticulationCache& cache = reinterpret_cast<physx::PxArticulationCache&>(*cache_pod);
        auto flags = physx::PxArticulationCacheFlags(flags_pod);
    ...
    void physx_PxArticulationReducedCoordinate_packJointData(physx_PxArticulationReducedCoordinate_Pod const* self__pod, float const* maximum, float* reduced) {
        physx::PxArticulationReducedCoordinate const* self_ = reinterpret_cast<physx::PxArticulationReducedCoordinate const*>(self__pod);
        self_->packJointData(maximum, reduced);
    }

    void physx_PxArticulationReducedCoordinate_unpackJointData(physx_PxArticulationReducedCoordinate_Pod const* self__pod, float const* reduced, float* maximum) {
        physx::PxArticulationReducedCoordinate const* self_ = reinterpret_cast<physx::PxArticulationReducedCoordinate const*>(self__pod);
        self_->unpackJointData(reduced, maximum);
    }

    void physx_PxArticulationReducedCoordinate_commonInit(physx_PxArticulationReducedCoordinate_Pod const* self__pod) {
        physx::PxArticulationReducedCoordinate const* self_ = reinterpret_cast<physx::PxArticulationReducedCoordinate const*>(self__pod);
        self_->commonInit();
    }

    void physx_PxArticulationReducedCoordinate_computeGeneralizedGravityForce(physx_PxArticulationReducedCoordinate_Pod const* self__pod, physx_PxArticulationCache_Pod* cache_pod) {
        physx::PxArticulationReducedCoordinate const* self_ = reinterpret_cast<physx::PxArticulationReducedCoordinate const*>(self__pod);
        physx::PxArticulationCache& cache = reinterpret_cast<physx::PxArticulationCache&>(*cache_pod);
        self_->computeGeneralizedGravityForce(cache);
    }

    void physx_PxArticulationReducedCoordinate_computeCoriolisAndCentrifugalForce(physx_PxArticulationReducedCoordinate_Pod const* self__pod, physx_PxArticulationCache_Pod* cache_pod) {
        physx::PxArticulationReducedCoordinate const* self_ = reinterpret_cast<physx::PxArticulationReducedCoordinate const*>(self__pod);
        physx::PxArticulationCache& cache = reinterpret_cast<physx::PxArticulationCache&>(*cache_pod);
        self_->computeCoriolisAndCentrifugalForce(cache);
    }

    void physx_PxArticulationReducedCoordinate_computeGeneralizedExternalForce(physx_PxArticulationReducedCoordinate_Pod const* self__pod, physx_PxArticulationCache_Pod* cache_pod) {
        physx::PxArticulationReducedCoordinate const* self_ = reinterpret_cast<physx::PxArticulationReducedCoordinate const*>(self__pod);
        physx::PxArticulationCache& cache = reinterpret_cast<physx::PxArticulationCache&>(*cache_pod);
        self_->computeGeneralizedExternalForce(cache);
    }

    void physx_PxArticulationReducedCoordinate_computeJointAcceleration(physx_PxArticulationReducedCoordinate_Pod const* self__pod, physx_PxArticulationCache_Pod* cache_pod) {
        physx::PxArticulationReducedCoordinate const* self_ = reinterpret_cast<physx::PxArticulationReducedCoordinate const*>(self__pod);
        physx::PxArticulationCache& cache = reinterpret_cast<physx::PxArticulationCache&>(*cache_pod);
        self_->computeJointAcceleration(cache);
    }

    void physx_PxArticulationReducedCoordinate_computeJointForce(physx_PxArticulationReducedCoordinate_Pod const* self__pod, physx_PxArticulationCache_Pod* cache_pod) {
        physx::PxArticulationReducedCoordinate const* self_ = reinterpret_cast<physx::PxArticulationReducedCoordinate const*>(self__pod);
        physx::PxArticulationCache& cache = reinterpret_cast<physx::PxArticulationCache&>(*cache_pod);
        self_->computeJointForce(cache);
    }

    void physx_PxArticulationReducedCoordinate_computeDenseJacobian(physx_PxArticulationReducedCoordinate_Pod const* self__pod, physx_PxArticulationCache_Pod* cache_pod, uint32_t* nRows_pod, uint32_t* nCols_pod) {
        physx::PxArticulationReducedCoordinate const* self_ = reinterpret_cast<physx::PxArticulationReducedCoordinate const*>(self__pod);
        physx::PxArticulationCache& cache = reinterpret_cast<physx::PxArticulationCache&>(*cache_pod);
    ...
    void physx_PxArticulationReducedCoordinate_computeCoefficientMatrix(physx_PxArticulationReducedCoordinate_Pod const* self__pod, physx_PxArticulationCache_Pod* cache_pod) {
        physx::PxArticulationReducedCoordinate const* self_ = reinterpret_cast<physx::PxArticulationReducedCoordinate const*>(self__pod);
        physx::PxArticulationCache& cache = reinterpret_cast<physx::PxArticulationCache&>(*cache_pod);
        self_->computeCoefficientMatrix(cache);
    }

    bool physx_PxArticulationReducedCoordinate_computeLambda(physx_PxArticulationReducedCoordinate_Pod const* self__pod, physx_PxArticulationCache_Pod* cache_pod, physx_PxArticulationCache_Pod* initialState_pod, float const*const jointTorque, uint32_t maxIter) {
        physx::PxArticulationReducedCoordinate const* self_ = reinterpret_cast<physx::PxArticulationReducedCoordinate const*>(self__pod);
        physx::PxArticulationCache& cache = reinterpret_cast<physx::PxArticulationCache&>(*cache_pod);
    ...
    void physx_PxArticulationReducedCoordinate_computeGeneralizedMassMatrix(physx_PxArticulationReducedCoordinate_Pod const* self__pod, physx_PxArticulationCache_Pod* cache_pod) {
        physx::PxArticulationReducedCoordinate const* self_ = reinterpret_cast<physx::PxArticulationReducedCoordinate const*>(self__pod);
        physx::PxArticulationCache& cache = reinterpret_cast<physx::PxArticulationCache&>(*cache_pod);
        self_->computeGeneralizedMassMatrix(cache);
    }

    void physx_PxArticulationReducedCoordinate_addLoopJoint_mut(physx_PxArticulationReducedCoordinate_Pod* self__pod, physx_PxConstraint_Pod* joint_pod) {
        physx::PxArticulationReducedCoordinate* self_ = reinterpret_cast<physx::PxArticulationReducedCoordinate*>(self__pod);
        physx::PxConstraint* joint = reinterpret_cast<physx::PxConstraint*>(joint_pod);
        self_->addLoopJoint(joint);
    }

    void physx_PxArticulationReducedCoordinate_removeLoopJoint_mut(physx_PxArticulationReducedCoordinate_Pod* self__pod, physx_PxConstraint_Pod* joint_pod) {
        physx::PxArticulationReducedCoordinate* self_ = reinterpret_cast<physx::PxArticulationReducedCoordinate*>(self__pod);
        physx::PxConstraint* joint = reinterpret_cast<physx::PxConstraint*>(joint_pod);
        self_->removeLoopJoint(joint);
    }

    uint32_t physx_PxArticulationReducedCoordinate_getNbLoopJoints(physx_PxArticulationReducedCoordinate_Pod const* self__pod) {
        physx::PxArticulationReducedCoordinate const* self_ = reinterpret_cast<physx::PxArticulationReducedCoordinate const*>(self__pod);
        uint32_t return_val = self_->getNbLoopJoints();
        return return_val;
    }

    uint32_t physx_PxArticulationReducedCoordinate_getLoopJoints(physx_PxArticulationReducedCoordinate_Pod const* self__pod, physx_PxConstraint_Pod** userBuffer_pod, uint32_t bufferSize, uint32_t startIndex) {
        physx::PxArticulationReducedCoordinate const* self_ = reinterpret_cast<physx::PxArticulationReducedCoordinate const*>(self__pod);
    ...
    uint32_t physx_PxArticulationReducedCoordinate_getCoefficientMatrixSize(physx_PxArticulationReducedCoordinate_Pod const* self__pod) {
        physx::PxArticulationReducedCoordinate const* self_ = reinterpret_cast<physx::PxArticulationReducedCoordinate const*>(self__pod);
        uint32_t return_val = self_->getCoefficientMatrixSize();
        return return_val;
    }

    void physx_PxArticulationReducedCoordinate_setRootGlobalPose_mut(physx_PxArticulationReducedCoordinate_Pod* self__pod, physx_PxTransform_Pod const* pose_pod, bool autowake) {
        physx::PxArticulationReducedCoordinate* self_ = reinterpret_cast<physx::PxArticulationReducedCoordinate*>(self__pod);
        physx::PxTransform const& pose = reinterpret_cast<physx::PxTransform const&>(*pose_pod);
        self_->setRootGlobalPose(pose, autowake);
    }

    physx_PxTransform_Pod physx_PxArticulationReducedCoordinate_getRootGlobalPose(physx_PxArticulationReducedCoordinate_Pod const* self__pod) {
        physx::PxArticulationReducedCoordinate const* self_ = reinterpret_cast<physx::PxArticulationReducedCoordinate const*>(self__pod);
    ...
    void physx_PxArticulationReducedCoordinate_setRootLinearVelocity_mut(physx_PxArticulationReducedCoordinate_Pod* self__pod, physx_PxVec3_Pod const* linearVelocity_pod, bool autowake) {
        physx::PxArticulationReducedCoordinate* self_ = reinterpret_cast<physx::PxArticulationReducedCoordinate*>(self__pod);
    ...
    physx_PxVec3_Pod physx_PxArticulationReducedCoordinate_getRootLinearVelocity(physx_PxArticulationReducedCoordinate_Pod const* self__pod) {
        physx::PxArticulationReducedCoordinate const* self_ = reinterpret_cast<physx::PxArticulationReducedCoordinate const*>(self__pod);
    ...
    void physx_PxArticulationReducedCoordinate_setRootAngularVelocity_mut(physx_PxArticulationReducedCoordinate_Pod* self__pod, physx_PxVec3_Pod const* angularVelocity_pod, bool autowake) {
        physx::PxArticulationReducedCoordinate* self_ = reinterpret_cast<physx::PxArticulationReducedCoordinate*>(self__pod);
    ...
    physx_PxVec3_Pod physx_PxArticulationReducedCoordinate_getRootAngularVelocity(physx_PxArticulationReducedCoordinate_Pod const* self__pod) {
        physx::PxArticulationReducedCoordinate const* self_ = reinterpret_cast<physx::PxArticulationReducedCoordinate const*>(self__pod);
    ...
    physx_PxSpatialVelocity_Pod physx_PxArticulationReducedCoordinate_getLinkAcceleration_mut(physx_PxArticulationReducedCoordinate_Pod* self__pod, uint32_t linkId) {
        physx::PxArticulationReducedCoordinate* self_ = reinterpret_cast<physx::PxArticulationReducedCoordinate*>(self__pod);
    ...
    uint32_t physx_PxArticulationReducedCoordinate_getGpuArticulationIndex_mut(physx_PxArticulationReducedCoordinate_Pod* self__pod) {
        physx::PxArticulationReducedCoordinate* self_ = reinterpret_cast<physx::PxArticulationReducedCoordinate*>(self__pod);
        uint32_t return_val = self_->getGpuArticulationIndex();
        return return_val;
    }

    physx_PxArticulationSpatialTendon_Pod* physx_PxArticulationReducedCoordinate_createSpatialTendon_mut(physx_PxArticulationReducedCoordinate_Pod* self__pod) {
        physx::PxArticulationReducedCoordinate* self_ = reinterpret_cast<physx::PxArticulationReducedCoordinate*>(self__pod);
    ...
    physx_PxArticulationFixedTendon_Pod* physx_PxArticulationReducedCoordinate_createFixedTendon_mut(physx_PxArticulationReducedCoordinate_Pod* self__pod) {
        physx::PxArticulationReducedCoordinate* self_ = reinterpret_cast<physx::PxArticulationReducedCoordinate*>(self__pod);
    ...
    physx_PxArticulationSensor_Pod* physx_PxArticulationReducedCoordinate_createSensor_mut(physx_PxArticulationReducedCoordinate_Pod* self__pod, physx_PxArticulationLink_Pod* link_pod, physx_PxTransform_Pod const* relativePose_pod) {
        physx::PxArticulationReducedCoordinate* self_ = reinterpret_cast<physx::PxArticulationReducedCoordinate*>(self__pod);
        physx::PxArticulationLink* link = reinterpret_cast<physx::PxArticulationLink*>(link_pod);
    ...
    uint32_t physx_PxArticulationReducedCoordinate_getSpatialTendons(physx_PxArticulationReducedCoordinate_Pod const* self__pod, physx_PxArticulationSpatialTendon_Pod** userBuffer_pod, uint32_t bufferSize, uint32_t startIndex) {
        physx::PxArticulationReducedCoordinate const* self_ = reinterpret_cast<physx::PxArticulationReducedCoordinate const*>(self__pod);
    ...
    uint32_t physx_PxArticulationReducedCoordinate_getNbSpatialTendons_mut(physx_PxArticulationReducedCoordinate_Pod* self__pod) {
        physx::PxArticulationReducedCoordinate* self_ = reinterpret_cast<physx::PxArticulationReducedCoordinate*>(self__pod);
        uint32_t return_val = self_->getNbSpatialTendons();
        return return_val;
    }

    uint32_t physx_PxArticulationReducedCoordinate_getFixedTendons(physx_PxArticulationReducedCoordinate_Pod const* self__pod, physx_PxArticulationFixedTendon_Pod** userBuffer_pod, uint32_t bufferSize, uint32_t startIndex) {
        physx::PxArticulationReducedCoordinate const* self_ = reinterpret_cast<physx::PxArticulationReducedCoordinate const*>(self__pod);
    ...
    uint32_t physx_PxArticulationReducedCoordinate_getNbFixedTendons_mut(physx_PxArticulationReducedCoordinate_Pod* self__pod) {
        physx::PxArticulationReducedCoordinate* self_ = reinterpret_cast<physx::PxArticulationReducedCoordinate*>(self__pod);
        uint32_t return_val = self_->getNbFixedTendons();
        return return_val;
    }

    uint32_t physx_PxArticulationReducedCoordinate_getSensors(physx_PxArticulationReducedCoordinate_Pod const* self__pod, physx_PxArticulationSensor_Pod** userBuffer_pod, uint32_t bufferSize, uint32_t startIndex) {
        physx::PxArticulationReducedCoordinate const* self_ = reinterpret_cast<physx::PxArticulationReducedCoordinate const*>(self__pod);
    ...
    uint32_t physx_PxArticulationReducedCoordinate_getNbSensors_mut(physx_PxArticulationReducedCoordinate_Pod* self__pod) {
        physx::PxArticulationReducedCoordinate* self_ = reinterpret_cast<physx::PxArticulationReducedCoordinate*>(self__pod);
        uint32_t return_val = self_->getNbSensors();
        return return_val;
    }

    void physx_PxArticulationReducedCoordinate_updateKinematic_mut(physx_PxArticulationReducedCoordinate_Pod* self__pod, uint8_t flags_pod) {
        physx::PxArticulationReducedCoordinate* self_ = reinterpret_cast<physx::PxArticulationReducedCoordinate*>(self__pod);
        auto flags = physx::PxArticulationKinematicFlags(flags_pod);
        self_->updateKinematic(flags);
    }

    physx_PxArticulationLink_Pod* physx_PxArticulationJointReducedCoordinate_getParentArticulationLink(physx_PxArticulationJointReducedCoordinate_Pod const* self__pod) {
    ...
    void physx_PxArticulationJointReducedCoordinate_setParentPose_mut(physx_PxArticulationJointReducedCoordinate_Pod* self__pod, physx_PxTransform_Pod const* pose_pod) {
    ...
    physx_PxTransform_Pod physx_PxArticulationJointReducedCoordinate_getParentPose(physx_PxArticulationJointReducedCoordinate_Pod const* self__pod) {
        physx::PxArticulationJointReducedCoordinate const* self_ = reinterpret_cast<physx::PxArticulationJointReducedCoordinate const*>(self__pod);
    ...
    physx_PxArticulationLink_Pod* physx_PxArticulationJointReducedCoordinate_getChildArticulationLink(physx_PxArticulationJointReducedCoordinate_Pod const* self__pod) {
        physx::PxArticulationJointReducedCoordinate const* self_ = reinterpret_cast<physx::PxArticulationJointReducedCoordinate const*>(self__pod);
    ...
    void physx_PxArticulationJointReducedCoordinate_setChildPose_mut(physx_PxArticulationJointReducedCoordinate_Pod* self__pod, physx_PxTransform_Pod const* pose_pod) {
        physx::PxArticulationJointReducedCoordinate* self_ = reinterpret_cast<physx::PxArticulationJointReducedCoordinate*>(self__pod);
        physx::PxTransform const& pose = reinterpret_cast<physx::PxTransform const&>(*pose_pod);
        self_->setChildPose(pose);
    }

    physx_PxTransform_Pod physx_PxArticulationJointReducedCoordinate_getChildPose(physx_PxArticulationJointReducedCoordinate_Pod const* self__pod) {
        physx::PxArticulationJointReducedCoordinate const* self_ = reinterpret_cast<physx::PxArticulationJointReducedCoordinate const*>(self__pod);
    ...
    void physx_PxArticulationJointReducedCoordinate_setJointType_mut(physx_PxArticulationJointReducedCoordinate_Pod* self__pod, int32_t jointType_pod) {
        physx::PxArticulationJointReducedCoordinate* self_ = reinterpret_cast<physx::PxArticulationJointReducedCoordinate*>(self__pod);
        auto jointType = static_cast<physx::PxArticulationJointType::Enum>(jointType_pod);
        self_->setJointType(jointType);
    }

    int32_t physx_PxArticulationJointReducedCoordinate_getJointType(physx_PxArticulationJointReducedCoordinate_Pod const* self__pod) {
        physx::PxArticulationJointReducedCoordinate const* self_ = reinterpret_cast<physx::PxArticulationJointReducedCoordinate const*>(self__pod);
    ...
    void physx_PxArticulationJointReducedCoordinate_setMotion_mut(physx_PxArticulationJointReducedCoordinate_Pod* self__pod, int32_t axis_pod, int32_t motion_pod) {
        physx::PxArticulationJointReducedCoordinate* self_ = reinterpret_cast<physx::PxArticulationJointReducedCoordinate*>(self__pod);
        auto axis = static_cast<physx::PxArticulationAxis::Enum>(axis_pod);
    ...
    int32_t physx_PxArticulationJointReducedCoordinate_getMotion(physx_PxArticulationJointReducedCoordinate_Pod const* self__pod, int32_t axis_pod) {
        physx::PxArticulationJointReducedCoordinate const* self_ = reinterpret_cast<physx::PxArticulationJointReducedCoordinate const*>(self__pod);
        auto axis = static_cast<physx::PxArticulationAxis::Enum>(axis_pod);
    ...
    void physx_PxArticulationJointReducedCoordinate_setLimitParams_mut(physx_PxArticulationJointReducedCoordinate_Pod* self__pod, int32_t axis_pod, physx_PxArticulationLimit_Pod const* limit_pod) {
        physx::PxArticulationJointReducedCoordinate* self_ = reinterpret_cast<physx::PxArticulationJointReducedCoordinate*>(self__pod);
        auto axis = static_cast<physx::PxArticulationAxis::Enum>(axis_pod);
    ...
    physx_PxArticulationLimit_Pod physx_PxArticulationJointReducedCoordinate_getLimitParams(physx_PxArticulationJointReducedCoordinate_Pod const* self__pod, int32_t axis_pod) {
        physx::PxArticulationJointReducedCoordinate const* self_ = reinterpret_cast<physx::PxArticulationJointReducedCoordinate const*>(self__pod);
        auto axis = static_cast<physx::PxArticulationAxis::Enum>(axis_pod);
    ...
    void physx_PxArticulationJointReducedCoordinate_setDriveParams_mut(physx_PxArticulationJointReducedCoordinate_Pod* self__pod, int32_t axis_pod, physx_PxArticulationDrive_Pod const* drive_pod) {
        physx::PxArticulationJointReducedCoordinate* self_ = reinterpret_cast<physx::PxArticulationJointReducedCoordinate*>(self__pod);
        auto axis = static_cast<physx::PxArticulationAxis::Enum>(axis_pod);
    ...
    physx_PxArticulationDrive_Pod physx_PxArticulationJointReducedCoordinate_getDriveParams(physx_PxArticulationJointReducedCoordinate_Pod const* self__pod, int32_t axis_pod) {
        physx::PxArticulationJointReducedCoordinate const* self_ = reinterpret_cast<physx::PxArticulationJointReducedCoordinate const*>(self__pod);
        auto axis = static_cast<physx::PxArticulationAxis::Enum>(axis_pod);
    ...
    void physx_PxArticulationJointReducedCoordinate_setDriveTarget_mut(physx_PxArticulationJointReducedCoordinate_Pod* self__pod, int32_t axis_pod, float target, bool autowake) {
        physx::PxArticulationJointReducedCoordinate* self_ = reinterpret_cast<physx::PxArticulationJointReducedCoordinate*>(self__pod);
        auto axis = static_cast<physx::PxArticulationAxis::Enum>(axis_pod);
        self_->setDriveTarget(axis, target, autowake);
    }

    float physx_PxArticulationJointReducedCoordinate_getDriveTarget(physx_PxArticulationJointReducedCoordinate_Pod const* self__pod, int32_t axis_pod) {
        physx::PxArticulationJointReducedCoordinate const* self_ = reinterpret_cast<physx::PxArticulationJointReducedCoordinate const*>(self__pod);
        auto axis = static_cast<physx::PxArticulationAxis::Enum>(axis_pod);
    ...
    void physx_PxArticulationJointReducedCoordinate_setDriveVelocity_mut(physx_PxArticulationJointReducedCoordinate_Pod* self__pod, int32_t axis_pod, float targetVel, bool autowake) {
        physx::PxArticulationJointReducedCoordinate* self_ = reinterpret_cast<physx::PxArticulationJointReducedCoordinate*>(self__pod);
        auto axis = static_cast<physx::PxArticulationAxis::Enum>(axis_pod);
        self_->setDriveVelocity(axis, targetVel, autowake);
    }

    float physx_PxArticulationJointReducedCoordinate_getDriveVelocity(physx_PxArticulationJointReducedCoordinate_Pod const* self__pod, int32_t axis_pod) {
        physx::PxArticulationJointReducedCoordinate const* self_ = reinterpret_cast<physx::PxArticulationJointReducedCoordinate const*>(self__pod);
        auto axis = static_cast<physx::PxArticulationAxis::Enum>(axis_pod);
    ...
    void physx_PxArticulationJointReducedCoordinate_setArmature_mut(physx_PxArticulationJointReducedCoordinate_Pod* self__pod, int32_t axis_pod, float armature) {
        physx::PxArticulationJointReducedCoordinate* self_ = reinterpret_cast<physx::PxArticulationJointReducedCoordinate*>(self__pod);
        auto axis = static_cast<physx::PxArticulationAxis::Enum>(axis_pod);
        self_->setArmature(axis, armature);
    }

    float physx_PxArticulationJointReducedCoordinate_getArmature(physx_PxArticulationJointReducedCoordinate_Pod const* self__pod, int32_t axis_pod) {
        physx::PxArticulationJointReducedCoordinate const* self_ = reinterpret_cast<physx::PxArticulationJointReducedCoordinate const*>(self__pod);
        auto axis = static_cast<physx::PxArticulationAxis::Enum>(axis_pod);
    ...
    void physx_PxArticulationJointReducedCoordinate_setFrictionCoefficient_mut(physx_PxArticulationJointReducedCoordinate_Pod* self__pod, float coefficient) {
        physx::PxArticulationJointReducedCoordinate* self_ = reinterpret_cast<physx::PxArticulationJointReducedCoordinate*>(self__pod);
        self_->setFrictionCoefficient(coefficient);
    }

    float physx_PxArticulationJointReducedCoordinate_getFrictionCoefficient(physx_PxArticulationJointReducedCoordinate_Pod const* self__pod) {
        physx::PxArticulationJointReducedCoordinate const* self_ = reinterpret_cast<physx::PxArticulationJointReducedCoordinate const*>(self__pod);
        float return_val = self_->getFrictionCoefficient();
        return return_val;
    }

    void physx_PxArticulationJointReducedCoordinate_setMaxJointVelocity_mut(physx_PxArticulationJointReducedCoordinate_Pod* self__pod, float maxJointV) {
        physx::PxArticulationJointReducedCoordinate* self_ = reinterpret_cast<physx::PxArticulationJointReducedCoordinate*>(self__pod);
        self_->setMaxJointVelocity(maxJointV);
    }

    float physx_PxArticulationJointReducedCoordinate_getMaxJointVelocity(physx_PxArticulationJointReducedCoordinate_Pod const* self__pod) {
        physx::PxArticulationJointReducedCoordinate const* self_ = reinterpret_cast<physx::PxArticulationJointReducedCoordinate const*>(self__pod);
        float return_val = self_->getMaxJointVelocity();
        return return_val;
    }

    void physx_PxArticulationJointReducedCoordinate_setJointPosition_mut(physx_PxArticulationJointReducedCoordinate_Pod* self__pod, int32_t axis_pod, float jointPos) {
        physx::PxArticulationJointReducedCoordinate* self_ = reinterpret_cast<physx::PxArticulationJointReducedCoordinate*>(self__pod);
        auto axis = static_cast<physx::PxArticulationAxis::Enum>(axis_pod);
        self_->setJointPosition(axis, jointPos);
    }

    float physx_PxArticulationJointReducedCoordinate_getJointPosition(physx_PxArticulationJointReducedCoordinate_Pod const* self__pod, int32_t axis_pod) {
        physx::PxArticulationJointReducedCoordinate const* self_ = reinterpret_cast<physx::PxArticulationJointReducedCoordinate const*>(self__pod);
        auto axis = static_cast<physx::PxArticulationAxis::Enum>(axis_pod);
    ...
    void physx_PxArticulationJointReducedCoordinate_setJointVelocity_mut(physx_PxArticulationJointReducedCoordinate_Pod* self__pod, int32_t axis_pod, float jointVel) {
        physx::PxArticulationJointReducedCoordinate* self_ = reinterpret_cast<physx::PxArticulationJointReducedCoordinate*>(self__pod);
        auto axis = static_cast<physx::PxArticulationAxis::Enum>(axis_pod);
        self_->setJointVelocity(axis, jointVel);
    }

    float physx_PxArticulationJointReducedCoordinate_getJointVelocity(physx_PxArticulationJointReducedCoordinate_Pod const* self__pod, int32_t axis_pod) {
        physx::PxArticulationJointReducedCoordinate const* self_ = reinterpret_cast<physx::PxArticulationJointReducedCoordinate const*>(self__pod);
        auto axis = static_cast<physx::PxArticulationAxis::Enum>(axis_pod);
    ...
    char const* physx_PxArticulationJointReducedCoordinate_getConcreteTypeName(physx_PxArticulationJointReducedCoordinate_Pod const* self__pod) {
        physx::PxArticulationJointReducedCoordinate const* self_ = reinterpret_cast<physx::PxArticulationJointReducedCoordinate const*>(self__pod);
        char const* return_val = self_->getConcreteTypeName();
        return return_val;
    }

    void physx_PxShape_release_mut(physx_PxShape_Pod* self__pod) {
        physx::PxShape* self_ = reinterpret_cast<physx::PxShape*>(self__pod);
        self_->release();
    }

    void physx_PxShape_setGeometry_mut(physx_PxShape_Pod* self__pod, physx_PxGeometry_Pod const* geometry_pod) {
        physx::PxShape* self_ = reinterpret_cast<physx::PxShape*>(self__pod);
        physx::PxGeometry const& geometry = reinterpret_cast<physx::PxGeometry const&>(*geometry_pod);
        self_->setGeometry(geometry);
    }

    physx_PxGeometry_Pod const* physx_PxShape_getGeometry(physx_PxShape_Pod const* self__pod) {
    ...
    physx_PxRigidActor_Pod* physx_PxShape_getActor(physx_PxShape_Pod const* self__pod) {
        physx::PxShape const* self_ = reinterpret_cast<physx::PxShape const*>(self__pod);
    ...
    void physx_PxShape_setLocalPose_mut(physx_PxShape_Pod* self__pod, physx_PxTransform_Pod const* pose_pod) {
        physx::PxShape* self_ = reinterpret_cast<physx::PxShape*>(self__pod);
        physx::PxTransform const& pose = reinterpret_cast<physx::PxTransform const&>(*pose_pod);
        self_->setLocalPose(pose);
    }

    physx_PxTransform_Pod physx_PxShape_getLocalPose(physx_PxShape_Pod const* self__pod) {
        physx::PxShape const* self_ = reinterpret_cast<physx::PxShape const*>(self__pod);
    ...
    void physx_PxShape_setSimulationFilterData_mut(physx_PxShape_Pod* self__pod, physx_PxFilterData_Pod const* data_pod) {
        physx::PxShape* self_ = reinterpret_cast<physx::PxShape*>(self__pod);
        physx::PxFilterData const& data = reinterpret_cast<physx::PxFilterData const&>(*data_pod);
        self_->setSimulationFilterData(data);
    }

    physx_PxFilterData_Pod physx_PxShape_getSimulationFilterData(physx_PxShape_Pod const* self__pod) {
        physx::PxShape const* self_ = reinterpret_cast<physx::PxShape const*>(self__pod);
    ...
    void physx_PxShape_setQueryFilterData_mut(physx_PxShape_Pod* self__pod, physx_PxFilterData_Pod const* data_pod) {
        physx::PxShape* self_ = reinterpret_cast<physx::PxShape*>(self__pod);
        physx::PxFilterData const& data = reinterpret_cast<physx::PxFilterData const&>(*data_pod);
        self_->setQueryFilterData(data);
    }

    physx_PxFilterData_Pod physx_PxShape_getQueryFilterData(physx_PxShape_Pod const* self__pod) {
        physx::PxShape const* self_ = reinterpret_cast<physx::PxShape const*>(self__pod);
    ...
    void physx_PxShape_setMaterials_mut(physx_PxShape_Pod* self__pod, physx_PxMaterial_Pod* const* materials_pod, uint16_t materialCount) {
        physx::PxShape* self_ = reinterpret_cast<physx::PxShape*>(self__pod);
    ...
    uint16_t physx_PxShape_getNbMaterials(physx_PxShape_Pod const* self__pod) {
        physx::PxShape const* self_ = reinterpret_cast<physx::PxShape const*>(self__pod);
        uint16_t return_val = self_->getNbMaterials();
        return return_val;
    }

    uint32_t physx_PxShape_getMaterials(physx_PxShape_Pod const* self__pod, physx_PxMaterial_Pod** userBuffer_pod, uint32_t bufferSize, uint32_t startIndex) {
        physx::PxShape const* self_ = reinterpret_cast<physx::PxShape const*>(self__pod);
    ...
    physx_PxBaseMaterial_Pod* physx_PxShape_getMaterialFromInternalFaceIndex(physx_PxShape_Pod const* self__pod, uint32_t faceIndex) {
        physx::PxShape const* self_ = reinterpret_cast<physx::PxShape const*>(self__pod);
    ...
    void physx_PxShape_setContactOffset_mut(physx_PxShape_Pod* self__pod, float contactOffset) {
        physx::PxShape* self_ = reinterpret_cast<physx::PxShape*>(self__pod);
        self_->setContactOffset(contactOffset);
    }

    float physx_PxShape_getContactOffset(physx_PxShape_Pod const* self__pod) {
        physx::PxShape const* self_ = reinterpret_cast<physx::PxShape const*>(self__pod);
        float return_val = self_->getContactOffset();
        return return_val;
    }

    void physx_PxShape_setRestOffset_mut(physx_PxShape_Pod* self__pod, float restOffset) {
        physx::PxShape* self_ = reinterpret_cast<physx::PxShape*>(self__pod);
        self_->setRestOffset(restOffset);
    }

    float physx_PxShape_getRestOffset(physx_PxShape_Pod const* self__pod) {
        physx::PxShape const* self_ = reinterpret_cast<physx::PxShape const*>(self__pod);
        float return_val = self_->getRestOffset();
        return return_val;
    }

    void physx_PxShape_setDensityForFluid_mut(physx_PxShape_Pod* self__pod, float densityForFluid) {
        physx::PxShape* self_ = reinterpret_cast<physx::PxShape*>(self__pod);
        self_->setDensityForFluid(densityForFluid);
    }

    float physx_PxShape_getDensityForFluid(physx_PxShape_Pod const* self__pod) {
        physx::PxShape const* self_ = reinterpret_cast<physx::PxShape const*>(self__pod);
        float return_val = self_->getDensityForFluid();
        return return_val;
    }

    void physx_PxShape_setTorsionalPatchRadius_mut(physx_PxShape_Pod* self__pod, float radius) {
        physx::PxShape* self_ = reinterpret_cast<physx::PxShape*>(self__pod);
        self_->setTorsionalPatchRadius(radius);
    }

    float physx_PxShape_getTorsionalPatchRadius(physx_PxShape_Pod const* self__pod) {
        physx::PxShape const* self_ = reinterpret_cast<physx::PxShape const*>(self__pod);
        float return_val = self_->getTorsionalPatchRadius();
        return return_val;
    }

    void physx_PxShape_setMinTorsionalPatchRadius_mut(physx_PxShape_Pod* self__pod, float radius) {
        physx::PxShape* self_ = reinterpret_cast<physx::PxShape*>(self__pod);
        self_->setMinTorsionalPatchRadius(radius);
    }

    float physx_PxShape_getMinTorsionalPatchRadius(physx_PxShape_Pod const* self__pod) {
        physx::PxShape const* self_ = reinterpret_cast<physx::PxShape const*>(self__pod);
        float return_val = self_->getMinTorsionalPatchRadius();
        return return_val;
    }

    void physx_PxShape_setFlag_mut(physx_PxShape_Pod* self__pod, int32_t flag_pod, bool value) {
        physx::PxShape* self_ = reinterpret_cast<physx::PxShape*>(self__pod);
        auto flag = static_cast<physx::PxShapeFlag::Enum>(flag_pod);
        self_->setFlag(flag, value);
    }

    void physx_PxShape_setFlags_mut(physx_PxShape_Pod* self__pod, uint8_t inFlags_pod) {
        physx::PxShape* self_ = reinterpret_cast<physx::PxShape*>(self__pod);
        auto inFlags = physx::PxShapeFlags(inFlags_pod);
        self_->setFlags(inFlags);
    }

    uint8_t physx_PxShape_getFlags(physx_PxShape_Pod const* self__pod) {
        physx::PxShape const* self_ = reinterpret_cast<physx::PxShape const*>(self__pod);
    ...
    bool physx_PxShape_isExclusive(physx_PxShape_Pod const* self__pod) {
        physx::PxShape const* self_ = reinterpret_cast<physx::PxShape const*>(self__pod);
        bool return_val = self_->isExclusive();
        return return_val;
    }

    void physx_PxShape_setName_mut(physx_PxShape_Pod* self__pod, char const* name) {
        physx::PxShape* self_ = reinterpret_cast<physx::PxShape*>(self__pod);
        self_->setName(name);
    }

    char const* physx_PxShape_getName(physx_PxShape_Pod const* self__pod) {
        physx::PxShape const* self_ = reinterpret_cast<physx::PxShape const*>(self__pod);
        char const* return_val = self_->getName();
        return return_val;
    }

    char const* physx_PxShape_getConcreteTypeName(physx_PxShape_Pod const* self__pod) {
        physx::PxShape const* self_ = reinterpret_cast<physx::PxShape const*>(self__pod);
        char const* return_val = self_->getConcreteTypeName();
        return return_val;
    }

    void physx_PxRigidActor_release_mut(physx_PxRigidActor_Pod* self__pod) {
        physx::PxRigidActor* self_ = reinterpret_cast<physx::PxRigidActor*>(self__pod);
        self_->release();
    }

    uint32_t physx_PxRigidActor_getInternalActorIndex(physx_PxRigidActor_Pod const* self__pod) {
    ...
    physx_PxTransform_Pod physx_PxRigidActor_getGlobalPose(physx_PxRigidActor_Pod const* self__pod) {
        physx::PxRigidActor const* self_ = reinterpret_cast<physx::PxRigidActor const*>(self__pod);
    ...
    void physx_PxRigidActor_setGlobalPose_mut(physx_PxRigidActor_Pod* self__pod, physx_PxTransform_Pod const* pose_pod, bool autowake) {
        physx::PxRigidActor* self_ = reinterpret_cast<physx::PxRigidActor*>(self__pod);
        physx::PxTransform const& pose = reinterpret_cast<physx::PxTransform const&>(*pose_pod);
        self_->setGlobalPose(pose, autowake);
    }

    bool physx_PxRigidActor_attachShape_mut(physx_PxRigidActor_Pod* self__pod, physx_PxShape_Pod* shape_pod) {
        physx::PxRigidActor* self_ = reinterpret_cast<physx::PxRigidActor*>(self__pod);
    ...
    void physx_PxRigidActor_detachShape_mut(physx_PxRigidActor_Pod* self__pod, physx_PxShape_Pod* shape_pod, bool wakeOnLostTouch) {
        physx::PxRigidActor* self_ = reinterpret_cast<physx::PxRigidActor*>(self__pod);
        physx::PxShape& shape = reinterpret_cast<physx::PxShape&>(*shape_pod);
        self_->detachShape(shape, wakeOnLostTouch);
    }

    uint32_t physx_PxRigidActor_getNbShapes(physx_PxRigidActor_Pod const* self__pod) {
        physx::PxRigidActor const* self_ = reinterpret_cast<physx::PxRigidActor const*>(self__pod);
        uint32_t return_val = self_->getNbShapes();
        return return_val;
    }

    uint32_t physx_PxRigidActor_getShapes(physx_PxRigidActor_Pod const* self__pod, physx_PxShape_Pod** userBuffer_pod, uint32_t bufferSize, uint32_t startIndex) {
        physx::PxRigidActor const* self_ = reinterpret_cast<physx::PxRigidActor const*>(self__pod);
    ...
    uint32_t physx_PxRigidActor_getNbConstraints(physx_PxRigidActor_Pod const* self__pod) {
        physx::PxRigidActor const* self_ = reinterpret_cast<physx::PxRigidActor const*>(self__pod);
        uint32_t return_val = self_->getNbConstraints();
        return return_val;
    }

    uint32_t physx_PxRigidActor_getConstraints(physx_PxRigidActor_Pod const* self__pod, physx_PxConstraint_Pod** userBuffer_pod, uint32_t bufferSize, uint32_t startIndex) {
        physx::PxRigidActor const* self_ = reinterpret_cast<physx::PxRigidActor const*>(self__pod);
        physx::PxConstraint** userBuffer = reinterpret_cast<physx::PxConstraint**>(userBuffer_pod);
    ...
    physx_PxNodeIndex_Pod physx_PxNodeIndex_new(uint32_t id, uint32_t articLinkId) {
    ...
    physx_PxNodeIndex_Pod physx_PxNodeIndex_new_1(uint32_t id) {
    ...
    uint32_t physx_PxNodeIndex_index(physx_PxNodeIndex_Pod const* self__pod) {
        physx::PxNodeIndex const* self_ = reinterpret_cast<physx::PxNodeIndex const*>(self__pod);
        uint32_t return_val = self_->index();
        return return_val;
    }

    uint32_t physx_PxNodeIndex_articulationLinkId(physx_PxNodeIndex_Pod const* self__pod) {
        physx::PxNodeIndex const* self_ = reinterpret_cast<physx::PxNodeIndex const*>(self__pod);
        uint32_t return_val = self_->articulationLinkId();
        return return_val;
    }

    uint32_t physx_PxNodeIndex_isArticulation(physx_PxNodeIndex_Pod const* self__pod) {
        physx::PxNodeIndex const* self_ = reinterpret_cast<physx::PxNodeIndex const*>(self__pod);
        uint32_t return_val = self_->isArticulation();
        return return_val;
    }

    bool physx_PxNodeIndex_isStaticBody(physx_PxNodeIndex_Pod const* self__pod) {
        physx::PxNodeIndex const* self_ = reinterpret_cast<physx::PxNodeIndex const*>(self__pod);
        bool return_val = self_->isStaticBody();
        return return_val;
    }

    bool physx_PxNodeIndex_isValid(physx_PxNodeIndex_Pod const* self__pod) {
        physx::PxNodeIndex const* self_ = reinterpret_cast<physx::PxNodeIndex const*>(self__pod);
        bool return_val = self_->isValid();
        return return_val;
    }

    void physx_PxNodeIndex_setIndices_mut(physx_PxNodeIndex_Pod* self__pod, uint32_t index, uint32_t articLinkId) {
        physx::PxNodeIndex* self_ = reinterpret_cast<physx::PxNodeIndex*>(self__pod);
        self_->setIndices(index, articLinkId);
    }

    void physx_PxNodeIndex_setIndices_mut_1(physx_PxNodeIndex_Pod* self__pod, uint32_t index) {
        physx::PxNodeIndex* self_ = reinterpret_cast<physx::PxNodeIndex*>(self__pod);
        self_->setIndices(index);
    }

    uint64_t physx_PxNodeIndex_getInd(physx_PxNodeIndex_Pod const* self__pod) {
        physx::PxNodeIndex const* self_ = reinterpret_cast<physx::PxNodeIndex const*>(self__pod);
        uint64_t return_val = self_->getInd();
        return return_val;
    }

    void physx_PxRigidBody_setCMassLocalPose_mut(physx_PxRigidBody_Pod* self__pod, physx_PxTransform_Pod const* pose_pod) {
        physx::PxRigidBody* self_ = reinterpret_cast<physx::PxRigidBody*>(self__pod);
        physx::PxTransform const& pose = reinterpret_cast<physx::PxTransform const&>(*pose_pod);
        self_->setCMassLocalPose(pose);
    }

    physx_PxTransform_Pod physx_PxRigidBody_getCMassLocalPose(physx_PxRigidBody_Pod const* self__pod) {
    ...
    void physx_PxRigidBody_setMass_mut(physx_PxRigidBody_Pod* self__pod, float mass) {
        physx::PxRigidBody* self_ = reinterpret_cast<physx::PxRigidBody*>(self__pod);
        self_->setMass(mass);
    }

    float physx_PxRigidBody_getMass(physx_PxRigidBody_Pod const* self__pod) {
        physx::PxRigidBody const* self_ = reinterpret_cast<physx::PxRigidBody const*>(self__pod);
        float return_val = self_->getMass();
        return return_val;
    }

    float physx_PxRigidBody_getInvMass(physx_PxRigidBody_Pod const* self__pod) {
        physx::PxRigidBody const* self_ = reinterpret_cast<physx::PxRigidBody const*>(self__pod);
        float return_val = self_->getInvMass();
        return return_val;
    }

    void physx_PxRigidBody_setMassSpaceInertiaTensor_mut(physx_PxRigidBody_Pod* self__pod, physx_PxVec3_Pod const* m_pod) {
        physx::PxRigidBody* self_ = reinterpret_cast<physx::PxRigidBody*>(self__pod);
        physx::PxVec3 const& m = reinterpret_cast<physx::PxVec3 const&>(*m_pod);
        self_->setMassSpaceInertiaTensor(m);
    }

    physx_PxVec3_Pod physx_PxRigidBody_getMassSpaceInertiaTensor(physx_PxRigidBody_Pod const* self__pod) {
        physx::PxRigidBody const* self_ = reinterpret_cast<physx::PxRigidBody const*>(self__pod);
    ...
    physx_PxVec3_Pod physx_PxRigidBody_getMassSpaceInvInertiaTensor(physx_PxRigidBody_Pod const* self__pod) {
        physx::PxRigidBody const* self_ = reinterpret_cast<physx::PxRigidBody const*>(self__pod);
    ...
    void physx_PxRigidBody_setLinearDamping_mut(physx_PxRigidBody_Pod* self__pod, float linDamp) {
        physx::PxRigidBody* self_ = reinterpret_cast<physx::PxRigidBody*>(self__pod);
        self_->setLinearDamping(linDamp);
    }

    float physx_PxRigidBody_getLinearDamping(physx_PxRigidBody_Pod const* self__pod) {
        physx::PxRigidBody const* self_ = reinterpret_cast<physx::PxRigidBody const*>(self__pod);
        float return_val = self_->getLinearDamping();
        return return_val;
    }

    void physx_PxRigidBody_setAngularDamping_mut(physx_PxRigidBody_Pod* self__pod, float angDamp) {
        physx::PxRigidBody* self_ = reinterpret_cast<physx::PxRigidBody*>(self__pod);
        self_->setAngularDamping(angDamp);
    }

    float physx_PxRigidBody_getAngularDamping(physx_PxRigidBody_Pod const* self__pod) {
        physx::PxRigidBody const* self_ = reinterpret_cast<physx::PxRigidBody const*>(self__pod);
        float return_val = self_->getAngularDamping();
        return return_val;
    }

    physx_PxVec3_Pod physx_PxRigidBody_getLinearVelocity(physx_PxRigidBody_Pod const* self__pod) {
        physx::PxRigidBody const* self_ = reinterpret_cast<physx::PxRigidBody const*>(self__pod);
    ...
    physx_PxVec3_Pod physx_PxRigidBody_getAngularVelocity(physx_PxRigidBody_Pod const* self__pod) {
        physx::PxRigidBody const* self_ = reinterpret_cast<physx::PxRigidBody const*>(self__pod);
    ...
    void physx_PxRigidBody_setMaxLinearVelocity_mut(physx_PxRigidBody_Pod* self__pod, float maxLinVel) {
        physx::PxRigidBody* self_ = reinterpret_cast<physx::PxRigidBody*>(self__pod);
        self_->setMaxLinearVelocity(maxLinVel);
    }

    float physx_PxRigidBody_getMaxLinearVelocity(physx_PxRigidBody_Pod const* self__pod) {
        physx::PxRigidBody const* self_ = reinterpret_cast<physx::PxRigidBody const*>(self__pod);
        float return_val = self_->getMaxLinearVelocity();
        return return_val;
    }

    void physx_PxRigidBody_setMaxAngularVelocity_mut(physx_PxRigidBody_Pod* self__pod, float maxAngVel) {
        physx::PxRigidBody* self_ = reinterpret_cast<physx::PxRigidBody*>(self__pod);
        self_->setMaxAngularVelocity(maxAngVel);
    }

    float physx_PxRigidBody_getMaxAngularVelocity(physx_PxRigidBody_Pod const* self__pod) {
        physx::PxRigidBody const* self_ = reinterpret_cast<physx::PxRigidBody const*>(self__pod);
        float return_val = self_->getMaxAngularVelocity();
        return return_val;
    }

    void physx_PxRigidBody_addForce_mut(physx_PxRigidBody_Pod* self__pod, physx_PxVec3_Pod const* force_pod, int32_t mode_pod, bool autowake) {
        physx::PxRigidBody* self_ = reinterpret_cast<physx::PxRigidBody*>(self__pod);
    ...
    void physx_PxRigidBody_addTorque_mut(physx_PxRigidBody_Pod* self__pod, physx_PxVec3_Pod const* torque_pod, int32_t mode_pod, bool autowake) {
        physx::PxRigidBody* self_ = reinterpret_cast<physx::PxRigidBody*>(self__pod);
    ...
    void physx_PxRigidBody_clearForce_mut(physx_PxRigidBody_Pod* self__pod, int32_t mode_pod) {
        physx::PxRigidBody* self_ = reinterpret_cast<physx::PxRigidBody*>(self__pod);
        auto mode = static_cast<physx::PxForceMode::Enum>(mode_pod);
        self_->clearForce(mode);
    }

    void physx_PxRigidBody_clearTorque_mut(physx_PxRigidBody_Pod* self__pod, int32_t mode_pod) {
        physx::PxRigidBody* self_ = reinterpret_cast<physx::PxRigidBody*>(self__pod);
        auto mode = static_cast<physx::PxForceMode::Enum>(mode_pod);
        self_->clearTorque(mode);
    }

    void physx_PxRigidBody_setForceAndTorque_mut(physx_PxRigidBody_Pod* self__pod, physx_PxVec3_Pod const* force_pod, physx_PxVec3_Pod const* torque_pod, int32_t mode_pod) {
        physx::PxRigidBody* self_ = reinterpret_cast<physx::PxRigidBody*>(self__pod);
        physx::PxVec3 const& force = reinterpret_cast<physx::PxVec3 const&>(*force_pod);
        physx::PxVec3 const& torque = reinterpret_cast<physx::PxVec3 const&>(*torque_pod);
        auto mode = static_cast<physx::PxForceMode::Enum>(mode_pod);
    ...
    void physx_PxRigidBody_setRigidBodyFlag_mut(physx_PxRigidBody_Pod* self__pod, int32_t flag_pod, bool value) {
        physx::PxRigidBody* self_ = reinterpret_cast<physx::PxRigidBody*>(self__pod);
        auto flag = static_cast<physx::PxRigidBodyFlag::Enum>(flag_pod);
        self_->setRigidBodyFlag(flag, value);
    }

    void physx_PxRigidBody_setRigidBodyFlags_mut(physx_PxRigidBody_Pod* self__pod, uint16_t inFlags_pod) {
        physx::PxRigidBody* self_ = reinterpret_cast<physx::PxRigidBody*>(self__pod);
        auto inFlags = physx::PxRigidBodyFlags(inFlags_pod);
        self_->setRigidBodyFlags(inFlags);
    }

    uint16_t physx_PxRigidBody_getRigidBodyFlags(physx_PxRigidBody_Pod const* self__pod) {
        physx::PxRigidBody const* self_ = reinterpret_cast<physx::PxRigidBody const*>(self__pod);
    ...
    void physx_PxRigidBody_setMinCCDAdvanceCoefficient_mut(physx_PxRigidBody_Pod* self__pod, float advanceCoefficient) {
        physx::PxRigidBody* self_ = reinterpret_cast<physx::PxRigidBody*>(self__pod);
        self_->setMinCCDAdvanceCoefficient(advanceCoefficient);
    }

    float physx_PxRigidBody_getMinCCDAdvanceCoefficient(physx_PxRigidBody_Pod const* self__pod) {
        physx::PxRigidBody const* self_ = reinterpret_cast<physx::PxRigidBody const*>(self__pod);
        float return_val = self_->getMinCCDAdvanceCoefficient();
        return return_val;
    }

    void physx_PxRigidBody_setMaxDepenetrationVelocity_mut(physx_PxRigidBody_Pod* self__pod, float biasClamp) {
        physx::PxRigidBody* self_ = reinterpret_cast<physx::PxRigidBody*>(self__pod);
        self_->setMaxDepenetrationVelocity(biasClamp);
    }

    float physx_PxRigidBody_getMaxDepenetrationVelocity(physx_PxRigidBody_Pod const* self__pod) {
        physx::PxRigidBody const* self_ = reinterpret_cast<physx::PxRigidBody const*>(self__pod);
        float return_val = self_->getMaxDepenetrationVelocity();
        return return_val;
    }

    void physx_PxRigidBody_setMaxContactImpulse_mut(physx_PxRigidBody_Pod* self__pod, float maxImpulse) {
        physx::PxRigidBody* self_ = reinterpret_cast<physx::PxRigidBody*>(self__pod);
        self_->setMaxContactImpulse(maxImpulse);
    }

    float physx_PxRigidBody_getMaxContactImpulse(physx_PxRigidBody_Pod const* self__pod) {
        physx::PxRigidBody const* self_ = reinterpret_cast<physx::PxRigidBody const*>(self__pod);
        float return_val = self_->getMaxContactImpulse();
        return return_val;
    }

    void physx_PxRigidBody_setContactSlopCoefficient_mut(physx_PxRigidBody_Pod* self__pod, float slopCoefficient) {
        physx::PxRigidBody* self_ = reinterpret_cast<physx::PxRigidBody*>(self__pod);
        self_->setContactSlopCoefficient(slopCoefficient);
    }

    float physx_PxRigidBody_getContactSlopCoefficient(physx_PxRigidBody_Pod const* self__pod) {
        physx::PxRigidBody const* self_ = reinterpret_cast<physx::PxRigidBody const*>(self__pod);
        float return_val = self_->getContactSlopCoefficient();
        return return_val;
    }

    physx_PxNodeIndex_Pod physx_PxRigidBody_getInternalIslandNodeIndex(physx_PxRigidBody_Pod const* self__pod) {
        physx::PxRigidBody const* self_ = reinterpret_cast<physx::PxRigidBody const*>(self__pod);
    ...
    void physx_PxArticulationLink_release_mut(physx_PxArticulationLink_Pod* self__pod) {
        physx::PxArticulationLink* self_ = reinterpret_cast<physx::PxArticulationLink*>(self__pod);
        self_->release();
    }

    physx_PxArticulationReducedCoordinate_Pod* physx_PxArticulationLink_getArticulation(physx_PxArticulationLink_Pod const* self__pod) {
    ...
    physx_PxArticulationJointReducedCoordinate_Pod* physx_PxArticulationLink_getInboundJoint(physx_PxArticulationLink_Pod const* self__pod) {
        physx::PxArticulationLink const* self_ = reinterpret_cast<physx::PxArticulationLink const*>(self__pod);
    ...
    uint32_t physx_PxArticulationLink_getInboundJointDof(physx_PxArticulationLink_Pod const* self__pod) {
        physx::PxArticulationLink const* self_ = reinterpret_cast<physx::PxArticulationLink const*>(self__pod);
        uint32_t return_val = self_->getInboundJointDof();
        return return_val;
    }

    uint32_t physx_PxArticulationLink_getNbChildren(physx_PxArticulationLink_Pod const* self__pod) {
        physx::PxArticulationLink const* self_ = reinterpret_cast<physx::PxArticulationLink const*>(self__pod);
        uint32_t return_val = self_->getNbChildren();
        return return_val;
    }

    uint32_t physx_PxArticulationLink_getLinkIndex(physx_PxArticulationLink_Pod const* self__pod) {
        physx::PxArticulationLink const* self_ = reinterpret_cast<physx::PxArticulationLink const*>(self__pod);
        uint32_t return_val = self_->getLinkIndex();
        return return_val;
    }

    uint32_t physx_PxArticulationLink_getChildren(physx_PxArticulationLink_Pod const* self__pod, physx_PxArticulationLink_Pod** userBuffer_pod, uint32_t bufferSize, uint32_t startIndex) {
        physx::PxArticulationLink const* self_ = reinterpret_cast<physx::PxArticulationLink const*>(self__pod);
        physx::PxArticulationLink** userBuffer = reinterpret_cast<physx::PxArticulationLink**>(userBuffer_pod);
    ...
    void physx_PxArticulationLink_setCfmScale_mut(physx_PxArticulationLink_Pod* self__pod, float cfm) {
        physx::PxArticulationLink* self_ = reinterpret_cast<physx::PxArticulationLink*>(self__pod);
        self_->setCfmScale(cfm);
    }

    float physx_PxArticulationLink_getCfmScale(physx_PxArticulationLink_Pod const* self__pod) {
        physx::PxArticulationLink const* self_ = reinterpret_cast<physx::PxArticulationLink const*>(self__pod);
        float return_val = self_->getCfmScale();
        return return_val;
    }

    physx_PxVec3_Pod physx_PxArticulationLink_getLinearVelocity(physx_PxArticulationLink_Pod const* self__pod) {
        physx::PxArticulationLink const* self_ = reinterpret_cast<physx::PxArticulationLink const*>(self__pod);
        physx::PxVec3 return_val = self_->getLinearVelocity();
        physx_PxVec3_Pod return_val_pod;
        memcpy(&return_val_pod, &return_val, sizeof(return_val_pod));
    ...
    physx_PxVec3_Pod physx_PxArticulationLink_getAngularVelocity(physx_PxArticulationLink_Pod const* self__pod) {
        physx::PxArticulationLink const* self_ = reinterpret_cast<physx::PxArticulationLink const*>(self__pod);
        physx::PxVec3 return_val = self_->getAngularVelocity();
        physx_PxVec3_Pod return_val_pod;
        memcpy(&return_val_pod, &return_val, sizeof(return_val_pod));
    ...
    char const* physx_PxArticulationLink_getConcreteTypeName(physx_PxArticulationLink_Pod const* self__pod) {
        physx::PxArticulationLink const* self_ = reinterpret_cast<physx::PxArticulationLink const*>(self__pod);
        char const* return_val = self_->getConcreteTypeName();
        return return_val;
    }

    physx_PxConeLimitedConstraint_Pod physx_PxConeLimitedConstraint_new() {
    ...
    void physx_PxConstraint_release_mut(physx_PxConstraint_Pod* self__pod) {
        physx::PxConstraint* self_ = reinterpret_cast<physx::PxConstraint*>(self__pod);
        self_->release();
    }

    physx_PxScene_Pod* physx_PxConstraint_getScene(physx_PxConstraint_Pod const* self__pod) {
    ...
    void physx_PxConstraint_getActors(physx_PxConstraint_Pod const* self__pod, physx_PxRigidActor_Pod** actor0_pod, physx_PxRigidActor_Pod** actor1_pod) {
        physx::PxConstraint const* self_ = reinterpret_cast<physx::PxConstraint const*>(self__pod);
    ...
    void physx_PxConstraint_setActors_mut(physx_PxConstraint_Pod* self__pod, physx_PxRigidActor_Pod* actor0_pod, physx_PxRigidActor_Pod* actor1_pod) {
        physx::PxConstraint* self_ = reinterpret_cast<physx::PxConstraint*>(self__pod);
        physx::PxRigidActor* actor0 = reinterpret_cast<physx::PxRigidActor*>(actor0_pod);
        physx::PxRigidActor* actor1 = reinterpret_cast<physx::PxRigidActor*>(actor1_pod);
    ...
    void physx_PxConstraint_markDirty_mut(physx_PxConstraint_Pod* self__pod) {
        physx::PxConstraint* self_ = reinterpret_cast<physx::PxConstraint*>(self__pod);
        self_->markDirty();
    }

    uint16_t physx_PxConstraint_getFlags(physx_PxConstraint_Pod const* self__pod) {
        physx::PxConstraint const* self_ = reinterpret_cast<physx::PxConstraint const*>(self__pod);
    ...
    void physx_PxConstraint_setFlags_mut(physx_PxConstraint_Pod* self__pod, uint16_t flags_pod) {
        physx::PxConstraint* self_ = reinterpret_cast<physx::PxConstraint*>(self__pod);
        auto flags = physx::PxConstraintFlags(flags_pod);
        self_->setFlags(flags);
    }

    void physx_PxConstraint_setFlag_mut(physx_PxConstraint_Pod* self__pod, int32_t flag_pod, bool value) {
        physx::PxConstraint* self_ = reinterpret_cast<physx::PxConstraint*>(self__pod);
        auto flag = static_cast<physx::PxConstraintFlag::Enum>(flag_pod);
        self_->setFlag(flag, value);
    }

    void physx_PxConstraint_getForce(physx_PxConstraint_Pod const* self__pod, physx_PxVec3_Pod* linear_pod, physx_PxVec3_Pod* angular_pod) {
        physx::PxConstraint const* self_ = reinterpret_cast<physx::PxConstraint const*>(self__pod);
    ...
    bool physx_PxConstraint_isValid(physx_PxConstraint_Pod const* self__pod) {
        physx::PxConstraint const* self_ = reinterpret_cast<physx::PxConstraint const*>(self__pod);
        bool return_val = self_->isValid();
        return return_val;
    }

    void physx_PxConstraint_setBreakForce_mut(physx_PxConstraint_Pod* self__pod, float linear, float angular) {
        physx::PxConstraint* self_ = reinterpret_cast<physx::PxConstraint*>(self__pod);
        self_->setBreakForce(linear, angular);
    }

    void physx_PxConstraint_getBreakForce(physx_PxConstraint_Pod const* self__pod, float* linear_pod, float* angular_pod) {
        physx::PxConstraint const* self_ = reinterpret_cast<physx::PxConstraint const*>(self__pod);
    ...
    void physx_PxConstraint_setMinResponseThreshold_mut(physx_PxConstraint_Pod* self__pod, float threshold) {
        physx::PxConstraint* self_ = reinterpret_cast<physx::PxConstraint*>(self__pod);
        self_->setMinResponseThreshold(threshold);
    }

    float physx_PxConstraint_getMinResponseThreshold(physx_PxConstraint_Pod const* self__pod) {
        physx::PxConstraint const* self_ = reinterpret_cast<physx::PxConstraint const*>(self__pod);
        float return_val = self_->getMinResponseThreshold();
        return return_val;
    }

    void* physx_PxConstraint_getExternalReference_mut(physx_PxConstraint_Pod* self__pod, uint32_t* typeID_pod) {
        physx::PxConstraint* self_ = reinterpret_cast<physx::PxConstraint*>(self__pod);
    ...
    void physx_PxConstraint_setConstraintFunctions_mut(physx_PxConstraint_Pod* self__pod, physx_PxConstraintConnector_Pod* connector_pod, physx_PxConstraintShaderTable_Pod const* shaders_pod) {
        physx::PxConstraint* self_ = reinterpret_cast<physx::PxConstraint*>(self__pod);
    ...
    char const* physx_PxConstraint_getConcreteTypeName(physx_PxConstraint_Pod const* self__pod) {
        physx::PxConstraint const* self_ = reinterpret_cast<physx::PxConstraint const*>(self__pod);
        char const* return_val = self_->getConcreteTypeName();
        return return_val;
    }

    physx_PxContactStreamIterator_Pod physx_PxContactStreamIterator_new(uint8_t const* contactPatches, uint8_t const* contactPoints, uint32_t const* contactFaceIndices, uint32_t nbPatches, uint32_t nbContacts) {
    ...
    bool physx_PxContactStreamIterator_hasNextPatch(physx_PxContactStreamIterator_Pod const* self__pod) {
    ...
    uint32_t physx_PxContactStreamIterator_getTotalContactCount(physx_PxContactStreamIterator_Pod const* self__pod) {
        physx::PxContactStreamIterator const* self_ = reinterpret_cast<physx::PxContactStreamIterator const*>(self__pod);
        uint32_t return_val = self_->getTotalContactCount();
        return return_val;
    }

    uint32_t physx_PxContactStreamIterator_getTotalPatchCount(physx_PxContactStreamIterator_Pod const* self__pod) {
        physx::PxContactStreamIterator const* self_ = reinterpret_cast<physx::PxContactStreamIterator const*>(self__pod);
        uint32_t return_val = self_->getTotalPatchCount();
        return return_val;
    }

    void physx_PxContactStreamIterator_nextPatch_mut(physx_PxContactStreamIterator_Pod* self__pod) {
        physx::PxContactStreamIterator* self_ = reinterpret_cast<physx::PxContactStreamIterator*>(self__pod);
        self_->nextPatch();
    }

    bool physx_PxContactStreamIterator_hasNextContact(physx_PxContactStreamIterator_Pod const* self__pod) {
        physx::PxContactStreamIterator const* self_ = reinterpret_cast<physx::PxContactStreamIterator const*>(self__pod);
        bool return_val = self_->hasNextContact();
        return return_val;
    }

    void physx_PxContactStreamIterator_nextContact_mut(physx_PxContactStreamIterator_Pod* self__pod) {
        physx::PxContactStreamIterator* self_ = reinterpret_cast<physx::PxContactStreamIterator*>(self__pod);
        self_->nextContact();
    }

    physx_PxVec3_Pod const* physx_PxContactStreamIterator_getContactNormal(physx_PxContactStreamIterator_Pod const* self__pod) {
        physx::PxContactStreamIterator const* self_ = reinterpret_cast<physx::PxContactStreamIterator const*>(self__pod);
    ...
    float physx_PxContactStreamIterator_getInvMassScale0(physx_PxContactStreamIterator_Pod const* self__pod) {
        physx::PxContactStreamIterator const* self_ = reinterpret_cast<physx::PxContactStreamIterator const*>(self__pod);
        float return_val = self_->getInvMassScale0();
        return return_val;
    }

    float physx_PxContactStreamIterator_getInvMassScale1(physx_PxContactStreamIterator_Pod const* self__pod) {
        physx::PxContactStreamIterator const* self_ = reinterpret_cast<physx::PxContactStreamIterator const*>(self__pod);
        float return_val = self_->getInvMassScale1();
        return return_val;
    }

    float physx_PxContactStreamIterator_getInvInertiaScale0(physx_PxContactStreamIterator_Pod const* self__pod) {
        physx::PxContactStreamIterator const* self_ = reinterpret_cast<physx::PxContactStreamIterator const*>(self__pod);
        float return_val = self_->getInvInertiaScale0();
        return return_val;
    }

    float physx_PxContactStreamIterator_getInvInertiaScale1(physx_PxContactStreamIterator_Pod const* self__pod) {
        physx::PxContactStreamIterator const* self_ = reinterpret_cast<physx::PxContactStreamIterator const*>(self__pod);
        float return_val = self_->getInvInertiaScale1();
        return return_val;
    }

    float physx_PxContactStreamIterator_getMaxImpulse(physx_PxContactStreamIterator_Pod const* self__pod) {
        physx::PxContactStreamIterator const* self_ = reinterpret_cast<physx::PxContactStreamIterator const*>(self__pod);
        float return_val = self_->getMaxImpulse();
        return return_val;
    }

    physx_PxVec3_Pod const* physx_PxContactStreamIterator_getTargetVel(physx_PxContactStreamIterator_Pod const* self__pod) {
        physx::PxContactStreamIterator const* self_ = reinterpret_cast<physx::PxContactStreamIterator const*>(self__pod);
    ...
    physx_PxVec3_Pod const* physx_PxContactStreamIterator_getContactPoint(physx_PxContactStreamIterator_Pod const* self__pod) {
        physx::PxContactStreamIterator const* self_ = reinterpret_cast<physx::PxContactStreamIterator const*>(self__pod);
    ...
    float physx_PxContactStreamIterator_getSeparation(physx_PxContactStreamIterator_Pod const* self__pod) {
        physx::PxContactStreamIterator const* self_ = reinterpret_cast<physx::PxContactStreamIterator const*>(self__pod);
        float return_val = self_->getSeparation();
        return return_val;
    }

    uint32_t physx_PxContactStreamIterator_getFaceIndex0(physx_PxContactStreamIterator_Pod const* self__pod) {
        physx::PxContactStreamIterator const* self_ = reinterpret_cast<physx::PxContactStreamIterator const*>(self__pod);
        uint32_t return_val = self_->getFaceIndex0();
        return return_val;
    }

    uint32_t physx_PxContactStreamIterator_getFaceIndex1(physx_PxContactStreamIterator_Pod const* self__pod) {
        physx::PxContactStreamIterator const* self_ = reinterpret_cast<physx::PxContactStreamIterator const*>(self__pod);
        uint32_t return_val = self_->getFaceIndex1();
        return return_val;
    }

    float physx_PxContactStreamIterator_getStaticFriction(physx_PxContactStreamIterator_Pod const* self__pod) {
        physx::PxContactStreamIterator const* self_ = reinterpret_cast<physx::PxContactStreamIterator const*>(self__pod);
        float return_val = self_->getStaticFriction();
        return return_val;
    }

    float physx_PxContactStreamIterator_getDynamicFriction(physx_PxContactStreamIterator_Pod const* self__pod) {
        physx::PxContactStreamIterator const* self_ = reinterpret_cast<physx::PxContactStreamIterator const*>(self__pod);
        float return_val = self_->getDynamicFriction();
        return return_val;
    }

    float physx_PxContactStreamIterator_getRestitution(physx_PxContactStreamIterator_Pod const* self__pod) {
        physx::PxContactStreamIterator const* self_ = reinterpret_cast<physx::PxContactStreamIterator const*>(self__pod);
        float return_val = self_->getRestitution();
        return return_val;
    }

    float physx_PxContactStreamIterator_getDamping(physx_PxContactStreamIterator_Pod const* self__pod) {
        physx::PxContactStreamIterator const* self_ = reinterpret_cast<physx::PxContactStreamIterator const*>(self__pod);
        float return_val = self_->getDamping();
        return return_val;
    }

    uint32_t physx_PxContactStreamIterator_getMaterialFlags(physx_PxContactStreamIterator_Pod const* self__pod) {
        physx::PxContactStreamIterator const* self_ = reinterpret_cast<physx::PxContactStreamIterator const*>(self__pod);
        uint32_t return_val = self_->getMaterialFlags();
        return return_val;
    }

    uint16_t physx_PxContactStreamIterator_getMaterialIndex0(physx_PxContactStreamIterator_Pod const* self__pod) {
        physx::PxContactStreamIterator const* self_ = reinterpret_cast<physx::PxContactStreamIterator const*>(self__pod);
        uint16_t return_val = self_->getMaterialIndex0();
        return return_val;
    }

    uint16_t physx_PxContactStreamIterator_getMaterialIndex1(physx_PxContactStreamIterator_Pod const* self__pod) {
        physx::PxContactStreamIterator const* self_ = reinterpret_cast<physx::PxContactStreamIterator const*>(self__pod);
        uint16_t return_val = self_->getMaterialIndex1();
        return return_val;
    }

    bool physx_PxContactStreamIterator_advanceToIndex_mut(physx_PxContactStreamIterator_Pod* self__pod, uint32_t initialIndex) {
        physx::PxContactStreamIterator* self_ = reinterpret_cast<physx::PxContactStreamIterator*>(self__pod);
        bool return_val = self_->advanceToIndex(initialIndex);
        return return_val;
    }

    physx_PxVec3_Pod const* physx_PxContactSet_getPoint(physx_PxContactSet_Pod const* self__pod, uint32_t i) {
    ...
    void physx_PxContactSet_setPoint_mut(physx_PxContactSet_Pod* self__pod, uint32_t i, physx_PxVec3_Pod const* p_pod) {
        physx::PxContactSet* self_ = reinterpret_cast<physx::PxContactSet*>(self__pod);
        physx::PxVec3 const& p = reinterpret_cast<physx::PxVec3 const&>(*p_pod);
        self_->setPoint(i, p);
    }

    physx_PxVec3_Pod const* physx_PxContactSet_getNormal(physx_PxContactSet_Pod const* self__pod, uint32_t i) {
        physx::PxContactSet const* self_ = reinterpret_cast<physx::PxContactSet const*>(self__pod);
    ...
    void physx_PxContactSet_setNormal_mut(physx_PxContactSet_Pod* self__pod, uint32_t i, physx_PxVec3_Pod const* n_pod) {
        physx::PxContactSet* self_ = reinterpret_cast<physx::PxContactSet*>(self__pod);
        physx::PxVec3 const& n = reinterpret_cast<physx::PxVec3 const&>(*n_pod);
        self_->setNormal(i, n);
    }

    float physx_PxContactSet_getSeparation(physx_PxContactSet_Pod const* self__pod, uint32_t i) {
        physx::PxContactSet const* self_ = reinterpret_cast<physx::PxContactSet const*>(self__pod);
        float return_val = self_->getSeparation(i);
        return return_val;
    }

    void physx_PxContactSet_setSeparation_mut(physx_PxContactSet_Pod* self__pod, uint32_t i, float s) {
        physx::PxContactSet* self_ = reinterpret_cast<physx::PxContactSet*>(self__pod);
        self_->setSeparation(i, s);
    }

    physx_PxVec3_Pod const* physx_PxContactSet_getTargetVelocity(physx_PxContactSet_Pod const* self__pod, uint32_t i) {
        physx::PxContactSet const* self_ = reinterpret_cast<physx::PxContactSet const*>(self__pod);
    ...
    void physx_PxContactSet_setTargetVelocity_mut(physx_PxContactSet_Pod* self__pod, uint32_t i, physx_PxVec3_Pod const* v_pod) {
        physx::PxContactSet* self_ = reinterpret_cast<physx::PxContactSet*>(self__pod);
        physx::PxVec3 const& v = reinterpret_cast<physx::PxVec3 const&>(*v_pod);
        self_->setTargetVelocity(i, v);
    }

    uint32_t physx_PxContactSet_getInternalFaceIndex0(physx_PxContactSet_Pod const* self__pod, uint32_t i) {
        physx::PxContactSet const* self_ = reinterpret_cast<physx::PxContactSet const*>(self__pod);
        uint32_t return_val = self_->getInternalFaceIndex0(i);
        return return_val;
    }

    uint32_t physx_PxContactSet_getInternalFaceIndex1(physx_PxContactSet_Pod const* self__pod, uint32_t i) {
        physx::PxContactSet const* self_ = reinterpret_cast<physx::PxContactSet const*>(self__pod);
        uint32_t return_val = self_->getInternalFaceIndex1(i);
        return return_val;
    }

    float physx_PxContactSet_getMaxImpulse(physx_PxContactSet_Pod const* self__pod, uint32_t i) {
        physx::PxContactSet const* self_ = reinterpret_cast<physx::PxContactSet const*>(self__pod);
        float return_val = self_->getMaxImpulse(i);
        return return_val;
    }

    void physx_PxContactSet_setMaxImpulse_mut(physx_PxContactSet_Pod* self__pod, uint32_t i, float s) {
        physx::PxContactSet* self_ = reinterpret_cast<physx::PxContactSet*>(self__pod);
        self_->setMaxImpulse(i, s);
    }

    float physx_PxContactSet_getRestitution(physx_PxContactSet_Pod const* self__pod, uint32_t i) {
        physx::PxContactSet const* self_ = reinterpret_cast<physx::PxContactSet const*>(self__pod);
        float return_val = self_->getRestitution(i);
        return return_val;
    }

    void physx_PxContactSet_setRestitution_mut(physx_PxContactSet_Pod* self__pod, uint32_t i, float r) {
        physx::PxContactSet* self_ = reinterpret_cast<physx::PxContactSet*>(self__pod);
        self_->setRestitution(i, r);
    }

    float physx_PxContactSet_getStaticFriction(physx_PxContactSet_Pod const* self__pod, uint32_t i) {
        physx::PxContactSet const* self_ = reinterpret_cast<physx::PxContactSet const*>(self__pod);
        float return_val = self_->getStaticFriction(i);
        return return_val;
    }

    void physx_PxContactSet_setStaticFriction_mut(physx_PxContactSet_Pod* self__pod, uint32_t i, float f) {
        physx::PxContactSet* self_ = reinterpret_cast<physx::PxContactSet*>(self__pod);
        self_->setStaticFriction(i, f);
    }

    float physx_PxContactSet_getDynamicFriction(physx_PxContactSet_Pod const* self__pod, uint32_t i) {
        physx::PxContactSet const* self_ = reinterpret_cast<physx::PxContactSet const*>(self__pod);
        float return_val = self_->getDynamicFriction(i);
        return return_val;
    }

    void physx_PxContactSet_setDynamicFriction_mut(physx_PxContactSet_Pod* self__pod, uint32_t i, float f) {
        physx::PxContactSet* self_ = reinterpret_cast<physx::PxContactSet*>(self__pod);
        self_->setDynamicFriction(i, f);
    }

    void physx_PxContactSet_ignore_mut(physx_PxContactSet_Pod* self__pod, uint32_t i) {
        physx::PxContactSet* self_ = reinterpret_cast<physx::PxContactSet*>(self__pod);
        self_->ignore(i);
    }

    uint32_t physx_PxContactSet_size(physx_PxContactSet_Pod const* self__pod) {
        physx::PxContactSet const* self_ = reinterpret_cast<physx::PxContactSet const*>(self__pod);
        uint32_t return_val = self_->size();
        return return_val;
    }

    float physx_PxContactSet_getInvMassScale0(physx_PxContactSet_Pod const* self__pod) {
        physx::PxContactSet const* self_ = reinterpret_cast<physx::PxContactSet const*>(self__pod);
        float return_val = self_->getInvMassScale0();
        return return_val;
    }

    float physx_PxContactSet_getInvMassScale1(physx_PxContactSet_Pod const* self__pod) {
        physx::PxContactSet const* self_ = reinterpret_cast<physx::PxContactSet const*>(self__pod);
        float return_val = self_->getInvMassScale1();
        return return_val;
    }

    float physx_PxContactSet_getInvInertiaScale0(physx_PxContactSet_Pod const* self__pod) {
        physx::PxContactSet const* self_ = reinterpret_cast<physx::PxContactSet const*>(self__pod);
        float return_val = self_->getInvInertiaScale0();
        return return_val;
    }

    float physx_PxContactSet_getInvInertiaScale1(physx_PxContactSet_Pod const* self__pod) {
        physx::PxContactSet const* self_ = reinterpret_cast<physx::PxContactSet const*>(self__pod);
        float return_val = self_->getInvInertiaScale1();
        return return_val;
    }

    void physx_PxContactSet_setInvMassScale0_mut(physx_PxContactSet_Pod* self__pod, float scale) {
        physx::PxContactSet* self_ = reinterpret_cast<physx::PxContactSet*>(self__pod);
        self_->setInvMassScale0(scale);
    }

    void physx_PxContactSet_setInvMassScale1_mut(physx_PxContactSet_Pod* self__pod, float scale) {
        physx::PxContactSet* self_ = reinterpret_cast<physx::PxContactSet*>(self__pod);
        self_->setInvMassScale1(scale);
    }

    void physx_PxContactSet_setInvInertiaScale0_mut(physx_PxContactSet_Pod* self__pod, float scale) {
        physx::PxContactSet* self_ = reinterpret_cast<physx::PxContactSet*>(self__pod);
        self_->setInvInertiaScale0(scale);
    }

    void physx_PxContactSet_setInvInertiaScale1_mut(physx_PxContactSet_Pod* self__pod, float scale) {
        physx::PxContactSet* self_ = reinterpret_cast<physx::PxContactSet*>(self__pod);
        self_->setInvInertiaScale1(scale);
    }

    void physx_PxContactModifyCallback_onContactModify_mut(physx_PxContactModifyCallback_Pod* self__pod, physx_PxContactModifyPair_Pod*const pairs_pod, uint32_t count) {
    ...
    void physx_PxCCDContactModifyCallback_onCCDContactModify_mut(physx_PxCCDContactModifyCallback_Pod* self__pod, physx_PxContactModifyPair_Pod*const pairs_pod, uint32_t count) {
    ...
    void physx_PxDeletionListener_onRelease_mut(physx_PxDeletionListener_Pod* self__pod, physx_PxBase_Pod const* observed_pod, void* userData, int32_t deletionEvent_pod) {
    ...
    bool physx_PxBaseMaterial_isKindOf(physx_PxBaseMaterial_Pod const* self__pod, char const* name) {
    ...
    void physx_PxFEMMaterial_setYoungsModulus_mut(physx_PxFEMMaterial_Pod* self__pod, float young) {
        physx::PxFEMMaterial* self_ = reinterpret_cast<physx::PxFEMMaterial*>(self__pod);
        self_->setYoungsModulus(young);
    }

    float physx_PxFEMMaterial_getYoungsModulus(physx_PxFEMMaterial_Pod const* self__pod) {
    ...
    void physx_PxFEMMaterial_setPoissons_mut(physx_PxFEMMaterial_Pod* self__pod, float poisson) {
        physx::PxFEMMaterial* self_ = reinterpret_cast<physx::PxFEMMaterial*>(self__pod);
        self_->setPoissons(poisson);
    }

    float physx_PxFEMMaterial_getPoissons(physx_PxFEMMaterial_Pod const* self__pod) {
        physx::PxFEMMaterial const* self_ = reinterpret_cast<physx::PxFEMMaterial const*>(self__pod);
        float return_val = self_->getPoissons();
        return return_val;
    }

    void physx_PxFEMMaterial_setDynamicFriction_mut(physx_PxFEMMaterial_Pod* self__pod, float dynamicFriction) {
        physx::PxFEMMaterial* self_ = reinterpret_cast<physx::PxFEMMaterial*>(self__pod);
        self_->setDynamicFriction(dynamicFriction);
    }

    float physx_PxFEMMaterial_getDynamicFriction(physx_PxFEMMaterial_Pod const* self__pod) {
        physx::PxFEMMaterial const* self_ = reinterpret_cast<physx::PxFEMMaterial const*>(self__pod);
        float return_val = self_->getDynamicFriction();
        return return_val;
    }

    physx_PxFilterData_Pod physx_PxFilterData_new(int32_t anon_param0_pod) {
    ...
    physx_PxFilterData_Pod physx_PxFilterData_new_1() {
    ...
    physx_PxFilterData_Pod physx_PxFilterData_new_2(uint32_t w0, uint32_t w1, uint32_t w2, uint32_t w3) {
    ...
    void physx_PxFilterData_setToDefault_mut(physx_PxFilterData_Pod* self__pod) {
    ...
    void physx_PxSimulationFilterCallback_pairLost_mut(physx_PxSimulationFilterCallback_Pod* self__pod, uint32_t pairID, uint32_t attributes0, physx_PxFilterData_Pod filterData0_pod, uint32_t attributes1, physx_PxFilterData_Pod filterData1_pod, bool objectRemoved) {
        physx::PxSimulationFilterCallback* self_ = reinterpret_cast<physx::PxSimulationFilterCallback*>(self__pod);
        physx::PxFilterData filterData0;
        memcpy(&filterData0, &filterData0_pod, sizeof(filterData0));
        physx::PxFilterData filterData1;
    ...
    bool physx_PxSimulationFilterCallback_statusChange_mut(physx_PxSimulationFilterCallback_Pod* self__pod, uint32_t* pairID_pod, uint16_t* pairFlags_pod, uint16_t* filterFlags_pod) {
        physx::PxSimulationFilterCallback* self_ = reinterpret_cast<physx::PxSimulationFilterCallback*>(self__pod);
    ...
    uint8_t physx_PxLockedData_getDataAccessFlags_mut(physx_PxLockedData_Pod* self__pod) {
    ...
    void physx_PxLockedData_unlock_mut(physx_PxLockedData_Pod* self__pod) {
        physx::PxLockedData* self_ = reinterpret_cast<physx::PxLockedData*>(self__pod);
        self_->unlock();
    }

    void physx_PxLockedData_delete(physx_PxLockedData_Pod* self__pod) {
        physx::PxLockedData* self_ = reinterpret_cast<physx::PxLockedData*>(self__pod);
        delete self_;
    }

    void physx_PxMaterial_setDynamicFriction_mut(physx_PxMaterial_Pod* self__pod, float coef) {
        physx::PxMaterial* self_ = reinterpret_cast<physx::PxMaterial*>(self__pod);
        self_->setDynamicFriction(coef);
    }

    float physx_PxMaterial_getDynamicFriction(physx_PxMaterial_Pod const* self__pod) {
        physx::PxMaterial const* self_ = reinterpret_cast<physx::PxMaterial const*>(self__pod);
        float return_val = self_->getDynamicFriction();
        return return_val;
    }

    void physx_PxMaterial_setStaticFriction_mut(physx_PxMaterial_Pod* self__pod, float coef) {
        physx::PxMaterial* self_ = reinterpret_cast<physx::PxMaterial*>(self__pod);
        self_->setStaticFriction(coef);
    }

    float physx_PxMaterial_getStaticFriction(physx_PxMaterial_Pod const* self__pod) {
        physx::PxMaterial const* self_ = reinterpret_cast<physx::PxMaterial const*>(self__pod);
        float return_val = self_->getStaticFriction();
        return return_val;
    }

    void physx_PxMaterial_setRestitution_mut(physx_PxMaterial_Pod* self__pod, float rest) {
        physx::PxMaterial* self_ = reinterpret_cast<physx::PxMaterial*>(self__pod);
        self_->setRestitution(rest);
    }

    float physx_PxMaterial_getRestitution(physx_PxMaterial_Pod const* self__pod) {
        physx::PxMaterial const* self_ = reinterpret_cast<physx::PxMaterial const*>(self__pod);
        float return_val = self_->getRestitution();
        return return_val;
    }

    void physx_PxMaterial_setDamping_mut(physx_PxMaterial_Pod* self__pod, float damping) {
        physx::PxMaterial* self_ = reinterpret_cast<physx::PxMaterial*>(self__pod);
        self_->setDamping(damping);
    }

    float physx_PxMaterial_getDamping(physx_PxMaterial_Pod const* self__pod) {
        physx::PxMaterial const* self_ = reinterpret_cast<physx::PxMaterial const*>(self__pod);
        float return_val = self_->getDamping();
        return return_val;
    }

    void physx_PxMaterial_setFlag_mut(physx_PxMaterial_Pod* self__pod, int32_t flag_pod, bool b) {
        physx::PxMaterial* self_ = reinterpret_cast<physx::PxMaterial*>(self__pod);
        auto flag = static_cast<physx::PxMaterialFlag::Enum>(flag_pod);
        self_->setFlag(flag, b);
    }

    void physx_PxMaterial_setFlags_mut(physx_PxMaterial_Pod* self__pod, uint16_t flags_pod) {
        physx::PxMaterial* self_ = reinterpret_cast<physx::PxMaterial*>(self__pod);
        auto flags = physx::PxMaterialFlags(flags_pod);
        self_->setFlags(flags);
    }

    uint16_t physx_PxMaterial_getFlags(physx_PxMaterial_Pod const* self__pod) {
        physx::PxMaterial const* self_ = reinterpret_cast<physx::PxMaterial const*>(self__pod);
    ...
    void physx_PxMaterial_setFrictionCombineMode_mut(physx_PxMaterial_Pod* self__pod, int32_t combMode_pod) {
        physx::PxMaterial* self_ = reinterpret_cast<physx::PxMaterial*>(self__pod);
        auto combMode = static_cast<physx::PxCombineMode::Enum>(combMode_pod);
        self_->setFrictionCombineMode(combMode);
    }

    int32_t physx_PxMaterial_getFrictionCombineMode(physx_PxMaterial_Pod const* self__pod) {
        physx::PxMaterial const* self_ = reinterpret_cast<physx::PxMaterial const*>(self__pod);
    ...
    void physx_PxMaterial_setRestitutionCombineMode_mut(physx_PxMaterial_Pod* self__pod, int32_t combMode_pod) {
        physx::PxMaterial* self_ = reinterpret_cast<physx::PxMaterial*>(self__pod);
        auto combMode = static_cast<physx::PxCombineMode::Enum>(combMode_pod);
        self_->setRestitutionCombineMode(combMode);
    }

    int32_t physx_PxMaterial_getRestitutionCombineMode(physx_PxMaterial_Pod const* self__pod) {
        physx::PxMaterial const* self_ = reinterpret_cast<physx::PxMaterial const*>(self__pod);
    ...
    char const* physx_PxMaterial_getConcreteTypeName(physx_PxMaterial_Pod const* self__pod) {
        physx::PxMaterial const* self_ = reinterpret_cast<physx::PxMaterial const*>(self__pod);
        char const* return_val = self_->getConcreteTypeName();
        return return_val;
    }

    physx_PxDiffuseParticleParams_Pod physx_PxDiffuseParticleParams_new() {
    ...
    void physx_PxDiffuseParticleParams_setToDefault_mut(physx_PxDiffuseParticleParams_Pod* self__pod) {
        physx::PxDiffuseParticleParams* self_ = reinterpret_cast<physx::PxDiffuseParticleParams*>(self__pod);
        self_->setToDefault();
    }

    void physx_PxParticleMaterial_setFriction_mut(physx_PxParticleMaterial_Pod* self__pod, float friction) {
        physx::PxParticleMaterial* self_ = reinterpret_cast<physx::PxParticleMaterial*>(self__pod);
        self_->setFriction(friction);
    }

    float physx_PxParticleMaterial_getFriction(physx_PxParticleMaterial_Pod const* self__pod) {
    ...
    void physx_PxParticleMaterial_setDamping_mut(physx_PxParticleMaterial_Pod* self__pod, float damping) {
        physx::PxParticleMaterial* self_ = reinterpret_cast<physx::PxParticleMaterial*>(self__pod);
        self_->setDamping(damping);
    }

    float physx_PxParticleMaterial_getDamping(physx_PxParticleMaterial_Pod const* self__pod) {
        physx::PxParticleMaterial const* self_ = reinterpret_cast<physx::PxParticleMaterial const*>(self__pod);
        float return_val = self_->getDamping();
        return return_val;
    }

    void physx_PxParticleMaterial_setAdhesion_mut(physx_PxParticleMaterial_Pod* self__pod, float adhesion) {
        physx::PxParticleMaterial* self_ = reinterpret_cast<physx::PxParticleMaterial*>(self__pod);
        self_->setAdhesion(adhesion);
    }

    float physx_PxParticleMaterial_getAdhesion(physx_PxParticleMaterial_Pod const* self__pod) {
        physx::PxParticleMaterial const* self_ = reinterpret_cast<physx::PxParticleMaterial const*>(self__pod);
        float return_val = self_->getAdhesion();
        return return_val;
    }

    void physx_PxParticleMaterial_setGravityScale_mut(physx_PxParticleMaterial_Pod* self__pod, float scale) {
        physx::PxParticleMaterial* self_ = reinterpret_cast<physx::PxParticleMaterial*>(self__pod);
        self_->setGravityScale(scale);
    }

    float physx_PxParticleMaterial_getGravityScale(physx_PxParticleMaterial_Pod const* self__pod) {
        physx::PxParticleMaterial const* self_ = reinterpret_cast<physx::PxParticleMaterial const*>(self__pod);
        float return_val = self_->getGravityScale();
        return return_val;
    }

    void physx_PxParticleMaterial_setAdhesionRadiusScale_mut(physx_PxParticleMaterial_Pod* self__pod, float scale) {
        physx::PxParticleMaterial* self_ = reinterpret_cast<physx::PxParticleMaterial*>(self__pod);
        self_->setAdhesionRadiusScale(scale);
    }

    float physx_PxParticleMaterial_getAdhesionRadiusScale(physx_PxParticleMaterial_Pod const* self__pod) {
        physx::PxParticleMaterial const* self_ = reinterpret_cast<physx::PxParticleMaterial const*>(self__pod);
        float return_val = self_->getAdhesionRadiusScale();
        return return_val;
    }

    void physx_PxPhysics_release_mut(physx_PxPhysics_Pod* self__pod) {
        physx::PxPhysics* self_ = reinterpret_cast<physx::PxPhysics*>(self__pod);
        self_->release();
    }

    physx_PxFoundation_Pod* physx_PxPhysics_getFoundation_mut(physx_PxPhysics_Pod* self__pod) {
        physx::PxPhysics* self_ = reinterpret_cast<physx::PxPhysics*>(self__pod);
    ...
    physx_PxAggregate_Pod* physx_PxPhysics_createAggregate_mut(physx_PxPhysics_Pod* self__pod, uint32_t maxActor, uint32_t maxShape, uint32_t filterHint) {
        physx::PxPhysics* self_ = reinterpret_cast<physx::PxPhysics*>(self__pod);
    ...
    physx_PxTolerancesScale_Pod const* physx_PxPhysics_getTolerancesScale(physx_PxPhysics_Pod const* self__pod) {
    ...
    physx_PxTriangleMesh_Pod* physx_PxPhysics_createTriangleMesh_mut(physx_PxPhysics_Pod* self__pod, physx_PxInputStream_Pod* stream_pod) {
        physx::PxPhysics* self_ = reinterpret_cast<physx::PxPhysics*>(self__pod);
    ...
    uint32_t physx_PxPhysics_getNbTriangleMeshes(physx_PxPhysics_Pod const* self__pod) {
        physx::PxPhysics const* self_ = reinterpret_cast<physx::PxPhysics const*>(self__pod);
        uint32_t return_val = self_->getNbTriangleMeshes();
        return return_val;
    }

    uint32_t physx_PxPhysics_getTriangleMeshes(physx_PxPhysics_Pod const* self__pod, physx_PxTriangleMesh_Pod** userBuffer_pod, uint32_t bufferSize, uint32_t startIndex) {
        physx::PxPhysics const* self_ = reinterpret_cast<physx::PxPhysics const*>(self__pod);
    ...
    physx_PxTetrahedronMesh_Pod* physx_PxPhysics_createTetrahedronMesh_mut(physx_PxPhysics_Pod* self__pod, physx_PxInputStream_Pod* stream_pod) {
        physx::PxPhysics* self_ = reinterpret_cast<physx::PxPhysics*>(self__pod);
        physx::PxInputStream& stream = reinterpret_cast<physx::PxInputStream&>(*stream_pod);
    ...
    physx_PxSoftBodyMesh_Pod* physx_PxPhysics_createSoftBodyMesh_mut(physx_PxPhysics_Pod* self__pod, physx_PxInputStream_Pod* stream_pod) {
        physx::PxPhysics* self_ = reinterpret_cast<physx::PxPhysics*>(self__pod);
        physx::PxInputStream& stream = reinterpret_cast<physx::PxInputStream&>(*stream_pod);
    ...
    uint32_t physx_PxPhysics_getNbTetrahedronMeshes(physx_PxPhysics_Pod const* self__pod) {
        physx::PxPhysics const* self_ = reinterpret_cast<physx::PxPhysics const*>(self__pod);
        uint32_t return_val = self_->getNbTetrahedronMeshes();
        return return_val;
    }

    uint32_t physx_PxPhysics_getTetrahedronMeshes(physx_PxPhysics_Pod const* self__pod, physx_PxTetrahedronMesh_Pod** userBuffer_pod, uint32_t bufferSize, uint32_t startIndex) {
        physx::PxPhysics const* self_ = reinterpret_cast<physx::PxPhysics const*>(self__pod);
    ...
    physx_PxHeightField_Pod* physx_PxPhysics_createHeightField_mut(physx_PxPhysics_Pod* self__pod, physx_PxInputStream_Pod* stream_pod) {
        physx::PxPhysics* self_ = reinterpret_cast<physx::PxPhysics*>(self__pod);
        physx::PxInputStream& stream = reinterpret_cast<physx::PxInputStream&>(*stream_pod);
    ...
    uint32_t physx_PxPhysics_getNbHeightFields(physx_PxPhysics_Pod const* self__pod) {
        physx::PxPhysics const* self_ = reinterpret_cast<physx::PxPhysics const*>(self__pod);
        uint32_t return_val = self_->getNbHeightFields();
        return return_val;
    }

    uint32_t physx_PxPhysics_getHeightFields(physx_PxPhysics_Pod const* self__pod, physx_PxHeightField_Pod** userBuffer_pod, uint32_t bufferSize, uint32_t startIndex) {
        physx::PxPhysics const* self_ = reinterpret_cast<physx::PxPhysics const*>(self__pod);
    ...
    physx_PxConvexMesh_Pod* physx_PxPhysics_createConvexMesh_mut(physx_PxPhysics_Pod* self__pod, physx_PxInputStream_Pod* stream_pod) {
        physx::PxPhysics* self_ = reinterpret_cast<physx::PxPhysics*>(self__pod);
        physx::PxInputStream& stream = reinterpret_cast<physx::PxInputStream&>(*stream_pod);
    ...
    uint32_t physx_PxPhysics_getNbConvexMeshes(physx_PxPhysics_Pod const* self__pod) {
        physx::PxPhysics const* self_ = reinterpret_cast<physx::PxPhysics const*>(self__pod);
        uint32_t return_val = self_->getNbConvexMeshes();
        return return_val;
    }

    uint32_t physx_PxPhysics_getConvexMeshes(physx_PxPhysics_Pod const* self__pod, physx_PxConvexMesh_Pod** userBuffer_pod, uint32_t bufferSize, uint32_t startIndex) {
        physx::PxPhysics const* self_ = reinterpret_cast<physx::PxPhysics const*>(self__pod);
    ...
    physx_PxBVH_Pod* physx_PxPhysics_createBVH_mut(physx_PxPhysics_Pod* self__pod, physx_PxInputStream_Pod* stream_pod) {
        physx::PxPhysics* self_ = reinterpret_cast<physx::PxPhysics*>(self__pod);
        physx::PxInputStream& stream = reinterpret_cast<physx::PxInputStream&>(*stream_pod);
    ...
    uint32_t physx_PxPhysics_getNbBVHs(physx_PxPhysics_Pod const* self__pod) {
        physx::PxPhysics const* self_ = reinterpret_cast<physx::PxPhysics const*>(self__pod);
        uint32_t return_val = self_->getNbBVHs();
        return return_val;
    }

    uint32_t physx_PxPhysics_getBVHs(physx_PxPhysics_Pod const* self__pod, physx_PxBVH_Pod** userBuffer_pod, uint32_t bufferSize, uint32_t startIndex) {
        physx::PxPhysics const* self_ = reinterpret_cast<physx::PxPhysics const*>(self__pod);
    ...
    physx_PxScene_Pod* physx_PxPhysics_createScene_mut(physx_PxPhysics_Pod* self__pod, physx_PxSceneDesc_Pod const* sceneDesc_pod) {
        physx::PxPhysics* self_ = reinterpret_cast<physx::PxPhysics*>(self__pod);
    ...
    uint32_t physx_PxPhysics_getNbScenes(physx_PxPhysics_Pod const* self__pod) {
        physx::PxPhysics const* self_ = reinterpret_cast<physx::PxPhysics const*>(self__pod);
        uint32_t return_val = self_->getNbScenes();
        return return_val;
    }

    uint32_t physx_PxPhysics_getScenes(physx_PxPhysics_Pod const* self__pod, physx_PxScene_Pod** userBuffer_pod, uint32_t bufferSize, uint32_t startIndex) {
        physx::PxPhysics const* self_ = reinterpret_cast<physx::PxPhysics const*>(self__pod);
    ...
    physx_PxRigidStatic_Pod* physx_PxPhysics_createRigidStatic_mut(physx_PxPhysics_Pod* self__pod, physx_PxTransform_Pod const* pose_pod) {
        physx::PxPhysics* self_ = reinterpret_cast<physx::PxPhysics*>(self__pod);
        physx::PxTransform const& pose = reinterpret_cast<physx::PxTransform const&>(*pose_pod);
    ...
    physx_PxRigidDynamic_Pod* physx_PxPhysics_createRigidDynamic_mut(physx_PxPhysics_Pod* self__pod, physx_PxTransform_Pod const* pose_pod) {
        physx::PxPhysics* self_ = reinterpret_cast<physx::PxPhysics*>(self__pod);
        physx::PxTransform const& pose = reinterpret_cast<physx::PxTransform const&>(*pose_pod);
    ...
    physx_PxPruningStructure_Pod* physx_PxPhysics_createPruningStructure_mut(physx_PxPhysics_Pod* self__pod, physx_PxRigidActor_Pod* const* actors_pod, uint32_t nbActors) {
        physx::PxPhysics* self_ = reinterpret_cast<physx::PxPhysics*>(self__pod);
    ...
    physx_PxShape_Pod* physx_PxPhysics_createShape_mut(physx_PxPhysics_Pod* self__pod, physx_PxGeometry_Pod const* geometry_pod, physx_PxMaterial_Pod const* material_pod, bool isExclusive, uint8_t shapeFlags_pod) {
        physx::PxPhysics* self_ = reinterpret_cast<physx::PxPhysics*>(self__pod);
        physx::PxGeometry const& geometry = reinterpret_cast<physx::PxGeometry const&>(*geometry_pod);
    ...
    physx_PxShape_Pod* physx_PxPhysics_createShape_mut_1(physx_PxPhysics_Pod* self__pod, physx_PxGeometry_Pod const* geometry_pod, physx_PxMaterial_Pod* const* materials_pod, uint16_t materialCount, bool isExclusive, uint8_t shapeFlags_pod) {
        physx::PxPhysics* self_ = reinterpret_cast<physx::PxPhysics*>(self__pod);
        physx::PxGeometry const& geometry = reinterpret_cast<physx::PxGeometry const&>(*geometry_pod);
        physx::PxMaterial* const* materials = reinterpret_cast<physx::PxMaterial* const*>(materials_pod);
        auto shapeFlags = physx::PxShapeFlags(shapeFlags_pod);
    ...
    uint32_t physx_PxPhysics_getNbShapes(physx_PxPhysics_Pod const* self__pod) {
        physx::PxPhysics const* self_ = reinterpret_cast<physx::PxPhysics const*>(self__pod);
        uint32_t return_val = self_->getNbShapes();
        return return_val;
    }

    uint32_t physx_PxPhysics_getShapes(physx_PxPhysics_Pod const* self__pod, physx_PxShape_Pod** userBuffer_pod, uint32_t bufferSize, uint32_t startIndex) {
        physx::PxPhysics const* self_ = reinterpret_cast<physx::PxPhysics const*>(self__pod);
        physx::PxShape** userBuffer = reinterpret_cast<physx::PxShape**>(userBuffer_pod);
        uint32_t return_val = self_->getShapes(userBuffer, bufferSize, startIndex);
        return return_val;
    ...
    physx_PxConstraint_Pod* physx_PxPhysics_createConstraint_mut(physx_PxPhysics_Pod* self__pod, physx_PxRigidActor_Pod* actor0_pod, physx_PxRigidActor_Pod* actor1_pod, physx_PxConstraintConnector_Pod* connector_pod, physx_PxConstraintShaderTable_Pod const* shaders_pod, uint32_t dataSize) {
        physx::PxPhysics* self_ = reinterpret_cast<physx::PxPhysics*>(self__pod);
        physx::PxRigidActor* actor0 = reinterpret_cast<physx::PxRigidActor*>(actor0_pod);
        physx::PxRigidActor* actor1 = reinterpret_cast<physx::PxRigidActor*>(actor1_pod);
        physx::PxConstraintConnector& connector = reinterpret_cast<physx::PxConstraintConnector&>(*connector_pod);
    ...
    physx_PxArticulationReducedCoordinate_Pod* physx_PxPhysics_createArticulationReducedCoordinate_mut(physx_PxPhysics_Pod* self__pod) {
        physx::PxPhysics* self_ = reinterpret_cast<physx::PxPhysics*>(self__pod);
    ...
    physx_PxMaterial_Pod* physx_PxPhysics_createMaterial_mut(physx_PxPhysics_Pod* self__pod, float staticFriction, float dynamicFriction, float restitution) {
        physx::PxPhysics* self_ = reinterpret_cast<physx::PxPhysics*>(self__pod);
    ...
    uint32_t physx_PxPhysics_getNbMaterials(physx_PxPhysics_Pod const* self__pod) {
        physx::PxPhysics const* self_ = reinterpret_cast<physx::PxPhysics const*>(self__pod);
        uint32_t return_val = self_->getNbMaterials();
        return return_val;
    }

    uint32_t physx_PxPhysics_getMaterials(physx_PxPhysics_Pod const* self__pod, physx_PxMaterial_Pod** userBuffer_pod, uint32_t bufferSize, uint32_t startIndex) {
        physx::PxPhysics const* self_ = reinterpret_cast<physx::PxPhysics const*>(self__pod);
        physx::PxMaterial** userBuffer = reinterpret_cast<physx::PxMaterial**>(userBuffer_pod);
        uint32_t return_val = self_->getMaterials(userBuffer, bufferSize, startIndex);
        return return_val;
    ...
    void physx_PxPhysics_registerDeletionListener_mut(physx_PxPhysics_Pod* self__pod, physx_PxDeletionListener_Pod* observer_pod, uint8_t const* deletionEvents_pod, bool restrictedObjectSet) {
        physx::PxPhysics* self_ = reinterpret_cast<physx::PxPhysics*>(self__pod);
    ...
    void physx_PxPhysics_unregisterDeletionListener_mut(physx_PxPhysics_Pod* self__pod, physx_PxDeletionListener_Pod* observer_pod) {
        physx::PxPhysics* self_ = reinterpret_cast<physx::PxPhysics*>(self__pod);
        physx::PxDeletionListener& observer = reinterpret_cast<physx::PxDeletionListener&>(*observer_pod);
        self_->unregisterDeletionListener(observer);
    }

    void physx_PxPhysics_registerDeletionListenerObjects_mut(physx_PxPhysics_Pod* self__pod, physx_PxDeletionListener_Pod* observer_pod, physx_PxBase_Pod const* const* observables_pod, uint32_t observableCount) {
        physx::PxPhysics* self_ = reinterpret_cast<physx::PxPhysics*>(self__pod);
        physx::PxDeletionListener& observer = reinterpret_cast<physx::PxDeletionListener&>(*observer_pod);
    ...
    void physx_PxPhysics_unregisterDeletionListenerObjects_mut(physx_PxPhysics_Pod* self__pod, physx_PxDeletionListener_Pod* observer_pod, physx_PxBase_Pod const* const* observables_pod, uint32_t observableCount) {
        physx::PxPhysics* self_ = reinterpret_cast<physx::PxPhysics*>(self__pod);
        physx::PxDeletionListener& observer = reinterpret_cast<physx::PxDeletionListener&>(*observer_pod);
        physx::PxBase const* const* observables = reinterpret_cast<physx::PxBase const* const*>(observables_pod);
    ...
    physx_PxInsertionCallback_Pod* physx_PxPhysics_getPhysicsInsertionCallback_mut(physx_PxPhysics_Pod* self__pod) {
        physx::PxPhysics* self_ = reinterpret_cast<physx::PxPhysics*>(self__pod);
    ...
    physx_PxPhysics_Pod* physx_phys_PxCreatePhysics(uint32_t version, physx_PxFoundation_Pod* foundation_pod, physx_PxTolerancesScale_Pod const* scale_pod, bool trackOutstandingAllocations, physx_PxPvd_Pod* pvd_pod, physx_PxOmniPvd_Pod* omniPvd_pod) {
        physx::PxFoundation& foundation = reinterpret_cast<physx::PxFoundation&>(*foundation_pod);
    ...
    physx_PxPhysics_Pod* physx_phys_PxGetPhysics() {
        physx::PxPhysics& return_val = PxGetPhysics();
        auto return_val_pod = reinterpret_cast<physx_PxPhysics_Pod*>(&return_val);
        return return_val_pod;
    }

    physx_PxActorShape_Pod physx_PxActorShape_new() {
    ...
    physx_PxActorShape_Pod physx_PxActorShape_new_1(physx_PxRigidActor_Pod* a_pod, physx_PxShape_Pod* s_pod) {
    ...
    physx_PxQueryCache_Pod physx_PxQueryCache_new() {
    ...
    physx_PxQueryCache_Pod physx_PxQueryCache_new_1(physx_PxShape_Pod* s_pod, uint32_t findex) {
        physx::PxShape* s = reinterpret_cast<physx::PxShape*>(s_pod);
    ...
    physx_PxQueryFilterData_Pod physx_PxQueryFilterData_new() {
    ...
    physx_PxQueryFilterData_Pod physx_PxQueryFilterData_new_1(physx_PxFilterData_Pod const* fd_pod, uint16_t f_pod) {
    ...
    physx_PxQueryFilterData_Pod physx_PxQueryFilterData_new_2(uint16_t f_pod) {
        auto f = physx::PxQueryFlags(f_pod);
    ...
    int32_t physx_PxQueryFilterCallback_preFilter_mut(physx_PxQueryFilterCallback_Pod* self__pod, physx_PxFilterData_Pod const* filterData_pod, physx_PxShape_Pod const* shape_pod, physx_PxRigidActor_Pod const* actor_pod, uint16_t* queryFlags_pod) {
    ...
    int32_t physx_PxQueryFilterCallback_postFilter_mut(physx_PxQueryFilterCallback_Pod* self__pod, physx_PxFilterData_Pod const* filterData_pod, physx_PxQueryHit_Pod const* hit_pod, physx_PxShape_Pod const* shape_pod, physx_PxRigidActor_Pod const* actor_pod) {
        physx::PxQueryFilterCallback* self_ = reinterpret_cast<physx::PxQueryFilterCallback*>(self__pod);
        physx::PxFilterData const& filterData = reinterpret_cast<physx::PxFilterData const&>(*filterData_pod);
    ...
    void physx_PxQueryFilterCallback_delete(physx_PxQueryFilterCallback_Pod* self__pod) {
        physx::PxQueryFilterCallback* self_ = reinterpret_cast<physx::PxQueryFilterCallback*>(self__pod);
        delete self_;
    }

    void physx_PxRigidDynamic_setKinematicTarget_mut(physx_PxRigidDynamic_Pod* self__pod, physx_PxTransform_Pod const* destination_pod) {
    ...
    bool physx_PxRigidDynamic_getKinematicTarget(physx_PxRigidDynamic_Pod const* self__pod, physx_PxTransform_Pod* target_pod) {
    ...
    bool physx_PxRigidDynamic_isSleeping(physx_PxRigidDynamic_Pod const* self__pod) {
        physx::PxRigidDynamic const* self_ = reinterpret_cast<physx::PxRigidDynamic const*>(self__pod);
        bool return_val = self_->isSleeping();
        return return_val;
    }

    void physx_PxRigidDynamic_setSleepThreshold_mut(physx_PxRigidDynamic_Pod* self__pod, float threshold) {
        physx::PxRigidDynamic* self_ = reinterpret_cast<physx::PxRigidDynamic*>(self__pod);
        self_->setSleepThreshold(threshold);
    }

    float physx_PxRigidDynamic_getSleepThreshold(physx_PxRigidDynamic_Pod const* self__pod) {
        physx::PxRigidDynamic const* self_ = reinterpret_cast<physx::PxRigidDynamic const*>(self__pod);
        float return_val = self_->getSleepThreshold();
        return return_val;
    }

    void physx_PxRigidDynamic_setStabilizationThreshold_mut(physx_PxRigidDynamic_Pod* self__pod, float threshold) {
        physx::PxRigidDynamic* self_ = reinterpret_cast<physx::PxRigidDynamic*>(self__pod);
        self_->setStabilizationThreshold(threshold);
    }

    float physx_PxRigidDynamic_getStabilizationThreshold(physx_PxRigidDynamic_Pod const* self__pod) {
        physx::PxRigidDynamic const* self_ = reinterpret_cast<physx::PxRigidDynamic const*>(self__pod);
        float return_val = self_->getStabilizationThreshold();
        return return_val;
    }

    uint8_t physx_PxRigidDynamic_getRigidDynamicLockFlags(physx_PxRigidDynamic_Pod const* self__pod) {
        physx::PxRigidDynamic const* self_ = reinterpret_cast<physx::PxRigidDynamic const*>(self__pod);
    ...
    void physx_PxRigidDynamic_setRigidDynamicLockFlag_mut(physx_PxRigidDynamic_Pod* self__pod, int32_t flag_pod, bool value) {
        physx::PxRigidDynamic* self_ = reinterpret_cast<physx::PxRigidDynamic*>(self__pod);
        auto flag = static_cast<physx::PxRigidDynamicLockFlag::Enum>(flag_pod);
        self_->setRigidDynamicLockFlag(flag, value);
    }

    void physx_PxRigidDynamic_setRigidDynamicLockFlags_mut(physx_PxRigidDynamic_Pod* self__pod, uint8_t flags_pod) {
        physx::PxRigidDynamic* self_ = reinterpret_cast<physx::PxRigidDynamic*>(self__pod);
        auto flags = physx::PxRigidDynamicLockFlags(flags_pod);
        self_->setRigidDynamicLockFlags(flags);
    }

    physx_PxVec3_Pod physx_PxRigidDynamic_getLinearVelocity(physx_PxRigidDynamic_Pod const* self__pod) {
        physx::PxRigidDynamic const* self_ = reinterpret_cast<physx::PxRigidDynamic const*>(self__pod);
        physx::PxVec3 return_val = self_->getLinearVelocity();
        physx_PxVec3_Pod return_val_pod;
        memcpy(&return_val_pod, &return_val, sizeof(return_val_pod));
    ...
    void physx_PxRigidDynamic_setLinearVelocity_mut(physx_PxRigidDynamic_Pod* self__pod, physx_PxVec3_Pod const* linVel_pod, bool autowake) {
        physx::PxRigidDynamic* self_ = reinterpret_cast<physx::PxRigidDynamic*>(self__pod);
        physx::PxVec3 const& linVel = reinterpret_cast<physx::PxVec3 const&>(*linVel_pod);
        self_->setLinearVelocity(linVel, autowake);
    }

    physx_PxVec3_Pod physx_PxRigidDynamic_getAngularVelocity(physx_PxRigidDynamic_Pod const* self__pod) {
        physx::PxRigidDynamic const* self_ = reinterpret_cast<physx::PxRigidDynamic const*>(self__pod);
        physx::PxVec3 return_val = self_->getAngularVelocity();
        physx_PxVec3_Pod return_val_pod;
        memcpy(&return_val_pod, &return_val, sizeof(return_val_pod));
    ...
    void physx_PxRigidDynamic_setAngularVelocity_mut(physx_PxRigidDynamic_Pod* self__pod, physx_PxVec3_Pod const* angVel_pod, bool autowake) {
        physx::PxRigidDynamic* self_ = reinterpret_cast<physx::PxRigidDynamic*>(self__pod);
        physx::PxVec3 const& angVel = reinterpret_cast<physx::PxVec3 const&>(*angVel_pod);
        self_->setAngularVelocity(angVel, autowake);
    }

    void physx_PxRigidDynamic_setWakeCounter_mut(physx_PxRigidDynamic_Pod* self__pod, float wakeCounterValue) {
        physx::PxRigidDynamic* self_ = reinterpret_cast<physx::PxRigidDynamic*>(self__pod);
        self_->setWakeCounter(wakeCounterValue);
    }

    float physx_PxRigidDynamic_getWakeCounter(physx_PxRigidDynamic_Pod const* self__pod) {
        physx::PxRigidDynamic const* self_ = reinterpret_cast<physx::PxRigidDynamic const*>(self__pod);
        float return_val = self_->getWakeCounter();
        return return_val;
    }

    void physx_PxRigidDynamic_wakeUp_mut(physx_PxRigidDynamic_Pod* self__pod) {
        physx::PxRigidDynamic* self_ = reinterpret_cast<physx::PxRigidDynamic*>(self__pod);
        self_->wakeUp();
    }

    void physx_PxRigidDynamic_putToSleep_mut(physx_PxRigidDynamic_Pod* self__pod) {
        physx::PxRigidDynamic* self_ = reinterpret_cast<physx::PxRigidDynamic*>(self__pod);
        self_->putToSleep();
    }

    void physx_PxRigidDynamic_setSolverIterationCounts_mut(physx_PxRigidDynamic_Pod* self__pod, uint32_t minPositionIters, uint32_t minVelocityIters) {
        physx::PxRigidDynamic* self_ = reinterpret_cast<physx::PxRigidDynamic*>(self__pod);
        self_->setSolverIterationCounts(minPositionIters, minVelocityIters);
    }

    void physx_PxRigidDynamic_getSolverIterationCounts(physx_PxRigidDynamic_Pod const* self__pod, uint32_t* minPositionIters_pod, uint32_t* minVelocityIters_pod) {
        physx::PxRigidDynamic const* self_ = reinterpret_cast<physx::PxRigidDynamic const*>(self__pod);
        uint32_t& minPositionIters = *minPositionIters_pod;
        uint32_t& minVelocityIters = *minVelocityIters_pod;
        self_->getSolverIterationCounts(minPositionIters, minVelocityIters);
    ...
    float physx_PxRigidDynamic_getContactReportThreshold(physx_PxRigidDynamic_Pod const* self__pod) {
        physx::PxRigidDynamic const* self_ = reinterpret_cast<physx::PxRigidDynamic const*>(self__pod);
        float return_val = self_->getContactReportThreshold();
        return return_val;
    }

    void physx_PxRigidDynamic_setContactReportThreshold_mut(physx_PxRigidDynamic_Pod* self__pod, float threshold) {
        physx::PxRigidDynamic* self_ = reinterpret_cast<physx::PxRigidDynamic*>(self__pod);
        self_->setContactReportThreshold(threshold);
    }

    char const* physx_PxRigidDynamic_getConcreteTypeName(physx_PxRigidDynamic_Pod const* self__pod) {
        physx::PxRigidDynamic const* self_ = reinterpret_cast<physx::PxRigidDynamic const*>(self__pod);
        char const* return_val = self_->getConcreteTypeName();
        return return_val;
    }

    char const* physx_PxRigidStatic_getConcreteTypeName(physx_PxRigidStatic_Pod const* self__pod) {
        physx::PxRigidStatic const* self_ = reinterpret_cast<physx::PxRigidStatic const*>(self__pod);
        char const* return_val = self_->getConcreteTypeName();
        return return_val;
    }

    physx_PxSceneQueryDesc_Pod physx_PxSceneQueryDesc_new() {
    ...
    void physx_PxSceneQueryDesc_setToDefault_mut(physx_PxSceneQueryDesc_Pod* self__pod) {
        physx::PxSceneQueryDesc* self_ = reinterpret_cast<physx::PxSceneQueryDesc*>(self__pod);
        self_->setToDefault();
    }

    bool physx_PxSceneQueryDesc_isValid(physx_PxSceneQueryDesc_Pod const* self__pod) {
        physx::PxSceneQueryDesc const* self_ = reinterpret_cast<physx::PxSceneQueryDesc const*>(self__pod);
        bool return_val = self_->isValid();
        return return_val;
    }

    void physx_PxSceneQuerySystemBase_setDynamicTreeRebuildRateHint_mut(physx_PxSceneQuerySystemBase_Pod* self__pod, uint32_t dynamicTreeRebuildRateHint) {
    ...
    uint32_t physx_PxSceneQuerySystemBase_getDynamicTreeRebuildRateHint(physx_PxSceneQuerySystemBase_Pod const* self__pod) {
    ...
    void physx_PxSceneQuerySystemBase_forceRebuildDynamicTree_mut(physx_PxSceneQuerySystemBase_Pod* self__pod, uint32_t prunerIndex) {
        physx::PxSceneQuerySystemBase* self_ = reinterpret_cast<physx::PxSceneQuerySystemBase*>(self__pod);
        self_->forceRebuildDynamicTree(prunerIndex);
    }

    void physx_PxSceneQuerySystemBase_setUpdateMode_mut(physx_PxSceneQuerySystemBase_Pod* self__pod, int32_t updateMode_pod) {
        physx::PxSceneQuerySystemBase* self_ = reinterpret_cast<physx::PxSceneQuerySystemBase*>(self__pod);
        auto updateMode = static_cast<physx::PxSceneQueryUpdateMode::Enum>(updateMode_pod);
        self_->setUpdateMode(updateMode);
    }

    int32_t physx_PxSceneQuerySystemBase_getUpdateMode(physx_PxSceneQuerySystemBase_Pod const* self__pod) {
        physx::PxSceneQuerySystemBase const* self_ = reinterpret_cast<physx::PxSceneQuerySystemBase const*>(self__pod);
    ...
    uint32_t physx_PxSceneQuerySystemBase_getStaticTimestamp(physx_PxSceneQuerySystemBase_Pod const* self__pod) {
        physx::PxSceneQuerySystemBase const* self_ = reinterpret_cast<physx::PxSceneQuerySystemBase const*>(self__pod);
        uint32_t return_val = self_->getStaticTimestamp();
        return return_val;
    }

    void physx_PxSceneQuerySystemBase_flushUpdates_mut(physx_PxSceneQuerySystemBase_Pod* self__pod) {
        physx::PxSceneQuerySystemBase* self_ = reinterpret_cast<physx::PxSceneQuerySystemBase*>(self__pod);
        self_->flushUpdates();
    }

    bool physx_PxSceneQuerySystemBase_raycast(physx_PxSceneQuerySystemBase_Pod const* self__pod, physx_PxVec3_Pod const* origin_pod, physx_PxVec3_Pod const* unitDir_pod, float distance, physx_PxRaycastCallback_Pod* hitCall_pod, uint16_t hitFlags_pod, physx_PxQueryFilterData_Pod const* filterData_pod, physx_PxQueryFilterCallback_Pod* filterCall_pod, physx_PxQueryCache_Pod const* cache_pod, uint32_t queryFlags_pod) {
        physx::PxSceneQuerySystemBase const* self_ = reinterpret_cast<physx::PxSceneQuerySystemBase const*>(self__pod);
        physx::PxVec3 const& origin = reinterpret_cast<physx::PxVec3 const&>(*origin_pod);
        physx::PxVec3 const& unitDir = reinterpret_cast<physx::PxVec3 const&>(*unitDir_pod);
    ...
    bool physx_PxSceneQuerySystemBase_sweep(physx_PxSceneQuerySystemBase_Pod const* self__pod, physx_PxGeometry_Pod const* geometry_pod, physx_PxTransform_Pod const* pose_pod, physx_PxVec3_Pod const* unitDir_pod, float distance, physx_PxSweepCallback_Pod* hitCall_pod, uint16_t hitFlags_pod, physx_PxQueryFilterData_Pod const* filterData_pod, physx_PxQueryFilterCallback_Pod* filterCall_pod, physx_PxQueryCache_Pod const* cache_pod, float inflation, uint32_t queryFlags_pod) {
        physx::PxSceneQuerySystemBase const* self_ = reinterpret_cast<physx::PxSceneQuerySystemBase const*>(self__pod);
        physx::PxGeometry const& geometry = reinterpret_cast<physx::PxGeometry const&>(*geometry_pod);
        physx::PxTransform const& pose = reinterpret_cast<physx::PxTransform const&>(*pose_pod);
        physx::PxVec3 const& unitDir = reinterpret_cast<physx::PxVec3 const&>(*unitDir_pod);
    ...
    bool physx_PxSceneQuerySystemBase_overlap(physx_PxSceneQuerySystemBase_Pod const* self__pod, physx_PxGeometry_Pod const* geometry_pod, physx_PxTransform_Pod const* pose_pod, physx_PxOverlapCallback_Pod* hitCall_pod, physx_PxQueryFilterData_Pod const* filterData_pod, physx_PxQueryFilterCallback_Pod* filterCall_pod, physx_PxQueryCache_Pod const* cache_pod, uint32_t queryFlags_pod) {
        physx::PxSceneQuerySystemBase const* self_ = reinterpret_cast<physx::PxSceneQuerySystemBase const*>(self__pod);
        physx::PxGeometry const& geometry = reinterpret_cast<physx::PxGeometry const&>(*geometry_pod);
        physx::PxTransform const& pose = reinterpret_cast<physx::PxTransform const&>(*pose_pod);
    ...
    void physx_PxSceneSQSystem_setSceneQueryUpdateMode_mut(physx_PxSceneSQSystem_Pod* self__pod, int32_t updateMode_pod) {
        physx::PxSceneSQSystem* self_ = reinterpret_cast<physx::PxSceneSQSystem*>(self__pod);
        auto updateMode = static_cast<physx::PxSceneQueryUpdateMode::Enum>(updateMode_pod);
        self_->setSceneQueryUpdateMode(updateMode);
    }

    int32_t physx_PxSceneSQSystem_getSceneQueryUpdateMode(physx_PxSceneSQSystem_Pod const* self__pod) {
    ...
    uint32_t physx_PxSceneSQSystem_getSceneQueryStaticTimestamp(physx_PxSceneSQSystem_Pod const* self__pod) {
        physx::PxSceneSQSystem const* self_ = reinterpret_cast<physx::PxSceneSQSystem const*>(self__pod);
        uint32_t return_val = self_->getSceneQueryStaticTimestamp();
        return return_val;
    }

    void physx_PxSceneSQSystem_flushQueryUpdates_mut(physx_PxSceneSQSystem_Pod* self__pod) {
        physx::PxSceneSQSystem* self_ = reinterpret_cast<physx::PxSceneSQSystem*>(self__pod);
        self_->flushQueryUpdates();
    }

    void physx_PxSceneSQSystem_forceDynamicTreeRebuild_mut(physx_PxSceneSQSystem_Pod* self__pod, bool rebuildStaticStructure, bool rebuildDynamicStructure) {
        physx::PxSceneSQSystem* self_ = reinterpret_cast<physx::PxSceneSQSystem*>(self__pod);
        self_->forceDynamicTreeRebuild(rebuildStaticStructure, rebuildDynamicStructure);
    }

    int32_t physx_PxSceneSQSystem_getStaticStructure(physx_PxSceneSQSystem_Pod const* self__pod) {
        physx::PxSceneSQSystem const* self_ = reinterpret_cast<physx::PxSceneSQSystem const*>(self__pod);
    ...
    int32_t physx_PxSceneSQSystem_getDynamicStructure(physx_PxSceneSQSystem_Pod const* self__pod) {
        physx::PxSceneSQSystem const* self_ = reinterpret_cast<physx::PxSceneSQSystem const*>(self__pod);
    ...
    void physx_PxSceneSQSystem_sceneQueriesUpdate_mut(physx_PxSceneSQSystem_Pod* self__pod, physx_PxBaseTask_Pod* completionTask_pod, bool controlSimulation) {
        physx::PxSceneSQSystem* self_ = reinterpret_cast<physx::PxSceneSQSystem*>(self__pod);
    ...
    bool physx_PxSceneSQSystem_checkQueries_mut(physx_PxSceneSQSystem_Pod* self__pod, bool block) {
        physx::PxSceneSQSystem* self_ = reinterpret_cast<physx::PxSceneSQSystem*>(self__pod);
        bool return_val = self_->checkQueries(block);
        return return_val;
    }

    bool physx_PxSceneSQSystem_fetchQueries_mut(physx_PxSceneSQSystem_Pod* self__pod, bool block) {
        physx::PxSceneSQSystem* self_ = reinterpret_cast<physx::PxSceneSQSystem*>(self__pod);
        bool return_val = self_->fetchQueries(block);
        return return_val;
    }

    void physx_PxSceneQuerySystem_release_mut(physx_PxSceneQuerySystem_Pod* self__pod) {
        physx::PxSceneQuerySystem* self_ = reinterpret_cast<physx::PxSceneQuerySystem*>(self__pod);
        self_->release();
    }

    void physx_PxSceneQuerySystem_acquireReference_mut(physx_PxSceneQuerySystem_Pod* self__pod) {
        physx::PxSceneQuerySystem* self_ = reinterpret_cast<physx::PxSceneQuerySystem*>(self__pod);
        self_->acquireReference();
    }

    void physx_PxSceneQuerySystem_preallocate_mut(physx_PxSceneQuerySystem_Pod* self__pod, uint32_t prunerIndex, uint32_t nbShapes) {
        physx::PxSceneQuerySystem* self_ = reinterpret_cast<physx::PxSceneQuerySystem*>(self__pod);
        self_->preallocate(prunerIndex, nbShapes);
    }

    void physx_PxSceneQuerySystem_flushMemory_mut(physx_PxSceneQuerySystem_Pod* self__pod) {
        physx::PxSceneQuerySystem* self_ = reinterpret_cast<physx::PxSceneQuerySystem*>(self__pod);
        self_->flushMemory();
    }

    void physx_PxSceneQuerySystem_addSQShape_mut(physx_PxSceneQuerySystem_Pod* self__pod, physx_PxRigidActor_Pod const* actor_pod, physx_PxShape_Pod const* shape_pod, physx_PxBounds3_Pod const* bounds_pod, physx_PxTransform_Pod const* transform_pod, uint32_t const* compoundHandle, bool hasPruningStructure) {
        physx::PxSceneQuerySystem* self_ = reinterpret_cast<physx::PxSceneQuerySystem*>(self__pod);
        physx::PxRigidActor const& actor = reinterpret_cast<physx::PxRigidActor const&>(*actor_pod);
        physx::PxShape const& shape = reinterpret_cast<physx::PxShape const&>(*shape_pod);
        physx::PxBounds3 const& bounds = reinterpret_cast<physx::PxBounds3 const&>(*bounds_pod);
    ...
    void physx_PxSceneQuerySystem_removeSQShape_mut(physx_PxSceneQuerySystem_Pod* self__pod, physx_PxRigidActor_Pod const* actor_pod, physx_PxShape_Pod const* shape_pod) {
        physx::PxSceneQuerySystem* self_ = reinterpret_cast<physx::PxSceneQuerySystem*>(self__pod);
        physx::PxRigidActor const& actor = reinterpret_cast<physx::PxRigidActor const&>(*actor_pod);
        physx::PxShape const& shape = reinterpret_cast<physx::PxShape const&>(*shape_pod);
    ...
    void physx_PxSceneQuerySystem_updateSQShape_mut(physx_PxSceneQuerySystem_Pod* self__pod, physx_PxRigidActor_Pod const* actor_pod, physx_PxShape_Pod const* shape_pod, physx_PxTransform_Pod const* transform_pod) {
        physx::PxSceneQuerySystem* self_ = reinterpret_cast<physx::PxSceneQuerySystem*>(self__pod);
        physx::PxRigidActor const& actor = reinterpret_cast<physx::PxRigidActor const&>(*actor_pod);
        physx::PxShape const& shape = reinterpret_cast<physx::PxShape const&>(*shape_pod);
        physx::PxTransform const& transform = reinterpret_cast<physx::PxTransform const&>(*transform_pod);
    ...
    uint32_t physx_PxSceneQuerySystem_addSQCompound_mut(physx_PxSceneQuerySystem_Pod* self__pod, physx_PxRigidActor_Pod const* actor_pod, physx_PxShape_Pod const** shapes_pod, physx_PxBVH_Pod const* bvh_pod, physx_PxTransform_Pod const* transforms_pod) {
        physx::PxSceneQuerySystem* self_ = reinterpret_cast<physx::PxSceneQuerySystem*>(self__pod);
        physx::PxRigidActor const& actor = reinterpret_cast<physx::PxRigidActor const&>(*actor_pod);
    ...
    void physx_PxSceneQuerySystem_removeSQCompound_mut(physx_PxSceneQuerySystem_Pod* self__pod, uint32_t compoundHandle) {
        physx::PxSceneQuerySystem* self_ = reinterpret_cast<physx::PxSceneQuerySystem*>(self__pod);
        self_->removeSQCompound(compoundHandle);
    }

    void physx_PxSceneQuerySystem_updateSQCompound_mut(physx_PxSceneQuerySystem_Pod* self__pod, uint32_t compoundHandle, physx_PxTransform_Pod const* compoundTransform_pod) {
        physx::PxSceneQuerySystem* self_ = reinterpret_cast<physx::PxSceneQuerySystem*>(self__pod);
    ...
    void physx_PxSceneQuerySystem_shiftOrigin_mut(physx_PxSceneQuerySystem_Pod* self__pod, physx_PxVec3_Pod const* shift_pod) {
        physx::PxSceneQuerySystem* self_ = reinterpret_cast<physx::PxSceneQuerySystem*>(self__pod);
        physx::PxVec3 const& shift = reinterpret_cast<physx::PxVec3 const&>(*shift_pod);
        self_->shiftOrigin(shift);
    }

    void physx_PxSceneQuerySystem_merge_mut(physx_PxSceneQuerySystem_Pod* self__pod, physx_PxPruningStructure_Pod const* pruningStructure_pod) {
        physx::PxSceneQuerySystem* self_ = reinterpret_cast<physx::PxSceneQuerySystem*>(self__pod);
    ...
    uint32_t physx_PxSceneQuerySystem_getHandle(physx_PxSceneQuerySystem_Pod const* self__pod, physx_PxRigidActor_Pod const* actor_pod, physx_PxShape_Pod const* shape_pod, uint32_t* prunerIndex_pod) {
    ...
    void physx_PxSceneQuerySystem_sync_mut(physx_PxSceneQuerySystem_Pod* self__pod, uint32_t prunerIndex, uint32_t const* handles, uint32_t const* indices, physx_PxBounds3_Pod const* bounds_pod, physx_PxTransformPadded_Pod const* transforms_pod, uint32_t count, physx_PxBitMap_Pod const* ignoredIndices_pod) {
        physx::PxSceneQuerySystem* self_ = reinterpret_cast<physx::PxSceneQuerySystem*>(self__pod);
        physx::PxBounds3 const* bounds = reinterpret_cast<physx::PxBounds3 const*>(bounds_pod);
    ...
    void physx_PxSceneQuerySystem_finalizeUpdates_mut(physx_PxSceneQuerySystem_Pod* self__pod) {
        physx::PxSceneQuerySystem* self_ = reinterpret_cast<physx::PxSceneQuerySystem*>(self__pod);
        self_->finalizeUpdates();
    }

    void* physx_PxSceneQuerySystem_prepareSceneQueryBuildStep_mut(physx_PxSceneQuerySystem_Pod* self__pod, uint32_t prunerIndex) {
        physx::PxSceneQuerySystem* self_ = reinterpret_cast<physx::PxSceneQuerySystem*>(self__pod);
        void* return_val = self_->prepareSceneQueryBuildStep(prunerIndex);
        return return_val;
    }

    void physx_PxSceneQuerySystem_sceneQueryBuildStep_mut(physx_PxSceneQuerySystem_Pod* self__pod, void* handle) {
        physx::PxSceneQuerySystem* self_ = reinterpret_cast<physx::PxSceneQuerySystem*>(self__pod);
        self_->sceneQueryBuildStep(handle);
    }

    physx_PxBroadPhaseDesc_Pod physx_PxBroadPhaseDesc_new(int32_t type_pod) {
    ...
    bool physx_PxBroadPhaseDesc_isValid(physx_PxBroadPhaseDesc_Pod const* self__pod) {
    ...
    physx_PxBroadPhaseUpdateData_Pod physx_PxBroadPhaseUpdateData_new(uint32_t const* created, uint32_t nbCreated, uint32_t const* updated, uint32_t nbUpdated, uint32_t const* removed, uint32_t nbRemoved, physx_PxBounds3_Pod const* bounds_pod, uint32_t const* groups, float const* distances, uint32_t capacity) {
        physx::PxBounds3 const* bounds = reinterpret_cast<physx::PxBounds3 const*>(bounds_pod);
    ...
    physx_PxBroadPhaseResults_Pod physx_PxBroadPhaseResults_new() {
    ...
    uint32_t physx_PxBroadPhaseRegions_getNbRegions(physx_PxBroadPhaseRegions_Pod const* self__pod) {
    ...
    uint32_t physx_PxBroadPhaseRegions_getRegions(physx_PxBroadPhaseRegions_Pod const* self__pod, physx_PxBroadPhaseRegionInfo_Pod* userBuffer_pod, uint32_t bufferSize, uint32_t startIndex) {
        physx::PxBroadPhaseRegions const* self_ = reinterpret_cast<physx::PxBroadPhaseRegions const*>(self__pod);
    ...
    uint32_t physx_PxBroadPhaseRegions_addRegion_mut(physx_PxBroadPhaseRegions_Pod* self__pod, physx_PxBroadPhaseRegion_Pod const* region_pod, bool populateRegion, physx_PxBounds3_Pod const* bounds_pod, float const* distances) {
    ...
    bool physx_PxBroadPhaseRegions_removeRegion_mut(physx_PxBroadPhaseRegions_Pod* self__pod, uint32_t handle) {
        physx::PxBroadPhaseRegions* self_ = reinterpret_cast<physx::PxBroadPhaseRegions*>(self__pod);
        bool return_val = self_->removeRegion(handle);
        return return_val;
    }

    uint32_t physx_PxBroadPhaseRegions_getNbOutOfBoundsObjects(physx_PxBroadPhaseRegions_Pod const* self__pod) {
        physx::PxBroadPhaseRegions const* self_ = reinterpret_cast<physx::PxBroadPhaseRegions const*>(self__pod);
        uint32_t return_val = self_->getNbOutOfBoundsObjects();
        return return_val;
    }

    uint32_t const* physx_PxBroadPhaseRegions_getOutOfBoundsObjects(physx_PxBroadPhaseRegions_Pod const* self__pod) {
        physx::PxBroadPhaseRegions const* self_ = reinterpret_cast<physx::PxBroadPhaseRegions const*>(self__pod);
        uint32_t const* return_val = self_->getOutOfBoundsObjects();
        return return_val;
    }

    void physx_PxBroadPhase_release_mut(physx_PxBroadPhase_Pod* self__pod) {
        physx::PxBroadPhase* self_ = reinterpret_cast<physx::PxBroadPhase*>(self__pod);
        self_->release();
    }

    int32_t physx_PxBroadPhase_getType(physx_PxBroadPhase_Pod const* self__pod) {
    ...
    void physx_PxBroadPhase_getCaps(physx_PxBroadPhase_Pod const* self__pod, physx_PxBroadPhaseCaps_Pod* caps_pod) {
        physx::PxBroadPhase const* self_ = reinterpret_cast<physx::PxBroadPhase const*>(self__pod);
        physx::PxBroadPhaseCaps& caps = reinterpret_cast<physx::PxBroadPhaseCaps&>(*caps_pod);
        self_->getCaps(caps);
    }

    physx_PxBroadPhaseRegions_Pod* physx_PxBroadPhase_getRegions_mut(physx_PxBroadPhase_Pod* self__pod) {
        physx::PxBroadPhase* self_ = reinterpret_cast<physx::PxBroadPhase*>(self__pod);
    ...
    physx_PxAllocatorCallback_Pod* physx_PxBroadPhase_getAllocator_mut(physx_PxBroadPhase_Pod* self__pod) {
        physx::PxBroadPhase* self_ = reinterpret_cast<physx::PxBroadPhase*>(self__pod);
    ...
    uint64_t physx_PxBroadPhase_getContextID(physx_PxBroadPhase_Pod const* self__pod) {
        physx::PxBroadPhase const* self_ = reinterpret_cast<physx::PxBroadPhase const*>(self__pod);
        uint64_t return_val = self_->getContextID();
        return return_val;
    }

    void physx_PxBroadPhase_setScratchBlock_mut(physx_PxBroadPhase_Pod* self__pod, void* scratchBlock, uint32_t size) {
        physx::PxBroadPhase* self_ = reinterpret_cast<physx::PxBroadPhase*>(self__pod);
        self_->setScratchBlock(scratchBlock, size);
    }

    void physx_PxBroadPhase_update_mut(physx_PxBroadPhase_Pod* self__pod, physx_PxBroadPhaseUpdateData_Pod const* updateData_pod, physx_PxBaseTask_Pod* continuation_pod) {
        physx::PxBroadPhase* self_ = reinterpret_cast<physx::PxBroadPhase*>(self__pod);
    ...
    void physx_PxBroadPhase_fetchResults_mut(physx_PxBroadPhase_Pod* self__pod, physx_PxBroadPhaseResults_Pod* results_pod) {
        physx::PxBroadPhase* self_ = reinterpret_cast<physx::PxBroadPhase*>(self__pod);
        physx::PxBroadPhaseResults& results = reinterpret_cast<physx::PxBroadPhaseResults&>(*results_pod);
        self_->fetchResults(results);
    }

    void physx_PxBroadPhase_update_mut_1(physx_PxBroadPhase_Pod* self__pod, physx_PxBroadPhaseResults_Pod* results_pod, physx_PxBroadPhaseUpdateData_Pod const* updateData_pod) {
        physx::PxBroadPhase* self_ = reinterpret_cast<physx::PxBroadPhase*>(self__pod);
        physx::PxBroadPhaseResults& results = reinterpret_cast<physx::PxBroadPhaseResults&>(*results_pod);
        physx::PxBroadPhaseUpdateData const& updateData = reinterpret_cast<physx::PxBroadPhaseUpdateData const&>(*updateData_pod);
    ...
    physx_PxBroadPhase_Pod* physx_phys_PxCreateBroadPhase(physx_PxBroadPhaseDesc_Pod const* desc_pod) {
    ...
    void physx_PxAABBManager_release_mut(physx_PxAABBManager_Pod* self__pod) {
        physx::PxAABBManager* self_ = reinterpret_cast<physx::PxAABBManager*>(self__pod);
        self_->release();
    }

    physx_PxBroadPhase_Pod* physx_PxAABBManager_getBroadPhase_mut(physx_PxAABBManager_Pod* self__pod) {
        physx::PxAABBManager* self_ = reinterpret_cast<physx::PxAABBManager*>(self__pod);
    ...
    physx_PxBounds3_Pod const* physx_PxAABBManager_getBounds(physx_PxAABBManager_Pod const* self__pod) {
    ...
    float const* physx_PxAABBManager_getDistances(physx_PxAABBManager_Pod const* self__pod) {
        physx::PxAABBManager const* self_ = reinterpret_cast<physx::PxAABBManager const*>(self__pod);
        float const* return_val = self_->getDistances();
        return return_val;
    }

    uint32_t const* physx_PxAABBManager_getGroups(physx_PxAABBManager_Pod const* self__pod) {
        physx::PxAABBManager const* self_ = reinterpret_cast<physx::PxAABBManager const*>(self__pod);
        uint32_t const* return_val = self_->getGroups();
        return return_val;
    }

    uint32_t physx_PxAABBManager_getCapacity(physx_PxAABBManager_Pod const* self__pod) {
        physx::PxAABBManager const* self_ = reinterpret_cast<physx::PxAABBManager const*>(self__pod);
        uint32_t return_val = self_->getCapacity();
        return return_val;
    }

    void physx_PxAABBManager_addObject_mut(physx_PxAABBManager_Pod* self__pod, uint32_t index, physx_PxBounds3_Pod const* bounds_pod, uint32_t group, float distance) {
        physx::PxAABBManager* self_ = reinterpret_cast<physx::PxAABBManager*>(self__pod);
        physx::PxBounds3 const& bounds = reinterpret_cast<physx::PxBounds3 const&>(*bounds_pod);
        self_->addObject(index, bounds, group, distance);
    }

    void physx_PxAABBManager_removeObject_mut(physx_PxAABBManager_Pod* self__pod, uint32_t index) {
        physx::PxAABBManager* self_ = reinterpret_cast<physx::PxAABBManager*>(self__pod);
        self_->removeObject(index);
    }

    void physx_PxAABBManager_updateObject_mut(physx_PxAABBManager_Pod* self__pod, uint32_t index, physx_PxBounds3_Pod const* bounds_pod, float const* distance) {
        physx::PxAABBManager* self_ = reinterpret_cast<physx::PxAABBManager*>(self__pod);
        physx::PxBounds3 const* bounds = reinterpret_cast<physx::PxBounds3 const*>(bounds_pod);
        self_->updateObject(index, bounds, distance);
    }

    void physx_PxAABBManager_update_mut(physx_PxAABBManager_Pod* self__pod, physx_PxBaseTask_Pod* continuation_pod) {
        physx::PxAABBManager* self_ = reinterpret_cast<physx::PxAABBManager*>(self__pod);
        physx::PxBaseTask* continuation = reinterpret_cast<physx::PxBaseTask*>(continuation_pod);
        self_->update(continuation);
    }

    void physx_PxAABBManager_fetchResults_mut(physx_PxAABBManager_Pod* self__pod, physx_PxBroadPhaseResults_Pod* results_pod) {
        physx::PxAABBManager* self_ = reinterpret_cast<physx::PxAABBManager*>(self__pod);
        physx::PxBroadPhaseResults& results = reinterpret_cast<physx::PxBroadPhaseResults&>(*results_pod);
        self_->fetchResults(results);
    }

    void physx_PxAABBManager_update_mut_1(physx_PxAABBManager_Pod* self__pod, physx_PxBroadPhaseResults_Pod* results_pod) {
        physx::PxAABBManager* self_ = reinterpret_cast<physx::PxAABBManager*>(self__pod);
        physx::PxBroadPhaseResults& results = reinterpret_cast<physx::PxBroadPhaseResults&>(*results_pod);
        self_->update(results);
    }

    physx_PxAABBManager_Pod* physx_phys_PxCreateAABBManager(physx_PxBroadPhase_Pod* broadphase_pod) {
    ...
    physx_PxSceneLimits_Pod physx_PxSceneLimits_new() {
    ...
    void physx_PxSceneLimits_setToDefault_mut(physx_PxSceneLimits_Pod* self__pod) {
        physx::PxSceneLimits* self_ = reinterpret_cast<physx::PxSceneLimits*>(self__pod);
        self_->setToDefault();
    }

    bool physx_PxSceneLimits_isValid(physx_PxSceneLimits_Pod const* self__pod) {
        physx::PxSceneLimits const* self_ = reinterpret_cast<physx::PxSceneLimits const*>(self__pod);
        bool return_val = self_->isValid();
        return return_val;
    }

    physx_PxgDynamicsMemoryConfig_Pod physx_PxgDynamicsMemoryConfig_new() {
    ...
    bool physx_PxgDynamicsMemoryConfig_isValid(physx_PxgDynamicsMemoryConfig_Pod const* self__pod) {
        physx::PxgDynamicsMemoryConfig const* self_ = reinterpret_cast<physx::PxgDynamicsMemoryConfig const*>(self__pod);
        bool return_val = self_->isValid();
        return return_val;
    }

    physx_PxSceneDesc_Pod physx_PxSceneDesc_new(physx_PxTolerancesScale_Pod const* scale_pod) {
        physx::PxTolerancesScale const& scale = reinterpret_cast<physx::PxTolerancesScale const&>(*scale_pod);
    ...
    void physx_PxSceneDesc_setToDefault_mut(physx_PxSceneDesc_Pod* self__pod, physx_PxTolerancesScale_Pod const* scale_pod) {
        physx::PxSceneDesc* self_ = reinterpret_cast<physx::PxSceneDesc*>(self__pod);
        physx::PxTolerancesScale const& scale = reinterpret_cast<physx::PxTolerancesScale const&>(*scale_pod);
        self_->setToDefault(scale);
    }

    bool physx_PxSceneDesc_isValid(physx_PxSceneDesc_Pod const* self__pod) {
        physx::PxSceneDesc const* self_ = reinterpret_cast<physx::PxSceneDesc const*>(self__pod);
        bool return_val = self_->isValid();
        return return_val;
    }

    physx_PxTolerancesScale_Pod const* physx_PxSceneDesc_getTolerancesScale(physx_PxSceneDesc_Pod const* self__pod) {
        physx::PxSceneDesc const* self_ = reinterpret_cast<physx::PxSceneDesc const*>(self__pod);
        physx::PxTolerancesScale const& return_val = self_->getTolerancesScale();
        auto return_val_pod = reinterpret_cast<physx_PxTolerancesScale_Pod const*>(&return_val);
        return return_val_pod;
    ...
    uint32_t physx_PxSimulationStatistics_getNbBroadPhaseAdds(physx_PxSimulationStatistics_Pod const* self__pod) {
    ...
    uint32_t physx_PxSimulationStatistics_getNbBroadPhaseRemoves(physx_PxSimulationStatistics_Pod const* self__pod) {
        physx::PxSimulationStatistics const* self_ = reinterpret_cast<physx::PxSimulationStatistics const*>(self__pod);
        uint32_t return_val = self_->getNbBroadPhaseRemoves();
        return return_val;
    }

    uint32_t physx_PxSimulationStatistics_getRbPairStats(physx_PxSimulationStatistics_Pod const* self__pod, int32_t pairType_pod, int32_t g0_pod, int32_t g1_pod) {
        physx::PxSimulationStatistics const* self_ = reinterpret_cast<physx::PxSimulationStatistics const*>(self__pod);
    ...
    physx_PxSimulationStatistics_Pod physx_PxSimulationStatistics_new() {
    ...
    void physx_PxPvdSceneClient_setScenePvdFlag_mut(physx_PxPvdSceneClient_Pod* self__pod, int32_t flag_pod, bool value) {
    ...
    void physx_PxPvdSceneClient_setScenePvdFlags_mut(physx_PxPvdSceneClient_Pod* self__pod, uint8_t flags_pod) {
        physx::PxPvdSceneClient* self_ = reinterpret_cast<physx::PxPvdSceneClient*>(self__pod);
        auto flags = physx::PxPvdSceneFlags(flags_pod);
        self_->setScenePvdFlags(flags);
    }

    uint8_t physx_PxPvdSceneClient_getScenePvdFlags(physx_PxPvdSceneClient_Pod const* self__pod) {
    ...
    void physx_PxPvdSceneClient_updateCamera_mut(physx_PxPvdSceneClient_Pod* self__pod, char const* name, physx_PxVec3_Pod const* origin_pod, physx_PxVec3_Pod const* up_pod, physx_PxVec3_Pod const* target_pod) {
        physx::PxPvdSceneClient* self_ = reinterpret_cast<physx::PxPvdSceneClient*>(self__pod);
        physx::PxVec3 const& origin = reinterpret_cast<physx::PxVec3 const&>(*origin_pod);
    ...
    void physx_PxPvdSceneClient_drawPoints_mut(physx_PxPvdSceneClient_Pod* self__pod, physx_PxDebugPoint_Pod const* points_pod, uint32_t count) {
        physx::PxPvdSceneClient* self_ = reinterpret_cast<physx::PxPvdSceneClient*>(self__pod);
        physx::PxDebugPoint const* points = reinterpret_cast<physx::PxDebugPoint const*>(points_pod);
        self_->drawPoints(points, count);
    }

    void physx_PxPvdSceneClient_drawLines_mut(physx_PxPvdSceneClient_Pod* self__pod, physx_PxDebugLine_Pod const* lines_pod, uint32_t count) {
        physx::PxPvdSceneClient* self_ = reinterpret_cast<physx::PxPvdSceneClient*>(self__pod);
        physx::PxDebugLine const* lines = reinterpret_cast<physx::PxDebugLine const*>(lines_pod);
        self_->drawLines(lines, count);
    }

    void physx_PxPvdSceneClient_drawTriangles_mut(physx_PxPvdSceneClient_Pod* self__pod, physx_PxDebugTriangle_Pod const* triangles_pod, uint32_t count) {
        physx::PxPvdSceneClient* self_ = reinterpret_cast<physx::PxPvdSceneClient*>(self__pod);
    ...
    void physx_PxPvdSceneClient_drawText_mut(physx_PxPvdSceneClient_Pod* self__pod, physx_PxDebugText_Pod const* text_pod) {
        physx::PxPvdSceneClient* self_ = reinterpret_cast<physx::PxPvdSceneClient*>(self__pod);
        physx::PxDebugText const& text = reinterpret_cast<physx::PxDebugText const&>(*text_pod);
        self_->drawText(text);
    }

    physx_PxDominanceGroupPair_Pod physx_PxDominanceGroupPair_new(uint8_t a, uint8_t b) {
    ...
    void physx_PxBroadPhaseCallback_delete(physx_PxBroadPhaseCallback_Pod* self__pod) {
        physx::PxBroadPhaseCallback* self_ = reinterpret_cast<physx::PxBroadPhaseCallback*>(self__pod);
        delete self_;
    }

    void physx_PxBroadPhaseCallback_onObjectOutOfBounds_mut(physx_PxBroadPhaseCallback_Pod* self__pod, physx_PxShape_Pod* shape_pod, physx_PxActor_Pod* actor_pod) {
        physx::PxBroadPhaseCallback* self_ = reinterpret_cast<physx::PxBroadPhaseCallback*>(self__pod);
        physx::PxShape& shape = reinterpret_cast<physx::PxShape&>(*shape_pod);
        physx::PxActor& actor = reinterpret_cast<physx::PxActor&>(*actor_pod);
    ...
    void physx_PxBroadPhaseCallback_onObjectOutOfBounds_mut_1(physx_PxBroadPhaseCallback_Pod* self__pod, physx_PxAggregate_Pod* aggregate_pod) {
        physx::PxBroadPhaseCallback* self_ = reinterpret_cast<physx::PxBroadPhaseCallback*>(self__pod);
        physx::PxAggregate& aggregate = reinterpret_cast<physx::PxAggregate&>(*aggregate_pod);
        self_->onObjectOutOfBounds(aggregate);
    }

    void physx_PxScene_release_mut(physx_PxScene_Pod* self__pod) {
        physx::PxScene* self_ = reinterpret_cast<physx::PxScene*>(self__pod);
        self_->release();
    }

    void physx_PxScene_setFlag_mut(physx_PxScene_Pod* self__pod, int32_t flag_pod, bool value) {
        physx::PxScene* self_ = reinterpret_cast<physx::PxScene*>(self__pod);
        auto flag = static_cast<physx::PxSceneFlag::Enum>(flag_pod);
        self_->setFlag(flag, value);
    }

    uint32_t physx_PxScene_getFlags(physx_PxScene_Pod const* self__pod) {
    ...
    void physx_PxScene_setLimits_mut(physx_PxScene_Pod* self__pod, physx_PxSceneLimits_Pod const* limits_pod) {
        physx::PxScene* self_ = reinterpret_cast<physx::PxScene*>(self__pod);
        physx::PxSceneLimits const& limits = reinterpret_cast<physx::PxSceneLimits const&>(*limits_pod);
        self_->setLimits(limits);
    }

    physx_PxSceneLimits_Pod physx_PxScene_getLimits(physx_PxScene_Pod const* self__pod) {
        physx::PxScene const* self_ = reinterpret_cast<physx::PxScene const*>(self__pod);
    ...
    physx_PxPhysics_Pod* physx_PxScene_getPhysics_mut(physx_PxScene_Pod* self__pod) {
        physx::PxScene* self_ = reinterpret_cast<physx::PxScene*>(self__pod);
    ...
    uint32_t physx_PxScene_getTimestamp(physx_PxScene_Pod const* self__pod) {
        physx::PxScene const* self_ = reinterpret_cast<physx::PxScene const*>(self__pod);
        uint32_t return_val = self_->getTimestamp();
        return return_val;
    }

    bool physx_PxScene_addArticulation_mut(physx_PxScene_Pod* self__pod, physx_PxArticulationReducedCoordinate_Pod* articulation_pod) {
        physx::PxScene* self_ = reinterpret_cast<physx::PxScene*>(self__pod);
        physx::PxArticulationReducedCoordinate& articulation = reinterpret_cast<physx::PxArticulationReducedCoordinate&>(*articulation_pod);
        bool return_val = self_->addArticulation(articulation);
        return return_val;
    ...
    void physx_PxScene_removeArticulation_mut(physx_PxScene_Pod* self__pod, physx_PxArticulationReducedCoordinate_Pod* articulation_pod, bool wakeOnLostTouch) {
        physx::PxScene* self_ = reinterpret_cast<physx::PxScene*>(self__pod);
        physx::PxArticulationReducedCoordinate& articulation = reinterpret_cast<physx::PxArticulationReducedCoordinate&>(*articulation_pod);
        self_->removeArticulation(articulation, wakeOnLostTouch);
    }

    bool physx_PxScene_addActor_mut(physx_PxScene_Pod* self__pod, physx_PxActor_Pod* actor_pod, physx_PxBVH_Pod const* bvh_pod) {
        physx::PxScene* self_ = reinterpret_cast<physx::PxScene*>(self__pod);
        physx::PxActor& actor = reinterpret_cast<physx::PxActor&>(*actor_pod);
        physx::PxBVH const* bvh = reinterpret_cast<physx::PxBVH const*>(bvh_pod);
        bool return_val = self_->addActor(actor, bvh);
    ...
    bool physx_PxScene_addActors_mut(physx_PxScene_Pod* self__pod, physx_PxActor_Pod* const* actors_pod, uint32_t nbActors) {
        physx::PxScene* self_ = reinterpret_cast<physx::PxScene*>(self__pod);
    ...
    bool physx_PxScene_addActors_mut_1(physx_PxScene_Pod* self__pod, physx_PxPruningStructure_Pod const* pruningStructure_pod) {
        physx::PxScene* self_ = reinterpret_cast<physx::PxScene*>(self__pod);
        physx::PxPruningStructure const& pruningStructure = reinterpret_cast<physx::PxPruningStructure const&>(*pruningStructure_pod);
    ...
    void physx_PxScene_removeActor_mut(physx_PxScene_Pod* self__pod, physx_PxActor_Pod* actor_pod, bool wakeOnLostTouch) {
        physx::PxScene* self_ = reinterpret_cast<physx::PxScene*>(self__pod);
        physx::PxActor& actor = reinterpret_cast<physx::PxActor&>(*actor_pod);
        self_->removeActor(actor, wakeOnLostTouch);
    }

    void physx_PxScene_removeActors_mut(physx_PxScene_Pod* self__pod, physx_PxActor_Pod* const* actors_pod, uint32_t nbActors, bool wakeOnLostTouch) {
        physx::PxScene* self_ = reinterpret_cast<physx::PxScene*>(self__pod);
        physx::PxActor* const* actors = reinterpret_cast<physx::PxActor* const*>(actors_pod);
        self_->removeActors(actors, nbActors, wakeOnLostTouch);
    }

    bool physx_PxScene_addAggregate_mut(physx_PxScene_Pod* self__pod, physx_PxAggregate_Pod* aggregate_pod) {
        physx::PxScene* self_ = reinterpret_cast<physx::PxScene*>(self__pod);
        physx::PxAggregate& aggregate = reinterpret_cast<physx::PxAggregate&>(*aggregate_pod);
    ...
    void physx_PxScene_removeAggregate_mut(physx_PxScene_Pod* self__pod, physx_PxAggregate_Pod* aggregate_pod, bool wakeOnLostTouch) {
        physx::PxScene* self_ = reinterpret_cast<physx::PxScene*>(self__pod);
        physx::PxAggregate& aggregate = reinterpret_cast<physx::PxAggregate&>(*aggregate_pod);
        self_->removeAggregate(aggregate, wakeOnLostTouch);
    }

    bool physx_PxScene_addCollection_mut(physx_PxScene_Pod* self__pod, physx_PxCollection_Pod const* collection_pod) {
        physx::PxScene* self_ = reinterpret_cast<physx::PxScene*>(self__pod);
    ...
    uint32_t physx_PxScene_getNbActors(physx_PxScene_Pod const* self__pod, uint16_t types_pod) {
        physx::PxScene const* self_ = reinterpret_cast<physx::PxScene const*>(self__pod);
    ...
    uint32_t physx_PxScene_getActors(physx_PxScene_Pod const* self__pod, uint16_t types_pod, physx_PxActor_Pod** userBuffer_pod, uint32_t bufferSize, uint32_t startIndex) {
        physx::PxScene const* self_ = reinterpret_cast<physx::PxScene const*>(self__pod);
        auto types = physx::PxActorTypeFlags(types_pod);
        physx::PxActor** userBuffer = reinterpret_cast<physx::PxActor**>(userBuffer_pod);
    ...
    physx_PxActor_Pod** physx_PxScene_getActiveActors_mut(physx_PxScene_Pod* self__pod, uint32_t* nbActorsOut_pod) {
        physx::PxScene* self_ = reinterpret_cast<physx::PxScene*>(self__pod);
    ...
    uint32_t physx_PxScene_getNbArticulations(physx_PxScene_Pod const* self__pod) {
        physx::PxScene const* self_ = reinterpret_cast<physx::PxScene const*>(self__pod);
        uint32_t return_val = self_->getNbArticulations();
        return return_val;
    }

    uint32_t physx_PxScene_getArticulations(physx_PxScene_Pod const* self__pod, physx_PxArticulationReducedCoordinate_Pod** userBuffer_pod, uint32_t bufferSize, uint32_t startIndex) {
        physx::PxScene const* self_ = reinterpret_cast<physx::PxScene const*>(self__pod);
    ...
    uint32_t physx_PxScene_getNbConstraints(physx_PxScene_Pod const* self__pod) {
        physx::PxScene const* self_ = reinterpret_cast<physx::PxScene const*>(self__pod);
        uint32_t return_val = self_->getNbConstraints();
        return return_val;
    }

    uint32_t physx_PxScene_getConstraints(physx_PxScene_Pod const* self__pod, physx_PxConstraint_Pod** userBuffer_pod, uint32_t bufferSize, uint32_t startIndex) {
        physx::PxScene const* self_ = reinterpret_cast<physx::PxScene const*>(self__pod);
        physx::PxConstraint** userBuffer = reinterpret_cast<physx::PxConstraint**>(userBuffer_pod);
        uint32_t return_val = self_->getConstraints(userBuffer, bufferSize, startIndex);
        return return_val;
    ...
    uint32_t physx_PxScene_getNbAggregates(physx_PxScene_Pod const* self__pod) {
        physx::PxScene const* self_ = reinterpret_cast<physx::PxScene const*>(self__pod);
        uint32_t return_val = self_->getNbAggregates();
        return return_val;
    }

    uint32_t physx_PxScene_getAggregates(physx_PxScene_Pod const* self__pod, physx_PxAggregate_Pod** userBuffer_pod, uint32_t bufferSize, uint32_t startIndex) {
        physx::PxScene const* self_ = reinterpret_cast<physx::PxScene const*>(self__pod);
    ...
    void physx_PxScene_setDominanceGroupPair_mut(physx_PxScene_Pod* self__pod, uint8_t group1, uint8_t group2, physx_PxDominanceGroupPair_Pod const* dominance_pod) {
        physx::PxScene* self_ = reinterpret_cast<physx::PxScene*>(self__pod);
    ...
    physx_PxDominanceGroupPair_Pod physx_PxScene_getDominanceGroupPair(physx_PxScene_Pod const* self__pod, uint8_t group1, uint8_t group2) {
        physx::PxScene const* self_ = reinterpret_cast<physx::PxScene const*>(self__pod);
    ...
    physx_PxCpuDispatcher_Pod* physx_PxScene_getCpuDispatcher(physx_PxScene_Pod const* self__pod) {
        physx::PxScene const* self_ = reinterpret_cast<physx::PxScene const*>(self__pod);
        physx::PxCpuDispatcher* return_val = self_->getCpuDispatcher();
        auto return_val_pod = reinterpret_cast<physx_PxCpuDispatcher_Pod*>(return_val);
        return return_val_pod;
    ...
    uint8_t physx_PxScene_createClient_mut(physx_PxScene_Pod* self__pod) {
        physx::PxScene* self_ = reinterpret_cast<physx::PxScene*>(self__pod);
        uint8_t return_val = self_->createClient();
        return return_val;
    }

    void physx_PxScene_setSimulationEventCallback_mut(physx_PxScene_Pod* self__pod, physx_PxSimulationEventCallback_Pod* callback_pod) {
        physx::PxScene* self_ = reinterpret_cast<physx::PxScene*>(self__pod);
    ...
    physx_PxSimulationEventCallback_Pod* physx_PxScene_getSimulationEventCallback(physx_PxScene_Pod const* self__pod) {
        physx::PxScene const* self_ = reinterpret_cast<physx::PxScene const*>(self__pod);
    ...
    void physx_PxScene_setContactModifyCallback_mut(physx_PxScene_Pod* self__pod, physx_PxContactModifyCallback_Pod* callback_pod) {
        physx::PxScene* self_ = reinterpret_cast<physx::PxScene*>(self__pod);
    ...
    void physx_PxScene_setCCDContactModifyCallback_mut(physx_PxScene_Pod* self__pod, physx_PxCCDContactModifyCallback_Pod* callback_pod) {
        physx::PxScene* self_ = reinterpret_cast<physx::PxScene*>(self__pod);
    ...
    physx_PxContactModifyCallback_Pod* physx_PxScene_getContactModifyCallback(physx_PxScene_Pod const* self__pod) {
        physx::PxScene const* self_ = reinterpret_cast<physx::PxScene const*>(self__pod);
    ...
    physx_PxCCDContactModifyCallback_Pod* physx_PxScene_getCCDContactModifyCallback(physx_PxScene_Pod const* self__pod) {
        physx::PxScene const* self_ = reinterpret_cast<physx::PxScene const*>(self__pod);
    ...
    void physx_PxScene_setBroadPhaseCallback_mut(physx_PxScene_Pod* self__pod, physx_PxBroadPhaseCallback_Pod* callback_pod) {
        physx::PxScene* self_ = reinterpret_cast<physx::PxScene*>(self__pod);
    ...
    physx_PxBroadPhaseCallback_Pod* physx_PxScene_getBroadPhaseCallback(physx_PxScene_Pod const* self__pod) {
        physx::PxScene const* self_ = reinterpret_cast<physx::PxScene const*>(self__pod);
    ...
    void physx_PxScene_setFilterShaderData_mut(physx_PxScene_Pod* self__pod, void const* data, uint32_t dataSize) {
        physx::PxScene* self_ = reinterpret_cast<physx::PxScene*>(self__pod);
        self_->setFilterShaderData(data, dataSize);
    }

    void const* physx_PxScene_getFilterShaderData(physx_PxScene_Pod const* self__pod) {
        physx::PxScene const* self_ = reinterpret_cast<physx::PxScene const*>(self__pod);
        void const* return_val = self_->getFilterShaderData();
        return return_val;
    }

    uint32_t physx_PxScene_getFilterShaderDataSize(physx_PxScene_Pod const* self__pod) {
        physx::PxScene const* self_ = reinterpret_cast<physx::PxScene const*>(self__pod);
        uint32_t return_val = self_->getFilterShaderDataSize();
        return return_val;
    }

    bool physx_PxScene_resetFiltering_mut(physx_PxScene_Pod* self__pod, physx_PxActor_Pod* actor_pod) {
        physx::PxScene* self_ = reinterpret_cast<physx::PxScene*>(self__pod);
        physx::PxActor& actor = reinterpret_cast<physx::PxActor&>(*actor_pod);
    ...
    bool physx_PxScene_resetFiltering_mut_1(physx_PxScene_Pod* self__pod, physx_PxRigidActor_Pod* actor_pod, physx_PxShape_Pod* const* shapes_pod, uint32_t shapeCount) {
        physx::PxScene* self_ = reinterpret_cast<physx::PxScene*>(self__pod);
    ...
    int32_t physx_PxScene_getKinematicKinematicFilteringMode(physx_PxScene_Pod const* self__pod) {
        physx::PxScene const* self_ = reinterpret_cast<physx::PxScene const*>(self__pod);
    ...
    int32_t physx_PxScene_getStaticKinematicFilteringMode(physx_PxScene_Pod const* self__pod) {
        physx::PxScene const* self_ = reinterpret_cast<physx::PxScene const*>(self__pod);
    ...
    bool physx_PxScene_simulate_mut(physx_PxScene_Pod* self__pod, float elapsedTime, physx_PxBaseTask_Pod* completionTask_pod, void* scratchMemBlock, uint32_t scratchMemBlockSize, bool controlSimulation) {
        physx::PxScene* self_ = reinterpret_cast<physx::PxScene*>(self__pod);
        physx::PxBaseTask* completionTask = reinterpret_cast<physx::PxBaseTask*>(completionTask_pod);
    ...
    bool physx_PxScene_advance_mut(physx_PxScene_Pod* self__pod, physx_PxBaseTask_Pod* completionTask_pod) {
        physx::PxScene* self_ = reinterpret_cast<physx::PxScene*>(self__pod);
        physx::PxBaseTask* completionTask = reinterpret_cast<physx::PxBaseTask*>(completionTask_pod);
    ...
    bool physx_PxScene_collide_mut(physx_PxScene_Pod* self__pod, float elapsedTime, physx_PxBaseTask_Pod* completionTask_pod, void* scratchMemBlock, uint32_t scratchMemBlockSize, bool controlSimulation) {
        physx::PxScene* self_ = reinterpret_cast<physx::PxScene*>(self__pod);
        physx::PxBaseTask* completionTask = reinterpret_cast<physx::PxBaseTask*>(completionTask_pod);
    ...
    bool physx_PxScene_checkResults_mut(physx_PxScene_Pod* self__pod, bool block) {
        physx::PxScene* self_ = reinterpret_cast<physx::PxScene*>(self__pod);
        bool return_val = self_->checkResults(block);
        return return_val;
    }

    bool physx_PxScene_fetchCollision_mut(physx_PxScene_Pod* self__pod, bool block) {
        physx::PxScene* self_ = reinterpret_cast<physx::PxScene*>(self__pod);
        bool return_val = self_->fetchCollision(block);
        return return_val;
    }

    bool physx_PxScene_fetchResults_mut(physx_PxScene_Pod* self__pod, bool block, uint32_t* errorState) {
        physx::PxScene* self_ = reinterpret_cast<physx::PxScene*>(self__pod);
        bool return_val = self_->fetchResults(block, errorState);
        return return_val;
    }

    bool physx_PxScene_fetchResultsStart_mut(physx_PxScene_Pod* self__pod, physx_PxContactPairHeader_Pod const** contactPairs_pod, uint32_t* nbContactPairs_pod, bool block) {
        physx::PxScene* self_ = reinterpret_cast<physx::PxScene*>(self__pod);
    ...
    void physx_PxScene_processCallbacks_mut(physx_PxScene_Pod* self__pod, physx_PxBaseTask_Pod* continuation_pod) {
        physx::PxScene* self_ = reinterpret_cast<physx::PxScene*>(self__pod);
        physx::PxBaseTask* continuation = reinterpret_cast<physx::PxBaseTask*>(continuation_pod);
        self_->processCallbacks(continuation);
    }

    void physx_PxScene_fetchResultsFinish_mut(physx_PxScene_Pod* self__pod, uint32_t* errorState) {
        physx::PxScene* self_ = reinterpret_cast<physx::PxScene*>(self__pod);
        self_->fetchResultsFinish(errorState);
    }

    void physx_PxScene_fetchResultsParticleSystem_mut(physx_PxScene_Pod* self__pod) {
        physx::PxScene* self_ = reinterpret_cast<physx::PxScene*>(self__pod);
        self_->fetchResultsParticleSystem();
    }

    void physx_PxScene_flushSimulation_mut(physx_PxScene_Pod* self__pod, bool sendPendingReports) {
        physx::PxScene* self_ = reinterpret_cast<physx::PxScene*>(self__pod);
        self_->flushSimulation(sendPendingReports);
    }

    void physx_PxScene_setGravity_mut(physx_PxScene_Pod* self__pod, physx_PxVec3_Pod const* vec_pod) {
        physx::PxScene* self_ = reinterpret_cast<physx::PxScene*>(self__pod);
        physx::PxVec3 const& vec = reinterpret_cast<physx::PxVec3 const&>(*vec_pod);
        self_->setGravity(vec);
    }

    physx_PxVec3_Pod physx_PxScene_getGravity(physx_PxScene_Pod const* self__pod) {
        physx::PxScene const* self_ = reinterpret_cast<physx::PxScene const*>(self__pod);
    ...
    void physx_PxScene_setBounceThresholdVelocity_mut(physx_PxScene_Pod* self__pod, float t) {
        physx::PxScene* self_ = reinterpret_cast<physx::PxScene*>(self__pod);
        self_->setBounceThresholdVelocity(t);
    }

    float physx_PxScene_getBounceThresholdVelocity(physx_PxScene_Pod const* self__pod) {
        physx::PxScene const* self_ = reinterpret_cast<physx::PxScene const*>(self__pod);
        float return_val = self_->getBounceThresholdVelocity();
        return return_val;
    }

    void physx_PxScene_setCCDMaxPasses_mut(physx_PxScene_Pod* self__pod, uint32_t ccdMaxPasses) {
        physx::PxScene* self_ = reinterpret_cast<physx::PxScene*>(self__pod);
        self_->setCCDMaxPasses(ccdMaxPasses);
    }

    uint32_t physx_PxScene_getCCDMaxPasses(physx_PxScene_Pod const* self__pod) {
        physx::PxScene const* self_ = reinterpret_cast<physx::PxScene const*>(self__pod);
        uint32_t return_val = self_->getCCDMaxPasses();
        return return_val;
    }

    void physx_PxScene_setCCDMaxSeparation_mut(physx_PxScene_Pod* self__pod, float t) {
        physx::PxScene* self_ = reinterpret_cast<physx::PxScene*>(self__pod);
        self_->setCCDMaxSeparation(t);
    }

    float physx_PxScene_getCCDMaxSeparation(physx_PxScene_Pod const* self__pod) {
        physx::PxScene const* self_ = reinterpret_cast<physx::PxScene const*>(self__pod);
        float return_val = self_->getCCDMaxSeparation();
        return return_val;
    }

    void physx_PxScene_setCCDThreshold_mut(physx_PxScene_Pod* self__pod, float t) {
        physx::PxScene* self_ = reinterpret_cast<physx::PxScene*>(self__pod);
        self_->setCCDThreshold(t);
    }

    float physx_PxScene_getCCDThreshold(physx_PxScene_Pod const* self__pod) {
        physx::PxScene const* self_ = reinterpret_cast<physx::PxScene const*>(self__pod);
        float return_val = self_->getCCDThreshold();
        return return_val;
    }

    void physx_PxScene_setMaxBiasCoefficient_mut(physx_PxScene_Pod* self__pod, float t) {
        physx::PxScene* self_ = reinterpret_cast<physx::PxScene*>(self__pod);
        self_->setMaxBiasCoefficient(t);
    }

    float physx_PxScene_getMaxBiasCoefficient(physx_PxScene_Pod const* self__pod) {
        physx::PxScene const* self_ = reinterpret_cast<physx::PxScene const*>(self__pod);
        float return_val = self_->getMaxBiasCoefficient();
        return return_val;
    }

    void physx_PxScene_setFrictionOffsetThreshold_mut(physx_PxScene_Pod* self__pod, float t) {
        physx::PxScene* self_ = reinterpret_cast<physx::PxScene*>(self__pod);
        self_->setFrictionOffsetThreshold(t);
    }

    float physx_PxScene_getFrictionOffsetThreshold(physx_PxScene_Pod const* self__pod) {
        physx::PxScene const* self_ = reinterpret_cast<physx::PxScene const*>(self__pod);
        float return_val = self_->getFrictionOffsetThreshold();
        return return_val;
    }

    void physx_PxScene_setFrictionCorrelationDistance_mut(physx_PxScene_Pod* self__pod, float t) {
        physx::PxScene* self_ = reinterpret_cast<physx::PxScene*>(self__pod);
        self_->setFrictionCorrelationDistance(t);
    }

    float physx_PxScene_getFrictionCorrelationDistance(physx_PxScene_Pod const* self__pod) {
        physx::PxScene const* self_ = reinterpret_cast<physx::PxScene const*>(self__pod);
        float return_val = self_->getFrictionCorrelationDistance();
        return return_val;
    }

    int32_t physx_PxScene_getFrictionType(physx_PxScene_Pod const* self__pod) {
        physx::PxScene const* self_ = reinterpret_cast<physx::PxScene const*>(self__pod);
    ...
    int32_t physx_PxScene_getSolverType(physx_PxScene_Pod const* self__pod) {
        physx::PxScene const* self_ = reinterpret_cast<physx::PxScene const*>(self__pod);
    ...
    bool physx_PxScene_setVisualizationParameter_mut(physx_PxScene_Pod* self__pod, int32_t param_pod, float value) {
        physx::PxScene* self_ = reinterpret_cast<physx::PxScene*>(self__pod);
    ...
    float physx_PxScene_getVisualizationParameter(physx_PxScene_Pod const* self__pod, int32_t paramEnum_pod) {
        physx::PxScene const* self_ = reinterpret_cast<physx::PxScene const*>(self__pod);
    ...
    void physx_PxScene_setVisualizationCullingBox_mut(physx_PxScene_Pod* self__pod, physx_PxBounds3_Pod const* box_pod) {
        physx::PxScene* self_ = reinterpret_cast<physx::PxScene*>(self__pod);
        physx::PxBounds3 const& box = reinterpret_cast<physx::PxBounds3 const&>(*box_pod);
        self_->setVisualizationCullingBox(box);
    }

    physx_PxBounds3_Pod physx_PxScene_getVisualizationCullingBox(physx_PxScene_Pod const* self__pod) {
        physx::PxScene const* self_ = reinterpret_cast<physx::PxScene const*>(self__pod);
    ...
    physx_PxRenderBuffer_Pod const* physx_PxScene_getRenderBuffer_mut(physx_PxScene_Pod* self__pod) {
        physx::PxScene* self_ = reinterpret_cast<physx::PxScene*>(self__pod);
    ...
    void physx_PxScene_getSimulationStatistics(physx_PxScene_Pod const* self__pod, physx_PxSimulationStatistics_Pod* stats_pod) {
        physx::PxScene const* self_ = reinterpret_cast<physx::PxScene const*>(self__pod);
    ...
    int32_t physx_PxScene_getBroadPhaseType(physx_PxScene_Pod const* self__pod) {
        physx::PxScene const* self_ = reinterpret_cast<physx::PxScene const*>(self__pod);
    ...
    bool physx_PxScene_getBroadPhaseCaps(physx_PxScene_Pod const* self__pod, physx_PxBroadPhaseCaps_Pod* caps_pod) {
        physx::PxScene const* self_ = reinterpret_cast<physx::PxScene const*>(self__pod);
        physx::PxBroadPhaseCaps& caps = reinterpret_cast<physx::PxBroadPhaseCaps&>(*caps_pod);
    ...
    uint32_t physx_PxScene_getNbBroadPhaseRegions(physx_PxScene_Pod const* self__pod) {
        physx::PxScene const* self_ = reinterpret_cast<physx::PxScene const*>(self__pod);
        uint32_t return_val = self_->getNbBroadPhaseRegions();
        return return_val;
    }

    uint32_t physx_PxScene_getBroadPhaseRegions(physx_PxScene_Pod const* self__pod, physx_PxBroadPhaseRegionInfo_Pod* userBuffer_pod, uint32_t bufferSize, uint32_t startIndex) {
        physx::PxScene const* self_ = reinterpret_cast<physx::PxScene const*>(self__pod);
        physx::PxBroadPhaseRegionInfo* userBuffer = reinterpret_cast<physx::PxBroadPhaseRegionInfo*>(userBuffer_pod);
    ...
    uint32_t physx_PxScene_addBroadPhaseRegion_mut(physx_PxScene_Pod* self__pod, physx_PxBroadPhaseRegion_Pod const* region_pod, bool populateRegion) {
        physx::PxScene* self_ = reinterpret_cast<physx::PxScene*>(self__pod);
        physx::PxBroadPhaseRegion const& region = reinterpret_cast<physx::PxBroadPhaseRegion const&>(*region_pod);
    ...
    bool physx_PxScene_removeBroadPhaseRegion_mut(physx_PxScene_Pod* self__pod, uint32_t handle) {
        physx::PxScene* self_ = reinterpret_cast<physx::PxScene*>(self__pod);
        bool return_val = self_->removeBroadPhaseRegion(handle);
        return return_val;
    }

    physx_PxTaskManager_Pod* physx_PxScene_getTaskManager(physx_PxScene_Pod const* self__pod) {
        physx::PxScene const* self_ = reinterpret_cast<physx::PxScene const*>(self__pod);
        physx::PxTaskManager* return_val = self_->getTaskManager();
        auto return_val_pod = reinterpret_cast<physx_PxTaskManager_Pod*>(return_val);
        return return_val_pod;
    ...
    void physx_PxScene_lockRead_mut(physx_PxScene_Pod* self__pod, char const* file, uint32_t line) {
        physx::PxScene* self_ = reinterpret_cast<physx::PxScene*>(self__pod);
        self_->lockRead(file, line);
    }

    void physx_PxScene_unlockRead_mut(physx_PxScene_Pod* self__pod) {
        physx::PxScene* self_ = reinterpret_cast<physx::PxScene*>(self__pod);
        self_->unlockRead();
    }

    void physx_PxScene_lockWrite_mut(physx_PxScene_Pod* self__pod, char const* file, uint32_t line) {
        physx::PxScene* self_ = reinterpret_cast<physx::PxScene*>(self__pod);
        self_->lockWrite(file, line);
    }

    void physx_PxScene_unlockWrite_mut(physx_PxScene_Pod* self__pod) {
        physx::PxScene* self_ = reinterpret_cast<physx::PxScene*>(self__pod);
        self_->unlockWrite();
    }

    void physx_PxScene_setNbContactDataBlocks_mut(physx_PxScene_Pod* self__pod, uint32_t numBlocks) {
        physx::PxScene* self_ = reinterpret_cast<physx::PxScene*>(self__pod);
        self_->setNbContactDataBlocks(numBlocks);
    }

    uint32_t physx_PxScene_getNbContactDataBlocksUsed(physx_PxScene_Pod const* self__pod) {
        physx::PxScene const* self_ = reinterpret_cast<physx::PxScene const*>(self__pod);
        uint32_t return_val = self_->getNbContactDataBlocksUsed();
        return return_val;
    }

    uint32_t physx_PxScene_getMaxNbContactDataBlocksUsed(physx_PxScene_Pod const* self__pod) {
        physx::PxScene const* self_ = reinterpret_cast<physx::PxScene const*>(self__pod);
        uint32_t return_val = self_->getMaxNbContactDataBlocksUsed();
        return return_val;
    }

    uint32_t physx_PxScene_getContactReportStreamBufferSize(physx_PxScene_Pod const* self__pod) {
        physx::PxScene const* self_ = reinterpret_cast<physx::PxScene const*>(self__pod);
        uint32_t return_val = self_->getContactReportStreamBufferSize();
        return return_val;
    }

    void physx_PxScene_setSolverBatchSize_mut(physx_PxScene_Pod* self__pod, uint32_t solverBatchSize) {
        physx::PxScene* self_ = reinterpret_cast<physx::PxScene*>(self__pod);
        self_->setSolverBatchSize(solverBatchSize);
    }

    uint32_t physx_PxScene_getSolverBatchSize(physx_PxScene_Pod const* self__pod) {
        physx::PxScene const* self_ = reinterpret_cast<physx::PxScene const*>(self__pod);
        uint32_t return_val = self_->getSolverBatchSize();
        return return_val;
    }

    void physx_PxScene_setSolverArticulationBatchSize_mut(physx_PxScene_Pod* self__pod, uint32_t solverBatchSize) {
        physx::PxScene* self_ = reinterpret_cast<physx::PxScene*>(self__pod);
        self_->setSolverArticulationBatchSize(solverBatchSize);
    }

    uint32_t physx_PxScene_getSolverArticulationBatchSize(physx_PxScene_Pod const* self__pod) {
        physx::PxScene const* self_ = reinterpret_cast<physx::PxScene const*>(self__pod);
        uint32_t return_val = self_->getSolverArticulationBatchSize();
        return return_val;
    }

    float physx_PxScene_getWakeCounterResetValue(physx_PxScene_Pod const* self__pod) {
        physx::PxScene const* self_ = reinterpret_cast<physx::PxScene const*>(self__pod);
        float return_val = self_->getWakeCounterResetValue();
        return return_val;
    }

    void physx_PxScene_shiftOrigin_mut(physx_PxScene_Pod* self__pod, physx_PxVec3_Pod const* shift_pod) {
        physx::PxScene* self_ = reinterpret_cast<physx::PxScene*>(self__pod);
        physx::PxVec3 const& shift = reinterpret_cast<physx::PxVec3 const&>(*shift_pod);
        self_->shiftOrigin(shift);
    }

    physx_PxPvdSceneClient_Pod* physx_PxScene_getScenePvdClient_mut(physx_PxScene_Pod* self__pod) {
        physx::PxScene* self_ = reinterpret_cast<physx::PxScene*>(self__pod);
    ...
    void physx_PxScene_copyArticulationData_mut(physx_PxScene_Pod* self__pod, void* data, void* index, int32_t dataType_pod, uint32_t nbCopyArticulations, void* copyEvent) {
        physx::PxScene* self_ = reinterpret_cast<physx::PxScene*>(self__pod);
    ...
    void physx_PxScene_applyArticulationData_mut(physx_PxScene_Pod* self__pod, void* data, void* index, int32_t dataType_pod, uint32_t nbUpdatedArticulations, void* waitEvent, void* signalEvent) {
        physx::PxScene* self_ = reinterpret_cast<physx::PxScene*>(self__pod);
        auto dataType = static_cast<physx::PxArticulationGpuDataType::Enum>(dataType_pod);
        self_->applyArticulationData(data, index, dataType, nbUpdatedArticulations, waitEvent, signalEvent);
    }

    void physx_PxScene_copySoftBodyData_mut(physx_PxScene_Pod* self__pod, void** data, void* dataSizes, void* softBodyIndices, int32_t flag_pod, uint32_t nbCopySoftBodies, uint32_t maxSize, void* copyEvent) {
        physx::PxScene* self_ = reinterpret_cast<physx::PxScene*>(self__pod);
    ...
    void physx_PxScene_applySoftBodyData_mut(physx_PxScene_Pod* self__pod, void** data, void* dataSizes, void* softBodyIndices, int32_t flag_pod, uint32_t nbUpdatedSoftBodies, uint32_t maxSize, void* applyEvent) {
        physx::PxScene* self_ = reinterpret_cast<physx::PxScene*>(self__pod);
        auto flag = static_cast<physx::PxSoftBodyDataFlag::Enum>(flag_pod);
        self_->applySoftBodyData(data, dataSizes, softBodyIndices, flag, nbUpdatedSoftBodies, maxSize, applyEvent);
    }

    void physx_PxScene_copyContactData_mut(physx_PxScene_Pod* self__pod, void* data, uint32_t maxContactPairs, void* numContactPairs, void* copyEvent) {
        physx::PxScene* self_ = reinterpret_cast<physx::PxScene*>(self__pod);
        self_->copyContactData(data, maxContactPairs, numContactPairs, copyEvent);
    }

    void physx_PxScene_copyBodyData_mut(physx_PxScene_Pod* self__pod, physx_PxGpuBodyData_Pod* data_pod, physx_PxGpuActorPair_Pod* index_pod, uint32_t nbCopyActors, void* copyEvent) {
        physx::PxScene* self_ = reinterpret_cast<physx::PxScene*>(self__pod);
    ...
    void physx_PxScene_applyActorData_mut(physx_PxScene_Pod* self__pod, void* data, physx_PxGpuActorPair_Pod* index_pod, int32_t flag_pod, uint32_t nbUpdatedActors, void* waitEvent, void* signalEvent) {
        physx::PxScene* self_ = reinterpret_cast<physx::PxScene*>(self__pod);
        physx::PxGpuActorPair* index = reinterpret_cast<physx::PxGpuActorPair*>(index_pod);
    ...
    void physx_PxScene_computeDenseJacobians_mut(physx_PxScene_Pod* self__pod, physx_PxIndexDataPair_Pod const* indices_pod, uint32_t nbIndices, void* computeEvent) {
        physx::PxScene* self_ = reinterpret_cast<physx::PxScene*>(self__pod);
    ...
    void physx_PxScene_computeGeneralizedMassMatrices_mut(physx_PxScene_Pod* self__pod, physx_PxIndexDataPair_Pod const* indices_pod, uint32_t nbIndices, void* computeEvent) {
        physx::PxScene* self_ = reinterpret_cast<physx::PxScene*>(self__pod);
        physx::PxIndexDataPair const* indices = reinterpret_cast<physx::PxIndexDataPair const*>(indices_pod);
        self_->computeGeneralizedMassMatrices(indices, nbIndices, computeEvent);
    }

    void physx_PxScene_computeGeneralizedGravityForces_mut(physx_PxScene_Pod* self__pod, physx_PxIndexDataPair_Pod const* indices_pod, uint32_t nbIndices, void* computeEvent) {
        physx::PxScene* self_ = reinterpret_cast<physx::PxScene*>(self__pod);
        physx::PxIndexDataPair const* indices = reinterpret_cast<physx::PxIndexDataPair const*>(indices_pod);
        self_->computeGeneralizedGravityForces(indices, nbIndices, computeEvent);
    }

    void physx_PxScene_computeCoriolisAndCentrifugalForces_mut(physx_PxScene_Pod* self__pod, physx_PxIndexDataPair_Pod const* indices_pod, uint32_t nbIndices, void* computeEvent) {
        physx::PxScene* self_ = reinterpret_cast<physx::PxScene*>(self__pod);
        physx::PxIndexDataPair const* indices = reinterpret_cast<physx::PxIndexDataPair const*>(indices_pod);
        self_->computeCoriolisAndCentrifugalForces(indices, nbIndices, computeEvent);
    }

    physx_PxgDynamicsMemoryConfig_Pod physx_PxScene_getGpuDynamicsConfig(physx_PxScene_Pod const* self__pod) {
        physx::PxScene const* self_ = reinterpret_cast<physx::PxScene const*>(self__pod);
    ...
    void physx_PxScene_applyParticleBufferData_mut(physx_PxScene_Pod* self__pod, uint32_t const* indices, physx_PxGpuParticleBufferIndexPair_Pod const* bufferIndexPair_pod, uint32_t const* flags_pod, uint32_t nbUpdatedBuffers, void* waitEvent, void* signalEvent) {
        physx::PxScene* self_ = reinterpret_cast<physx::PxScene*>(self__pod);
    ...
    physx_PxSceneReadLock_Pod* physx_PxSceneReadLock_new_alloc(physx_PxScene_Pod* scene_pod, char const* file, uint32_t line) {
    ...
    void physx_PxSceneReadLock_delete(physx_PxSceneReadLock_Pod* self__pod) {
        physx::PxSceneReadLock* self_ = reinterpret_cast<physx::PxSceneReadLock*>(self__pod);
        delete self_;
    }

    physx_PxSceneWriteLock_Pod* physx_PxSceneWriteLock_new_alloc(physx_PxScene_Pod* scene_pod, char const* file, uint32_t line) {
        physx::PxScene& scene = reinterpret_cast<physx::PxScene&>(*scene_pod);
    ...
    void physx_PxSceneWriteLock_delete(physx_PxSceneWriteLock_Pod* self__pod) {
        physx::PxSceneWriteLock* self_ = reinterpret_cast<physx::PxSceneWriteLock*>(self__pod);
        delete self_;
    }

    physx_PxContactPairExtraDataItem_Pod physx_PxContactPairExtraDataItem_new() {
    ...
    physx_PxContactPairVelocity_Pod physx_PxContactPairVelocity_new() {
    ...
    physx_PxContactPairPose_Pod physx_PxContactPairPose_new() {
    ...
    physx_PxContactPairIndex_Pod physx_PxContactPairIndex_new() {
    ...
    physx_PxContactPairExtraDataIterator_Pod physx_PxContactPairExtraDataIterator_new(uint8_t const* stream, uint32_t size) {
    ...
    bool physx_PxContactPairExtraDataIterator_nextItemSet_mut(physx_PxContactPairExtraDataIterator_Pod* self__pod) {
    ...
    physx_PxContactPairHeader_Pod physx_PxContactPairHeader_new() {
    ...
    physx_PxContactPair_Pod physx_PxContactPair_new() {
    ...
    uint32_t physx_PxContactPair_extractContacts(physx_PxContactPair_Pod const* self__pod, physx_PxContactPairPoint_Pod* userBuffer_pod, uint32_t bufferSize) {
    ...
    void physx_PxContactPair_bufferContacts(physx_PxContactPair_Pod const* self__pod, physx_PxContactPair_Pod* newPair_pod, uint8_t* bufferMemory) {
        physx::PxContactPair const* self_ = reinterpret_cast<physx::PxContactPair const*>(self__pod);
        physx::PxContactPair* newPair = reinterpret_cast<physx::PxContactPair*>(newPair_pod);
        self_->bufferContacts(newPair, bufferMemory);
    }

    uint32_t const* physx_PxContactPair_getInternalFaceIndices(physx_PxContactPair_Pod const* self__pod) {
        physx::PxContactPair const* self_ = reinterpret_cast<physx::PxContactPair const*>(self__pod);
        uint32_t const* return_val = self_->getInternalFaceIndices();
        return return_val;
    }

    physx_PxTriggerPair_Pod physx_PxTriggerPair_new() {
    ...
    physx_PxConstraintInfo_Pod physx_PxConstraintInfo_new() {
    ...
    physx_PxConstraintInfo_Pod physx_PxConstraintInfo_new_1(physx_PxConstraint_Pod* c_pod, void* extRef, uint32_t t) {
    ...
    void physx_PxSimulationEventCallback_onConstraintBreak_mut(physx_PxSimulationEventCallback_Pod* self__pod, physx_PxConstraintInfo_Pod* constraints_pod, uint32_t count) {
    ...
    void physx_PxSimulationEventCallback_onWake_mut(physx_PxSimulationEventCallback_Pod* self__pod, physx_PxActor_Pod** actors_pod, uint32_t count) {
        physx::PxSimulationEventCallback* self_ = reinterpret_cast<physx::PxSimulationEventCallback*>(self__pod);
        physx::PxActor** actors = reinterpret_cast<physx::PxActor**>(actors_pod);
        self_->onWake(actors, count);
    }

    void physx_PxSimulationEventCallback_onSleep_mut(physx_PxSimulationEventCallback_Pod* self__pod, physx_PxActor_Pod** actors_pod, uint32_t count) {
        physx::PxSimulationEventCallback* self_ = reinterpret_cast<physx::PxSimulationEventCallback*>(self__pod);
        physx::PxActor** actors = reinterpret_cast<physx::PxActor**>(actors_pod);
        self_->onSleep(actors, count);
    }

    void physx_PxSimulationEventCallback_onContact_mut(physx_PxSimulationEventCallback_Pod* self__pod, physx_PxContactPairHeader_Pod const* pairHeader_pod, physx_PxContactPair_Pod const* pairs_pod, uint32_t nbPairs) {
        physx::PxSimulationEventCallback* self_ = reinterpret_cast<physx::PxSimulationEventCallback*>(self__pod);
    ...
    void physx_PxSimulationEventCallback_onTrigger_mut(physx_PxSimulationEventCallback_Pod* self__pod, physx_PxTriggerPair_Pod* pairs_pod, uint32_t count) {
        physx::PxSimulationEventCallback* self_ = reinterpret_cast<physx::PxSimulationEventCallback*>(self__pod);
        physx::PxTriggerPair* pairs = reinterpret_cast<physx::PxTriggerPair*>(pairs_pod);
        self_->onTrigger(pairs, count);
    }

    void physx_PxSimulationEventCallback_onAdvance_mut(physx_PxSimulationEventCallback_Pod* self__pod, physx_PxRigidBody_Pod const* const* bodyBuffer_pod, physx_PxTransform_Pod const* poseBuffer_pod, uint32_t count) {
        physx::PxSimulationEventCallback* self_ = reinterpret_cast<physx::PxSimulationEventCallback*>(self__pod);
    ...
    void physx_PxSimulationEventCallback_delete(physx_PxSimulationEventCallback_Pod* self__pod) {
        physx::PxSimulationEventCallback* self_ = reinterpret_cast<physx::PxSimulationEventCallback*>(self__pod);
        delete self_;
    }

    physx_PxFEMParameters_Pod physx_PxFEMParameters_new() {
    ...
    void physx_PxPruningStructure_release_mut(physx_PxPruningStructure_Pod* self__pod) {
        physx::PxPruningStructure* self_ = reinterpret_cast<physx::PxPruningStructure*>(self__pod);
        self_->release();
    }

    uint32_t physx_PxPruningStructure_getRigidActors(physx_PxPruningStructure_Pod const* self__pod, physx_PxRigidActor_Pod** userBuffer_pod, uint32_t bufferSize, uint32_t startIndex) {
    ...
    uint32_t physx_PxPruningStructure_getNbRigidActors(physx_PxPruningStructure_Pod const* self__pod) {
        physx::PxPruningStructure const* self_ = reinterpret_cast<physx::PxPruningStructure const*>(self__pod);
        uint32_t return_val = self_->getNbRigidActors();
        return return_val;
    }

    void const* physx_PxPruningStructure_getStaticMergeData(physx_PxPruningStructure_Pod const* self__pod) {
        physx::PxPruningStructure const* self_ = reinterpret_cast<physx::PxPruningStructure const*>(self__pod);
        void const* return_val = self_->getStaticMergeData();
        return return_val;
    }

    void const* physx_PxPruningStructure_getDynamicMergeData(physx_PxPruningStructure_Pod const* self__pod) {
        physx::PxPruningStructure const* self_ = reinterpret_cast<physx::PxPruningStructure const*>(self__pod);
        void const* return_val = self_->getDynamicMergeData();
        return return_val;
    }

    char const* physx_PxPruningStructure_getConcreteTypeName(physx_PxPruningStructure_Pod const* self__pod) {
        physx::PxPruningStructure const* self_ = reinterpret_cast<physx::PxPruningStructure const*>(self__pod);
        char const* return_val = self_->getConcreteTypeName();
        return return_val;
    }

    physx_PxExtendedVec3_Pod physx_PxExtendedVec3_new() {
    ...
    physx_PxExtendedVec3_Pod physx_PxExtendedVec3_new_1(double _x, double _y, double _z) {
    ...
    bool physx_PxExtendedVec3_isZero(physx_PxExtendedVec3_Pod const* self__pod) {
        physx::PxExtendedVec3 const* self_ = reinterpret_cast<physx::PxExtendedVec3 const*>(self__pod);
        bool return_val = self_->isZero();
        return return_val;
    }

    double physx_PxExtendedVec3_dot(physx_PxExtendedVec3_Pod const* self__pod, physx_PxVec3_Pod const* v_pod) {
        physx::PxExtendedVec3 const* self_ = reinterpret_cast<physx::PxExtendedVec3 const*>(self__pod);
        physx::PxVec3 const& v = reinterpret_cast<physx::PxVec3 const&>(*v_pod);
    ...
    double physx_PxExtendedVec3_distanceSquared(physx_PxExtendedVec3_Pod const* self__pod, physx_PxExtendedVec3_Pod const* v_pod) {
        physx::PxExtendedVec3 const* self_ = reinterpret_cast<physx::PxExtendedVec3 const*>(self__pod);
    ...
    double physx_PxExtendedVec3_magnitudeSquared(physx_PxExtendedVec3_Pod const* self__pod) {
        physx::PxExtendedVec3 const* self_ = reinterpret_cast<physx::PxExtendedVec3 const*>(self__pod);
        double return_val = self_->magnitudeSquared();
        return return_val;
    }

    double physx_PxExtendedVec3_magnitude(physx_PxExtendedVec3_Pod const* self__pod) {
        physx::PxExtendedVec3 const* self_ = reinterpret_cast<physx::PxExtendedVec3 const*>(self__pod);
        double return_val = self_->magnitude();
        return return_val;
    }

    double physx_PxExtendedVec3_normalize_mut(physx_PxExtendedVec3_Pod* self__pod) {
        physx::PxExtendedVec3* self_ = reinterpret_cast<physx::PxExtendedVec3*>(self__pod);
        double return_val = self_->normalize();
        return return_val;
    }

    bool physx_PxExtendedVec3_isFinite(physx_PxExtendedVec3_Pod const* self__pod) {
        physx::PxExtendedVec3 const* self_ = reinterpret_cast<physx::PxExtendedVec3 const*>(self__pod);
        bool return_val = self_->isFinite();
        return return_val;
    }

    void physx_PxExtendedVec3_maximum_mut(physx_PxExtendedVec3_Pod* self__pod, physx_PxExtendedVec3_Pod const* v_pod) {
        physx::PxExtendedVec3* self_ = reinterpret_cast<physx::PxExtendedVec3*>(self__pod);
        physx::PxExtendedVec3 const& v = reinterpret_cast<physx::PxExtendedVec3 const&>(*v_pod);
        self_->maximum(v);
    }

    void physx_PxExtendedVec3_minimum_mut(physx_PxExtendedVec3_Pod* self__pod, physx_PxExtendedVec3_Pod const* v_pod) {
        physx::PxExtendedVec3* self_ = reinterpret_cast<physx::PxExtendedVec3*>(self__pod);
        physx::PxExtendedVec3 const& v = reinterpret_cast<physx::PxExtendedVec3 const&>(*v_pod);
        self_->minimum(v);
    }

    void physx_PxExtendedVec3_set_mut(physx_PxExtendedVec3_Pod* self__pod, double x_, double y_, double z_) {
        physx::PxExtendedVec3* self_ = reinterpret_cast<physx::PxExtendedVec3*>(self__pod);
        self_->set(x_, y_, z_);
    }

    void physx_PxExtendedVec3_setPlusInfinity_mut(physx_PxExtendedVec3_Pod* self__pod) {
        physx::PxExtendedVec3* self_ = reinterpret_cast<physx::PxExtendedVec3*>(self__pod);
        self_->setPlusInfinity();
    }

    void physx_PxExtendedVec3_setMinusInfinity_mut(physx_PxExtendedVec3_Pod* self__pod) {
        physx::PxExtendedVec3* self_ = reinterpret_cast<physx::PxExtendedVec3*>(self__pod);
        self_->setMinusInfinity();
    }

    void physx_PxExtendedVec3_cross_mut(physx_PxExtendedVec3_Pod* self__pod, physx_PxExtendedVec3_Pod const* left_pod, physx_PxVec3_Pod const* right_pod) {
        physx::PxExtendedVec3* self_ = reinterpret_cast<physx::PxExtendedVec3*>(self__pod);
    ...
    void physx_PxExtendedVec3_cross_mut_1(physx_PxExtendedVec3_Pod* self__pod, physx_PxExtendedVec3_Pod const* left_pod, physx_PxExtendedVec3_Pod const* right_pod) {
        physx::PxExtendedVec3* self_ = reinterpret_cast<physx::PxExtendedVec3*>(self__pod);
        physx::PxExtendedVec3 const& left = reinterpret_cast<physx::PxExtendedVec3 const&>(*left_pod);
    ...
    physx_PxExtendedVec3_Pod physx_PxExtendedVec3_cross(physx_PxExtendedVec3_Pod const* self__pod, physx_PxExtendedVec3_Pod const* v_pod) {
        physx::PxExtendedVec3 const* self_ = reinterpret_cast<physx::PxExtendedVec3 const*>(self__pod);
        physx::PxExtendedVec3 const& v = reinterpret_cast<physx::PxExtendedVec3 const&>(*v_pod);
    ...
    void physx_PxExtendedVec3_cross_mut_2(physx_PxExtendedVec3_Pod* self__pod, physx_PxVec3_Pod const* left_pod, physx_PxExtendedVec3_Pod const* right_pod) {
        physx::PxExtendedVec3* self_ = reinterpret_cast<physx::PxExtendedVec3*>(self__pod);
    ...
    physx_PxVec3_Pod physx_phys_toVec3(physx_PxExtendedVec3_Pod const* v_pod) {
        physx::PxExtendedVec3 const& v = reinterpret_cast<physx::PxExtendedVec3 const&>(*v_pod);
    ...
    int32_t physx_PxObstacle_getType(physx_PxObstacle_Pod const* self__pod) {
    ...
    physx_PxBoxObstacle_Pod physx_PxBoxObstacle_new() {
    ...
    physx_PxCapsuleObstacle_Pod physx_PxCapsuleObstacle_new() {
    ...
    void physx_PxObstacleContext_release_mut(physx_PxObstacleContext_Pod* self__pod) {
        physx::PxObstacleContext* self_ = reinterpret_cast<physx::PxObstacleContext*>(self__pod);
        self_->release();
    }

    physx_PxControllerManager_Pod* physx_PxObstacleContext_getControllerManager(physx_PxObstacleContext_Pod const* self__pod) {
    ...
    uint32_t physx_PxObstacleContext_addObstacle_mut(physx_PxObstacleContext_Pod* self__pod, physx_PxObstacle_Pod const* obstacle_pod) {
        physx::PxObstacleContext* self_ = reinterpret_cast<physx::PxObstacleContext*>(self__pod);
    ...
    bool physx_PxObstacleContext_removeObstacle_mut(physx_PxObstacleContext_Pod* self__pod, uint32_t handle) {
        physx::PxObstacleContext* self_ = reinterpret_cast<physx::PxObstacleContext*>(self__pod);
        bool return_val = self_->removeObstacle(handle);
        return return_val;
    }

    bool physx_PxObstacleContext_updateObstacle_mut(physx_PxObstacleContext_Pod* self__pod, uint32_t handle, physx_PxObstacle_Pod const* obstacle_pod) {
        physx::PxObstacleContext* self_ = reinterpret_cast<physx::PxObstacleContext*>(self__pod);
        physx::PxObstacle const& obstacle = reinterpret_cast<physx::PxObstacle const&>(*obstacle_pod);
    ...
    uint32_t physx_PxObstacleContext_getNbObstacles(physx_PxObstacleContext_Pod const* self__pod) {
        physx::PxObstacleContext const* self_ = reinterpret_cast<physx::PxObstacleContext const*>(self__pod);
        uint32_t return_val = self_->getNbObstacles();
        return return_val;
    }

    physx_PxObstacle_Pod const* physx_PxObstacleContext_getObstacle(physx_PxObstacleContext_Pod const* self__pod, uint32_t i) {
        physx::PxObstacleContext const* self_ = reinterpret_cast<physx::PxObstacleContext const*>(self__pod);
    ...
    physx_PxObstacle_Pod const* physx_PxObstacleContext_getObstacleByHandle(physx_PxObstacleContext_Pod const* self__pod, uint32_t handle) {
        physx::PxObstacleContext const* self_ = reinterpret_cast<physx::PxObstacleContext const*>(self__pod);
    ...
    void physx_PxUserControllerHitReport_onShapeHit_mut(physx_PxUserControllerHitReport_Pod* self__pod, physx_PxControllerShapeHit_Pod const* hit_pod) {
    ...
    void physx_PxUserControllerHitReport_onControllerHit_mut(physx_PxUserControllerHitReport_Pod* self__pod, physx_PxControllersHit_Pod const* hit_pod) {
        physx::PxUserControllerHitReport* self_ = reinterpret_cast<physx::PxUserControllerHitReport*>(self__pod);
        physx::PxControllersHit const& hit = reinterpret_cast<physx::PxControllersHit const&>(*hit_pod);
        self_->onControllerHit(hit);
    }

    void physx_PxUserControllerHitReport_onObstacleHit_mut(physx_PxUserControllerHitReport_Pod* self__pod, physx_PxControllerObstacleHit_Pod const* hit_pod) {
        physx::PxUserControllerHitReport* self_ = reinterpret_cast<physx::PxUserControllerHitReport*>(self__pod);
    ...
    void physx_PxControllerFilterCallback_delete(physx_PxControllerFilterCallback_Pod* self__pod) {
        physx::PxControllerFilterCallback* self_ = reinterpret_cast<physx::PxControllerFilterCallback*>(self__pod);
        delete self_;
    }

    bool physx_PxControllerFilterCallback_filter_mut(physx_PxControllerFilterCallback_Pod* self__pod, physx_PxController_Pod const* a_pod, physx_PxController_Pod const* b_pod) {
        physx::PxControllerFilterCallback* self_ = reinterpret_cast<physx::PxControllerFilterCallback*>(self__pod);
    ...
    physx_PxControllerFilters_Pod physx_PxControllerFilters_new(physx_PxFilterData_Pod const* filterData_pod, physx_PxQueryFilterCallback_Pod* cb_pod, physx_PxControllerFilterCallback_Pod* cctFilterCb_pod) {
        physx::PxFilterData const* filterData = reinterpret_cast<physx::PxFilterData const*>(filterData_pod);
    ...
    bool physx_PxControllerDesc_isValid(physx_PxControllerDesc_Pod const* self__pod) {
        physx::PxControllerDesc const* self_ = reinterpret_cast<physx::PxControllerDesc const*>(self__pod);
        bool return_val = self_->isValid();
        return return_val;
    }

    int32_t physx_PxControllerDesc_getType(physx_PxControllerDesc_Pod const* self__pod) {
        physx::PxControllerDesc const* self_ = reinterpret_cast<physx::PxControllerDesc const*>(self__pod);
    ...
    int32_t physx_PxController_getType(physx_PxController_Pod const* self__pod) {
    ...
    void physx_PxController_release_mut(physx_PxController_Pod* self__pod) {
        physx::PxController* self_ = reinterpret_cast<physx::PxController*>(self__pod);
        self_->release();
    }

    uint8_t physx_PxController_move_mut(physx_PxController_Pod* self__pod, physx_PxVec3_Pod const* disp_pod, float minDist, float elapsedTime, physx_PxControllerFilters_Pod const* filters_pod, physx_PxObstacleContext_Pod const* obstacles_pod) {
        physx::PxController* self_ = reinterpret_cast<physx::PxController*>(self__pod);
    ...
    bool physx_PxController_setPosition_mut(physx_PxController_Pod* self__pod, physx_PxExtendedVec3_Pod const* position_pod) {
        physx::PxController* self_ = reinterpret_cast<physx::PxController*>(self__pod);
    ...
    physx_PxExtendedVec3_Pod const* physx_PxController_getPosition(physx_PxController_Pod const* self__pod) {
        physx::PxController const* self_ = reinterpret_cast<physx::PxController const*>(self__pod);
    ...
    bool physx_PxController_setFootPosition_mut(physx_PxController_Pod* self__pod, physx_PxExtendedVec3_Pod const* position_pod) {
        physx::PxController* self_ = reinterpret_cast<physx::PxController*>(self__pod);
        physx::PxExtendedVec3 const& position = reinterpret_cast<physx::PxExtendedVec3 const&>(*position_pod);
    ...
    physx_PxExtendedVec3_Pod physx_PxController_getFootPosition(physx_PxController_Pod const* self__pod) {
        physx::PxController const* self_ = reinterpret_cast<physx::PxController const*>(self__pod);
    ...
    physx_PxRigidDynamic_Pod* physx_PxController_getActor(physx_PxController_Pod const* self__pod) {
        physx::PxController const* self_ = reinterpret_cast<physx::PxController const*>(self__pod);
    ...
    void physx_PxController_setStepOffset_mut(physx_PxController_Pod* self__pod, float offset) {
        physx::PxController* self_ = reinterpret_cast<physx::PxController*>(self__pod);
        self_->setStepOffset(offset);
    }

    float physx_PxController_getStepOffset(physx_PxController_Pod const* self__pod) {
        physx::PxController const* self_ = reinterpret_cast<physx::PxController const*>(self__pod);
        float return_val = self_->getStepOffset();
        return return_val;
    }

    void physx_PxController_setNonWalkableMode_mut(physx_PxController_Pod* self__pod, int32_t flag_pod) {
        physx::PxController* self_ = reinterpret_cast<physx::PxController*>(self__pod);
        auto flag = static_cast<physx::PxControllerNonWalkableMode::Enum>(flag_pod);
        self_->setNonWalkableMode(flag);
    }

    int32_t physx_PxController_getNonWalkableMode(physx_PxController_Pod const* self__pod) {
        physx::PxController const* self_ = reinterpret_cast<physx::PxController const*>(self__pod);
    ...
    float physx_PxController_getContactOffset(physx_PxController_Pod const* self__pod) {
        physx::PxController const* self_ = reinterpret_cast<physx::PxController const*>(self__pod);
        float return_val = self_->getContactOffset();
        return return_val;
    }

    void physx_PxController_setContactOffset_mut(physx_PxController_Pod* self__pod, float offset) {
        physx::PxController* self_ = reinterpret_cast<physx::PxController*>(self__pod);
        self_->setContactOffset(offset);
    }

    physx_PxVec3_Pod physx_PxController_getUpDirection(physx_PxController_Pod const* self__pod) {
        physx::PxController const* self_ = reinterpret_cast<physx::PxController const*>(self__pod);
    ...
    void physx_PxController_setUpDirection_mut(physx_PxController_Pod* self__pod, physx_PxVec3_Pod const* up_pod) {
        physx::PxController* self_ = reinterpret_cast<physx::PxController*>(self__pod);
        physx::PxVec3 const& up = reinterpret_cast<physx::PxVec3 const&>(*up_pod);
        self_->setUpDirection(up);
    }

    float physx_PxController_getSlopeLimit(physx_PxController_Pod const* self__pod) {
        physx::PxController const* self_ = reinterpret_cast<physx::PxController const*>(self__pod);
        float return_val = self_->getSlopeLimit();
        return return_val;
    }

    void physx_PxController_setSlopeLimit_mut(physx_PxController_Pod* self__pod, float slopeLimit) {
        physx::PxController* self_ = reinterpret_cast<physx::PxController*>(self__pod);
        self_->setSlopeLimit(slopeLimit);
    }

    void physx_PxController_invalidateCache_mut(physx_PxController_Pod* self__pod) {
        physx::PxController* self_ = reinterpret_cast<physx::PxController*>(self__pod);
        self_->invalidateCache();
    }

    physx_PxScene_Pod* physx_PxController_getScene_mut(physx_PxController_Pod* self__pod) {
        physx::PxController* self_ = reinterpret_cast<physx::PxController*>(self__pod);
        physx::PxScene* return_val = self_->getScene();
        auto return_val_pod = reinterpret_cast<physx_PxScene_Pod*>(return_val);
        return return_val_pod;
    ...
    void* physx_PxController_getUserData(physx_PxController_Pod const* self__pod) {
        physx::PxController const* self_ = reinterpret_cast<physx::PxController const*>(self__pod);
        void* return_val = self_->getUserData();
        return return_val;
    }

    void physx_PxController_setUserData_mut(physx_PxController_Pod* self__pod, void* userData) {
        physx::PxController* self_ = reinterpret_cast<physx::PxController*>(self__pod);
        self_->setUserData(userData);
    }

    void physx_PxController_getState(physx_PxController_Pod const* self__pod, physx_PxControllerState_Pod* state_pod) {
        physx::PxController const* self_ = reinterpret_cast<physx::PxController const*>(self__pod);
        physx::PxControllerState& state = reinterpret_cast<physx::PxControllerState&>(*state_pod);
        self_->getState(state);
    }

    void physx_PxController_getStats(physx_PxController_Pod const* self__pod, physx_PxControllerStats_Pod* stats_pod) {
        physx::PxController const* self_ = reinterpret_cast<physx::PxController const*>(self__pod);
        physx::PxControllerStats& stats = reinterpret_cast<physx::PxControllerStats&>(*stats_pod);
        self_->getStats(stats);
    }

    void physx_PxController_resize_mut(physx_PxController_Pod* self__pod, float height) {
        physx::PxController* self_ = reinterpret_cast<physx::PxController*>(self__pod);
        self_->resize(height);
    }

    physx_PxBoxControllerDesc_Pod* physx_PxBoxControllerDesc_new_alloc() {
    ...
    void physx_PxBoxControllerDesc_delete(physx_PxBoxControllerDesc_Pod* self__pod) {
        physx::PxBoxControllerDesc* self_ = reinterpret_cast<physx::PxBoxControllerDesc*>(self__pod);
        delete self_;
    }

    void physx_PxBoxControllerDesc_setToDefault_mut(physx_PxBoxControllerDesc_Pod* self__pod) {
        physx::PxBoxControllerDesc* self_ = reinterpret_cast<physx::PxBoxControllerDesc*>(self__pod);
        self_->setToDefault();
    }

    bool physx_PxBoxControllerDesc_isValid(physx_PxBoxControllerDesc_Pod const* self__pod) {
        physx::PxBoxControllerDesc const* self_ = reinterpret_cast<physx::PxBoxControllerDesc const*>(self__pod);
        bool return_val = self_->isValid();
        return return_val;
    }

    float physx_PxBoxController_getHalfHeight(physx_PxBoxController_Pod const* self__pod) {
    ...
    float physx_PxBoxController_getHalfSideExtent(physx_PxBoxController_Pod const* self__pod) {
        physx::PxBoxController const* self_ = reinterpret_cast<physx::PxBoxController const*>(self__pod);
        float return_val = self_->getHalfSideExtent();
        return return_val;
    }

    float physx_PxBoxController_getHalfForwardExtent(physx_PxBoxController_Pod const* self__pod) {
        physx::PxBoxController const* self_ = reinterpret_cast<physx::PxBoxController const*>(self__pod);
        float return_val = self_->getHalfForwardExtent();
        return return_val;
    }

    bool physx_PxBoxController_setHalfHeight_mut(physx_PxBoxController_Pod* self__pod, float halfHeight) {
    ...
    bool physx_PxBoxController_setHalfSideExtent_mut(physx_PxBoxController_Pod* self__pod, float halfSideExtent) {
        physx::PxBoxController* self_ = reinterpret_cast<physx::PxBoxController*>(self__pod);
        bool return_val = self_->setHalfSideExtent(halfSideExtent);
        return return_val;
    }

    bool physx_PxBoxController_setHalfForwardExtent_mut(physx_PxBoxController_Pod* self__pod, float halfForwardExtent) {
        physx::PxBoxController* self_ = reinterpret_cast<physx::PxBoxController*>(self__pod);
        bool return_val = self_->setHalfForwardExtent(halfForwardExtent);
        return return_val;
    }

    physx_PxCapsuleControllerDesc_Pod* physx_PxCapsuleControllerDesc_new_alloc() {
    ...
    void physx_PxCapsuleControllerDesc_delete(physx_PxCapsuleControllerDesc_Pod* self__pod) {
        physx::PxCapsuleControllerDesc* self_ = reinterpret_cast<physx::PxCapsuleControllerDesc*>(self__pod);
        delete self_;
    }

    void physx_PxCapsuleControllerDesc_setToDefault_mut(physx_PxCapsuleControllerDesc_Pod* self__pod) {
        physx::PxCapsuleControllerDesc* self_ = reinterpret_cast<physx::PxCapsuleControllerDesc*>(self__pod);
        self_->setToDefault();
    }

    bool physx_PxCapsuleControllerDesc_isValid(physx_PxCapsuleControllerDesc_Pod const* self__pod) {
        physx::PxCapsuleControllerDesc const* self_ = reinterpret_cast<physx::PxCapsuleControllerDesc const*>(self__pod);
        bool return_val = self_->isValid();
        return return_val;
    }

    float physx_PxCapsuleController_getRadius(physx_PxCapsuleController_Pod const* self__pod) {
    ...
    bool physx_PxCapsuleController_setRadius_mut(physx_PxCapsuleController_Pod* self__pod, float radius) {
    ...
    float physx_PxCapsuleController_getHeight(physx_PxCapsuleController_Pod const* self__pod) {
        physx::PxCapsuleController const* self_ = reinterpret_cast<physx::PxCapsuleController const*>(self__pod);
        float return_val = self_->getHeight();
        return return_val;
    }

    bool physx_PxCapsuleController_setHeight_mut(physx_PxCapsuleController_Pod* self__pod, float height) {
        physx::PxCapsuleController* self_ = reinterpret_cast<physx::PxCapsuleController*>(self__pod);
        bool return_val = self_->setHeight(height);
        return return_val;
    }

    int32_t physx_PxCapsuleController_getClimbingMode(physx_PxCapsuleController_Pod const* self__pod) {
        physx::PxCapsuleController const* self_ = reinterpret_cast<physx::PxCapsuleController const*>(self__pod);
    ...
    bool physx_PxCapsuleController_setClimbingMode_mut(physx_PxCapsuleController_Pod* self__pod, int32_t mode_pod) {
        physx::PxCapsuleController* self_ = reinterpret_cast<physx::PxCapsuleController*>(self__pod);
    ...
    uint8_t physx_PxControllerBehaviorCallback_getBehaviorFlags_mut(physx_PxControllerBehaviorCallback_Pod* self__pod, physx_PxShape_Pod const* shape_pod, physx_PxActor_Pod const* actor_pod) {
    ...
    uint8_t physx_PxControllerBehaviorCallback_getBehaviorFlags_mut_1(physx_PxControllerBehaviorCallback_Pod* self__pod, physx_PxController_Pod const* controller_pod) {
        physx::PxControllerBehaviorCallback* self_ = reinterpret_cast<physx::PxControllerBehaviorCallback*>(self__pod);
    ...
    uint8_t physx_PxControllerBehaviorCallback_getBehaviorFlags_mut_2(physx_PxControllerBehaviorCallback_Pod* self__pod, physx_PxObstacle_Pod const* obstacle_pod) {
        physx::PxControllerBehaviorCallback* self_ = reinterpret_cast<physx::PxControllerBehaviorCallback*>(self__pod);
        physx::PxObstacle const& obstacle = reinterpret_cast<physx::PxObstacle const&>(*obstacle_pod);
    ...
    void physx_PxControllerManager_release_mut(physx_PxControllerManager_Pod* self__pod) {
        physx::PxControllerManager* self_ = reinterpret_cast<physx::PxControllerManager*>(self__pod);
        self_->release();
    }

    physx_PxScene_Pod* physx_PxControllerManager_getScene(physx_PxControllerManager_Pod const* self__pod) {
    ...
    uint32_t physx_PxControllerManager_getNbControllers(physx_PxControllerManager_Pod const* self__pod) {
        physx::PxControllerManager const* self_ = reinterpret_cast<physx::PxControllerManager const*>(self__pod);
        uint32_t return_val = self_->getNbControllers();
        return return_val;
    }

    physx_PxController_Pod* physx_PxControllerManager_getController_mut(physx_PxControllerManager_Pod* self__pod, uint32_t index) {
        physx::PxControllerManager* self_ = reinterpret_cast<physx::PxControllerManager*>(self__pod);
    ...
    physx_PxController_Pod* physx_PxControllerManager_createController_mut(physx_PxControllerManager_Pod* self__pod, physx_PxControllerDesc_Pod const* desc_pod) {
        physx::PxControllerManager* self_ = reinterpret_cast<physx::PxControllerManager*>(self__pod);
    ...
    void physx_PxControllerManager_purgeControllers_mut(physx_PxControllerManager_Pod* self__pod) {
        physx::PxControllerManager* self_ = reinterpret_cast<physx::PxControllerManager*>(self__pod);
        self_->purgeControllers();
    }

    physx_PxRenderBuffer_Pod* physx_PxControllerManager_getRenderBuffer_mut(physx_PxControllerManager_Pod* self__pod) {
        physx::PxControllerManager* self_ = reinterpret_cast<physx::PxControllerManager*>(self__pod);
    ...
    void physx_PxControllerManager_setDebugRenderingFlags_mut(physx_PxControllerManager_Pod* self__pod, uint32_t flags_pod) {
        physx::PxControllerManager* self_ = reinterpret_cast<physx::PxControllerManager*>(self__pod);
        auto flags = physx::PxControllerDebugRenderFlags(flags_pod);
        self_->setDebugRenderingFlags(flags);
    }

    uint32_t physx_PxControllerManager_getNbObstacleContexts(physx_PxControllerManager_Pod const* self__pod) {
        physx::PxControllerManager const* self_ = reinterpret_cast<physx::PxControllerManager const*>(self__pod);
        uint32_t return_val = self_->getNbObstacleContexts();
        return return_val;
    }

    physx_PxObstacleContext_Pod* physx_PxControllerManager_getObstacleContext_mut(physx_PxControllerManager_Pod* self__pod, uint32_t index) {
        physx::PxControllerManager* self_ = reinterpret_cast<physx::PxControllerManager*>(self__pod);
    ...
    physx_PxObstacleContext_Pod* physx_PxControllerManager_createObstacleContext_mut(physx_PxControllerManager_Pod* self__pod) {
        physx::PxControllerManager* self_ = reinterpret_cast<physx::PxControllerManager*>(self__pod);
    ...
    void physx_PxControllerManager_computeInteractions_mut(physx_PxControllerManager_Pod* self__pod, float elapsedTime, physx_PxControllerFilterCallback_Pod* cctFilterCb_pod) {
        physx::PxControllerManager* self_ = reinterpret_cast<physx::PxControllerManager*>(self__pod);
        physx::PxControllerFilterCallback* cctFilterCb = reinterpret_cast<physx::PxControllerFilterCallback*>(cctFilterCb_pod);
        self_->computeInteractions(elapsedTime, cctFilterCb);
    }

    void physx_PxControllerManager_setTessellation_mut(physx_PxControllerManager_Pod* self__pod, bool flag, float maxEdgeLength) {
        physx::PxControllerManager* self_ = reinterpret_cast<physx::PxControllerManager*>(self__pod);
        self_->setTessellation(flag, maxEdgeLength);
    }

    void physx_PxControllerManager_setOverlapRecoveryModule_mut(physx_PxControllerManager_Pod* self__pod, bool flag) {
        physx::PxControllerManager* self_ = reinterpret_cast<physx::PxControllerManager*>(self__pod);
        self_->setOverlapRecoveryModule(flag);
    }

    void physx_PxControllerManager_setPreciseSweeps_mut(physx_PxControllerManager_Pod* self__pod, bool flag) {
        physx::PxControllerManager* self_ = reinterpret_cast<physx::PxControllerManager*>(self__pod);
        self_->setPreciseSweeps(flag);
    }

    void physx_PxControllerManager_setPreventVerticalSlidingAgainstCeiling_mut(physx_PxControllerManager_Pod* self__pod, bool flag) {
        physx::PxControllerManager* self_ = reinterpret_cast<physx::PxControllerManager*>(self__pod);
        self_->setPreventVerticalSlidingAgainstCeiling(flag);
    }

    void physx_PxControllerManager_shiftOrigin_mut(physx_PxControllerManager_Pod* self__pod, physx_PxVec3_Pod const* shift_pod) {
        physx::PxControllerManager* self_ = reinterpret_cast<physx::PxControllerManager*>(self__pod);
        physx::PxVec3 const& shift = reinterpret_cast<physx::PxVec3 const&>(*shift_pod);
        self_->shiftOrigin(shift);
    }

    physx_PxControllerManager_Pod* physx_phys_PxCreateControllerManager(physx_PxScene_Pod* scene_pod, bool lockingEnabled) {
        physx::PxScene& scene = reinterpret_cast<physx::PxScene&>(*scene_pod);
    ...
    physx_PxDim3_Pod physx_PxDim3_new() {
        PxDim3 return_val;
    ...
    physx_PxSDFDesc_Pod physx_PxSDFDesc_new() {
    ...
    bool physx_PxSDFDesc_isValid(physx_PxSDFDesc_Pod const* self__pod) {
        physx::PxSDFDesc const* self_ = reinterpret_cast<physx::PxSDFDesc const*>(self__pod);
        bool return_val = self_->isValid();
        return return_val;
    }

    physx_PxConvexMeshDesc_Pod physx_PxConvexMeshDesc_new() {
    ...
    void physx_PxConvexMeshDesc_setToDefault_mut(physx_PxConvexMeshDesc_Pod* self__pod) {
        physx::PxConvexMeshDesc* self_ = reinterpret_cast<physx::PxConvexMeshDesc*>(self__pod);
        self_->setToDefault();
    }

    bool physx_PxConvexMeshDesc_isValid(physx_PxConvexMeshDesc_Pod const* self__pod) {
        physx::PxConvexMeshDesc const* self_ = reinterpret_cast<physx::PxConvexMeshDesc const*>(self__pod);
        bool return_val = self_->isValid();
        return return_val;
    }

    physx_PxTriangleMeshDesc_Pod physx_PxTriangleMeshDesc_new() {
    ...
    void physx_PxTriangleMeshDesc_setToDefault_mut(physx_PxTriangleMeshDesc_Pod* self__pod) {
        physx::PxTriangleMeshDesc* self_ = reinterpret_cast<physx::PxTriangleMeshDesc*>(self__pod);
        self_->setToDefault();
    }

    bool physx_PxTriangleMeshDesc_isValid(physx_PxTriangleMeshDesc_Pod const* self__pod) {
        physx::PxTriangleMeshDesc const* self_ = reinterpret_cast<physx::PxTriangleMeshDesc const*>(self__pod);
        bool return_val = self_->isValid();
        return return_val;
    }

    physx_PxTetrahedronMeshDesc_Pod physx_PxTetrahedronMeshDesc_new() {
    ...
    bool physx_PxTetrahedronMeshDesc_isValid(physx_PxTetrahedronMeshDesc_Pod const* self__pod) {
        physx::PxTetrahedronMeshDesc const* self_ = reinterpret_cast<physx::PxTetrahedronMeshDesc const*>(self__pod);
        bool return_val = self_->isValid();
        return return_val;
    }

    physx_PxSoftBodySimulationDataDesc_Pod physx_PxSoftBodySimulationDataDesc_new() {
    ...
    bool physx_PxSoftBodySimulationDataDesc_isValid(physx_PxSoftBodySimulationDataDesc_Pod const* self__pod) {
        physx::PxSoftBodySimulationDataDesc const* self_ = reinterpret_cast<physx::PxSoftBodySimulationDataDesc const*>(self__pod);
        bool return_val = self_->isValid();
        return return_val;
    }

    void physx_PxBVH34MidphaseDesc_setToDefault_mut(physx_PxBVH34MidphaseDesc_Pod* self__pod) {
        physx::PxBVH34MidphaseDesc* self_ = reinterpret_cast<physx::PxBVH34MidphaseDesc*>(self__pod);
        self_->setToDefault();
    }

    bool physx_PxBVH34MidphaseDesc_isValid(physx_PxBVH34MidphaseDesc_Pod const* self__pod) {
        physx::PxBVH34MidphaseDesc const* self_ = reinterpret_cast<physx::PxBVH34MidphaseDesc const*>(self__pod);
        bool return_val = self_->isValid();
        return return_val;
    }

    physx_PxMidphaseDesc_Pod physx_PxMidphaseDesc_new() {
    ...
    int32_t physx_PxMidphaseDesc_getType(physx_PxMidphaseDesc_Pod const* self__pod) {
    ...
    void physx_PxMidphaseDesc_setToDefault_mut(physx_PxMidphaseDesc_Pod* self__pod, int32_t type_pod) {
    ...
    bool physx_PxMidphaseDesc_isValid(physx_PxMidphaseDesc_Pod const* self__pod) {
        physx::PxMidphaseDesc const* self_ = reinterpret_cast<physx::PxMidphaseDesc const*>(self__pod);
        bool return_val = self_->isValid();
        return return_val;
    }

    physx_PxBVHDesc_Pod physx_PxBVHDesc_new() {
    ...
    void physx_PxBVHDesc_setToDefault_mut(physx_PxBVHDesc_Pod* self__pod) {
        physx::PxBVHDesc* self_ = reinterpret_cast<physx::PxBVHDesc*>(self__pod);
        self_->setToDefault();
    }

    bool physx_PxBVHDesc_isValid(physx_PxBVHDesc_Pod const* self__pod) {
        physx::PxBVHDesc const* self_ = reinterpret_cast<physx::PxBVHDesc const*>(self__pod);
        bool return_val = self_->isValid();
        return return_val;
    }

    physx_PxCookingParams_Pod physx_PxCookingParams_new(physx_PxTolerancesScale_Pod const* sc_pod) {
    ...
    physx_PxInsertionCallback_Pod* physx_phys_PxGetStandaloneInsertionCallback() {
        physx::PxInsertionCallback* return_val = PxGetStandaloneInsertionCallback();
        auto return_val_pod = reinterpret_cast<physx_PxInsertionCallback_Pod*>(return_val);
        return return_val_pod;
    }

    bool physx_phys_PxCookBVH(physx_PxBVHDesc_Pod const* desc_pod, physx_PxOutputStream_Pod* stream_pod) {
    ...
    physx_PxBVH_Pod* physx_phys_PxCreateBVH(physx_PxBVHDesc_Pod const* desc_pod, physx_PxInsertionCallback_Pod* insertionCallback_pod) {
        physx::PxBVHDesc const& desc = reinterpret_cast<physx::PxBVHDesc const&>(*desc_pod);
    ...
    bool physx_phys_PxCookHeightField(physx_PxHeightFieldDesc_Pod const* desc_pod, physx_PxOutputStream_Pod* stream_pod) {
    ...
    physx_PxHeightField_Pod* physx_phys_PxCreateHeightField(physx_PxHeightFieldDesc_Pod const* desc_pod, physx_PxInsertionCallback_Pod* insertionCallback_pod) {
        physx::PxHeightFieldDesc const& desc = reinterpret_cast<physx::PxHeightFieldDesc const&>(*desc_pod);
        physx::PxInsertionCallback& insertionCallback = reinterpret_cast<physx::PxInsertionCallback&>(*insertionCallback_pod);
    ...
    bool physx_phys_PxCookConvexMesh(physx_PxCookingParams_Pod const* params_pod, physx_PxConvexMeshDesc_Pod const* desc_pod, physx_PxOutputStream_Pod* stream_pod, int32_t* condition_pod) {
    ...
    physx_PxConvexMesh_Pod* physx_phys_PxCreateConvexMesh(physx_PxCookingParams_Pod const* params_pod, physx_PxConvexMeshDesc_Pod const* desc_pod, physx_PxInsertionCallback_Pod* insertionCallback_pod, int32_t* condition_pod) {
        physx::PxCookingParams const& params = reinterpret_cast<physx::PxCookingParams const&>(*params_pod);
        physx::PxConvexMeshDesc const& desc = reinterpret_cast<physx::PxConvexMeshDesc const&>(*desc_pod);
        physx::PxInsertionCallback& insertionCallback = reinterpret_cast<physx::PxInsertionCallback&>(*insertionCallback_pod);
        physx::PxConvexMeshCookingResult::Enum* condition = reinterpret_cast<physx::PxConvexMeshCookingResult::Enum*>(condition_pod);
    ...
    bool physx_phys_PxValidateConvexMesh(physx_PxCookingParams_Pod const* params_pod, physx_PxConvexMeshDesc_Pod const* desc_pod) {
        physx::PxCookingParams const& params = reinterpret_cast<physx::PxCookingParams const&>(*params_pod);
        physx::PxConvexMeshDesc const& desc = reinterpret_cast<physx::PxConvexMeshDesc const&>(*desc_pod);
    ...
    bool physx_phys_PxValidateTriangleMesh(physx_PxCookingParams_Pod const* params_pod, physx_PxTriangleMeshDesc_Pod const* desc_pod) {
        physx::PxCookingParams const& params = reinterpret_cast<physx::PxCookingParams const&>(*params_pod);
    ...
    physx_PxTriangleMesh_Pod* physx_phys_PxCreateTriangleMesh(physx_PxCookingParams_Pod const* params_pod, physx_PxTriangleMeshDesc_Pod const* desc_pod, physx_PxInsertionCallback_Pod* insertionCallback_pod, int32_t* condition_pod) {
        physx::PxCookingParams const& params = reinterpret_cast<physx::PxCookingParams const&>(*params_pod);
        physx::PxTriangleMeshDesc const& desc = reinterpret_cast<physx::PxTriangleMeshDesc const&>(*desc_pod);
        physx::PxInsertionCallback& insertionCallback = reinterpret_cast<physx::PxInsertionCallback&>(*insertionCallback_pod);
    ...
    bool physx_phys_PxCookTriangleMesh(physx_PxCookingParams_Pod const* params_pod, physx_PxTriangleMeshDesc_Pod const* desc_pod, physx_PxOutputStream_Pod* stream_pod, int32_t* condition_pod) {
        physx::PxCookingParams const& params = reinterpret_cast<physx::PxCookingParams const&>(*params_pod);
        physx::PxTriangleMeshDesc const& desc = reinterpret_cast<physx::PxTriangleMeshDesc const&>(*desc_pod);
        physx::PxOutputStream& stream = reinterpret_cast<physx::PxOutputStream&>(*stream_pod);
        physx::PxTriangleMeshCookingResult::Enum* condition = reinterpret_cast<physx::PxTriangleMeshCookingResult::Enum*>(condition_pod);
    ...
    physx_PxDefaultMemoryOutputStream_Pod* physx_PxDefaultMemoryOutputStream_new_alloc(physx_PxAllocatorCallback_Pod* allocator_pod) {
        physx::PxAllocatorCallback& allocator = reinterpret_cast<physx::PxAllocatorCallback&>(*allocator_pod);
    ...
    void physx_PxDefaultMemoryOutputStream_delete(physx_PxDefaultMemoryOutputStream_Pod* self__pod) {
        physx::PxDefaultMemoryOutputStream* self_ = reinterpret_cast<physx::PxDefaultMemoryOutputStream*>(self__pod);
        delete self_;
    }

    uint32_t physx_PxDefaultMemoryOutputStream_write_mut(physx_PxDefaultMemoryOutputStream_Pod* self__pod, void const* src, uint32_t count) {
        physx::PxDefaultMemoryOutputStream* self_ = reinterpret_cast<physx::PxDefaultMemoryOutputStream*>(self__pod);
        uint32_t return_val = self_->write(src, count);
        return return_val;
    }

    uint32_t physx_PxDefaultMemoryOutputStream_getSize(physx_PxDefaultMemoryOutputStream_Pod const* self__pod) {
    ...
    uint8_t* physx_PxDefaultMemoryOutputStream_getData(physx_PxDefaultMemoryOutputStream_Pod const* self__pod) {
        physx::PxDefaultMemoryOutputStream const* self_ = reinterpret_cast<physx::PxDefaultMemoryOutputStream const*>(self__pod);
        uint8_t* return_val = self_->getData();
        return return_val;
    }

    physx_PxDefaultMemoryInputData_Pod* physx_PxDefaultMemoryInputData_new_alloc(uint8_t* data, uint32_t length) {
    ...
    uint32_t physx_PxDefaultMemoryInputData_read_mut(physx_PxDefaultMemoryInputData_Pod* self__pod, void* dest, uint32_t count) {
        physx::PxDefaultMemoryInputData* self_ = reinterpret_cast<physx::PxDefaultMemoryInputData*>(self__pod);
        uint32_t return_val = self_->read(dest, count);
        return return_val;
    }

    uint32_t physx_PxDefaultMemoryInputData_getLength(physx_PxDefaultMemoryInputData_Pod const* self__pod) {
        physx::PxDefaultMemoryInputData const* self_ = reinterpret_cast<physx::PxDefaultMemoryInputData const*>(self__pod);
        uint32_t return_val = self_->getLength();
        return return_val;
    }

    void physx_PxDefaultMemoryInputData_seek_mut(physx_PxDefaultMemoryInputData_Pod* self__pod, uint32_t pos) {
        physx::PxDefaultMemoryInputData* self_ = reinterpret_cast<physx::PxDefaultMemoryInputData*>(self__pod);
        self_->seek(pos);
    }

    uint32_t physx_PxDefaultMemoryInputData_tell(physx_PxDefaultMemoryInputData_Pod const* self__pod) {
        physx::PxDefaultMemoryInputData const* self_ = reinterpret_cast<physx::PxDefaultMemoryInputData const*>(self__pod);
        uint32_t return_val = self_->tell();
        return return_val;
    }

    physx_PxDefaultFileOutputStream_Pod* physx_PxDefaultFileOutputStream_new_alloc(char const* name) {
    ...
    void physx_PxDefaultFileOutputStream_delete(physx_PxDefaultFileOutputStream_Pod* self__pod) {
        physx::PxDefaultFileOutputStream* self_ = reinterpret_cast<physx::PxDefaultFileOutputStream*>(self__pod);
        delete self_;
    }

    uint32_t physx_PxDefaultFileOutputStream_write_mut(physx_PxDefaultFileOutputStream_Pod* self__pod, void const* src, uint32_t count) {
        physx::PxDefaultFileOutputStream* self_ = reinterpret_cast<physx::PxDefaultFileOutputStream*>(self__pod);
        uint32_t return_val = self_->write(src, count);
        return return_val;
    }

    bool physx_PxDefaultFileOutputStream_isValid_mut(physx_PxDefaultFileOutputStream_Pod* self__pod) {
        physx::PxDefaultFileOutputStream* self_ = reinterpret_cast<physx::PxDefaultFileOutputStream*>(self__pod);
        bool return_val = self_->isValid();
        return return_val;
    }

    physx_PxDefaultFileInputData_Pod* physx_PxDefaultFileInputData_new_alloc(char const* name) {
    ...
    void physx_PxDefaultFileInputData_delete(physx_PxDefaultFileInputData_Pod* self__pod) {
        physx::PxDefaultFileInputData* self_ = reinterpret_cast<physx::PxDefaultFileInputData*>(self__pod);
        delete self_;
    }

    uint32_t physx_PxDefaultFileInputData_read_mut(physx_PxDefaultFileInputData_Pod* self__pod, void* dest, uint32_t count) {
        physx::PxDefaultFileInputData* self_ = reinterpret_cast<physx::PxDefaultFileInputData*>(self__pod);
        uint32_t return_val = self_->read(dest, count);
        return return_val;
    }

    void physx_PxDefaultFileInputData_seek_mut(physx_PxDefaultFileInputData_Pod* self__pod, uint32_t pos) {
        physx::PxDefaultFileInputData* self_ = reinterpret_cast<physx::PxDefaultFileInputData*>(self__pod);
        self_->seek(pos);
    }

    uint32_t physx_PxDefaultFileInputData_tell(physx_PxDefaultFileInputData_Pod const* self__pod) {
        physx::PxDefaultFileInputData const* self_ = reinterpret_cast<physx::PxDefaultFileInputData const*>(self__pod);
        uint32_t return_val = self_->tell();
        return return_val;
    }

    uint32_t physx_PxDefaultFileInputData_getLength(physx_PxDefaultFileInputData_Pod const* self__pod) {
        physx::PxDefaultFileInputData const* self_ = reinterpret_cast<physx::PxDefaultFileInputData const*>(self__pod);
        uint32_t return_val = self_->getLength();
        return return_val;
    }

    bool physx_PxDefaultFileInputData_isValid(physx_PxDefaultFileInputData_Pod const* self__pod) {
        physx::PxDefaultFileInputData const* self_ = reinterpret_cast<physx::PxDefaultFileInputData const*>(self__pod);
        bool return_val = self_->isValid();
        return return_val;
    }

    void* physx_phys_platformAlignedAlloc(size_t size_pod) {
        size_t size;
        memcpy(&size, &size_pod, sizeof(size));
    ...
    void* physx_PxDefaultAllocator_allocate_mut(physx_PxDefaultAllocator_Pod* self__pod, size_t size_pod, char const* anon_param1, char const* anon_param2, int32_t anon_param3) {
    ...
    void physx_PxDefaultAllocator_deallocate_mut(physx_PxDefaultAllocator_Pod* self__pod, void* ptr) {
        physx::PxDefaultAllocator* self_ = reinterpret_cast<physx::PxDefaultAllocator*>(self__pod);
        self_->deallocate(ptr);
    }

    void physx_PxDefaultAllocator_delete(physx_PxDefaultAllocator_Pod* self__pod) {
        physx::PxDefaultAllocator* self_ = reinterpret_cast<physx::PxDefaultAllocator*>(self__pod);
        delete self_;
    }

    void physx_PxJoint_setActors_mut(physx_PxJoint_Pod* self__pod, physx_PxRigidActor_Pod* actor0_pod, physx_PxRigidActor_Pod* actor1_pod) {
    ...
    void physx_PxJoint_getActors(physx_PxJoint_Pod const* self__pod, physx_PxRigidActor_Pod** actor0_pod, physx_PxRigidActor_Pod** actor1_pod) {
    ...
    void physx_PxJoint_setLocalPose_mut(physx_PxJoint_Pod* self__pod, int32_t actor_pod, physx_PxTransform_Pod const* localPose_pod) {
        physx::PxJoint* self_ = reinterpret_cast<physx::PxJoint*>(self__pod);
    ...
    physx_PxTransform_Pod physx_PxJoint_getLocalPose(physx_PxJoint_Pod const* self__pod, int32_t actor_pod) {
        physx::PxJoint const* self_ = reinterpret_cast<physx::PxJoint const*>(self__pod);
        auto actor = static_cast<physx::PxJointActorIndex::Enum>(actor_pod);
    ...
    physx_PxTransform_Pod physx_PxJoint_getRelativeTransform(physx_PxJoint_Pod const* self__pod) {
        physx::PxJoint const* self_ = reinterpret_cast<physx::PxJoint const*>(self__pod);
    ...
    physx_PxVec3_Pod physx_PxJoint_getRelativeLinearVelocity(physx_PxJoint_Pod const* self__pod) {
        physx::PxJoint const* self_ = reinterpret_cast<physx::PxJoint const*>(self__pod);
    ...
    physx_PxVec3_Pod physx_PxJoint_getRelativeAngularVelocity(physx_PxJoint_Pod const* self__pod) {
        physx::PxJoint const* self_ = reinterpret_cast<physx::PxJoint const*>(self__pod);
    ...
    void physx_PxJoint_setBreakForce_mut(physx_PxJoint_Pod* self__pod, float force, float torque) {
        physx::PxJoint* self_ = reinterpret_cast<physx::PxJoint*>(self__pod);
        self_->setBreakForce(force, torque);
    }

    void physx_PxJoint_getBreakForce(physx_PxJoint_Pod const* self__pod, float* force_pod, float* torque_pod) {
        physx::PxJoint const* self_ = reinterpret_cast<physx::PxJoint const*>(self__pod);
    ...
    void physx_PxJoint_setConstraintFlags_mut(physx_PxJoint_Pod* self__pod, uint16_t flags_pod) {
        physx::PxJoint* self_ = reinterpret_cast<physx::PxJoint*>(self__pod);
        auto flags = physx::PxConstraintFlags(flags_pod);
        self_->setConstraintFlags(flags);
    }

    void physx_PxJoint_setConstraintFlag_mut(physx_PxJoint_Pod* self__pod, int32_t flag_pod, bool value) {
        physx::PxJoint* self_ = reinterpret_cast<physx::PxJoint*>(self__pod);
        auto flag = static_cast<physx::PxConstraintFlag::Enum>(flag_pod);
        self_->setConstraintFlag(flag, value);
    }

    uint16_t physx_PxJoint_getConstraintFlags(physx_PxJoint_Pod const* self__pod) {
        physx::PxJoint const* self_ = reinterpret_cast<physx::PxJoint const*>(self__pod);
    ...
    void physx_PxJoint_setInvMassScale0_mut(physx_PxJoint_Pod* self__pod, float invMassScale) {
        physx::PxJoint* self_ = reinterpret_cast<physx::PxJoint*>(self__pod);
        self_->setInvMassScale0(invMassScale);
    }

    float physx_PxJoint_getInvMassScale0(physx_PxJoint_Pod const* self__pod) {
        physx::PxJoint const* self_ = reinterpret_cast<physx::PxJoint const*>(self__pod);
        float return_val = self_->getInvMassScale0();
        return return_val;
    }

    void physx_PxJoint_setInvInertiaScale0_mut(physx_PxJoint_Pod* self__pod, float invInertiaScale) {
        physx::PxJoint* self_ = reinterpret_cast<physx::PxJoint*>(self__pod);
        self_->setInvInertiaScale0(invInertiaScale);
    }

    float physx_PxJoint_getInvInertiaScale0(physx_PxJoint_Pod const* self__pod) {
        physx::PxJoint const* self_ = reinterpret_cast<physx::PxJoint const*>(self__pod);
        float return_val = self_->getInvInertiaScale0();
        return return_val;
    }

    void physx_PxJoint_setInvMassScale1_mut(physx_PxJoint_Pod* self__pod, float invMassScale) {
        physx::PxJoint* self_ = reinterpret_cast<physx::PxJoint*>(self__pod);
        self_->setInvMassScale1(invMassScale);
    }

    float physx_PxJoint_getInvMassScale1(physx_PxJoint_Pod const* self__pod) {
        physx::PxJoint const* self_ = reinterpret_cast<physx::PxJoint const*>(self__pod);
        float return_val = self_->getInvMassScale1();
        return return_val;
    }

    void physx_PxJoint_setInvInertiaScale1_mut(physx_PxJoint_Pod* self__pod, float invInertiaScale) {
        physx::PxJoint* self_ = reinterpret_cast<physx::PxJoint*>(self__pod);
        self_->setInvInertiaScale1(invInertiaScale);
    }

    float physx_PxJoint_getInvInertiaScale1(physx_PxJoint_Pod const* self__pod) {
        physx::PxJoint const* self_ = reinterpret_cast<physx::PxJoint const*>(self__pod);
        float return_val = self_->getInvInertiaScale1();
        return return_val;
    }

    physx_PxConstraint_Pod* physx_PxJoint_getConstraint(physx_PxJoint_Pod const* self__pod) {
        physx::PxJoint const* self_ = reinterpret_cast<physx::PxJoint const*>(self__pod);
    ...
    void physx_PxJoint_setName_mut(physx_PxJoint_Pod* self__pod, char const* name) {
        physx::PxJoint* self_ = reinterpret_cast<physx::PxJoint*>(self__pod);
        self_->setName(name);
    }

    char const* physx_PxJoint_getName(physx_PxJoint_Pod const* self__pod) {
        physx::PxJoint const* self_ = reinterpret_cast<physx::PxJoint const*>(self__pod);
        char const* return_val = self_->getName();
        return return_val;
    }

    void physx_PxJoint_release_mut(physx_PxJoint_Pod* self__pod) {
        physx::PxJoint* self_ = reinterpret_cast<physx::PxJoint*>(self__pod);
        self_->release();
    }

    physx_PxScene_Pod* physx_PxJoint_getScene(physx_PxJoint_Pod const* self__pod) {
        physx::PxJoint const* self_ = reinterpret_cast<physx::PxJoint const*>(self__pod);
        physx::PxScene* return_val = self_->getScene();
        auto return_val_pod = reinterpret_cast<physx_PxScene_Pod*>(return_val);
        return return_val_pod;
    ...
    void physx_PxJoint_getBinaryMetaData(physx_PxOutputStream_Pod* stream_pod) {
        physx::PxOutputStream& stream = reinterpret_cast<physx::PxOutputStream&>(*stream_pod);
        PxJoint::getBinaryMetaData(stream);
    }

    physx_PxSpring_Pod physx_PxSpring_new(float stiffness_, float damping_) {
    ...
    void physx_phys_PxSetJointGlobalFrame(physx_PxJoint_Pod* joint_pod, physx_PxVec3_Pod const* wsAnchor_pod, physx_PxVec3_Pod const* wsAxis_pod) {
    ...
    physx_PxDistanceJoint_Pod* physx_phys_PxDistanceJointCreate(physx_PxPhysics_Pod* physics_pod, physx_PxRigidActor_Pod* actor0_pod, physx_PxTransform_Pod const* localFrame0_pod, physx_PxRigidActor_Pod* actor1_pod, physx_PxTransform_Pod const* localFrame1_pod) {
    ...
    float physx_PxDistanceJoint_getDistance(physx_PxDistanceJoint_Pod const* self__pod) {
    ...
    void physx_PxDistanceJoint_setMinDistance_mut(physx_PxDistanceJoint_Pod* self__pod, float distance) {
        physx::PxDistanceJoint* self_ = reinterpret_cast<physx::PxDistanceJoint*>(self__pod);
        self_->setMinDistance(distance);
    }

    float physx_PxDistanceJoint_getMinDistance(physx_PxDistanceJoint_Pod const* self__pod) {
        physx::PxDistanceJoint const* self_ = reinterpret_cast<physx::PxDistanceJoint const*>(self__pod);
        float return_val = self_->getMinDistance();
        return return_val;
    }

    void physx_PxDistanceJoint_setMaxDistance_mut(physx_PxDistanceJoint_Pod* self__pod, float distance) {
        physx::PxDistanceJoint* self_ = reinterpret_cast<physx::PxDistanceJoint*>(self__pod);
        self_->setMaxDistance(distance);
    }

    float physx_PxDistanceJoint_getMaxDistance(physx_PxDistanceJoint_Pod const* self__pod) {
        physx::PxDistanceJoint const* self_ = reinterpret_cast<physx::PxDistanceJoint const*>(self__pod);
        float return_val = self_->getMaxDistance();
        return return_val;
    }

    void physx_PxDistanceJoint_setTolerance_mut(physx_PxDistanceJoint_Pod* self__pod, float tolerance) {
        physx::PxDistanceJoint* self_ = reinterpret_cast<physx::PxDistanceJoint*>(self__pod);
        self_->setTolerance(tolerance);
    }

    float physx_PxDistanceJoint_getTolerance(physx_PxDistanceJoint_Pod const* self__pod) {
        physx::PxDistanceJoint const* self_ = reinterpret_cast<physx::PxDistanceJoint const*>(self__pod);
        float return_val = self_->getTolerance();
        return return_val;
    }

    void physx_PxDistanceJoint_setStiffness_mut(physx_PxDistanceJoint_Pod* self__pod, float stiffness) {
        physx::PxDistanceJoint* self_ = reinterpret_cast<physx::PxDistanceJoint*>(self__pod);
        self_->setStiffness(stiffness);
    }

    float physx_PxDistanceJoint_getStiffness(physx_PxDistanceJoint_Pod const* self__pod) {
        physx::PxDistanceJoint const* self_ = reinterpret_cast<physx::PxDistanceJoint const*>(self__pod);
        float return_val = self_->getStiffness();
        return return_val;
    }

    void physx_PxDistanceJoint_setDamping_mut(physx_PxDistanceJoint_Pod* self__pod, float damping) {
        physx::PxDistanceJoint* self_ = reinterpret_cast<physx::PxDistanceJoint*>(self__pod);
        self_->setDamping(damping);
    }

    float physx_PxDistanceJoint_getDamping(physx_PxDistanceJoint_Pod const* self__pod) {
        physx::PxDistanceJoint const* self_ = reinterpret_cast<physx::PxDistanceJoint const*>(self__pod);
        float return_val = self_->getDamping();
        return return_val;
    }

    void physx_PxDistanceJoint_setContactDistance_mut(physx_PxDistanceJoint_Pod* self__pod, float contactDistance) {
        physx::PxDistanceJoint* self_ = reinterpret_cast<physx::PxDistanceJoint*>(self__pod);
        self_->setContactDistance(contactDistance);
    }

    float physx_PxDistanceJoint_getContactDistance(physx_PxDistanceJoint_Pod const* self__pod) {
        physx::PxDistanceJoint const* self_ = reinterpret_cast<physx::PxDistanceJoint const*>(self__pod);
        float return_val = self_->getContactDistance();
        return return_val;
    }

    void physx_PxDistanceJoint_setDistanceJointFlags_mut(physx_PxDistanceJoint_Pod* self__pod, uint16_t flags_pod) {
        physx::PxDistanceJoint* self_ = reinterpret_cast<physx::PxDistanceJoint*>(self__pod);
        auto flags = physx::PxDistanceJointFlags(flags_pod);
        self_->setDistanceJointFlags(flags);
    }

    void physx_PxDistanceJoint_setDistanceJointFlag_mut(physx_PxDistanceJoint_Pod* self__pod, int32_t flag_pod, bool value) {
        physx::PxDistanceJoint* self_ = reinterpret_cast<physx::PxDistanceJoint*>(self__pod);
        auto flag = static_cast<physx::PxDistanceJointFlag::Enum>(flag_pod);
        self_->setDistanceJointFlag(flag, value);
    }

    uint16_t physx_PxDistanceJoint_getDistanceJointFlags(physx_PxDistanceJoint_Pod const* self__pod) {
        physx::PxDistanceJoint const* self_ = reinterpret_cast<physx::PxDistanceJoint const*>(self__pod);
    ...
    char const* physx_PxDistanceJoint_getConcreteTypeName(physx_PxDistanceJoint_Pod const* self__pod) {
        physx::PxDistanceJoint const* self_ = reinterpret_cast<physx::PxDistanceJoint const*>(self__pod);
        char const* return_val = self_->getConcreteTypeName();
        return return_val;
    }

    physx_PxContactJoint_Pod* physx_phys_PxContactJointCreate(physx_PxPhysics_Pod* physics_pod, physx_PxRigidActor_Pod* actor0_pod, physx_PxTransform_Pod const* localFrame0_pod, physx_PxRigidActor_Pod* actor1_pod, physx_PxTransform_Pod const* localFrame1_pod) {
        physx::PxPhysics& physics = reinterpret_cast<physx::PxPhysics&>(*physics_pod);
        physx::PxRigidActor* actor0 = reinterpret_cast<physx::PxRigidActor*>(actor0_pod);
        physx::PxTransform const& localFrame0 = reinterpret_cast<physx::PxTransform const&>(*localFrame0_pod);
        physx::PxRigidActor* actor1 = reinterpret_cast<physx::PxRigidActor*>(actor1_pod);
    ...
    physx_PxJacobianRow_Pod physx_PxJacobianRow_new() {
    ...
    physx_PxJacobianRow_Pod physx_PxJacobianRow_new_1(physx_PxVec3_Pod const* lin0_pod, physx_PxVec3_Pod const* lin1_pod, physx_PxVec3_Pod const* ang0_pod, physx_PxVec3_Pod const* ang1_pod) {
    ...
    void physx_PxContactJoint_setContact_mut(physx_PxContactJoint_Pod* self__pod, physx_PxVec3_Pod const* contact_pod) {
    ...
    void physx_PxContactJoint_setContactNormal_mut(physx_PxContactJoint_Pod* self__pod, physx_PxVec3_Pod const* contactNormal_pod) {
        physx::PxContactJoint* self_ = reinterpret_cast<physx::PxContactJoint*>(self__pod);
    ...
    void physx_PxContactJoint_setPenetration_mut(physx_PxContactJoint_Pod* self__pod, float penetration) {
        physx::PxContactJoint* self_ = reinterpret_cast<physx::PxContactJoint*>(self__pod);
        self_->setPenetration(penetration);
    }

    physx_PxVec3_Pod physx_PxContactJoint_getContact(physx_PxContactJoint_Pod const* self__pod) {
    ...
    physx_PxVec3_Pod physx_PxContactJoint_getContactNormal(physx_PxContactJoint_Pod const* self__pod) {
        physx::PxContactJoint const* self_ = reinterpret_cast<physx::PxContactJoint const*>(self__pod);
    ...
    float physx_PxContactJoint_getPenetration(physx_PxContactJoint_Pod const* self__pod) {
        physx::PxContactJoint const* self_ = reinterpret_cast<physx::PxContactJoint const*>(self__pod);
        float return_val = self_->getPenetration();
        return return_val;
    }

    float physx_PxContactJoint_getRestitution(physx_PxContactJoint_Pod const* self__pod) {
        physx::PxContactJoint const* self_ = reinterpret_cast<physx::PxContactJoint const*>(self__pod);
        float return_val = self_->getRestitution();
        return return_val;
    }

    void physx_PxContactJoint_setRestitution_mut(physx_PxContactJoint_Pod* self__pod, float restitution) {
        physx::PxContactJoint* self_ = reinterpret_cast<physx::PxContactJoint*>(self__pod);
        self_->setRestitution(restitution);
    }

    float physx_PxContactJoint_getBounceThreshold(physx_PxContactJoint_Pod const* self__pod) {
        physx::PxContactJoint const* self_ = reinterpret_cast<physx::PxContactJoint const*>(self__pod);
        float return_val = self_->getBounceThreshold();
        return return_val;
    }

    void physx_PxContactJoint_setBounceThreshold_mut(physx_PxContactJoint_Pod* self__pod, float bounceThreshold) {
        physx::PxContactJoint* self_ = reinterpret_cast<physx::PxContactJoint*>(self__pod);
        self_->setBounceThreshold(bounceThreshold);
    }

    char const* physx_PxContactJoint_getConcreteTypeName(physx_PxContactJoint_Pod const* self__pod) {
        physx::PxContactJoint const* self_ = reinterpret_cast<physx::PxContactJoint const*>(self__pod);
        char const* return_val = self_->getConcreteTypeName();
        return return_val;
    }

    void physx_PxContactJoint_computeJacobians(physx_PxContactJoint_Pod const* self__pod, physx_PxJacobianRow_Pod* jacobian_pod) {
        physx::PxContactJoint const* self_ = reinterpret_cast<physx::PxContactJoint const*>(self__pod);
        physx::PxJacobianRow* jacobian = reinterpret_cast<physx::PxJacobianRow*>(jacobian_pod);
        self_->computeJacobians(jacobian);
    }

    uint32_t physx_PxContactJoint_getNbJacobianRows(physx_PxContactJoint_Pod const* self__pod) {
        physx::PxContactJoint const* self_ = reinterpret_cast<physx::PxContactJoint const*>(self__pod);
        uint32_t return_val = self_->getNbJacobianRows();
        return return_val;
    }

    physx_PxFixedJoint_Pod* physx_phys_PxFixedJointCreate(physx_PxPhysics_Pod* physics_pod, physx_PxRigidActor_Pod* actor0_pod, physx_PxTransform_Pod const* localFrame0_pod, physx_PxRigidActor_Pod* actor1_pod, physx_PxTransform_Pod const* localFrame1_pod) {
        physx::PxPhysics& physics = reinterpret_cast<physx::PxPhysics&>(*physics_pod);
        physx::PxRigidActor* actor0 = reinterpret_cast<physx::PxRigidActor*>(actor0_pod);
        physx::PxTransform const& localFrame0 = reinterpret_cast<physx::PxTransform const&>(*localFrame0_pod);
        physx::PxRigidActor* actor1 = reinterpret_cast<physx::PxRigidActor*>(actor1_pod);
    ...
    char const* physx_PxFixedJoint_getConcreteTypeName(physx_PxFixedJoint_Pod const* self__pod) {
        physx::PxFixedJoint const* self_ = reinterpret_cast<physx::PxFixedJoint const*>(self__pod);
        char const* return_val = self_->getConcreteTypeName();
        return return_val;
    }

    physx_PxJointLimitParameters_Pod* physx_PxJointLimitParameters_new_alloc() {
    ...
    bool physx_PxJointLimitParameters_isValid(physx_PxJointLimitParameters_Pod const* self__pod) {
        physx::PxJointLimitParameters const* self_ = reinterpret_cast<physx::PxJointLimitParameters const*>(self__pod);
        bool return_val = self_->isValid();
        return return_val;
    }

    bool physx_PxJointLimitParameters_isSoft(physx_PxJointLimitParameters_Pod const* self__pod) {
        physx::PxJointLimitParameters const* self_ = reinterpret_cast<physx::PxJointLimitParameters const*>(self__pod);
        bool return_val = self_->isSoft();
        return return_val;
    }

    physx_PxJointLinearLimit_Pod physx_PxJointLinearLimit_new(physx_PxTolerancesScale_Pod const* scale_pod, float extent, float contactDist_deprecated) {
        physx::PxTolerancesScale const& scale = reinterpret_cast<physx::PxTolerancesScale const&>(*scale_pod);
    ...
    physx_PxJointLinearLimit_Pod physx_PxJointLinearLimit_new_1(float extent, physx_PxSpring_Pod const* spring_pod) {
    ...
    bool physx_PxJointLinearLimit_isValid(physx_PxJointLinearLimit_Pod const* self__pod) {
        physx::PxJointLinearLimit const* self_ = reinterpret_cast<physx::PxJointLinearLimit const*>(self__pod);
        bool return_val = self_->isValid();
        return return_val;
    }

    void physx_PxJointLinearLimit_delete(physx_PxJointLinearLimit_Pod* self__pod) {
        physx::PxJointLinearLimit* self_ = reinterpret_cast<physx::PxJointLinearLimit*>(self__pod);
        delete self_;
    }

    physx_PxJointLinearLimitPair_Pod physx_PxJointLinearLimitPair_new(physx_PxTolerancesScale_Pod const* scale_pod, float lowerLimit, float upperLimit, float contactDist_deprecated) {
        physx::PxTolerancesScale const& scale = reinterpret_cast<physx::PxTolerancesScale const&>(*scale_pod);
    ...
    physx_PxJointLinearLimitPair_Pod physx_PxJointLinearLimitPair_new_1(float lowerLimit, float upperLimit, physx_PxSpring_Pod const* spring_pod) {
        physx::PxSpring const& spring = reinterpret_cast<physx::PxSpring const&>(*spring_pod);
    ...
    bool physx_PxJointLinearLimitPair_isValid(physx_PxJointLinearLimitPair_Pod const* self__pod) {
        physx::PxJointLinearLimitPair const* self_ = reinterpret_cast<physx::PxJointLinearLimitPair const*>(self__pod);
        bool return_val = self_->isValid();
        return return_val;
    }

    void physx_PxJointLinearLimitPair_delete(physx_PxJointLinearLimitPair_Pod* self__pod) {
        physx::PxJointLinearLimitPair* self_ = reinterpret_cast<physx::PxJointLinearLimitPair*>(self__pod);
        delete self_;
    }

    physx_PxJointAngularLimitPair_Pod physx_PxJointAngularLimitPair_new(float lowerLimit, float upperLimit, float contactDist_deprecated) {
    ...
    physx_PxJointAngularLimitPair_Pod physx_PxJointAngularLimitPair_new_1(float lowerLimit, float upperLimit, physx_PxSpring_Pod const* spring_pod) {
        physx::PxSpring const& spring = reinterpret_cast<physx::PxSpring const&>(*spring_pod);
    ...
    bool physx_PxJointAngularLimitPair_isValid(physx_PxJointAngularLimitPair_Pod const* self__pod) {
        physx::PxJointAngularLimitPair const* self_ = reinterpret_cast<physx::PxJointAngularLimitPair const*>(self__pod);
        bool return_val = self_->isValid();
        return return_val;
    }

    void physx_PxJointAngularLimitPair_delete(physx_PxJointAngularLimitPair_Pod* self__pod) {
        physx::PxJointAngularLimitPair* self_ = reinterpret_cast<physx::PxJointAngularLimitPair*>(self__pod);
        delete self_;
    }

    physx_PxJointLimitCone_Pod physx_PxJointLimitCone_new(float yLimitAngle, float zLimitAngle, float contactDist_deprecated) {
    ...
    physx_PxJointLimitCone_Pod physx_PxJointLimitCone_new_1(float yLimitAngle, float zLimitAngle, physx_PxSpring_Pod const* spring_pod) {
        physx::PxSpring const& spring = reinterpret_cast<physx::PxSpring const&>(*spring_pod);
    ...
    bool physx_PxJointLimitCone_isValid(physx_PxJointLimitCone_Pod const* self__pod) {
        physx::PxJointLimitCone const* self_ = reinterpret_cast<physx::PxJointLimitCone const*>(self__pod);
        bool return_val = self_->isValid();
        return return_val;
    }

    void physx_PxJointLimitCone_delete(physx_PxJointLimitCone_Pod* self__pod) {
        physx::PxJointLimitCone* self_ = reinterpret_cast<physx::PxJointLimitCone*>(self__pod);
        delete self_;
    }

    physx_PxJointLimitPyramid_Pod physx_PxJointLimitPyramid_new(float yLimitAngleMin, float yLimitAngleMax, float zLimitAngleMin, float zLimitAngleMax, float contactDist_deprecated) {
    ...
    physx_PxJointLimitPyramid_Pod physx_PxJointLimitPyramid_new_1(float yLimitAngleMin, float yLimitAngleMax, float zLimitAngleMin, float zLimitAngleMax, physx_PxSpring_Pod const* spring_pod) {
        physx::PxSpring const& spring = reinterpret_cast<physx::PxSpring const&>(*spring_pod);
    ...
    bool physx_PxJointLimitPyramid_isValid(physx_PxJointLimitPyramid_Pod const* self__pod) {
        physx::PxJointLimitPyramid const* self_ = reinterpret_cast<physx::PxJointLimitPyramid const*>(self__pod);
        bool return_val = self_->isValid();
        return return_val;
    }

    void physx_PxJointLimitPyramid_delete(physx_PxJointLimitPyramid_Pod* self__pod) {
        physx::PxJointLimitPyramid* self_ = reinterpret_cast<physx::PxJointLimitPyramid*>(self__pod);
        delete self_;
    }

    physx_PxPrismaticJoint_Pod* physx_phys_PxPrismaticJointCreate(physx_PxPhysics_Pod* physics_pod, physx_PxRigidActor_Pod* actor0_pod, physx_PxTransform_Pod const* localFrame0_pod, physx_PxRigidActor_Pod* actor1_pod, physx_PxTransform_Pod const* localFrame1_pod) {
        physx::PxPhysics& physics = reinterpret_cast<physx::PxPhysics&>(*physics_pod);
        physx::PxRigidActor* actor0 = reinterpret_cast<physx::PxRigidActor*>(actor0_pod);
        physx::PxTransform const& localFrame0 = reinterpret_cast<physx::PxTransform const&>(*localFrame0_pod);
        physx::PxRigidActor* actor1 = reinterpret_cast<physx::PxRigidActor*>(actor1_pod);
    ...
    float physx_PxPrismaticJoint_getPosition(physx_PxPrismaticJoint_Pod const* self__pod) {
    ...
    float physx_PxPrismaticJoint_getVelocity(physx_PxPrismaticJoint_Pod const* self__pod) {
        physx::PxPrismaticJoint const* self_ = reinterpret_cast<physx::PxPrismaticJoint const*>(self__pod);
        float return_val = self_->getVelocity();
        return return_val;
    }

    void physx_PxPrismaticJoint_setLimit_mut(physx_PxPrismaticJoint_Pod* self__pod, physx_PxJointLinearLimitPair_Pod const* anon_param0_pod) {
    ...
    physx_PxJointLinearLimitPair_Pod physx_PxPrismaticJoint_getLimit(physx_PxPrismaticJoint_Pod const* self__pod) {
        physx::PxPrismaticJoint const* self_ = reinterpret_cast<physx::PxPrismaticJoint const*>(self__pod);
    ...
    void physx_PxPrismaticJoint_setPrismaticJointFlags_mut(physx_PxPrismaticJoint_Pod* self__pod, uint16_t flags_pod) {
        physx::PxPrismaticJoint* self_ = reinterpret_cast<physx::PxPrismaticJoint*>(self__pod);
        auto flags = physx::PxPrismaticJointFlags(flags_pod);
        self_->setPrismaticJointFlags(flags);
    }

    void physx_PxPrismaticJoint_setPrismaticJointFlag_mut(physx_PxPrismaticJoint_Pod* self__pod, int32_t flag_pod, bool value) {
        physx::PxPrismaticJoint* self_ = reinterpret_cast<physx::PxPrismaticJoint*>(self__pod);
        auto flag = static_cast<physx::PxPrismaticJointFlag::Enum>(flag_pod);
        self_->setPrismaticJointFlag(flag, value);
    }

    uint16_t physx_PxPrismaticJoint_getPrismaticJointFlags(physx_PxPrismaticJoint_Pod const* self__pod) {
        physx::PxPrismaticJoint const* self_ = reinterpret_cast<physx::PxPrismaticJoint const*>(self__pod);
    ...
    char const* physx_PxPrismaticJoint_getConcreteTypeName(physx_PxPrismaticJoint_Pod const* self__pod) {
        physx::PxPrismaticJoint const* self_ = reinterpret_cast<physx::PxPrismaticJoint const*>(self__pod);
        char const* return_val = self_->getConcreteTypeName();
        return return_val;
    }

    physx_PxRevoluteJoint_Pod* physx_phys_PxRevoluteJointCreate(physx_PxPhysics_Pod* physics_pod, physx_PxRigidActor_Pod* actor0_pod, physx_PxTransform_Pod const* localFrame0_pod, physx_PxRigidActor_Pod* actor1_pod, physx_PxTransform_Pod const* localFrame1_pod) {
        physx::PxPhysics& physics = reinterpret_cast<physx::PxPhysics&>(*physics_pod);
        physx::PxRigidActor* actor0 = reinterpret_cast<physx::PxRigidActor*>(actor0_pod);
        physx::PxTransform const& localFrame0 = reinterpret_cast<physx::PxTransform const&>(*localFrame0_pod);
        physx::PxRigidActor* actor1 = reinterpret_cast<physx::PxRigidActor*>(actor1_pod);
    ...
    float physx_PxRevoluteJoint_getAngle(physx_PxRevoluteJoint_Pod const* self__pod) {
        physx::PxRevoluteJoint const* self_ = reinterpret_cast<physx::PxRevoluteJoint const*>(self__pod);
        float return_val = self_->getAngle();
        return return_val;
    }

    float physx_PxRevoluteJoint_getVelocity(physx_PxRevoluteJoint_Pod const* self__pod) {
        physx::PxRevoluteJoint const* self_ = reinterpret_cast<physx::PxRevoluteJoint const*>(self__pod);
        float return_val = self_->getVelocity();
        return return_val;
    }

    void physx_PxRevoluteJoint_setLimit_mut(physx_PxRevoluteJoint_Pod* self__pod, physx_PxJointAngularLimitPair_Pod const* limits_pod) {
    ...
    physx_PxJointAngularLimitPair_Pod physx_PxRevoluteJoint_getLimit(physx_PxRevoluteJoint_Pod const* self__pod) {
        physx::PxRevoluteJoint const* self_ = reinterpret_cast<physx::PxRevoluteJoint const*>(self__pod);
    ...
    void physx_PxRevoluteJoint_setDriveVelocity_mut(physx_PxRevoluteJoint_Pod* self__pod, float velocity, bool autowake) {
        physx::PxRevoluteJoint* self_ = reinterpret_cast<physx::PxRevoluteJoint*>(self__pod);
        self_->setDriveVelocity(velocity, autowake);
    }

    float physx_PxRevoluteJoint_getDriveVelocity(physx_PxRevoluteJoint_Pod const* self__pod) {
        physx::PxRevoluteJoint const* self_ = reinterpret_cast<physx::PxRevoluteJoint const*>(self__pod);
        float return_val = self_->getDriveVelocity();
        return return_val;
    }

    void physx_PxRevoluteJoint_setDriveForceLimit_mut(physx_PxRevoluteJoint_Pod* self__pod, float limit) {
        physx::PxRevoluteJoint* self_ = reinterpret_cast<physx::PxRevoluteJoint*>(self__pod);
        self_->setDriveForceLimit(limit);
    }

    float physx_PxRevoluteJoint_getDriveForceLimit(physx_PxRevoluteJoint_Pod const* self__pod) {
        physx::PxRevoluteJoint const* self_ = reinterpret_cast<physx::PxRevoluteJoint const*>(self__pod);
        float return_val = self_->getDriveForceLimit();
        return return_val;
    }

    void physx_PxRevoluteJoint_setDriveGearRatio_mut(physx_PxRevoluteJoint_Pod* self__pod, float ratio) {
        physx::PxRevoluteJoint* self_ = reinterpret_cast<physx::PxRevoluteJoint*>(self__pod);
        self_->setDriveGearRatio(ratio);
    }

    float physx_PxRevoluteJoint_getDriveGearRatio(physx_PxRevoluteJoint_Pod const* self__pod) {
        physx::PxRevoluteJoint const* self_ = reinterpret_cast<physx::PxRevoluteJoint const*>(self__pod);
        float return_val = self_->getDriveGearRatio();
        return return_val;
    }

    void physx_PxRevoluteJoint_setRevoluteJointFlags_mut(physx_PxRevoluteJoint_Pod* self__pod, uint16_t flags_pod) {
        physx::PxRevoluteJoint* self_ = reinterpret_cast<physx::PxRevoluteJoint*>(self__pod);
        auto flags = physx::PxRevoluteJointFlags(flags_pod);
        self_->setRevoluteJointFlags(flags);
    }

    void physx_PxRevoluteJoint_setRevoluteJointFlag_mut(physx_PxRevoluteJoint_Pod* self__pod, int32_t flag_pod, bool value) {
        physx::PxRevoluteJoint* self_ = reinterpret_cast<physx::PxRevoluteJoint*>(self__pod);
        auto flag = static_cast<physx::PxRevoluteJointFlag::Enum>(flag_pod);
        self_->setRevoluteJointFlag(flag, value);
    }

    uint16_t physx_PxRevoluteJoint_getRevoluteJointFlags(physx_PxRevoluteJoint_Pod const* self__pod) {
        physx::PxRevoluteJoint const* self_ = reinterpret_cast<physx::PxRevoluteJoint const*>(self__pod);
    ...
    char const* physx_PxRevoluteJoint_getConcreteTypeName(physx_PxRevoluteJoint_Pod const* self__pod) {
        physx::PxRevoluteJoint const* self_ = reinterpret_cast<physx::PxRevoluteJoint const*>(self__pod);
        char const* return_val = self_->getConcreteTypeName();
        return return_val;
    }

    physx_PxSphericalJoint_Pod* physx_phys_PxSphericalJointCreate(physx_PxPhysics_Pod* physics_pod, physx_PxRigidActor_Pod* actor0_pod, physx_PxTransform_Pod const* localFrame0_pod, physx_PxRigidActor_Pod* actor1_pod, physx_PxTransform_Pod const* localFrame1_pod) {
        physx::PxPhysics& physics = reinterpret_cast<physx::PxPhysics&>(*physics_pod);
        physx::PxRigidActor* actor0 = reinterpret_cast<physx::PxRigidActor*>(actor0_pod);
        physx::PxTransform const& localFrame0 = reinterpret_cast<physx::PxTransform const&>(*localFrame0_pod);
        physx::PxRigidActor* actor1 = reinterpret_cast<physx::PxRigidActor*>(actor1_pod);
    ...
    physx_PxJointLimitCone_Pod physx_PxSphericalJoint_getLimitCone(physx_PxSphericalJoint_Pod const* self__pod) {
    ...
    void physx_PxSphericalJoint_setLimitCone_mut(physx_PxSphericalJoint_Pod* self__pod, physx_PxJointLimitCone_Pod const* limit_pod) {
    ...
    float physx_PxSphericalJoint_getSwingYAngle(physx_PxSphericalJoint_Pod const* self__pod) {
        physx::PxSphericalJoint const* self_ = reinterpret_cast<physx::PxSphericalJoint const*>(self__pod);
        float return_val = self_->getSwingYAngle();
        return return_val;
    }

    float physx_PxSphericalJoint_getSwingZAngle(physx_PxSphericalJoint_Pod const* self__pod) {
        physx::PxSphericalJoint const* self_ = reinterpret_cast<physx::PxSphericalJoint const*>(self__pod);
        float return_val = self_->getSwingZAngle();
        return return_val;
    }

    void physx_PxSphericalJoint_setSphericalJointFlags_mut(physx_PxSphericalJoint_Pod* self__pod, uint16_t flags_pod) {
        physx::PxSphericalJoint* self_ = reinterpret_cast<physx::PxSphericalJoint*>(self__pod);
        auto flags = physx::PxSphericalJointFlags(flags_pod);
        self_->setSphericalJointFlags(flags);
    }

    void physx_PxSphericalJoint_setSphericalJointFlag_mut(physx_PxSphericalJoint_Pod* self__pod, int32_t flag_pod, bool value) {
        physx::PxSphericalJoint* self_ = reinterpret_cast<physx::PxSphericalJoint*>(self__pod);
        auto flag = static_cast<physx::PxSphericalJointFlag::Enum>(flag_pod);
        self_->setSphericalJointFlag(flag, value);
    }

    uint16_t physx_PxSphericalJoint_getSphericalJointFlags(physx_PxSphericalJoint_Pod const* self__pod) {
        physx::PxSphericalJoint const* self_ = reinterpret_cast<physx::PxSphericalJoint const*>(self__pod);
    ...
    char const* physx_PxSphericalJoint_getConcreteTypeName(physx_PxSphericalJoint_Pod const* self__pod) {
        physx::PxSphericalJoint const* self_ = reinterpret_cast<physx::PxSphericalJoint const*>(self__pod);
        char const* return_val = self_->getConcreteTypeName();
        return return_val;
    }

    physx_PxD6Joint_Pod* physx_phys_PxD6JointCreate(physx_PxPhysics_Pod* physics_pod, physx_PxRigidActor_Pod* actor0_pod, physx_PxTransform_Pod const* localFrame0_pod, physx_PxRigidActor_Pod* actor1_pod, physx_PxTransform_Pod const* localFrame1_pod) {
        physx::PxPhysics& physics = reinterpret_cast<physx::PxPhysics&>(*physics_pod);
        physx::PxRigidActor* actor0 = reinterpret_cast<physx::PxRigidActor*>(actor0_pod);
        physx::PxTransform const& localFrame0 = reinterpret_cast<physx::PxTransform const&>(*localFrame0_pod);
        physx::PxRigidActor* actor1 = reinterpret_cast<physx::PxRigidActor*>(actor1_pod);
    ...
    physx_PxD6JointDrive_Pod physx_PxD6JointDrive_new() {
    ...
    physx_PxD6JointDrive_Pod physx_PxD6JointDrive_new_1(float driveStiffness, float driveDamping, float driveForceLimit, bool isAcceleration) {
    ...
    bool physx_PxD6JointDrive_isValid(physx_PxD6JointDrive_Pod const* self__pod) {
        physx::PxD6JointDrive const* self_ = reinterpret_cast<physx::PxD6JointDrive const*>(self__pod);
        bool return_val = self_->isValid();
        return return_val;
    }

    void physx_PxD6Joint_setMotion_mut(physx_PxD6Joint_Pod* self__pod, int32_t axis_pod, int32_t type_pod) {
    ...
    int32_t physx_PxD6Joint_getMotion(physx_PxD6Joint_Pod const* self__pod, int32_t axis_pod) {
    ...
    float physx_PxD6Joint_getTwistAngle(physx_PxD6Joint_Pod const* self__pod) {
        physx::PxD6Joint const* self_ = reinterpret_cast<physx::PxD6Joint const*>(self__pod);
        float return_val = self_->getTwistAngle();
        return return_val;
    }

    float physx_PxD6Joint_getSwingYAngle(physx_PxD6Joint_Pod const* self__pod) {
        physx::PxD6Joint const* self_ = reinterpret_cast<physx::PxD6Joint const*>(self__pod);
        float return_val = self_->getSwingYAngle();
        return return_val;
    }

    float physx_PxD6Joint_getSwingZAngle(physx_PxD6Joint_Pod const* self__pod) {
        physx::PxD6Joint const* self_ = reinterpret_cast<physx::PxD6Joint const*>(self__pod);
        float return_val = self_->getSwingZAngle();
        return return_val;
    }

    void physx_PxD6Joint_setDistanceLimit_mut(physx_PxD6Joint_Pod* self__pod, physx_PxJointLinearLimit_Pod const* limit_pod) {
        physx::PxD6Joint* self_ = reinterpret_cast<physx::PxD6Joint*>(self__pod);
    ...
    physx_PxJointLinearLimit_Pod physx_PxD6Joint_getDistanceLimit(physx_PxD6Joint_Pod const* self__pod) {
        physx::PxD6Joint const* self_ = reinterpret_cast<physx::PxD6Joint const*>(self__pod);
    ...
    void physx_PxD6Joint_setLinearLimit_mut(physx_PxD6Joint_Pod* self__pod, int32_t axis_pod, physx_PxJointLinearLimitPair_Pod const* limit_pod) {
        physx::PxD6Joint* self_ = reinterpret_cast<physx::PxD6Joint*>(self__pod);
        auto axis = static_cast<physx::PxD6Axis::Enum>(axis_pod);
    ...
    physx_PxJointLinearLimitPair_Pod physx_PxD6Joint_getLinearLimit(physx_PxD6Joint_Pod const* self__pod, int32_t axis_pod) {
        physx::PxD6Joint const* self_ = reinterpret_cast<physx::PxD6Joint const*>(self__pod);
        auto axis = static_cast<physx::PxD6Axis::Enum>(axis_pod);
    ...
    void physx_PxD6Joint_setTwistLimit_mut(physx_PxD6Joint_Pod* self__pod, physx_PxJointAngularLimitPair_Pod const* limit_pod) {
        physx::PxD6Joint* self_ = reinterpret_cast<physx::PxD6Joint*>(self__pod);
    ...
    physx_PxJointAngularLimitPair_Pod physx_PxD6Joint_getTwistLimit(physx_PxD6Joint_Pod const* self__pod) {
        physx::PxD6Joint const* self_ = reinterpret_cast<physx::PxD6Joint const*>(self__pod);
    ...
    void physx_PxD6Joint_setSwingLimit_mut(physx_PxD6Joint_Pod* self__pod, physx_PxJointLimitCone_Pod const* limit_pod) {
        physx::PxD6Joint* self_ = reinterpret_cast<physx::PxD6Joint*>(self__pod);
        physx::PxJointLimitCone const& limit = reinterpret_cast<physx::PxJointLimitCone const&>(*limit_pod);
        self_->setSwingLimit(limit);
    }

    physx_PxJointLimitCone_Pod physx_PxD6Joint_getSwingLimit(physx_PxD6Joint_Pod const* self__pod) {
        physx::PxD6Joint const* self_ = reinterpret_cast<physx::PxD6Joint const*>(self__pod);
    ...
    void physx_PxD6Joint_setPyramidSwingLimit_mut(physx_PxD6Joint_Pod* self__pod, physx_PxJointLimitPyramid_Pod const* limit_pod) {
        physx::PxD6Joint* self_ = reinterpret_cast<physx::PxD6Joint*>(self__pod);
    ...
    physx_PxJointLimitPyramid_Pod physx_PxD6Joint_getPyramidSwingLimit(physx_PxD6Joint_Pod const* self__pod) {
        physx::PxD6Joint const* self_ = reinterpret_cast<physx::PxD6Joint const*>(self__pod);
    ...
    void physx_PxD6Joint_setDrive_mut(physx_PxD6Joint_Pod* self__pod, int32_t index_pod, physx_PxD6JointDrive_Pod const* drive_pod) {
        physx::PxD6Joint* self_ = reinterpret_cast<physx::PxD6Joint*>(self__pod);
    ...
    physx_PxD6JointDrive_Pod physx_PxD6Joint_getDrive(physx_PxD6Joint_Pod const* self__pod, int32_t index_pod) {
        physx::PxD6Joint const* self_ = reinterpret_cast<physx::PxD6Joint const*>(self__pod);
        auto index = static_cast<physx::PxD6Drive::Enum>(index_pod);
    ...
    void physx_PxD6Joint_setDrivePosition_mut(physx_PxD6Joint_Pod* self__pod, physx_PxTransform_Pod const* pose_pod, bool autowake) {
        physx::PxD6Joint* self_ = reinterpret_cast<physx::PxD6Joint*>(self__pod);
        physx::PxTransform const& pose = reinterpret_cast<physx::PxTransform const&>(*pose_pod);
        self_->setDrivePosition(pose, autowake);
    }

    physx_PxTransform_Pod physx_PxD6Joint_getDrivePosition(physx_PxD6Joint_Pod const* self__pod) {
        physx::PxD6Joint const* self_ = reinterpret_cast<physx::PxD6Joint const*>(self__pod);
    ...
    void physx_PxD6Joint_setDriveVelocity_mut(physx_PxD6Joint_Pod* self__pod, physx_PxVec3_Pod const* linear_pod, physx_PxVec3_Pod const* angular_pod, bool autowake) {
        physx::PxD6Joint* self_ = reinterpret_cast<physx::PxD6Joint*>(self__pod);
        physx::PxVec3 const& linear = reinterpret_cast<physx::PxVec3 const&>(*linear_pod);
        physx::PxVec3 const& angular = reinterpret_cast<physx::PxVec3 const&>(*angular_pod);
    ...
    void physx_PxD6Joint_getDriveVelocity(physx_PxD6Joint_Pod const* self__pod, physx_PxVec3_Pod* linear_pod, physx_PxVec3_Pod* angular_pod) {
        physx::PxD6Joint const* self_ = reinterpret_cast<physx::PxD6Joint const*>(self__pod);
        physx::PxVec3& linear = reinterpret_cast<physx::PxVec3&>(*linear_pod);
        physx::PxVec3& angular = reinterpret_cast<physx::PxVec3&>(*angular_pod);
    ...
    void physx_PxD6Joint_setProjectionLinearTolerance_mut(physx_PxD6Joint_Pod* self__pod, float tolerance) {
        physx::PxD6Joint* self_ = reinterpret_cast<physx::PxD6Joint*>(self__pod);
        self_->setProjectionLinearTolerance(tolerance);
    }

    float physx_PxD6Joint_getProjectionLinearTolerance(physx_PxD6Joint_Pod const* self__pod) {
        physx::PxD6Joint const* self_ = reinterpret_cast<physx::PxD6Joint const*>(self__pod);
        float return_val = self_->getProjectionLinearTolerance();
        return return_val;
    }

    void physx_PxD6Joint_setProjectionAngularTolerance_mut(physx_PxD6Joint_Pod* self__pod, float tolerance) {
        physx::PxD6Joint* self_ = reinterpret_cast<physx::PxD6Joint*>(self__pod);
        self_->setProjectionAngularTolerance(tolerance);
    }

    float physx_PxD6Joint_getProjectionAngularTolerance(physx_PxD6Joint_Pod const* self__pod) {
        physx::PxD6Joint const* self_ = reinterpret_cast<physx::PxD6Joint const*>(self__pod);
        float return_val = self_->getProjectionAngularTolerance();
        return return_val;
    }

    char const* physx_PxD6Joint_getConcreteTypeName(physx_PxD6Joint_Pod const* self__pod) {
        physx::PxD6Joint const* self_ = reinterpret_cast<physx::PxD6Joint const*>(self__pod);
        char const* return_val = self_->getConcreteTypeName();
        return return_val;
    }

    physx_PxGearJoint_Pod* physx_phys_PxGearJointCreate(physx_PxPhysics_Pod* physics_pod, physx_PxRigidActor_Pod* actor0_pod, physx_PxTransform_Pod const* localFrame0_pod, physx_PxRigidActor_Pod* actor1_pod, physx_PxTransform_Pod const* localFrame1_pod) {
        physx::PxPhysics& physics = reinterpret_cast<physx::PxPhysics&>(*physics_pod);
        physx::PxRigidActor* actor0 = reinterpret_cast<physx::PxRigidActor*>(actor0_pod);
        physx::PxTransform const& localFrame0 = reinterpret_cast<physx::PxTransform const&>(*localFrame0_pod);
        physx::PxRigidActor* actor1 = reinterpret_cast<physx::PxRigidActor*>(actor1_pod);
    ...
    bool physx_PxGearJoint_setHinges_mut(physx_PxGearJoint_Pod* self__pod, physx_PxBase_Pod const* hinge0_pod, physx_PxBase_Pod const* hinge1_pod) {
    ...
    void physx_PxGearJoint_setGearRatio_mut(physx_PxGearJoint_Pod* self__pod, float ratio) {
        physx::PxGearJoint* self_ = reinterpret_cast<physx::PxGearJoint*>(self__pod);
        self_->setGearRatio(ratio);
    }

    float physx_PxGearJoint_getGearRatio(physx_PxGearJoint_Pod const* self__pod) {
        physx::PxGearJoint const* self_ = reinterpret_cast<physx::PxGearJoint const*>(self__pod);
        float return_val = self_->getGearRatio();
        return return_val;
    }

    char const* physx_PxGearJoint_getConcreteTypeName(physx_PxGearJoint_Pod const* self__pod) {
        physx::PxGearJoint const* self_ = reinterpret_cast<physx::PxGearJoint const*>(self__pod);
        char const* return_val = self_->getConcreteTypeName();
        return return_val;
    }

    physx_PxRackAndPinionJoint_Pod* physx_phys_PxRackAndPinionJointCreate(physx_PxPhysics_Pod* physics_pod, physx_PxRigidActor_Pod* actor0_pod, physx_PxTransform_Pod const* localFrame0_pod, physx_PxRigidActor_Pod* actor1_pod, physx_PxTransform_Pod const* localFrame1_pod) {
        physx::PxPhysics& physics = reinterpret_cast<physx::PxPhysics&>(*physics_pod);
        physx::PxRigidActor* actor0 = reinterpret_cast<physx::PxRigidActor*>(actor0_pod);
        physx::PxTransform const& localFrame0 = reinterpret_cast<physx::PxTransform const&>(*localFrame0_pod);
        physx::PxRigidActor* actor1 = reinterpret_cast<physx::PxRigidActor*>(actor1_pod);
    ...
    bool physx_PxRackAndPinionJoint_setJoints_mut(physx_PxRackAndPinionJoint_Pod* self__pod, physx_PxBase_Pod const* hinge_pod, physx_PxBase_Pod const* prismatic_pod) {
    ...
    void physx_PxRackAndPinionJoint_setRatio_mut(physx_PxRackAndPinionJoint_Pod* self__pod, float ratio) {
        physx::PxRackAndPinionJoint* self_ = reinterpret_cast<physx::PxRackAndPinionJoint*>(self__pod);
        self_->setRatio(ratio);
    }

    float physx_PxRackAndPinionJoint_getRatio(physx_PxRackAndPinionJoint_Pod const* self__pod) {
    ...
    bool physx_PxRackAndPinionJoint_setData_mut(physx_PxRackAndPinionJoint_Pod* self__pod, uint32_t nbRackTeeth, uint32_t nbPinionTeeth, float rackLength) {
        physx::PxRackAndPinionJoint* self_ = reinterpret_cast<physx::PxRackAndPinionJoint*>(self__pod);
        bool return_val = self_->setData(nbRackTeeth, nbPinionTeeth, rackLength);
        return return_val;
    }

    char const* physx_PxRackAndPinionJoint_getConcreteTypeName(physx_PxRackAndPinionJoint_Pod const* self__pod) {
        physx::PxRackAndPinionJoint const* self_ = reinterpret_cast<physx::PxRackAndPinionJoint const*>(self__pod);
        char const* return_val = self_->getConcreteTypeName();
        return return_val;
    }

    physx_PxGroupsMask_Pod* physx_PxGroupsMask_new_alloc() {
        auto return_val = new physx::PxGroupsMask();
        auto return_val_pod = reinterpret_cast<physx_PxGroupsMask_Pod*>(return_val);
        return return_val_pod;
    }

    void physx_PxGroupsMask_delete(physx_PxGroupsMask_Pod* self__pod) {
        physx::PxGroupsMask* self_ = reinterpret_cast<physx::PxGroupsMask*>(self__pod);
        delete self_;
    }

    uint16_t physx_phys_PxDefaultSimulationFilterShader(uint32_t attributes0, physx_PxFilterData_Pod filterData0_pod, uint32_t attributes1, physx_PxFilterData_Pod filterData1_pod, uint16_t* pairFlags_pod, void const* constantBlock, uint32_t constantBlockSize) {
        physx::PxFilterData filterData0;
        memcpy(&filterData0, &filterData0_pod, sizeof(filterData0));
        physx::PxFilterData filterData1;
        memcpy(&filterData1, &filterData1_pod, sizeof(filterData1));
    ...
    uint16_t physx_phys_PxGetGroup(physx_PxActor_Pod const* actor_pod) {
        physx::PxActor const& actor = reinterpret_cast<physx::PxActor const&>(*actor_pod);
        uint16_t return_val = PxGetGroup(actor);
        return return_val;
    }

    void physx_phys_PxSetGroup(physx_PxActor_Pod* actor_pod, uint16_t collisionGroup) {
        physx::PxActor& actor = reinterpret_cast<physx::PxActor&>(*actor_pod);
        PxSetGroup(actor, collisionGroup);
    }

    void physx_phys_PxGetFilterOps(int32_t* op0_pod, int32_t* op1_pod, int32_t* op2_pod) {
    ...
    void physx_phys_PxSetFilterOps(int32_t const* op0_pod, int32_t const* op1_pod, int32_t const* op2_pod) {
    ...
    void physx_phys_PxGetFilterConstants(physx_PxGroupsMask_Pod* c0_pod, physx_PxGroupsMask_Pod* c1_pod) {
    ...
    void physx_phys_PxSetFilterConstants(physx_PxGroupsMask_Pod const* c0_pod, physx_PxGroupsMask_Pod const* c1_pod) {
    ...
    physx_PxGroupsMask_Pod physx_phys_PxGetGroupsMask(physx_PxActor_Pod const* actor_pod) {
        physx::PxActor const& actor = reinterpret_cast<physx::PxActor const&>(*actor_pod);
    ...
    void physx_phys_PxSetGroupsMask(physx_PxActor_Pod* actor_pod, physx_PxGroupsMask_Pod const* mask_pod) {
        physx::PxActor& actor = reinterpret_cast<physx::PxActor&>(*actor_pod);
        physx::PxGroupsMask const& mask = reinterpret_cast<physx::PxGroupsMask const&>(*mask_pod);
        PxSetGroupsMask(actor, mask);
    }

    physx_PxDefaultErrorCallback_Pod* physx_PxDefaultErrorCallback_new_alloc() {
    ...
    void physx_PxDefaultErrorCallback_delete(physx_PxDefaultErrorCallback_Pod* self__pod) {
        physx::PxDefaultErrorCallback* self_ = reinterpret_cast<physx::PxDefaultErrorCallback*>(self__pod);
        delete self_;
    }

    void physx_PxDefaultErrorCallback_reportError_mut(physx_PxDefaultErrorCallback_Pod* self__pod, int32_t code_pod, char const* message, char const* file, int32_t line) {
        physx::PxDefaultErrorCallback* self_ = reinterpret_cast<physx::PxDefaultErrorCallback*>(self__pod);
        auto code = static_cast<physx::PxErrorCode::Enum>(code_pod);
        self_->reportError(code, message, file, line);
    }

    physx_PxShape_Pod* physx_PxRigidActorExt_createExclusiveShape(physx_PxRigidActor_Pod* actor_pod, physx_PxGeometry_Pod const* geometry_pod, physx_PxMaterial_Pod* const* materials_pod, uint16_t materialCount, uint8_t shapeFlags_pod) {
        physx::PxRigidActor& actor = reinterpret_cast<physx::PxRigidActor&>(*actor_pod);
        physx::PxGeometry const& geometry = reinterpret_cast<physx::PxGeometry const&>(*geometry_pod);
        physx::PxMaterial* const* materials = reinterpret_cast<physx::PxMaterial* const*>(materials_pod);
        auto shapeFlags = physx::PxShapeFlags(shapeFlags_pod);
    ...
    physx_PxShape_Pod* physx_PxRigidActorExt_createExclusiveShape_1(physx_PxRigidActor_Pod* actor_pod, physx_PxGeometry_Pod const* geometry_pod, physx_PxMaterial_Pod const* material_pod, uint8_t shapeFlags_pod) {
        physx::PxRigidActor& actor = reinterpret_cast<physx::PxRigidActor&>(*actor_pod);
        physx::PxGeometry const& geometry = reinterpret_cast<physx::PxGeometry const&>(*geometry_pod);
        physx::PxMaterial const& material = reinterpret_cast<physx::PxMaterial const&>(*material_pod);
        auto shapeFlags = physx::PxShapeFlags(shapeFlags_pod);
    ...
    physx_PxBounds3_Pod* physx_PxRigidActorExt_getRigidActorShapeLocalBoundsList(physx_PxRigidActor_Pod const* actor_pod, uint32_t* numBounds_pod) {
        physx::PxRigidActor const& actor = reinterpret_cast<physx::PxRigidActor const&>(*actor_pod);
    ...
    physx_PxBVH_Pod* physx_PxRigidActorExt_createBVHFromActor(physx_PxPhysics_Pod* physics_pod, physx_PxRigidActor_Pod const* actor_pod) {
        physx::PxPhysics& physics = reinterpret_cast<physx::PxPhysics&>(*physics_pod);
        physx::PxRigidActor const& actor = reinterpret_cast<physx::PxRigidActor const&>(*actor_pod);
    ...
    physx_PxMassProperties_Pod physx_PxMassProperties_new() {
    ...
    physx_PxMassProperties_Pod physx_PxMassProperties_new_1(float m, physx_PxMat33_Pod const* inertiaT_pod, physx_PxVec3_Pod const* com_pod) {
    ...
    physx_PxMassProperties_Pod physx_PxMassProperties_new_2(physx_PxGeometry_Pod const* geometry_pod) {
        physx::PxGeometry const& geometry = reinterpret_cast<physx::PxGeometry const&>(*geometry_pod);
    ...
    void physx_PxMassProperties_translate_mut(physx_PxMassProperties_Pod* self__pod, physx_PxVec3_Pod const* t_pod) {
    ...
    physx_PxVec3_Pod physx_PxMassProperties_getMassSpaceInertia(physx_PxMat33_Pod const* inertia_pod, physx_PxQuat_Pod* massFrame_pod) {
    ...
    physx_PxMat33_Pod physx_PxMassProperties_translateInertia(physx_PxMat33_Pod const* inertia_pod, float mass, physx_PxVec3_Pod const* t_pod) {
        physx::PxMat33 const& inertia = reinterpret_cast<physx::PxMat33 const&>(*inertia_pod);
        physx::PxVec3 const& t = reinterpret_cast<physx::PxVec3 const&>(*t_pod);
    ...
    physx_PxMat33_Pod physx_PxMassProperties_rotateInertia(physx_PxMat33_Pod const* inertia_pod, physx_PxQuat_Pod const* q_pod) {
        physx::PxMat33 const& inertia = reinterpret_cast<physx::PxMat33 const&>(*inertia_pod);
        physx::PxQuat const& q = reinterpret_cast<physx::PxQuat const&>(*q_pod);
    ...
    physx_PxMat33_Pod physx_PxMassProperties_scaleInertia(physx_PxMat33_Pod const* inertia_pod, physx_PxQuat_Pod const* scaleRotation_pod, physx_PxVec3_Pod const* scale_pod) {
        physx::PxMat33 const& inertia = reinterpret_cast<physx::PxMat33 const&>(*inertia_pod);
    ...
    physx_PxMassProperties_Pod physx_PxMassProperties_sum(physx_PxMassProperties_Pod const* props_pod, physx_PxTransform_Pod const* transforms_pod, uint32_t count) {
    ...
    bool physx_PxRigidBodyExt_updateMassAndInertia(physx_PxRigidBody_Pod* body_pod, float const* shapeDensities, uint32_t shapeDensityCount, physx_PxVec3_Pod const* massLocalPose_pod, bool includeNonSimShapes) {
    ...
    bool physx_PxRigidBodyExt_updateMassAndInertia_1(physx_PxRigidBody_Pod* body_pod, float density, physx_PxVec3_Pod const* massLocalPose_pod, bool includeNonSimShapes) {
        physx::PxRigidBody& body = reinterpret_cast<physx::PxRigidBody&>(*body_pod);
        physx::PxVec3 const* massLocalPose = reinterpret_cast<physx::PxVec3 const*>(massLocalPose_pod);
    ...
    bool physx_PxRigidBodyExt_setMassAndUpdateInertia(physx_PxRigidBody_Pod* body_pod, float const* shapeMasses, uint32_t shapeMassCount, physx_PxVec3_Pod const* massLocalPose_pod, bool includeNonSimShapes) {
        physx::PxRigidBody& body = reinterpret_cast<physx::PxRigidBody&>(*body_pod);
        physx::PxVec3 const* massLocalPose = reinterpret_cast<physx::PxVec3 const*>(massLocalPose_pod);
    ...
    bool physx_PxRigidBodyExt_setMassAndUpdateInertia_1(physx_PxRigidBody_Pod* body_pod, float mass, physx_PxVec3_Pod const* massLocalPose_pod, bool includeNonSimShapes) {
        physx::PxRigidBody& body = reinterpret_cast<physx::PxRigidBody&>(*body_pod);
        physx::PxVec3 const* massLocalPose = reinterpret_cast<physx::PxVec3 const*>(massLocalPose_pod);
    ...
    physx_PxMassProperties_Pod physx_PxRigidBodyExt_computeMassPropertiesFromShapes(physx_PxShape_Pod const* const* shapes_pod, uint32_t shapeCount) {
    ...
    void physx_PxRigidBodyExt_addForceAtPos(physx_PxRigidBody_Pod* body_pod, physx_PxVec3_Pod const* force_pod, physx_PxVec3_Pod const* pos_pod, int32_t mode_pod, bool wakeup) {
        physx::PxRigidBody& body = reinterpret_cast<physx::PxRigidBody&>(*body_pod);
        physx::PxVec3 const& force = reinterpret_cast<physx::PxVec3 const&>(*force_pod);
        physx::PxVec3 const& pos = reinterpret_cast<physx::PxVec3 const&>(*pos_pod);
        auto mode = static_cast<physx::PxForceMode::Enum>(mode_pod);
    ...
    void physx_PxRigidBodyExt_addForceAtLocalPos(physx_PxRigidBody_Pod* body_pod, physx_PxVec3_Pod const* force_pod, physx_PxVec3_Pod const* pos_pod, int32_t mode_pod, bool wakeup) {
        physx::PxRigidBody& body = reinterpret_cast<physx::PxRigidBody&>(*body_pod);
        physx::PxVec3 const& force = reinterpret_cast<physx::PxVec3 const&>(*force_pod);
        physx::PxVec3 const& pos = reinterpret_cast<physx::PxVec3 const&>(*pos_pod);
        auto mode = static_cast<physx::PxForceMode::Enum>(mode_pod);
    ...
    void physx_PxRigidBodyExt_addLocalForceAtPos(physx_PxRigidBody_Pod* body_pod, physx_PxVec3_Pod const* force_pod, physx_PxVec3_Pod const* pos_pod, int32_t mode_pod, bool wakeup) {
        physx::PxRigidBody& body = reinterpret_cast<physx::PxRigidBody&>(*body_pod);
        physx::PxVec3 const& force = reinterpret_cast<physx::PxVec3 const&>(*force_pod);
        physx::PxVec3 const& pos = reinterpret_cast<physx::PxVec3 const&>(*pos_pod);
        auto mode = static_cast<physx::PxForceMode::Enum>(mode_pod);
    ...
    void physx_PxRigidBodyExt_addLocalForceAtLocalPos(physx_PxRigidBody_Pod* body_pod, physx_PxVec3_Pod const* force_pod, physx_PxVec3_Pod const* pos_pod, int32_t mode_pod, bool wakeup) {
        physx::PxRigidBody& body = reinterpret_cast<physx::PxRigidBody&>(*body_pod);
        physx::PxVec3 const& force = reinterpret_cast<physx::PxVec3 const&>(*force_pod);
        physx::PxVec3 const& pos = reinterpret_cast<physx::PxVec3 const&>(*pos_pod);
        auto mode = static_cast<physx::PxForceMode::Enum>(mode_pod);
    ...
    physx_PxVec3_Pod physx_PxRigidBodyExt_getVelocityAtPos(physx_PxRigidBody_Pod const* body_pod, physx_PxVec3_Pod const* pos_pod) {
    ...
    physx_PxVec3_Pod physx_PxRigidBodyExt_getLocalVelocityAtLocalPos(physx_PxRigidBody_Pod const* body_pod, physx_PxVec3_Pod const* pos_pod) {
        physx::PxRigidBody const& body = reinterpret_cast<physx::PxRigidBody const&>(*body_pod);
        physx::PxVec3 const& pos = reinterpret_cast<physx::PxVec3 const&>(*pos_pod);
    ...
    physx_PxVec3_Pod physx_PxRigidBodyExt_getVelocityAtOffset(physx_PxRigidBody_Pod const* body_pod, physx_PxVec3_Pod const* pos_pod) {
        physx::PxRigidBody const& body = reinterpret_cast<physx::PxRigidBody const&>(*body_pod);
        physx::PxVec3 const& pos = reinterpret_cast<physx::PxVec3 const&>(*pos_pod);
    ...
    void physx_PxRigidBodyExt_computeVelocityDeltaFromImpulse(physx_PxRigidBody_Pod const* body_pod, physx_PxVec3_Pod const* impulsiveForce_pod, physx_PxVec3_Pod const* impulsiveTorque_pod, physx_PxVec3_Pod* deltaLinearVelocity_pod, physx_PxVec3_Pod* deltaAngularVelocity_pod) {
        physx::PxRigidBody const& body = reinterpret_cast<physx::PxRigidBody const&>(*body_pod);
    ...
    void physx_PxRigidBodyExt_computeLinearAngularImpulse(physx_PxRigidBody_Pod const* body_pod, physx_PxTransform_Pod const* globalPose_pod, physx_PxVec3_Pod const* point_pod, physx_PxVec3_Pod const* impulse_pod, float invMassScale, float invInertiaScale, physx_PxVec3_Pod* linearImpulse_pod, physx_PxVec3_Pod* angularImpulse_pod) {
        physx::PxRigidBody const& body = reinterpret_cast<physx::PxRigidBody const&>(*body_pod);
        physx::PxTransform const& globalPose = reinterpret_cast<physx::PxTransform const&>(*globalPose_pod);
        physx::PxVec3 const& point = reinterpret_cast<physx::PxVec3 const&>(*point_pod);
        physx::PxVec3 const& impulse = reinterpret_cast<physx::PxVec3 const&>(*impulse_pod);
    ...
    physx_PxTransform_Pod physx_PxShapeExt_getGlobalPose(physx_PxShape_Pod const* shape_pod, physx_PxRigidActor_Pod const* actor_pod) {
        physx::PxShape const& shape = reinterpret_cast<physx::PxShape const&>(*shape_pod);
        physx::PxRigidActor const& actor = reinterpret_cast<physx::PxRigidActor const&>(*actor_pod);
    ...
    uint32_t physx_PxShapeExt_raycast(physx_PxShape_Pod const* shape_pod, physx_PxRigidActor_Pod const* actor_pod, physx_PxVec3_Pod const* rayOrigin_pod, physx_PxVec3_Pod const* rayDir_pod, float maxDist, uint16_t hitFlags_pod, uint32_t maxHits, physx_PxRaycastHit_Pod* rayHits_pod) {
        physx::PxShape const& shape = reinterpret_cast<physx::PxShape const&>(*shape_pod);
        physx::PxRigidActor const& actor = reinterpret_cast<physx::PxRigidActor const&>(*actor_pod);
    ...
    bool physx_PxShapeExt_overlap(physx_PxShape_Pod const* shape_pod, physx_PxRigidActor_Pod const* actor_pod, physx_PxGeometry_Pod const* otherGeom_pod, physx_PxTransform_Pod const* otherGeomPose_pod) {
        physx::PxShape const& shape = reinterpret_cast<physx::PxShape const&>(*shape_pod);
        physx::PxRigidActor const& actor = reinterpret_cast<physx::PxRigidActor const&>(*actor_pod);
    ...
    bool physx_PxShapeExt_sweep(physx_PxShape_Pod const* shape_pod, physx_PxRigidActor_Pod const* actor_pod, physx_PxVec3_Pod const* unitDir_pod, float distance, physx_PxGeometry_Pod const* otherGeom_pod, physx_PxTransform_Pod const* otherGeomPose_pod, physx_PxSweepHit_Pod* sweepHit_pod, uint16_t hitFlags_pod) {
        physx::PxShape const& shape = reinterpret_cast<physx::PxShape const&>(*shape_pod);
        physx::PxRigidActor const& actor = reinterpret_cast<physx::PxRigidActor const&>(*actor_pod);
        physx::PxVec3 const& unitDir = reinterpret_cast<physx::PxVec3 const&>(*unitDir_pod);
        physx::PxGeometry const& otherGeom = reinterpret_cast<physx::PxGeometry const&>(*otherGeom_pod);
    ...
    physx_PxBounds3_Pod physx_PxShapeExt_getWorldBounds(physx_PxShape_Pod const* shape_pod, physx_PxRigidActor_Pod const* actor_pod, float inflation) {
        physx::PxShape const& shape = reinterpret_cast<physx::PxShape const&>(*shape_pod);
        physx::PxRigidActor const& actor = reinterpret_cast<physx::PxRigidActor const&>(*actor_pod);
    ...
    physx_PxMeshOverlapUtil_Pod* physx_PxMeshOverlapUtil_new_alloc() {
        auto return_val = new physx::PxMeshOverlapUtil();
        auto return_val_pod = reinterpret_cast<physx_PxMeshOverlapUtil_Pod*>(return_val);
        return return_val_pod;
    }

    void physx_PxMeshOverlapUtil_delete(physx_PxMeshOverlapUtil_Pod* self__pod) {
        physx::PxMeshOverlapUtil* self_ = reinterpret_cast<physx::PxMeshOverlapUtil*>(self__pod);
        delete self_;
    }

    uint32_t physx_PxMeshOverlapUtil_findOverlap_mut(physx_PxMeshOverlapUtil_Pod* self__pod, physx_PxGeometry_Pod const* geom_pod, physx_PxTransform_Pod const* geomPose_pod, physx_PxTriangleMeshGeometry_Pod const* meshGeom_pod, physx_PxTransform_Pod const* meshPose_pod) {
        physx::PxMeshOverlapUtil* self_ = reinterpret_cast<physx::PxMeshOverlapUtil*>(self__pod);
        physx::PxGeometry const& geom = reinterpret_cast<physx::PxGeometry const&>(*geom_pod);
        physx::PxTransform const& geomPose = reinterpret_cast<physx::PxTransform const&>(*geomPose_pod);
        physx::PxTriangleMeshGeometry const& meshGeom = reinterpret_cast<physx::PxTriangleMeshGeometry const&>(*meshGeom_pod);
    ...
    uint32_t physx_PxMeshOverlapUtil_findOverlap_mut_1(physx_PxMeshOverlapUtil_Pod* self__pod, physx_PxGeometry_Pod const* geom_pod, physx_PxTransform_Pod const* geomPose_pod, physx_PxHeightFieldGeometry_Pod const* hfGeom_pod, physx_PxTransform_Pod const* hfPose_pod) {
        physx::PxMeshOverlapUtil* self_ = reinterpret_cast<physx::PxMeshOverlapUtil*>(self__pod);
        physx::PxGeometry const& geom = reinterpret_cast<physx::PxGeometry const&>(*geom_pod);
        physx::PxTransform const& geomPose = reinterpret_cast<physx::PxTransform const&>(*geomPose_pod);
        physx::PxHeightFieldGeometry const& hfGeom = reinterpret_cast<physx::PxHeightFieldGeometry const&>(*hfGeom_pod);
    ...
    uint32_t const* physx_PxMeshOverlapUtil_getResults(physx_PxMeshOverlapUtil_Pod const* self__pod) {
    ...
    uint32_t physx_PxMeshOverlapUtil_getNbResults(physx_PxMeshOverlapUtil_Pod const* self__pod) {
        physx::PxMeshOverlapUtil const* self_ = reinterpret_cast<physx::PxMeshOverlapUtil const*>(self__pod);
        uint32_t return_val = self_->getNbResults();
        return return_val;
    }

    bool physx_phys_PxComputeTriangleMeshPenetration(physx_PxVec3_Pod* direction_pod, float* depth_pod, physx_PxGeometry_Pod const* geom_pod, physx_PxTransform_Pod const* geomPose_pod, physx_PxTriangleMeshGeometry_Pod const* meshGeom_pod, physx_PxTransform_Pod const* meshPose_pod, uint32_t maxIter, uint32_t* usedIter) {
        physx::PxVec3& direction = reinterpret_cast<physx::PxVec3&>(*direction_pod);
        float& depth = *depth_pod;
        physx::PxGeometry const& geom = reinterpret_cast<physx::PxGeometry const&>(*geom_pod);
        physx::PxTransform const& geomPose = reinterpret_cast<physx::PxTransform const&>(*geomPose_pod);
    ...
    physx_PxXmlMiscParameter_Pod physx_PxXmlMiscParameter_new() {
    ...
    physx_PxXmlMiscParameter_Pod physx_PxXmlMiscParameter_new_1(physx_PxVec3_Pod* inUpVector_pod, physx_PxTolerancesScale_Pod inScale_pod) {
    ...
    bool physx_PxSerialization_isSerializable(physx_PxCollection_Pod* collection_pod, physx_PxSerializationRegistry_Pod* sr_pod, physx_PxCollection_Pod const* externalReferences_pod) {
        physx::PxCollection& collection = reinterpret_cast<physx::PxCollection&>(*collection_pod);
    ...
    void physx_PxSerialization_complete(physx_PxCollection_Pod* collection_pod, physx_PxSerializationRegistry_Pod* sr_pod, physx_PxCollection_Pod const* exceptFor_pod, bool followJoints) {
        physx::PxCollection& collection = reinterpret_cast<physx::PxCollection&>(*collection_pod);
        physx::PxSerializationRegistry& sr = reinterpret_cast<physx::PxSerializationRegistry&>(*sr_pod);
    ...
    physx_PxCollection_Pod* physx_PxSerialization_createCollectionFromBinary(void* memBlock, physx_PxSerializationRegistry_Pod* sr_pod, physx_PxCollection_Pod const* externalRefs_pod) {
        physx::PxSerializationRegistry& sr = reinterpret_cast<physx::PxSerializationRegistry&>(*sr_pod);
        physx::PxCollection const* externalRefs = reinterpret_cast<physx::PxCollection const*>(externalRefs_pod);
    ...
    bool physx_PxSerialization_serializeCollectionToXml(physx_PxOutputStream_Pod* outputStream_pod, physx_PxCollection_Pod* collection_pod, physx_PxSerializationRegistry_Pod* sr_pod, physx_PxCooking_Pod* cooking_pod, physx_PxCollection_Pod const* externalRefs_pod, physx_PxXmlMiscParameter_Pod* inArgs_pod) {
    ...
    bool physx_PxSerialization_serializeCollectionToBinary(physx_PxOutputStream_Pod* outputStream_pod, physx_PxCollection_Pod* collection_pod, physx_PxSerializationRegistry_Pod* sr_pod, physx_PxCollection_Pod const* externalRefs_pod, bool exportNames) {
        physx::PxOutputStream& outputStream = reinterpret_cast<physx::PxOutputStream&>(*outputStream_pod);
        physx::PxCollection& collection = reinterpret_cast<physx::PxCollection&>(*collection_pod);
        physx::PxSerializationRegistry& sr = reinterpret_cast<physx::PxSerializationRegistry&>(*sr_pod);
        physx::PxCollection const* externalRefs = reinterpret_cast<physx::PxCollection const*>(externalRefs_pod);
    ...
    physx_PxSerializationRegistry_Pod* physx_PxSerialization_createSerializationRegistry(physx_PxPhysics_Pod* physics_pod) {
        physx::PxPhysics& physics = reinterpret_cast<physx::PxPhysics&>(*physics_pod);
    ...
    void physx_PxDefaultCpuDispatcher_release_mut(physx_PxDefaultCpuDispatcher_Pod* self__pod) {
        physx::PxDefaultCpuDispatcher* self_ = reinterpret_cast<physx::PxDefaultCpuDispatcher*>(self__pod);
        self_->release();
    }

    void physx_PxDefaultCpuDispatcher_setRunProfiled_mut(physx_PxDefaultCpuDispatcher_Pod* self__pod, bool runProfiled) {
        physx::PxDefaultCpuDispatcher* self_ = reinterpret_cast<physx::PxDefaultCpuDispatcher*>(self__pod);
        self_->setRunProfiled(runProfiled);
    }

    bool physx_PxDefaultCpuDispatcher_getRunProfiled(physx_PxDefaultCpuDispatcher_Pod const* self__pod) {
    ...
    physx_PxDefaultCpuDispatcher_Pod* physx_phys_PxDefaultCpuDispatcherCreate(uint32_t numThreads, uint32_t* affinityMasks, int32_t mode_pod, uint32_t yieldProcessorCount) {
    ...
    bool physx_phys_PxBuildSmoothNormals(uint32_t nbTris, uint32_t nbVerts, physx_PxVec3_Pod const* verts_pod, uint32_t const* dFaces, uint16_t const* wFaces, physx_PxVec3_Pod* normals_pod, bool flip) {
    ...
    physx_PxRigidDynamic_Pod* physx_phys_PxCreateDynamic(physx_PxPhysics_Pod* sdk_pod, physx_PxTransform_Pod const* transform_pod, physx_PxGeometry_Pod const* geometry_pod, physx_PxMaterial_Pod* material_pod, float density, physx_PxTransform_Pod const* shapeOffset_pod) {
    ...
    physx_PxRigidDynamic_Pod* physx_phys_PxCreateDynamic_1(physx_PxPhysics_Pod* sdk_pod, physx_PxTransform_Pod const* transform_pod, physx_PxShape_Pod* shape_pod, float density) {
        physx::PxPhysics& sdk = reinterpret_cast<physx::PxPhysics&>(*sdk_pod);
        physx::PxTransform const& transform = reinterpret_cast<physx::PxTransform const&>(*transform_pod);
        physx::PxShape& shape = reinterpret_cast<physx::PxShape&>(*shape_pod);
    ...
    physx_PxRigidDynamic_Pod* physx_phys_PxCreateKinematic(physx_PxPhysics_Pod* sdk_pod, physx_PxTransform_Pod const* transform_pod, physx_PxGeometry_Pod const* geometry_pod, physx_PxMaterial_Pod* material_pod, float density, physx_PxTransform_Pod const* shapeOffset_pod) {
        physx::PxPhysics& sdk = reinterpret_cast<physx::PxPhysics&>(*sdk_pod);
        physx::PxTransform const& transform = reinterpret_cast<physx::PxTransform const&>(*transform_pod);
        physx::PxGeometry const& geometry = reinterpret_cast<physx::PxGeometry const&>(*geometry_pod);
        physx::PxMaterial& material = reinterpret_cast<physx::PxMaterial&>(*material_pod);
    ...
    physx_PxRigidDynamic_Pod* physx_phys_PxCreateKinematic_1(physx_PxPhysics_Pod* sdk_pod, physx_PxTransform_Pod const* transform_pod, physx_PxShape_Pod* shape_pod, float density) {
        physx::PxPhysics& sdk = reinterpret_cast<physx::PxPhysics&>(*sdk_pod);
        physx::PxTransform const& transform = reinterpret_cast<physx::PxTransform const&>(*transform_pod);
        physx::PxShape& shape = reinterpret_cast<physx::PxShape&>(*shape_pod);
    ...
    physx_PxRigidStatic_Pod* physx_phys_PxCreateStatic(physx_PxPhysics_Pod* sdk_pod, physx_PxTransform_Pod const* transform_pod, physx_PxGeometry_Pod const* geometry_pod, physx_PxMaterial_Pod* material_pod, physx_PxTransform_Pod const* shapeOffset_pod) {
        physx::PxPhysics& sdk = reinterpret_cast<physx::PxPhysics&>(*sdk_pod);
        physx::PxTransform const& transform = reinterpret_cast<physx::PxTransform const&>(*transform_pod);
        physx::PxGeometry const& geometry = reinterpret_cast<physx::PxGeometry const&>(*geometry_pod);
        physx::PxMaterial& material = reinterpret_cast<physx::PxMaterial&>(*material_pod);
    ...
    physx_PxRigidStatic_Pod* physx_phys_PxCreateStatic_1(physx_PxPhysics_Pod* sdk_pod, physx_PxTransform_Pod const* transform_pod, physx_PxShape_Pod* shape_pod) {
        physx::PxPhysics& sdk = reinterpret_cast<physx::PxPhysics&>(*sdk_pod);
        physx::PxTransform const& transform = reinterpret_cast<physx::PxTransform const&>(*transform_pod);
        physx::PxShape& shape = reinterpret_cast<physx::PxShape&>(*shape_pod);
    ...
    physx_PxShape_Pod* physx_phys_PxCloneShape(physx_PxPhysics_Pod* physicsSDK_pod, physx_PxShape_Pod const* shape_pod, bool isExclusive) {
    ...
    physx_PxRigidStatic_Pod* physx_phys_PxCloneStatic(physx_PxPhysics_Pod* physicsSDK_pod, physx_PxTransform_Pod const* transform_pod, physx_PxRigidActor_Pod const* actor_pod) {
        physx::PxPhysics& physicsSDK = reinterpret_cast<physx::PxPhysics&>(*physicsSDK_pod);
        physx::PxTransform const& transform = reinterpret_cast<physx::PxTransform const&>(*transform_pod);
        physx::PxRigidActor const& actor = reinterpret_cast<physx::PxRigidActor const&>(*actor_pod);
    ...
    physx_PxRigidDynamic_Pod* physx_phys_PxCloneDynamic(physx_PxPhysics_Pod* physicsSDK_pod, physx_PxTransform_Pod const* transform_pod, physx_PxRigidDynamic_Pod const* body_pod) {
        physx::PxPhysics& physicsSDK = reinterpret_cast<physx::PxPhysics&>(*physicsSDK_pod);
        physx::PxTransform const& transform = reinterpret_cast<physx::PxTransform const&>(*transform_pod);
    ...
    physx_PxRigidStatic_Pod* physx_phys_PxCreatePlane(physx_PxPhysics_Pod* sdk_pod, physx_PxPlane_Pod const* plane_pod, physx_PxMaterial_Pod* material_pod) {
        physx::PxPhysics& sdk = reinterpret_cast<physx::PxPhysics&>(*sdk_pod);
        physx::PxPlane const& plane = reinterpret_cast<physx::PxPlane const&>(*plane_pod);
        physx::PxMaterial& material = reinterpret_cast<physx::PxMaterial&>(*material_pod);
    ...
    void physx_phys_PxScaleRigidActor(physx_PxRigidActor_Pod* actor_pod, float scale, bool scaleMassProps) {
        physx::PxRigidActor& actor = reinterpret_cast<physx::PxRigidActor&>(*actor_pod);
        PxScaleRigidActor(actor, scale, scaleMassProps);
    }

    physx_PxStringTable_Pod* physx_PxStringTableExt_createStringTable(physx_PxAllocatorCallback_Pod* inAllocator_pod) {
    ...
    uint32_t physx_PxBroadPhaseExt_createRegionsFromWorldBounds(physx_PxBounds3_Pod* regions_pod, physx_PxBounds3_Pod const* globalBounds_pod, uint32_t nbSubdiv, uint32_t upAxis) {
    ...
    bool physx_PxSceneQueryExt_overlapAny(physx_PxScene_Pod const* scene_pod, physx_PxGeometry_Pod const* geometry_pod, physx_PxTransform_Pod const* pose_pod, physx_PxOverlapHit_Pod* hit_pod, physx_PxQueryFilterData_Pod const* filterData_pod, physx_PxQueryFilterCallback_Pod* filterCall_pod) {
        physx::PxScene const& scene = reinterpret_cast<physx::PxScene const&>(*scene_pod);
        physx::PxGeometry const& geometry = reinterpret_cast<physx::PxGeometry const&>(*geometry_pod);
        physx::PxTransform const& pose = reinterpret_cast<physx::PxTransform const&>(*pose_pod);
    ...
    void physx_PxBatchQueryExt_release_mut(physx_PxBatchQueryExt_Pod* self__pod) {
        physx::PxBatchQueryExt* self_ = reinterpret_cast<physx::PxBatchQueryExt*>(self__pod);
        self_->release();
    }

    physx_PxRaycastBuffer_Pod* physx_PxBatchQueryExt_raycast_mut(physx_PxBatchQueryExt_Pod* self__pod, physx_PxVec3_Pod const* origin_pod, physx_PxVec3_Pod const* unitDir_pod, float distance, uint16_t maxNbTouches, uint16_t hitFlags_pod, physx_PxQueryFilterData_Pod const* filterData_pod, physx_PxQueryCache_Pod const* cache_pod) {
        physx::PxBatchQueryExt* self_ = reinterpret_cast<physx::PxBatchQueryExt*>(self__pod);
        physx::PxVec3 const& origin = reinterpret_cast<physx::PxVec3 const&>(*origin_pod);
        physx::PxVec3 const& unitDir = reinterpret_cast<physx::PxVec3 const&>(*unitDir_pod);
        auto hitFlags = physx::PxHitFlags(hitFlags_pod);
    ...
    physx_PxSweepBuffer_Pod* physx_PxBatchQueryExt_sweep_mut(physx_PxBatchQueryExt_Pod* self__pod, physx_PxGeometry_Pod const* geometry_pod, physx_PxTransform_Pod const* pose_pod, physx_PxVec3_Pod const* unitDir_pod, float distance, uint16_t maxNbTouches, uint16_t hitFlags_pod, physx_PxQueryFilterData_Pod const* filterData_pod, physx_PxQueryCache_Pod const* cache_pod, float inflation) {
        physx::PxBatchQueryExt* self_ = reinterpret_cast<physx::PxBatchQueryExt*>(self__pod);
        physx::PxGeometry const& geometry = reinterpret_cast<physx::PxGeometry const&>(*geometry_pod);
        physx::PxTransform const& pose = reinterpret_cast<physx::PxTransform const&>(*pose_pod);
        physx::PxVec3 const& unitDir = reinterpret_cast<physx::PxVec3 const&>(*unitDir_pod);
    ...
    physx_PxOverlapBuffer_Pod* physx_PxBatchQueryExt_overlap_mut(physx_PxBatchQueryExt_Pod* self__pod, physx_PxGeometry_Pod const* geometry_pod, physx_PxTransform_Pod const* pose_pod, uint16_t maxNbTouches, physx_PxQueryFilterData_Pod const* filterData_pod, physx_PxQueryCache_Pod const* cache_pod) {
        physx::PxBatchQueryExt* self_ = reinterpret_cast<physx::PxBatchQueryExt*>(self__pod);
        physx::PxGeometry const& geometry = reinterpret_cast<physx::PxGeometry const&>(*geometry_pod);
        physx::PxTransform const& pose = reinterpret_cast<physx::PxTransform const&>(*pose_pod);
        physx::PxQueryFilterData const& filterData = reinterpret_cast<physx::PxQueryFilterData const&>(*filterData_pod);
    ...
    void physx_PxBatchQueryExt_execute_mut(physx_PxBatchQueryExt_Pod* self__pod) {
        physx::PxBatchQueryExt* self_ = reinterpret_cast<physx::PxBatchQueryExt*>(self__pod);
        self_->execute();
    }

    physx_PxBatchQueryExt_Pod* physx_phys_PxCreateBatchQueryExt(physx_PxScene_Pod const* scene_pod, physx_PxQueryFilterCallback_Pod* queryFilterCallback_pod, uint32_t maxNbRaycasts, uint32_t maxNbRaycastTouches, uint32_t maxNbSweeps, uint32_t maxNbSweepTouches, uint32_t maxNbOverlaps, uint32_t maxNbOverlapTouches) {
        physx::PxScene const& scene = reinterpret_cast<physx::PxScene const&>(*scene_pod);
    ...
    physx_PxSceneQuerySystem_Pod* physx_phys_PxCreateExternalSceneQuerySystem(physx_PxSceneQueryDesc_Pod const* desc_pod, uint64_t contextID) {
    ...
    uint32_t physx_PxCustomSceneQuerySystem_addPruner_mut(physx_PxCustomSceneQuerySystem_Pod* self__pod, int32_t primaryType_pod, int32_t secondaryType_pod, uint32_t preallocated) {
    ...
    uint32_t physx_PxCustomSceneQuerySystem_startCustomBuildstep_mut(physx_PxCustomSceneQuerySystem_Pod* self__pod) {
        physx::PxCustomSceneQuerySystem* self_ = reinterpret_cast<physx::PxCustomSceneQuerySystem*>(self__pod);
        uint32_t return_val = self_->startCustomBuildstep();
        return return_val;
    }

    void physx_PxCustomSceneQuerySystem_customBuildstep_mut(physx_PxCustomSceneQuerySystem_Pod* self__pod, uint32_t index) {
        physx::PxCustomSceneQuerySystem* self_ = reinterpret_cast<physx::PxCustomSceneQuerySystem*>(self__pod);
        self_->customBuildstep(index);
    }

    void physx_PxCustomSceneQuerySystem_finishCustomBuildstep_mut(physx_PxCustomSceneQuerySystem_Pod* self__pod) {
        physx::PxCustomSceneQuerySystem* self_ = reinterpret_cast<physx::PxCustomSceneQuerySystem*>(self__pod);
        self_->finishCustomBuildstep();
    }

    void physx_PxCustomSceneQuerySystemAdapter_delete(physx_PxCustomSceneQuerySystemAdapter_Pod* self__pod) {
        physx::PxCustomSceneQuerySystemAdapter* self_ = reinterpret_cast<physx::PxCustomSceneQuerySystemAdapter*>(self__pod);
        delete self_;
    }

    uint32_t physx_PxCustomSceneQuerySystemAdapter_getPrunerIndex(physx_PxCustomSceneQuerySystemAdapter_Pod const* self__pod, physx_PxRigidActor_Pod const* actor_pod, physx_PxShape_Pod const* shape_pod) {
    ...
    bool physx_PxCustomSceneQuerySystemAdapter_processPruner(physx_PxCustomSceneQuerySystemAdapter_Pod const* self__pod, uint32_t prunerIndex, physx_PxQueryThreadContext_Pod const* context_pod, physx_PxQueryFilterData_Pod const* filterData_pod, physx_PxQueryFilterCallback_Pod* filterCall_pod) {
        physx::PxCustomSceneQuerySystemAdapter const* self_ = reinterpret_cast<physx::PxCustomSceneQuerySystemAdapter const*>(self__pod);
    ...
    physx_PxCustomSceneQuerySystem_Pod* physx_phys_PxCreateCustomSceneQuerySystem(int32_t sceneQueryUpdateMode_pod, uint64_t contextID, physx_PxCustomSceneQuerySystemAdapter_Pod const* adapter_pod, bool usesTreeOfPruners) {
    ...
    uint32_t physx_phys_PxFindFaceIndex(physx_PxConvexMeshGeometry_Pod const* convexGeom_pod, physx_PxTransform_Pod const* geomPose_pod, physx_PxVec3_Pod const* impactPos_pod, physx_PxVec3_Pod const* unitDir_pod) {
    ...
    bool physx_PxPoissonSampler_setSamplingRadius_mut(physx_PxPoissonSampler_Pod* self__pod, float samplingRadius) {
    ...
    void physx_PxPoissonSampler_addSamplesInSphere_mut(physx_PxPoissonSampler_Pod* self__pod, physx_PxVec3_Pod const* sphereCenter_pod, float sphereRadius, bool createVolumeSamples) {
        physx::PxPoissonSampler* self_ = reinterpret_cast<physx::PxPoissonSampler*>(self__pod);
    ...
    void physx_PxPoissonSampler_addSamplesInBox_mut(physx_PxPoissonSampler_Pod* self__pod, physx_PxBounds3_Pod const* axisAlignedBox_pod, physx_PxQuat_Pod const* boxOrientation_pod, bool createVolumeSamples) {
        physx::PxPoissonSampler* self_ = reinterpret_cast<physx::PxPoissonSampler*>(self__pod);
    ...
    void physx_PxPoissonSampler_delete(physx_PxPoissonSampler_Pod* self__pod) {
        physx::PxPoissonSampler* self_ = reinterpret_cast<physx::PxPoissonSampler*>(self__pod);
        delete self_;
    }

    physx_PxPoissonSampler_Pod* physx_phys_PxCreateShapeSampler(physx_PxGeometry_Pod const* geometry_pod, physx_PxTransform_Pod const* transform_pod, physx_PxBounds3_Pod const* worldBounds_pod, float initialSamplingRadius, int32_t numSampleAttemptsAroundPoint) {
        physx::PxGeometry const& geometry = reinterpret_cast<physx::PxGeometry const&>(*geometry_pod);
        physx::PxTransform const& transform = reinterpret_cast<physx::PxTransform const&>(*transform_pod);
    ...
    bool physx_PxTriangleMeshPoissonSampler_isPointInTriangleMesh_mut(physx_PxTriangleMeshPoissonSampler_Pod* self__pod, physx_PxVec3_Pod const* p_pod) {
    ...
    void physx_PxTriangleMeshPoissonSampler_delete(physx_PxTriangleMeshPoissonSampler_Pod* self__pod) {
        physx::PxTriangleMeshPoissonSampler* self_ = reinterpret_cast<physx::PxTriangleMeshPoissonSampler*>(self__pod);
        delete self_;
    }

    physx_PxTriangleMeshPoissonSampler_Pod* physx_phys_PxCreateTriangleMeshSampler(uint32_t const* triangles, uint32_t numTriangles, physx_PxVec3_Pod const* vertices_pod, uint32_t numVertices, float initialSamplingRadius, int32_t numSampleAttemptsAroundPoint) {
    ...
    int32_t physx_PxTetrahedronMeshExt_findTetrahedronContainingPoint(physx_PxTetrahedronMesh_Pod const* mesh_pod, physx_PxVec3_Pod const* point_pod, physx_PxVec4_Pod* bary_pod, float tolerance) {
    ...
    int32_t physx_PxTetrahedronMeshExt_findTetrahedronClosestToPoint(physx_PxTetrahedronMesh_Pod const* mesh_pod, physx_PxVec3_Pod const* point_pod, physx_PxVec4_Pod* bary_pod) {
        physx::PxTetrahedronMesh const* mesh = reinterpret_cast<physx::PxTetrahedronMesh const*>(mesh_pod);
        physx::PxVec3 const& point = reinterpret_cast<physx::PxVec3 const&>(*point_pod);
        physx::PxVec4& bary = reinterpret_cast<physx::PxVec4&>(*bary_pod);
    ...
    bool physx_phys_PxInitExtensions(physx_PxPhysics_Pod* physics_pod, physx_PxPvd_Pod* pvd_pod) {
        physx::PxPhysics& physics = reinterpret_cast<physx::PxPhysics&>(*physics_pod);
        physx::PxPvd* pvd = reinterpret_cast<physx::PxPvd*>(pvd_pod);
    ...
    physx_PxRepXObject_Pod physx_PxRepXObject_new(char const* inTypeName, void const* inSerializable, uint64_t inId) {
    ...
    bool physx_PxRepXObject_isValid(physx_PxRepXObject_Pod const* self__pod) {
        physx::PxRepXObject const* self_ = reinterpret_cast<physx::PxRepXObject const*>(self__pod);
        bool return_val = self_->isValid();
        return return_val;
    }

    physx_PxRepXInstantiationArgs_Pod physx_PxRepXInstantiationArgs_new(physx_PxPhysics_Pod* inPhysics_pod, physx_PxCooking_Pod* inCooking_pod, physx_PxStringTable_Pod* inStringTable_pod) {
    ...
    char const* physx_PxRepXSerializer_getTypeName_mut(physx_PxRepXSerializer_Pod* self__pod) {
        physx::PxRepXSerializer* self_ = reinterpret_cast<physx::PxRepXSerializer*>(self__pod);
        char const* return_val = self_->getTypeName();
        return return_val;
    }

    void physx_PxRepXSerializer_objectToFile_mut(physx_PxRepXSerializer_Pod* self__pod, physx_PxRepXObject_Pod const* inLiveObject_pod, physx_PxCollection_Pod* inCollection_pod, physx_XmlWriter_Pod* inWriter_pod, physx_MemoryBuffer_Pod* inTempBuffer_pod, physx_PxRepXInstantiationArgs_Pod* inArgs_pod) {
        physx::PxRepXSerializer* self_ = reinterpret_cast<physx::PxRepXSerializer*>(self__pod);
    ...
    physx_PxRepXObject_Pod physx_PxRepXSerializer_fileToObject_mut(physx_PxRepXSerializer_Pod* self__pod, physx_XmlReader_Pod* inReader_pod, physx_XmlMemoryAllocator_Pod* inAllocator_pod, physx_PxRepXInstantiationArgs_Pod* inArgs_pod, physx_PxCollection_Pod* inCollection_pod) {
        physx::PxRepXSerializer* self_ = reinterpret_cast<physx::PxRepXSerializer*>(self__pod);
    ...
    bool physx_PxPvd_connect_mut(physx_PxPvd_Pod* self__pod, physx_PxPvdTransport_Pod* transport_pod, uint8_t flags_pod) {
    ...
    void physx_PxPvd_disconnect_mut(physx_PxPvd_Pod* self__pod) {
        physx::PxPvd* self_ = reinterpret_cast<physx::PxPvd*>(self__pod);
        self_->disconnect();
    }

    bool physx_PxPvd_isConnected_mut(physx_PxPvd_Pod* self__pod, bool useCachedStatus) {
        physx::PxPvd* self_ = reinterpret_cast<physx::PxPvd*>(self__pod);
        bool return_val = self_->isConnected(useCachedStatus);
        return return_val;
    }

    physx_PxPvdTransport_Pod* physx_PxPvd_getTransport_mut(physx_PxPvd_Pod* self__pod) {
        physx::PxPvd* self_ = reinterpret_cast<physx::PxPvd*>(self__pod);
    ...
    uint8_t physx_PxPvd_getInstrumentationFlags_mut(physx_PxPvd_Pod* self__pod) {
        physx::PxPvd* self_ = reinterpret_cast<physx::PxPvd*>(self__pod);
    ...
    void physx_PxPvd_release_mut(physx_PxPvd_Pod* self__pod) {
        physx::PxPvd* self_ = reinterpret_cast<physx::PxPvd*>(self__pod);
        self_->release();
    }

    physx_PxPvd_Pod* physx_phys_PxCreatePvd(physx_PxFoundation_Pod* foundation_pod) {
        physx::PxFoundation& foundation = reinterpret_cast<physx::PxFoundation&>(*foundation_pod);
    ...
    bool physx_PxPvdTransport_connect_mut(physx_PxPvdTransport_Pod* self__pod) {
        physx::PxPvdTransport* self_ = reinterpret_cast<physx::PxPvdTransport*>(self__pod);
        bool return_val = self_->connect();
        return return_val;
    }

    void physx_PxPvdTransport_disconnect_mut(physx_PxPvdTransport_Pod* self__pod) {
        physx::PxPvdTransport* self_ = reinterpret_cast<physx::PxPvdTransport*>(self__pod);
        self_->disconnect();
    }

    bool physx_PxPvdTransport_isConnected_mut(physx_PxPvdTransport_Pod* self__pod) {
        physx::PxPvdTransport* self_ = reinterpret_cast<physx::PxPvdTransport*>(self__pod);
        bool return_val = self_->isConnected();
        return return_val;
    }

    bool physx_PxPvdTransport_write_mut(physx_PxPvdTransport_Pod* self__pod, uint8_t const* inBytes, uint32_t inLength) {
        physx::PxPvdTransport* self_ = reinterpret_cast<physx::PxPvdTransport*>(self__pod);
        bool return_val = self_->write(inBytes, inLength);
        return return_val;
    }

    physx_PxPvdTransport_Pod* physx_PxPvdTransport_lock_mut(physx_PxPvdTransport_Pod* self__pod) {
        physx::PxPvdTransport* self_ = reinterpret_cast<physx::PxPvdTransport*>(self__pod);
    ...
    void physx_PxPvdTransport_unlock_mut(physx_PxPvdTransport_Pod* self__pod) {
        physx::PxPvdTransport* self_ = reinterpret_cast<physx::PxPvdTransport*>(self__pod);
        self_->unlock();
    }

    void physx_PxPvdTransport_flush_mut(physx_PxPvdTransport_Pod* self__pod) {
        physx::PxPvdTransport* self_ = reinterpret_cast<physx::PxPvdTransport*>(self__pod);
        self_->flush();
    }

    uint64_t physx_PxPvdTransport_getWrittenDataSize_mut(physx_PxPvdTransport_Pod* self__pod) {
        physx::PxPvdTransport* self_ = reinterpret_cast<physx::PxPvdTransport*>(self__pod);
        uint64_t return_val = self_->getWrittenDataSize();
        return return_val;
    }

    void physx_PxPvdTransport_release_mut(physx_PxPvdTransport_Pod* self__pod) {
        physx::PxPvdTransport* self_ = reinterpret_cast<physx::PxPvdTransport*>(self__pod);
        self_->release();
    }

    physx_PxPvdTransport_Pod* physx_phys_PxDefaultPvdSocketTransportCreate(char const* host, int32_t port, uint32_t timeoutInMilliseconds) {
        physx::PxPvdTransport* return_val = PxDefaultPvdSocketTransportCreate(host, port, timeoutInMilliseconds);
        auto return_val_pod = reinterpret_cast<physx_PxPvdTransport_Pod*>(return_val);
        return return_val_pod;
    }

    physx_PxPvdTransport_Pod* physx_phys_PxDefaultPvdFileTransportCreate(char const* name) {
